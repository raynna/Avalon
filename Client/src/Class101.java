...
public class Class101 {
	...
	try {
	    ...
	    String string = new String(this.aByteArray1082, this.anInt1083 * -999234057, i_0_);
	    this.anInt1083 += i_0_ * -786863161;
	    return string;
	}
	...
	try {
		...
		i_1_ |= ((this.aByteArray1082[((this.anInt1083 += -786863161) * -999234057) - 1]) & 0xff) << i_2_ * 8;
	    return i_1_;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1081(Class403 class403, byte i) {
	try {
