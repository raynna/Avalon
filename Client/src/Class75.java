...
public class Class75 {
	...
	for (int i_2_ = 0; i_2_ < i; i_2_++) {
	    this.anIntArray705[i_2_] = class298_sub53.readUnsignedShort() - 5120;
	    this.anIntArray703[i_2_] = class298_sub53.readUnsignedShort() - 5120;
	    this.anIntArray702[i_2_] = class298_sub53.readShort(1563719109);
	    this.anIntArray704[i_2_] = class298_sub53.readUnsignedShort() - 5120;
	    this.anIntArray706[i_2_] = class298_sub53.readUnsignedShort() - 5120;
	    this.anIntArray701[i_2_] = class298_sub53.readShort(2133929202);
	    this.anIntArray707[i_2_] = class298_sub53.readShort(1967809784);
	}
    }
    ...
    static final void method835(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
	    class105.aString1228 = (String) (class403.anObjectArray5240[((class403.anInt5241 -= 969361751) * -203050393)]);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method836(Class403 class403, byte i) {
	try {
	    int i_6_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    if (Class301_Sub1.aClass437_7637 != null) {
		Class298 class298 = Class301_Sub1.aClass437_7637.method5812(i_6_);
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = class298 != null ? 1 : 0;
	    } else
    ...
    static final void method838(Class403 class403, int i) {
	try {
