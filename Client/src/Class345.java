...
public class Class345 implements Interface19 {
	...
	if (null == class298_sub50) {
	    if (-1 != this.anInt6522 * 1099340307)
		return false;
	} else {
	    if (1099340307 * this.anInt6522 != class298_sub50.method3546(-1372966703))
		return false;
	    if (this.anInt6521 * 1026337135 > class298_sub50.method3548(49279861))
		return false;
	    int[] is = this.anIntArray6523;
	...
	try {
		...
		if (1099340307 * this.anInt6522 != class298_sub50.method3546(-1372966703))
		    return false;
		if (this.anInt6521 * 1026337135 > class298_sub50.method3548(1840203341))
		    return false;
		int[] is = this.anIntArray6523;
	...
	if (null == class298_sub50) {
	    ...
	    if (1099340307 * this.anInt6522 != class298_sub50.method3546(-1372966703))
		return false;
	    if (this.anInt6521 * 1026337135 > class298_sub50.method3548(966339099))
		return false;
	    int[] is = this.anIntArray6523;
	...
	this.anInt6522 = i * 397623323;
	this.anInt6521 = 875353487 * i_7_;
	this.anIntArray6523 = is;
    }

    static final void method4166(Class403 class403, int i) {
	try {
    ...
    static final void method4167(Class403 class403, byte i) {
	try {
    ...
    static final void method4168(Class403 class403, int i) {
	try {
    ...
    static final void method4169(Class403 class403, byte i) {
	try {
