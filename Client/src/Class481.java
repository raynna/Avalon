...
public abstract class Class481 {
	...
	try {
		...
		if ((mask & 0x80000) != 0) { // Unidentified - ordinal 2
		    ...
		    npc.anInt10105 = ((client.ticketCycle * 443738891 + stream.readUnsignedShortLE128(1478539457)) * 1828453179);
		    npc.anInt10106 = ((client.ticketCycle * 443738891 + stream.readUnsignedShortLE128(1478539457)) * -473408095);
		}
		...
		if (0 != (mask & 0x4)) { // Hit ? ordinal 7
			...
			for (int i_11_ = 0; i_11_ < i_10_; i_11_++) {
			    ...
			    npc.method4420(i_15_, i_13_, i_12_, i_14_, client.ticketCycle * 443738891, i_16_, i_17_, (byte) 6);
			}
		    }
		}
		if ((mask & 0x1000) != 0) {// ordinal 8
			...
			long l = (npcIndex | (long) ((npc.anInt10182 += -230300471) * -156273287 - 1) << 32);
		...
		if ((mask & 0x400) != 0) {// ordinal 13 other bar thing
		    ...
		    npc.anInt10086 = (npc.anInt10088 * 1195117671 + (client.ticketCycle * 1208636921 + (-1132907677 * npc.anInt10087)));
		}
		...
		if ((mask & 0x800) != 0) {// Force movement ordinal 15
		    ...
		    npc.anInt10095 = (stream.readUnsignedShortLE((byte) -54) + 443738891 * client.ticketCycle) * 996079737;
		    npc.anInt10103 = (stream.readUnsignedShortLE128(1478539457) + client.ticketCycle * 443738891) * 1000906529;
		...
		if ((mask & 0x200000) != 0) {// ordinal 20
			...
			long l = (npcIndex | (long) ((npc.anInt10183 += 55499771) * -1842219213 - 1) << 32);
