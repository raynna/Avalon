...
public class Class113 {
	...
	int i = is.length;
	this.anIntArray1370 = new int[i];
	this.aByteArray1371 = is;
	int[] is_0_ = new int[33];
	this.anIntArray1372 = new int[8];
	int i_1_ = 0;
	for (int i_2_ = 0; i_2_ < i; i_2_++) {
		...
		for (int i_12_ = 0; i_12_ < i_3_; i_12_++) {
		    ...
		    if ((i_5_ & i_13_) != 0) {
			if (this.anIntArray1372[i_11_] == 0)
			    this.anIntArray1372[i_11_] = i_1_;
			i_11_ = this.anIntArray1372[i_11_];
		    } else
			i_11_++;
		    if (i_11_ >= this.anIntArray1372.length) {
			int[] is_14_ = (new int[2 * this.anIntArray1372.length]);
			for (int i_15_ = 0; i_15_ < this.anIntArray1372.length; i_15_++)
			    is_14_[i_15_] = this.anIntArray1372[i_15_];
			this.anIntArray1372 = is_14_;
		    }
		    i_13_ >>>= 1;
		}
		this.anIntArray1372[i_11_] = i_2_ ^ 0xffffffff;
		if (i_11_ >= i_1_)
		    i_1_ = 1 + i_11_;
	    }
	}
	...
	try {
		...
		byte i_22_ = is[i_21_];
		if (i_22_ < 0)
		    i_20_ = this.anIntArray1372[i_20_];
		else
		    i_20_++;
		int i_23_;
		if ((i_23_ = this.anIntArray1372[i_20_]) < 0) {
	...
	try {
		...
		int i_30_ = is[i] & 0xff;
		int i_31_ = this.anIntArray1370[i_30_];
		int i_32_ = this.aByteArray1371[i_30_];
		if (0 == i_32_)
    ...
    static final void method1248(Class403 class403, byte i) {
	try {
    ...
    static final void method1249(Class403 class403, int i) {
	try {
    ...
    static final void method1250(Class403 class403, int i) {
	try {
    ...
    static final void method1251(Class403 class403, int i) {
	try {
	    int i_41_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    if (client.aString8804 != null && i_41_ < Class489.anInt6071 * -1801543887)
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = Class82_Sub6.aClass7Array6846[i_41_].aByte97;
	    else
    ...
    static final void method1252(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub20_7578.method5700(-1397951801);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (i != GameObjectType.T9.type * -1976050083)
		return (byte) 0;
	    if ((i_42_ & 0x1) == 0)
		return (byte) 1;
	    return (byte) 2;
    ...
    public static final Interface method1254(int parentHash, Interface class298_sub51, int[] is, boolean bool) {
	try {
	    Interface class298_sub51_45_ = (Interface) client.aClass437_8841.method5812(parentHash);
	    ...
	    client.aClass437_8841.method5817(class298_sub51, parentHash);
	    ...
	    if (null != class105)
		Class65.method761((Class389.aClass119Array4165[class105.ihash * -440872681 >>> 16]), class105, !bool, 112223880);
	    if (!bool)
