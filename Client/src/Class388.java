...
public final class Class388 {
    ...
    static final void method4853(Class403 class403, byte i) {
	try {
	    int i_0_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.anIntArray8828[i_0_];
	}
    ...
    static final void method4854(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
	    class105.aBoolean1211 = (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) == 1;
	    Tradution.method6054(class105, 37472514);
	    if (-1 == -1309843523 * class105.anInt1154 && !class119.aBoolean1403)
		Class508.method6281(-440872681 * class105.ihash, 473698218);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4855(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub19_7567.method5696(1452563063) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
