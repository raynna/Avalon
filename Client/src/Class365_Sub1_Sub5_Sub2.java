...
public class Class365_Sub1_Sub5_Sub2 extends Class365_Sub1_Sub5 implements Interface3 {
	...
	Class335 class335 = Class73.method818(this.aBoolean9936, 1239765065);
	...
	if (null != aClass60_9935.aClass351_602) {
	    Class69 class69 = aClass60_9935.aClass351_602.method4229();
	    class_ra.method5042(class69);
	}
	this.aBoolean9939 = class387.i() || null != aClass60_9935.aClass351_602;
	if (null == this.aClass334_9934)
	    this.aClass334_9934 = Class472.method6063((int) class235.aClass217_2599.aFloat2451, (int) class235.aClass217_2599.aFloat2455, (int) class235.aClass217_2599.aFloat2454, class387, 2146599220);
	else
	    Class264_Sub2.method2507((this.aClass334_9934), (int) class235.aClass217_2599.aFloat2451, (int) class235.aClass217_2599.aFloat2455, (int) class235.aClass217_2599.aFloat2454, class387, (byte) 1);
	return class335;
    }
	...
	try {
	    ...
	    Class222 class222 = method4347();
	    Class235 class235 = method4337();
	    Class335 class335 = Class73.method818((this.aBoolean9936), 1511204499);
	    ...
	    this.aBoolean9939 = (class387.i() || null != aClass60_9935.aClass351_602);
	    if (null == this.aClass334_9934)
		this.aClass334_9934 = Class472.method6063((int) (class235.aClass217_2599.aFloat2451), (int) (class235.aClass217_2599.aFloat2455), (int) (class235.aClass217_2599.aFloat2454), class387, 1999876467);
	    else
		Class264_Sub2.method2507(this.aClass334_9934, (int) class235.aClass217_2599.aFloat2451, (int) class235.aClass217_2599.aFloat2455, (int) class235.aClass217_2599.aFloat2454, class387, (byte) 127);
	    return class335;
	}
	catch (RuntimeException runtimeexception) {
    ...
    @Override
    public int method45() {
	return aClass60_9935.anInt601 * 1686561661;
    }
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub5_7572.method5641(-1981564122) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    int i_29_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    boolean bool = ((class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]) == 1);
	    if (Class301_Sub1.aClass437_7636 != null) {
		Class298 class298 = Class301_Sub1.aClass437_7636.method5812(i_29_);
		if (class298 != null && !bool)
		    class298.method2839(-1460969981);
		else if (class298 == null && bool) {
		    class298 = new Class298();
		    Class301_Sub1.aClass437_7636.method5817(class298, i_29_);
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		// if (0 == (Class10.slotFlags[i_32_] & 0x1)) {
		if (i_30_ > 0) {
		    i_30_--;
		    // Class10.slotFlags[i_32_] |= 0x2;
		} else {
	    ...
	    /*
	     * class298_sub53_sub2.initBitAccess(1796731201); for (int i_34_ =
	     * 0; i_34_ < Class10.anInt129 * 1168366243; i_34_++) { int i_35_ =
	     * Class10.anIntArray135[i_34_]; if (0 != (Class10.slotFlags[i_35_]
	     * & 0x1)) { if (i_30_ > 0) { i_30_--; Class10.slotFlags[i_35_] |=
	     * 0x2; } else { int i_36_ = class298_sub53_sub2.readBits(1); if
	     * (i_36_ == 0) { i_30_ = Class127_Sub3.method1431(
	     * class298_sub53_sub2, 2076159127); Class10.slotFlags[i_35_] |=
	     * 0x2; } else Class500.method6221(class298_sub53_sub2, i_35_,
	     * -1556347349); } } } class298_sub53_sub2.finishBitAccess((byte)
	     * 23); if (0 != i_30_) throw new RuntimeException();
	     */
		...
		throw new RuntimeException();
	    /*
	     * class298_sub53_sub2.initBitAccess(526089082); for (int i_40_ = 0;
	     * i_40_ < Class10.anInt130 * 1430471535; i_40_++) { int i_41_ =
	     * Class10.anIntArray134[i_40_]; if ((Class10.slotFlags[i_41_] &
	     * 0x1) == 0) { if (i_30_ > 0) { i_30_--; Class10.slotFlags[i_41_]
	     * |= 0x2; } else { int i_42_ = class298_sub53_sub2.readBits(1); if
	     * (i_42_ == 0) { i_30_ = Class127_Sub3.method1431(
	     * class298_sub53_sub2, 2129494225); Class10.slotFlags[i_41_] |=
	     * 0x2; } else if (Class501.method6229(class298_sub53_sub2, i_41_,
	     * -1080126826)) Class10.slotFlags[i_41_] |= 0x2; } } }
	     * class298_sub53_sub2.finishBitAccess((byte) 49); if (i_30_ != 0)
	     * throw new RuntimeException();
	     */
	    Class10.anInt129 = 0;
	    Class10.anInt130 = 0;
