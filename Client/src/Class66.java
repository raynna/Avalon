...
public abstract class Class66 {
    ...
    static final void method765(Class403 class403, int i) {
	try {
    ...
    static final void method766(Class403 class403, byte i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class105.aBoolean1161 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method768(Class403 class403, int i) {
	try {
	    IComponentDefinition.method1135((class403.aClass365_Sub1_Sub1_Sub2_5242), class403, -908974507);
	}
	catch (RuntimeException runtimeexception) {
