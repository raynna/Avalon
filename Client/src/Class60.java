...
public class Class60 {
	...
	try {
	    ...
	    if (!this.aBoolean592 && (-72440277 * this.anInt595 != class432.anInt5365 * 1181652947)) {
		method704(true, -1, 0, 2114520079);
		this.aBoolean600 = false;
		this.aClass387_584 = null;
	    }
	    method703(this.aClass365_Sub1_587, 1121645041);
	    if (bool_1_)
		bool_1_ = bool_1_ & (this.aBoolean598 & !this.aBoolean600 & Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub7_7581.method5650(-896655100) != 0);
	    if (bool && !bool_1_) {
		this.anInt595 = -722933511 * class432.anInt5365;
		return null;
	    }
	    Class217 class217 = (this.aClass365_Sub1_587.method4337().aClass217_2599);
	    Class331 class331 = client.aClass283_8716.method2675(-1611682495);
	    if (bool_1_) {
		class331.method4047(this.aClass_na599, this.aByte588, (int) class217.aFloat2451, (int) class217.aFloat2454, this.aBooleanArray596, 528677416);
		this.aBoolean600 = false;
	    }
	    Class_xa class_xa = class331.aClass_xaArray3517[this.aByte588];
	    ...
	    if (this.aClass438_593.method5819((byte) -82)) {
		if (bool_1_)
		    i |= 0x40000;
		class387 = (class432.method5774(class_ra, i, (11 != this.anInt589 * -1598457753 ? -1598457753 * this.anInt589 : 10), (11 == -1598457753 * this.anInt589 ? 4 + this.anInt590 * 748228569 : 748228569 * this.anInt590), class_xa, class_xa_3_, (int) class217.aFloat2451, class_xa.method6340((int) class217.aFloat2451, (int) class217.aFloat2454, -1408801129), (int) class217.aFloat2454, this.aClass438_593, this.aClass435_597, (byte) 18));
		if (null != class387) {
		    if (bool_1_) {
			if (null == this.aBooleanArray596)
			    this.aBooleanArray596 = new boolean[4];
			this.aClass_na599 = class387.ga(this.aClass_na599);
			class331.method4055(this.aClass_na599, this.aByte588, (int) class217.aFloat2451, (int) class217.aFloat2454, this.aBooleanArray596, -1719073428);
		...
		this.aClass387_584 = null;
	    } else if (this.aClass387_584 == null || (this.aClass387_584.m() & i) != i || (-72440277 * this.anInt595 != 1181652947 * class432.anInt5365)) {
		if (this.aClass387_584 != null)
		    i |= this.aClass387_584.m();
		Class454 class454 = (class432.method5785(class_ra, i, (this.anInt589 * -1598457753 != 11 ? -1598457753 * this.anInt589 : 10), (11 == this.anInt589 * -1598457753 ? 748228569 * this.anInt590 + 4 : 748228569 * this.anInt590), class_xa, class_xa_3_, (int) class217.aFloat2451, class_xa.method6340((int) class217.aFloat2451, (int) class217.aFloat2454, -1367024792), (int) class217.aFloat2454, bool_1_, this.aClass435_597, -105046202));
		if (class454 != null) {
		    this.aClass387_584 = class387 = (Class387) class454.anObject5645;
		    if (bool_1_) {
			this.aClass_na599 = (Class_na) class454.anObject5646;
			this.aBooleanArray596 = null;
			class331.method4055(this.aClass_na599, this.aByte588, (int) class217.aFloat2451, (int) class217.aFloat2454, null, -1920595487);
			this.aBoolean600 = true;
		    }
		    this.anInt586 = class387.YA() * -1931353415;
		    class387.n();
		...
		class387 = this.aClass387_584;
	    this.anInt595 = class432.anInt5365 * -722933511;
	    return class387;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (null != this.aClass351_602) {
		class387.method4786(class222);
		if (bool)
		    this.aClass351_602.method4231(class_ra, client.ticketCycle * 443738891, class85s, class68s, false);
		else
		    this.aClass351_602.method4233(443738891 * client.ticketCycle);
		this.aClass351_602.method4227((this.aByte603), i, i_4_, i_5_, i_6_);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    this.anInt594 = -803072405 * client.ticketCycle;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (class432.method5779(934270378)) {
		    if (bool && this.aClass438_593.method5819((byte) -5) && class432.method5773(this.aClass438_593.method5823(2076230166), 1402053046))
			return;
		    if (1181652947 * class432.anInt5365 != -72440277 * this.anInt595)
		    ...
		    if (bool && this.aClass438_593.method5819((byte) -12) && class432_16_.method5773(this.aClass438_593.method5823(1572334487), 1867786247))
			return;
		    if (this.anInt595 * -72440277 != 1181652947 * class432.anInt5365)
	    ...
	    if (i_14_ == -1)
		this.aClass438_593.method5843(-1, false, 79187064);
	    else {
		this.aClass438_593.method5824(i_14_, 0, i_12_, bool_15_, (byte) 0);
		this.anInt594 = client.ticketCycle * -803072405;
		this.aBoolean600 = false;
		this.aClass387_584 = null;
	    }
	}
	...
	try {
		...
		Class217 class217 = (this.aClass365_Sub1_587.method4337().aClass217_2599);
		client.aClass283_8716.method2675(-1611682495).method4047(this.aClass_na599, this.aByte588, (int) class217.aFloat2451, (int) class217.aFloat2454, this.aBooleanArray596, 677085165);
		this.aBooleanArray596 = null;
		this.aClass_na599 = null;
	    }
	}
	...
	try {
	    ...
	    int i_17_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    int i_18_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]);
	    if (i_18_ == -1)
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = -1;
	    else
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = GraphicsToolkit.aClass256_5315.method2441(i_17_, 2082342727).method3431((char) i_18_, 166344309);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class403 class403 = HandshakePacket.method1950(407967339);
	    class403.anInterface3_5233 = interface3;
	    SubIncommingPacket.method1925(class502, i, i_19_, class403, 536465062);
	    class403.anInterface3_5233 = null;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ck.u(").append(')').toString());
	}
	...
	try {
	    int i_21_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_21_).anInt5720) * 1764050979;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = -1801543887 * Class489.anInt6071;
	    else
    ...
    static final void method714(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
	    class403.anInt5239 -= -1175642067;
	    int i_22_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    short i_23_ = (short) (class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]);
	    short i_24_ = (short) (class403.anIntArray5244[class403.anInt5239 * 681479919 + 2]);
	    if (i_22_ >= 0 && i_22_ < 5) {
		...
		if (class105.anInt1154 * -1309843523 == -1 && !class119.aBoolean1403)
		    Class440.method5862(class105.ihash * -440872681, i_22_, 227307662);
	    }
	}
	catch (RuntimeException runtimeexception) {
