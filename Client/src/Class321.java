...
public class Class321 {
	...
	try {
	    int i_10_;
	    if (!bool) {
		int i_11_ = ((this.anInt3354 * 240739725 + i * (-195574461 * this.anInt3353) / 50) & 0x7ff);
		...
		i_10_ = 2048;
	    aClass298_Sub10_3337.method2896((((-1796735565 * this.anInt3352 * i_10_ >> 11) + this.anInt3327 * -884690819) / 2048.0F), (byte) 3);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method3919(Class403 class403, int i) {
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = (-1071570519 * Class82_Sub6.aClass7Array6846[i_24_].anInt95);
	    else
    ...
    static final void method3920(Class403 class403, int i) {
	try {
    ...
    static final void method3921(Class403 class403, int i) {
	try {
	    class403.anInt5241 -= 1938723502;
	    String string = (String) (class403.anObjectArray5240[-203050393 * class403.anInt5241]);
	    String string_25_ = ((String) (class403.anObjectArray5240[-203050393 * class403.anInt5241 + 1]));
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = new StringBuilder().append(string).append(string_25_).toString();
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method3922(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_26_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    int i_27_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class77.method841(i_26_, i_27_, (byte) -125) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method3924(Class403 class403, int i) {
	try {
    ...
    static final void method3925(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
	    class403.anInt5239 -= -783761378;
	    class105.anInt1241 = (class403.anIntArray5244[681479919 * class403.anInt5239]) * 381202251;
	    class105.anInt1252 = (-283274507 * (class403.anIntArray5244[1 + class403.anInt5239 * 681479919]));
	...
	try {
	    if (i_36_ >= Class372.anInt4049 * 1155384281 && i_36_ <= Class372.anInt4050 * -1062447355) {
		i = Class463.method6012(i, -1424479739 * Class372.anInt4051, 1135094847 * Class372.anInt4048, -1212608691);
		i_35_ = Class463.method6012(i_35_, (Class372.anInt4051 * -1424479739), Class372.anInt4048 * 1135094847, -1212608691);
