...
public class Class298_Sub4 extends Class298 {
    ...
    int[] method2854() {
	return this.anIntArray7191;
    }

    Class298_Sub4(int i, int i_0_, int[] is, boolean bool) {
	this.anInt7190 = i;
	this.anInt7192 = i_0_;
	this.anIntArray7191 = is;
	if (bool) {
	    int[] is_1_ = new int[this.anInt7192];
	    int[] is_2_ = new int[this.anInt7192];
	    int[] is_3_ = new int[this.anInt7192];
	    int[] is_4_ = new int[this.anInt7192];
	    if (anIntArray7187 == null || (anIntArray7187.length != this.anIntArray7191.length))
		anIntArray7187 = new int[this.anIntArray7191.length];
	    int i_5_ = this.anInt7192;
	    int i_6_ = this.anInt7192;
	    int i_7_ = i_5_ - 1;
	    int i_8_ = i_6_ - 1;
	    int i_9_ = i_5_ * i_6_;
	    int i_11_;
		...
		for (int i_13_ = i_7_; i_13_ >= 0; i_13_--) {
		    int i_14_ = this.anIntArray7191[--i_11_];
		...
		for (int i_29_ = i_7_; i_29_ >= 0; i_29_--) {
		    int i_30_ = this.anIntArray7191[--i_11_];
		    int i_31_ = this.anIntArray7191[--i_10_];
	    ...
	    int[] is_32_ = this.anIntArray7191;
	    this.anIntArray7191 = anIntArray7187;
	...
	if (i != 0 || i_33_ != 0) {
	    if (anIntArray7187 == null || (anIntArray7187.length != this.anIntArray7191.length))
		anIntArray7187 = new int[this.anIntArray7191.length];
	    int i_34_ = this.anIntArray7191.length;
	    int i_35_ = i;
	    int i_36_ = this.anInt7192 - 1;
	    int i_37_ = this.anInt7192 * i_33_;
	    int i_38_ = i_34_ - 1;
	    for (int i_39_ = 0; i_39_ < i_34_; i_39_ += this.anInt7192) {
		int i_40_ = i_39_ + i_37_ & i_38_;
		for (int i_41_ = 0; i_41_ < this.anInt7192; i_41_++) {
		    int i_42_ = i_39_ + i_41_;
		    int i_43_ = i_40_ + (i_41_ + i_35_ & i_36_);
		    anIntArray7187[i_42_] = this.anIntArray7191[i_43_];
		}
	    }
	    int[] is = this.anIntArray7191;
	    this.anIntArray7191 = anIntArray7187;
	    anIntArray7187 = is;
	}
    }
