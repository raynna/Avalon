...
public class Class_ta_Sub2 extends Class_ta {
	...
	this.anIntArray8443 = is;
	this.anIntArray8442 = is_1_;
    }

    static void method6000(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[class403.anInt5239 * 681479919 - 1] = (Class316.aClass362_3318.method4307((class403.anIntArray5244[681479919 * class403.anInt5239 - 1]), 245040087).anInt4012) * 126451825;
	}
    ...
    static final void method6002(Class403 class403, int i) {
	try {
    ...
    static void method6004(Class403 class403, int i) {
	try {
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = (Class316.aClass362_3318.method4307((class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]), 245040087).aString4008);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method6005(Class403 class403, int i) {
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = Class82_Sub6.aClass7Array6846[i_4_].aString93;
	    else
