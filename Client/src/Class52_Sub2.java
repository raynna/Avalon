...
public abstract class Class52_Sub2 extends Class52 {
    ...
    static final void method588(Class403 class403, short i) {
	try {
	...
	try {
	    ...
	    try {
		class476 = Class86.method962("2", client.gametype.aString5317, true, -1804643872);
    ...
    static final void method590(Class403 class403, int i) {
	try {
