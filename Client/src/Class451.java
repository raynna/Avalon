...
public class Class451 {
	...
	try {
	    Class443 class443;
	    synchronized (this.aClass348_5640) {
		class443 = (Class443) this.aClass348_5640.method4184(i);
	    }
	    if (class443 != null)
		return class443;
	    byte[] is;
	    synchronized (this.idx2) {
		is = (this.idx2.getFile(-1006924897 * Class120.aClass120_1428.anInt1460, i));
	    }
	...
	this.idx2 = class243;
	this.idx2.method2316((-1006924897 * (Class120.aClass120_1428.anInt1460)), -978414795);
    }

    static final void method5933(Class403 class403, int i) {
	try {
