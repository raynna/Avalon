...
public class a implements Interface25 {
	...
	if (i > 0 && i <= 7) {
	    ...
	    var_h_17_ = var_h_18_ = new h(this.aJa6670);
	var_h.BA(var_h_17_, var_h_18_, i_15_, bool_16_, bool);
	var_h_17_.aClass85Array6677 = var_h.aClass85Array6677;
	var_h_17_.aClass68Array6676 = var_h.aClass68Array6676;
	return var_h_17_;
    }
	...
	this.aClass233_6673.method2145(class222);
	wa(this.nativeid, ((h) class387).nativeid, this.aClass233_6673.aFloatArray2594, is, i);
    }
	...
	this.aClass233_6673.method2145(class222);
	J(this.nativeid, ((h) class387).nativeid, is, this.aClass233_6673.aFloatArray2594);
    }
	...
	for (int i_79_ = 0; i_79_ < 7; i_79_++) {
	    this.aHArray6671[i_79_] = new h(this.aJa6670);
	    this.aHArray6672[i_79_] = new h(this.aJa6670);
	}
	this.aClass233_6673 = new Class233();
	ha(this.nativeid, var_ja, i, i_78_);
    }
	...
	this.aClass233_6673.method2145(class222);
	return ya(this.nativeid, ((h) class387).nativeid, i, i_88_, this.aClass233_6673.aFloatArray2594, bool);
    }
