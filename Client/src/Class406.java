...
public final class Class406 {
    ...
    static final void method4960(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    long l = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    long l_0_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (int) (l + l * l_0_ / 100L);
	}
    ...
    static final void method4961(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_1_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    int i_2_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]);
	    if (null == Class389.aClass119Array4165[i_1_])
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = 0;
	    else
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = (Class389.aClass119Array4165[i_1_].aClass105Array1405[i_2_].anInt1141) * -914988669;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		client.anInt8772 = (client.aClass437_8696.method5814(1946710966) * -118843751);
		int i_7_ = 0;
