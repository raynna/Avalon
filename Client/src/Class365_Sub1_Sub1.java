...
public abstract class Class365_Sub1_Sub1 extends Class365_Sub1 {
	...
	plane = (byte) i;
	aByte7724 = (byte) i_0_;
	method4340(new Class217(i_1_, i_2_, i_3_));
	...
	while_50_: for (int i_28_ = aShort9798; i_28_ <= aShort9796; i_28_++) {
		...
		long l = (aClass331_7722.aLongArrayArrayArray3554[plane][i_28_][i_29_]);
		long l_30_ = 0L;
		while_49_: while (l_30_ <= 48L) {
		    int i_31_ = (int) (l >>> (int) l_30_ & 0xffffL);
		    if (i_31_ <= 0)
			break;
		    Class321 class321 = (aClass331_7722.aClass321Array3558[i_31_ - 1]);
	...
	if (this.aByte9800 != 0) {
	    int i_34_ = (aShort9798 - -804213305 * aClass331_7722.anInt3553);
	    int i_35_ = (aShort9795 - aClass331_7722.anInt3513 * 465603579);
	    short i_36_;
	    int i_37_;
	    int i_38_;
	    short i_39_;
		...
		long l = (aClass331_7722.aLongArrayArrayArray3554[plane][i_36_][i_37_]);
		while_51_: do {
		    Class321 class321;
		    do {
			if (0L == l)
		...
		while (false);
		l = (aClass331_7722.aLongArrayArrayArray3554[plane][i_38_][i_39_]);
		while_52_: do {
		    Class321 class321;
		    do {
			if (0L == l)
	...
	for (int i = aShort9798; i <= aShort9796; i++) {
		...
		int i_43_ = (aClass331_7722.anInt3538 * 583010427 + (i - (aClass331_7722.anInt3553 * -804213305)));
		if (i_43_ >= 0 && i_43_ < (aClass331_7722.aBooleanArrayArray3563).length) {
		    int i_44_ = (i_42_ - 465603579 * aClass331_7722.anInt3513 + (aClass331_7722.anInt3538 * 583010427));
		    if (i_44_ >= 0 && i_44_ < (aClass331_7722.aBooleanArrayArray3563).length && (aClass331_7722.aBooleanArrayArray3563[i_43_][i_44_]))
			return true;
		}
	    }
	}
	...
	for (int i = aShort9798; i <= aShort9796; i++) {
		...
		int i_46_ = (aClass331_7722.anInt3538 * 583010427 + (i - (aClass331_7722.anInt3553 * -804213305)));
		if (i_46_ >= 0 && i_46_ < (aClass331_7722.aBooleanArrayArray3563).length) {
		    int i_47_ = (i_45_ - 465603579 * aClass331_7722.anInt3513 + (aClass331_7722.anInt3538 * 583010427));
		    if (i_47_ >= 0 && i_47_ < (aClass331_7722.aBooleanArrayArray3563).length && (aClass331_7722.aBooleanArrayArray3563[i_46_][i_47_]))
			return true;
		}
	    }
	}
	...
	for (int i = aShort9798; i <= aShort9796; i++) {
		...
		int i_49_ = (aClass331_7722.anInt3538 * 583010427 + (i - (aClass331_7722.anInt3553 * -804213305)));
		if (i_49_ >= 0 && i_49_ < (aClass331_7722.aBooleanArrayArray3563).length) {
		    int i_50_ = (i_48_ - 465603579 * aClass331_7722.anInt3513 + (aClass331_7722.anInt3538 * 583010427));
		    if (i_50_ >= 0 && i_50_ < (aClass331_7722.aBooleanArrayArray3563).length && (aClass331_7722.aBooleanArrayArray3563[i_49_][i_50_]))
			return true;
		}
	    }
	}
