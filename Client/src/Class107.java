...
public class Class107 {
    ...
    static final void method1138(Class403 class403, int i) {
	try {
	    ...
	    Interface class298_sub51 = ((Interface) client.aClass437_8841.method5812(i_0_));
    ...
    static final void method1139(Class403 class403, int i) {
	try {
	    class403.anInt5241 -= 1938723502;
	    String string = (String) (class403.anObjectArray5240[-203050393 * class403.anInt5241]);
	    String string_2_ = ((String) (class403.anObjectArray5240[1 + -203050393 * class403.anInt5241]));
	    class403.anInt5239 -= -783761378;
	    int i_3_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    ...
	    class298_sub36.out.writeByte((Class58.method693(string, 824741758) + 2 + Class58.method693(string_2_, 1825350693)));
	    class298_sub36.out.writeString(string, 2106957480);
	    class298_sub36.out.writeByte(i_3_ - 1);
	    class298_sub36.out.writeByte(i_4_);
	    class298_sub36.out.writeString(string_2_, 2102628417);
    ...
    static final void method1140(Class403 class403, int i) {
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub25_7569, (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]), -2044130238);
    ...
    static final void method1141(Class403 class403, short i) {
	try {
    ...
    static final void method1142(Class403 class403, int i) {
	try {
    ...
    static final void method1143(Class403 class403, int i) {
	try {
	    int i_6_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class403.aClass162_5252.membersRanks[i_6_];
	}
	catch (RuntimeException runtimeexception) {
