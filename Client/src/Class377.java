...
public class Class377 {
    ...
    static final void method4662(Class403 class403, int i) {
	try {
    ...
    static final void method4663(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub10_7548.method5660(-575221319) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4665(IComponentDefinition class105, Class119 class119, Class403 class403, short i) {
	try {
	    class105.aBoolean1182 = (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) == 1;
    ...
    static final void method4666(Class403 class403, byte i) {
	try {
    ...
    static final void method4667(Class403 class403, int i) {
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = client.aBooleanArray8722[i_5_] ? 1 : 0;
	    else
    ...
    static final void method4668(Class403 class403, byte i) {
	try {
	    int i_6_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = class403.aClass162_5252.bannedMembersDisplayNames[i_6_];
	}
	catch (RuntimeException runtimeexception) {
