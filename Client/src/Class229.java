...
public class Class229 implements Interface12 {
	...
	return i * 100 / this.anInterface6Array6453.length;
    }
	...
	try {
	    return (Class122.method1319((byte) 1) >= l + this.anInt6454 * -568263897);
	}
	catch (RuntimeException runtimeexception) {
	...
	for (int i = 0; i < interface6s.length; i++) {
	    ...
	    if (interface6 != null)
		interface6.method58(bool || this.aBoolean6450, (byte) -53);
	}
	this.aBoolean6450 = false;
    }
	...
	for (int i = 0; i < interface6s.length; i++) {
	    Interface6 interface6 = interface6s[i];
	    if (interface6 != null)
		interface6.method58(bool || this.aBoolean6450, (byte) -27);
	}
	this.aBoolean6450 = false;
    }
	...
	try {
	    if (3.0 == Class301.aFloat3234)
		return 37;
	    if (4.0 == Class301.aFloat3234)
		return 50;
	    if (6.0 == Class301.aFloat3234)
		return 75;
	    if (8.0 == Class301.aFloat3234)
		return 100;
	    return 200;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (null != Class231.aFrame2589) {
			...
			if (Class298_Sub36.aFrame7403 == container) {
			    ...
			    Class291.anInt6472 -= (insets.bottom + insets.top) * -2115832951;
			}
			...
			if (Class190.method1859((byte) -55) != 1)
			    ...
			    Class291.anInt6473 = ((-639974669 * Class78.anInt733 - 775068819 * client.anInt8794) / 2 * -753018213);
			...
			if (container == Class298_Sub36.aFrame7403) {
			    ...
			    Class52_Sub2_Sub1.aCanvas9079.setLocation(Class291.anInt6473 * 1898544019, Class291.anInt6474 * 540368727);
