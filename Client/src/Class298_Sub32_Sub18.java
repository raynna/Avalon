...
public class Class298_Sub32_Sub18 extends Class298_Sub32 {
	...
	switch (i) {
	    case 3:
		this.anInt9442 = class298_sub53.readUnsignedByte() * -190415455;
		break;
	    case 0:
		this.anInt9434 = class298_sub53.readUnsignedByte() * 56159889;
		break;
	    case 1:
		this.anInt9441 = class298_sub53.readUnsignedByte() * -518479681;
		break;
	}
    }
	...
	if (aClass257_7384.aBoolean2810) {
		...
		int i_6_;
		if (716214897 * this.anInt9434 == 0)
		    i_6_ = ((i_4_ - i_1_) * (1525982817 * this.anInt9442));
		else {
		    int i_7_ = i_2_ * i_2_ + i_5_ * i_5_ >> 12;
		    i_6_ = (int) (Math.sqrt(i_7_ / 4096.0F) * 4096.0);
		    i_6_ = (int) (i_6_ * ((this.anInt9442) * 1525982817) * 3.141592653589793);
		}
		i_6_ -= i_6_ & ~0xfff;
		if (0 == this.anInt9441 * 1988808511)
		    i_6_ = (Class250.anIntArray2761[i_6_ >> 4 & 0xff] + 4096 >> 1);
		else if (this.anInt9441 * 1988808511 == 2) {
		    i_6_ -= 2048;
		    if (i_6_ < 0)
			i_6_ = -i_6_;
		    i_6_ = 2048 - i_6_ << 1;
	...
	try {
		...
		for (int i_11_ = 0; i_11_ < Class250.anInt2755 * -1474554145; i_11_++) {
		    ...
		    int i_14_;
		    if (716214897 * this.anInt9434 == 0)
			i_14_ = ((i_12_ - i_9_) * (1525982817 * this.anInt9442));
		    else {
			int i_15_ = i_10_ * i_10_ + i_13_ * i_13_ >> 12;
			i_14_ = (int) (Math.sqrt(i_15_ / 4096.0F) * 4096.0);
			i_14_ = (int) (i_14_ * (this.anInt9442 * 1525982817) * 3.141592653589793);
		    }
		    i_14_ -= i_14_ & ~0xfff;
		    if (0 == (this.anInt9441 * 1988808511))
	...
	if (aClass257_7384.aBoolean2810) {
		...
		int i_21_;
		if (716214897 * this.anInt9434 == 0)
		    i_21_ = ((i_19_ - i_16_) * (1525982817 * this.anInt9442));
		else {
		    int i_22_ = i_17_ * i_17_ + i_20_ * i_20_ >> 12;
		    i_21_ = (int) (Math.sqrt(i_22_ / 4096.0F) * 4096.0);
		    i_21_ = (int) (i_21_ * ((this.anInt9442) * 1525982817) * 3.141592653589793);
		}
		i_21_ -= i_21_ & ~0xfff;
		if (0 == this.anInt9441 * 1988808511)
