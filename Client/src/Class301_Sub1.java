...
public class Class301_Sub1 extends Class301 {
    ...
    static final void method3712(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
		...
		Class422.method5623(class105.ihash * -440872681, 1575385059);
	}
	...
	try {
		...
		if (client.method2801(class105).method3498(i - 1, (byte) -25)) {
		    ...
		    if (-1233866115 * client.anInt8752 == 14 || 0 == client.anInt8752 * -1233866115) {
			if (i >= 1 && i <= 10) {
			    //System.out.println("Client blocked click: " + (i_0_ >> 16) + "," + (i_0_ & 0xFFFF) + "," + i_1_ + "," + (class105.anInt1280 * -1232467723));
			}
		    }
		}
	    }
