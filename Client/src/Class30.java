...
public abstract class Class30 {
	...
	this.aClass_ra_Sub2_381 = class_ra_sub2;
	this.anInt372 = i;
	this.aClass55_377 = class55;
	this.aClass77_378 = class77;
	this.aBoolean379 = bool;
	this.anInt380 = i_0_;
	OpenGL.glGenTextures(1, anIntArray382, 0);
	this.anInt376 = anIntArray382[0];
	method409(0);
    }
	...
	if (this.aBoolean368) {
	    OpenGL.glTexParameteri(this.anInt372, 10241, this.aBoolean379 ? 9987 : 9729);
	    OpenGL.glTexParameteri(this.anInt372, 10240, 9729);
	} else {
	    OpenGL.glTexParameteri(this.anInt372, 10241, this.aBoolean379 ? 9984 : 9728);
	    OpenGL.glTexParameteri(this.anInt372, 10240, 9728);
	}
    }

    void method408() {
	if (this.anInt376 > 0) {
	    this.aClass_ra_Sub2_381.anInt8175 -= method416();
	    int[] is = new int[1];
	    is[0] = this.anInt376;
	...
	this.aClass_ra_Sub2_381.anInt8175 -= i;
	this.aClass_ra_Sub2_381.anInt8175 += method416();
    }

    void method410(boolean bool) {
	if (this.aBoolean368 != bool) {
	    this.aBoolean368 = bool;
	    method407();
	}
    }

    static void method411(int i, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, int[] is) {
	if (i_2_ > 0 && !AccountCreationStage.method6152(i_2_, 1883323827))
	    throw new IllegalArgumentException("");
	if (i_3_ > 0 && !AccountCreationStage.method6152(i_3_, 1954585128))
	    throw new IllegalArgumentException("");
	if (i_4_ != 32993)
	    throw new IllegalArgumentException("");
	int i_6_ = 0;
	...
	if (i_27_ > 0 && !AccountCreationStage.method6152(i_27_, 2122015724))
	    throw new IllegalArgumentException("");
	if (i_28_ > 0 && !AccountCreationStage.method6152(i_28_, 2088094849))
	    throw new IllegalArgumentException("");
    ...
    boolean method413() {
	if (this.aClass_ra_Sub2_381.framebuffer_obj) {
	    int i = method416();
	    this.aClass_ra_Sub2_381.method5256(this);
	    OpenGL.glGenerateMipmapEXT(this.anInt372);
	...
	if (i_46_ > 0 && !AccountCreationStage.method6152(i_46_, 2081148754))
	    throw new IllegalArgumentException("");
	if (i_47_ > 0 && !AccountCreationStage.method6152(i_47_, 2048879832))
	    throw new IllegalArgumentException("");
    ...
    int method416() {
	int i = (this.aClass55_377.anInt556 * 845115459 * (this.aClass77_378.anInt724 * 685647847) * this.anInt380);
	return this.aBoolean379 ? i * 4 / 3 : i;
    }

    void method417() {
	if (this.anInt376 > 0) {
	    this.aClass_ra_Sub2_381.method5229(this.anInt376, method416());
	    this.anInt376 = 0;
	}
    }
}
