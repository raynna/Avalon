...
public class Class292 {
	...
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_1_).anInt5772) * 1625363587;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (client.qa_op && (client.method2801(class105).anInt7416 * -1266165749 != 0 || 0 == class105.type * -1215239439)) {
	...
	try {
		...
		if (!class298_sub49.aBoolean7594)
		    Class285.method2710((class298_sub49.anInt7589) * 1566028323, (byte) 49);
		else
