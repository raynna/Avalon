...
public class Class213_Sub2_Sub1 extends Class213_Sub2 {
	...
	int i_6_ = i * 2;
	int i_7_ = i_5_ & 0xff;
	this.aByteArray9168[i_6_++] = (byte) -1;
	this.aByteArray9168[i_6_] = (byte) (3 * i_7_ >> 5);
    }

    void method1979(int i, byte i_8_) {
	int i_9_ = i * 2;
	int i_10_ = i_8_ & 0xff;
	this.aByteArray9168[i_9_++] = (byte) -1;
	this.aByteArray9168[i_9_] = (byte) (3 * i_10_ >> 5);
    }

    void method1980(int i, byte i_11_) {
	int i_12_ = i * 2;
	int i_13_ = i_11_ & 0xff;
	this.aByteArray9168[i_12_++] = (byte) -1;
	this.aByteArray9168[i_12_] = (byte) (3 * i_13_ >> 5);
    }
