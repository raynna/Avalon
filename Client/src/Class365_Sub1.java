...
public abstract class Class365_Sub1 extends Class365 {
	...
	try {
	    long l = (aClass331_7722.aLongArrayArrayArray3554[plane][i][i_17_]);
	    long l_19_ = 0L;
	    int i_20_ = 0;
		...
		if (i_21_ <= 0)
		    break;
		class298_sub10s[i_20_++] = (aClass331_7722.aClass321Array3558[i_21_ - 1].aClass298_Sub10_3337);
	    }
    ...
    static final void method4401(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
	    int i_23_ = ((class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) - 1);
	    if (i_23_ < 0 || i_23_ > 9)
		class403.anInt5241 -= 969361751;
	    else
		class105.method1115(i_23_, (String) (class403.anObjectArray5240[(class403.anInt5241 -= 969361751) * -203050393]), 1110385787);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4402(Class403 class403, byte i) {
	try {
