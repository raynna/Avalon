...
public class Class422_Sub13 extends Class422 {
	...
	try {
	    ...
	    if (i_2_ >= 1155384281 * Class372.anInt4049 && i_2_ <= Class372.anInt4050 * -1062447355) {
		int[] is = Class372.anIntArrayArray4047[i_2_];
		int i_40_ = Class463.method6012(i - i_3_, (Class372.anInt4051 * -1424479739), (Class372.anInt4048 * 1135094847), -1212608691);
		int i_41_ = Class463.method6012(i + i_3_, (-1424479739 * Class372.anInt4051), (Class372.anInt4048 * 1135094847), -1212608691);
		int i_42_ = Class463.method6012(i - i_12_, (Class372.anInt4051 * -1424479739), (1135094847 * Class372.anInt4048), -1212608691);
		int i_43_ = Class463.method6012(i_12_ + i, (Class372.anInt4051 * -1424479739), (Class372.anInt4048 * 1135094847), -1212608691);
		...
		if (i_45_ >= Class372.anInt4049 * 1155384281 && i_44_ <= -1062447355 * Class372.anInt4050) {
		    int i_46_ = Class463.method6012(i + i_9_, (Class372.anInt4051 * -1424479739), (1135094847 * Class372.anInt4048), -1212608691);
		    int i_47_ = Class463.method6012(i - i_9_, (-1424479739 * Class372.anInt4051), (Class372.anInt4048 * 1135094847), -1212608691);
		    if (bool) {
			int i_48_ = (Class463.method6012(i + i_11_, -1424479739 * Class372.anInt4051, Class372.anInt4048 * 1135094847, -1212608691));
			int i_49_ = (Class463.method6012(i - i_11_, Class372.anInt4051 * -1424479739, 1135094847 * Class372.anInt4048, -1212608691));
			if (i_44_ >= 1155384281 * Class372.anInt4049) {
			    int[] is = (Class372.anIntArrayArray4047[i_44_]);
			...
			if (i_45_ <= Class372.anInt4050 * -1062447355) {
			    int[] is = (Class372.anIntArrayArray4047[i_45_]);
			...
			if (i_44_ >= 1155384281 * Class372.anInt4049)
			    Class82_Sub22.method940((Class372.anIntArrayArray4047[i_44_]), i_47_, i_46_, i_6_, -1094701951);
			if (i_45_ <= Class372.anInt4050 * -1062447355)
			    Class82_Sub22.method940((Class372.anIntArrayArray4047[i_45_]), i_47_, i_46_, i_6_, 1089051807);
		    }
		}
	    }
	}
