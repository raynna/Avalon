...
public class Class249 implements Interface_ma {
	...
	int[] is = (method2390(i, 354542821).method3421(this.aClass243_6460, this, f, i_0_, i_1_, this.aClass53Array6462[i].aBoolean544, 795191351));
	return is;
    }
	...
	RsByteBuffer class298_sub53 = new RsByteBuffer(class243.getFile(0, 0));
	this.anInt6463 = class298_sub53.readUnsignedShort() * 12939135;
	...
	for (int i = 0; i < this.anInt6463 * -1882566529; i++) {
		...
		this.aClass53Array6462[i].aBoolean524 = class298_sub53.readUnsignedByte() == 0;
	}
	for (int i = 0; i < -1882566529 * this.anInt6463; i++) {
	    if (this.aClass53Array6462[i] != null)
		this.aClass53Array6462[i].aBoolean518 = class298_sub53.readUnsignedByte() == 1;
	}
	for (int i = 0; i < this.anInt6463 * -1882566529; i++) {
	    if (null != this.aClass53Array6462[i])
		this.aClass53Array6462[i].aBoolean538 = class298_sub53.readUnsignedByte() == 1;
	}
	for (int i = 0; i < this.anInt6463 * -1882566529; i++) {
	    if (null != this.aClass53Array6462[i])
		this.aClass53Array6462[i].aByte534 = class298_sub53.readByte(-12558881);
	}
	for (int i = 0; i < this.anInt6463 * -1882566529; i++) {
	    if (this.aClass53Array6462[i] != null)
		this.aClass53Array6462[i].aByte533 = class298_sub53.readByte(-12558881);
	}
	for (int i = 0; i < this.anInt6463 * -1882566529; i++) {
	    if (null != this.aClass53Array6462[i])
		this.aClass53Array6462[i].aByte529 = class298_sub53.readByte(-12558881);
	}
	for (int i = 0; i < -1882566529 * this.anInt6463; i++) {
	    if (null != this.aClass53Array6462[i])
		this.aClass53Array6462[i].aByte536 = class298_sub53.readByte(-12558881);
	}
	for (int i = 0; i < this.anInt6463 * -1882566529; i++) {
	    if (null != this.aClass53Array6462[i])
		this.aClass53Array6462[i].aShort532 = (short) class298_sub53.readUnsignedShort();
	}
	for (int i = 0; i < this.anInt6463 * -1882566529; i++) {
	    if (this.aClass53Array6462[i] != null)
		this.aClass53Array6462[i].aByte535 = class298_sub53.readByte(-12558881);
	}
	for (int i = 0; i < this.anInt6463 * -1882566529; i++) {
	    if (null != this.aClass53Array6462[i])
		this.aClass53Array6462[i].aByte509 = class298_sub53.readByte(-12558881);
	}
	for (int i = 0; i < -1882566529 * this.anInt6463; i++) {
	    if (this.aClass53Array6462[i] != null)
		this.aClass53Array6462[i].aBoolean527 = class298_sub53.readUnsignedByte() == 1;
	}
	for (int i = 0; i < -1882566529 * this.anInt6463; i++) {
	    if (this.aClass53Array6462[i] != null)
		this.aClass53Array6462[i].aBoolean544 = class298_sub53.readUnsignedByte() == 1;
	}
	for (int i = 0; i < -1882566529 * this.anInt6463; i++) {
	    if (null != this.aClass53Array6462[i])
		this.aClass53Array6462[i].aByte537 = class298_sub53.readByte(-12558881);
	}
	for (int i = 0; i < this.anInt6463 * -1882566529; i++) {
	    if (null != this.aClass53Array6462[i])
		this.aClass53Array6462[i].aBoolean540 = class298_sub53.readUnsignedByte() == 1;
	}
	for (int i = 0; i < this.anInt6463 * -1882566529; i++) {
	    if (null != this.aClass53Array6462[i])
		this.aClass53Array6462[i].aBoolean541 = class298_sub53.readUnsignedByte() == 1;
	}
	for (int i = 0; i < -1882566529 * this.anInt6463; i++) {
	    if (this.aClass53Array6462[i] != null)
		this.aClass53Array6462[i].aBoolean543 = class298_sub53.readUnsignedByte() == 1;
	}
	for (int i = 0; i < this.anInt6463 * -1882566529; i++) {
	    if (null != this.aClass53Array6462[i])
		this.aClass53Array6462[i].anInt519 = class298_sub53.readUnsignedByte() * -39200327;
	}
	for (int i = 0; i < this.anInt6463 * -1882566529; i++) {
	    if (this.aClass53Array6462[i] != null)
		this.aClass53Array6462[i].anInt531 = class298_sub53.readInt((byte) -86) * -946109519;
	}
	for (int i = 0; i < -1882566529 * this.anInt6463; i++) {
	    if (this.aClass53Array6462[i] != null)
		this.aClass53Array6462[i].anInt528 = class298_sub53.readUnsignedByte() * 980235301;
	}
    }
	...
	try {
	    int[] is = (method2390(i, 1119072054).method3423(this.aClass243_6460, this, f, i_5_, i_6_, bool, this.aClass53Array6462[i].aBoolean544, -1817838295));
	    return is;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    int[] is = (method2390(i, 1019997631).method3421(this.aClass243_6460, this, f, i_8_, i_9_, this.aClass53Array6462[i].aBoolean544, -524170328));
	    return is;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class298_Sub37 class298_sub37 = this.aClass354_6464.method4253(i);
	    if (class298_sub37 != null)
		return (Class298_Sub37_Sub6) class298_sub37;
	    byte[] is = this.aClass243_6461.method2294(i, (byte) 51);
	    if (null == is)
		return null;
	    Class298_Sub37_Sub6 class298_sub37_sub6 = new Class298_Sub37_Sub6(new RsByteBuffer(is));
	    this.aClass354_6464.method4255(class298_sub37_sub6, i);
	...
	int[] is = (method2390(i, 526499029).method3421(this.aClass243_6460, this, f, i_12_, i_13_, this.aClass53Array6462[i].aBoolean544, -1650198196));
	return is;
    }
	...
	return (class298_sub37_sub6 != null && class298_sub37_sub6.method3420((this.aClass243_6460), this, (byte) 78));
    }

    @Override
    public int[] method178(int i, float f, int i_15_, int i_16_, boolean bool) {
	int[] is = (method2390(i, -345886802).method3421(this.aClass243_6460, this, f, i_15_, i_16_, this.aClass53Array6462[i].aBoolean544, -1164110413));
	return is;
    }

    @Override
    public int[] method182(int i, float f, int i_17_, int i_18_, boolean bool) {
	int[] is = (method2390(i, -1131324471).method3421(this.aClass243_6460, this, f, i_17_, i_18_, this.aClass53Array6462[i].aBoolean544, -876617633));
	return is;
    }
	...
	try {
	    float[] fs = (method2390(i, -1967108124).method3422(this.aClass243_6460, this, i_19_, i_20_, this.aClass53Array6462[i].aBoolean544, -1481337578));
	    return fs;
	}
	catch (RuntimeException runtimeexception) {
	...
	float[] fs = (method2390(i, 2055609416).method3422(this.aClass243_6460, this, i_22_, i_23_, this.aClass53Array6462[i].aBoolean544, -415868966));
	return fs;
    }

    @Override
    public float[] method184(int i, float f, int i_24_, int i_25_, boolean bool) {
	float[] fs = (method2390(i, -1813054507).method3422(this.aClass243_6460, this, i_24_, i_25_, this.aClass53Array6462[i].aBoolean544, -1304965359));
	return fs;
    }
	...
	int[] is = (method2390(i, -212514005).method3423(this.aClass243_6460, this, f, i_26_, i_27_, bool, this.aClass53Array6462[i].aBoolean544, -1817838295));
	return is;
    }
    ...
    static final void method2392(Class394 class394, Class403 class403, byte i) {
	try {
		...
		case 868:
		    ...
		    break;
		case 730:
		    EntityStrategy.method4099(class403, -276667740);
		    break;
		case 85:
		...
		case 105:
		    ...
		    break;
		case 431:
		    ClanSettings.method1772(class403, -1212653763);
		    break;
		case 419:
		...
		case 74:
		    ...
		    break;
		case 609:
		    HandshakePacket.method1946(class403, 1302049828);
		    break;
		case 587:
		...
		case 810:
		    ...
		    break;
		case 640:
		    ObjectCheckStrategyExact.method4096(class403, 857283388);
		    break;
		case 54:
		...
		case 307:
		    ...
		    break;
		case 794:
		    EntityStrategy.method4100(class403, 814786304);
		    break;
		case 2:
		...
		case 174:
		    ...
		    break;
		case 713:
		    EntityStrategy.method4101(class403, (byte) 4);
		    break;
		case 514:
		...
		case 251:
		    ...
		    break;
		case 700:
		    ClanSettings.method1770(class403, 685678199);
		    break;
		case 382:
		...
		case 227:
		    ...
		    break;
		case 558:
		    AccountCreationStage.method6158(class403, 497619825);
		    break;
		case 283:
		...
		case 180:
		    ...
		    break;
		case 221:
		    Class242_Sub1.openUrl(class403);
		    break;
		case 811:
		...
		case 664:
		    ...
		    break;
		case 893:
		    HandshakePacket.method1948(class403, -311375034);
		    break;
		case 659:
		...
		case 392:
		    ...
		    break;
		case 124:
		    EntityStrategy.method4098(class403, (byte) 0);
		    break;
		case 574:
		...
		case 194:
		    ...
		    break;
		case 540:
		    HandshakePacket.method1949(class403, (byte) -103);
		    break;
		case 78:
		...
		case 989:
		    ...
		    break;
		case 381:
		    AccountCreationStage.method6156(class403, (byte) -55);
		    break;
		case 511:
		...
		case 61:
		    ...
		    break;
		case 914:
		    ObjectCheckStrategyExact.method4097(class403, (short) -2807);
		    break;
		case 911:
		...
		case 733:
		    ...
		    break;
		case 856:
		    AccountCreationStage.method6147(class403, 1504628080);
		    break;
		case 414:
		...
		case 746:
		    ...
		    break;
		case 909:
		    AccountCreationStage.method6150(class403, (byte) 8);
		    break;
		case 5:
		...
		case 723:
		    ...
		    break;
		case 757:
		    Class403.method4943(class403, 663211790);
		    break;
		case 185:
		...
		case 116:
		    ...
		    break;
		case 98:
		    Class127_Sub1.setInterfaceOnComponent(class403, (byte) 115);
		    break;
		case 63:
		...
		case 301:
		    ...
		    break;
		case 15:
		    AccountCreationStage.method6155(class403, -86584801);
		    break;
		case 88:
		...
		case 598:
		    ...
		    break;
		case 469:
		    AccountCreationStage.method6149(class403, (byte) 0);
		    break;
		case 983:
		...
		case 923:
		    ...
		    break;
		case 975:
		    EntityStrategy.method4102(class403, (byte) 0);
		    break;
		case 254:
		...
		case 635:
		    ...
		    break;
		case 625:
		    Class403.method4942(class403, (byte) 1);
		    break;
		case 831:
		...
		case 162:
		    ...
		    break;
		case 767:
		    Class403.method4945(class403, 1378939686);
		    break;
		case 756:
		...
		case 847:
		    ...
		    break;
		case 128:
		    AccountCreationStage.method6148(class403, -2131789274);
		    break;
		case 918:
		...
		case 483:
		    ...
		    break;
		case 114:
		    AccountCreationStage.method6151(class403, 65280);
		    break;
		case 161:
    ...
    static final void method2393(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
		...
		Class422.method5623(-440872681 * class105.ihash, 1872852053);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2394(Class403 class403, int i) {
	try {
