...
public class Class335 {
    ...
    static final void method4085(Class403 class403, short i) {
	try {
    ...
    static final void method4087(Class403 class403, int i) {
	try {
	    int i_4_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Character.toUpperCase((char) i_4_);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4088(Class403 class403, int i) {
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = class298_sub37_sub8.anIntArray9599.length;
	}
	catch (RuntimeException runtimeexception) {
