...
public class Class378 {
	...
	try {
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = (class403.anObjectArray5234[(class403.anIntArray5257[1883543357 * class403.anInt5259])]);
	}
	...
	try {
	    ...
	    Class255.errorPrint(runtimeexception.toString() + "\n" + new StringBuilder().append("ps.i(").append(')').toString());
