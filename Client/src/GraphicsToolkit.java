...
public abstract class GraphicsToolkit {
	...
	try {
	    ...
	    if (929186669 * this.anInt5310 > 0 || aClass52_5292 != aClass52_Sub2_5312)
		throw new RuntimeException();
	    if (aClass52_5292 != null)
		aClass52_5292.method546();
	    if (this.anInt5310 * 929186669 < 0)
	...
	try {
	    if (929186669 * this.anInt5310 < 0 || (this.aClass52_Sub1Array5304[this.anInt5310 * 929186669]) != class52_sub1)
		throw new RuntimeException();
	    this.aClass52_Sub1Array5304[(this.anInt5310 -= 1780694629) * 929186669 + 1] = null;
	    class52_sub1.method546();
	    if (this.anInt5310 * 929186669 >= 0) {
		aClass52_5292 = (this.aClass52_Sub1Array5304[this.anInt5310 * 929186669]);
		this.aClass52_Sub1Array5304[this.anInt5310 * 929186669].method136();
	    } else {
    ...
    public abstract Class264 method5092(Class505 class505, IndexedImage[] class89s, boolean bool);
    ...
    public abstract Class264 method5113(Class505 class505, IndexedImage[] class89s, boolean bool);

    public abstract Class264 method5114(Class505 class505, IndexedImage[] class89s, boolean bool);
	...
	try {
	    if (929186669 * this.anInt5310 >= 3)
		throw new RuntimeException();
	    if (this.anInt5310 * 929186669 >= 0)
		this.aClass52_Sub1Array5304[929186669 * this.anInt5310].method546();
	    else
		aClass52_Sub2_5312.method546();
	    aClass52_5292 = this.aClass52_Sub1Array5304[(this.anInt5310 += 1780694629) * 929186669] = class52_sub1;
	...
	this.aClass52_Sub1Array5304 = new Class52_Sub1[4];
	...
	try {
		...
		Class288_Sub1.aClass219_7147.method2043(-4360787748556788915L * Class230.aLong2560, Class82_Sub6.aClass227_6843.aClass470_2549.method6049(Class321.aClass429_3357, -875414210), (360399239 * Class82_Sub6.aClass227_6843.anInt2551), Class82_Sub6.aClass227_6843, 180676280);
	...
	try {
	    if (i > i_485_ && i < i_485_ + i_487_ && i_484_ > i_489_ - class505.anInt6202 * 1110385787 - 1 && i_484_ < i_489_ + -1883958527 * class505.anInt6197 && class298_sub37_sub15.aBoolean9664)
		i_490_ = i_491_;
	...
	try {
	    int i_493_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	...
	try {
		...
		if (2 != -64305285 * Class3.anInt56 && 5 != Class3.anInt56 * -64305285 && null != Class384.aClass57_4127) {
			...
			int i_505_ = ((class296.keyTiles[i_504_] >> 14 & 0x3fff) - -1760580017 * class341.gameSceneBaseX);
			int i_506_ = ((class296.keyTiles[i_504_] & 0x3fff) - 283514611 * class341.gameSceneBaseY);
			int i_507_ = 2 + 4 * i_505_ - i_498_ / 128;
			int i_508_ = 2 + 4 * i_506_ - i_499_ / 128;
			Class248.method2389(class_ra, class_ta, class105, i, i_496_, i_507_, i_508_, class296.keyIds[i_504_], (byte) 0);
		    }
		    ...
		    for (Class298_Sub2 class298_sub2 = ((Class298_Sub2) client.aClass437_8685.method5816(1742338274)); class298_sub2 != null; class298_sub2 = ((Class298_Sub2) client.aClass437_8685.method5815((byte) 24))) {
			int i_512_ = (int) ((class298_sub2.hash * 7051297995265073167L) >> 28 & 0x3L);
			if (i_512_ == Class3.anInt57 * -1694437021) {
			    int i_513_ = ((int) ((class298_sub2.hash * 7051297995265073167L) & 0x3fffL) - -1760580017 * class341.gameSceneBaseX);
