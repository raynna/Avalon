...
public class Class104 {
    ...
    static final void method1101(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -1175642067;
	    long l = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    long l_0_ = (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]);
	    long l_1_ = (class403.anIntArray5244[2 + class403.anInt5239 * 681479919]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (int) (l_1_ * l / l_0_);
	}
    ...
    static final void method1102(Class403 class403, int i) {
	try {
	    int i_2_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = Class285.method2709(i_2_, -1648336964);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if ((client.ticketCycle * 443738891 == class365_sub1_sub1_sub2.anInt10103 * 1450943713) || !class438.method5819((byte) -78) || class438.method5836(1, 2027501470)) {
		int i_3_ = (class365_sub1_sub1_sub2.anInt10103 * 1450943713 - class365_sub1_sub1_sub2.anInt10095 * -412225079);
		int i_4_ = (443738891 * client.ticketCycle - -412225079 * class365_sub1_sub1_sub2.anInt10095);
		...
		class365_sub1_sub1_sub2.method4341((i_5_ * (i_3_ - i_4_) + i_4_ * i_7_) / i_3_, (int) class217.aFloat2455, (i_4_ * i_8_ + (i_3_ - i_4_) * i_6_) / i_3_);
	    }
	...
	try {
		...
		Class422_Sub24.method5714(Class83.aClass105Array764, -1412584499, 0, 0, Class462.anInt5683 * -2110394505, -1111710645 * Class298_Sub40_Sub9.anInt9716, Class216.anInt6660 * -391533651, HashTable.anInt5518 * -514549911, (Class82_Sub3.aClass105_6825 == client.aClass105_8712 ? -1 : client.aClass105_8712.anInt1303 * 91937559), true, (byte) 0);
		Class83.aClass105Array764 = null;
	    }
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1105(Class403 class403, int i) {
	try {
    ...
    static final void method1106(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (class403.anIntArray5248[(class403.anIntArray5257[1883543357 * class403.anInt5259])]);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		return "";
	    if (((class298_sub37_sub15.aString9657 == null) || class298_sub37_sub15.aString9657.length() == 0) && null != (class298_sub37_sub15.aString9669) && class298_sub37_sub15.aString9669.length() > 0)
		return (class298_sub37_sub15.aString9669);
	    return class298_sub37_sub15.aString9657;
	}
	catch (RuntimeException runtimeexception) {
