...
public class Class465 implements Interface18 {
	...
	if (-1527694577 * this.anInt6517 != class465_0_.anInt6517 * -1527694577)
	    return false;
	if (this.aBoolean6513 != class465_0_.aBoolean6513)
	    return false;
	return true;
    }
	...
	try {
		...
		return false;
	    if (this.aBoolean6513 != class465_1_.aBoolean6513)
		return false;
	    return true;
	}
	...
	try {
	    ...
	    long l = -1L;
	    l = l >>> 8 ^ ls[(int) ((l ^ 696186641 * this.anInt6519) & 0xffL)];
	    l = l >>> 8 ^ ls[(int) ((l ^ (1776279405 * this.anInt6514) >> 8) & 0xffL)];
	    l = l >>> 8 ^ ls[(int) ((l ^ this.anInt6514 * 1776279405) & 0xffL)];
	    l = l >>> 8 ^ ls[(int) ((l ^ 793126543 * (this.anInt6515) >> 24) & 0xffL)];
	    l = l >>> 8 ^ ls[(int) ((l ^ 793126543 * (this.anInt6515) >> 16) & 0xffL)];
	    l = l >>> 8 ^ ls[(int) ((l ^ 793126543 * (this.anInt6515) >> 8) & 0xffL)];
	    l = l >>> 8 ^ ls[(int) ((l ^ 793126543 * this.anInt6515) & 0xffL)];
	    l = l >>> 8 ^ ls[(int) ((l ^ -2052168577 * this.anInt6516) & 0xffL)];
	    l = l >>> 8 ^ ls[(int) ((l ^ (-2128765879 * this.anInt6518) >> 24) & 0xffL)];
	    l = l >>> 8 ^ ls[(int) ((l ^ (this.anInt6518 * -2128765879) >> 16) & 0xffL)];
	    l = l >>> 8 ^ ls[(int) ((l ^ (-2128765879 * this.anInt6518) >> 8) & 0xffL)];
	    l = l >>> 8 ^ ls[(int) ((l ^ this.anInt6518 * -2128765879) & 0xffL)];
	    l = l >>> 8 ^ ls[(int) ((l ^ -1527694577 * this.anInt6517) & 0xffL)];
	    l = l >>> 8 ^ ls[(int) ((l ^ (this.aBoolean6513 ? 1 : 0)) & 0xffL)];
	    return l;
	}
	catch (RuntimeException runtimeexception) {
	...
	if (-1527694577 * this.anInt6517 != class465_2_.anInt6517 * -1527694577)
	    return false;
	if (this.aBoolean6513 != class465_2_.aBoolean6513)
	    return false;
	return true;
    }
    ...
    static final void method6018(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
    ...
    static final void method6019(Class403 class403, short i) {
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = class350.anIntArray3712[i_10_];
	    } else
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = -809747019 * class350.anInt3711;
	}
	catch (RuntimeException runtimeexception) {
