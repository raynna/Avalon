...
public class Class298_Sub40_Sub13 extends Class298_Sub40 {
	...
	try {
	    this.anInt9731 = class298_sub53.readInt((byte) -19) * -1426634659;
	    this.anInt9730 = class298_sub53.readInt((byte) 80) * 771945371;
	}
	...
	this.anInt9731 = class298_sub53.readInt((byte) -92) * -1426634659;
	this.anInt9730 = class298_sub53.readInt((byte) 6) * 771945371;
    }
	...
	this.anInt9731 = class298_sub53.readInt((byte) -50) * -1426634659;
	this.anInt9730 = class298_sub53.readInt((byte) -74) * 771945371;
    }
    ...
    static void method3518(Class222 class222, Class233 class233, int i, int i_1_, int i_2_) {
	try {
	    if (null == Class436.aClass233_5493)
		Class436.aClass233_5493 = new Class233(class233);
	    else
