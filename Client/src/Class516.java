...
public class Class516 {
	...
	this.anInt6235 = i_0_ * 1688575393;
    }
	...
	try {
		...
		class298_sub36.out.writeByte(Class58.method693(string, 148630832));
		class298_sub36.out.writeString(string, 2138604047);
    ...
    static final void method6301(Class403 class403, int i) {
	try {
    ...
    static final void method6302(Class403 class403, int i) {
	try {
    ...
    static final void method6303(Class403 class403, byte i) {
	try {
