...
public class Class298_Sub32_Sub5 extends Class298_Sub32 {
	...
	if (aClass257_7384.aBoolean2810) {
	    int i_0_ = 1698072291 * this.anInt9352 >> 1;
	    int[][] is_1_ = aClass257_7384.method2449(432902408);
	    Random random = new Random(this.anInt9349 * -1552351361);
	    for (int i_2_ = 0; i_2_ < -1197969353 * this.anInt9344; i_2_++) {
		int i_3_ = (this.anInt9352 * 1698072291 > 0 ? (-114289409 * this.anInt9350 + ((Class298_Sub19_Sub3.method3039(random, (1698072291 * this.anInt9352), (byte) -39)) - i_0_)) : -114289409 * this.anInt9350);
		i_3_ = i_3_ >> 4 & 0xff;
		...
		int i_6_ = i_4_ + ((this.anInt9346 * -1584670283 * Class250.anIntArray2763[i_3_]) >> 12);
		int i_7_ = (((-1584670283 * this.anInt9346 * Class250.anIntArray2761[i_3_]) >> 12) + i_5_);
		int i_8_ = i_7_ - i_5_;
		int i_9_ = i_6_ - i_4_;
		if (0 != i_9_ || i_8_ != 0) {
		    if (i_8_ < 0)
	...
	switch (i) {
	    case 3:
		this.anInt9350 = class298_sub53.readUnsignedShort() * -132715777;
		break;
	    case 2:
		this.anInt9346 = class298_sub53.readUnsignedByte() * -1689580387;
		break;
	    case 0:
		this.anInt9349 = class298_sub53.readUnsignedByte() * 94814335;
		break;
	    case 1:
		this.anInt9344 = class298_sub53.readUnsignedShort() * -23968377;
		break;
	    case 4:
		this.anInt9352 = class298_sub53.readUnsignedShort() * 1425338059;
		break;
	}
    }
	...
	if (aClass257_7384.aBoolean2810) {
	    int i_25_ = 1698072291 * this.anInt9352 >> 1;
	    int[][] is_26_ = aClass257_7384.method2449(-125478280);
	    Random random = new Random(this.anInt9349 * -1552351361);
	    for (int i_27_ = 0; i_27_ < -1197969353 * this.anInt9344; i_27_++) {
		int i_28_ = (this.anInt9352 * 1698072291 > 0 ? (-114289409 * this.anInt9350 + ((Class298_Sub19_Sub3.method3039(random, (1698072291 * this.anInt9352), (byte) 21)) - i_25_)) : -114289409 * this.anInt9350);
		i_28_ = i_28_ >> 4 & 0xff;
		...
		int i_31_ = i_29_ + ((this.anInt9346 * -1584670283 * Class250.anIntArray2763[i_28_]) >> 12);
		int i_32_ = (((-1584670283 * this.anInt9346 * Class250.anIntArray2761[i_28_]) >> 12) + i_30_);
	...
	try {
	    ...
	    if (aClass257_7384.aBoolean2810) {
		int i_52_ = 1698072291 * this.anInt9352 >> 1;
		int[][] is_53_ = aClass257_7384.method2449(-1416653577);
		Random random = new Random(this.anInt9349 * -1552351361);
		for (int i_54_ = 0; (i_54_ < -1197969353 * this.anInt9344); i_54_++) {
		    int i_55_ = ((this.anInt9352 * 1698072291 > 0) ? ((-114289409 * this.anInt9350) + ((Class298_Sub19_Sub3.method3039(random, (1698072291 * this.anInt9352), (byte) 24)) - i_52_)) : (-114289409 * this.anInt9350));
		    i_55_ = i_55_ >> 4 & 0xff;
		    ...
		    int i_58_ = (i_56_ + ((this.anInt9346 * -1584670283 * Class250.anIntArray2763[i_55_]) >> 12));
		    int i_59_ = (((-1584670283 * this.anInt9346 * Class250.anIntArray2761[i_55_]) >> 12) + i_57_);
	...
	super(0, true);
	this.anInt9344 = -692113744;
	this.anInt9346 = -1263482416;
	this.anInt9352 = 1324134400;
	this.anInt9350 = 0;
    }

    static final void method3174(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
