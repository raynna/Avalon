...
public final class Class243 {
	...
	try {
	    if (this.aClass226_2713 == null) {
		this.aClass226_2713 = this.aClass242_2720.method2250(2102263091);
		if (this.aClass226_2713 == null)
		    return false;
		this.anObjectArray2717 = new Object[-1583970959 * ((this.aClass226_2713).anInt2521)];
		this.anObjectArrayArray2718 = new Object[-1583970959 * ((this.aClass226_2713).anInt2521)][];
	    }
	    return true;
	}
	...
	try {
	    ...
	    return (this.aClass226_2713.anInt2513 * 1600327191);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		return false;
	    if (i < 0 || i_0_ < 0 || i >= (this.aClass226_2713.anIntArray2517).length || i_0_ >= (this.aClass226_2713.anIntArray2517[i])) {
		if (aBoolean2721)
	...
	try {
	    if (this.aBoolean2715)
		this.anObjectArray2717[i] = this.aClass242_2720.method2251(i, (byte) -83);
	    else
		this.anObjectArray2717[i] = Class158.method1702(this.aClass242_2720.method2251(i, (byte) -115), false, (short) -5444);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass242_2720.method2256(i, (short) -11867);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		return null;
	    byte[] is_6_ = null;
	    if (null == this.anObjectArrayArray2718[i] || null == this.anObjectArrayArray2718[i][i_4_]) {
	    ...
	    if (null == this.anObjectArrayArray2718[i])
		throw new RuntimeException("");
	    if (this.anObjectArrayArray2718[i][i_4_] == null) {
		if (i_5_ >= -969677092) {
		    /* empty */
		}
	    } else {
		is_6_ = Class338.method4114((this.anObjectArrayArray2718[i][i_4_]), false, -390800011);
		if (is_6_ == null)
		    throw new RuntimeException("");
	    }
	    if (null != is_6_) {
		if (this.anInt2719 * -1870742467 == 1) {
		    this.anObjectArrayArray2718[i][i_4_] = null;
		    if (1 == (this.aClass226_2713.anIntArray2517[i]))
			this.anObjectArrayArray2718[i] = null;
		} else if (this.anInt2719 * -1870742467 == 2)
		    this.anObjectArrayArray2718[i] = null;
	    }
	    return is_6_;
	}
	...
	try {
		...
		return false;
	    if (this.anObjectArrayArray2718[i] != null && this.anObjectArrayArray2718[i][i_7_] != null)
		return true;
	    if (this.anObjectArray2717[i] != null)
		return true;
	    method2287(i, (byte) 102);
	    if (null != this.anObjectArray2717[i])
		return true;
	    return false;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		return false;
	    boolean bool = true;
	    for (int i_10_ = 0; i_10_ < (this.aClass226_2713.anIntArray2518).length; i_10_++) {
		int i_11_ = (this.aClass226_2713.anIntArray2518[i_10_]);
		if (this.anObjectArray2717[i_11_] == null) {
		    method2287(i_11_, (byte) 10);
		    if (null == this.anObjectArray2717[i_11_])
			bool = false;
		}
	    }
	    return bool;
	...
	try {
	    ...
	    int i_12_ = 0;
	    int i_13_ = 0;
	    for (int i_14_ = 0; i_14_ < this.anObjectArray2717.length; i_14_++) {
		if ((this.aClass226_2713.anIntArray2525[i_14_]) > 0) {
		    i_12_ += 100;
	...
	try {
		...
		return null;
	    if ((this.aClass226_2713.anIntArray2517).length == 1)
		return getFile(0, i);
	    if (!method2309(i, (byte) 1))
		return null;
	    if (this.aClass226_2713.anIntArray2517[i] == 1)
		return getFile(i, 0);
	    throw new RuntimeException();
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    int i_17_ = (this.aClass226_2713.aClass112_2520.method1239(Class244.method2328(string, -1973803814), 867865737));
	    if (i_17_ < 0)
		return false;
	    return true;
	}
	...
	try {
		...
		return -1;
	    return (this.aClass226_2713.anIntArray2517).length;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (method2309(i, (byte) 1)) {
		if (this.anObjectArrayArray2718 != null)
		    this.anObjectArrayArray2718[i] = null;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (bool) {
		    this.aClass226_2713.anIntArray2519 = null;
		    this.aClass226_2713.aClass112_2520 = null;
		}
		if (bool_19_) {
		    this.aClass226_2713.anIntArrayArray2523 = null;
		    this.aClass226_2713.aClass112Array2528 = null;
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	this.aClass242_2720 = class242;
	this.aBoolean2715 = bool;
	this.anInt2719 = -98387179 * i;
    }
	...
	try {
		...
		return -1;
	    int i_21_ = this.aClass226_2713.aClass112_2520.method1239(i, 1079998267);
	...
	try {
	    ...
	    int i_23_ = (this.aClass226_2713.aClass112_2520.method1239(Class244.method2328(string, -1984349791), 728033014));
	    if (i_23_ < 0)
		return false;
	    int i_24_ = (this.aClass226_2713.aClass112Array2528[i_23_].method1239(Class244.method2328(string_22_, -2081152646), 2090644563));
	    if (i_24_ < 0)
		return false;
	    return true;
	}
    ...
    public synchronized byte[] getFile(String archiveName, String fileName) {
	try {
	    if (!method2284(-1323260380))
		return null;
	    archiveName = archiveName.toLowerCase();
	    fileName = fileName.toLowerCase();
	    int archiveId = (this.aClass226_2713.aClass112_2520.method1239(Class244.method2328(archiveName, -1961901970), 1404802795));
	    if (!method2309(archiveId, (byte) 1))
		return null;
	    int i_27_ = (this.aClass226_2713.aClass112Array2528[archiveId].method1239(Class244.method2328(fileName, -2059879258), 838109915));
	    return getFile(archiveId, i_27_);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    int i_29_ = (this.aClass226_2713.aClass112_2520.method1239(Class244.method2328(string, -2027002851), 906979105));
	    if (!method2309(i_29_, (byte) 1))
		return false;
	    int i_30_ = (this.aClass226_2713.aClass112Array2528[i_29_].method1239(Class244.method2328(string_28_, -2028561031), 2121455333));
	...
	try {
	    ...
	    if (this.anObjectArray2717[i] != null)
		return 100;
	    return this.aClass242_2720.method2253(i, 65535);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		string = string.toLowerCase();
		int i_32_ = (this.aClass226_2713.aClass112_2520.method1239(Class244.method2328(string, -2097971535), 1493933726));
	...
	try {
		...
		return 0;
	    string = string.toLowerCase();
	    int i_33_ = (this.aClass226_2713.aClass112_2520.method1239(Class244.method2328(string, -2069451291), 96817353));
	...
	try {
	    ...
	    if (null == this.anObjectArray2717[i])
		return false;
	    int i_36_ = (this.aClass226_2713.anIntArray2525[i]);
	    int[] is_37_ = (this.aClass226_2713.anIntArrayArray2526[i]);
	    if (null == this.anObjectArrayArray2718[i])
		this.anObjectArrayArray2718[i] = new Object[(this.aClass226_2713.anIntArray2517[i])];
	    Object[] objects = this.anObjectArrayArray2718[i];
	    boolean bool = true;
		...
		is_40_ = Class338.method4114((this.anObjectArray2717[i]), true, -858479492);
		...
		if (2 != this.anInt2719 * -1870742467) {
			...
			if (null == is_37_)
			    ...
			    i_55_ = is_37_[i_54_];
			if (-1870742467 * this.anInt2719 == 0)
		...
		if (null == is_37_)
		    ...
		    i_70_ = is_37_[0];
		if (0 == this.anInt2719 * -1870742467)
    ...
    public synchronized int[] getFileIds(int archiveId) {
	try {
	    if (!method2309(archiveId, (byte) 1))
		return null;
	    int[] is = (this.aClass226_2713.anIntArrayArray2526[archiveId]);
	    if (is == null) {
		is = new int[(this.aClass226_2713.anIntArray2525[archiveId])];
	...
	if (null == this.anObjectArray2717[i])
	    return false;
	int i_74_ = this.aClass226_2713.anIntArray2525[i];
	int[] is_75_ = (this.aClass226_2713.anIntArrayArray2526[i]);
	if (null == this.anObjectArrayArray2718[i])
	    this.anObjectArrayArray2718[i] = new Object[(this.aClass226_2713.anIntArray2517[i])];
	Object[] objects = this.anObjectArrayArray2718[i];
	boolean bool = true;
	...
	byte[] is_78_;
	if (null != is && (0 != is[0] || is[1] != 0 || is[2] != 0 || 0 != is[3])) {
	    is_78_ = Class338.method4114(this.anObjectArray2717[i], true, -1017882504);
	    ...
	    is_78_ = Class338.method4114(this.anObjectArray2717[i], false, 959051680);
	byte[] is_79_;
	try {
	...
	try {
		...
		return false;
	    if (i < 0 || i >= (this.aClass226_2713.anIntArray2517).length || 0 == (this.aClass226_2713.anIntArray2517[i])) {
		if (aBoolean2721)
	...
	try {
		...
		return false;
	    if (1 == (this.aClass226_2713.anIntArray2517).length)
	...
	try {
		...
		return -1;
	    string = string.toLowerCase();
	    int i_111_ = (this.aClass226_2713.aClass112_2520.method1239(Class244.method2328(string, -2067562497), 403552753));
	...
	try {
		...
		return false;
	    string = string.toLowerCase();
	    int i_112_ = (this.aClass226_2713.aClass112_2520.method1239(Class244.method2328(string, -2120237955), 187766103));
	...
	if (null == this.anObjectArray2717[i])
	    return false;
	int i_115_ = this.aClass226_2713.anIntArray2525[i];
	int[] is_116_ = (this.aClass226_2713.anIntArrayArray2526[i]);
	if (null == this.anObjectArrayArray2718[i])
	    this.anObjectArrayArray2718[i] = new Object[(this.aClass226_2713.anIntArray2517[i])];
	Object[] objects = this.anObjectArrayArray2718[i];
	boolean bool = true;
	...
	byte[] is_119_;
	if (null != is && (0 != is[0] || is[1] != 0 || is[2] != 0 || 0 != is[3])) {
	    is_119_ = Class338.method4114(this.anObjectArray2717[i], true, 1730830793);
	    ...
	    is_119_ = Class338.method4114(this.anObjectArray2717[i], false, 235085962);
	byte[] is_120_;
	try {
    ...
    public byte[] getFile(int i, int i_150_) {
	try {
	...
	try {
	    if (!method2309(i, (byte) 1))
		return 0;
	    return (this.aClass226_2713.anIntArray2517[i]);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2317(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
    ...
    static final void method2318(Class403 class403, int i) {
	try {
