...
public class Class298_Sub32_Sub39 extends Class298_Sub32 {
	...
	try {
	    switch (i) {
		case 0:
		    this.anInt9570 = class298_sub53.readUnsignedByte() * 382646931;
		    break;
		case 1:
		    this.anInt9571 = class298_sub53.readUnsignedShort() * 1354827067;
		    break;
		case 2:
		    this.anInt9566 = class298_sub53.readUnsignedByte() * 438974141;
		    break;
	    }
	}
	...
	try {
	    int i_1_ = 0;
	    this.anIntArray9573 = new int[1 + (-2096663653 * this.anInt9570)];
	    this.anIntArray9574 = new int[(-2096663653 * this.anInt9570) + 1];
	    int i_2_ = 4096 / (-2096663653 * this.anInt9570);
	    int i_3_ = (this.anInt9571 * -1111258125 * i_2_ >> 12);
	    for (int i_4_ = 0; i_4_ < -2096663653 * this.anInt9570; i_4_++) {
		this.anIntArray9574[i_4_] = i_1_;
		this.anIntArray9573[i_4_] = i_3_ + i_1_;
		i_1_ += i_2_;
	    }
	    this.anIntArray9574[this.anInt9570 * -2096663653] = 4096;
	    this.anIntArray9573[this.anInt9570 * -2096663653] = this.anIntArray9573[0] + 4096;
	}
	catch (RuntimeException runtimeexception) {
	...
	if (aClass257_7384.aBoolean2810) {
		...
		for (int i_6_ = 0; i_6_ < -1474554145 * Class250.anInt2755; i_6_++) {
		    ...
		    for (int i_10_ = 0; i_10_ < (-2096663653 * this.anInt9570); i_10_++) {
			if (i_7_ >= (this.anIntArray9574[i_10_]) && i_7_ < (this.anIntArray9574[1 + i_10_])) {
			    if (i_7_ < (this.anIntArray9573[i_10_]))
				i_8_ = 4096;
			    break;
			}
		    }
		...
		int i_11_ = 0;
		for (int i_12_ = 0; (i_12_ < this.anInt9570 * -2096663653); i_12_++) {
		    if (i_5_ >= (this.anIntArray9574[i_12_]) && i_5_ < (this.anIntArray9574[1 + i_12_])) {
			if (i_5_ < (this.anIntArray9573[i_12_]))
			    i_11_ = 4096;
			break;
		    }
		}
	...
	if (aClass257_7384.aBoolean2810) {
		...
		for (int i_14_ = 0; i_14_ < -1474554145 * Class250.anInt2755; i_14_++) {
		    ...
		    for (int i_18_ = 0; i_18_ < (-2096663653 * this.anInt9570); i_18_++) {
			if (i_15_ >= (this.anIntArray9574[i_18_]) && i_15_ < (this.anIntArray9574[1 + i_18_])) {
			    if (i_15_ < (this.anIntArray9573[i_18_]))
				i_16_ = 4096;
			    break;
			}
		    }
		...
		int i_19_ = 0;
		for (int i_20_ = 0; (i_20_ < this.anInt9570 * -2096663653); i_20_++) {
		    if (i_13_ >= (this.anIntArray9574[i_20_]) && i_13_ < (this.anIntArray9574[1 + i_20_])) {
			if (i_13_ < (this.anIntArray9573[i_20_]))
			    i_19_ = 4096;
			break;
		    }
		}
	...
	try {
		...
		if (this.anInt9566 * -882183019 != 0) {
			...
			for (int i_27_ = 0; (i_27_ < (-2096663653 * this.anInt9570)); i_27_++) {
			    if (i_24_ >= (this.anIntArray9574[i_27_]) && i_24_ < (this.anIntArray9574[1 + i_27_])) {
				if (i_24_ < (this.anIntArray9573[i_27_]))
				    i_25_ = 4096;
				break;
			    }
			}
		    ...
		    int i_28_ = 0;
		    for (int i_29_ = 0; i_29_ < (this.anInt9570 * -2096663653); i_29_++) {
			if (i_22_ >= (this.anIntArray9574[i_29_]) && i_22_ < (this.anIntArray9574[1 + i_29_])) {
			    if (i_22_ < (this.anIntArray9573[i_29_]))
				i_28_ = 4096;
			    break;
			}
		    }
