...
public class Class515 {
	...
	try {
	    byte[] is = this.aClass243_6229.getFile(i, 0);
	...
	RsByteBuffer class298_sub53 = new RsByteBuffer(this.aClass243_6229.getFile(0, 0));
	...
	if (i < 4) {
		...
		int i_11_;
		if (i > 2) {
		    this.anInt6232 = class298_sub53.readShort(1770899550) * 818506755;
    ...
    static final void method6298(Class403 class403, int i) {
	try {
