...
public class Class320 implements Interface21 {
    ...
    Class320(int i) {
	this.anInt6549 = -1849427999 * i;
    }

    @Override
    public int method243() {
	return 2012122145 * this.anInt6549;
    }
	...
	try {
	    ...
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.screenSizePreference, 2, 1293702073);
    ...
    static final void method3911(Class403 class403, int i) {
	try {
    ...
    static final void method3912(Class403 class403, int i) {
	try {
	    int i_1_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub3_7556.method5612(i_1_, 1352882135);
	}
	catch (RuntimeException runtimeexception) {
