...
public class Class18 {
	...
	try {
	    ...
	    if ((class403.anIntArray5244[class403.anInt5239 * 681479919]) <= (class403.anIntArray5244[1 + class403.anInt5239 * 681479919]))
	...
	try {
	    ...
	    class298_sub36.aClass198_7401 = class198;
	    class298_sub36.anInt7397 = class198.length * -1035235683;
	    if (-1 == class298_sub36.anInt7397 * 157188735)
		class298_sub36.out = new RsBitsBuffer(260);
	    else if (class298_sub36.anInt7397 * 157188735 == -2)
		class298_sub36.out = new RsBitsBuffer(10000);
	    else if (157188735 * class298_sub36.anInt7397 <= 18)
		class298_sub36.out = new RsBitsBuffer(20);
	    else if (class298_sub36.anInt7397 * 157188735 <= 98)
		class298_sub36.out = new RsBitsBuffer(100);
	    else
		class298_sub36.out = new RsBitsBuffer(260);
	    class298_sub36.out.method3665(isaacCipher, (byte) 74);
	    class298_sub36.out.method3668((class298_sub36.aClass198_7401.id) * -1687656101, (byte) -23);
	...
	try {
	    ...
	    int i_9_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]);
		...
		Class242_Sub1.method2282(i_8_, i_9_, "", "", "", string, -541387718);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		int i_12_ = (385051775 * class298_sub36.out.index);
		class298_sub36.out.writeString(string, 2138689470);
		class298_sub36.out.writeString(string_10_, 2115793947);
		class298_sub36.out.writeByte(i);
		class298_sub36.out.writeByte(bool ? 1 : 0);
		class298_sub36.out.index += 814893177;
		class298_sub36.out.method3611(Class361.anIntArray3913, i_12_, (class298_sub36.out.index * 385051775), -1325657598);
		class298_sub36.out.method3593(385051775 * (class298_sub36.out.index) - i_12_, 1585504133);
