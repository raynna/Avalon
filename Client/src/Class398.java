...
public class Class398 {
	...
	try {
	    if (1 == i)
		this.anInt5204 = class298_sub53.readBigSmart(1235052657) * 422607467;
	    else if (i == 2)
		anInt5205 = class298_sub53.readBigSmart(1235052657) * 761293581;
	    else if (4 == i)
		this.anInt5217 = class298_sub53.readUnsignedShort() * -1420991257;
	    else if (i == 5)
		this.anInt5211 = class298_sub53.readUnsignedShort() * -586540739;
	    else if (i == 6)
		this.anInt5212 = class298_sub53.readUnsignedShort() * -79411937;
	    else if (7 == i)
		this.anInt5213 = class298_sub53.readUnsignedByte() * 1905965041;
	    else if (8 == i)
		this.anInt5214 = class298_sub53.readUnsignedByte() * -241990007;
	    else if (9 == i) {
		aByte5216 = (byte) 3;
		...
		aByte5216 = (byte) 2;
		this.anInt5203 = class298_sub53.readUnsignedByte() * -497453824;
	    } else if (i == 15) {
		aByte5216 = (byte) 3;
		this.anInt5203 = class298_sub53.readUnsignedShort() * 48388469;
	    } else if (16 == i) {
		aByte5216 = (byte) 3;
		this.anInt5203 = class298_sub53.readInt((byte) 52) * 48388469;
	    } else if (40 == i) {
		int i_2_ = class298_sub53.readUnsignedByte();
		this.aShortArray5206 = new short[i_2_];
		this.aShortArray5207 = new short[i_2_];
		for (int i_3_ = 0; i_3_ < i_2_; i_3_++) {
		    this.aShortArray5206[i_3_] = (short) class298_sub53.readUnsignedShort();
		    this.aShortArray5207[i_3_] = (short) class298_sub53.readUnsignedShort();
		}
	    } else if (41 == i) {
		...
		for (int i_5_ = 0; i_5_ < i_4_; i_5_++) {
		    this.aShortArray5208[i_5_] = (short) class298_sub53.readUnsignedShort();
		    this.aShortArray5209[i_5_] = (short) class298_sub53.readUnsignedShort();
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (this.anInt5211 * -64059883 != 128)
		i_14_ |= 0x2;
	    if (128 != this.anInt5217 * -1869386025 || 0 != this.anInt5212 * -614140193)
		i_14_ |= 0x5;
	    Class387 class387;
	    synchronized (this.aClass389_5210.aClass348_4162) {
		class387 = ((Class387) (this.aClass389_5210.aClass348_4162.method4184((this.anInt5202 = (1757755963 * ((-559444237 * this.anInt5202) | (class_ra.anInt5298 * 580915349 << 29)))) * -559444237)));
	    }
		...
		if (this.aShortArray5208 != null)
		    i_15_ |= 0x8000;
		Model class64 = Model.method751((this.aClass389_5210.aClass243_4160), (this.anInt5204 * -283549117), 0);
		if (class64 == null)
		    return null;
		if (class64.anInt630 < 13)
		    class64.method755(2);
		class387 = (class_ra.method5037(class64, i_15_, -258957271 * (this.aClass389_5210).anInt4163, 64 + -2043193071 * this.anInt5213, 850 + 1459867577 * this.anInt5214));
		if (null != this.aShortArray5206) {
		    for (int i_16_ = 0; i_16_ < this.aShortArray5206.length; i_16_++)
			class387.X(this.aShortArray5206[i_16_], this.aShortArray5207[i_16_]);
		}
		if (this.aShortArray5208 != null) {
		    for (int i_17_ = 0; i_17_ < this.aShortArray5208.length; i_17_++)
			class387.W(this.aShortArray5208[i_17_], this.aShortArray5209[i_17_]);
		}
		class387.KA(i_14_);
		synchronized (this.aClass389_5210.aClass348_4162) {
	    ...
	    if (-1869386025 * this.anInt5217 != 128 || this.anInt5211 * -64059883 != 128)
		class387_18_.oa(-1869386025 * this.anInt5217, this.anInt5211 * -64059883, -1869386025 * this.anInt5217);
	    if (-614140193 * this.anInt5212 != 0) {
		if (this.anInt5212 * -614140193 == 90)
		    class387_18_.f(4096);
		if (-614140193 * this.anInt5212 == 180)
		    class387_18_.f(8192);
		if (270 == -614140193 * this.anInt5212)
    ...
    Class398() {
	this.anInt5211 = -2062770560;
	this.anInt5212 = 0;
	this.anInt5213 = 0;
	this.anInt5214 = 0;
	aBoolean5215 = false;
	aByte5216 = (byte) 0;
	this.anInt5203 = -48388469;
    }
	...
	try {
		...
		return true;
	    return (this.aClass389_5210.aClass243_4160.method2290(-283549117 * this.anInt5204, 0, -676484272));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		class298_sub36.out.writeByte(Class58.method693(string, 1482909411));
		class298_sub36.out.writeString(string, 2132300359);
	...
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub28_7573, (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) != 0 ? 1 : 0, -856880407);
