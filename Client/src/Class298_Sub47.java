...
public class Class298_Sub47 extends Class298 {
	...
	try {
		...
		if (class365_sub1_sub1_sub2_sub2 == Class287.myPlayer) {
			...
			String string_3_ = (client.gametype == Class411.game_stellardawn ? (Tradution.aClass470_5928.method6049(Class321.aClass429_3357, -875414210)) : (Tradution.aClass470_5911.method6049(Class321.aClass429_3357, -875414210)));
			...
			Class234.method2174(client.aString8838, new StringBuilder().append(client.aString8754).append(" ").append(Class26.aString351).append(" ").append(Class285.method2709(16777215, -1806308451)).append(string).toString(), 697885143 * Class240.anInt2704, 15, -1, 1888274983 * (class365_sub1_sub1_sub2_sub2.anInt10064), 0, 0, true, false, 1888274983 * (class365_sub1_sub1_sub2_sub2.anInt10064), false, -2028889244);
		    if (!bool) {
			for (int i_4_ = 9; i_4_ >= 0; i_4_--) {
			    if (client.aStringArray8820[i_4_] != null) {
				short i_5_ = 0;
				if ((client.gametype == Class411.game_rs) && (client.aStringArray8820[i_4_].equalsIgnoreCase(Tradution.aClass470_5906.method6049(Class321.aClass429_3357, -875414210)))) {
				...
				Class234.method2174(client.aStringArray8820[i_4_], new StringBuilder().append(Class285.method2709(16777215, -1822012281)).append(string).toString(), i_7_, i_6_, -1, 1888274983 * (class365_sub1_sub1_sub2_sub2.anInt10064), 0, 0, true, false, (class365_sub1_sub1_sub2_sub2.anInt10064) * 1888274983, false, -1451194858);
			    }
			}
		    } else
			Class234.method2174(new StringBuilder().append(Class285.method2709(13421772, -1997294576)).append(string).toString(), "", -1, -1, 0, 0L, 0, 0, false, true, class365_sub1_sub1_sub2_sub2.anInt10064 * 1888274983, false, -1271989822);
		    if (!bool) {
			for (Class298_Sub37_Sub15 class298_sub37_sub15 = ((Class298_Sub37_Sub15) Class436.aClass453_5480.method5939(1766612795)); class298_sub37_sub15 != null; class298_sub37_sub15 = ((Class298_Sub37_Sub15) Class436.aClass453_5480.method5944(49146))) {
			    if (23 == 946432351 * (class298_sub37_sub15.anInt9662)) {
				class298_sub37_sub15.aString9669 = new StringBuilder().append(Class285.method2709(16777215, -1702215598)).append(string).toString();
				break;
			    }
			}
		    }
