...
public class IndexedImage {
    ...
    public static IndexedImage method979(Class243 class243, int i) {
    ...
    public static IndexedImage[] method981(Class243 class243, int i) {
    ...
    public static IndexedImage[] method982(byte[] is) {
	...
	IndexedImage[] class89s = new IndexedImage[i];
	for (int i_9_ = 0; i_9_ < i; i_9_++)
	    class89s[i_9_] = new IndexedImage();
	...
	for (int i_21_ = 0; i_21_ < i; i_21_++) {
	    IndexedImage class89 = class89s[i_21_];
    ...
    public static IndexedImage method987(Class243 class243, int i, int i_81_) {
	byte[] is = class243.getFile(i, i_81_);
	if (is == null)
	    return null;
	return method982(is)[0];
    }
