...
public class Class148 implements Interface23 {
	...
	try {
	    ConfigDefinitions defs = Class472.aClass314_5965.getConfigDefinitions(configId, -781710328);
	    int varpId = defs.anInt3469 * -50358139;
	    int fromBitshift = defs.anInt3468 * -1528472107;
	    int tillBitshift = 1394539663 * defs.anInt3470;
	    int i_6_ = anIntArray6650[tillBitshift - fromBitshift];
	    if (i_1_ < 0 || i_1_ > i_6_)
		i_1_ = 0;
	    i_6_ <<= fromBitshift;
	    method1605(varpId, (this.anIntArray6652[varpId] & (i_6_ ^ 0xffffffff) | i_1_ << fromBitshift & i_6_), (byte) 16);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    this.aClass437_6647 = new HashTable(128);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class298_Sub33 class298_sub33 = ((Class298_Sub33) this.aClass437_6647.method5812(i));
		...
		this.aClass437_6647.method5817(class298_sub33, i);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    for (Class298_Sub33 class298_sub33 = (Class298_Sub33) (bool ? this.aClass437_6647.method5816(1646690306) : this.aClass437_6647.method5815((byte) 18)); class298_sub33 != null; class298_sub33 = (Class298_Sub33) this.aClass437_6647.method5815((byte) -66)) {
		if ((class298_sub33.aLong7385 * -959724544626478745L & 0x3fffffffffffffffL) < l) {
			...
			int i_24_ = (int) (7051297995265073167L * class298_sub33.hash);
			anIntArray6654[i_24_] = this.anIntArray6652[i_24_];
    ...
    static final void method1608(Class403 class403, byte i) {
	try {
	    int i_29_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
    ...
    static final void method1609(Class403 class403, byte i) {
	try {
	    int i_30_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
    ...
    static final void method1610(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.anInt8665 * -1154804873;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1611(Class403 class403, short i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8680 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1613(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_32_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    int i_33_ = (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class298_Sub1.method2845(i_32_, i_33_, false, false, 1482071907);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		int i_34_ = 1898544019 * Class291.anInt6473;
		int i_35_ = 540368727 * Class291.anInt6474;
		int i_36_ = (Class78.anInt733 * -639974669 - Class462.anInt5683 * -2110394505 - i_34_);
		int i_37_ = (1282634425 * Class291.anInt6472 - -1111710645 * Class298_Sub40_Sub9.anInt9716 - i_35_);
		if (i_34_ > 0 || i_36_ > 0 || i_35_ > 0 || i_37_ > 0) {
			...
			if (i_34_ > 0)
			    graphics.fillRect(i_38_, i_39_, i_34_, Class291.anInt6472 * 1282634425);
			if (i_35_ > 0)
			    graphics.fillRect(i_38_, i_39_, -639974669 * Class78.anInt733, i_35_);
			if (i_36_ > 0)
			    graphics.fillRect((i_38_ + Class78.anInt733 * -639974669 - i_36_), i_39_, i_36_, Class291.anInt6472 * 1282634425);
			if (i_37_ > 0)
			    graphics.fillRect(i_38_, (Class291.anInt6472 * 1282634425 + i_39_ - i_37_), -639974669 * Class78.anInt733, i_37_);
		    }
    ...
    static final void method1615(Class403 class403, byte i) {
	try {
	    int i_40_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
    ...
    static final void method1616(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
	    class105.anInt1284 = (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) * -1066050969;
	    Tradution.method6054(class105, 2100669842);
	    if (-1 == class105.anInt1154 * -1309843523 && !class119.aBoolean1403)
		Class509.method6286(class105.ihash * -440872681, -1977969421);
	}
	catch (RuntimeException runtimeexception) {
