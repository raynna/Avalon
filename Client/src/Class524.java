...
public class Class524 implements Runnable {
	...
	this.anInetAddress6294 = InetAddress.getByAddress(new byte[] { (byte) (i >> 24 & 0xff), (byte) (i >> 16 & 0xff), (byte) (i >> 8 & 0xff), (byte) (i & 0xff) });
    }

    @Override
    public void run() {
	try {
	    this.aString6293 = this.anInetAddress6294.getHostName();
	}
	catch (RuntimeException runtimeexception) {
