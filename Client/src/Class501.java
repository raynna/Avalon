...
public final class Class501 {
	...
	try {
	    ...
	    int i_2_ = i_1_ & (this.aWeakReference_Sub1Array6121.length - 1);
	    WeakReference_Sub1 weakreference_sub1 = this.aWeakReference_Sub1Array6121[i_2_];
	    if (weakreference_sub1 == null) {
		this.aWeakReference_Sub1Array6121[i_2_] = new WeakReference_Sub1(object, (this.aReferenceQueue6120), i_1_, object_0_);
		...
		for (;;) {
			...
			weakreference_sub1.aWeakReference_Sub1_6302 = new WeakReference_Sub1(object, (this.aReferenceQueue6120), i_1_, object_0_);
			this.anInt6118 += -1233820543;
	...
	try {
	    for (;;) {
		WeakReference_Sub1 weakreference_sub1 = ((WeakReference_Sub1) this.aReferenceQueue6120.poll());
		if (weakreference_sub1 == null)
		    break;
	...
	try {
	    ...
	    Class287.myPlayer.method4341(client.aClass283_8716.method2629(-1895849411) * 512 / 2, 0.0F, client.aClass283_8716.method2630(501771104) * 512 / 2);
    ...
    static final void method6228(Class403 class403, byte i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 1354508417 * class105.anInt1143;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		class365_sub1_sub1_sub2_sub2.anInt10090 = -790543005 * class410.anInt5285;
	...
	try {
	    Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(2, i);
