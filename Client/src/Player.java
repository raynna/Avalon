...
public class Player extends Entity {
	...
	try {
	    ...
	    class217.aFloat2451 += getSize() - i_2_ << 8;
	    class217.aFloat2454 += getSize() - i_2_ << 8;
	    method4340(class217);
	    class217.method2006();
	    if (bool_3_)
		this.aString10199 = stream.readJagString(681479919);
	    else
		this.aString10199 = null;
	    if (bool_4_)
		...
		if (1 != Class82_Sub18.aClass405_6892.anIntArray5267[i_6_]) {
			...
			int firstShort = (i_7_ << 8) + i_8_;
			if (i_6_ == 0 && 65535 == firstShort) {
			...
			if (firstShort >= 16384) {
			    firstShort -= 16384;
			    // firstShort = Class519.anIntArray6274[firstShort -
			    // 32768];
			    is[i_6_] = firstShort | 0x40000000;
			    class468s[i_6_] = Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(firstShort);
			    int i_10_ = class468s[i_6_].anInt5700 * 1832088845;
			    if (0 != i_10_)
				anInt10208 = 1076333291 * i_10_;
			} else
			    is[i_6_] = firstShort - 256 | ~0x7fffffff;
		    }
		}
	    }
	    if (-1 == i_5_) {
	    ...
	    this.anInt10216 = stream.readUnsignedShort() * 148972467;
		...
		class217.aFloat2451 = (scenePositionXQueue[0] << 9) + (getSize() << 8);
		class217.aFloat2454 = (scenePositionYQueue[0] << 9) + (getSize() << 8);
		method4340(class217);
		class217.method2006();
	    }
	...
	try {
		...
		this.anInt10122 = (int) (-661498661 * (this.anInt10122) - i_28_ / 10.0F) * 1394444115;
	    } else
		this.anInt10122 = (int) ((this.anInt10122) * -661498661 - (this.anInt10122) * -661498661 / 10.0F) * 1394444115;
	    class222.method2070(class222_26_);
	    class222.method2064(0.0F, -20 - (-661498661 * this.anInt10122), 0.0F);
		...
		if (class350.aBoolean3756 && (164936249 * aClass366_10209.anInt3974 == -1 || (Class15.aClass507_224.method6269(aClass366_10209.anInt3974 * 164936249, -465726953).aBoolean6165))) {
		    ...
		    Class387 class387 = (Class283.method2678(class_ra, i_27_, -155466425 * (this.anInt10097), -197572281 * (this.anInt10073), -104151209 * (this.anInt10074), 1, aClass387Array10082[0], 0, 0, 160, 240, class438_29_ != null ? class438_29_ : class438, 1812843484));
		    if (null != class387) {
		...
		for (int i_30_ = client.aClass19Array8869.length - 1; i_30_ >= 0; i_30_--) {
			...
			if (958933333 * class19.anInt266 == 1) {
				...
				method4468(class_ra, class222, aClass387Array10082[0], i_31_, i_32_, class19.anInt263 * 408071539, 92160000L);
			    }
			}
			if (2 == class19.anInt266 * 958933333) {
			    Class217 class217 = (Class287.myPlayer.method4337().aClass217_2599);
			    long l = -1338192389 * class19.anInt260 - (int) class217.aFloat2451;
			    long l_33_ = class19.anInt261 * 1018128075 - (int) class217.aFloat2454;
			    long l_34_ = 2140036693 * class19.anInt257 << 9;
			    l_34_ *= l_34_;
			...
			if (10 == class19.anInt266 * 958933333 && -841622081 * class19.anInt256 >= 0 && (-841622081 * class19.anInt256 < (client.aClass365_Sub1_Sub1_Sub2_Sub2Array8805).length)) {
				...
				method4468(class_ra, class222, aClass387Array10082[0], i_36_, i_37_, 408071539 * class19.anInt263, 92160000L);
			    }
			}
		    }
		}
	    ...
	    class222.method2070(class222_26_);
	    class222.method2064(0.0F, -5 - (-661498661 * this.anInt10122), 0.0F);
	    ...
	    if (null != this.aClass351_10067) {
		Class69 class69 = this.aClass351_10067.method4229();
		class_ra.method5042(class69);
	    }
	    for (int i_39_ = 0; i_39_ < aClass387Array10082.length; i_39_++) {
		if (null != aClass387Array10082[i_39_])
		    this.aBoolean10129 |= aClass387Array10082[i_39_].i();
    ...
    @Override
    int method4438() {
	return this.anInt10216 * 613696379;
    }
	...
	try {
		...
		int i_43_ = ((int) ((Math.atan2(l, l_40_) * 2607.5945876176133) - aClass386_10084.method4719((byte) 0)) & 0x3fff);
		Class387 class387_44_ = (Class219.method2044(class_ra, i_43_, (this.anInt10097 * -155466425), (-197572281 * this.anInt10073), (this.anInt10074 * -104151209), i, -2134746538));
	...
	try {
	    ...
	    boolean bool = (0 != aByte10130 && 443738891 * client.ticketCycle >= anInt10105 * 1920148979 && 443738891 * client.ticketCycle < 1953154657 * anInt10106);
	    if (bool)
		i |= 0x80000;
		...
		if ((this.anInt10097 * -155466425) != 0)
		    class387.t(-155466425 * this.anInt10097);
	...
	try {
	    String string = "";
	    if (this.aString10199 != null)
		string = this.aString10199;
	    if (bool)
	    ...
	    if (null != this.aString10197)
		string = new StringBuilder().append(string).append(this.aString10197).toString();
	    return string;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    int i_59_ = getSize();
	    Class217 class217 = Class217.method2005(method4337().aClass217_2599);
	    class217.aFloat2451 = 256 * i_59_ + scenePositionXQueue[0] * 512;
	    class217.aFloat2454 = i_59_ * 256 + scenePositionYQueue[0] * 512;
	    method4340(class217);
	    class217.method2006();
	    if (this == Class287.myPlayer)
	...
	Class326 class326 = (aClass331_7722.aClass326ArrayArrayArray3516[plane][(int) class235.aClass217_2599.aFloat2451 >> 9][(int) class235.aClass217_2599.aFloat2454 >> 9]);
	if (null != class326 && null != class326.aClass365_Sub1_Sub2_3461) {
	    int i_75_ = ((this.anInt10122 * -661498661) - class326.aClass365_Sub1_Sub2_3461.aShort9801);
	    this.anInt10122 = (int) (-661498661 * (this.anInt10122) - i_75_ / 10.0F) * 1394444115;
	} else
	    this.anInt10122 = (int) ((this.anInt10122) * -661498661 - (this.anInt10122) * -661498661 / 10.0F) * 1394444115;
	...
	if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub18_7561.method5693(-1650118723) == 1) {
		...
		Class387 class387 = (Class283.method2678(class_ra, i, (-155466425 * this.anInt10097), (-197572281 * this.anInt10073), (-104151209 * this.anInt10074), 1, aClass387Array10082[0], 0, 0, 160, 240, class438_76_ != null ? class438_76_ : class438, 1812843484));
		if (null != class387) {
		    if (null == aClass302_Sub1Array7726 || (aClass302_Sub1Array7726.length < 1 + aClass387Array10082.length))
	...
	if (this == Class287.myPlayer) {
		...
		if (null != class19 && class19.anInt263 * 408071539 != -1) {
			...
			if (null != class298_sub29) {
			    ...
			    method4468(class_ra, class222, aClass387Array10082[0], i_78_, i_79_, class19.anInt263 * 408071539, 92160000L);
			}
		    }
		    if (2 == class19.anInt266 * 958933333) {
			Class217 class217 = (Class287.myPlayer.method4337().aClass217_2599);
			long l = -1338192389 * class19.anInt260 - (int) class217.aFloat2451;
			long l_80_ = class19.anInt261 * 1018128075 - (int) class217.aFloat2454;
			long l_81_ = 2140036693 * class19.anInt257 << 9;
			l_81_ *= l_81_;
			...
			if (class365_sub1_sub1_sub2_sub2_82_ != null) {
			    ...
			    method4468(class_ra, class222, aClass387Array10082[0], i_83_, i_84_, 408071539 * class19.anInt263, 92160000L);
			}
		    }
		}
	    }
	...
	for (int i_86_ = 0; i_86_ < aClass387Array10082.length; i_86_++) {
		...
		this.aBoolean10129 |= aClass387Array10082[i_86_].i();
	...
	if (null != aClass366_10209 && (this.aBoolean10128 || method4469(class_ra, 0, (byte) 83))) {
	    Class222 class222 = class_ra.method5178();
	    class222.method2054(method4337());
	    class222.method2064(0.0F, -5.0F, 0.0F);
	    method4445(class_ra, aClass387Array10082, class222, this.aBoolean10128, -639077471);
	...
	try {
		...
		if (null == (this.aClass62_10118).aString608)
		    return null;
	...
	if (null != aClass366_10209 && (this.aBoolean10128 || method4469(class_ra, 0, (byte) -3))) {
	    Class222 class222 = class_ra.method5178();
	    class222.method2054(method4337());
	    class222.method2064(0.0F, -5.0F, 0.0F);
	    method4445(class_ra, aClass387Array10082, class222, this.aBoolean10128, -758371208);
	    for (int i = 0; i < aClass387Array10082.length; i++)
		aClass387Array10082[i] = null;
	}
    }
	...
	try {
	    if (null != aClass366_10209 && (this.aBoolean10128 || method4469(class_ra, 0, (byte) 34))) {
		Class222 class222 = class_ra.method5178();
		class222.method2054(method4337());
		class222.method2064(0.0F, -5.0F, 0.0F);
		method4445(class_ra, aClass387Array10082, class222, this.aBoolean10128, 1138059762);
