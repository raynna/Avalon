...
public class Class431 implements Interface15 {
	...
	return this.aClass_ra6503.method5030(is, i, i_0_, i_1_, i_2_, false);
    }

    @Override
    public Object method212(int[] is, int i, int i_3_, int i_4_, int i_5_, boolean bool) {
	return this.aClass_ra6503.method5030(is, i, i_3_, i_4_, i_5_, false);
    }

    @Override
    public Object method214(int[] is, int i, int i_6_, int i_7_, int i_8_, boolean bool, int i_9_) {
	try {
	    return this.aClass_ra6503.method5030(is, i, i_6_, i_7_, i_8_, false);
	}
	...
	return this.aClass_ra6503.method5030(is, i, i_10_, i_11_, i_12_, false);
    }
    ...
    static final void method5765(Class403 class403, int i) {
	try {
	...
	try {
	    ...
	    Class360.aClass25_3905.anInt336 = 0;
