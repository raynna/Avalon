...
public class Class139 {
    ...
    static final void method1546(Class403 class403, int i) {
	try {
    ...
    static final void method1547(Class403 class403, byte i) {
	try {
	    int i_4_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    MapDetails class298_sub37_sub13 = Class301.method3708(i_4_ >> 14 & 0x3fff, i_4_ & 0x3fff);
	    if (class298_sub37_sub13 == null)
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = -1;
	    else
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = class298_sub37_sub13.fileId * -947282109;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1550(Class403 class403, byte i) {
	try {
    ...
    static final void method1551(Class403 class403, int i) {
	try {
