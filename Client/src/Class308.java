...
public abstract class Class308 {
	...
	try {
		...
		if (this.aClass298_Sub24_Sub4_3280 == null) {
		    for (Class298_Sub24 class298_sub24 = (Class298_Sub24) this.aClass437_3279.method5816(1591555400); null != class298_sub24; class298_sub24 = (Class298_Sub24) this.aClass437_3279.method5815((byte) -51)) {
	...
	try {
	    for (Class298_Sub24 class298_sub24 = (Class298_Sub24) this.aClass437_3279.method5816(2015139315); null != class298_sub24; class298_sub24 = (Class298_Sub24) this.aClass437_3279.method5815((byte) 5)) {
		if (!(class298_sub24 instanceof Class298_Sub24_Sub4)) {
		    if (i <= 0) {
			/* empty */
		    }
		    ...
		    Class298_Sub24_Sub4 class298_sub24_sub4 = (Class298_Sub24_Sub4) class298_sub24;
		    while (((class298_sub24_sub4.anInt7352) * -1312498565 <= 8 || (method3779((short) 30482) > class298_sub24_sub4.method3093(-136313953))) && (class298_sub24_sub4.anOggStreamState7351.packetOut(this.anOggPacket3272)) == 1)
	...
	try {
		...
		return (!this.aClass298_Sub24_Sub3_3278.method3087(-1737998296) || (method3779((short) 7060) > this.aClass298_Sub24_Sub3_3278.method3085(-2077117247)));
	    double d = this.aClass298_Sub24_Sub3_3278.method3084(-1240396603);
	    return (0.0 == d || (Class122.method1319((byte) 1) >= this.aClass298_Sub24_Sub3_3278.method3086((byte) 0) + 1000.0 / d));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    for (Class298_Sub24 class298_sub24 = (Class298_Sub24) this.aClass437_3279.method5816(2104844471); null != class298_sub24; class298_sub24 = (Class298_Sub24) this.aClass437_3279.method5815((byte) -42)) {
	...
	try {
		...
		for (Class298_Sub24 class298_sub24 = (Class298_Sub24) this.aClass437_3279.method5816(1658578802); class298_sub24 != null; class298_sub24 = (Class298_Sub24) this.aClass437_3279.method5815((byte) -74)) {
	...
	try {
		...
		return false;
	    if (null != this.aClass298_Sub24_Sub1_3268 && this.aClass298_Sub24_Sub1_3268.method3083(-693943954) > 0)
		return false;
	    return true;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		do {
			...
			break while_75_;
		    i_1_ = method3775(this.aByteArray3270, -2116572420);
		    if (-1 == i_1_) {
		...
		this.aClass437_3279.method5817(class298_sub24, i_2_);
		return class298_sub24;
	    }
	    Class298_Sub24 class298_sub24 = ((Class298_Sub24) this.aClass437_3279.method5812(i_2_));
	...
	try {
	    if (null != this.aClass298_Sub24_Sub1_3268) {
		Class298_Sub19_Sub3 class298_sub19_sub3 = this.aClass298_Sub24_Sub1_3268.method3082(-840425248);
	...
	try {
		...
		while_77_: for (/**/; !this.aBoolean3276; this.aBoolean3281 = false) {
			...
			class298_sub24 = ((Class298_Sub24) (this.aClass437_3279.method5812(this.anOggPage3271.getSerialNumber())));
	...
	this.aClass437_3279 = new HashTable(8);
    }
	...
	try {
	    ...
	    int i_13_ = -i_8_;
	    int i_14_ = -1;
	    int i_15_ = Class463.method6012(i_8_ + i, Class372.anInt4051 * -1424479739, Class372.anInt4048 * 1135094847, -1212608691);
	    int i_16_ = Class463.method6012(i - i_8_, Class372.anInt4051 * -1424479739, 1135094847 * Class372.anInt4048, -1212608691);
	    Class82_Sub22.method940(Class372.anIntArrayArray4047[i_7_], i_16_, i_15_, i_9_, 410046201);
	    while (i_12_ > i_11_) {
		i_14_ += 2;
		i_13_ += i_14_;
		if (i_13_ > 0) {
		    ...
		    if (i_18_ >= 1155384281 * Class372.anInt4049 && i_17_ <= Class372.anInt4050 * -1062447355) {
			int i_19_ = Class463.method6012(i_11_ + i, (Class372.anInt4051 * -1424479739), (1135094847 * Class372.anInt4048), -1212608691);
			int i_20_ = Class463.method6012(i - i_11_, (-1424479739 * Class372.anInt4051), (Class372.anInt4048 * 1135094847), -1212608691);
			if (i_18_ <= Class372.anInt4050 * -1062447355)
			    Class82_Sub22.method940((Class372.anIntArrayArray4047[i_18_]), i_20_, i_19_, i_9_, 483446032);
			if (i_17_ >= 1155384281 * Class372.anInt4049)
			    Class82_Sub22.method940((Class372.anIntArrayArray4047[i_17_]), i_20_, i_19_, i_9_, 694694186);
		    }
		}
		i_11_++;
		int i_21_ = i_7_ - i_11_;
		int i_22_ = i_11_ + i_7_;
		if (i_22_ >= 1155384281 * Class372.anInt4049 && i_21_ <= -1062447355 * Class372.anInt4050) {
		    int i_23_ = Class463.method6012(i_12_ + i, (-1424479739 * Class372.anInt4051), (Class372.anInt4048 * 1135094847), -1212608691);
		    int i_24_ = Class463.method6012(i - i_12_, (Class372.anInt4051 * -1424479739), 1135094847 * (Class372.anInt4048), -1212608691);
		    if (i_22_ <= Class372.anInt4050 * -1062447355)
			Class82_Sub22.method940((Class372.anIntArrayArray4047[i_22_]), i_24_, i_23_, i_9_, -698175360);
		    if (i_21_ >= Class372.anInt4049 * 1155384281)
			Class82_Sub22.method940((Class372.anIntArrayArray4047[i_21_]), i_24_, i_23_, i_9_, -1368687138);
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method3783(Class403 class403, int i) {
	try {
