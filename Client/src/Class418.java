...
public final class Class418 {
    ...
    static final void method5596(Class403 class403, byte i) {
	try {
	    IComponentDefinition class105 = Class50.getIComponentDefinitions((class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]), (byte) -64);
    ...
    static void method5597(Class403 class403, byte i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (class369.anIntArrayArray4017 == null ? 0 : class369.anIntArrayArray4017.length);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method5599(Class403 class403, int i) {
	try {
	...
	try {
	    Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(17, i);
	...
	try {
	    Class298_Sub9.aClass437_7224.method5811((byte) -68);
	}
	catch (RuntimeException runtimeexception) {
