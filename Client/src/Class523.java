...
final class Class523 implements Interface17 {
    ...
    static final void method6329(IComponentDefinition class105, Class403 class403, int i) {
	try {
	    int i_0_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    int i_1_ = ((class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) - 1);
	    if (2 != 1548853569 * class105.anInt1184)
		throw new RuntimeException("");
	    NPCDefinitions class503 = Class15.aClass507_224.method6269(class105.anInt1151 * 572201537, -87546938);
	...
	try {
		...
		int i_4_ = class105.ihash * -440872681 >>> 16;
		...
		for (Interface class298_sub51 = (Interface) class460.method5979(-2012602178); null != class298_sub51; class298_sub51 = (Interface) class460.next()) {
			...
			return Class50.getIComponentDefinitions((int) (7051297995265073167L * (class298_sub51.hash)), (byte) -3);
		}
	    }
	    return null;
	}
	...
	try {
		...
		class298_sub50_sub1.anInt9736 = -435781441 * i;
		class298_sub50_sub1.anInt9737 = i_5_ * -871010593;
		class298_sub50_sub1.anInt9738 = i_6_ * -25797095;
		class298_sub50_sub1.aLong9739 = -8923914877553624531L * l;
		class298_sub50_sub1.anInt9740 = i_7_ * 1687973955;
