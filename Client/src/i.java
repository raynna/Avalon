...
public class i extends Class_xa implements Interface25 {
	...
	this.aJa6678 = var_ja;
	G(this.aJa6678, var_ba, i, i_0_, anIntArrayArray6290, is_1_, i_2_, i_3_, i_4_);
    }
	...
	int i_74_ = 0;
	float[] fs = new float[this.aClass453_6679.method5948(1828905535)];
	for (Class298_Sub10 class298_sub10 = ((Class298_Sub10) this.aClass453_6679.method5939(1766612795)); class298_sub10 != null; class298_sub10 = ((Class298_Sub10) this.aClass453_6679.method5944(49146)))
	...
	for (int i_75_ = 0; i_75_ < i_72_ + i_72_; i_75_++) {
		...
		if (bools[i_75_][i_76_]) {
			...
			this.aJa6678.method5571().method281(this, i_77_, i_78_);
		}
	    }
	}
    }
	...
	this.aJa6678.method5571().method282(this, i, i_79_, i_80_, i_81_, i_82_, i_83_, i_84_, bools);
    }
	...
	this.aJa6678.method5571().method282(this, i, i_89_, i_90_, i_91_, i_92_, i_93_, i_94_, bools);
    }
	...
	this.aClass453_6679.add(class298_sub10);
	...
	for (int i_134_ = 0; i_134_ < i_131_ + i_131_; i_134_++) {
		...
		if (bools[i_134_][i_135_]) {
			...
			this.aJa6678.method5571().method281(this, i_136_, i_137_);
		}
	    }
	}
    }
	...
	for (int i_142_ = 0; i_142_ < i_139_ + i_139_; i_142_++) {
		...
		if (bools[i_142_][i_143_]) {
			...
			this.aJa6678.method5571().method281(this, i_144_, i_145_);
		}
	    }
	}
    }
	...
	this.aJa6678.method5571().method282(this, i, i_178_, i_179_, i_180_, i_181_, i_182_, i_183_, bools);
    }

    @Override
    public void method6351(int i, int i_184_, int i_185_, int i_186_, int i_187_, int i_188_, int i_189_, boolean[][] bools) {
	this.aJa6678.method5571().method282(this, i, i_184_, i_185_, i_186_, i_187_, i_188_, i_189_, bools);
    }

    @Override
    public void method6352(int i, int i_190_, int i_191_, int i_192_, int i_193_, int i_194_, int i_195_, boolean[][] bools) {
	this.aJa6678.method5571().method282(this, i, i_190_, i_191_, i_192_, i_193_, i_194_, i_195_, bools);
    }
	...
	this.aJa6678.method5571().method282(this, i, i_281_, i_282_, i_283_, i_284_, i_285_, i_286_, bools);
    }
