...
public class Class330 implements Runnable {
    ...
    static final void method4002(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (Class287.myPlayer.anInt10206 * 696798311);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4003(Class403 class403, int i) {
	try {
    ...
    static final void method4004(Class403 class403, int i) {
	try {
	    class403.aLongArray5235[(class403.anIntArray5257[class403.anInt5259 * 1883543357])] = (class403.aLongArray5251[((class403.anInt5245 -= -682569305) * 1685767703)]);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final boolean method4006(int i, int i_6_, PathStrategy class336, Class289 class289, int i_7_) {
	try {
	    int i_8_ = i;
	    int i_9_ = i_6_;
	    int i_10_ = 64;
