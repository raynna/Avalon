...
public final class Class315 {
    static LobbyPathStrategy lobbynpcsstrategy;
    static RectangleOverlapStrategy rectoverlapstrategy;
    static short aShort3306;
    static ExactStrategy exactdestinationstrategy = new ExactStrategy();
    static ObjectCheckStrategyClosest objcheckstrategyclosest;
    static ObjectCheckStrategyExact objcheckstrategyexact;
    static EntityStrategy entitystrategy;
    ...
    static {
	rectoverlapstrategy = new RectangleOverlapStrategy();
	entitystrategy = new EntityStrategy();
	lobbynpcsstrategy = new LobbyPathStrategy();
	objcheckstrategyclosest = new ObjectCheckStrategyClosest();
	objcheckstrategyexact = new ObjectCheckStrategyExact();
    }
	...
	try {
		...
		int i_13_ = 134435705 * ClanSettings.baseTileX + (i_12_ >> 4 & 0x7);
		...
		int i_19_ = (i_18_ >> 4 & 0x7) + 134435705 * ClanSettings.baseTileX;
		...
		if (i_16_ == -1976050083 * GameObjectType.T11.type)
		    i_16_ = GameObjectType.T10.type * -1976050083;
		int i_23_ = 0;
		...
		int i_38_ = (i_37_ >> 4 & 0x7) + 134435705 * ClanSettings.baseTileX;
		...
		int i_41_ = ClanSettings.baseTileX * 134435705 + (i_40_ >> 3 & 0x7);
		...
		if (client.aClass283_8716.method2674(-135283377) != Class266.aClass266_2846) {
			...
			i_48_ <<= 2;
			i_52_ <<= 2;
			Class365_Sub1_Sub1_Sub1 class365_sub1_sub1_sub1 = (new Class365_Sub1_Sub1_Sub1(client.aClass283_8716.method2675(-1611682495), i_46_, -191892109 * Class375.basePlane, Class375.basePlane * -191892109, i_41_, i_42_, i_47_, i_49_ + client.ticketCycle * 443738891, client.ticketCycle * 443738891 + i_50_, i_51_, i_52_, 0, i_45_, i_48_, bool, -1));
			class365_sub1_sub1_sub1.method4405(i_43_, i_44_, Class356.method4271(i_43_, i_44_, (-191892109 * Class375.basePlane), -1671970391) - i_48_, 443738891 * client.ticketCycle + i_49_, -53743739);
		...
		int i_56_ = ClanSettings.baseTileX * 134435705 + (i_53_ >> 4 & 0x7);
		...
		int i_65_ = (i_62_ >> 4 & 0x7) + 134435705 * ClanSettings.baseTileX;
		...
		if (null != client.aClass437_8685) {
		    Class298_Sub2 class298_sub2 = ((Class298_Sub2) (client.aClass437_8685.method5812(-191892109 * Class375.basePlane << 28 | i_64_ << 14 | i_66_)));
			...
			for (Class298_Sub12 class298_sub12 = ((Class298_Sub12) class298_sub2.aClass453_7166.method5939(1766612795)); null != class298_sub12; class298_sub12 = (Class298_Sub12) class298_sub2.aClass453_7166.method5944(49146)) {
				...
				class298_sub12.method2839(-1460969981);
		...
		int i_71_ = (i_70_ >> 4 & 0x7) + ClanSettings.baseTileX * 134435705;
		...
		int i_77_ = 134435705 * ClanSettings.baseTileX + (i_76_ >> 4 & 0x7);
		...
		int i_90_ = ClanSettings.baseTileX * 134435705 + (i_87_ >> 4 & 0x7);
		...
		int i_93_ = 268871410 * ClanSettings.baseTileX + (i_92_ >> 4 & 0xf);
		...
		int i_110_ = ClanSettings.baseTileX * 134435705 + (i_109_ >> 4 & 0x7);
		...
		int i_121_ = 134435705 * ClanSettings.baseTileX + (i_120_ >> 4 & 0x7);
		...
		if (client.aClass283_8716.method2674(1544127575) != Class266.aClass266_2846) {
			...
			if (-1 == i_123_) {
			    Class298_Sub37_Sub3 class298_sub37_sub3 = ((Class298_Sub37_Sub3) (client.aClass437_8825.method5812(i_121_ << 16 | i_122_)));
			    ...
			    client.aClass437_8825.method5817((new Class298_Sub37_Sub3(class365_sub1_sub1_sub3)), i_121_ << 16 | i_122_);
			}
		    }
		}
	    } else if (SubIncommingPacket.aClass206_2342 == class206) {
		int i_130_ = class298_sub53_sub2.readUnsignedByte();
		int i_131_ = (i_130_ >> 4 & 0x7) + 134435705 * ClanSettings.baseTileX;
		...
		if (client.aClass283_8716.method2674(39884684) != Class266.aClass266_2846) {
			...
			if ((Class287.myPlayer.scenePositionXQueue[0]) >= i_131_ - i_140_ && (Class287.myPlayer.scenePositionXQueue[0]) <= i_140_ + i_131_ && (Class287.myPlayer.scenePositionYQueue[0]) >= i_132_ - i_140_ && (Class287.myPlayer.scenePositionYQueue[0]) <= i_140_ + i_132_)
			    RectangleOverlapStrategy.method4103(i_133_, i_136_, i_137_, i_138_, ((i_131_ << 16) + ((-191892109 * Class375.basePlane) << 24) + (i_132_ << 8) + i_135_), bool, i_139_, -889648047);
		    }
		}
		...
		int i_145_ = 134435705 * ClanSettings.baseTileX + (i_142_ >> 4 & 0x7);
		int i_146_ = i_145_ + -1760580017 * class341.gameSceneBaseX;
		Class298_Sub2 class298_sub2 = ((Class298_Sub2) (client.aClass437_8685.method5812(Class375.basePlane * -191892109 << 28 | i_144_ << 14 | i_146_)));
		if (class298_sub2 != null) {
	...
	try {
	    if (i_148_ <= Class372.anInt4050 * -1062447355 && i_149_ >= 1155384281 * Class372.anInt4049) {
		boolean bool;
		if (i < Class372.anInt4051 * -1424479739) {
		    i = Class372.anInt4051 * -1424479739;
		    bool = false;
		} else if (i > Class372.anInt4048 * 1135094847) {
		    i = 1135094847 * Class372.anInt4048;
		    bool = false;
		} else
		    bool = true;
		boolean bool_152_;
		if (i_147_ < -1424479739 * Class372.anInt4051) {
		    i_147_ = -1424479739 * Class372.anInt4051;
		    bool_152_ = false;
		} else if (i_147_ > Class372.anInt4048 * 1135094847) {
		    i_147_ = 1135094847 * Class372.anInt4048;
		    bool_152_ = false;
		} else
		    bool_152_ = true;
		if (i_148_ >= Class372.anInt4049 * 1155384281)
		    Class82_Sub22.method940((Class372.anIntArrayArray4047[i_148_++]), i, i_147_, i_150_, -1668539966);
		else
		    i_148_ = Class372.anInt4049 * 1155384281;
		if (i_149_ <= -1062447355 * Class372.anInt4050)
		    Class82_Sub22.method940((Class372.anIntArrayArray4047[i_149_--]), i, i_147_, i_150_, 172166528);
		else
		    i_149_ = -1062447355 * Class372.anInt4050;
		if (bool && bool_152_) {
		    for (int i_153_ = i_148_; i_153_ <= i_149_; i_153_++) {
			int[] is = Class372.anIntArrayArray4047[i_153_];
			is[i] = is[i_147_] = i_150_;
		    }
		} else if (bool) {
		    for (int i_154_ = i_148_; i_154_ <= i_149_; i_154_++)
			Class372.anIntArrayArray4047[i_154_][i] = i_150_;
		} else if (bool_152_) {
		    for (int i_155_ = i_148_; i_155_ <= i_149_; i_155_++)
			Class372.anIntArrayArray4047[i_155_][i_147_] = i_150_;
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    int i_168_ = -1;
	    int i_169_ = -1;
	    if (i_156_ >= Class372.anInt4049 * 1155384281 && i_156_ <= Class372.anInt4050 * -1062447355) {
		int[] is = Class372.anIntArrayArray4047[i_156_];
		int i_170_ = Class463.method6012(i - i_157_, (-1424479739 * Class372.anInt4051), 1135094847 * Class372.anInt4048, -1212608691);
		int i_171_ = Class463.method6012(i + i_157_, (Class372.anInt4051 * -1424479739), 1135094847 * Class372.anInt4048, -1212608691);
		int i_172_ = Class463.method6012(i - i_163_, (-1424479739 * Class372.anInt4051), Class372.anInt4048 * 1135094847, -1212608691);
		int i_173_ = Class463.method6012(i + i_163_, (Class372.anInt4051 * -1424479739), 1135094847 * Class372.anInt4048, -1212608691);
		...
		if (i_165_ >= 0) {
		    ...
		    if (i_175_ >= Class372.anInt4049 * 1155384281 && i_174_ <= -1062447355 * Class372.anInt4050) {
			if (i_164_ >= i_163_) {
			    int i_176_ = (Class463.method6012(i_162_ + i, Class372.anInt4051 * -1424479739, 1135094847 * Class372.anInt4048, -1212608691));
			    int i_177_ = (Class463.method6012(i - i_162_, Class372.anInt4051 * -1424479739, 1135094847 * Class372.anInt4048, -1212608691));
			    if (i_175_ <= -1062447355 * Class372.anInt4050)
				Class82_Sub22.method940((Class372.anIntArrayArray4047[i_175_]), i_177_, i_176_, i_159_, -587973246);
			    if (i_174_ >= 1155384281 * Class372.anInt4049)
				Class82_Sub22.method940((Class372.anIntArrayArray4047[i_174_]), i_177_, i_176_, i_159_, 458640866);
			} else {
			    int i_178_ = Class372_Sub1.anIntArray7727[i_164_];
			    int i_179_ = (Class463.method6012(i_162_ + i, Class372.anInt4051 * -1424479739, 1135094847 * Class372.anInt4048, -1212608691));
			    int i_180_ = Class463.method6012(i - i_162_, (Class372.anInt4051 * -1424479739), (Class372.anInt4048 * 1135094847), -1212608691);
			    int i_181_ = Class463.method6012(i_178_ + i, (Class372.anInt4051 * -1424479739), (Class372.anInt4048 * 1135094847), -1212608691);
			    int i_182_ = (Class463.method6012(i - i_178_, -1424479739 * Class372.anInt4051, 1135094847 * Class372.anInt4048, -1212608691));
			    if (i_175_ <= Class372.anInt4050 * -1062447355) {
				int[] is = (Class372.anIntArrayArray4047[i_175_]);
			    ...
			    if (i_174_ >= 1155384281 * Class372.anInt4049) {
				int[] is = (Class372.anIntArrayArray4047[i_174_]);
		...
		if (i_184_ >= Class372.anInt4049 * 1155384281 && i_183_ <= -1062447355 * Class372.anInt4050) {
		    int i_185_ = i_164_ + i;
		    int i_186_ = i - i_164_;
		    if (i_185_ >= -1424479739 * Class372.anInt4051 && i_186_ <= 1135094847 * Class372.anInt4048) {
			i_185_ = Class463.method6012(i_185_, (-1424479739 * Class372.anInt4051), (1135094847 * Class372.anInt4048), -1212608691);
			i_186_ = Class463.method6012(i_186_, (Class372.anInt4051 * -1424479739), (Class372.anInt4048 * 1135094847), -1212608691);
			if (i_162_ < i_163_) {
			    int i_187_ = (i_166_ < i_162_ ? Class372_Sub1.anIntArray7727[i_162_] : i_166_);
			    int i_188_ = (Class463.method6012(i + i_187_, Class372.anInt4051 * -1424479739, 1135094847 * Class372.anInt4048, -1212608691));
			    int i_189_ = (Class463.method6012(i - i_187_, -1424479739 * Class372.anInt4051, Class372.anInt4048 * 1135094847, -1212608691));
			    if (i_184_ <= Class372.anInt4050 * -1062447355) {
				int[] is = (Class372.anIntArrayArray4047[i_184_]);
			    ...
			    if (i_183_ >= Class372.anInt4049 * 1155384281) {
				int[] is = (Class372.anIntArrayArray4047[i_183_]);
			    ...
			    if (i_184_ <= Class372.anInt4050 * -1062447355)
				Class82_Sub22.method940((Class372.anIntArrayArray4047[i_184_]), i_186_, i_185_, i_159_, -2102947655);
			    if (i_183_ >= Class372.anInt4049 * 1155384281)
				Class82_Sub22.method940((Class372.anIntArrayArray4047[i_183_]), i_186_, i_185_, i_159_, -372087596);
			}
		    }
		}
	    }
