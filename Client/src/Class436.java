...
public class Class436 {
    static Class348 aClass348_5464;
	...
	aClass348_5464 = new Class348(30);
	aClass105_5486 = null;
    ...
    static final void method5805(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
    ...
    static final void method5806(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (class403.myClanChannel.method3097((String) (class403.anObjectArray5240[((class403.anInt5241 -= 969361751) * -203050393)]), (byte) -7));
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method5807(Class403 class403, int i) {
	try {
	    int i_0_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    if (i_0_ > 255 || i_0_ < 0)
		i_0_ = 0;
	    if (i_0_ != Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub20_7578.method5700(-1514807660)) {
		Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub20_7578, i_0_, -1997480653);
    ...
    static final void method5809(Class403 class403, byte i) {
	try {
