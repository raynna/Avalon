...
public abstract class Entity extends Class365_Sub1_Sub1 {
    ...
    public final void method4420(int i, int i_31_, int soakingMark, int i_33_, int i_34_, int i_35_, int hpBarPercentage, byte i_37_) {
	try {
	    boolean bool = true;
		...
		for (int i_45_ = 0; i_45_ < HashTable.aClass371_5520.anInt4032 * -942466371; i_45_++) {
		    ...
		    this.aByte10133 = (byte) ((this.aByte10133 + 1) % (-942466371 * HashTable.aClass371_5520.anInt4032));
		...
		anIntArray10127[i_40_] = soakingMark;
		anIntArray10083[i_40_] = i_33_;
		anIntArray10080[i_40_] = i_35_ + (i_34_ + i_42_);
		hpPercentageBar[i_40_] = hpBarPercentage;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    this.anInt10097 = ((int) (Math.atan2(i_99_ - i_100_, i_71_) * 2607.5945876176133) & 0x3fff) * 1814320247;
	    this.anInt10073 = ((int) (Math.atan2(i_102_ - i_101_, i_70_) * 2607.5945876176133) & 0x3fff) * -1037987721;
	    ...
	    this.anInt10074 = (1400968295 * ((this.anInt10074 * -104151209 >> 1) - (int) class217.aFloat2455));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (this.aClass62_10118 != null && null != (this.aClass62_10118).aString608) {
		this.aClass62_10118.anInt611 -= -1979671751;
		if ((this.aClass62_10118).anInt611 * -1542462711 == 0)
		    this.aClass62_10118.aString608 = null;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    this.aClass62_10118.aString608 = string;
	    this.aClass62_10118.anInt607 = -883265885 * i;
	    this.aClass62_10118.anInt609 = -998781563 * i_106_;
	    this.aClass62_10118.anInt611 = (this.aClass62_10118.anInt610 = i_107_ * -1166793105) * 1683680471;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (anInt10132 * 1097409519 != 1992528251 * this.anInt10107)
		method4416((byte) -65);
	...
	int i = ((this.anInt10065 * 1173963243 - 1 << 8) + 240);
	Class217 class217 = method4337().aClass217_2599;
	...
	try {
		...
		return false;
	    return method4433((1992528251 * this.anInt10107), -1999241902);
	}
	catch (RuntimeException runtimeexception) {
	...
	hpPercentageBar = new int[HashTable.aClass371_5520.anInt4032 * -942466371];
	...
	try {
		...
		if ((this.aClass351_10067 == null || (this.aClass351_10067.aBoolean3772)) && (i_127_ > 0 || i_129_ > 0))
		    this.aClass351_10067 = Class351.method4232(client.ticketCycle * 443738891, true);
		if (this.aClass351_10067 != null) {
		    ...
		    this.aClass351_10067.method4231(class_ra, 443738891 * client.ticketCycle, class85s_133_, class68s_137_, false);
		    this.aBoolean10128 = true;
		}
	    } else if (this.aClass351_10067 != null)
		this.aClass351_10067.method4233(client.ticketCycle * 443738891);
	    if (null != this.aClass351_10067)
		this.aClass351_10067.method4227(plane, aShort9798, aShort9796, aShort9795, aShort9797);
	}
	catch (RuntimeException runtimeexception) {
