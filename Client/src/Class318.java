...
public abstract class Class318 {
    ...
    static final void method3870(Class403 class403, int i) {
	try {
	    if (client.anInt8942 * 1131012101 == 0)
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = -2;
	    else if (client.anInt8942 * 1131012101 == 1)
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = -1;
	    else
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = client.anInt8941 * -1054937867;
	}
    ...
    static final void method3871(Class403 class403, byte i) {
	try {
	    class403.anInt5239 -= -1959403445;
	    int i_10_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    int i_11_ = (class403.anIntArray5244[1 + class403.anInt5239 * 681479919]);
	    int i_12_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 2]);
	    int i_13_ = (class403.anIntArray5244[3 + 681479919 * class403.anInt5239]);
	    int i_14_ = (class403.anIntArray5244[4 + class403.anInt5239 * 681479919]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (i_11_ - i_10_) * (i_14_ - i_12_) / (i_13_ - i_12_) + i_10_;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method3872(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    client.aShort8928 = (short) (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    if (client.aShort8928 <= 0)
		client.aShort8928 = (short) 256;
	    client.aShort8929 = (short) (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]);
    ...
    static final void method3875(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -1567522756;
	    class105.anInt1253 = -478399925 * (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    class105.anInt1153 = (-1661995333 * (class403.anIntArray5244[1 + 681479919 * class403.anInt5239]));
	    class105.anInt1221 = 0;
	    class105.anInt1198 = 0;
	    int i_15_ = (class403.anIntArray5244[681479919 * class403.anInt5239 + 2]);
	    if (i_15_ < 0)
		i_15_ = 0;
	    else if (i_15_ > 4)
		i_15_ = 4;
	    int i_16_ = (class403.anIntArray5244[681479919 * class403.anInt5239 + 3]);
	    if (i_16_ < 0)
		i_16_ = 0;
	    else if (i_16_ > 4)
		i_16_ = 4;
