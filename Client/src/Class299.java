...
public class Class299 {
	...
	this.anInt3193 = class298_sub53.method3645(590991010) * -1823687737;
	...
	for (int i_2_ = 0; i_2_ < this.anInt3193 * -755722761; i_2_++) {
	    this.anIntArray3194[i_2_] = i_0_ + class298_sub53.readByte(-12558881);
	    this.anIntArray3196[i_2_] = i_1_ + class298_sub53.readByte(-12558881);
	}
	...
	try {
	    ...
	    Class341 class341_3_ = new Class341(1855729883 * Class99.anInt952, this.anIntArray3194[0], this.anIntArray3196[0]);
	    for (int i_4_ = 1; i_4_ < this.anInt3193 * -755722761; i_4_++) {
		Class341 class341_5_ = new Class341(1855729883 * Class99.anInt952, this.anIntArray3194[i_4_], this.anIntArray3196[i_4_]);
		while ((class341_3_.gameSceneBaseX * -1760580017 != class341_5_.gameSceneBaseX * -1760580017) || (class341_5_.gameSceneBaseY * 283514611 != 283514611 * class341_3_.gameSceneBaseY)) {
			...
			if (class244.method2320(i_7_, i_8_, 1621681169))
			    i_6_++;
			this.aLinkedList3198.add(new Class365_Sub1_Sub1_Sub4(class331, this, Class99.anInt952 * 1855729883, i_6_, i_9_, Class356.method4271(i_9_, i_10_, (1855729883 * Class99.anInt952), -969266952), i_10_));
		    }
		}
	...
	try {
	    Model class64 = Model.method751(Class341.aClass243_3646, -1002982425 * this.anInt3195, 0);
	    if (class64 == null)
		return null;
