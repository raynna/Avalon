...
public class Shortcut implements Interface19 {
	...
	try {
	    return (i >= -1976050083 * GameObjectType.T4.type && i <= -1976050083 * GameObjectType.T8.type);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (GameObjectType.T1.type * -1976050083 == i || -1976050083 * GameObjectType.T3.type == i)
    ...
    static final void method4264(Class403 class403, short i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_10_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    int i_11_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]);
	    Class497 class497 = Class92.aClass504_905.method6251(i_11_, -1869114423);
	    if (class497.method6206(1883696427))
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = client.aClass283_8716.method2641(-1837734772).getObjectDefinitions(i_10_).method5770(i_11_, class497.aString6101, 1595133323);
	    else
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = (client.aClass283_8716.method2641(767453715).getObjectDefinitions(i_10_).method5776(i_11_, class497.anInt6100 * -388931549, (byte) 2));
	}
	catch (RuntimeException runtimeexception) {
    ...
    static void method4265(int i, int i_12_, int i_13_, int i_14_) {
	try {
	    Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(8, i);
	    class298_sub37_sub12.method3449((byte) 10);
	    class298_sub37_sub12.type = i_12_ * 1274450087;
	    class298_sub37_sub12.value = 293101103 * i_13_;
	    class298_sub37_sub12.modelZoom = i_14_ * -80288087;
	}
	catch (RuntimeException runtimeexception) {
