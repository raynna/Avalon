...
public class Class182 {
	...
	try {
		...
		this.anInt1834 = class298_sub53.readInt((byte) 100) * -1365954181;
		this.anInt1835 = class298_sub53.readInt((byte) -15) * 902519911;
	    } else if (7 == i) {
		...
		this.anInt1838 = class298_sub53.readUnsignedByte() * 587779089;
	    else if (21 == i)
		this.anInt1839 = class298_sub53.readUnsignedByte() * 1460884271;
	    else if (i == 22)
		anInt1828 = class298_sub53.readInt((byte) -1) * 460402411;
	    else if (23 == i)
		this.anInt1830 = class298_sub53.readUnsignedByte() * -853474699;
	    else if (24 == i)
		aBoolean1860 = false;
	    else if (25 == i) {
		...
		this.anInt1833 = class298_sub53.readUnsignedByte() * -1461114135;
	    else if (29 == i)
