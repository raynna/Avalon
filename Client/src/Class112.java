...
public class Class112 {
    ...
    static final void method1241(Class403 class403, int i) {
	try {
    ...
    static final void method1242(Class403 class403, int i) {
	try {
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = Class22.method371(-1872384633).toString();
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(12, i);
	    class298_sub37_sub12.method3449((byte) 78);
	    class298_sub37_sub12.type = 1274450087 * i_9_;
	}
	catch (RuntimeException runtimeexception) {
