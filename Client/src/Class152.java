...
public class Class152 {
	...
	try {
	    this.aLong1592 = (class298_sub53.readLong((short) 9142) * 1517159550238851441L);
	    this.aLong1588 = (class298_sub53.readLong((short) 28083) * 8735484037837793267L);
		...
		this.aClass453_1587.add(class298_sub17);
	    }
	}
	...
	try {
	    if ((-6615773310558494831L * this.aLong1592 != class298_sub25.hash * 7051297995265073167L) || (-3106107963843196613L * this.aLong1588 != (class298_sub25.aLong7361 * -3244420319926665157L)))
		throw new RuntimeException("");
	    for (Class298_Sub17 class298_sub17 = (Class298_Sub17) this.aClass453_1587.method5939(1766612795); class298_sub17 != null; class298_sub17 = ((Class298_Sub17) this.aClass453_1587.method5944(49146)))
		class298_sub17.method2918(class298_sub25, -2022437727);
	    class298_sub25.aLong7361 += 8816161044679006451L;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1653(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = -2067054685 * Class52_Sub2.anInt6815;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    class455.method5954(is_3_, 8 * i_1_);
    ...
    static final void method1656(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7583.method5726(-2143087996);
	}
	catch (RuntimeException runtimeexception) {
