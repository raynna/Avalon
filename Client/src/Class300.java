...
public class Class300 {
    ...
    static final void method3683(Class403 class403, int i) {
	try {
    ...
    static final void method3684(Class403 class403, byte i) {
	try {
	...
	try {
	    ...
	    class302_sub4.anInt7653 = i * 1025727709;
	    class302_sub4.anInt7652 = 862924059 * i_8_;
	    class302_sub4.anInt7656 = i_9_ * -1389157181;
	    class302_sub4.anInt7655 = (i_11_ + client.ticketCycle * 443738891) * -1019659005;
	    class302_sub4.anInt7654 = i_10_ * 274200991;
	    class302_sub4.aString7657 = string;
	    class302_sub4.anInt7651 = i_12_ * 334332979;
    ...
    static final void method3688(Class403 class403, byte i) {
	try {
	    int i_14_ = (class403.anIntArray5257[class403.anInt5259 * 1883543357]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class128.aClass148_6331.anIntArray6654[i_14_];
	}
	catch (RuntimeException runtimeexception) {
