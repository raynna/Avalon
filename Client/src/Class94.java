...
public final class Class94 {
	...
	try {
		...
		this.aClass365_Sub1_Sub1_Sub2_Sub1_910.method4456(i, i_1_, i_2_, true, this.aClass365_Sub1_Sub1_Sub2_Sub1_910.getSize(), (byte) 21);
	    else {
		this.aClass365_Sub1_Sub1_Sub2_Sub2_911.plane = this.aClass365_Sub1_Sub1_Sub2_Sub2_911.aByte7724 = (byte) i;
		this.aClass365_Sub1_Sub1_Sub2_Sub2_911.method4472(i_1_, i_2_, -1945697758);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (1762367763 * anInt909 >= 0) {
		    this.aClass365_Sub1_Sub1_Sub2_Sub1_910 = (new NPC(client.aClass283_8716.method2675(-1611682495), 25));
		    ...
		    this.aClass365_Sub1_Sub1_Sub2_Sub2_911.sendAppearence(Class128_Sub1.aClass298_Sub53_8555, (byte) 3);
		    this.aClass365_Sub1_Sub1_Sub2_Sub2_911.anInt10064 = 302956801 * this.anInt906;
		    this.aClass365_Sub1_Sub1_Sub2_Sub2_911.anInt10075 = -128551287 * client.ticketCycle;
		    this.aClass365_Sub1_Sub1_Sub2_Sub2_911.anInt10071 = (((Class87.anInt803 += 2029434363) * -132903629 - 1) * -689024993);
		}
	    }
	    if (1762367763 * anInt909 >= 0) {
		this.aClass365_Sub1_Sub1_Sub2_Sub1_910.method4456(i_5_, i, i_4_, true, this.aClass365_Sub1_Sub1_Sub2_Sub1_910.getSize(), (byte) 43);
		...
		this.aClass365_Sub1_Sub1_Sub2_Sub2_911.method4472(i, i_4_, -2044145189);
	...
	try {
		...
		if (this.anIntArray907 == null) {
		    ...
		    this.anIntArray907 = class350.method4210(2115260709);
		}
    ...
    static final void method1021(Class403 class403, int i) {
	try {
    ...
    static final void method1022(Class403 class403, int i) {
	try {
	    Class390 class390 = (class403.aBoolean5261 ? class403.aClass390_5247 : class403.aClass390_5246);
	    IComponentDefinition class105 = class390.aClass105_4168;
	    Class119 class119 = class390.aClass119_4167;
    ...
    static final void method1023(Class403 class403, int i) {
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub15_7560, (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) == 1 ? 1 : 0, -1851948852);
    ...
    static final void method1024(Class403 class403, int i) {
	try {
	    IComponentDefinition.method1135(((Class365_Sub1) class403.anInterface3_5233), class403, -778688640);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1025(Class403 class403, int i) {
	try {
	    if (client.playerRights * 1806357379 >= 2)
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = 1806357379 * client.playerRights;
	    else
    ...
    static final void method1026(Class403 class403, int i) {
	try {
	    int i_12_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    if (-257444687 * client.WINDOW_PANE_ID != -1) {
		if (i_12_ == 0) {
		    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = client.WINDOW_PANE_ID * -257444687;
		    return;
		}
		i_12_--;
	    }
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = -1617025021 * class298_sub51.interfaceId;
	}
	catch (RuntimeException runtimeexception) {
