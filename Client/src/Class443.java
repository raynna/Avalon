...
public class Class443 {
	...
	try {
	    ...
	    int checkSnow = client.Snow ? -255 : 255;
	    if (anInt5595 * -620399085 < 0)
		anInt5595 = 0;
	    else if (-620399085 * anInt5595 > checkSnow)
		anInt5595 = -1574873371;
	    if (656695887 * anInt5600 < 0)
		anInt5600 = 0;
	    else if (anInt5600 * 656695887 > checkSnow)
		anInt5600 = 43596369;
	    if (d_7_ > 0.5)
	...
	try {
	    if (1 == i) {
		this.anInt5593 = class298_sub53.read24BitUnsignedInteger((byte) -8) * -1369220863;
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class95.anInt923 * -2009663223;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    int i_23_ = (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]);
	    int i_24_ = (class403.anIntArray5244[2 + 681479919 * class403.anInt5239]);
	    if (i_22_ < 0 || i_22_ > 9)
