...
public class Class441 {
	...
	try {
		...
		if (this.aClass298_Sub37_Sub4_5583 != null) {
			...
			this.anInt5586 = is[i_0_] * -1477634565;
			this.aClass298_Sub37_Sub4_5587 = class395.method4900((this.anInt5586 * -643912397) >> 16, -1623469578);
			this.anInt5586 = (this.anInt5586 * -643912397 & 0xffff) * -1477634565;
		    }
		    if (class391.aBoolean4185)
			this.anInt5588 = (this.anInt5588 * -1050600049 | 0x200) * 1673486703;
		    if (this.aClass298_Sub37_Sub4_5583.method3413(this.anInt5584 * 806878007, (byte) -4))
			this.anInt5588 = (1673486703 * (-1050600049 * this.anInt5588 | 0x80));
		    if (this.aClass298_Sub37_Sub4_5583.method3415(806878007 * this.anInt5584, -460356399))
			this.anInt5588 = (1673486703 * (-1050600049 * this.anInt5588 | 0x100));
		    if (this.aClass298_Sub37_Sub4_5583.method3414(this.anInt5584 * 806878007, (byte) -54))
			this.anInt5588 = (1673486703 * (this.anInt5588 * -1050600049 | 0x400));
		    if (this.aClass298_Sub37_Sub4_5587 != null) {
			if (this.aClass298_Sub37_Sub4_5587.method3413(-643912397 * this.anInt5586, (byte) 9))
			    this.anInt5588 = (1673486703 * (-1050600049 * this.anInt5588 | 0x80));
			if (this.aClass298_Sub37_Sub4_5587.method3415(this.anInt5586 * -643912397, -460356399))
			    this.anInt5588 = (1673486703 * (this.anInt5588 * -1050600049 | 0x100));
			if (this.aClass298_Sub37_Sub4_5587.method3414(-643912397 * this.anInt5586, (byte) 7))
    ...
    static final void method5865(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
    ...
    static final void method5867(Class403 class403, byte i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 715019623 * class352.anInt3785;
	}
	catch (RuntimeException runtimeexception) {
