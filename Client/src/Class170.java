...
public final class Class170 {
    ...
    static final void method1809(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class105.spriteId * 1411971043;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1810(Class403 class403, byte i) {
	try {
    ...
    public static void method1811(int i, Class243 class243, int i_2_, int i_3_, int i_4_, boolean bool, Class97 class97, byte i_5_) {
	try {
	    if (i > 0) {
	...
	try {
		...
		if (null == class105) {
			...
			class298_sub46.arguements = class105.anObjectArray1275;
			Class444.executeScript(class298_sub46);
		    }
		    if (1 == i && class105.anObjectArray1250 != null) {
			if (class105.anInt1154 * -1309843523 >= 0) {
			    IComponentDefinition class105_8_ = Class50.getIComponentDefinitions((class105.ihash * -440872681), (byte) -12);
			...
			ScriptEnvironment class298_sub46 = new ScriptEnvironment();
			class298_sub46.aClass105_7525 = class105;
			class298_sub46.arguements = class105.anObjectArray1250;
			Class444.executeScript(class298_sub46);
		    }
		}
	    }
    ...
    static final void method1813(Class403 class403, byte i) {
	try {
    ...
    static final void method1815(Class403 class403, byte i) {
	try {
	    int i_10_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class82_Sub5.method882(i_10_, false, (byte) 63);
	}
	catch (RuntimeException runtimeexception) {
