...
public class Class298_Sub8_Sub1 extends Class298_Sub8 {
    ...
    @Override
    boolean method2869() {
	if ((this.aClass_ra_Sub2_7222.framebuffer_obj) && this.aClass_ra_Sub2_7222.fragment_shader && (this.aClass_ra_Sub2_7222).texture_float) {
		...
		this.aClass_ra_Sub2_7222.method5005(this.aClass52_Sub1_Sub2_9179, (byte) -107);
		return false;
	    }
	    this.aClass_ra_Sub2_7222.method5005(this.aClass52_Sub1_Sub2_9179, (byte) -15);
	    this.aClass29_9175 = (Class29.method406(this.aClass_ra_Sub2_7222, (new Class48[] { Class48.method526(this.aClass_ra_Sub2_7222, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") })));
	    this.aClass29_9189 = (Class29.method406(this.aClass_ra_Sub2_7222, (new Class48[] { Class48.method526(this.aClass_ra_Sub2_7222, 35632, "uniform vec3 params;\nuniform sampler2D sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2D(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") })));
	    this.aClass29_9183 = (Class29.method406(this.aClass_ra_Sub2_7222, (new Class48[] { Class48.method526(this.aClass_ra_Sub2_7222, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform vec3 dimScale;\nuniform sampler2D bloomTex;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n\t vec4 bloomCol = texture2D(bloomTex, gl_TexCoord[1].xy);\n\t vec4 sceneCol = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n\t float preLum = 0.99*dot(lumCoef, sceneCol.rgb)+0.01;\n    float postLum = preLum*(1.0+(preLum/params.y))/(preLum+1.0);\n\t gl_FragColor = sceneCol*(postLum/preLum)+bloomCol*params.x;\n}\n") })));
	    this.aClass29_9187 = (Class29.method406(this.aClass_ra_Sub2_7222, (new Class48[] { Class48.method526(this.aClass_ra_Sub2_7222, 35632, "uniform vec3 step;\nuniform sampler2D baseTex;\nvoid main() {\n\tvec4 fragCol = texture2D(baseTex, gl_TexCoord[0].xy)*0.091396265;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-8.0*step.xy))*0.012369139;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 8.0*step.xy))*0.012369139;\n\tgl_FragColor = fragCol;\n}\n") })));
	...
	this.anInt9185 = i;
	this.anInt9184 = i_0_;
	int i_1_ = Class422_Sub4.method5639(this.anInt9185, 1918937807);
	int i_2_ = Class422_Sub4.method5639(this.anInt9184, 1314388027);
	if (this.anInt9188 != i_1_ || this.anInt9186 != i_2_) {
		...
		if (this.aClass52_Sub1_Sub2_9170 == null)
		    this.aClass52_Sub1_Sub2_9170 = new Class52_Sub1_Sub2(this.aClass_ra_Sub2_7222);
	...
	this.aClass_ra_Sub2_7222.method5255(1);
	this.aClass_ra_Sub2_7222.method5256(null);
	...
	this.anInt9185 = i;
	this.anInt9184 = i_7_;
	int i_8_ = Class422_Sub4.method5639(this.anInt9185, 1360936610);
	int i_9_ = Class422_Sub4.method5639(this.anInt9184, 1074782076);
	...
	if (this.aClass30_Sub2Array9190 != null) {
	    this.aClass_ra_Sub2_7222.method5143(this.aClass52_Sub1_Sub2_9170, (byte) 9);
	    int i_15_ = Class422_Sub4.method5639((this.anInt9185), 2071757561);
	    int i_16_ = Class422_Sub4.method5639((this.anInt9184), 1398420241);
	    int i_17_ = 0;
		...
		if (i_17_ == 0) {
		    this.aClass_ra_Sub2_7222.method5256(class30_sub2);
		    OpenGL.glBegin(7);
		    OpenGL.glTexCoord2f(0.0F, 0.0F);
		    OpenGL.glVertex2i(0, 0);
		    OpenGL.glTexCoord2f((this.anInt9185), 0.0F);
		    OpenGL.glVertex2i(1, 0);
		    OpenGL.glTexCoord2f((this.anInt9185), (this.anInt9184));
		    OpenGL.glVertex2i(1, 1);
		    OpenGL.glTexCoord2f(0.0F, (this.anInt9184));
		    OpenGL.glVertex2i(0, 1);
		    OpenGL.glEnd();
		} else {
		    this.aClass_ra_Sub2_7222.method5256(this.aClass30_Sub2Array9190[i_17_ - 1]);
		    OpenGL.glBegin(7);
		    OpenGL.glTexCoord2f(0.0F, 0.0F);
		    OpenGL.glVertex2i(0, 0);
	    ...
	    this.aClass_ra_Sub2_7222.method5005(this.aClass52_Sub1_Sub2_9170, (byte) -59);
	    this.aClass_ra_Sub2_7222.method5256(this.aClass30_Sub2Array9190[i_17_ - 1]);
	    this.aClass_ra_Sub2_7222.method5143(this.aClass52_Sub1_Sub2_9179, (byte) -3);
	    this.aClass52_Sub1_Sub2_9179.method572(0);
	...
	this.aClass_ra_Sub2_7222.method5256(this.aClass30_Sub2_9180);
	...
	OpenGL.glEnd();
	this.aClass52_Sub1_Sub2_9179.method572(0);
	this.aClass_ra_Sub2_7222.method5256(this.aClass30_Sub2_9181);
	...
	this.aClass_ra_Sub2_7222.method5005(this.aClass52_Sub1_Sub2_9179, (byte) 2);
	...
	if ((this.aClass_ra_Sub2_7222.framebuffer_obj) && this.aClass_ra_Sub2_7222.fragment_shader && (this.aClass_ra_Sub2_7222).texture_float) {
	    ...
	    this.aClass_ra_Sub2_7222.method5005(this.aClass52_Sub1_Sub2_9179, (byte) -37);
	    this.aClass29_9175 = (Class29.method406(this.aClass_ra_Sub2_7222, (new Class48[] { Class48.method526(this.aClass_ra_Sub2_7222, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") })));
	    this.aClass29_9189 = (Class29.method406(this.aClass_ra_Sub2_7222, (new Class48[] { Class48.method526(this.aClass_ra_Sub2_7222, 35632, "uniform vec3 params;\nuniform sampler2D sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2D(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") })));
	    this.aClass29_9183 = (Class29.method406(this.aClass_ra_Sub2_7222, (new Class48[] { Class48.method526(this.aClass_ra_Sub2_7222, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform vec3 dimScale;\nuniform sampler2D bloomTex;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n\t vec4 bloomCol = texture2D(bloomTex, gl_TexCoord[1].xy);\n\t vec4 sceneCol = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n\t float preLum = 0.99*dot(lumCoef, sceneCol.rgb)+0.01;\n    float postLum = preLum*(1.0+(preLum/params.y))/(preLum+1.0);\n\t gl_FragColor = sceneCol*(postLum/preLum)+bloomCol*params.x;\n}\n") })));
	    this.aClass29_9187 = (Class29.method406(this.aClass_ra_Sub2_7222, (new Class48[] { Class48.method526(this.aClass_ra_Sub2_7222, 35632, "uniform vec3 step;\nuniform sampler2D baseTex;\nvoid main() {\n\tvec4 fragCol = texture2D(baseTex, gl_TexCoord[0].xy)*0.091396265;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-8.0*step.xy))*0.012369139;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 8.0*step.xy))*0.012369139;\n\tgl_FragColor = fragCol;\n}\n") })));
	...
	OpenGL.glOrtho(0.0, 1.0, 0.0, 1.0, -1.0, 1.0);
	if (this.aClass30_Sub2Array9190 != null) {
	    this.aClass_ra_Sub2_7222.method5143(this.aClass52_Sub1_Sub2_9170, (byte) -3);
	    int i_23_ = Class422_Sub4.method5639((this.anInt9185), 1462499323);
	    int i_24_ = Class422_Sub4.method5639((this.anInt9184), 1465383629);
	    int i_25_ = 0;
		...
		if (i_25_ == 0) {
		    ...
		    this.aClass_ra_Sub2_7222.method5256(this.aClass30_Sub2Array9190[i_25_ - 1]);
		    OpenGL.glBegin(7);
		    OpenGL.glTexCoord2f(0.0F, 0.0F);
		    OpenGL.glVertex2i(0, 0);
		    OpenGL.glTexCoord2f(1.0F, 0.0F);
	    ...
	    this.aClass_ra_Sub2_7222.method5005(this.aClass52_Sub1_Sub2_9170, (byte) -15);
	    this.aClass_ra_Sub2_7222.method5256(this.aClass30_Sub2Array9190[i_25_ - 1]);
	    this.aClass_ra_Sub2_7222.method5143(this.aClass52_Sub1_Sub2_9179, (byte) -7);
	    this.aClass52_Sub1_Sub2_9179.method572(0);
	    OpenGL.glViewport(0, 0, 256, 256);
	    ...
	    this.aClass_ra_Sub2_7222.method5256(class30_sub2);
	    this.aClass_ra_Sub2_7222.method5143(this.aClass52_Sub1_Sub2_9179, (byte) -16);
	    this.aClass52_Sub1_Sub2_9179.method572(0);
	    OpenGL.glViewport(0, 0, 256, 256);
	...
	OpenGL.glPopMatrix();
	OpenGL.glMatrixMode(5888);
	this.aClass_ra_Sub2_7222.method5005(this.aClass52_Sub1_Sub2_9179, (byte) -14);
	...
	OpenGL.glOrtho(0.0, 1.0, 0.0, 1.0, -1.0, 1.0);
	if (this.aClass30_Sub2Array9190 != null) {
	    this.aClass_ra_Sub2_7222.method5143(this.aClass52_Sub1_Sub2_9170, (byte) 61);
	    int i_31_ = Class422_Sub4.method5639((this.anInt9185), 1385804775);
	    int i_32_ = Class422_Sub4.method5639((this.anInt9184), 1199238042);
	    int i_33_ = 0;
		...
		if (i_33_ == 0) {
		    ...
		    this.aClass_ra_Sub2_7222.method5256(this.aClass30_Sub2Array9190[i_33_ - 1]);
		    OpenGL.glBegin(7);
		    OpenGL.glTexCoord2f(0.0F, 0.0F);
		    OpenGL.glVertex2i(0, 0);
		    OpenGL.glTexCoord2f(1.0F, 0.0F);
	    ...
	    this.aClass_ra_Sub2_7222.method5005(this.aClass52_Sub1_Sub2_9170, (byte) 83);
	    this.aClass_ra_Sub2_7222.method5256(this.aClass30_Sub2Array9190[i_33_ - 1]);
	    this.aClass_ra_Sub2_7222.method5143(this.aClass52_Sub1_Sub2_9179, (byte) 17);
	    this.aClass52_Sub1_Sub2_9179.method572(0);
	    OpenGL.glViewport(0, 0, 256, 256);
	    ...
	    this.aClass_ra_Sub2_7222.method5256(class30_sub2);
	    this.aClass_ra_Sub2_7222.method5143(this.aClass52_Sub1_Sub2_9179, (byte) -6);
	    this.aClass52_Sub1_Sub2_9179.method572(0);
	    OpenGL.glViewport(0, 0, 256, 256);
	...
	OpenGL.glPopMatrix();
	OpenGL.glMatrixMode(5888);
	this.aClass_ra_Sub2_7222.method5005(this.aClass52_Sub1_Sub2_9179, (byte) -116);
	...
	if ((this.aClass_ra_Sub2_7222.framebuffer_obj) && this.aClass_ra_Sub2_7222.fragment_shader && (this.aClass_ra_Sub2_7222).texture_float) {
	    ...
	    this.aClass52_Sub1_Sub2_9179.method572(0);
	    if (!this.aClass52_Sub1_Sub2_9179.method560()) {
		this.aClass_ra_Sub2_7222.method5005(this.aClass52_Sub1_Sub2_9179, (byte) -42);
		return false;
	    }
	    this.aClass_ra_Sub2_7222.method5005(this.aClass52_Sub1_Sub2_9179, (byte) 12);
	    this.aClass29_9175 = (Class29.method406(this.aClass_ra_Sub2_7222, (new Class48[] { Class48.method526(this.aClass_ra_Sub2_7222, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") })));
	    this.aClass29_9189 = (Class29.method406(this.aClass_ra_Sub2_7222, (new Class48[] { Class48.method526(this.aClass_ra_Sub2_7222, 35632, "uniform vec3 params;\nuniform sampler2D sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n    vec4 col = texture2D(sceneTex, gl_TexCoord[0].xy);\n    gl_FragColor = col*step(params.x, dot(lumCoef, col.rgb));\n}\n") })));
	    this.aClass29_9183 = (Class29.method406(this.aClass_ra_Sub2_7222, (new Class48[] { Class48.method526(this.aClass_ra_Sub2_7222, 35632, "#extension GL_ARB_texture_rectangle : enable\nuniform vec3 params;\nuniform vec3 dimScale;\nuniform sampler2D bloomTex;\nuniform sampler2DRect sceneTex;\nconst vec3 lumCoef = vec3(0.2126, 0.7152, 0.0722);\nvoid main() {\n\t vec4 bloomCol = texture2D(bloomTex, gl_TexCoord[1].xy);\n\t vec4 sceneCol = texture2DRect(sceneTex, gl_TexCoord[0].xy);\n\t float preLum = 0.99*dot(lumCoef, sceneCol.rgb)+0.01;\n    float postLum = preLum*(1.0+(preLum/params.y))/(preLum+1.0);\n\t gl_FragColor = sceneCol*(postLum/preLum)+bloomCol*params.x;\n}\n") })));
	    this.aClass29_9187 = (Class29.method406(this.aClass_ra_Sub2_7222, (new Class48[] { Class48.method526(this.aClass_ra_Sub2_7222, 35632, "uniform vec3 step;\nuniform sampler2D baseTex;\nvoid main() {\n\tvec4 fragCol = texture2D(baseTex, gl_TexCoord[0].xy)*0.091396265;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 1.0*step.xy))*0.088584304;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 2.0*step.xy))*0.08065692;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 3.0*step.xy))*0.068989515;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 4.0*step.xy))*0.055434637;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 5.0*step.xy))*0.04184426;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 6.0*step.xy))*0.029672023;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 7.0*step.xy))*0.019765828;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+(-8.0*step.xy))*0.012369139;\n\tfragCol += texture2D(baseTex, gl_TexCoord[0].xy+( 8.0*step.xy))*0.012369139;\n\tgl_FragColor = fragCol;\n}\n") })));
	...
	int i_39_ = Class422_Sub4.method5639(this.anInt9185, 1657798261);
	int i_40_ = Class422_Sub4.method5639(this.anInt9184, 1091426304);
    ...
    boolean method2890() {
	return (this.aClass_ra_Sub2_7222.framebuffer_obj && (this.aClass_ra_Sub2_7222).fragment_shader && (this.aClass_ra_Sub2_7222).texture_float);
    }
}
