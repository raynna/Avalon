...
public class Class82_Sub7 extends Class82 {
	...
	try {
	    ...
	    client.anInt8768 = 0;
	    client.anInt8770 = -1367521861 * this.anInt6849;
	    client.anInt8857 = 0;
	    client.anInt8852 = 2019692335 * this.anInt6852;
	    client.anInt8774 = -970762691 * this.anInt6850;
	    client.anInt8769 = -2694169;
	    client.anInt8771 = this.anInt6847 * -1957420531;
	...
	this.anInt6848 = class298_sub53.readUnsignedShort() * 1053415677;
	this.anInt6851 = class298_sub53.readUnsignedShort() * -289957137;
	this.anInt6849 = class298_sub53.readUnsignedShort() * -1654642079;
	this.anInt6847 = class298_sub53.readUnsignedShort() * 456781431;
	this.anInt6852 = class298_sub53.readUnsignedShort() * -1191092803;
	this.anInt6850 = class298_sub53.readUnsignedShort() * 512797893;
    }
	...
	try {
	    ...
	    class233.method2152(f, f_0_, f_1_, f_2_, i_6_, i_5_, i, i_3_);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method891(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = -2005990483 * Class360.anInt3910;
	}
	catch (RuntimeException runtimeexception) {
