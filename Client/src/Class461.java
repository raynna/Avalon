...
public class Class461 implements Iterable {
	...
	try {
	    Class298_Sub37 class298_sub37 = this.aClass298_Sub37_5680;
	    if (aClass298_Sub37_5679 == class298_sub37) {
		this.aClass298_Sub37_5680 = null;
		return null;
	    }
	    this.aClass298_Sub37_5680 = class298_sub37.aClass298_Sub37_7405;
	    return class298_sub37;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    this.aClass298_Sub37_5680 = class298_sub37_1_.aClass298_Sub37_7405;
	...
	try {
		...
		int i_6_ = 0;
		int i_7_ = ((class298_sub41.anInt7449 * 43235291 * Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7582.method5726(-2144866042)) >> 8);
		...
		if ((826975881 * class298_sub41.anInt7430 == 0) || i_6_ - 256 > 826975881 * class298_sub41.anInt7430 || Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7582.method5726(-2144778383) == 0 || (-1926928785 * class298_sub41.anInt7424) != i) {
		    ...
		    if (i_12_ != 0 || 0 != i_13_) {
			int i_14_ = ((-(-1847894591 * Class135.anInt6384) - (int) (Math.atan2(i_12_, i_13_) * 2607.5945876176133) - 4096) & 0x3fff);
			if (i_14_ > 8192)
			    i_14_ = 16384 - i_14_;
			int i_15_;
			if (i_6_ <= 0)
			...
			if ((391847895 * class298_sub41.anInt7443) >= 0) {
			    i_12_ = (((-455518897 * class298_sub41.anInt7452 == 256) && (class298_sub41.anInt7441) * 1495381837 == 256) ? 256 : Class391.method4888((1495381837 * (class298_sub41.anInt7441)), ((class298_sub41.anInt7452) * -455518897), -1122963701));
			    if (class298_sub41.aBoolean7444) {
				if (null == (class298_sub41.aClass298_Sub23_7445))
				    class298_sub41.aClass298_Sub23_7445 = (Class298_Sub23.method3066(Class439.aClass243_5575, (class298_sub41.anInt7443) * 391847895));
				...
				Class278 class278 = Class278.method2604((Class52.aClass243_507), ((class298_sub41.anInt7443) * 391847895), 0);
				if (null != class278) {
			...
			if ((class298_sub41.anIntArray7432 != null) && (class298_sub41.anInt7454 -= 950219665 * i_4_) * -1221989007 <= 0) {
			    i_12_ = (((class298_sub41.anInt7452) * -455518897 == 256 && (256 == (class298_sub41.anInt7441) * 1495381837)) ? 256 : ((int) (Math.random() * ((-455518897 * (class298_sub41.anInt7452)) - ((class298_sub41.anInt7441) * 1495381837))) + (class298_sub41.anInt7441) * 1495381837));
			    if (class298_sub41.aBoolean7451) {
				if (null == (class298_sub41.aClass298_Sub23_7420)) {
				    i_13_ = (int) (Math.random() * (class298_sub41.anIntArray7432).length);
				    class298_sub41.aClass298_Sub23_7420 = (Class298_Sub23.method3066(Class439.aClass243_5575, (class298_sub41.anIntArray7432[i_13_])));
				}
				if ((class298_sub41.aClass298_Sub23_7420) != null) {
					...
					class298_sub41.anInt7454 = (((class298_sub41.anInt7450 * -15898815) + (int) (Math.random() * ((-1398300237 * (class298_sub41.anInt7422)) - (-15898815 * (class298_sub41.anInt7450))))) * 950219665);
				    }
				}
			    } else {
				i_13_ = (int) (Math.random() * (class298_sub41.anIntArray7432).length);
				Class278 class278 = Class278.method2604((Class52.aClass243_507), (class298_sub41.anIntArray7432[i_13_]), 0);
				if (null != class278) {
				    Class298_Sub26_Sub1 class298_sub26_sub1 = (class278.method2601().method3104(Class282.aClass270_6546));
				    Class298_Sub19_Sub2 class298_sub19_sub2 = (Class298_Sub19_Sub2.method3027(class298_sub26_sub1, i_12_, i_9_ << 6, i_11_));
				    class298_sub19_sub2.method2991(0);
				    Class285.aClass298_Sub19_Sub4_3083.method3043(class298_sub19_sub2);
				    class298_sub41.aClass298_Sub19_Sub2_7426 = class298_sub19_sub2;
				    class298_sub41.anInt7454 = ((-15898815 * (class298_sub41.anInt7450) + (int) (Math.random() * (((class298_sub41.anInt7422) * -1398300237) - (-15898815 * (class298_sub41.anInt7450))))) * 950219665);
				}
			    }
			}
		    } else {
			...
			if (!class298_sub41.aClass298_Sub19_Sub2_7426.method2840(-629325116)) {
			    class298_sub41.aClass298_Sub19_Sub2_7426 = null;
			    class298_sub41.aClass298_Sub23_7420 = null;
			    class298_sub41.aClass298_Sub26_Sub1_7453 = null;
			}
