...
public class Class145 implements Interface5 {
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.anInt8844 * 827374123;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = -548972447 * client.anInt8952;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (class403.myClanChannel.members[i_0_].anInt1682) * -1333059205;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (int) (Math.random() * (i_1_ + 1));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = class298_sub37_sub8.anIntArray9598.length;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
			...
			for (int i_44_ = i; i_44_ <= 1 + i && i_44_ <= 3; i_44_++) {
				...
				if (interface3 != null) {
					...
					if (null != class432.anIntArray5366) {
					    for (int i_46_ = 0; (i_46_ < (class432.anIntArray5366).length); i_46_++) {
						if ((class432.anIntArray5366[i_46_]) != -1) {
						    ObjectDefinitions class432_47_ = (class433.getObjectDefinitions((class432.anIntArray5366[i_46_])));
		...
		MapKeys class296 = client.aClass283_8716.method2631(1336735501);
		if (null != class296) {
