...
public abstract class Class82 {
    ...
    static final void method873(Class403 class403, int i) {
	try {
    ...
    static final void method874(Class403 class403, int i) {
	try {
	    long l = (class403.aLongArray5251[((class403.anInt5245 -= -682569305) * 1685767703)]);
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = l == -1L ? "" : Long.toString(l, 36).toUpperCase();
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method875(Class403 class403, byte i) {
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub13_7550, (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]), -283253928);
    ...
    static final void method876(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_10_;
	}
	catch (RuntimeException runtimeexception) {
