...
public class Class98_Sub4 extends Class98 {
	...
	try {
	    ...
	    PathStrategy.method4095(i_3_, i_4_, i_5_, i_6_, i_7_, i_8_, i_9_, i_10_, this.anInt947 * 1785836763, (byte) -73);
	}
	...
	int i_23_ = i * (-499535773 * this.anInt6940) >> 12;
	int i_24_ = this.anInt6941 * -1676834815 * i_22_ >> 12;
	int i_25_ = this.anInt6947 * 1286877931 * i >> 12;
	int i_26_ = 1208078209 * this.anInt6943 * i_22_ >> 12;
	int i_27_ = 1616079851 * this.anInt6944 * i >> 12;
	int i_28_ = 1348897509 * this.anInt6945 * i_22_ >> 12;
	int i_29_ = 1800257793 * this.anInt6939 * i >> 12;
	int i_30_ = 1776133377 * this.anInt6946 * i_22_ >> 12;
	PathStrategy.method4095(i_23_, i_24_, i_25_, i_26_, i_27_, i_28_, i_29_, i_30_, this.anInt947 * 1785836763, (byte) -33);
    }
    ...
    static final void method1068(Class403 class403, byte i) {
	try {
	    int i_37_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    IComponentDefinition class105 = Class50.getIComponentDefinitions(i_37_, (byte) -58);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 2053897963 * class105.anInt1169;
	}
	catch (RuntimeException runtimeexception) {
