...
public class Class419 {
    ...
    static final void method5604(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class165.aClass319_6366.method3878(1767596149) ? 1 : 0;
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class165.aClass319_6366.method3887(1474356836) ? 1 : 0;
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class165.aClass319_6366.method3880((byte) -46) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		try {
			...
			Class8.anInt102 = 0;
			Class8.anInt103 = 0;
		    } else if (string.equalsIgnoreCase("toogleophax")) {
			client.qa_op = !client.qa_op;
			Class255.method2435("Current value:" + client.qa_op, 1394924823);
		    } else if (string.startsWith("csdbg ")) {
			Class388.aBoolean4154 = true;
			Class388.aString4155 = string.substring(6);
		    } else if (string.equalsIgnoreCase("csdbgall")) {
			Class388.aBoolean4154 = true;
			Class388.aString4155 = null;
		    } else if (string.equalsIgnoreCase("csdbgoff")) {
			Class388.aBoolean4154 = false;
			...
			Class255.method2435(new StringBuilder().append("Look: ").append(Class287.myPlayer.plane).append(",").append((-1125224763 * Class_xa.cameraLookViewLocalX + class341.gameSceneBaseX * -1760580017) >> 6).append(",").append((283514611 * class341.gameSceneBaseY + IPAddress.cameraLookViewLocalY * -1758389953) >> 6).append(",").append((class341.gameSceneBaseX * -1760580017 + -1125224763 * Class_xa.cameraLookViewLocalX) & 0x3f).append(",").append((283514611 * class341.gameSceneBaseY + -1758389953 * IPAddress.cameraLookViewLocalY) & 0x3f).append(" Height: ").append((Class356.method4271(Class_xa.cameraLookViewLocalX * -1125224763, -1758389953 * IPAddress.cameraLookViewLocalY, (Class287.myPlayer.plane), -860898067)) - 771695069 * Class18.cameraLookViewZ).toString(), 1171744016);
		    }
		}
		...
		try {
			...
			class298_sub36.out.writeByte(string.length() + 3);
			class298_sub36.out.writeByte(bool ? 1 : 0);
			class298_sub36.out.writeByte(bool_9_ ? 1 : 0);
			class298_sub36.out.writeString(string, 2127017558);
