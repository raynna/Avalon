...
public final class Class467 {
    ...
    static final void method6024(Class403 class403, int i) {
	try {
	    int i_9_ = (class403.anIntArray5257[1883543357 * class403.anInt5259]);
		...
		is[i_10_] = (class403.anIntArray5244[(681479919 * class403.anInt5239 - -1249619929 * class298_sub37_sub17.anInt9682 + i_10_)]);
	    for (int i_11_ = 0; i_11_ < 2027436935 * class298_sub37_sub17.anInt9674; i_11_++)
		objects[i_11_] = (class403.anObjectArray5240[(i_11_ + (-203050393 * class403.anInt5241 - 2027436935 * class298_sub37_sub17.anInt9674))]);
	    for (int i_12_ = 0; i_12_ < class298_sub37_sub17.anInt9684 * -1520504699; i_12_++)
		ls[i_12_] = (class403.aLongArray5251[(i_12_ + (1685767703 * class403.anInt5245 - class298_sub37_sub17.anInt9684 * -1520504699))]);
	    ...
	    class402.anInt5226 = -985206291 * class403.anInt5259;
