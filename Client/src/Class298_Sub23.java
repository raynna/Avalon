...
public class Class298_Sub23 extends Class298 {
	...
	this.anInt7318 = class298_sub53.readInt((byte) 55);
	this.anInt7335 = class298_sub53.readInt((byte) 18);
	this.anInt7320 = class298_sub53.readInt((byte) -10);
	this.anInt7321 = class298_sub53.readInt((byte) -87);
	if (this.anInt7321 < 0) {
	    this.anInt7321 = this.anInt7321 ^ 0xffffffff;
	    this.aBoolean7336 = true;
	}
	int i = class298_sub53.readInt((byte) 96);
	this.aByteArrayArray7347 = new byte[i][];
	for (int i_0_ = 0; i_0_ < i; i_0_++) {
	    ...
	    this.aByteArrayArray7347[i_0_] = is_3_;
	}
    }
	...
	byte[] is = class243.getFile(i, i_4_);
	if (is == null)
	    return null;
	...
	if (is != null && is[0] <= 0)
	    return null;
	if (this.aByteArray7341 == null) {
	    this.anInt7319 = 0;
	    this.aFloatArray7323 = new float[anInt7327];
	    this.aByteArray7341 = new byte[this.anInt7335];
	    this.anInt7330 = 0;
	    this.anInt7350 = 0;
	}
	for (/**/; (this.anInt7350 < this.aByteArrayArray7347.length); this.anInt7350++) {
	    if (is != null && is[0] <= 0)
		return null;
	    float[] fs = method3071(this.anInt7350);
	    if (fs != null) {
		int i = this.anInt7330;
		int i_5_ = fs.length;
		if (i_5_ > this.anInt7335 - i)
		    i_5_ = this.anInt7335 - i;
		for (int i_6_ = 0; i_6_ < i_5_; i_6_++) {
		    int i_7_ = (int) (128.0F + fs[i_6_] * 128.0F);
		    if ((i_7_ & ~0xff) != 0)
			i_7_ = (i_7_ ^ 0xffffffff) >> 31;
		    this.aByteArray7341[i++] = (byte) (i_7_ - 128);
		}
		if (is != null)
		    is[0] -= i - this.anInt7330;
		this.anInt7330 = i;
	    }
	}
	this.aFloatArray7323 = null;
	byte[] is_8_ = this.aByteArray7341;
	this.aByteArray7341 = null;
	return new Class298_Sub26_Sub1(this.anInt7318, is_8_, this.anInt7320, this.anInt7321, this.aBoolean7336);
    }
	...
	if (i_10_ != 0)
	    i_9_ = -i_9_;
	return (float) (i_9_ * Math.pow(2.0, i_11_ - 788));
    }
	...
	for (int i = 0; i < 2; i++) {
		...
		fs[2 * i_16_] = (float) Math.cos(4 * i_16_ * 3.141592653589793 / i_12_);
		fs[2 * i_16_ + 1] = -(float) Math.sin(4 * i_16_ * 3.141592653589793 / i_12_);
	    }
	    float[] fs_17_ = new float[i_13_];
	    for (int i_18_ = 0; i_18_ < i_14_; i_18_++) {
		fs_17_[2 * i_18_] = (float) Math.cos((2 * i_18_ + 1) * 3.141592653589793 / (2 * i_12_));
		fs_17_[2 * i_18_ + 1] = (float) Math.sin((2 * i_18_ + 1) * 3.141592653589793 / (2 * i_12_));
	    }
	    float[] fs_19_ = new float[i_14_];
	    for (int i_20_ = 0; i_20_ < i_15_; i_20_++) {
		fs_19_[2 * i_20_] = (float) Math.cos((4 * i_20_ + 2) * 3.141592653589793 / i_12_);
		fs_19_[2 * i_20_ + 1] = -(float) Math.sin((4 * i_20_ + 2) * 3.141592653589793 / i_12_);
	    }
	...
	method3062(this.aByteArrayArray7347[i], 0);
	method3063();
	...
	int i_49_ = class269.anInt2884;
	int i_50_ = class269.anIntArray2886[i_49_];
	boolean bool_51_ = !aClass281Array7344[i_50_].method2613();
	boolean bool_52_ = bool_51_;
	for (i_50_ = 0; i_50_ < class269.anInt2885; i_50_++) {
	    Class280 class280 = (aClass280Array7329[class269.anIntArray2887[i_50_]]);
	    float[] fs = aFloatArray7349;
	    class280.method2609(fs, i_39_ >> 1, bool_52_);
	}
	if (!bool_51_) {
	    i_50_ = class269.anInt2884;
	    int i_53_ = class269.anIntArray2886[i_50_];
	...
	if (bool_51_) {
		...
		float f = (float) Math.sin((i_103_ - i_43_ + 0.5) / i_45_ * 0.5 * 3.141592653589793);
		aFloatArray7349[i_103_] *= (float) Math.sin(1.5707963267948966 * f * f);
	    }
	    for (int i_104_ = i_46_; i_104_ < i_47_; i_104_++) {
		float f = (float) Math.sin(((i_104_ - i_46_ + 0.5) / i_48_ * 0.5 * 3.141592653589793) + 1.5707963267948966);
		aFloatArray7349[i_104_] *= (float) Math.sin(1.5707963267948966 * f * f);
	    }
	}
	float[] fs = null;
	if (this.anInt7319 > 0) {
	    int i_105_ = this.anInt7319 + i_39_ >> 2;
	    fs = new float[i_105_];
	    if (!this.aBoolean7338) {
		for (int i_106_ = 0; i_106_ < this.anInt7337; i_106_++) {
		    int i_107_ = (this.anInt7319 >> 1) + i_106_;
		    fs[i_106_] += this.aFloatArray7323[i_107_];
		}
	    }
	    if (!bool_51_) {
	...
	float[] fs_110_ = this.aFloatArray7323;
	this.aFloatArray7323 = aFloatArray7349;
	aFloatArray7349 = fs_110_;
	this.anInt7319 = i_39_;
	this.anInt7337 = i_47_ - (i_39_ >> 1);
	this.aBoolean7338 = bool_51_;
	return fs;
    }
