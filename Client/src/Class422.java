...
public abstract class Class422 {
    ...
    public static void resetSounds(byte i) {
	try {
    ...
    static final void method5618(Class403 class403, int i) {
	try {
    ...
    static void method5620(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[class403.anInt5239 * 681479919 - 2] = (Class316.aClass362_3318.method4307((class403.anIntArray5244[class403.anInt5239 * 681479919 - 2]), 245040087).method4567(Class128.aClass148_6331, (class403.anIntArray5244[681479919 * class403.anInt5239 - 1]), -1119994003)) ? 1 : 0;
    ...
    static final void method5622(Class403 class403, short i) {
	try {
	...
	try {
	    Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(4, i);
