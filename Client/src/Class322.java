...
public class Class322 {
    ...
    static final void method3930(Class403 class403, int i) {
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = Class82_Sub6.aClass7Array6846[i_0_].aString96;
	    else
	...
	try {
	    byte[] is = class243.getFile(i, i_1_);
	    if (null == is)
		return null;
	...
	try {
	    ...
	    client.anInt8832 = client.ticketCycle * -1390800553;
