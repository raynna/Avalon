...
public class Class266 {
	...
	this.allowDynamicMap = bool;
	this.aBoolean2851 = bool_0_;
    }
	...
	try {
		...
		if (class365_sub1_sub1_sub2_7_ != null) {
		    ...
		    if (i_8_ != 0 || 0 != i_9_)
			class365_sub1_sub1_sub2.method4414((int) (Math.atan2(i_8_, i_9_) * 2607.5945876176133) & 0x3fff, (byte) 1);
		}
	    }
		...
		if (-1 != class365_sub1_sub1_sub2_sub1.anInt10179 * 579792529 && ((class365_sub1_sub1_sub2_sub1.anInt10120 * 2050671733 == 0) || (-1531994851 * class365_sub1_sub1_sub2_sub1.anInt10124) > 0)) {
		    ...
		    if (0 != i_10_ || i_11_ != 0)
			class365_sub1_sub1_sub2_sub1.method4414((int) (Math.atan2(i_10_, i_11_) * 2607.5945876176133) & 0x3fff, (byte) 1);
	...
	try {
		...
		for (Class298_Sub52 class298_sub52 = (Class298_Sub52) class453.method5939(1766612795); class298_sub52 != null; class298_sub52 = (Class298_Sub52) class453.method5944(49146)) {
		    Class352 class352 = (Class301.aClass339_3251.method4116(-530122905 * class298_sub52.anInt7608, -1838109089));
    ...
    static final void method2527(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class66.anInt666 * -1972322437;
	}
	catch (RuntimeException runtimeexception) {
