...
public class za extends Class52_Sub2 implements Interface25 {
	...
	this.anInt8985 = i;
	this.anInt8984 = i_0_;
	wa(this.aCanvas8982, i, i_0_);
	if (this.aJa8981.method4992((short) 10240) == this)
	    method136();
    }
	...
	this.anInt8985 = i;
	this.anInt8984 = i_1_;
	n(var_ja, this.aCanvas8982, i, i_1_);
    }
	...
	if (this.aJa8981.method4992((short) -12143) == this)
	    method546();
	ma(true);
	this.nativeid = 0L;
	...
	if (this.aJa8981.method4992((short) -2527) == this)
	    method546();
	ma(true);
	this.nativeid = 0L;
	this.aCanvas8982 = null;
	...
	this.anInt8985 = i;
	this.anInt8984 = i_14_;
	wa(this.aCanvas8982, i, i_14_);
	if (this.aJa8981.method4992((short) -7265) == this)
	    method136();
    }

    @Override
    boolean method134() {
	this.aJa8981.PA(this);
	return true;
    }
	...
	if (this.aJa8981.method4992((short) -9633) == this)
	    method546();
	ma(true);
	this.nativeid = 0L;
	this.aCanvas8982 = null;
