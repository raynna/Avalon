...
public class Class3 {
	...
	try {
	    ...
	    try {
		class476 = Class86.method962("", client.gametype.aString5317, true, -1804643872);
    ...
    static final void method301(Class403 class403, byte i) {
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub16_7557, (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) == 1 ? 1 : 0, -223155318);
	    method300(656179282);
    ...
    static final void method303(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class494.method6192(string, -1912416826) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
