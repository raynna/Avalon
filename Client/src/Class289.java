...
public class Class289 {
    ...
    public boolean method2742(int i, int i_68_, int i_69_, int i_70_, int i_71_, int objtype, int i_73_, int i_74_) {
	try {
	    if (1 == i_69_) {
    ...
    static final void method2745(Class403 class403, int i) {
	try {
	    class403.anInt5245 -= -1365138610;
	    if ((class403.aLongArray5251[1685767703 * class403.anInt5245]) < (class403.aLongArray5251[1685767703 * class403.anInt5245 + 1]))
    ...
    static final void method2746(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_84_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    int i_85_ = (class403.anIntArray5244[1 + class403.anInt5239 * 681479919]);
	    ClientScriptMap class483 = Class51.aClass475_506.getClientScriptMap(i_84_, 1528209569);
	    if ('s' == class483.aChar6037) {
		/* empty */
	    }
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = class483.method6122(i_85_, (byte) -30);
	}
	catch (RuntimeException runtimeexception) {
