...
public class Class272 {
	...
	try {
	    if (this.aClass243_2901.method2296(1029061077) == 1)
		return method2549(0, i, is, 1909168122);
	    if (this.aClass243_2901.method2316(i, -1941901563) == 1)
	...
	try {
	    if (this.aClass243_2900.method2296(853704793) == 1)
		return method2550(0, i, is, -745389241);
	    if (this.aClass243_2900.method2316(i, -1796273847) == 1)
    ...
    static final void method2553(Class403 class403, int i) {
	try {
    ...
    static final void method2554(Class403 class403, int i) {
	try {
	    ...
	    class298_sub36.out.writeString(string, 2114518021);
    ...
    static final void method2555(Class403 class403, int i) {
	try {
    ...
    static final void method2556(Class403 class403, int i) {
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub2_7547, (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) == 1 ? 1 : 0, 1031457025);
