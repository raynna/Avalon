...
public abstract class Class365_Sub1_Sub5 extends Class365_Sub1 {
	...
	return (aClass331_7722.aBooleanArrayArray3563[(583010427 * aClass331_7722.anInt3538 + (((int) class217.aFloat2451 >> -1688804109 * aClass331_7722.anInt3504) - -804213305 * aClass331_7722.anInt3553))][(aClass331_7722.anInt3538 * 583010427 + (((int) class217.aFloat2454 >> -1688804109 * aClass331_7722.anInt3504) - aClass331_7722.anInt3513 * 465603579))]);
    }
	...
	try {
	    ...
	    int i_2_ = 0;
	    if (aClass331_7722.anInt3553 * -804213305 == i_0_)
		i_2_++;
	    else if (-804213305 * aClass331_7722.anInt3553 < i_0_)
		i_2_ += 2;
	...
	int i_5_ = 0;
	if (aClass331_7722.anInt3553 * -804213305 == i)
	    i_5_++;
	else if (-804213305 * aClass331_7722.anInt3553 < i)
	    i_5_ += 2;
	if (465603579 * aClass331_7722.anInt3513 == i_4_)
	    i_5_ += 3;
	else if (465603579 * aClass331_7722.anInt3513 > i_4_)
	    i_5_ += 6;
	...
	method4340(new Class217(i, i_7_, i_8_));
    }
    ...
    static final void method4522(Class403 class403, int i) {
	try {
	    int i_12_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    MapDetails class298_sub37_sub13 = Class301.method3705(i_12_);
	    if (null == class298_sub37_sub13) {
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = 0;
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = 0;
	    } else {
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = (-1973484731 * class298_sub37_sub13.tileHash >> 14 & 0x3fff);
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = class298_sub37_sub13.tileHash * -1973484731 & 0x3fff;
	    }
	}
	catch (RuntimeException runtimeexception) {
