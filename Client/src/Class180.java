...
public class Class180 implements Interface20 {
    ...
    static final void method1836(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8647 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1837(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class165.aClass319_6366.method3894((byte) 69);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1838(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class352.method4245(Class122.method1319((byte) 1));
	}
	catch (RuntimeException runtimeexception) {
