...
public final class Class70 {
	...
	try {
		...
		this.aClass437_683.method5811((byte) -68);
	}
	...
	try {
	    Class298_Sub35 class298_sub35 = ((Class298_Sub35) this.aClass437_683.method5812(i));
	...
	try {
	    if (this.aClass437_683 == null)
		this.aClass437_683 = new HashTable(1793476641 * this.anInt682);
	    Class298_Sub35 class298_sub35 = ((Class298_Sub35) this.aClass437_683.method5812(i));
	    if (null != class298_sub35)
		class298_sub35.anInt7394 = i_4_ * -898670337;
	    else {
		class298_sub35 = new Class298_Sub35(i_4_);
		this.aClass437_683.method5817(class298_sub35, i);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (-1 != -1204256389 * class432.anInt5400)
			...
			i_16_ = i_12_;
		    if ((i_15_ == -1976050083 * GameObjectType.T0.type) || (-1976050083 * GameObjectType.T2.type == i_15_)) {
			if (i_14_ == 0)
		    ...
		    if (i_15_ == -1976050083 * GameObjectType.T3.type) {
			if (0 == i_14_)
		    ...
		    if (GameObjectType.T2.type * -1976050083 == i_15_) {
			if (i_14_ == 0)
		...
		else if (GameObjectType.T9.type * -1976050083 == i_18_) {
		    int i_19_ = -1118482;
		    if (1532834983 * class432.anInt5382 > 0)
			i_19_ = -1179648;
		    if (i_17_ == 0 || i_17_ == 2)
	...
	try {
		...
		Class403 class403 = HandshakePacket.method1950(1034965053);
		...
		class403.anObjectArray5234[0] = string;
		class403.anIntArray5248[0] = i_21_;
	...
	try {
	    Class74.anInt691 = class243.getArchiveId("p11_full") * 1133798363;
	    Class74.anInt690 = class243.getArchiveId("p12_full") * 399685195;
	    Class74.anInt698 = class243.getArchiveId("b12_full") * 1666679073;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("cv.a(").append(')').toString());
	}
