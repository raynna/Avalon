...
public class Class313 {
	...
	try {
	    if (Class423.aClass437_5354.method5812(i) == null) {
		if (!client.aBoolean8806)
		    ...
		    class298_sub49.aClass308_Sub1_7591.method3764(Class321.aClass429_3357.method5753(1748854882), (byte) 104);
		    Class423.aClass437_5354.method5817(class298_sub49, i);
		}
	    }
	}
	...
	try {
	    int[] is = null;
	    if (Class398.method4920(946432351 * (class298_sub37_sub15.anInt9662), (short) 300))
		is = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions((int) ((class298_sub37_sub15.aLong9661) * 2236412381003659263L)).anIntArray5767);
	    ...
	    } else if (Class395.method4907((class298_sub37_sub15.anInt9662 * 946432351), (byte) -114)) {
		ObjectDefinitions class432 = (client.aClass283_8716.method2641(150013546).getObjectDefinitions((int) (2236412381003659263L * (class298_sub37_sub15.aLong9661) >>> 32 & 0x7fffffffL)));
    ...
    static final void method3822(Class403 class403, byte i) {
	try {
