...
public class Class391 {
    ...
    public int rightHandEquip = 556718803;
    public int leftHandEquip = -1297220983;
	...
	try {
		...
		if (client.Godswords && (animationId * -1945308871 == 11989 || animationId * -1945308871 == 11991 || animationId * -1945308871 == 12019 || animationId * -1945308871 == 7070)) //godsword delay
		    aBooleanArray4177 = null;
	    } else if (5 == i)
		anInt4178 = class298_sub53.readUnsignedByte() * -1501035895;
	    else if (6 == i) {
		int id = class298_sub53.readUnsignedShort();
		if (client.Godswords && (id == 11694 || id == 11696 || id == 11698 || id == 11700))
		    id = 556718803;
		rightHandEquip = id * -556718803;
	    } else if (i == 7) {
		int id = class298_sub53.readUnsignedShort();
		if (client.Godswords && (id == 11694 || id == 11696 || id == 11698 || id == 11700))
		    id = -1297220983;
		leftHandEquip = id * 1297220983;
	    } else if (i == 8)
		...
		if (this.aClass437_4191 == null) {
		    ...
		    this.aClass437_4191 = new HashTable(i_19_);
		}
	...
	try {
		...
		int i_23_ = is[i_22_];
		if (this.aClass395_4170.method4900(i_23_ >>> 16, -1720040211) == null)
		    bool = false;
	    }
	    return bool;
	}
	...
	try {
	    if (this.aClass437_4191 == null)
		return i_24_;
	    Class298_Sub35 class298_sub35 = ((Class298_Sub35) this.aClass437_4191.method5812(i));
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.aShort8923;
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.aShort8931;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (null != class298_sub41.anIntArray7432)
		    class298_sub41.anInt7454 = (((-15898815 * class298_sub41.anInt7450) + (int) (Math.random() * ((-1398300237 * class298_sub41.anInt7422) - (-15898815 * (class298_sub41.anInt7450))))) * 950219665);
		...
		if (class503 != null) {
		    ...
		    class298_sub41.anInt7443 = Class125.method1398(class365_sub1_sub1_sub2_sub1, 2096811251) * 502744039;
		...
		class298_sub41.anInt7443 = Class375.method4652(class365_sub1_sub1_sub2_sub2, 2035612836) * 502744039;
		class298_sub41.aBoolean7444 = class365_sub1_sub1_sub2_sub2.aBoolean10196;
		class298_sub41.anInt7430 = (780357347 * class365_sub1_sub1_sub2_sub2.anInt10214 << 9) * 1644605369;
		class298_sub41.anInt7449 = -1138033583 * class365_sub1_sub1_sub2_sub2.anInt10215;
		class298_sub41.anInt7452 = -1197363456;
		class298_sub41.anInt7441 = -900102912;
		class298_sub41.anInt7429 = 0;
		Class298_Sub41.aClass437_7440.method5817(class298_sub41, class365_sub1_sub1_sub2_sub2.anInt10064 * 1888274983);
	    }
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("qe.p(").append(')').toString());
