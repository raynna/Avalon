...
final class Class382 implements Interface22 {
	...
	try {
	    class403.anInt5239 -= -407600972;
	    Class194.method1868(2025307040);
	    Class365_Sub1_Sub3_Sub2.method4512(313309588);
	    IPAddress.anInt5958 = 1806117321 * (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    Class82_Sub4.anInt6833 = (-1838335691 * (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]));
	    Class313.anInt3297 = (389597853 * (class403.anIntArray5244[2 + 681479919 * class403.anInt5239]));
	    Class436.anInt5484 = ((class403.anIntArray5244[3 + 681479919 * class403.anInt5239]) * -1589801219);
	    Class362.anInt3918 = (-666665017 * (class403.anIntArray5244[4 + class403.anInt5239 * 681479919]));
	    Class422_Sub14.anInt8400 = ((class403.anIntArray5244[5 + class403.anInt5239 * 681479919]) * 207797751);
	    ClanSettings.anInt1680 = ((class403.anIntArray5244[6 + 681479919 * class403.anInt5239]) * -741526353);
	    Class361.anInt3914 = ((class403.anIntArray5244[681479919 * class403.anInt5239 + 7]) * -221610643);
	    Class260.anInt2820 = ((class403.anIntArray5244[681479919 * class403.anInt5239 + 8]) * 1226151685);
	    Class343.anInt3674 = (-994575607 * (class403.anIntArray5244[9 + class403.anInt5239 * 681479919]));
	    Class298_Sub40_Sub2.anInt9693 = (-1941123577 * (class403.anIntArray5244[681479919 * class403.anInt5239 + 10]));
	    Class242.anInt2710 = ((class403.anIntArray5244[11 + class403.anInt5239 * 681479919]) * -1418353209);
	    Class158.idx8.method2310(Class362.anInt3918 * 142643703, -457216440);
	    Class158.idx8.method2310(Class422_Sub14.anInt8400 * 1757615047, -457216440);
	    Class158.idx8.method2310(1049272911 * ClanSettings.anInt1680, -457216440);
	    Class158.idx8.method2310(-745532315 * Class361.anInt3914, -457216440);
	...
	try {
	    ...
	    int i_9_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    int i_10_ = (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_9_ > i_10_ ? i_9_ : i_10_;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = new StringBuilder().append(string).append(i_11_).toString();
	}
	catch (RuntimeException runtimeexception) {
