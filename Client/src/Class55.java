...
public class Class55 {
    ...
    static final void method603(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    Class386.method4725(Class287.myPlayer, (class403.anIntArray5244[(class403.anInt5239 * 681479919)]), (class403.anIntArray5244[(681479919 * class403.anInt5239 + 1)]), -16777216);
	}
    ...
    static final void method604(Class403 class403, byte i) {
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub25_7569, (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]), -2054835114);
    ...
    static final void method605(Class403 class403, int i) {
	try {
	...
	try {
		...
		for (int i_1_ = 0; i_1_ < strings.length; i_1_++) {
			...
			Class146.aLong1576 = (Class122.method1319((byte) 1) + i_2_ * 1000) * 6717445677357895093L;
			break;
		    }
