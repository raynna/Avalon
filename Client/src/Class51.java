...
public class Class51 {
    ...
    static final void method539(Class403 class403, byte i) {
	try {
	    Class86.method967((class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]), 255, 50, 36344261);
	}
    ...
    static final void method540(Class403 class403, short i) {
	try {
	...
	try {
	    ...
	    player.method4341((player.scenePositionXQueue[0] << 9) + (player.getSize() << 8), (player.method4343().aClass217_2599.aFloat2455), (player.scenePositionYQueue[0] << 9) + (player.getSize() << 8));
    ...
    static final void method542(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub13_7550.method5675(-254007730);
	}
	catch (RuntimeException runtimeexception) {
