...
public abstract class Class_xa {
    ...
    public static int cameraLookViewLocalX;
    ...
    static final void method6360(Class403 class403, int i) {
	try {
	    int i_166_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
    ...
    static final void method6361(Class403 class403, byte i) {
	try {
	    int i_167_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
    ...
    static final void method6362(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_168_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    int i_169_ = (class403.anIntArray5244[1 + 681479919 * class403.anInt5239]);
	    if (i_168_ > 700 || i_169_ > 700)
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = 256;
	    double d = ((Math.random() * (i_169_ + i_168_) - i_168_ + 800.0) / 100.0);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (int) (Math.pow(2.0, d) + 0.5);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method6364(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -1175642067;
	    int i_170_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    int i_171_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]);
	    int i_172_ = (class403.anIntArray5244[2 + class403.anInt5239 * 681479919]);
	    long l = MapKeys.method2830(0, 0, 12, i_170_, i_171_, i_172_, (byte) 67);
	    int i_173_ = Class408.method4966(l);
	    if (i_172_ < 1970)
		i_173_--;
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_173_;
	}
	catch (RuntimeException runtimeexception) {
