...
public class Class373 {
    ...
    static final void method4606(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
    ...
    static final void method4607(Class403 class403, byte i) {
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = client.anIntArray8705[i_2_];
	    else
    ...
    static final void method4608(Class403 class403, int i) {
	try {
    ...
    static final void method4609(Class403 class403, int i) {
	try {
	    boolean bool = false;
	    String string = "";
    ...
    static final void method4611(Class403 class403, int i) {
	try {
	    int i_5_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    int i_6_ = client.GRAND_EXCHANGE_SLOTS[i_5_].method2400(-574288948);
