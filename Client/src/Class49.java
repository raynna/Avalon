...
public class Class49 {
	...
	if (!method528())
	    return false;
	Class52_Sub1_Sub2 class52_sub1_sub2 = (this.aClass_ra_Sub2_497.aClass52_Sub1_Sub2_8148);
	Class298_Sub37_Sub18 class298_sub37_sub18 = new Class298_Sub37_Sub18(this.aClass_ra_Sub2_497, Class55.aClass55_557, Class77.aClass77_717, class30_sub4.anInt6750, (class30_sub4.anInt6751));
	boolean bool = false;
	this.aClass_ra_Sub2_497.method5143(class52_sub1_sub2, (byte) 27);
	...
	if (class52_sub1_sub2.method560()) {
	    ...
	    OpenGL.glUniform2f(OpenGL.glGetUniformLocation((this.aClass29_498.anInt365), "sampleSize"), 1.0F / class30_sub4_0_.anInt6750, 1.0F / class30_sub4_0_.anInt6751);
	    for (int i = 0; i < class30_sub4.anInt6749; i++) {
		float f_1_ = ((float) i / (float) class30_sub4.anInt6749);
		this.aClass_ra_Sub2_497.method5256(class30_sub4_0_);
		OpenGL.glBegin(7);
	...
	this.aClass_ra_Sub2_497.method5005(class52_sub1_sub2, (byte) 7);
	return bool;
    }

    boolean method528() {
	if (this.aClass_ra_Sub2_497.framebuffer_obj && (this.aClass_ra_Sub2_497.fragment_shader) && this.aClass29_498 == null) {
	    Class48 class48 = (Class48.method526(this.aClass_ra_Sub2_497, 35632, "uniform float rcpRelief;\nuniform vec2 sampleSize;\nuniform sampler3D heightMap;\nvoid main() {\nfloat dx = texture3D(heightMap, vec3(-sampleSize.x, 0.0, 0.0)+gl_TexCoord[0].xyz).r - texture3D(heightMap, vec3(sampleSize.x, 0.0, 0.0)+gl_TexCoord[0].xyz).r;\nfloat dy = texture3D(heightMap, vec3(0.0, -sampleSize.y, 0.0)+gl_TexCoord[0].xyz).r - texture3D(heightMap, vec3(0.0, sampleSize.y, 0.0)+gl_TexCoord[0].xyz).r;\ngl_FragColor = vec4(0.5+normalize(vec3(dx, dy, rcpRelief))*0.5, texture3D(heightMap, gl_TexCoord[0].xyz).r);\n}\n"));
	    if (class48 != null)
		this.aClass29_498 = Class29.method406(this.aClass_ra_Sub2_497, new Class48[] { class48 });
	}
	return this.aClass29_498 != null;
    }

    Class49(Class_ra_Sub2 class_ra_sub2) {
	this.aClass_ra_Sub2_497 = class_ra_sub2;
    }
}
