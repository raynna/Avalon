...
public class Class409 {
	...
	try {
	    return (client.anIntArray8739[this.anInt5281 * -1511232243]);
	}
	...
	try {
	    ...
	    if (null == interface3)
		return null;
	    if (interface3.method32((byte) 42) != -1949334017 * this.anInt5282)
		return null;
	    return interface3;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    int i_2_ = 1008331379 * this.aClass341_5283.anInt3645;
	    Class341 class341 = client.aClass283_8716.method2628(681479919);
	    int i_3_ = (this.aClass341_5283.gameSceneBaseX * -1760580017 - class341.gameSceneBaseX * -1760580017);
	    int i_4_ = (this.aClass341_5283.gameSceneBaseY * 283514611 - class341.gameSceneBaseY * 283514611);
    ...
    static final void method4973(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
	    class403.anInt5239 -= -783761378;
	    class105.anInt1158 = (class403.anIntArray5244[class403.anInt5239 * 681479919]) * 349940087;
	    class105.anInt1242 = ((class403.anIntArray5244[1 + 681479919 * class403.anInt5239]) * 153098785);
    ...
    static final void method4974(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class301_Sub1.aBoolean7635 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4975(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub7_7581.method5650(-192114923);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		for (int i_9_ = 0; i_9_ < class456s.length; i_9_++) {
		    if (i == class456s[i_9_].anInt5663 * 28445523 && 262154323 * class456s[i_9_].anInt5665 == i_5_ && (i_7_ == 0 || 1126617439 * (class456s[i_9_].anInt5662) == i_7_) && (!bool || (-1087459453 * class456s[i_9_].anInt5664 > i_6_))) {
    ...
    static final void method4977(Class403 class403, int i) {
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub11_7558, (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]), 417121289);
    ...
    static final void method4979(Class403 class403, int i) {
	try {
	    boolean bool = ((class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) != 0);
	    int i_11_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = Class300.method3685(i_11_, 0, bool, Class321.aClass429_3357, (short) 25477);
	}
	catch (RuntimeException runtimeexception) {
