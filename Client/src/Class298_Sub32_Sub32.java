...
public class Class298_Sub32_Sub32 extends Class298_Sub32 {
	...
	switch (i) {
	    case 0:
		this.anInt9511 = class298_sub53.readUnsignedShort() * 1298582163;
		break;
	    case 1:
		this.anInt9514 = class298_sub53.readUnsignedShort() * 2091520197;
		break;
	}
    }
    ...
    static final void method3344(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub7.aBoolean8385 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
