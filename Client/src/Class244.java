...
public class Class244 {
    ...
    static final void method2323(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    class105.anInt1193 = (class403.anIntArray5244[class403.anInt5239 * 681479919]) * 437213185;
	    class105.anInt1194 = (1266800241 * (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]));
    ...
    static final void method2324(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -391880689;
	    int i_14_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    Interface class298_sub51 = ((Interface) client.aClass437_8841.method5812(i_14_));
    ...
    static final void method2325(Class403 class403, byte i) {
	try {
    ...
    static final void method2329(Class403 class403, int i) {
	try {
	    if ((class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) == 1)
		class403.anInt5259 += ((class403.anIntArray5257[1883543357 * class403.anInt5259]) * 286750741);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (class365_sub1_sub1_sub2_sub1 == (class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub1_7433)) {
