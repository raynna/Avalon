...
public class Class504 {
	...
	this.idx2 = class243;
	if (null != this.idx2)
	    this.idx2.method2316(Class120.aClass120_1416.anInt1460 * -1006924897, 1020653544);
    }
	...
	try {
	    Class497 class497;
	    synchronized (this.aClass348_6195) {
		class497 = (Class497) this.aClass348_6195.method4184(i);
	    }
	    if (class497 != null)
		return class497;
	    byte[] is;
	    synchronized (this.idx2) {
		is = (this.idx2.getFile(-1006924897 * Class120.aClass120_1416.anInt1460, i));
	    }
	    class497 = new Class497();
	    if (is != null)
		class497.method6204(new RsByteBuffer(is), -1070488617);
	    synchronized (this.aClass348_6195) {
		this.aClass348_6195.method4194(class497, i);
	    }
	    return class497;
	}
	catch (RuntimeException runtimeexception) {
