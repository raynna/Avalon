...
public class Class298_Sub40_Sub8 extends Class298_Sub40 {
	...
	this.anInt9713 = class298_sub53.readInt((byte) 64) * 1255006169;
	this.aLong9712 = class298_sub53.readLong((short) 9128) * 3352878270957006169L;
    }

    @Override
    void method3508(RsByteBuffer class298_sub53, int i) {
	try {
	    this.anInt9713 = class298_sub53.readInt((byte) -40) * 1255006169;
	    this.aLong9712 = (class298_sub53.readLong((short) 26335) * 3352878270957006169L);
	}
	catch (RuntimeException runtimeexception) {
	...
	this.anInt9713 = class298_sub53.readInt((byte) -113) * 1255006169;
	this.aLong9712 = class298_sub53.readLong((short) 19522) * 3352878270957006169L;
    }
