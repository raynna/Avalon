...
public class Class405 {
    ...
    static final void method4956(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8802 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    client.anInt8832 = -1390800553 * client.ticketCycle;
    ...
    static void method4959(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[class403.anInt5239 * 681479919 - 1] = (Class316.aClass362_3318.method4307((class403.anIntArray5244[class403.anInt5239 * 681479919 - 1]), 245040087).anInt4006) * 1327747841;
	}
	catch (RuntimeException runtimeexception) {
