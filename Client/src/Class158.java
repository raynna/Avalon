...
public class Class158 implements Interface5 {
    ...
    static final void method1699(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
    ...
    static final void method1700(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1170 * 1045422783;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1701(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -1567522756;
	    Class320.method3913((class403.anIntArray5244[class403.anInt5239 * 681479919]), (class403.anIntArray5244[1 + class403.anInt5239 * 681479919]), (class403.anIntArray5244[681479919 * class403.anInt5239 + 2]), (class403.anIntArray5244[3 + 681479919 * class403.anInt5239]), true, 256, 1228357249);
	}
	catch (RuntimeException runtimeexception) {
