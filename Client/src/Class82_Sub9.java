...
public class Class82_Sub9 extends Class82 {
	...
	this.anInt6858 = class298_sub53.readUnsignedShort() * 1855434323;
	this.anInt6857 = class298_sub53.readUnsignedShort() * -1535090649;
    }
	...
	try {
	    ...
	    Class239.method2210((class403.anIntArray5244[681479919 * class403.anInt5239]), (class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]), (class403.anIntArray5244[2 + class403.anInt5239 * 681479919]), 255, 256, 1698817492);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return ((i >= -1976050083 * GameObjectType.T0.type && i <= GameObjectType.T3.type * -1976050083) || GameObjectType.T9.type * -1976050083 == i);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method902(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub30_7575.method5730(1991711560) == 1 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
