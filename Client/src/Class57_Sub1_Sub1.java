...
public class Class57_Sub1_Sub1 extends Class57_Sub1 {
	...
	int[] is_2_ = (this.aClass_ra_Sub1_9006.anIntArray7967);
	if (is_2_ != null) {
	    if (anInt9004 == 0) {
		if (anInt8991 == 0) {
		    int i_3_ = anInt9001;
			...
			if (i_4_ >= 0) {
			    ...
			    int i_7_ = anInt9011;
			    int i_8_ = anInt8999;
			    if (i_6_ >= 0 && i_7_ >= 0 && i_6_ - (this.anInt9010 << 12) < 0 && i_7_ - (this.anInt8989 << 12) < 0) {
				int i_9_ = is[i_4_] - i;
				...
				if (i_8_ < i_10_)
				    i_8_ = i_10_;
				for (/**/; i_8_ < 0; i_8_++) {
				    int i_12_ = (this.anIntArray9965[((i_7_ >> 12) * (this.anInt9010)) + (i_6_ >> 12)]);
				    int i_13_ = i_12_ >>> 24;
				    int i_14_ = 256 - i_13_;
			...
			if (i_17_ >= 0) {
			    ...
			    int i_21_ = anInt8999;
			    if (i_19_ >= 0 && (i_19_ - (this.anInt9010 << 12)) < 0) {
				int i_22_;
				if ((i_22_ = (i_20_ - (this.anInt8989 << 12))) >= 0) {
				...
				if (i_21_ < i_24_)
				    i_21_ = i_24_;
				for (/**/; i_21_ < 0; i_21_++) {
				    int i_26_ = (this.anIntArray9965[((i_20_ >> 12) * (this.anInt9010)) + (i_19_ >> 12)]);
				    int i_27_ = i_26_ >>> 24;
				    int i_28_ = 256 - i_27_;
			...
			if (i_31_ >= 0) {
			    ...
			    int i_35_ = anInt8999;
			    if (i_33_ >= 0 && (i_33_ - (this.anInt9010 << 12)) < 0) {
				if (i_34_ < 0) {
				...
				int i_37_;
				if ((i_37_ = (1 + i_34_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_35_)
				    i_35_ = i_37_;
				...
				if (i_35_ < i_39_)
				    i_35_ = i_39_;
				for (/**/; i_35_ < 0; i_35_++) {
				    int i_41_ = (this.anIntArray9965[((i_34_ >> 12) * (this.anInt9010)) + (i_33_ >> 12)]);
				    int i_42_ = i_41_ >>> 24;
				    int i_43_ = 256 - i_42_;
		...
		if (anInt8991 == 0) {
			...
			if (i_46_ >= 0) {
			    ...
			    int i_49_ = anInt9011;
			    int i_50_ = anInt8999;
			    if (i_49_ >= 0 && (i_49_ - (this.anInt8989 << 12)) < 0) {
				int i_51_;
				if ((i_51_ = (i_48_ - (this.anInt9010 << 12))) >= 0) {
				...
				if (i_50_ < i_53_)
				    i_50_ = i_53_;
				for (/**/; i_50_ < 0; i_50_++) {
				    int i_55_ = (this.anIntArray9965[((i_49_ >> 12) * (this.anInt9010)) + (i_48_ >> 12)]);
				    int i_56_ = i_55_ >>> 24;
				    int i_57_ = 256 - i_56_;
			...
			if (i_60_ >= 0) {
			    ...
			    int i_64_ = anInt8999;
			    int i_65_;
			    if ((i_65_ = i_62_ - ((this.anInt9010) << 12)) >= 0) {
				...
				i_64_ = i_65_;
			    if ((i_65_ = i_63_ - ((this.anInt8989) << 12)) >= 0) {
				...
				i_64_ = i_67_;
			    for (/**/; i_64_ < 0; i_64_++) {
				int i_69_ = (this.anIntArray9965[((i_63_ >> 12) * this.anInt9010 + (i_62_ >> 12))]);
				int i_70_ = i_69_ >>> 24;
				int i_71_ = 256 - i_70_;
			...
			if (i_74_ >= 0) {
			    ...
			    int i_78_ = anInt8999;
			    int i_79_;
			    if ((i_79_ = i_76_ - ((this.anInt9010) << 12)) >= 0) {
			    ...
			    if ((i_79_ = (1 + i_77_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_78_)
				i_78_ = i_79_;
				...
				i_78_ = i_81_;
			    for (/**/; i_78_ < 0; i_78_++) {
				int i_83_ = (this.anIntArray9965[((i_77_ >> 12) * this.anInt9010 + (i_76_ >> 12))]);
				int i_84_ = i_83_ >>> 24;
				int i_85_ = 256 - i_84_;
		...
		while (i_87_ < 0) {
			...
			int i_91_ = anInt9011;
			int i_92_ = anInt8999;
			if (i_91_ >= 0 && i_91_ - (this.anInt8989 << 12) < 0) {
			    if (i_90_ < 0) {
			    ...
			    int i_94_;
			    if ((i_94_ = (1 + i_90_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_92_)
				i_92_ = i_94_;
				...
				i_92_ = i_96_;
			    for (/**/; i_92_ < 0; i_92_++) {
				int i_98_ = (this.anIntArray9965[((i_91_ >> 12) * this.anInt9010 + (i_90_ >> 12))]);
				int i_99_ = i_98_ >>> 24;
		...
		while (i_102_ < 0) {
			...
			int i_109_;
			if ((i_109_ = (1 + i_105_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_107_)
			    i_107_ = i_109_;
			if ((i_109_ = i_106_ - (this.anInt8989 << 12)) >= 0) {
			...
			if (i_107_ < i_111_)
			    i_107_ = i_111_;
			for (/**/; i_107_ < 0; i_107_++) {
			    int i_113_ = (this.anIntArray9965[(((i_106_ >> 12) * this.anInt9010) + (i_105_ >> 12))]);
		...
		while (i_117_ < 0) {
			...
			int i_124_;
			if ((i_124_ = (1 + i_120_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_122_)
			    i_122_ = i_124_;
			if (i_121_ < 0) {
			...
			if ((i_124_ = (1 + i_121_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_122_)
			    i_122_ = i_124_;
			...
			if (i_122_ < i_126_)
			    i_122_ = i_126_;
			for (/**/; i_122_ < 0; i_122_++) {
			    int i_128_ = (this.anIntArray9965[(((i_121_ >> 12) * this.anInt9010) + (i_120_ >> 12))]);
	...
	if (bool)
	    this.anIntArray9965 = new int[i_133_ * i_134_];
	else
	    this.anIntArray9965 = is;
	i_132_ -= this.anInt9010;
	int i_135_ = 0;
	for (int i_136_ = 0; i_136_ < i_134_; i_136_++) {
	    for (int i_137_ = 0; i_137_ < i_133_; i_137_++)
		this.anIntArray9965[i_135_++] = is[i++];
	    i += i_132_;
	}
    }
	...
	for (int i_144_ = 0; i_144_ < i_141_; i_144_++) {
		...
		this.anIntArray9965[i_145_ + i_147_] = is[i_146_ + i_147_] & 0xffffff;
	}
    }
	...
	if (is == null)
	    throw new IllegalStateException("");
	if (i_149_ == 0) {
	    for (int i_150_ = 0; i_150_ < this.anInt8989; i_150_++) {
		int i_151_ = i_150_ * this.anInt9010;
		int i_152_ = (((i_148_ + i_150_) * ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883)) + i);
		for (int i_153_ = 0; i_153_ < this.anInt9010; i_153_++)
		    this.anIntArray9965[i_151_ + i_153_] = ((this.anIntArray9965[i_151_ + i_153_]) & 0xffffff | is[i_152_ + i_153_] << 8 & ~0xffffff);
	    }
	} else if (i_149_ == 1) {
	    for (int i_154_ = 0; i_154_ < this.anInt8989; i_154_++) {
		int i_155_ = i_154_ * this.anInt9010;
		int i_156_ = (((i_148_ + i_154_) * ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883)) + i);
		for (int i_157_ = 0; i_157_ < this.anInt9010; i_157_++)
		    this.anIntArray9965[i_155_ + i_157_] = ((this.anIntArray9965[i_155_ + i_157_]) & 0xffffff | is[i_156_ + i_157_] << 16 & ~0xffffff);
	    }
	} else if (i_149_ == 2) {
	    for (int i_158_ = 0; i_158_ < this.anInt8989; i_158_++) {
		int i_159_ = i_158_ * this.anInt9010;
		int i_160_ = (((i_148_ + i_158_) * ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883)) + i);
		for (int i_161_ = 0; i_161_ < this.anInt9010; i_161_++)
		    this.anIntArray9965[i_159_ + i_161_] = ((this.anIntArray9965[i_159_ + i_161_]) & 0xffffff | is[i_160_ + i_161_] << 24 & ~0xffffff);
	    }
	} else if (i_149_ == 3) {
	    for (int i_162_ = 0; i_162_ < this.anInt8989; i_162_++) {
		int i_163_ = i_162_ * this.anInt9010;
		int i_164_ = (((i_148_ + i_162_) * ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883)) + i);
		for (int i_165_ = 0; i_165_ < this.anInt9010; i_165_++)
		    this.anIntArray9965[i_163_ + i_165_] = ((this.anIntArray9965[i_163_ + i_165_]) & 0xffffff | (is[i_164_ + i_165_] != 0 ? -16777216 : 0));
	    }
	}
    }
	...
	return new Class24(this.anInt9010, this.anInt8989, this.anIntArray9965);
    }
	...
	int[] is = (this.aClass_ra_Sub1_9006.anIntArray7967);
	if (is != null) {
	    int i_170_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
	    i += this.anInt8990;
	    i_166_ += this.anInt9000;
	    int i_171_ = i_166_ * i_170_ + i;
	    int i_172_ = 0;
	    int i_173_ = this.anInt8989;
	    int i_174_ = this.anInt9010;
	    int i_175_ = i_170_ - i_174_;
	    int i_176_ = 0;
	    if (i_166_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_177_ = ((this.aClass_ra_Sub1_9006.anInt7976) * -1278653805 - i_166_);
		i_173_ -= i_177_;
		i_166_ = ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805);
		i_172_ += i_177_ * i_174_;
		i_171_ += i_177_ * i_170_;
	    }
	    if (i_166_ + i_173_ > ((this.aClass_ra_Sub1_9006).anInt7977) * 63686679)
		i_173_ -= (i_166_ + i_173_ - (this.aClass_ra_Sub1_9006.anInt7977) * 63686679);
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_178_ = ((this.aClass_ra_Sub1_9006.anInt7974) * -912871679 - i);
		i_174_ -= i_178_;
	    ...
	    if (i + i_174_ > (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725) {
		int i_179_ = (i + i_174_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725);
		i_174_ -= i_179_;
		i_176_ += i_179_;
		i_175_ += i_179_;
	    }
		...
		if (i_169_ == 0) {
			...
			for (int i_180_ = -i_173_; i_180_ < 0; i_180_++) {
			    ...
			    while (i_171_ < i_181_) {
				is[i_171_++] = (this.anIntArray9965[i_172_++]);
				is[i_171_++] = (this.anIntArray9965[i_172_++]);
				is[i_171_++] = (this.anIntArray9965[i_172_++]);
				is[i_171_++] = (this.anIntArray9965[i_172_++]);
			    }
			...
			for (int i_185_ = -i_173_; i_185_ < 0; i_185_++) {
				...
				int i_187_ = (this.anIntArray9965[i_172_++]);
			...
			for (int i_191_ = -i_173_; i_191_ < 0; i_191_++) {
				...
				int i_193_ = (this.anIntArray9965[i_172_++]);
			...
			for (int i_201_ = -i_173_; i_201_ < 0; i_201_++) {
				...
				int i_203_ = (this.anIntArray9965[i_172_++]);
			...
			for (int i_204_ = -i_173_; i_204_ < 0; i_204_++) {
				...
				int i_206_ = (this.anIntArray9965[i_172_++]);
			...
			if ((i_168_ & 0xffffff) == 16777215) {
				...
				for (int i_211_ = -i_174_; i_211_ < 0; i_211_++) {
				    int i_212_ = (this.anIntArray9965[i_172_++]);
				...
				for (int i_220_ = -i_174_; i_220_ < 0; i_220_++) {
				    int i_221_ = (this.anIntArray9965[i_172_++]);
			...
			for (int i_231_ = -i_173_; i_231_ < 0; i_231_++) {
				...
				int i_233_ = (this.anIntArray9965[i_172_++]);
			...
			for (int i_243_ = -i_173_; i_243_ < 0; i_243_++) {
				...
				int i_245_ = (this.anIntArray9965[i_172_++]);
			...
			for (int i_249_ = -i_173_; i_249_ < 0; i_249_++) {
				...
				int i_251_ = (this.anIntArray9965[i_172_++]);
				if (i_251_ != 0) {
			...
			for (int i_258_ = -i_173_; i_258_ < 0; i_258_++) {
				...
				int i_260_ = (this.anIntArray9965[i_172_++]);
				if (i_260_ != 0) {
			...
			for (int i_267_ = -i_173_; i_267_ < 0; i_267_++) {
				...
				int i_269_ = (this.anIntArray9965[i_172_++]);
			...
			for (int i_277_ = -i_173_; i_277_ < 0; i_277_++) {
				...
				int i_279_ = (this.anIntArray9965[i_172_++]);
				if (i_279_ != 0) {
	...
	if (i_286_ > 0 && i_287_ > 0 && (bool || bool_283_)) {
	    int i_293_ = 0;
	    int i_294_ = 0;
	    int i_295_ = (this.anInt8990 + this.anInt9010 + this.anInt8997);
	    int i_296_ = (this.anInt9000 + this.anInt8989 + this.anInt8993);
	    int i_297_ = (i_295_ << 16) / i_286_;
	    int i_298_ = (i_296_ << 16) / i_287_;
	    if (this.anInt8990 > 0) {
		int i_299_ = (((this.anInt8990 << 16) + i_297_ - 1) / i_297_);
		i += i_299_;
		i_293_ += i_299_ * i_297_ - (this.anInt8990 << 16);
	    }
	    if (this.anInt9000 > 0) {
		int i_300_ = (((this.anInt9000 << 16) + i_298_ - 1) / i_298_);
		i_285_ += i_300_;
		i_294_ += i_300_ * i_298_ - (this.anInt9000 << 16);
	    }
	    if (this.anInt9010 < i_295_)
		i_286_ = ((this.anInt9010 << 16) - i_293_ + i_297_ - 1) / i_297_;
	    if (this.anInt8989 < i_296_)
		i_287_ = ((this.anInt8989 << 16) - i_294_ + i_298_ - 1) / i_298_;
	    int i_301_ = i + i_285_ * (((this.aClass_ra_Sub1_9006).anInt7971) * 692106883);
	    int i_302_ = (((this.aClass_ra_Sub1_9006).anInt7971 * 692106883) - i_286_);
	    if (i_285_ + i_287_ > ((this.aClass_ra_Sub1_9006).anInt7977) * 63686679)
		i_287_ -= (i_285_ + i_287_ - (this.aClass_ra_Sub1_9006.anInt7977) * 63686679);
	    if (i_285_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_303_ = ((this.aClass_ra_Sub1_9006.anInt7976) * -1278653805 - i_285_);
		i_287_ -= i_303_;
		i_301_ += i_303_ * (((this.aClass_ra_Sub1_9006).anInt7971) * 692106883);
		i_294_ += i_298_ * i_303_;
	    }
	    if (i + i_286_ > (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725) {
		int i_304_ = (i + i_286_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725);
		i_286_ -= i_304_;
		i_302_ += i_304_;
	    }
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_305_ = ((this.aClass_ra_Sub1_9006.anInt7974) * -912871679 - i);
		i_286_ -= i_305_;
		i_301_ += i_305_;
		...
		if (i_288_ == 1) {
			...
			int i_308_ = ((i_294_ >> 16) * this.anInt9010);
			for (int i_309_ = -i_286_; i_309_ < 0; i_309_++) {
			    if (!bool_283_ || f < fs[i_301_]) {
				if (bool)
				    is[i_301_] = (this.anIntArray9965[(i_293_ >> 16) + i_308_]);
			...
			int i_315_ = ((i_294_ >> 16) * this.anInt9010);
			for (int i_316_ = -i_286_; i_316_ < 0; i_316_++) {
			    if (!bool_283_ || f < fs[i_301_]) {
				if (bool) {
				    int i_317_ = (this.anIntArray9965[(i_293_ >> 16) + i_315_]);
			...
			int i_323_ = ((i_294_ >> 16) * this.anInt9010);
			for (int i_324_ = -i_286_; i_324_ < 0; i_324_++) {
			    if (!bool_283_ || f < fs[i_301_]) {
				if (bool) {
				    int i_325_ = (this.anIntArray9965[(i_293_ >> 16) + i_323_]);
			...
			int i_335_ = ((i_294_ >> 16) * this.anInt9010);
			for (int i_336_ = -i_286_; i_336_ < 0; i_336_++) {
			    if (!bool_283_ || f < fs[i_301_]) {
				if (bool) {
				    int i_337_ = (this.anIntArray9965[(i_293_ >> 16) + i_335_]);
		...
		if (i_288_ == 1) {
			...
			int i_340_ = ((i_294_ >> 16) * this.anInt9010);
			for (int i_341_ = -i_286_; i_341_ < 0; i_341_++) {
			    if (!bool_283_ || f < fs[i_301_]) {
				if (bool) {
				    int i_342_ = (this.anIntArray9965[(i_293_ >> 16) + i_340_]);
			...
			for (int i_347_ = -i_287_; i_347_ < 0; i_347_++) {
			    int i_348_ = ((i_294_ >> 16) * this.anInt9010);
			    for (int i_349_ = -i_286_; i_349_ < 0; i_349_++) {
				if (!bool_283_ || f < fs[i_301_]) {
				    if (bool) {
					int i_350_ = (this.anIntArray9965[(i_293_ >> 16) + i_348_]);
			...
			for (int i_357_ = -i_287_; i_357_ < 0; i_357_++) {
			    int i_358_ = ((i_294_ >> 16) * this.anInt9010);
			    for (int i_359_ = -i_286_; i_359_ < 0; i_359_++) {
				if (!bool_283_ || f < fs[i_301_]) {
				    int i_360_ = (this.anIntArray9965[(i_293_ >> 16) + i_358_]);
			...
			int i_373_ = ((i_294_ >> 16) * this.anInt9010);
			for (int i_374_ = -i_286_; i_374_ < 0; i_374_++) {
			    if (!bool_283_ || f < fs[i_301_]) {
				if (bool) {
				    int i_375_ = (this.anIntArray9965[(i_293_ >> 16) + i_373_]);
			...
			int i_387_ = ((i_294_ >> 16) * this.anInt9010);
			for (int i_388_ = -i_286_; i_388_ < 0; i_388_++) {
			    if (!bool_283_ || f < fs[i_301_]) {
				if (bool) {
				    int i_389_ = (this.anIntArray9965[(i_293_ >> 16) + i_387_]);
		...
		if (i_288_ == 1) {
			...
			int i_395_ = ((i_294_ >> 16) * this.anInt9010);
			for (int i_396_ = -i_286_; i_396_ < 0; i_396_++) {
			    if (!bool_283_ || f < fs[i_301_]) {
				int i_397_ = (this.anIntArray9965[(i_293_ >> 16) + i_395_]);
				if (i_397_ != 0) {
				    if (bool) {
			...
			int i_406_ = ((i_294_ >> 16) * this.anInt9010);
			for (int i_407_ = -i_286_; i_407_ < 0; i_407_++) {
			    if (!bool_283_ || f < fs[i_301_]) {
				int i_408_ = (this.anIntArray9965[(i_293_ >> 16) + i_406_]);
				if (i_408_ != 0) {
				    if (bool) {
			...
			int i_417_ = ((i_294_ >> 16) * this.anInt9010);
			for (int i_418_ = -i_286_; i_418_ < 0; i_418_++) {
			    if (!bool_283_ || f < fs[i_301_]) {
				if (bool) {
				    int i_419_ = (this.anIntArray9965[(i_293_ >> 16) + i_417_]);
			...
			int i_429_ = ((i_294_ >> 16) * this.anInt9010);
			for (int i_430_ = -i_286_; i_430_ < 0; i_430_++) {
			    if (!bool_283_ || f < fs[i_301_]) {
				int i_431_ = (this.anIntArray9965[(i_293_ >> 16) + i_429_]);
				if (i_431_ != 0) {
				    if (bool) {
	...
	if (i_436_ > 0 && i_437_ > 0) {
		...
		int i_442_ = 0;
		int i_443_ = 0;
		int i_444_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
		int i_445_ = (this.anInt8990 + this.anInt9010 + this.anInt8997);
		int i_446_ = (this.anInt9000 + this.anInt8989 + this.anInt8993);
		int i_447_ = (i_445_ << 16) / i_436_;
		int i_448_ = (i_446_ << 16) / i_437_;
		if (this.anInt8990 > 0) {
		    int i_449_ = (((this.anInt8990 << 16) + i_447_ - 1) / i_447_);
		    i += i_449_;
		    i_442_ += (i_449_ * i_447_ - (this.anInt8990 << 16));
		}
		if (this.anInt9000 > 0) {
		    int i_450_ = (((this.anInt9000 << 16) + i_448_ - 1) / i_448_);
		    i_435_ += i_450_;
		    i_443_ += (i_450_ * i_448_ - (this.anInt9000 << 16));
		}
		if (this.anInt9010 < i_445_)
		    i_436_ = ((this.anInt9010 << 16) - i_442_ + i_447_ - 1) / i_447_;
		if (this.anInt8989 < i_446_)
		    i_437_ = ((this.anInt8989 << 16) - i_443_ + i_448_ - 1) / i_448_;
		int i_451_ = i + i_435_ * i_444_;
		int i_452_ = i_444_ - i_436_;
		if (i_435_ + i_437_ > ((this.aClass_ra_Sub1_9006).anInt7977 * 63686679))
		    i_437_ -= (i_435_ + i_437_ - ((this.aClass_ra_Sub1_9006).anInt7977) * 63686679);
		if (i_435_ < (this.aClass_ra_Sub1_9006.anInt7976) * -1278653805) {
		    int i_453_ = (((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_435_);
		    i_437_ -= i_453_;
		    i_451_ += i_453_ * i_444_;
		    i_443_ += i_448_ * i_453_;
		}
		if (i + i_436_ > ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725) {
		    int i_454_ = (i + i_436_ - (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725);
		    i_436_ -= i_454_;
		    i_452_ += i_454_;
		}
		if (i < ((this.aClass_ra_Sub1_9006).anInt7974 * -912871679)) {
		    int i_455_ = (((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
		    i_436_ -= i_455_;
		    i_451_ += i_455_;
		...
		if (i_440_ == 0) {
			...
			for (int i_457_ = -i_437_; i_457_ < 0; i_457_++) {
			    int i_458_ = ((i_443_ >> 16) * this.anInt9010);
			    for (int i_459_ = -i_436_; i_459_ < 0; i_459_++) {
				is[i_451_++] = (this.anIntArray9965[(i_442_ >> 16) + i_458_]);
				i_442_ += i_447_;
			    }
			    i_443_ += i_448_;
			    i_442_ = i_456_;
			...
			for (int i_464_ = -i_437_; i_464_ < 0; i_464_++) {
			    int i_465_ = ((i_443_ >> 16) * this.anInt9010);
			    for (int i_466_ = -i_436_; i_466_ < 0; i_466_++) {
				int i_467_ = (this.anIntArray9965[(i_442_ >> 16) + i_465_]);
			...
			for (int i_472_ = -i_437_; i_472_ < 0; i_472_++) {
			    int i_473_ = ((i_443_ >> 16) * this.anInt9010);
			    for (int i_474_ = -i_436_; i_474_ < 0; i_474_++) {
				int i_475_ = (this.anIntArray9965[(i_442_ >> 16) + i_473_]);
			...
			for (int i_484_ = -i_437_; i_484_ < 0; i_484_++) {
			    int i_485_ = ((i_443_ >> 16) * this.anInt9010);
			    for (int i_486_ = -i_436_; i_486_ < 0; i_486_++) {
				int i_487_ = (this.anIntArray9965[(i_442_ >> 16) + i_485_]);
			...
			for (int i_489_ = -i_437_; i_489_ < 0; i_489_++) {
			    int i_490_ = ((i_443_ >> 16) * this.anInt9010);
			    for (int i_491_ = -i_436_; i_491_ < 0; i_491_++) {
				int i_492_ = (this.anIntArray9965[(i_442_ >> 16) + i_490_]);
			...
			if ((i_439_ & 0xffffff) == 16777215) {
				...
				int i_498_ = ((i_443_ >> 16) * this.anInt9010);
				for (int i_499_ = -i_436_; i_499_ < 0; i_499_++) {
				    int i_500_ = (this.anIntArray9965[(i_442_ >> 16) + i_498_]);
				...
				int i_508_ = ((i_443_ >> 16) * this.anInt9010);
				for (int i_509_ = -i_436_; i_509_ < 0; i_509_++) {
				    int i_510_ = (this.anIntArray9965[(i_442_ >> 16) + i_508_]);
			...
			for (int i_521_ = -i_437_; i_521_ < 0; i_521_++) {
			    int i_522_ = ((i_443_ >> 16) * this.anInt9010);
			    for (int i_523_ = -i_436_; i_523_ < 0; i_523_++) {
				int i_524_ = (this.anIntArray9965[(i_442_ >> 16) + i_522_]);
			...
			for (int i_535_ = -i_437_; i_535_ < 0; i_535_++) {
			    int i_536_ = ((i_443_ >> 16) * this.anInt9010);
			    for (int i_537_ = -i_436_; i_537_ < 0; i_537_++) {
				int i_538_ = (this.anIntArray9965[(i_442_ >> 16) + i_536_]);
			...
			for (int i_543_ = -i_437_; i_543_ < 0; i_543_++) {
			    int i_544_ = ((i_443_ >> 16) * this.anInt9010);
			    for (int i_545_ = -i_436_; i_545_ < 0; i_545_++) {
				int i_546_ = (this.anIntArray9965[(i_442_ >> 16) + i_544_]);
				if (i_546_ != 0) {
			...
			for (int i_554_ = -i_437_; i_554_ < 0; i_554_++) {
			    int i_555_ = ((i_443_ >> 16) * this.anInt9010);
			    for (int i_556_ = -i_436_; i_556_ < 0; i_556_++) {
				int i_557_ = (this.anIntArray9965[(i_442_ >> 16) + i_555_]);
				if (i_557_ != 0) {
			...
			for (int i_565_ = -i_437_; i_565_ < 0; i_565_++) {
			    int i_566_ = ((i_443_ >> 16) * this.anInt9010);
			    for (int i_567_ = -i_436_; i_567_ < 0; i_567_++) {
				int i_568_ = (this.anIntArray9965[(i_442_ >> 16) + i_566_]);
			...
			for (int i_577_ = -i_437_; i_577_ < 0; i_577_++) {
			    int i_578_ = ((i_443_ >> 16) * this.anInt9010);
			    for (int i_579_ = -i_436_; i_579_ < 0; i_579_++) {
				int i_580_ = (this.anIntArray9965[(i_442_ >> 16) + i_578_]);
				if (i_580_ != 0) {
	...
	int[] is_586_ = (this.aClass_ra_Sub1_9006.anIntArray7967);
	if (is_586_ != null) {
	    if (anInt9004 == 0) {
		if (anInt8991 == 0) {
			...
			if (i_588_ >= 0) {
			    ...
			    if (i_590_ >= 0 && i_591_ >= 0 && (i_590_ - (this.anInt9010 << 12)) < 0 && (i_591_ - (this.anInt8989 << 12)) < 0) {
				...
				if (i_592_ < i_594_)
				    i_592_ = i_594_;
				for (/**/; i_592_ < 0; i_592_++) {
				    int i_596_ = (this.anIntArray9965[(((i_591_ >> 12) * (this.anInt9010)) + (i_590_ >> 12))]);
			...
			if (i_601_ >= 0) {
			    ...
			    if (i_603_ >= 0 && (i_603_ - (this.anInt9010 << 12)) < 0) {
				int i_606_;
				if ((i_606_ = (i_604_ - (this.anInt8989 << 12))) >= 0) {
				...
				if (i_605_ < i_608_)
				    i_605_ = i_608_;
				for (/**/; i_605_ < 0; i_605_++) {
				    int i_610_ = (this.anIntArray9965[(((i_604_ >> 12) * (this.anInt9010)) + (i_603_ >> 12))]);
			...
			if (i_615_ >= 0) {
			    ...
			    if (i_617_ >= 0 && (i_617_ - (this.anInt9010 << 12)) < 0) {
				if (i_618_ < 0) {
				...
				int i_621_;
				if ((i_621_ = (1 + i_618_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_619_)
				    i_619_ = i_621_;
				...
				if (i_619_ < i_623_)
				    i_619_ = i_623_;
				for (/**/; i_619_ < 0; i_619_++) {
				    int i_625_ = (this.anIntArray9965[(((i_618_ >> 12) * (this.anInt9010)) + (i_617_ >> 12))]);
		...
		if (anInt8991 == 0) {
			...
			if (i_630_ >= 0) {
			    ...
			    if (i_633_ >= 0 && (i_633_ - (this.anInt8989 << 12)) < 0) {
				int i_635_;
				if ((i_635_ = (i_632_ - (this.anInt9010 << 12))) >= 0) {
				...
				if (i_634_ < i_637_)
				    i_634_ = i_637_;
				for (/**/; i_634_ < 0; i_634_++) {
				    int i_639_ = (this.anIntArray9965[(((i_633_ >> 12) * (this.anInt9010)) + (i_632_ >> 12))]);
			...
			if (i_644_ >= 0) {
			    ...
			    int i_649_;
			    if ((i_649_ = i_646_ - ((this.anInt9010) << 12)) >= 0) {
				...
				i_648_ = i_649_;
			    if ((i_649_ = i_647_ - ((this.anInt8989) << 12)) >= 0) {
				...
				i_648_ = i_651_;
			    for (/**/; i_648_ < 0; i_648_++) {
				int i_653_ = (this.anIntArray9965[((i_647_ >> 12) * this.anInt9010 + (i_646_ >> 12))]);
			...
			if (i_658_ >= 0) {
			    ...
			    int i_663_;
			    if ((i_663_ = i_660_ - ((this.anInt9010) << 12)) >= 0) {
			    ...
			    if ((i_663_ = (1 + i_661_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_662_)
				i_662_ = i_663_;
				...
				i_662_ = i_665_;
			    for (/**/; i_662_ < 0; i_662_++) {
				int i_667_ = (this.anIntArray9965[((i_661_ >> 12) * this.anInt9010 + (i_660_ >> 12))]);
		...
		while (i_671_ < 0) {
			...
			if (i_675_ >= 0 && i_675_ - (this.anInt8989 << 12) < 0) {
			    if (i_674_ < 0) {
			    ...
			    int i_678_;
			    if ((i_678_ = (1 + i_674_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_676_)
				i_676_ = i_678_;
				...
				i_676_ = i_680_;
			    for (/**/; i_676_ < 0; i_676_++) {
				int i_682_ = (this.anIntArray9965[((i_675_ >> 12) * this.anInt9010 + (i_674_ >> 12))]);
		...
		while (i_686_ < 0) {
			...
			int i_693_;
			if ((i_693_ = (1 + i_689_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_691_)
			    i_691_ = i_693_;
			if ((i_693_ = i_690_ - (this.anInt8989 << 12)) >= 0) {
			...
			if (i_691_ < i_695_)
			    i_691_ = i_695_;
			for (/**/; i_691_ < 0; i_691_++) {
			    int i_697_ = (this.anIntArray9965[(((i_690_ >> 12) * this.anInt9010) + (i_689_ >> 12))]);
		...
		while (i_701_ < 0) {
			...
			int i_708_;
			if ((i_708_ = (1 + i_704_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_706_)
			    i_706_ = i_708_;
			if (i_705_ < 0) {
			...
			if ((i_708_ = (1 + i_705_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_706_)
			    i_706_ = i_708_;
			...
			if (i_706_ < i_710_)
			    i_706_ = i_710_;
			for (/**/; i_706_ < 0; i_706_++) {
			    int i_712_ = (this.anIntArray9965[(((i_705_ >> 12) * this.anInt9010) + (i_704_ >> 12))]);
	...
	if (is == null)
	    throw new IllegalStateException("");
	if (i_717_ == 0) {
	    for (int i_718_ = 0; i_718_ < this.anInt8989; i_718_++) {
		int i_719_ = i_718_ * this.anInt9010;
		int i_720_ = (((i_716_ + i_718_) * ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883)) + i);
		for (int i_721_ = 0; i_721_ < this.anInt9010; i_721_++)
		    this.anIntArray9965[i_719_ + i_721_] = ((this.anIntArray9965[i_719_ + i_721_]) & 0xffffff | is[i_720_ + i_721_] << 8 & ~0xffffff);
	    }
	} else if (i_717_ == 1) {
	    for (int i_722_ = 0; i_722_ < this.anInt8989; i_722_++) {
		int i_723_ = i_722_ * this.anInt9010;
		int i_724_ = (((i_716_ + i_722_) * ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883)) + i);
		for (int i_725_ = 0; i_725_ < this.anInt9010; i_725_++)
		    this.anIntArray9965[i_723_ + i_725_] = ((this.anIntArray9965[i_723_ + i_725_]) & 0xffffff | is[i_724_ + i_725_] << 16 & ~0xffffff);
	    }
	} else if (i_717_ == 2) {
	    for (int i_726_ = 0; i_726_ < this.anInt8989; i_726_++) {
		int i_727_ = i_726_ * this.anInt9010;
		int i_728_ = (((i_716_ + i_726_) * ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883)) + i);
		for (int i_729_ = 0; i_729_ < this.anInt9010; i_729_++)
		    this.anIntArray9965[i_727_ + i_729_] = ((this.anIntArray9965[i_727_ + i_729_]) & 0xffffff | is[i_728_ + i_729_] << 24 & ~0xffffff);
	    }
	} else if (i_717_ == 3) {
	    for (int i_730_ = 0; i_730_ < this.anInt8989; i_730_++) {
		int i_731_ = i_730_ * this.anInt9010;
		int i_732_ = (((i_716_ + i_730_) * ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883)) + i);
		for (int i_733_ = 0; i_733_ < this.anInt9010; i_733_++)
		    this.anIntArray9965[i_731_ + i_733_] = ((this.anIntArray9965[i_731_ + i_733_]) & 0xffffff | (is[i_732_ + i_733_] != 0 ? -16777216 : 0));
	    }
	}
    }
	...
	this.anIntArray9965 = new int[i * i_734_];
    }
	...
	if (is != null) {
		...
		if (anInt8991 == 0) {
			...
			if (i_738_ >= 0 && i_739_ >= 0 && i_738_ - (this.anInt9010 << 12) < 0 && i_739_ - (this.anInt8989 << 12) < 0) {
			    for (/**/; i_740_ < 0; i_740_++) {
				int i_741_ = (((i_739_ >> 12) * this.anInt9010) + (i_738_ >> 12));
				int i_742_ = i_737_++;
				if (i_735_ == 0) {
				    if (i == 1)
					is[i_742_] = (this.anIntArray9965[i_741_]);
				    else if (i == 0) {
					int i_743_ = (this.anIntArray9965[i_741_++]);
					...
					int i_747_ = (this.anIntArray9965[i_741_++]);
					...
					int i_752_ = (this.anIntArray9965[i_741_]);
				    ...
				    if (i == 1) {
					int i_755_ = (this.anIntArray9965[i_741_]);
					...
					int i_759_ = (this.anIntArray9965[i_741_]);
					...
					int i_770_ = (this.anIntArray9965[i_741_]);
					...
					int i_777_ = (this.anIntArray9965[i_741_]);
				    ...
				    if (i == 1) {
					int i_783_ = (this.anIntArray9965[i_741_]);
					...
					int i_787_ = (this.anIntArray9965[i_741_]);
					...
					int i_794_ = (this.anIntArray9965[i_741_]);
					...
					int i_799_ = (this.anIntArray9965[i_741_]);
			...
			if (i_807_ >= 0 && i_807_ - (this.anInt9010 << 12) < 0) {
			    int i_810_;
			    if ((i_810_ = i_808_ - ((this.anInt8989) << 12)) >= 0) {
				...
				i_809_ = i_810_;
			    for (/**/; i_809_ < 0; i_809_++) {
				int i_811_ = (((i_808_ >> 12) * this.anInt9010) + (i_807_ >> 12));
				int i_812_ = i_806_++;
				if (i_735_ == 0) {
				    if (i == 1)
					is[i_812_] = (this.anIntArray9965[i_811_]);
				    else if (i == 0) {
					int i_813_ = (this.anIntArray9965[i_811_++]);
					...
					int i_817_ = (this.anIntArray9965[i_811_++]);
					...
					int i_822_ = (this.anIntArray9965[i_811_]);
				    ...
				    if (i == 1) {
					int i_825_ = (this.anIntArray9965[i_811_]);
					...
					int i_829_ = (this.anIntArray9965[i_811_]);
					...
					int i_840_ = (this.anIntArray9965[i_811_]);
					...
					int i_847_ = (this.anIntArray9965[i_811_]);
				    ...
				    if (i == 1) {
					int i_853_ = (this.anIntArray9965[i_811_]);
					...
					int i_857_ = (this.anIntArray9965[i_811_]);
					...
					int i_864_ = (this.anIntArray9965[i_811_]);
					...
					int i_869_ = (this.anIntArray9965[i_811_]);
			...
			if (i_877_ >= 0 && i_877_ - (this.anInt9010 << 12) < 0) {
			    if (i_878_ < 0) {
			    ...
			    int i_881_;
			    if ((i_881_ = (1 + i_878_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_879_)
				i_879_ = i_881_;
			    for (/**/; i_879_ < 0; i_879_++) {
				int i_882_ = (((i_878_ >> 12) * this.anInt9010) + (i_877_ >> 12));
				int i_883_ = i_876_++;
				if (i_735_ == 0) {
				    if (i == 1)
					is[i_883_] = (this.anIntArray9965[i_882_]);
				    else if (i == 0) {
					int i_884_ = (this.anIntArray9965[i_882_++]);
					...
					int i_888_ = (this.anIntArray9965[i_882_++]);
					...
					int i_893_ = (this.anIntArray9965[i_882_]);
				    ...
				    if (i == 1) {
					int i_896_ = (this.anIntArray9965[i_882_]);
					...
					int i_900_ = (this.anIntArray9965[i_882_]);
					...
					int i_911_ = (this.anIntArray9965[i_882_]);
					...
					int i_918_ = (this.anIntArray9965[i_882_]);
				    ...
				    if (i == 1) {
					int i_924_ = (this.anIntArray9965[i_882_]);
					...
					int i_928_ = (this.anIntArray9965[i_882_]);
					...
					int i_935_ = (this.anIntArray9965[i_882_]);
					...
					int i_940_ = (this.anIntArray9965[i_882_]);
		...
		if (anInt8991 == 0) {
			...
			if (i_949_ >= 0 && i_949_ - (this.anInt8989 << 12) < 0) {
			    int i_951_;
			    if ((i_951_ = i_948_ - ((this.anInt9010) << 12)) >= 0) {
				...
				i_950_ = i_951_;
			    for (/**/; i_950_ < 0; i_950_++) {
				int i_952_ = (((i_949_ >> 12) * this.anInt9010) + (i_948_ >> 12));
				int i_953_ = i_947_++;
				if (i_735_ == 0) {
				    if (i == 1)
					is[i_953_] = (this.anIntArray9965[i_952_]);
				    else if (i == 0) {
					int i_954_ = (this.anIntArray9965[i_952_++]);
					...
					int i_958_ = (this.anIntArray9965[i_952_++]);
					...
					int i_963_ = (this.anIntArray9965[i_952_]);
				    ...
				    if (i == 1) {
					int i_966_ = (this.anIntArray9965[i_952_]);
					...
					int i_970_ = (this.anIntArray9965[i_952_]);
					...
					int i_981_ = (this.anIntArray9965[i_952_]);
					...
					int i_988_ = (this.anIntArray9965[i_952_]);
				    ...
				    if (i == 1) {
					int i_994_ = (this.anIntArray9965[i_952_]);
					...
					int i_998_ = (this.anIntArray9965[i_952_]);
					...
					int i_1005_ = (this.anIntArray9965[i_952_]);
					...
					int i_1010_ = (this.anIntArray9965[i_952_]);
			...
			int i_1021_;
			if ((i_1021_ = i_1018_ - (this.anInt9010 << 12)) >= 0) {
			...
			if ((i_1021_ = (i_1018_ - anInt9004) / anInt9004) > i_1020_)
			    i_1020_ = i_1021_;
			if ((i_1021_ = i_1019_ - (this.anInt8989 << 12)) >= 0) {
			...
			for (/**/; i_1020_ < 0; i_1020_++) {
			    int i_1022_ = (((i_1019_ >> 12) * this.anInt9010) + (i_1018_ >> 12));
			    int i_1023_ = i_1017_++;
			    if (i_735_ == 0) {
				if (i == 1)
				    is[i_1023_] = (this.anIntArray9965[i_1022_]);
				else if (i == 0) {
				    int i_1024_ = (this.anIntArray9965[i_1022_++]);
				    ...
				    int i_1028_ = (this.anIntArray9965[i_1022_++]);
				    ...
				    int i_1033_ = (this.anIntArray9965[i_1022_]);
				...
				if (i == 1) {
				    int i_1036_ = (this.anIntArray9965[i_1022_]);
				    ...
				    int i_1040_ = (this.anIntArray9965[i_1022_]);
				    ...
				    int i_1051_ = (this.anIntArray9965[i_1022_]);
				    ...
				    int i_1058_ = (this.anIntArray9965[i_1022_]);
				...
				if (i == 1) {
				    int i_1064_ = (this.anIntArray9965[i_1022_]);
				    ...
				    int i_1068_ = (this.anIntArray9965[i_1022_]);
				    ...
				    int i_1075_ = (this.anIntArray9965[i_1022_]);
				    ...
				    int i_1080_ = (this.anIntArray9965[i_1022_]);
			...
			int i_1091_;
			if ((i_1091_ = i_1088_ - (this.anInt9010 << 12)) >= 0) {
			...
			if ((i_1091_ = (1 + i_1089_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_1090_)
			    i_1090_ = i_1091_;
			for (/**/; i_1090_ < 0; i_1090_++) {
			    int i_1092_ = (((i_1089_ >> 12) * this.anInt9010) + (i_1088_ >> 12));
			    int i_1093_ = i_1087_++;
			    if (i_735_ == 0) {
				if (i == 1)
				    is[i_1093_] = (this.anIntArray9965[i_1092_]);
				else if (i == 0) {
				    int i_1094_ = (this.anIntArray9965[i_1092_++]);
				    ...
				    int i_1098_ = (this.anIntArray9965[i_1092_++]);
				    ...
				    int i_1103_ = (this.anIntArray9965[i_1092_]);
				...
				if (i == 1) {
				    int i_1106_ = (this.anIntArray9965[i_1092_]);
				    ...
				    int i_1110_ = (this.anIntArray9965[i_1092_]);
				    ...
				    int i_1121_ = (this.anIntArray9965[i_1092_]);
				    ...
				    int i_1128_ = (this.anIntArray9965[i_1092_]);
				...
				if (i == 1) {
				    int i_1134_ = (this.anIntArray9965[i_1092_]);
				    ...
				    int i_1138_ = (this.anIntArray9965[i_1092_]);
				    ...
				    int i_1145_ = (this.anIntArray9965[i_1092_]);
				    ...
				    int i_1150_ = (this.anIntArray9965[i_1092_]);
		...
		while (i_1156_ < 0) {
		    ...
		    if (i_1159_ >= 0 && i_1159_ - (this.anInt8989 << 12) < 0) {
			if (i_1158_ < 0) {
			...
			int i_1162_;
			if ((i_1162_ = (1 + i_1158_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_1160_)
			    i_1160_ = i_1162_;
			for (/**/; i_1160_ < 0; i_1160_++) {
			    int i_1163_ = (((i_1159_ >> 12) * this.anInt9010) + (i_1158_ >> 12));
			    int i_1164_ = i_1157_++;
			    if (i_735_ == 0) {
				if (i == 1)
				    is[i_1164_] = (this.anIntArray9965[i_1163_]);
				else if (i == 0) {
				    int i_1165_ = (this.anIntArray9965[i_1163_++]);
				    ...
				    int i_1169_ = (this.anIntArray9965[i_1163_++]);
				    ...
				    int i_1174_ = (this.anIntArray9965[i_1163_]);
				...
				if (i == 1) {
				    int i_1177_ = (this.anIntArray9965[i_1163_]);
				    ...
				    int i_1181_ = (this.anIntArray9965[i_1163_]);
				    ...
				    int i_1192_ = (this.anIntArray9965[i_1163_]);
				    ...
				    int i_1199_ = (this.anIntArray9965[i_1163_]);
				...
				if (i == 1) {
				    int i_1205_ = (this.anIntArray9965[i_1163_]);
				    ...
				    int i_1209_ = (this.anIntArray9965[i_1163_]);
				    ...
				    int i_1216_ = (this.anIntArray9965[i_1163_]);
				    ...
				    int i_1221_ = (this.anIntArray9965[i_1163_]);
		...
		for (int i_1227_ = anInt9001; i_1227_ < 0; i_1227_++) {
		    ...
		    int i_1233_;
		    if ((i_1233_ = (1 + i_1229_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_1231_)
			i_1231_ = i_1233_;
		    if ((i_1233_ = i_1230_ - (this.anInt8989 << 12)) >= 0) {
			...
			int i_1234_ = (((i_1230_ >> 12) * this.anInt9010) + (i_1229_ >> 12));
			int i_1235_ = i_1228_++;
			if (i_735_ == 0) {
			    if (i == 1)
				is[i_1235_] = (this.anIntArray9965[i_1234_]);
			    else if (i == 0) {
				int i_1236_ = (this.anIntArray9965[i_1234_++]);
				...
				int i_1240_ = (this.anIntArray9965[i_1234_++]);
				...
				int i_1245_ = (this.anIntArray9965[i_1234_]);
			    ...
			    if (i == 1) {
				int i_1248_ = (this.anIntArray9965[i_1234_]);
				...
				int i_1252_ = (this.anIntArray9965[i_1234_]);
				...
				int i_1263_ = (this.anIntArray9965[i_1234_]);
				...
				int i_1270_ = (this.anIntArray9965[i_1234_]);
			    ...
			    if (i == 1) {
				int i_1276_ = (this.anIntArray9965[i_1234_]);
				...
				int i_1280_ = (this.anIntArray9965[i_1234_]);
				...
				int i_1287_ = (this.anIntArray9965[i_1234_]);
				...
				int i_1292_ = (this.anIntArray9965[i_1234_]);
		...
		for (int i_1298_ = anInt9001; i_1298_ < 0; i_1298_++) {
		    ...
		    int i_1304_;
		    if ((i_1304_ = (1 + i_1300_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_1302_)
			i_1302_ = i_1304_;
		    if (i_1301_ < 0) {
		    ...
		    if ((i_1304_ = (1 + i_1301_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_1302_)
			i_1302_ = i_1304_;
		    for (/**/; i_1302_ < 0; i_1302_++) {
			int i_1305_ = (((i_1301_ >> 12) * this.anInt9010) + (i_1300_ >> 12));
			int i_1306_ = i_1299_++;
			if (i_735_ == 0) {
			    if (i == 1)
				is[i_1306_] = (this.anIntArray9965[i_1305_]);
			    else if (i == 0) {
				int i_1307_ = (this.anIntArray9965[i_1305_++]);
				...
				int i_1311_ = (this.anIntArray9965[i_1305_++]);
				...
				int i_1316_ = (this.anIntArray9965[i_1305_]);
			    ...
			    if (i == 1) {
				int i_1319_ = (this.anIntArray9965[i_1305_]);
				...
				int i_1323_ = (this.anIntArray9965[i_1305_]);
				...
				int i_1334_ = (this.anIntArray9965[i_1305_]);
				...
				int i_1341_ = (this.anIntArray9965[i_1305_]);
			    ...
			    if (i == 1) {
				int i_1347_ = (this.anIntArray9965[i_1305_]);
				...
				int i_1351_ = (this.anIntArray9965[i_1305_]);
				...
				int i_1358_ = (this.anIntArray9965[i_1305_]);
				...
				int i_1363_ = (this.anIntArray9965[i_1305_]);
	...
	int[] is = (this.aClass_ra_Sub1_9006.anIntArray7967);
	if (is != null) {
	    int i_1373_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
	    i += this.anInt8990;
	    i_1369_ += this.anInt9000;
	    int i_1374_ = i_1369_ * i_1373_ + i;
	    int i_1375_ = 0;
	    int i_1376_ = this.anInt8989;
	    int i_1377_ = this.anInt9010;
	    int i_1378_ = i_1373_ - i_1377_;
	    int i_1379_ = 0;
	    if (i_1369_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_1380_ = (((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_1369_);
		i_1376_ -= i_1380_;
		i_1369_ = ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805);
		i_1375_ += i_1380_ * i_1377_;
		i_1374_ += i_1380_ * i_1373_;
	    }
	    if (i_1369_ + i_1376_ > (this.aClass_ra_Sub1_9006.anInt7977 * 63686679))
		i_1376_ -= (i_1369_ + i_1376_ - (this.aClass_ra_Sub1_9006.anInt7977) * 63686679);
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_1381_ = (((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
		i_1377_ -= i_1381_;
		i = (this.aClass_ra_Sub1_9006.anInt7974 * -912871679);
		i_1375_ += i_1381_;
		i_1374_ += i_1381_;
	    ...
	    if (i + i_1377_ > (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725) {
		int i_1382_ = (i + i_1377_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725);
		i_1377_ -= i_1382_;
		i_1379_ += i_1382_;
		i_1378_ += i_1382_;
	    }
		...
		if (i_1372_ == 0) {
			...
			for (int i_1383_ = -i_1376_; i_1383_ < 0; i_1383_++) {
				...
				is[i_1374_++] = (this.anIntArray9965[i_1375_++]);
				is[i_1374_++] = (this.anIntArray9965[i_1375_++]);
				is[i_1374_++] = (this.anIntArray9965[i_1375_++]);
				is[i_1374_++] = (this.anIntArray9965[i_1375_++]);
			    }
			...
			for (int i_1388_ = -i_1376_; i_1388_ < 0; i_1388_++) {
				...
				int i_1390_ = (this.anIntArray9965[i_1375_++]);
			...
			for (int i_1394_ = -i_1376_; i_1394_ < 0; i_1394_++) {
				...
				int i_1396_ = (this.anIntArray9965[i_1375_++]);
			...
			for (int i_1404_ = -i_1376_; i_1404_ < 0; i_1404_++) {
				...
				int i_1406_ = (this.anIntArray9965[i_1375_++]);
			...
			for (int i_1407_ = -i_1376_; i_1407_ < 0; i_1407_++) {
				...
				int i_1409_ = (this.anIntArray9965[i_1375_++]);
			...
			if ((i_1371_ & 0xffffff) == 16777215) {
				...
				for (int i_1414_ = -i_1377_; i_1414_ < 0; i_1414_++) {
				    int i_1415_ = (this.anIntArray9965[i_1375_++]);
				...
				for (int i_1423_ = -i_1377_; i_1423_ < 0; i_1423_++) {
				    int i_1424_ = (this.anIntArray9965[i_1375_++]);
			...
			for (int i_1434_ = -i_1376_; i_1434_ < 0; i_1434_++) {
				...
				int i_1436_ = (this.anIntArray9965[i_1375_++]);
			...
			for (int i_1446_ = -i_1376_; i_1446_ < 0; i_1446_++) {
				...
				int i_1448_ = (this.anIntArray9965[i_1375_++]);
			...
			for (int i_1452_ = -i_1376_; i_1452_ < 0; i_1452_++) {
				...
				int i_1454_ = (this.anIntArray9965[i_1375_++]);
				if (i_1454_ != 0) {
			...
			for (int i_1461_ = -i_1376_; i_1461_ < 0; i_1461_++) {
				...
				int i_1463_ = (this.anIntArray9965[i_1375_++]);
				if (i_1463_ != 0) {
			...
			for (int i_1470_ = -i_1376_; i_1470_ < 0; i_1470_++) {
				...
				int i_1472_ = (this.anIntArray9965[i_1375_++]);
			...
			for (int i_1480_ = -i_1376_; i_1480_ < 0; i_1480_++) {
				...
				int i_1482_ = (this.anIntArray9965[i_1375_++]);
				if (i_1482_ != 0) {
	...
	int[] is = (this.aClass_ra_Sub1_9006.anIntArray7967);
	if (is != null) {
	    int i_1490_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
	    i += this.anInt8990;
	    i_1486_ += this.anInt9000;
	    int i_1491_ = i_1486_ * i_1490_ + i;
	    int i_1492_ = 0;
	    int i_1493_ = this.anInt8989;
	    int i_1494_ = this.anInt9010;
	    int i_1495_ = i_1490_ - i_1494_;
	    int i_1496_ = 0;
	    if (i_1486_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_1497_ = (((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_1486_);
		i_1493_ -= i_1497_;
		i_1486_ = ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805);
		i_1492_ += i_1497_ * i_1494_;
		i_1491_ += i_1497_ * i_1490_;
	    }
	    if (i_1486_ + i_1493_ > (this.aClass_ra_Sub1_9006.anInt7977 * 63686679))
		i_1493_ -= (i_1486_ + i_1493_ - (this.aClass_ra_Sub1_9006.anInt7977) * 63686679);
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_1498_ = (((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
		i_1494_ -= i_1498_;
		i = (this.aClass_ra_Sub1_9006.anInt7974 * -912871679);
		i_1492_ += i_1498_;
		i_1491_ += i_1498_;
	    ...
	    if (i + i_1494_ > (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725) {
		int i_1499_ = (i + i_1494_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725);
		i_1494_ -= i_1499_;
		i_1496_ += i_1499_;
		i_1495_ += i_1499_;
	    }
		...
		if (i_1489_ == 0) {
			...
			for (int i_1500_ = -i_1493_; i_1500_ < 0; i_1500_++) {
				...
				is[i_1491_++] = (this.anIntArray9965[i_1492_++]);
				is[i_1491_++] = (this.anIntArray9965[i_1492_++]);
				is[i_1491_++] = (this.anIntArray9965[i_1492_++]);
				is[i_1491_++] = (this.anIntArray9965[i_1492_++]);
			    }
			...
			for (int i_1505_ = -i_1493_; i_1505_ < 0; i_1505_++) {
				...
				int i_1507_ = (this.anIntArray9965[i_1492_++]);
			...
			for (int i_1511_ = -i_1493_; i_1511_ < 0; i_1511_++) {
				...
				int i_1513_ = (this.anIntArray9965[i_1492_++]);
			...
			for (int i_1521_ = -i_1493_; i_1521_ < 0; i_1521_++) {
				...
				int i_1523_ = (this.anIntArray9965[i_1492_++]);
			...
			for (int i_1524_ = -i_1493_; i_1524_ < 0; i_1524_++) {
				...
				int i_1526_ = (this.anIntArray9965[i_1492_++]);
			...
			if ((i_1488_ & 0xffffff) == 16777215) {
				...
				for (int i_1531_ = -i_1494_; i_1531_ < 0; i_1531_++) {
				    int i_1532_ = (this.anIntArray9965[i_1492_++]);
				...
				for (int i_1540_ = -i_1494_; i_1540_ < 0; i_1540_++) {
				    int i_1541_ = (this.anIntArray9965[i_1492_++]);
			...
			for (int i_1551_ = -i_1493_; i_1551_ < 0; i_1551_++) {
				...
				int i_1553_ = (this.anIntArray9965[i_1492_++]);
			...
			for (int i_1563_ = -i_1493_; i_1563_ < 0; i_1563_++) {
				...
				int i_1565_ = (this.anIntArray9965[i_1492_++]);
			...
			for (int i_1569_ = -i_1493_; i_1569_ < 0; i_1569_++) {
				...
				int i_1571_ = (this.anIntArray9965[i_1492_++]);
				if (i_1571_ != 0) {
			...
			for (int i_1578_ = -i_1493_; i_1578_ < 0; i_1578_++) {
				...
				int i_1580_ = (this.anIntArray9965[i_1492_++]);
				if (i_1580_ != 0) {
			...
			for (int i_1587_ = -i_1493_; i_1587_ < 0; i_1587_++) {
				...
				int i_1589_ = (this.anIntArray9965[i_1492_++]);
			...
			for (int i_1597_ = -i_1493_; i_1597_ < 0; i_1597_++) {
				...
				int i_1599_ = (this.anIntArray9965[i_1492_++]);
				if (i_1599_ != 0) {
	...
	if (is != null) {
	    i += this.anInt8990;
	    i_1603_ += this.anInt9000;
	    int i_1606_ = 0;
	    int i_1607_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
	    int i_1608_ = this.anInt9010;
	    int i_1609_ = this.anInt8989;
	    int i_1610_ = i_1607_ - i_1608_;
	    int i_1611_ = 0;
	    int i_1612_ = i + i_1603_ * i_1607_;
	    if (i_1603_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_1613_ = (((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_1603_);
		i_1609_ -= i_1613_;
		i_1603_ = ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805);
		i_1606_ += i_1613_ * i_1608_;
		i_1612_ += i_1613_ * i_1607_;
	    }
	    if (i_1603_ + i_1609_ > (this.aClass_ra_Sub1_9006.anInt7977 * 63686679))
		i_1609_ -= (i_1603_ + i_1609_ - (this.aClass_ra_Sub1_9006.anInt7977) * 63686679);
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_1614_ = (((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
		i_1608_ -= i_1614_;
		i = (this.aClass_ra_Sub1_9006.anInt7974 * -912871679);
		i_1606_ += i_1614_;
		i_1612_ += i_1614_;
	    ...
	    if (i + i_1608_ > (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725) {
		int i_1615_ = (i + i_1608_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725);
		i_1608_ -= i_1615_;
		i_1611_ += i_1615_;
		i_1610_ += i_1615_;
	    }
		...
		int[] is_1616_ = class_ta_sub2.anIntArray8443;
		int[] is_1617_ = class_ta_sub2.anIntArray8442;
		int i_1618_ = i_1603_;
		if (i_1605_ > i_1618_) {
		    i_1618_ = i_1605_;
		    i_1612_ += (i_1605_ - i_1603_) * i_1607_;
		    i_1606_ += ((i_1605_ - i_1603_) * this.anInt9010);
		}
		...
		for (int i_1620_ = i_1618_; i_1620_ < i_1619_; i_1620_++) {
			...
			int i_1628_ = (this.anIntArray9965[i_1606_++]);
	...
	int[] is = (this.aClass_ra_Sub1_9006.anIntArray7967);
	if (is != null) {
	    int i_1636_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
	    i += this.anInt8990;
	    i_1632_ += this.anInt9000;
	    int i_1637_ = i_1632_ * i_1636_ + i;
	    int i_1638_ = 0;
	    int i_1639_ = this.anInt8989;
	    int i_1640_ = this.anInt9010;
	    int i_1641_ = i_1636_ - i_1640_;
	    int i_1642_ = 0;
	    if (i_1632_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_1643_ = (((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_1632_);
		i_1639_ -= i_1643_;
		i_1632_ = ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805);
		i_1638_ += i_1643_ * i_1640_;
		i_1637_ += i_1643_ * i_1636_;
	    }
	    if (i_1632_ + i_1639_ > (this.aClass_ra_Sub1_9006.anInt7977 * 63686679))
		i_1639_ -= (i_1632_ + i_1639_ - (this.aClass_ra_Sub1_9006.anInt7977) * 63686679);
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_1644_ = (((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
		i_1640_ -= i_1644_;
		i = (this.aClass_ra_Sub1_9006.anInt7974 * -912871679);
		i_1638_ += i_1644_;
		i_1637_ += i_1644_;
	    ...
	    if (i + i_1640_ > (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725) {
		int i_1645_ = (i + i_1640_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725);
		i_1640_ -= i_1645_;
		i_1642_ += i_1645_;
		i_1641_ += i_1645_;
	    }
		...
		if (i_1635_ == 0) {
			...
			for (int i_1646_ = -i_1639_; i_1646_ < 0; i_1646_++) {
				...
				is[i_1637_++] = (this.anIntArray9965[i_1638_++]);
				is[i_1637_++] = (this.anIntArray9965[i_1638_++]);
				is[i_1637_++] = (this.anIntArray9965[i_1638_++]);
				is[i_1637_++] = (this.anIntArray9965[i_1638_++]);
			    }
			...
			for (int i_1651_ = -i_1639_; i_1651_ < 0; i_1651_++) {
				...
				int i_1653_ = (this.anIntArray9965[i_1638_++]);
			...
			for (int i_1657_ = -i_1639_; i_1657_ < 0; i_1657_++) {
				...
				int i_1659_ = (this.anIntArray9965[i_1638_++]);
			...
			for (int i_1667_ = -i_1639_; i_1667_ < 0; i_1667_++) {
				...
				int i_1669_ = (this.anIntArray9965[i_1638_++]);
			...
			for (int i_1670_ = -i_1639_; i_1670_ < 0; i_1670_++) {
				...
				int i_1672_ = (this.anIntArray9965[i_1638_++]);
			...
			if ((i_1634_ & 0xffffff) == 16777215) {
				...
				for (int i_1677_ = -i_1640_; i_1677_ < 0; i_1677_++) {
				    int i_1678_ = (this.anIntArray9965[i_1638_++]);
				...
				for (int i_1686_ = -i_1640_; i_1686_ < 0; i_1686_++) {
				    int i_1687_ = (this.anIntArray9965[i_1638_++]);
			...
			for (int i_1697_ = -i_1639_; i_1697_ < 0; i_1697_++) {
				...
				int i_1699_ = (this.anIntArray9965[i_1638_++]);
			...
			for (int i_1709_ = -i_1639_; i_1709_ < 0; i_1709_++) {
				...
				int i_1711_ = (this.anIntArray9965[i_1638_++]);
			...
			for (int i_1715_ = -i_1639_; i_1715_ < 0; i_1715_++) {
				...
				int i_1717_ = (this.anIntArray9965[i_1638_++]);
				if (i_1717_ != 0) {
			...
			for (int i_1724_ = -i_1639_; i_1724_ < 0; i_1724_++) {
				...
				int i_1726_ = (this.anIntArray9965[i_1638_++]);
				if (i_1726_ != 0) {
			...
			for (int i_1733_ = -i_1639_; i_1733_ < 0; i_1733_++) {
				...
				int i_1735_ = (this.anIntArray9965[i_1638_++]);
			...
			for (int i_1743_ = -i_1639_; i_1743_ < 0; i_1743_++) {
				...
				int i_1745_ = (this.anIntArray9965[i_1638_++]);
				if (i_1745_ != 0) {
	...
	if (is != null) {
	    i += this.anInt8990;
	    i_1749_ += this.anInt9000;
	    int i_1752_ = 0;
	    int i_1753_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
	    int i_1754_ = this.anInt9010;
	    int i_1755_ = this.anInt8989;
	    int i_1756_ = i_1753_ - i_1754_;
	    int i_1757_ = 0;
	    int i_1758_ = i + i_1749_ * i_1753_;
	    if (i_1749_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_1759_ = (((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_1749_);
		i_1755_ -= i_1759_;
		i_1749_ = ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805);
		i_1752_ += i_1759_ * i_1754_;
		i_1758_ += i_1759_ * i_1753_;
	    }
	    if (i_1749_ + i_1755_ > (this.aClass_ra_Sub1_9006.anInt7977 * 63686679))
		i_1755_ -= (i_1749_ + i_1755_ - (this.aClass_ra_Sub1_9006.anInt7977) * 63686679);
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_1760_ = (((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
		i_1754_ -= i_1760_;
		i = (this.aClass_ra_Sub1_9006.anInt7974 * -912871679);
		i_1752_ += i_1760_;
		i_1758_ += i_1760_;
	    ...
	    if (i + i_1754_ > (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725) {
		int i_1761_ = (i + i_1754_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725);
		i_1754_ -= i_1761_;
		i_1757_ += i_1761_;
		i_1756_ += i_1761_;
	    }
		...
		Class_ta_Sub2 class_ta_sub2 = (Class_ta_Sub2) class_ta;
		int[] is_1762_ = class_ta_sub2.anIntArray8443;
		int[] is_1763_ = class_ta_sub2.anIntArray8442;
		int i_1764_ = i_1749_;
		if (i_1751_ > i_1764_) {
		    i_1764_ = i_1751_;
		    i_1758_ += (i_1751_ - i_1749_) * i_1753_;
		    i_1752_ += ((i_1751_ - i_1749_) * this.anInt9010);
		}
		...
		for (int i_1766_ = i_1764_; i_1766_ < i_1765_; i_1766_++) {
			...
			int i_1774_ = (this.anIntArray9965[i_1752_++]);
	...
	if (is != null) {
		...
		if (anInt8991 == 0) {
			...
			if (i_1781_ >= 0 && i_1782_ >= 0 && i_1781_ - (this.anInt9010 << 12) < 0 && i_1782_ - (this.anInt8989 << 12) < 0) {
			    for (/**/; i_1783_ < 0; i_1783_++) {
				int i_1784_ = (((i_1782_ >> 12) * this.anInt9010) + (i_1781_ >> 12));
				int i_1785_ = i_1780_++;
				if (i_1778_ == 0) {
				    if (i == 1)
					is[i_1785_] = (this.anIntArray9965[i_1784_]);
				    else if (i == 0) {
					int i_1786_ = (this.anIntArray9965[i_1784_++]);
					...
					int i_1790_ = (this.anIntArray9965[i_1784_++]);
					...
					int i_1795_ = (this.anIntArray9965[i_1784_]);
				    ...
				    if (i == 1) {
					int i_1798_ = (this.anIntArray9965[i_1784_]);
					...
					int i_1802_ = (this.anIntArray9965[i_1784_]);
					...
					int i_1813_ = (this.anIntArray9965[i_1784_]);
					...
					int i_1820_ = (this.anIntArray9965[i_1784_]);
				    ...
				    if (i == 1) {
					int i_1826_ = (this.anIntArray9965[i_1784_]);
					...
					int i_1830_ = (this.anIntArray9965[i_1784_]);
					...
					int i_1837_ = (this.anIntArray9965[i_1784_]);
					...
					int i_1842_ = (this.anIntArray9965[i_1784_]);
			...
			if (i_1850_ >= 0 && i_1850_ - (this.anInt9010 << 12) < 0) {
			    int i_1853_;
			    if ((i_1853_ = (i_1851_ - (this.anInt8989 << 12))) >= 0) {
				...
				int i_1854_ = (((i_1851_ >> 12) * this.anInt9010) + (i_1850_ >> 12));
				int i_1855_ = i_1849_++;
				if (i_1778_ == 0) {
				    if (i == 1)
					is[i_1855_] = (this.anIntArray9965[i_1854_]);
				    else if (i == 0) {
					int i_1856_ = (this.anIntArray9965[i_1854_++]);
					...
					int i_1860_ = (this.anIntArray9965[i_1854_++]);
					...
					int i_1865_ = (this.anIntArray9965[i_1854_]);
				    ...
				    if (i == 1) {
					int i_1868_ = (this.anIntArray9965[i_1854_]);
					...
					int i_1872_ = (this.anIntArray9965[i_1854_]);
					...
					int i_1883_ = (this.anIntArray9965[i_1854_]);
					...
					int i_1890_ = (this.anIntArray9965[i_1854_]);
				    ...
				    if (i == 1) {
					int i_1896_ = (this.anIntArray9965[i_1854_]);
					...
					int i_1900_ = (this.anIntArray9965[i_1854_]);
					...
					int i_1907_ = (this.anIntArray9965[i_1854_]);
					...
					int i_1912_ = (this.anIntArray9965[i_1854_]);
			...
			if (i_1920_ >= 0 && i_1920_ - (this.anInt9010 << 12) < 0) {
			    if (i_1921_ < 0) {
			    ...
			    int i_1924_;
			    if ((i_1924_ = (1 + i_1921_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_1922_)
				i_1922_ = i_1924_;
			    for (/**/; i_1922_ < 0; i_1922_++) {
				int i_1925_ = (((i_1921_ >> 12) * this.anInt9010) + (i_1920_ >> 12));
				int i_1926_ = i_1919_++;
				if (i_1778_ == 0) {
				    if (i == 1)
					is[i_1926_] = (this.anIntArray9965[i_1925_]);
				    else if (i == 0) {
					int i_1927_ = (this.anIntArray9965[i_1925_++]);
					...
					int i_1931_ = (this.anIntArray9965[i_1925_++]);
					...
					int i_1936_ = (this.anIntArray9965[i_1925_]);
				    ...
				    if (i == 1) {
					int i_1939_ = (this.anIntArray9965[i_1925_]);
					...
					int i_1943_ = (this.anIntArray9965[i_1925_]);
					...
					int i_1954_ = (this.anIntArray9965[i_1925_]);
					...
					int i_1961_ = (this.anIntArray9965[i_1925_]);
				    ...
				    if (i == 1) {
					int i_1967_ = (this.anIntArray9965[i_1925_]);
					...
					int i_1971_ = (this.anIntArray9965[i_1925_]);
					...
					int i_1978_ = (this.anIntArray9965[i_1925_]);
					...
					int i_1983_ = (this.anIntArray9965[i_1925_]);
		...
		if (anInt8991 == 0) {
			...
			if (i_1992_ >= 0 && i_1992_ - (this.anInt8989 << 12) < 0) {
			    int i_1994_;
			    if ((i_1994_ = (i_1991_ - (this.anInt9010 << 12))) >= 0) {
				...
				int i_1995_ = (((i_1992_ >> 12) * this.anInt9010) + (i_1991_ >> 12));
				int i_1996_ = i_1990_++;
				if (i_1778_ == 0) {
				    if (i == 1)
					is[i_1996_] = (this.anIntArray9965[i_1995_]);
				    else if (i == 0) {
					int i_1997_ = (this.anIntArray9965[i_1995_++]);
					...
					int i_2001_ = (this.anIntArray9965[i_1995_++]);
					...
					int i_2006_ = (this.anIntArray9965[i_1995_]);
				    ...
				    if (i == 1) {
					int i_2009_ = (this.anIntArray9965[i_1995_]);
					...
					int i_2013_ = (this.anIntArray9965[i_1995_]);
					...
					int i_2024_ = (this.anIntArray9965[i_1995_]);
					...
					int i_2031_ = (this.anIntArray9965[i_1995_]);
				    ...
				    if (i == 1) {
					int i_2037_ = (this.anIntArray9965[i_1995_]);
					...
					int i_2041_ = (this.anIntArray9965[i_1995_]);
					...
					int i_2048_ = (this.anIntArray9965[i_1995_]);
					...
					int i_2053_ = (this.anIntArray9965[i_1995_]);
			...
			int i_2064_;
			if ((i_2064_ = i_2061_ - (this.anInt9010 << 12)) >= 0) {
			...
			if ((i_2064_ = (i_2061_ - anInt9004) / anInt9004) > i_2063_)
			    i_2063_ = i_2064_;
			if ((i_2064_ = i_2062_ - (this.anInt8989 << 12)) >= 0) {
			...
			for (/**/; i_2063_ < 0; i_2063_++) {
			    int i_2065_ = (((i_2062_ >> 12) * this.anInt9010) + (i_2061_ >> 12));
			    int i_2066_ = i_2060_++;
			    if (i_1778_ == 0) {
				if (i == 1)
				    is[i_2066_] = (this.anIntArray9965[i_2065_]);
				else if (i == 0) {
				    int i_2067_ = (this.anIntArray9965[i_2065_++]);
				    ...
				    int i_2071_ = (this.anIntArray9965[i_2065_++]);
				    ...
				    int i_2076_ = (this.anIntArray9965[i_2065_]);
				...
				if (i == 1) {
				    int i_2079_ = (this.anIntArray9965[i_2065_]);
				    ...
				    int i_2083_ = (this.anIntArray9965[i_2065_]);
				    ...
				    int i_2094_ = (this.anIntArray9965[i_2065_]);
				    ...
				    int i_2101_ = (this.anIntArray9965[i_2065_]);
				...
				if (i == 1) {
				    int i_2107_ = (this.anIntArray9965[i_2065_]);
				    ...
				    int i_2111_ = (this.anIntArray9965[i_2065_]);
				    ...
				    int i_2118_ = (this.anIntArray9965[i_2065_]);
				    ...
				    int i_2123_ = (this.anIntArray9965[i_2065_]);
			...
			int i_2134_;
			if ((i_2134_ = i_2131_ - (this.anInt9010 << 12)) >= 0) {
			...
			if ((i_2134_ = (1 + i_2132_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_2133_)
			    i_2133_ = i_2134_;
			for (/**/; i_2133_ < 0; i_2133_++) {
			    int i_2135_ = (((i_2132_ >> 12) * this.anInt9010) + (i_2131_ >> 12));
			    int i_2136_ = i_2130_++;
			    if (i_1778_ == 0) {
				if (i == 1)
				    is[i_2136_] = (this.anIntArray9965[i_2135_]);
				else if (i == 0) {
				    int i_2137_ = (this.anIntArray9965[i_2135_++]);
				    ...
				    int i_2141_ = (this.anIntArray9965[i_2135_++]);
				    ...
				    int i_2146_ = (this.anIntArray9965[i_2135_]);
				...
				if (i == 1) {
				    int i_2149_ = (this.anIntArray9965[i_2135_]);
				    ...
				    int i_2153_ = (this.anIntArray9965[i_2135_]);
				    ...
				    int i_2164_ = (this.anIntArray9965[i_2135_]);
				    ...
				    int i_2171_ = (this.anIntArray9965[i_2135_]);
				...
				if (i == 1) {
				    int i_2177_ = (this.anIntArray9965[i_2135_]);
				    ...
				    int i_2181_ = (this.anIntArray9965[i_2135_]);
				    ...
				    int i_2188_ = (this.anIntArray9965[i_2135_]);
				    ...
				    int i_2193_ = (this.anIntArray9965[i_2135_]);
		...
		while (i_2199_ < 0) {
		    ...
		    if (i_2202_ >= 0 && i_2202_ - (this.anInt8989 << 12) < 0) {
			if (i_2201_ < 0) {
			...
			int i_2205_;
			if ((i_2205_ = (1 + i_2201_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_2203_)
			    i_2203_ = i_2205_;
			for (/**/; i_2203_ < 0; i_2203_++) {
			    int i_2206_ = (((i_2202_ >> 12) * this.anInt9010) + (i_2201_ >> 12));
			    int i_2207_ = i_2200_++;
			    if (i_1778_ == 0) {
				if (i == 1)
				    is[i_2207_] = (this.anIntArray9965[i_2206_]);
				else if (i == 0) {
				    int i_2208_ = (this.anIntArray9965[i_2206_++]);
				    ...
				    int i_2212_ = (this.anIntArray9965[i_2206_++]);
				    ...
				    int i_2217_ = (this.anIntArray9965[i_2206_]);
				...
				if (i == 1) {
				    int i_2220_ = (this.anIntArray9965[i_2206_]);
				    ...
				    int i_2224_ = (this.anIntArray9965[i_2206_]);
				    ...
				    int i_2235_ = (this.anIntArray9965[i_2206_]);
				    ...
				    int i_2242_ = (this.anIntArray9965[i_2206_]);
				...
				if (i == 1) {
				    int i_2248_ = (this.anIntArray9965[i_2206_]);
				    ...
				    int i_2252_ = (this.anIntArray9965[i_2206_]);
				    ...
				    int i_2259_ = (this.anIntArray9965[i_2206_]);
				    ...
				    int i_2264_ = (this.anIntArray9965[i_2206_]);
		...
		for (int i_2270_ = anInt9001; i_2270_ < 0; i_2270_++) {
		    ...
		    int i_2276_;
		    if ((i_2276_ = (1 + i_2272_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_2274_)
			i_2274_ = i_2276_;
		    if ((i_2276_ = i_2273_ - (this.anInt8989 << 12)) >= 0) {
			...
			int i_2277_ = (((i_2273_ >> 12) * this.anInt9010) + (i_2272_ >> 12));
			int i_2278_ = i_2271_++;
			if (i_1778_ == 0) {
			    if (i == 1)
				is[i_2278_] = (this.anIntArray9965[i_2277_]);
			    else if (i == 0) {
				int i_2279_ = (this.anIntArray9965[i_2277_++]);
				...
				int i_2283_ = (this.anIntArray9965[i_2277_++]);
				...
				int i_2288_ = (this.anIntArray9965[i_2277_]);
			    ...
			    if (i == 1) {
				int i_2291_ = (this.anIntArray9965[i_2277_]);
				...
				int i_2295_ = (this.anIntArray9965[i_2277_]);
				...
				int i_2306_ = (this.anIntArray9965[i_2277_]);
				...
				int i_2313_ = (this.anIntArray9965[i_2277_]);
			    ...
			    if (i == 1) {
				int i_2319_ = (this.anIntArray9965[i_2277_]);
				...
				int i_2323_ = (this.anIntArray9965[i_2277_]);
				...
				int i_2330_ = (this.anIntArray9965[i_2277_]);
				...
				int i_2335_ = (this.anIntArray9965[i_2277_]);
		...
		for (int i_2341_ = anInt9001; i_2341_ < 0; i_2341_++) {
		    ...
		    int i_2347_;
		    if ((i_2347_ = (1 + i_2343_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_2345_)
			i_2345_ = i_2347_;
		    if (i_2344_ < 0) {
		    ...
		    if ((i_2347_ = (1 + i_2344_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_2345_)
			i_2345_ = i_2347_;
		    for (/**/; i_2345_ < 0; i_2345_++) {
			int i_2348_ = (((i_2344_ >> 12) * this.anInt9010) + (i_2343_ >> 12));
			int i_2349_ = i_2342_++;
			if (i_1778_ == 0) {
			    if (i == 1)
				is[i_2349_] = (this.anIntArray9965[i_2348_]);
			    else if (i == 0) {
				int i_2350_ = (this.anIntArray9965[i_2348_++]);
				...
				int i_2354_ = (this.anIntArray9965[i_2348_++]);
				...
				int i_2359_ = (this.anIntArray9965[i_2348_]);
			    ...
			    if (i == 1) {
				int i_2362_ = (this.anIntArray9965[i_2348_]);
				...
				int i_2366_ = (this.anIntArray9965[i_2348_]);
				...
				int i_2377_ = (this.anIntArray9965[i_2348_]);
				...
				int i_2384_ = (this.anIntArray9965[i_2348_]);
			    ...
			    if (i == 1) {
				int i_2390_ = (this.anIntArray9965[i_2348_]);
				...
				int i_2394_ = (this.anIntArray9965[i_2348_]);
				...
				int i_2401_ = (this.anIntArray9965[i_2348_]);
				...
				int i_2406_ = (this.anIntArray9965[i_2348_]);
	...
	if (i_2413_ > 0 && i_2414_ > 0) {
		...
		int i_2419_ = 0;
		int i_2420_ = 0;
		int i_2421_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
		int i_2422_ = (this.anInt8990 + this.anInt9010 + this.anInt8997);
		int i_2423_ = (this.anInt9000 + this.anInt8989 + this.anInt8993);
		int i_2424_ = (i_2422_ << 16) / i_2413_;
		int i_2425_ = (i_2423_ << 16) / i_2414_;
		if (this.anInt8990 > 0) {
		    int i_2426_ = ((this.anInt8990 << 16) + i_2424_ - 1) / i_2424_;
		    i += i_2426_;
		    i_2419_ += (i_2426_ * i_2424_ - (this.anInt8990 << 16));
		}
		if (this.anInt9000 > 0) {
		    int i_2427_ = ((this.anInt9000 << 16) + i_2425_ - 1) / i_2425_;
		    i_2412_ += i_2427_;
		    i_2420_ += (i_2427_ * i_2425_ - (this.anInt9000 << 16));
		}
		if (this.anInt9010 < i_2422_)
		    i_2413_ = ((this.anInt9010 << 16) - i_2419_ + i_2424_ - 1) / i_2424_;
		if (this.anInt8989 < i_2423_)
		    i_2414_ = ((this.anInt8989 << 16) - i_2420_ + i_2425_ - 1) / i_2425_;
		int i_2428_ = i + i_2412_ * i_2421_;
		int i_2429_ = i_2421_ - i_2413_;
		if (i_2412_ + i_2414_ > ((this.aClass_ra_Sub1_9006).anInt7977 * 63686679))
		    i_2414_ -= (i_2412_ + i_2414_ - ((this.aClass_ra_Sub1_9006).anInt7977) * 63686679);
		if (i_2412_ < (this.aClass_ra_Sub1_9006.anInt7976) * -1278653805) {
		    int i_2430_ = ((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_2412_;
		    i_2414_ -= i_2430_;
		    i_2428_ += i_2430_ * i_2421_;
		    i_2420_ += i_2425_ * i_2430_;
		}
		if (i + i_2413_ > ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725) {
		    int i_2431_ = (i + i_2413_ - (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725);
		    i_2413_ -= i_2431_;
		    i_2429_ += i_2431_;
		}
		if (i < ((this.aClass_ra_Sub1_9006).anInt7974 * -912871679)) {
		    int i_2432_ = ((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i;
		    i_2413_ -= i_2432_;
		    i_2428_ += i_2432_;
		...
		if (i_2417_ == 0) {
			...
			for (int i_2434_ = -i_2414_; i_2434_ < 0; i_2434_++) {
			    int i_2435_ = ((i_2420_ >> 16) * this.anInt9010);
			    for (int i_2436_ = -i_2413_; i_2436_ < 0; i_2436_++) {
				is[i_2428_++] = (this.anIntArray9965[(i_2419_ >> 16) + i_2435_]);
				i_2419_ += i_2424_;
			    }
			    i_2420_ += i_2425_;
			    i_2419_ = i_2433_;
			...
			for (int i_2441_ = -i_2414_; i_2441_ < 0; i_2441_++) {
			    int i_2442_ = ((i_2420_ >> 16) * this.anInt9010);
			    for (int i_2443_ = -i_2413_; i_2443_ < 0; i_2443_++) {
				int i_2444_ = (this.anIntArray9965[(i_2419_ >> 16) + i_2442_]);
			...
			for (int i_2449_ = -i_2414_; i_2449_ < 0; i_2449_++) {
			    int i_2450_ = ((i_2420_ >> 16) * this.anInt9010);
			    for (int i_2451_ = -i_2413_; i_2451_ < 0; i_2451_++) {
				int i_2452_ = (this.anIntArray9965[(i_2419_ >> 16) + i_2450_]);
			...
			for (int i_2461_ = -i_2414_; i_2461_ < 0; i_2461_++) {
			    int i_2462_ = ((i_2420_ >> 16) * this.anInt9010);
			    for (int i_2463_ = -i_2413_; i_2463_ < 0; i_2463_++) {
				int i_2464_ = (this.anIntArray9965[(i_2419_ >> 16) + i_2462_]);
			...
			for (int i_2466_ = -i_2414_; i_2466_ < 0; i_2466_++) {
			    int i_2467_ = ((i_2420_ >> 16) * this.anInt9010);
			    for (int i_2468_ = -i_2413_; i_2468_ < 0; i_2468_++) {
				int i_2469_ = (this.anIntArray9965[(i_2419_ >> 16) + i_2467_]);
			...
			if ((i_2416_ & 0xffffff) == 16777215) {
				...
				int i_2475_ = ((i_2420_ >> 16) * this.anInt9010);
				for (int i_2476_ = -i_2413_; i_2476_ < 0; i_2476_++) {
				    int i_2477_ = (this.anIntArray9965[(i_2419_ >> 16) + i_2475_]);
				...
				int i_2485_ = ((i_2420_ >> 16) * this.anInt9010);
				for (int i_2486_ = -i_2413_; i_2486_ < 0; i_2486_++) {
				    int i_2487_ = (this.anIntArray9965[(i_2419_ >> 16) + i_2485_]);
			...
			for (int i_2498_ = -i_2414_; i_2498_ < 0; i_2498_++) {
			    int i_2499_ = ((i_2420_ >> 16) * this.anInt9010);
			    for (int i_2500_ = -i_2413_; i_2500_ < 0; i_2500_++) {
				int i_2501_ = (this.anIntArray9965[(i_2419_ >> 16) + i_2499_]);
			...
			for (int i_2512_ = -i_2414_; i_2512_ < 0; i_2512_++) {
			    int i_2513_ = ((i_2420_ >> 16) * this.anInt9010);
			    for (int i_2514_ = -i_2413_; i_2514_ < 0; i_2514_++) {
				int i_2515_ = (this.anIntArray9965[(i_2419_ >> 16) + i_2513_]);
			...
			for (int i_2520_ = -i_2414_; i_2520_ < 0; i_2520_++) {
			    int i_2521_ = ((i_2420_ >> 16) * this.anInt9010);
			    for (int i_2522_ = -i_2413_; i_2522_ < 0; i_2522_++) {
				int i_2523_ = (this.anIntArray9965[(i_2419_ >> 16) + i_2521_]);
				if (i_2523_ != 0) {
			...
			for (int i_2531_ = -i_2414_; i_2531_ < 0; i_2531_++) {
			    int i_2532_ = ((i_2420_ >> 16) * this.anInt9010);
			    for (int i_2533_ = -i_2413_; i_2533_ < 0; i_2533_++) {
				int i_2534_ = (this.anIntArray9965[(i_2419_ >> 16) + i_2532_]);
				if (i_2534_ != 0) {
			...
			for (int i_2542_ = -i_2414_; i_2542_ < 0; i_2542_++) {
			    int i_2543_ = ((i_2420_ >> 16) * this.anInt9010);
			    for (int i_2544_ = -i_2413_; i_2544_ < 0; i_2544_++) {
				int i_2545_ = (this.anIntArray9965[(i_2419_ >> 16) + i_2543_]);
			...
			for (int i_2554_ = -i_2414_; i_2554_ < 0; i_2554_++) {
			    int i_2555_ = ((i_2420_ >> 16) * this.anInt9010);
			    for (int i_2556_ = -i_2413_; i_2556_ < 0; i_2556_++) {
				int i_2557_ = (this.anIntArray9965[(i_2419_ >> 16) + i_2555_]);
				if (i_2557_ != 0) {
	...
	int[] is = (this.aClass_ra_Sub1_9006.anIntArray7967);
	if (is != null) {
	    int i_2565_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
	    i += this.anInt8990;
	    i_2561_ += this.anInt9000;
	    int i_2566_ = i_2561_ * i_2565_ + i;
	    int i_2567_ = 0;
	    int i_2568_ = this.anInt8989;
	    int i_2569_ = this.anInt9010;
	    int i_2570_ = i_2565_ - i_2569_;
	    int i_2571_ = 0;
	    if (i_2561_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_2572_ = (((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_2561_);
		i_2568_ -= i_2572_;
		i_2561_ = ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805);
		i_2567_ += i_2572_ * i_2569_;
		i_2566_ += i_2572_ * i_2565_;
	    }
	    if (i_2561_ + i_2568_ > (this.aClass_ra_Sub1_9006.anInt7977 * 63686679))
		i_2568_ -= (i_2561_ + i_2568_ - (this.aClass_ra_Sub1_9006.anInt7977) * 63686679);
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_2573_ = (((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
		i_2569_ -= i_2573_;
		i = (this.aClass_ra_Sub1_9006.anInt7974 * -912871679);
		i_2567_ += i_2573_;
		i_2566_ += i_2573_;
	    ...
	    if (i + i_2569_ > (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725) {
		int i_2574_ = (i + i_2569_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725);
		i_2569_ -= i_2574_;
		i_2571_ += i_2574_;
		i_2570_ += i_2574_;
	    }
		...
		if (i_2564_ == 0) {
			...
			for (int i_2575_ = -i_2568_; i_2575_ < 0; i_2575_++) {
				...
				is[i_2566_++] = (this.anIntArray9965[i_2567_++]);
				is[i_2566_++] = (this.anIntArray9965[i_2567_++]);
				is[i_2566_++] = (this.anIntArray9965[i_2567_++]);
				is[i_2566_++] = (this.anIntArray9965[i_2567_++]);
			    }
			...
			for (int i_2580_ = -i_2568_; i_2580_ < 0; i_2580_++) {
				...
				int i_2582_ = (this.anIntArray9965[i_2567_++]);
			...
			for (int i_2586_ = -i_2568_; i_2586_ < 0; i_2586_++) {
				...
				int i_2588_ = (this.anIntArray9965[i_2567_++]);
			...
			for (int i_2596_ = -i_2568_; i_2596_ < 0; i_2596_++) {
				...
				int i_2598_ = (this.anIntArray9965[i_2567_++]);
			...
			for (int i_2599_ = -i_2568_; i_2599_ < 0; i_2599_++) {
				...
				int i_2601_ = (this.anIntArray9965[i_2567_++]);
			...
			if ((i_2563_ & 0xffffff) == 16777215) {
				...
				for (int i_2606_ = -i_2569_; i_2606_ < 0; i_2606_++) {
				    int i_2607_ = (this.anIntArray9965[i_2567_++]);
				...
				for (int i_2615_ = -i_2569_; i_2615_ < 0; i_2615_++) {
				    int i_2616_ = (this.anIntArray9965[i_2567_++]);
			...
			for (int i_2626_ = -i_2568_; i_2626_ < 0; i_2626_++) {
				...
				int i_2628_ = (this.anIntArray9965[i_2567_++]);
			...
			for (int i_2638_ = -i_2568_; i_2638_ < 0; i_2638_++) {
				...
				int i_2640_ = (this.anIntArray9965[i_2567_++]);
			...
			for (int i_2644_ = -i_2568_; i_2644_ < 0; i_2644_++) {
				...
				int i_2646_ = (this.anIntArray9965[i_2567_++]);
				if (i_2646_ != 0) {
			...
			for (int i_2653_ = -i_2568_; i_2653_ < 0; i_2653_++) {
				...
				int i_2655_ = (this.anIntArray9965[i_2567_++]);
				if (i_2655_ != 0) {
			...
			for (int i_2662_ = -i_2568_; i_2662_ < 0; i_2662_++) {
				...
				int i_2664_ = (this.anIntArray9965[i_2567_++]);
			...
			for (int i_2672_ = -i_2568_; i_2672_ < 0; i_2672_++) {
				...
				int i_2674_ = (this.anIntArray9965[i_2567_++]);
				if (i_2674_ != 0) {
	...
	if (is != null) {
		...
		if (anInt8991 == 0) {
			...
			if (i_2681_ >= 0 && i_2682_ >= 0 && i_2681_ - (this.anInt9010 << 12) < 0 && i_2682_ - (this.anInt8989 << 12) < 0) {
			    for (/**/; i_2683_ < 0; i_2683_++) {
				int i_2684_ = (((i_2682_ >> 12) * this.anInt9010) + (i_2681_ >> 12));
				int i_2685_ = i_2680_++;
				if (i_2678_ == 0) {
				    if (i == 1)
					is[i_2685_] = (this.anIntArray9965[i_2684_]);
				    else if (i == 0) {
					int i_2686_ = (this.anIntArray9965[i_2684_++]);
					...
					int i_2690_ = (this.anIntArray9965[i_2684_++]);
					...
					int i_2695_ = (this.anIntArray9965[i_2684_]);
				    ...
				    if (i == 1) {
					int i_2698_ = (this.anIntArray9965[i_2684_]);
					...
					int i_2702_ = (this.anIntArray9965[i_2684_]);
					...
					int i_2713_ = (this.anIntArray9965[i_2684_]);
					...
					int i_2720_ = (this.anIntArray9965[i_2684_]);
				    ...
				    if (i == 1) {
					int i_2726_ = (this.anIntArray9965[i_2684_]);
					...
					int i_2730_ = (this.anIntArray9965[i_2684_]);
					...
					int i_2737_ = (this.anIntArray9965[i_2684_]);
					...
					int i_2742_ = (this.anIntArray9965[i_2684_]);
			...
			if (i_2750_ >= 0 && i_2750_ - (this.anInt9010 << 12) < 0) {
			    int i_2753_;
			    if ((i_2753_ = (i_2751_ - (this.anInt8989 << 12))) >= 0) {
				...
				int i_2754_ = (((i_2751_ >> 12) * this.anInt9010) + (i_2750_ >> 12));
				int i_2755_ = i_2749_++;
				if (i_2678_ == 0) {
				    if (i == 1)
					is[i_2755_] = (this.anIntArray9965[i_2754_]);
				    else if (i == 0) {
					int i_2756_ = (this.anIntArray9965[i_2754_++]);
					...
					int i_2760_ = (this.anIntArray9965[i_2754_++]);
					...
					int i_2765_ = (this.anIntArray9965[i_2754_]);
				    ...
				    if (i == 1) {
					int i_2768_ = (this.anIntArray9965[i_2754_]);
					...
					int i_2772_ = (this.anIntArray9965[i_2754_]);
					...
					int i_2783_ = (this.anIntArray9965[i_2754_]);
					...
					int i_2790_ = (this.anIntArray9965[i_2754_]);
				    ...
				    if (i == 1) {
					int i_2796_ = (this.anIntArray9965[i_2754_]);
					...
					int i_2800_ = (this.anIntArray9965[i_2754_]);
					...
					int i_2807_ = (this.anIntArray9965[i_2754_]);
					...
					int i_2812_ = (this.anIntArray9965[i_2754_]);
			...
			if (i_2820_ >= 0 && i_2820_ - (this.anInt9010 << 12) < 0) {
			    if (i_2821_ < 0) {
			    ...
			    int i_2824_;
			    if ((i_2824_ = (1 + i_2821_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_2822_)
				i_2822_ = i_2824_;
			    for (/**/; i_2822_ < 0; i_2822_++) {
				int i_2825_ = (((i_2821_ >> 12) * this.anInt9010) + (i_2820_ >> 12));
				int i_2826_ = i_2819_++;
				if (i_2678_ == 0) {
				    if (i == 1)
					is[i_2826_] = (this.anIntArray9965[i_2825_]);
				    else if (i == 0) {
					int i_2827_ = (this.anIntArray9965[i_2825_++]);
					...
					int i_2831_ = (this.anIntArray9965[i_2825_++]);
					...
					int i_2836_ = (this.anIntArray9965[i_2825_]);
				    ...
				    if (i == 1) {
					int i_2839_ = (this.anIntArray9965[i_2825_]);
					...
					int i_2843_ = (this.anIntArray9965[i_2825_]);
					...
					int i_2854_ = (this.anIntArray9965[i_2825_]);
					...
					int i_2861_ = (this.anIntArray9965[i_2825_]);
				    ...
				    if (i == 1) {
					int i_2867_ = (this.anIntArray9965[i_2825_]);
					...
					int i_2871_ = (this.anIntArray9965[i_2825_]);
					...
					int i_2878_ = (this.anIntArray9965[i_2825_]);
					...
					int i_2883_ = (this.anIntArray9965[i_2825_]);
		...
		if (anInt8991 == 0) {
			...
			if (i_2892_ >= 0 && i_2892_ - (this.anInt8989 << 12) < 0) {
			    int i_2894_;
			    if ((i_2894_ = (i_2891_ - (this.anInt9010 << 12))) >= 0) {
				...
				int i_2895_ = (((i_2892_ >> 12) * this.anInt9010) + (i_2891_ >> 12));
				int i_2896_ = i_2890_++;
				if (i_2678_ == 0) {
				    if (i == 1)
					is[i_2896_] = (this.anIntArray9965[i_2895_]);
				    else if (i == 0) {
					int i_2897_ = (this.anIntArray9965[i_2895_++]);
					...
					int i_2901_ = (this.anIntArray9965[i_2895_++]);
					...
					int i_2906_ = (this.anIntArray9965[i_2895_]);
				    ...
				    if (i == 1) {
					int i_2909_ = (this.anIntArray9965[i_2895_]);
					...
					int i_2913_ = (this.anIntArray9965[i_2895_]);
					...
					int i_2924_ = (this.anIntArray9965[i_2895_]);
					...
					int i_2931_ = (this.anIntArray9965[i_2895_]);
				    ...
				    if (i == 1) {
					int i_2937_ = (this.anIntArray9965[i_2895_]);
					...
					int i_2941_ = (this.anIntArray9965[i_2895_]);
					...
					int i_2948_ = (this.anIntArray9965[i_2895_]);
					...
					int i_2953_ = (this.anIntArray9965[i_2895_]);
			...
			int i_2964_;
			if ((i_2964_ = i_2961_ - (this.anInt9010 << 12)) >= 0) {
			...
			if ((i_2964_ = (i_2961_ - anInt9004) / anInt9004) > i_2963_)
			    i_2963_ = i_2964_;
			if ((i_2964_ = i_2962_ - (this.anInt8989 << 12)) >= 0) {
			...
			for (/**/; i_2963_ < 0; i_2963_++) {
			    int i_2965_ = (((i_2962_ >> 12) * this.anInt9010) + (i_2961_ >> 12));
			    int i_2966_ = i_2960_++;
			    if (i_2678_ == 0) {
				if (i == 1)
				    is[i_2966_] = (this.anIntArray9965[i_2965_]);
				else if (i == 0) {
				    int i_2967_ = (this.anIntArray9965[i_2965_++]);
				    ...
				    int i_2971_ = (this.anIntArray9965[i_2965_++]);
				    ...
				    int i_2976_ = (this.anIntArray9965[i_2965_]);
				...
				if (i == 1) {
				    int i_2979_ = (this.anIntArray9965[i_2965_]);
				    ...
				    int i_2983_ = (this.anIntArray9965[i_2965_]);
				    ...
				    int i_2994_ = (this.anIntArray9965[i_2965_]);
				    ...
				    int i_3001_ = (this.anIntArray9965[i_2965_]);
				...
				if (i == 1) {
				    int i_3007_ = (this.anIntArray9965[i_2965_]);
				    ...
				    int i_3011_ = (this.anIntArray9965[i_2965_]);
				    ...
				    int i_3018_ = (this.anIntArray9965[i_2965_]);
				    ...
				    int i_3023_ = (this.anIntArray9965[i_2965_]);
			...
			int i_3034_;
			if ((i_3034_ = i_3031_ - (this.anInt9010 << 12)) >= 0) {
			...
			if ((i_3034_ = (1 + i_3032_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_3033_)
			    i_3033_ = i_3034_;
			for (/**/; i_3033_ < 0; i_3033_++) {
			    int i_3035_ = (((i_3032_ >> 12) * this.anInt9010) + (i_3031_ >> 12));
			    int i_3036_ = i_3030_++;
			    if (i_2678_ == 0) {
				if (i == 1)
				    is[i_3036_] = (this.anIntArray9965[i_3035_]);
				else if (i == 0) {
				    int i_3037_ = (this.anIntArray9965[i_3035_++]);
				    ...
				    int i_3041_ = (this.anIntArray9965[i_3035_++]);
				    ...
				    int i_3046_ = (this.anIntArray9965[i_3035_]);
				...
				if (i == 1) {
				    int i_3049_ = (this.anIntArray9965[i_3035_]);
				    ...
				    int i_3053_ = (this.anIntArray9965[i_3035_]);
				    ...
				    int i_3064_ = (this.anIntArray9965[i_3035_]);
				    ...
				    int i_3071_ = (this.anIntArray9965[i_3035_]);
				...
				if (i == 1) {
				    int i_3077_ = (this.anIntArray9965[i_3035_]);
				    ...
				    int i_3081_ = (this.anIntArray9965[i_3035_]);
				    ...
				    int i_3088_ = (this.anIntArray9965[i_3035_]);
				    ...
				    int i_3093_ = (this.anIntArray9965[i_3035_]);
		...
		while (i_3099_ < 0) {
		    ...
		    if (i_3102_ >= 0 && i_3102_ - (this.anInt8989 << 12) < 0) {
			if (i_3101_ < 0) {
			...
			int i_3105_;
			if ((i_3105_ = (1 + i_3101_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3103_)
			    i_3103_ = i_3105_;
			for (/**/; i_3103_ < 0; i_3103_++) {
			    int i_3106_ = (((i_3102_ >> 12) * this.anInt9010) + (i_3101_ >> 12));
			    int i_3107_ = i_3100_++;
			    if (i_2678_ == 0) {
				if (i == 1)
				    is[i_3107_] = (this.anIntArray9965[i_3106_]);
				else if (i == 0) {
				    int i_3108_ = (this.anIntArray9965[i_3106_++]);
				    ...
				    int i_3112_ = (this.anIntArray9965[i_3106_++]);
				    ...
				    int i_3117_ = (this.anIntArray9965[i_3106_]);
				...
				if (i == 1) {
				    int i_3120_ = (this.anIntArray9965[i_3106_]);
				    ...
				    int i_3124_ = (this.anIntArray9965[i_3106_]);
				    ...
				    int i_3135_ = (this.anIntArray9965[i_3106_]);
				    ...
				    int i_3142_ = (this.anIntArray9965[i_3106_]);
				...
				if (i == 1) {
				    int i_3148_ = (this.anIntArray9965[i_3106_]);
				    ...
				    int i_3152_ = (this.anIntArray9965[i_3106_]);
				    ...
				    int i_3159_ = (this.anIntArray9965[i_3106_]);
				    ...
				    int i_3164_ = (this.anIntArray9965[i_3106_]);
		...
		for (int i_3170_ = anInt9001; i_3170_ < 0; i_3170_++) {
		    ...
		    int i_3176_;
		    if ((i_3176_ = (1 + i_3172_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3174_)
			i_3174_ = i_3176_;
		    if ((i_3176_ = i_3173_ - (this.anInt8989 << 12)) >= 0) {
			...
			int i_3177_ = (((i_3173_ >> 12) * this.anInt9010) + (i_3172_ >> 12));
			int i_3178_ = i_3171_++;
			if (i_2678_ == 0) {
			    if (i == 1)
				is[i_3178_] = (this.anIntArray9965[i_3177_]);
			    else if (i == 0) {
				int i_3179_ = (this.anIntArray9965[i_3177_++]);
				...
				int i_3183_ = (this.anIntArray9965[i_3177_++]);
				...
				int i_3188_ = (this.anIntArray9965[i_3177_]);
			    ...
			    if (i == 1) {
				int i_3191_ = (this.anIntArray9965[i_3177_]);
				...
				int i_3195_ = (this.anIntArray9965[i_3177_]);
				...
				int i_3206_ = (this.anIntArray9965[i_3177_]);
				...
				int i_3213_ = (this.anIntArray9965[i_3177_]);
			    ...
			    if (i == 1) {
				int i_3219_ = (this.anIntArray9965[i_3177_]);
				...
				int i_3223_ = (this.anIntArray9965[i_3177_]);
				...
				int i_3230_ = (this.anIntArray9965[i_3177_]);
				...
				int i_3235_ = (this.anIntArray9965[i_3177_]);
		...
		for (int i_3241_ = anInt9001; i_3241_ < 0; i_3241_++) {
		    ...
		    int i_3247_;
		    if ((i_3247_ = (1 + i_3243_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3245_)
			i_3245_ = i_3247_;
		    if (i_3244_ < 0) {
		    ...
		    if ((i_3247_ = (1 + i_3244_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_3245_)
			i_3245_ = i_3247_;
		    for (/**/; i_3245_ < 0; i_3245_++) {
			int i_3248_ = (((i_3244_ >> 12) * this.anInt9010) + (i_3243_ >> 12));
			int i_3249_ = i_3242_++;
			if (i_2678_ == 0) {
			    if (i == 1)
				is[i_3249_] = (this.anIntArray9965[i_3248_]);
			    else if (i == 0) {
				int i_3250_ = (this.anIntArray9965[i_3248_++]);
				...
				int i_3254_ = (this.anIntArray9965[i_3248_++]);
				...
				int i_3259_ = (this.anIntArray9965[i_3248_]);
			    ...
			    if (i == 1) {
				int i_3262_ = (this.anIntArray9965[i_3248_]);
				...
				int i_3266_ = (this.anIntArray9965[i_3248_]);
				...
				int i_3277_ = (this.anIntArray9965[i_3248_]);
				...
				int i_3284_ = (this.anIntArray9965[i_3248_]);
			    ...
			    if (i == 1) {
				int i_3290_ = (this.anIntArray9965[i_3248_]);
				...
				int i_3294_ = (this.anIntArray9965[i_3248_]);
				...
				int i_3301_ = (this.anIntArray9965[i_3248_]);
				...
				int i_3306_ = (this.anIntArray9965[i_3248_]);
	...
	int[] is_3314_ = (this.aClass_ra_Sub1_9006.anIntArray7967);
	if (is_3314_ != null) {
	    if (anInt9004 == 0) {
		if (anInt8991 == 0) {
			...
			if (i_3316_ >= 0) {
			    ...
			    if (i_3318_ >= 0 && i_3319_ >= 0 && (i_3318_ - (this.anInt9010 << 12)) < 0 && (i_3319_ - (this.anInt8989 << 12)) < 0) {
				...
				for (/**/; i_3320_ < 0; i_3320_++) {
				    int i_3324_ = (this.anIntArray9965[(((i_3319_ >> 12) * (this.anInt9010)) + (i_3318_ >> 12))]);
			...
			if (i_3329_ >= 0) {
			    ...
			    if (i_3331_ >= 0 && (i_3331_ - (this.anInt9010 << 12)) < 0) {
				int i_3334_;
				if ((i_3334_ = (i_3332_ - (this.anInt8989 << 12))) >= 0) {
				...
				for (/**/; i_3333_ < 0; i_3333_++) {
				    int i_3338_ = (this.anIntArray9965[(((i_3332_ >> 12) * (this.anInt9010)) + (i_3331_ >> 12))]);
			...
			if (i_3343_ >= 0) {
			    ...
			    if (i_3345_ >= 0 && (i_3345_ - (this.anInt9010 << 12)) < 0) {
				if (i_3346_ < 0) {
				...
				int i_3349_;
				if ((i_3349_ = (1 + i_3346_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_3347_)
				    i_3347_ = i_3349_;
				...
				for (/**/; i_3347_ < 0; i_3347_++) {
				    int i_3353_ = (this.anIntArray9965[(((i_3346_ >> 12) * (this.anInt9010)) + (i_3345_ >> 12))]);
		...
		if (anInt8991 == 0) {
			...
			if (i_3358_ >= 0) {
			    ...
			    if (i_3361_ >= 0 && (i_3361_ - (this.anInt8989 << 12)) < 0) {
				int i_3363_;
				if ((i_3363_ = (i_3360_ - (this.anInt9010 << 12))) >= 0) {
				...
				for (/**/; i_3362_ < 0; i_3362_++) {
				    int i_3367_ = (this.anIntArray9965[(((i_3361_ >> 12) * (this.anInt9010)) + (i_3360_ >> 12))]);
			...
			if (i_3372_ >= 0) {
			    ...
			    int i_3377_;
			    if ((i_3377_ = (i_3374_ - (this.anInt9010 << 12))) >= 0) {
				...
				i_3376_ = i_3377_;
			    if ((i_3377_ = (i_3375_ - (this.anInt8989 << 12))) >= 0) {
				...
				int i_3381_ = (this.anIntArray9965[((i_3375_ >> 12) * this.anInt9010 + (i_3374_ >> 12))]);
			...
			if (i_3386_ >= 0) {
			    ...
			    int i_3391_;
			    if ((i_3391_ = (i_3388_ - (this.anInt9010 << 12))) >= 0) {
			    ...
			    if ((i_3391_ = (1 + i_3389_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_3390_)
				i_3390_ = i_3391_;
				...
				int i_3395_ = (this.anIntArray9965[((i_3389_ >> 12) * this.anInt9010 + (i_3388_ >> 12))]);
		...
		while (i_3399_ < 0) {
			...
			if (i_3403_ >= 0 && i_3403_ - (this.anInt8989 << 12) < 0) {
			    if (i_3402_ < 0) {
			    ...
			    int i_3406_;
			    if ((i_3406_ = (1 + i_3402_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3404_)
				i_3404_ = i_3406_;
				...
				int i_3410_ = (this.anIntArray9965[((i_3403_ >> 12) * this.anInt9010 + (i_3402_ >> 12))]);
		...
		while (i_3414_ < 0) {
			...
			int i_3421_;
			if ((i_3421_ = (1 + i_3417_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3419_)
			    i_3419_ = i_3421_;
			if ((i_3421_ = i_3418_ - (this.anInt8989 << 12)) >= 0) {
			...
			for (/**/; i_3419_ < 0; i_3419_++) {
			    int i_3425_ = (this.anIntArray9965[(((i_3418_ >> 12) * this.anInt9010) + (i_3417_ >> 12))]);
		...
		while (i_3429_ < 0) {
			...
			int i_3436_;
			if ((i_3436_ = (1 + i_3432_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3434_)
			    i_3434_ = i_3436_;
			if (i_3433_ < 0) {
			...
			if ((i_3436_ = (1 + i_3433_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_3434_)
			    i_3434_ = i_3436_;
			...
			for (/**/; i_3434_ < 0; i_3434_++) {
			    int i_3440_ = (this.anIntArray9965[(((i_3433_ >> 12) * this.anInt9010) + (i_3432_ >> 12))]);
	...
	if (i_3445_ > 0 && i_3446_ > 0) {
		...
		int i_3451_ = 0;
		int i_3452_ = 0;
		int i_3453_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
		int i_3454_ = (this.anInt8990 + this.anInt9010 + this.anInt8997);
		int i_3455_ = (this.anInt9000 + this.anInt8989 + this.anInt8993);
		int i_3456_ = (i_3454_ << 16) / i_3445_;
		int i_3457_ = (i_3455_ << 16) / i_3446_;
		if (this.anInt8990 > 0) {
		    int i_3458_ = ((this.anInt8990 << 16) + i_3456_ - 1) / i_3456_;
		    i += i_3458_;
		    i_3451_ += (i_3458_ * i_3456_ - (this.anInt8990 << 16));
		}
		if (this.anInt9000 > 0) {
		    int i_3459_ = ((this.anInt9000 << 16) + i_3457_ - 1) / i_3457_;
		    i_3444_ += i_3459_;
		    i_3452_ += (i_3459_ * i_3457_ - (this.anInt9000 << 16));
		}
		if (this.anInt9010 < i_3454_)
		    i_3445_ = ((this.anInt9010 << 16) - i_3451_ + i_3456_ - 1) / i_3456_;
		if (this.anInt8989 < i_3455_)
		    i_3446_ = ((this.anInt8989 << 16) - i_3452_ + i_3457_ - 1) / i_3457_;
		int i_3460_ = i + i_3444_ * i_3453_;
		int i_3461_ = i_3453_ - i_3445_;
		if (i_3444_ + i_3446_ > ((this.aClass_ra_Sub1_9006).anInt7977 * 63686679))
		    i_3446_ -= (i_3444_ + i_3446_ - ((this.aClass_ra_Sub1_9006).anInt7977) * 63686679);
		if (i_3444_ < (this.aClass_ra_Sub1_9006.anInt7976) * -1278653805) {
		    int i_3462_ = ((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_3444_;
		    i_3446_ -= i_3462_;
		    i_3460_ += i_3462_ * i_3453_;
		    i_3452_ += i_3457_ * i_3462_;
		}
		if (i + i_3445_ > ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725) {
		    int i_3463_ = (i + i_3445_ - (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725);
		    i_3445_ -= i_3463_;
		    i_3461_ += i_3463_;
		}
		if (i < ((this.aClass_ra_Sub1_9006).anInt7974 * -912871679)) {
		    int i_3464_ = ((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i;
		    i_3445_ -= i_3464_;
		    i_3460_ += i_3464_;
		...
		if (i_3449_ == 0) {
			...
			for (int i_3466_ = -i_3446_; i_3466_ < 0; i_3466_++) {
			    int i_3467_ = ((i_3452_ >> 16) * this.anInt9010);
			    for (int i_3468_ = -i_3445_; i_3468_ < 0; i_3468_++) {
				is[i_3460_++] = (this.anIntArray9965[(i_3451_ >> 16) + i_3467_]);
				i_3451_ += i_3456_;
			    }
			    i_3452_ += i_3457_;
			    i_3451_ = i_3465_;
			...
			for (int i_3473_ = -i_3446_; i_3473_ < 0; i_3473_++) {
			    int i_3474_ = ((i_3452_ >> 16) * this.anInt9010);
			    for (int i_3475_ = -i_3445_; i_3475_ < 0; i_3475_++) {
				int i_3476_ = (this.anIntArray9965[(i_3451_ >> 16) + i_3474_]);
			...
			for (int i_3481_ = -i_3446_; i_3481_ < 0; i_3481_++) {
			    int i_3482_ = ((i_3452_ >> 16) * this.anInt9010);
			    for (int i_3483_ = -i_3445_; i_3483_ < 0; i_3483_++) {
				int i_3484_ = (this.anIntArray9965[(i_3451_ >> 16) + i_3482_]);
			...
			for (int i_3493_ = -i_3446_; i_3493_ < 0; i_3493_++) {
			    int i_3494_ = ((i_3452_ >> 16) * this.anInt9010);
			    for (int i_3495_ = -i_3445_; i_3495_ < 0; i_3495_++) {
				int i_3496_ = (this.anIntArray9965[(i_3451_ >> 16) + i_3494_]);
			...
			for (int i_3498_ = -i_3446_; i_3498_ < 0; i_3498_++) {
			    int i_3499_ = ((i_3452_ >> 16) * this.anInt9010);
			    for (int i_3500_ = -i_3445_; i_3500_ < 0; i_3500_++) {
				int i_3501_ = (this.anIntArray9965[(i_3451_ >> 16) + i_3499_]);
			...
			if ((i_3448_ & 0xffffff) == 16777215) {
				...
				int i_3507_ = ((i_3452_ >> 16) * this.anInt9010);
				for (int i_3508_ = -i_3445_; i_3508_ < 0; i_3508_++) {
				    int i_3509_ = (this.anIntArray9965[(i_3451_ >> 16) + i_3507_]);
				...
				int i_3517_ = ((i_3452_ >> 16) * this.anInt9010);
				for (int i_3518_ = -i_3445_; i_3518_ < 0; i_3518_++) {
				    int i_3519_ = (this.anIntArray9965[(i_3451_ >> 16) + i_3517_]);
			...
			for (int i_3530_ = -i_3446_; i_3530_ < 0; i_3530_++) {
			    int i_3531_ = ((i_3452_ >> 16) * this.anInt9010);
			    for (int i_3532_ = -i_3445_; i_3532_ < 0; i_3532_++) {
				int i_3533_ = (this.anIntArray9965[(i_3451_ >> 16) + i_3531_]);
			...
			for (int i_3544_ = -i_3446_; i_3544_ < 0; i_3544_++) {
			    int i_3545_ = ((i_3452_ >> 16) * this.anInt9010);
			    for (int i_3546_ = -i_3445_; i_3546_ < 0; i_3546_++) {
				int i_3547_ = (this.anIntArray9965[(i_3451_ >> 16) + i_3545_]);
			...
			for (int i_3552_ = -i_3446_; i_3552_ < 0; i_3552_++) {
			    int i_3553_ = ((i_3452_ >> 16) * this.anInt9010);
			    for (int i_3554_ = -i_3445_; i_3554_ < 0; i_3554_++) {
				int i_3555_ = (this.anIntArray9965[(i_3451_ >> 16) + i_3553_]);
				if (i_3555_ != 0) {
			...
			for (int i_3563_ = -i_3446_; i_3563_ < 0; i_3563_++) {
			    int i_3564_ = ((i_3452_ >> 16) * this.anInt9010);
			    for (int i_3565_ = -i_3445_; i_3565_ < 0; i_3565_++) {
				int i_3566_ = (this.anIntArray9965[(i_3451_ >> 16) + i_3564_]);
				if (i_3566_ != 0) {
			...
			for (int i_3574_ = -i_3446_; i_3574_ < 0; i_3574_++) {
			    int i_3575_ = ((i_3452_ >> 16) * this.anInt9010);
			    for (int i_3576_ = -i_3445_; i_3576_ < 0; i_3576_++) {
				int i_3577_ = (this.anIntArray9965[(i_3451_ >> 16) + i_3575_]);
			...
			for (int i_3586_ = -i_3446_; i_3586_ < 0; i_3586_++) {
			    int i_3587_ = ((i_3452_ >> 16) * this.anInt9010);
			    for (int i_3588_ = -i_3445_; i_3588_ < 0; i_3588_++) {
				int i_3589_ = (this.anIntArray9965[(i_3451_ >> 16) + i_3587_]);
				if (i_3589_ != 0) {
	...
	if (i_3596_ > 0 && i_3597_ > 0 && (bool || bool_3593_)) {
	    int i_3603_ = 0;
	    int i_3604_ = 0;
	    int i_3605_ = (this.anInt8990 + this.anInt9010 + this.anInt8997);
	    int i_3606_ = (this.anInt9000 + this.anInt8989 + this.anInt8993);
	    int i_3607_ = (i_3605_ << 16) / i_3596_;
	    int i_3608_ = (i_3606_ << 16) / i_3597_;
	    if (this.anInt8990 > 0) {
		int i_3609_ = (((this.anInt8990 << 16) + i_3607_ - 1) / i_3607_);
		i += i_3609_;
		i_3603_ += (i_3609_ * i_3607_ - (this.anInt8990 << 16));
	    }
	    if (this.anInt9000 > 0) {
		int i_3610_ = (((this.anInt9000 << 16) + i_3608_ - 1) / i_3608_);
		i_3595_ += i_3610_;
		i_3604_ += (i_3610_ * i_3608_ - (this.anInt9000 << 16));
	    }
	    if (this.anInt9010 < i_3605_)
		i_3596_ = ((this.anInt9010 << 16) - i_3603_ + i_3607_ - 1) / i_3607_;
	    if (this.anInt8989 < i_3606_)
		i_3597_ = ((this.anInt8989 << 16) - i_3604_ + i_3608_ - 1) / i_3608_;
	    int i_3611_ = i + i_3595_ * (((this.aClass_ra_Sub1_9006).anInt7971) * 692106883);
	    int i_3612_ = (((this.aClass_ra_Sub1_9006).anInt7971 * 692106883) - i_3596_);
	    if (i_3595_ + i_3597_ > (this.aClass_ra_Sub1_9006.anInt7977 * 63686679))
		i_3597_ -= (i_3595_ + i_3597_ - (this.aClass_ra_Sub1_9006.anInt7977) * 63686679);
	    if (i_3595_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_3613_ = (((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_3595_);
		i_3597_ -= i_3613_;
		i_3611_ += i_3613_ * (((this.aClass_ra_Sub1_9006).anInt7971) * 692106883);
		i_3604_ += i_3608_ * i_3613_;
	    }
	    if (i + i_3596_ > (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725) {
		int i_3614_ = (i + i_3596_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725);
		i_3596_ -= i_3614_;
		i_3612_ += i_3614_;
	    }
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_3615_ = (((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
		i_3596_ -= i_3615_;
		i_3611_ += i_3615_;
		...
		if (i_3598_ == 1) {
			...
			int i_3618_ = ((i_3604_ >> 16) * this.anInt9010);
			for (int i_3619_ = -i_3596_; i_3619_ < 0; i_3619_++) {
			    if (!bool_3593_ || f < fs[i_3611_]) {
				if (bool)
				    is[i_3611_] = (this.anIntArray9965[(i_3603_ >> 16) + i_3618_]);
			...
			int i_3625_ = ((i_3604_ >> 16) * this.anInt9010);
			for (int i_3626_ = -i_3596_; i_3626_ < 0; i_3626_++) {
			    if (!bool_3593_ || f < fs[i_3611_]) {
				if (bool) {
				    int i_3627_ = (this.anIntArray9965[(i_3603_ >> 16) + i_3625_]);
			...
			int i_3633_ = ((i_3604_ >> 16) * this.anInt9010);
			for (int i_3634_ = -i_3596_; i_3634_ < 0; i_3634_++) {
			    if (!bool_3593_ || f < fs[i_3611_]) {
				if (bool) {
				    int i_3635_ = (this.anIntArray9965[(i_3603_ >> 16) + i_3633_]);
			...
			int i_3645_ = ((i_3604_ >> 16) * this.anInt9010);
			for (int i_3646_ = -i_3596_; i_3646_ < 0; i_3646_++) {
			    if (!bool_3593_ || f < fs[i_3611_]) {
				if (bool) {
				    int i_3647_ = (this.anIntArray9965[(i_3603_ >> 16) + i_3645_]);
		...
		if (i_3598_ == 1) {
			...
			int i_3650_ = ((i_3604_ >> 16) * this.anInt9010);
			for (int i_3651_ = -i_3596_; i_3651_ < 0; i_3651_++) {
			    if (!bool_3593_ || f < fs[i_3611_]) {
				if (bool) {
				    int i_3652_ = (this.anIntArray9965[(i_3603_ >> 16) + i_3650_]);
			...
			for (int i_3657_ = -i_3597_; i_3657_ < 0; i_3657_++) {
			    int i_3658_ = ((i_3604_ >> 16) * this.anInt9010);
			    for (int i_3659_ = -i_3596_; i_3659_ < 0; i_3659_++) {
				if (!bool_3593_ || f < fs[i_3611_]) {
				    if (bool) {
					int i_3660_ = (this.anIntArray9965[(i_3603_ >> 16) + i_3658_]);
			...
			for (int i_3667_ = -i_3597_; i_3667_ < 0; i_3667_++) {
			    int i_3668_ = ((i_3604_ >> 16) * this.anInt9010);
			    for (int i_3669_ = -i_3596_; i_3669_ < 0; i_3669_++) {
				if (!bool_3593_ || f < fs[i_3611_]) {
				    int i_3670_ = (this.anIntArray9965[(i_3603_ >> 16) + i_3668_]);
			...
			int i_3683_ = ((i_3604_ >> 16) * this.anInt9010);
			for (int i_3684_ = -i_3596_; i_3684_ < 0; i_3684_++) {
			    if (!bool_3593_ || f < fs[i_3611_]) {
				if (bool) {
				    int i_3685_ = (this.anIntArray9965[(i_3603_ >> 16) + i_3683_]);
			...
			int i_3697_ = ((i_3604_ >> 16) * this.anInt9010);
			for (int i_3698_ = -i_3596_; i_3698_ < 0; i_3698_++) {
			    if (!bool_3593_ || f < fs[i_3611_]) {
				if (bool) {
				    int i_3699_ = (this.anIntArray9965[(i_3603_ >> 16) + i_3697_]);
		...
		if (i_3598_ == 1) {
			...
			int i_3705_ = ((i_3604_ >> 16) * this.anInt9010);
			for (int i_3706_ = -i_3596_; i_3706_ < 0; i_3706_++) {
			    if (!bool_3593_ || f < fs[i_3611_]) {
				int i_3707_ = (this.anIntArray9965[(i_3603_ >> 16) + i_3705_]);
				if (i_3707_ != 0) {
				    if (bool) {
			...
			int i_3716_ = ((i_3604_ >> 16) * this.anInt9010);
			for (int i_3717_ = -i_3596_; i_3717_ < 0; i_3717_++) {
			    if (!bool_3593_ || f < fs[i_3611_]) {
				int i_3718_ = (this.anIntArray9965[(i_3603_ >> 16) + i_3716_]);
				if (i_3718_ != 0) {
				    if (bool) {
			...
			int i_3727_ = ((i_3604_ >> 16) * this.anInt9010);
			for (int i_3728_ = -i_3596_; i_3728_ < 0; i_3728_++) {
			    if (!bool_3593_ || f < fs[i_3611_]) {
				if (bool) {
				    int i_3729_ = (this.anIntArray9965[(i_3603_ >> 16) + i_3727_]);
			...
			int i_3739_ = ((i_3604_ >> 16) * this.anInt9010);
			for (int i_3740_ = -i_3596_; i_3740_ < 0; i_3740_++) {
			    if (!bool_3593_ || f < fs[i_3611_]) {
				int i_3741_ = (this.anIntArray9965[(i_3603_ >> 16) + i_3739_]);
				if (i_3741_ != 0) {
				    if (bool) {
	...
	int[] is_3747_ = (this.aClass_ra_Sub1_9006.anIntArray7967);
	if (is_3747_ != null) {
	    if (anInt9004 == 0) {
		if (anInt8991 == 0) {
			...
			if (i_3749_ >= 0) {
			    ...
			    if (i_3751_ >= 0 && i_3752_ >= 0 && (i_3751_ - (this.anInt9010 << 12)) < 0 && (i_3752_ - (this.anInt8989 << 12)) < 0) {
				...
				for (/**/; i_3753_ < 0; i_3753_++) {
				    int i_3757_ = (this.anIntArray9965[(((i_3752_ >> 12) * (this.anInt9010)) + (i_3751_ >> 12))]);
			...
			if (i_3762_ >= 0) {
			    ...
			    if (i_3764_ >= 0 && (i_3764_ - (this.anInt9010 << 12)) < 0) {
				int i_3767_;
				if ((i_3767_ = (i_3765_ - (this.anInt8989 << 12))) >= 0) {
				...
				for (/**/; i_3766_ < 0; i_3766_++) {
				    int i_3771_ = (this.anIntArray9965[(((i_3765_ >> 12) * (this.anInt9010)) + (i_3764_ >> 12))]);
			...
			if (i_3776_ >= 0) {
			    ...
			    if (i_3778_ >= 0 && (i_3778_ - (this.anInt9010 << 12)) < 0) {
				if (i_3779_ < 0) {
				...
				int i_3782_;
				if ((i_3782_ = (1 + i_3779_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_3780_)
				    i_3780_ = i_3782_;
				...
				for (/**/; i_3780_ < 0; i_3780_++) {
				    int i_3786_ = (this.anIntArray9965[(((i_3779_ >> 12) * (this.anInt9010)) + (i_3778_ >> 12))]);
		...
		if (anInt8991 == 0) {
			...
			if (i_3791_ >= 0) {
			    ...
			    if (i_3794_ >= 0 && (i_3794_ - (this.anInt8989 << 12)) < 0) {
				int i_3796_;
				if ((i_3796_ = (i_3793_ - (this.anInt9010 << 12))) >= 0) {
				...
				for (/**/; i_3795_ < 0; i_3795_++) {
				    int i_3800_ = (this.anIntArray9965[(((i_3794_ >> 12) * (this.anInt9010)) + (i_3793_ >> 12))]);
			...
			if (i_3805_ >= 0) {
			    ...
			    int i_3810_;
			    if ((i_3810_ = (i_3807_ - (this.anInt9010 << 12))) >= 0) {
				...
				i_3809_ = i_3810_;
			    if ((i_3810_ = (i_3808_ - (this.anInt8989 << 12))) >= 0) {
				...
				int i_3814_ = (this.anIntArray9965[((i_3808_ >> 12) * this.anInt9010 + (i_3807_ >> 12))]);
			...
			if (i_3819_ >= 0) {
			    ...
			    int i_3824_;
			    if ((i_3824_ = (i_3821_ - (this.anInt9010 << 12))) >= 0) {
			    ...
			    if ((i_3824_ = (1 + i_3822_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_3823_)
				i_3823_ = i_3824_;
				...
				int i_3828_ = (this.anIntArray9965[((i_3822_ >> 12) * this.anInt9010 + (i_3821_ >> 12))]);
		...
		while (i_3832_ < 0) {
			...
			if (i_3836_ >= 0 && i_3836_ - (this.anInt8989 << 12) < 0) {
			    if (i_3835_ < 0) {
			    ...
			    int i_3839_;
			    if ((i_3839_ = (1 + i_3835_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3837_)
				i_3837_ = i_3839_;
				...
				int i_3843_ = (this.anIntArray9965[((i_3836_ >> 12) * this.anInt9010 + (i_3835_ >> 12))]);
		...
		while (i_3847_ < 0) {
			...
			int i_3854_;
			if ((i_3854_ = (1 + i_3850_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3852_)
			    i_3852_ = i_3854_;
			if ((i_3854_ = i_3851_ - (this.anInt8989 << 12)) >= 0) {
			...
			for (/**/; i_3852_ < 0; i_3852_++) {
			    int i_3858_ = (this.anIntArray9965[(((i_3851_ >> 12) * this.anInt9010) + (i_3850_ >> 12))]);
		...
		while (i_3862_ < 0) {
			...
			int i_3869_;
			if ((i_3869_ = (1 + i_3865_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3867_)
			    i_3867_ = i_3869_;
			if (i_3866_ < 0) {
			...
			if ((i_3869_ = (1 + i_3866_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_3867_)
			    i_3867_ = i_3869_;
			...
			for (/**/; i_3867_ < 0; i_3867_++) {
			    int i_3873_ = (this.anIntArray9965[(((i_3866_ >> 12) * this.anInt9010) + (i_3865_ >> 12))]);
	...
	for (int i_3882_ = 0; i_3882_ < i_3879_; i_3882_++) {
		...
		this.anIntArray9965[i_3883_ + i_3885_] = is[i_3884_ + i_3885_] & 0xffffff;
	}
    }
	...
	for (int i_3891_ = 0; i_3891_ < i_3888_; i_3891_++) {
		...
		this.anIntArray9965[i_3892_ + i_3894_] = is[i_3893_ + i_3894_] & 0xffffff;
	}
    }
}
