...
public final class Class218 {
	...
	this.aFloat2461 = class218_10_.aFloat2461;
	this.aFloat2458 = class218_10_.aFloat2458;
	this.aFloat2462 = class218_10_.aFloat2462;
	this.aFloat2463 = class218_10_.aFloat2463;
    }

    public void method2023(float f, float f_11_, float f_12_, float f_13_) {
	float f_14_ = (float) Math.sin(f_13_ * 0.5F);
	float f_15_ = (float) Math.cos(f_13_ * 0.5F);
	...
	method2021(((class218_17_.aFloat2463 * this.aFloat2461) + (class218_17_.aFloat2461 * this.aFloat2463) + (class218_17_.aFloat2458 * this.aFloat2462) - (class218_17_.aFloat2462 * this.aFloat2458)), ((class218_17_.aFloat2463 * this.aFloat2458) - (class218_17_.aFloat2461 * this.aFloat2462) + (class218_17_.aFloat2458 * this.aFloat2463) + (class218_17_.aFloat2462 * this.aFloat2461)), ((class218_17_.aFloat2463 * this.aFloat2462) + (class218_17_.aFloat2461 * this.aFloat2458) - (class218_17_.aFloat2458 * this.aFloat2461) + (class218_17_.aFloat2462 * this.aFloat2463)), ((class218_17_.aFloat2463 * this.aFloat2463) - (class218_17_.aFloat2461 * this.aFloat2461) - (class218_17_.aFloat2458 * this.aFloat2458) - (class218_17_.aFloat2462 * this.aFloat2462)));
    }
