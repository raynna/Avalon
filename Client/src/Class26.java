...
public class Class26 {
	...
	aString352 = ")";
	aString351 = "->";
	aString354 = (Loader.hosted ? Loader.host_IP : "localhost");
	aString350 = "<br>";
	aString356 = "</col>";
    }

    static final void method396(Class403 class403, short i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class403.aClass365_Sub1_Sub1_Sub2_5242.method4363((byte) 51);
	}
    ...
    static final void method399(Class403 class403, int i) {
	try {
	    int i_18_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_18_).aBoolean5731) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
