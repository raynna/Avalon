...
public class Class159 {
	...
	this.aClass_ra_Sub3_1618 = class_ra_sub3;
	aBoolean1621 = this.aClass_ra_Sub3_1618.aBoolean8365;
	if (aBoolean1621 && !this.aClass_ra_Sub3_1618.method5349(Class55.aClass55_565, Class77.aClass77_717))
	    aBoolean1621 = false;
	if (aBoolean1621 || this.aClass_ra_Sub3_1618.method5348(Class55.aClass55_565, Class77.aClass77_717)) {
	    method1706();
	    if (!aBoolean1621) {
		this.anInterface9_Impl2Array1620 = new Interface9_Impl2[16];
		for (int i = 0; i < 16; i++) {
		    byte[] is = Class415.method5586(anObject1622, i * 32768, 32768, (byte) 1);
		    this.anInterface9_Impl2Array1620[i] = (this.aClass_ra_Sub3_1618.method5351(Class55.aClass55_565, 128, 128, true, is));
		}
		anInterface9_Impl2Array1624 = new Interface9_Impl2[16];
		for (int i = 0; i < 16; i++) {
		    byte[] is = Class415.method5586(anObject1628, i * 32768, 32768, (byte) 1);
		    anInterface9_Impl2Array1624[i] = (this.aClass_ra_Sub3_1618.method5351(Class55.aClass55_565, 128, 128, true, is));
		}
	    } else {
		byte[] is = Class338.method4114(anObject1622, false, 1565550558);
		this.anInterface9_Impl3_1623 = (this.aClass_ra_Sub3_1618.method5416(Class55.aClass55_565, 128, 128, 16, true, is));
		is = Class338.method4114(anObject1628, false, -1292209598);
		anInterface9_Impl3_1625 = (this.aClass_ra_Sub3_1618.method5416(Class55.aClass55_565, 128, 128, 16, true, is));
	    }
	}
    }

    public boolean method1704() {
	return (aBoolean1621 ? this.anInterface9_Impl3_1623 != null : this.anInterface9_Impl2Array1620 != null);
    }

    public boolean method1705() {
	if (!this.aClass_ra_Sub3_1618.aBoolean8365)
	    return false;
	if (anInterface9_Impl3_1626 == null) {
		...
		for (int i_4_ = 0; i_4_ < 128; i_4_++) {
			...
			float f = (is[i_6_ + i_8_] & 0xff) - (is[i_7_ + i_8_] & 0xff);
			float f_9_ = (is[i_5_ + (i_8_ - 1 & 0x7f)] & 0xff) - (is[i_5_ + (i_8_ + 1 & 0x7f)] & 0xff);
	    ...
	    anInterface9_Impl3_1626 = (this.aClass_ra_Sub3_1618.method5416(Class55.aClass55_557, 128, 128, 16, true, is_0_));
	}
