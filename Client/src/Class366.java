...
public class Class366 {
	...
	try {
		...
		this.anIntArray3969[i_2_] = i_0_ | ~0x7fffffff;
	...
	try {
	    if (-1 == i_5_)
		this.anIntArray3969[i] = 0;
	    else if (class477.getItemDefinitions(i_5_) != null) {
		this.anIntArray3969[i] = i_5_ | 0x40000000;
	...
	try {
	    ...
	    this.aLong3975 = -1662367026201571203L;
	    this.aLong3975 = (1662367026201571203L * (this.aLong3975 * 5093099708756449067L >>> 8 ^ ls[(int) (((this.aLong3975 * 5093099708756449067L) ^ (this.anInt3976 * 767962207) >> 8) & 0xffL)]));
	    this.aLong3975 = (1662367026201571203L * (5093099708756449067L * this.aLong3975 >>> 8 ^ ls[(int) (((this.aLong3975 * 5093099708756449067L) ^ this.anInt3976 * 767962207) & 0xffL)]));
	    for (int i_7_ = 0; i_7_ < this.anIntArray3969.length; i_7_++) {
		this.aLong3975 = (this.aLong3975 * 5093099708756449067L >>> 8 ^ ls[(int) (((5093099708756449067L * this.aLong3975) ^ (this.anIntArray3969[i_7_]) >> 24) & 0xffL)]) * 1662367026201571203L;
		this.aLong3975 = (1662367026201571203L * ((5093099708756449067L * this.aLong3975 >>> 8) ^ ls[(int) (((this.aLong3975 * 5093099708756449067L) ^ (this.anIntArray3969[i_7_]) >> 16) & 0xffL)]));
		this.aLong3975 = (5093099708756449067L * this.aLong3975 >>> 8 ^ ls[(int) (((5093099708756449067L * this.aLong3975) ^ (this.anIntArray3969[i_7_]) >> 8) & 0xffL)]) * 1662367026201571203L;
		this.aLong3975 = (this.aLong3975 * 5093099708756449067L >>> 8 ^ ls[(int) (((this.aLong3975 * 5093099708756449067L) ^ (this.anIntArray3969[i_7_])) & 0xffL)]) * 1662367026201571203L;
	    }
	    if (this.aClass464Array3971 != null) {
		for (int i_8_ = 0; i_8_ < this.aClass464Array3971.length; i_8_++) {
		    if (this.aClass464Array3971[i_8_] != null) {
			int[] is;
			int[] is_9_;
			if (aBoolean3977) {
			    is = (this.aClass464Array3971[i_8_].anIntArray5695);
			    is_9_ = (this.aClass464Array3971[i_8_].anIntArray5697);
			} else {
			    is = (this.aClass464Array3971[i_8_].anIntArray5694);
			    is_9_ = (this.aClass464Array3971[i_8_].anIntArray5690);
			}
			if (null != is) {
			    for (int i_10_ = 0; i_10_ < is.length; i_10_++) {
				this.aLong3975 = (((this.aLong3975 * 5093099708756449067L) >>> 8 ^ ls[(int) ((((this.aLong3975) * 5093099708756449067L) ^ is[i_10_] >> 8) & 0xffL)]) * 1662367026201571203L);
				this.aLong3975 = (((this.aLong3975 * 5093099708756449067L) >>> 8 ^ ls[(int) ((((this.aLong3975) * 5093099708756449067L) ^ is[i_10_]) & 0xffL)]) * 1662367026201571203L);
			    }
			}
			if (is_9_ != null) {
			    for (int i_11_ = 0; i_11_ < is_9_.length; i_11_++) {
				this.aLong3975 = (1662367026201571203L * ((5093099708756449067L * this.aLong3975) >>> 8 ^ ls[(int) (((5093099708756449067L * (this.aLong3975)) ^ is_9_[i_11_] >> 8) & 0xffL)]));
				this.aLong3975 = (((5093099708756449067L * this.aLong3975) >>> 8 ^ ls[(int) ((((this.aLong3975) * 5093099708756449067L) ^ is_9_[i_11_]) & 0xffL)]) * 1662367026201571203L);
			    }
			}
			if ((this.aClass464Array3971[i_8_].aShortArray5698) != null) {
			    for (int i_12_ = 0; i_12_ < (this.aClass464Array3971[i_8_].aShortArray5698).length; i_12_++) {
				this.aLong3975 = (1662367026201571203L * ((this.aLong3975 * 5093099708756449067L) >>> 8 ^ (ls[(int) (((5093099708756449067L * (this.aLong3975)) ^ (this.aClass464Array3971[i_8_].aShortArray5698[i_12_]) >> 8) & 0xffL)])));
				this.aLong3975 = (1662367026201571203L * ((5093099708756449067L * this.aLong3975) >>> 8 ^ (ls[(int) (((5093099708756449067L * (this.aLong3975)) ^ (this.aClass464Array3971[i_8_].aShortArray5698[i_12_])) & 0xffL)])));
			    }
			}
			if (null != (this.aClass464Array3971[i_8_].aShortArray5699)) {
			    for (int i_13_ = 0; i_13_ < (this.aClass464Array3971[i_8_].aShortArray5699).length; i_13_++) {
				this.aLong3975 = (1662367026201571203L * ((5093099708756449067L * this.aLong3975) >>> 8 ^ (ls[(int) (((5093099708756449067L * (this.aLong3975)) ^ (this.aClass464Array3971[i_8_].aShortArray5699[i_13_]) >> 8) & 0xffL)])));
				this.aLong3975 = (1662367026201571203L * ((5093099708756449067L * this.aLong3975) >>> 8 ^ (ls[(int) (((5093099708756449067L * (this.aLong3975)) ^ (this.aClass464Array3971[i_8_].aShortArray5699[i_13_])) & 0xffL)])));
			    }
			}
		    }
		}
		...
		this.aLong3975 = (1662367026201571203L * ((this.aLong3975 * 5093099708756449067L >>> 8) ^ ls[(int) (((this.aLong3975 * 5093099708756449067L) ^ anIntArray3973[i_14_]) & 0xffL)]));
	    this.aLong3975 = (this.aLong3975 * 5093099708756449067L >>> 8 ^ ls[(int) (((this.aLong3975 * 5093099708756449067L) ^ (aBoolean3977 ? 1 : 0)) & 0xffL)]) * 1662367026201571203L;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		class387 = (Class387) aClass348_3980.method4184(5093099708756449067L * (this.aLong3975));
	    }
		...
		int i_17_ = i_16_;
		boolean bool = false;
		for (int i_18_ = 0; i_18_ < this.anIntArray3969.length; i_18_++) {
		    int i_19_ = this.anIntArray3969[i_18_];
		    Class464 class464 = null;
		    if ((i_19_ & 0x40000000) != 0) {
			if (null != this.aClass464Array3971 && (this.aClass464Array3971[i_18_] != null))
			    class464 = this.aClass464Array3971[i_18_];
		...
		if (bool)
		    return null;
		Model[] class64s = new Model[this.anIntArray3969.length];
		int i_20_ = 0;
		for (int i_21_ = 0; i_21_ < this.anIntArray3969.length; i_21_++) {
		    int i_22_ = this.anIntArray3969[i_21_];
		    Class464 class464 = null;
		    if (0 != (i_22_ & 0x40000000)) {
			if (this.aClass464Array3971 != null && (this.aClass464Array3971[i_21_] != null))
			    class464 = this.aClass464Array3971[i_21_];
	...
	try {
	    ...
	    long l = (long) i_28_ << 32 | i_27_ << 16 | i_26_;
	    Class387 class387;
	    synchronized (aClass348_3980) {
	...
	try {
	    ...
	    int i_38_ = i;
	    long l = this.aLong3975 * 5093099708756449067L;
	    int[] is_39_ = this.anIntArray3969;
	    boolean bool_40_ = false;
	    boolean bool_41_ = false;
	    if (null != class438) {
		Class391 class391 = class438.method5820(28542107);
		if (null != class391 && (609841829 * class391.rightHandEquip >= 0 || 1548903495 * class391.leftHandEquip >= 0)) {
		    is_39_ = new int[this.anIntArray3969.length];
		    for (int i_42_ = 0; i_42_ < is_39_.length; i_42_++)
			is_39_[i_42_] = this.anIntArray3969[i_42_];
		    if (class391.rightHandEquip * 609841829 >= 0 && -1 != -817429509 * class405.anInt5266) {
			bool_40_ = true;
			if (65535 == class391.rightHandEquip * 609841829) {
			    ...
			    is_39_[-817429509 * class405.anInt5266] = 609841829 * class391.rightHandEquip | 0x40000000;
		    ...
		    if (1548903495 * class391.leftHandEquip >= 0 && -1 != class405.anInt5270 * -2126257265) {
			bool_41_ = true;
			if (class391.leftHandEquip * 1548903495 == 65535) {
			    ...
			    is_39_[-2126257265 * class405.anInt5270] = 1548903495 * class391.leftHandEquip | 0x40000000;
			    for (int i_46_ = 0; i_46_ < class405.anIntArray5273.length; i_46_++)
				is_39_[class405.anIntArray5273[i_46_]] = 0;
			    l ^= (is_39_[-2126257265 * class405.anInt5270]);
			}
		    }
		}
	    }
		...
		for (int i_54_ = 0; i_54_ < is_39_.length; i_54_++) {
			...
			if (!bool_56_ && null != this.aClass464Array3971 && (this.aClass464Array3971[i_54_] != null))
			    class464 = this.aClass464Array3971[i_54_];
		...
		if (bool_53_) {
		    if (-1L != (4366628042331861927L * this.aLong3966)) {
			synchronized (aClass348_3979) {
			    class387 = (Class387) (aClass348_3979.method4184(4366628042331861927L * this.aLong3966));
			}
		    }
		    if (null == class387 || class_ra.method5017(class387.m(), i_38_) != 0)
			return null;
			...
			if (0 != (i_60_ & 0x40000000)) {
			    if (!bool_61_ && null != this.aClass464Array3971 && (this.aClass464Array3971[i_59_] != null))
				class464 = (this.aClass464Array3971[i_59_]);
			    Model class64 = (class477.getItemDefinitions(i_60_ & 0x3fffffff).method6028(aBoolean3977, class464, -1675025463));
			    if (null != class64)
	...
	try {
	    ...
	    this.anIntArray3969 = is;
	    this.aClass464Array3971 = class464s;
