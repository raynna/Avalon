...
public class Class100 {
    ...
    static final void method1073(Class403 class403, byte i) {
	try {
	    IComponentDefinition class105 = Class50.getIComponentDefinitions((class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]), (byte) -124);
    ...
    static final void method1074(Class403 class403, int i) {
	try {
	    MapDetails.method3455((class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]), -1482618001);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1075(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (GraphicsToolkit.aClass256_5315.method2441(i_0_, 537859491).anIntArray9598[i_1_]);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1077(Class403 class403, int i) {
	try {
	    if (Class452.aBoolean5642) {
		Class456[] class456s = Class271.method2545((byte) -22);
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = class456s.length;
	    } else
    ...
    static final void method1078(Class403 class403, short i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class229.method2123(1029121048);
	}
	catch (RuntimeException runtimeexception) {
