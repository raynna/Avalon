...
public class Class505 {
	...
	try {
		...
		if (c == 60)
		    ...
		    if (-1 == i_1_) {
			i_3_ += ((this.aByteArray6199[Class124.method1387(c, 1088430238) & 0xff]) & 0xff);
			if (this.aByteArrayArray6198 != null && i_2_ != -1)
			    i_3_ += (this.aByteArrayArray6198[i_2_][c]);
			i_2_ = c;
		    }
		}
	    }
	...
	try {
		...
		if (c == 60)
		    ...
		    if (i_10_ == -1) {
			i_12_ += ((this.aByteArray6199[Class124.method1387(c, 1088430238) & 0xff]) & 0xff);
	...
	class298_sub53.readBytes(this.aByteArray6199, 0, 256, -953523806);
	if (bool) {
		...
		if (i_55_ != 32) {
			...
			if (i_56_ != 32)
			    this.aByteArrayArray6198[i_55_][i_56_] = (byte) Class25.method392(is_47_, is_51_, is_44_, (this.aByteArray6199), is_43_, i_55_, i_56_, -2019008168);
		    }
		}
	    }
    ...
    static final void method6266(Class403 class403, byte i) {
	try {
	    ...
	    int i_83_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    int i_84_ = (class403.anIntArray5244[1 + 681479919 * class403.anInt5239]);
    ...
    static final void method6268(Class403 class403, byte i) {
	try {
	    class403.anInt5241 -= 1938723502;
	    Class23.method377((String) (class403.anObjectArray5240[-203050393 * class403.anInt5241]), (String) (class403.anObjectArray5240[1 + -203050393 * class403.anInt5241]), "", (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) == 1, false, (byte) -37);
	}
	catch (RuntimeException runtimeexception) {
