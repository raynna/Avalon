...
public class Class131 {
	...
	try {
		...
		this.aClass348_1496.method4187();
	    }
	}
	...
	try {
	    Class125 class125;
	    synchronized (this.aClass348_1496) {
		class125 = (Class125) this.aClass348_1496.method4184(i);
	    }
	    if (class125 != null)
		return class125;
	    byte[] is;
	    synchronized (this.aClass243_1497) {
		is = (this.aClass243_1497.getFile(Class120.aClass120_1417.anInt1460 * -1006924897, i));
	    }
	...
	try {
	    synchronized (this.aClass348_1496) {
		this.aClass348_1496.method4189();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	this.aClass243_1497 = class243;
	this.aClass243_1497.method2316((Class120.aClass120_1417.anInt1460) * -1006924897, -1961959383);
    }

    public void method1469(int i, short i_1_) {
	try {
	    synchronized (this.aClass348_1496) {
		this.aClass348_1496.method4186(i, -985699563);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (class105.anInt1154 * -1309843523 != -1) {
			...
			if (class105_2_.aClass105Array1293 == class105_2_.aClass105Array1292) {
			    ...
			    Class425.arrayCopy(class105_2_.aClass105Array1292, 0, class105_2_.aClass105Array1293, 0, (-1309843523 * class105.anInt1154));
			    Class425.arrayCopy(class105_2_.aClass105Array1292, 1 + class105.anInt1154 * -1309843523, class105_2_.aClass105Array1293, -1309843523 * class105.anInt1154, (class105_2_.aClass105Array1292.length - class105.anInt1154 * -1309843523 - 1));
			} else {
			    int i_3_ = 0;
				...
				Class425.arrayCopy(class105s, 1 + i_3_, class105s, i_3_, (class105s.length - i_3_ - 1));
			...
			Class425.arrayCopy(class105s, i_4_ + 1, class105s, i_4_, class105s.length - i_4_ - 1);
    ...
    static final void method1471(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -1567522756;
	    int i_5_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    int i_6_ = (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]);
	    int i_7_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 2]);
	    int i_8_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 3]);
