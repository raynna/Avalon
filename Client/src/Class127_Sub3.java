...
public class Class127_Sub3 extends Class127 {
    ...
    Class127_Sub3(Class243 class243, Class243 class243_5_, Class128_Sub2 class128_sub2) {
	super(class243, class243_5_, class128_sub2);
    }
    ...
    static final void method1432(Class403 class403, int i) {
	try {
		...
		throw new RuntimeException();
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class483.method6127(string, (byte) 88) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1433(Class403 class403, byte i) {
	try {
	    class403.anInt5245 -= -1365138610;
	    if ((class403.aLongArray5251[class403.anInt5245 * 1685767703]) >= (class403.aLongArray5251[1685767703 * class403.anInt5245 + 1]))
