...
public class Class341 {
    ...
    static final void method4137(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = -749038817 * class105.anInt1155;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4138(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1223 * -1993792969;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4139(Class403 class403, int i) {
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = client.aBooleanArray8950[i_4_] ? 1 : 0;
	    else
    ...
    static final void method4140(Class403 class403, int i) {
	try {
	    int i_5_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_5_ >> 14 & 0x3fff;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (!bool && (i_9_ - i_7_ > 1024 || i_9_ - i_7_ < -1024 || i_10_ - i_8_ > 1024 || i_10_ - i_8_ < -1024)) {
		    class365_sub1_sub1_sub2.method4341(i_9_, class217.aFloat2455, i_10_);
			...
			if (i_7_ < i_9_) {
			    class217.aFloat2451 += i_12_;
			    Class431.anInt6504 = 1633205647 * (Class431.anInt6504 * 236175727 | 0x4);
			    if (class217.aFloat2451 > i_9_)
				class217.aFloat2451 = i_9_;
			} else if (i_7_ > i_9_) {
			    class217.aFloat2451 -= i_12_;
			...
			if (i_8_ < i_10_) {
			    class217.aFloat2454 += i_12_;
			    Class431.anInt6504 = 1633205647 * (236175727 * Class431.anInt6504 | 0x1);
			    if (class217.aFloat2454 > i_10_)
				class217.aFloat2454 = i_10_;
			} else if (i_8_ > i_10_) {
			    class217.aFloat2454 -= i_12_;
	...
	try {
	    ...
	    if (client.FPS) {
		int i_25_ = -256;
		if (914379507 * Class291.anInt6467 < 20)
		    i_25_ = -65536;
		Class343.aClass264_3673.method2474(new StringBuilder().append("Fps:").append(914379507 * Class291.anInt6467).toString(), i_23_, i_24_, i_25_, -1, (byte) -7);
		i_24_ += 15;
		...
		i_24_ += 15;
		long l_28_ = client.aClass25_8711.aClass124_340.method1384(1026179047);
		String string = "N/A";
		if (-1L != l_28_) {
		...
		Class343.aClass264_3673.method2474(new StringBuilder().append("Game: In:").append(-1705791507 * client.aClass25_8711.anInt343).append("B/s ").append("Out:").append(client.aClass25_8711.anInt327 * 1114720205).append("B/s ").append("Ping:").append(string).toString(), i_23_, i_24_, -256, -1, (byte) -47);
		i_24_ += 15;
		long l_29_ = client.aClass25_8693.aClass124_340.method1384(529918549);
		...
		Class343.aClass264_3673.method2474(new StringBuilder().append("Lobby: In:").append(client.aClass25_8693.anInt343 * -1705791507).append("B/s ").append("Out:").append(1114720205 * client.aClass25_8693.anInt327).append("B/s ").append("Ping:").append(string_30_).toString(), i_23_, i_24_, -256, -1, (byte) -30);
		i_24_ += 15;
		...
		String string_38_ = new StringBuilder().append("Cache:").append(Class300.method3685(i_37_, 2, true, Class429.aClass429_6624, (short) -6940)).append("% (").append(i_36_).append("%)").toString();
		ScriptEnvironment.aClass264_7534.method2474(string_38_, i_23_, i_24_, -256, -1, (byte) -26);
		i_24_ += 12;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		int i_47_ = 1;
		Class350 class350 = class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub1_7433.method4426(-1185806146);
		int i_48_ = class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub1_7433.aClass438_10077.method5823(1961619021);
		if (-1 == i_48_ || (class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub1_7433.aBoolean10094))
		    i_47_ = 0;
		...
		if (i_47_ != (974385733 * class298_sub41.anInt7439)) {
		    int i_49_ = (Class125.method1398((class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub1_7433), 2092032929));
		    NPCDefinitions class503 = (class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub1_7433.aClass503_10190);
		...
		Class217 class217 = (class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub1_7433.method4337().aClass217_2599);
		class298_sub41.anInt7425 = -7217919 * (int) class217.aFloat2451;
		class298_sub41.anInt7427 = ((int) class217.aFloat2451 + (class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub1_7433.getSize() << 8)) * 305826635;
		class298_sub41.anInt7423 = 584186023 * (int) class217.aFloat2454;
		class298_sub41.anInt7428 = ((int) class217.aFloat2454 + (class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub1_7433.getSize() << 8)) * -1647445571;
		class298_sub41.anInt7424 = ((class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub1_7433.plane) * 2135210127);
		Class461.method5989(class298_sub41, i, i_43_, i_44_, i_45_, -409300106);
	    }
		...
		int i_50_ = 1;
		Class350 class350 = class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub2_7434.method4426(1149258153);
		int i_51_ = class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub2_7434.aClass438_10077.method5823(1924378402);
		if (-1 == i_51_ || (class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub2_7434.aBoolean10094))
		    i_50_ = 0;
		...
		if (i_50_ != (class298_sub41.anInt7439 * 974385733)) {
		    int i_52_ = (Class375.method4652((class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub2_7434), 2117239368));
		    if (i_52_ != (class298_sub41.anInt7443 * 391847895) || (class298_sub41.aBoolean7444 != (class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub2_7434.aBoolean10196))) {
			boolean bool = false;
			if ((class298_sub41.aClass298_Sub19_Sub2_7447) != null) {
			    class298_sub41.anInt7449 -= 584623616;
			    if ((43235291 * class298_sub41.anInt7449) <= 0) {
			    ...
			    bool = true;
			if (bool) {
			    class298_sub41.anInt7449 = (-1138033583 * (class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub2_7434.anInt10215));
			    class298_sub41.aClass298_Sub26_Sub1_7446 = null;
			    class298_sub41.aClass298_Sub23_7445 = null;
			    class298_sub41.anInt7443 = i_52_ * 502744039;
			    class298_sub41.aBoolean7444 = (class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub2_7434.aBoolean10196);
		...
		Class217 class217 = (class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub2_7434.method4337().aClass217_2599);
		class298_sub41.anInt7425 = -7217919 * (int) class217.aFloat2451;
		class298_sub41.anInt7427 = ((int) class217.aFloat2451 + (class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub2_7434.getSize() << 8)) * 305826635;
		class298_sub41.anInt7423 = 584186023 * (int) class217.aFloat2454;
		class298_sub41.anInt7428 = ((int) class217.aFloat2454 + (class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub2_7434.getSize() << 8)) * -1647445571;
		class298_sub41.anInt7424 = ((class298_sub41.aClass365_Sub1_Sub1_Sub2_Sub2_7434.plane) * 2135210127);
		Class461.method5989(class298_sub41, i, i_43_, i_44_, i_45_, -409300106);
	    }
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4145(Class403 class403, int i) {
	try {
	    int i_53_ = (class403.anIntArray5257[1883543357 * class403.anInt5259]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = ((Player) class403.aClass365_Sub1_Sub1_Sub2_5242).aClass70_10223.method798(i_53_, 1440952834);
	}
	catch (RuntimeException runtimeexception) {
