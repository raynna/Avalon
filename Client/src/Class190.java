...
public class Class190 {
	...
	try {
	    if (1 == i)
		this.anInt1922 = class298_sub53.readUnsignedShort() * 631997191;
	    else if (2 == i)
	...
	try {
	    anInt1943 = (-738467127 * (Class220.anIntArray2474[this.anInt1922 * -1184073033 << 3]));
	    long l = anInt1933 * 1776313545;
	    long l_2_ = -739294135 * anInt1934;
	    long l_3_ = anInt1935 * -1849369705;
	    anInt1941 = (int) Math.sqrt(l * l + l_2_ * l_2_ + l_3_ * l_3_) * -1363693449;
		...
		aLong1931 = (-1570158024 * anInt1941 / (anInt1920 * -1595714959) * 8888916578422759065L);
		aLong1931 *= aLong1931 * 6688605316592129449L;
	    } else if (-1660029223 * anInt1936 == 2)
		aLong1931 = (-1570158024 * anInt1941 / (-1595714959 * anInt1920) * 8888916578422759065L);
    ...
    static final void method1856(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = -2093041337 * class105.anInt1156;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1857(Class403 class403, int i) {
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = client.aStringArray8859[i_5_];
		if (null != client.aStringArray8955[i_5_])
		    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = client.aStringArray8955[i_5_];
		else
    ...
    static final void method1858(Class403 class403, int i) {
	try {
	    int i_6_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub4_7563.method5612(i_6_, 1352882135);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1860(Class403 class403, int i) {
	try {
