...
public class Class157 {
	...
	long l = i_0_ << 16 | i;
	Object object = this.aClass348_1616.method4184(l);
	if (object != null)
	    return (Interface9_Impl2) object;
	if (!this.anInterface_ma1614.method170(i, (short) 28916))
	    return null;
	Class53 class53 = this.anInterface_ma1614.method174(i, 828461869);
	if (i_0_ == -1)
    ...
    void method1696() {
	this.aClass348_1616.method4186(5, -1019724952);
    }

    void method1697() {
	this.aClass348_1616.method4187();
    }
