...
public class NPCDefinitions {
	...
	try {
	    ...
	    int i_6_ = i;
	    if (-1282053981 * this.anInt6160 != 128)
		i_6_ |= 0x2;
	    if (128 != -2086573057 * this.anInt6150)
		i_6_ |= 0x5;
	    ...
	    long l = anInt6126 * -407713023 | 580915349 * class_ra.anInt5298 << 16;
	    if (null != class498)
		l |= class498.aLong6110 * -8495627389615588201L << 24;
	    Class387 class387;
	    synchronized (this.aClass507_6125.aClass348_6204) {
		class387 = (Class387) this.aClass507_6125.aClass348_6204.method4184(l);
	    }
		...
		if (null != class387)
		    i_6_ |= class387.m();
		int i_10_ = i_6_;
		if (this.aShortArray6133 != null)
		    i_10_ |= 0x4000;
		if (this.aShortArray6136 != null)
		    i_10_ |= 0x8000;
		if (this.aByte6141 != 0)
		    i_10_ |= 0x80000;
		int[] is_11_ = (null != class498 && class498.anIntArray6108 != null ? class498.anIntArray6108 : anIntArray6129);
		boolean bool_12_ = false;
		synchronized (this.aClass507_6125.aClass243_6208) {
		    for (int i_13_ = 0; i_13_ < is_11_.length; i_13_++) {
			if (is_11_[i_13_] == -1) {
			    if (i_4_ != -679459424)
				throw new IllegalStateException();
			} else if (!this.aClass507_6125.aClass243_6208.method2290(is_11_[i_13_], 0, -1819291215))
			    bool_12_ = true;
		    }
		}
		if (bool_12_)
		...
		for (int i_14_ = 0; i_14_ < is_11_.length; i_14_++) {
			...
			synchronized (this.aClass507_6125.aClass243_6208) {
			    class64s[i_14_] = Model.method751(((this.aClass507_6125).aClass243_6208), is_11_[i_14_], 0);
			}
			if (class64s[i_14_] != null) {
				...
				class64s[i_14_].method753((this.anIntArrayArray6166[i_14_][0]), (this.anIntArrayArray6166[i_14_][1]), (this.anIntArrayArray6166[i_14_][2]));
			}
		    }
		}
		...
		class387 = (class_ra.method5037(class64, i_10_, 299909243 * (this.aClass507_6125).anInt6210, -335572127 * this.anInt6137 + 64, 850 + -1208973327 * this.anInt6156));
		if (null != this.aShortArray6133) {
		    short[] is_22_;
		    if (class498 != null && null != class498.aShortArray6109)
			is_22_ = class498.aShortArray6109;
		    else
			is_22_ = aShortArray6134;
		    for (int i_23_ = 0; i_23_ < this.aShortArray6133.length; i_23_++) {
			if (null != this.aByteArray6135 && i_23_ < this.aByteArray6135.length)
			    class387.X((this.aShortArray6133[i_23_]), aShortArray6182[(this.aByteArray6135[i_23_]) & 0xff]);
			else
			    class387.X((this.aShortArray6133[i_23_]), is_22_[i_23_]);
		    }
		}
		if (null != this.aShortArray6136) {
		    short[] is_24_;
		    if (class498 != null && null != class498.aShortArray6107)
			is_24_ = class498.aShortArray6107;
		    else
			is_24_ = aShortArray6154;
		    for (int i_25_ = 0; i_25_ < this.aShortArray6136.length; i_25_++)
			class387.W(this.aShortArray6136[i_25_], is_24_[i_25_]);
		}
		if (0 != this.aByte6141)
	    ...
	    if (-2086573057 * this.anInt6150 != 128 || 128 != -1282053981 * this.anInt6160)
		class387_26_.oa(this.anInt6150 * -2086573057, this.anInt6160 * -1282053981, this.anInt6150 * -2086573057);
	    class387_26_.KA(i);
	    return class387_26_;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		class387 = (Class387) this.aClass507_6125.aClass348_6211.method4184(l);
	    }
		...
		synchronized (this.aClass507_6125.aClass243_6208) {
			...
			if (!this.aClass507_6125.aClass243_6208.method2290(is[i_36_], 0, -602703169))
			    bool = true;
		    }
		}
		if (bool)
		...
		synchronized (this.aClass507_6125.aClass243_6208) {
			...
			class64s[i_37_] = Model.method751(((this.aClass507_6125).aClass243_6208), is[i_37_], 0);
		}
		for (int i_38_ = 0; i_38_ < is.length; i_38_++) {
		    if (null != class64s[i_38_] && class64s[i_38_].anInt630 < 13)
		...
		if (class64s.length == 1)
		    ...
		    class64 = new Model(class64s, class64s.length);
		class387 = class_ra.method5037(class64, i_35_, ((this.aClass507_6125).anInt6210) * 299909243, 64, 768);
		if (this.aShortArray6133 != null) {
		    short[] is_39_;
		    ...
		    for (int i_40_ = 0; i_40_ < this.aShortArray6133.length; i_40_++) {
			if (null != this.aByteArray6135 && i_40_ < this.aByteArray6135.length)
			    class387.X((this.aShortArray6133[i_40_]), aShortArray6182[(this.aByteArray6135[i_40_]) & 0xff]);
			else
			    class387.X((this.aShortArray6133[i_40_]), is_39_[i_40_]);
		    }
		}
		if (this.aShortArray6136 != null) {
		    short[] is_41_;
		    ...
		    for (int i_42_ = 0; i_42_ < this.aShortArray6136.length; i_42_++)
			class387.W(this.aShortArray6136[i_42_], is_41_[i_42_]);
		}
		if (this.aByte6141 != 0)
		    class387.PA(this.aByte6138, this.aByte6139, this.aByte6157, this.aByte6141 & 0xff);
		class387.KA(i_34_);
	...
	try {
		...
		int i_44_ = is[i_43_];
		if (!this.aClass507_6125.aClass243_6208.method2290(i_44_, 0, -463050298))
		    bool = false;
	    }
	    return bool;
	}
	...
	try {
		...
		return i_45_;
	    Class298_Sub35 class298_sub35 = ((Class298_Sub35) this.aClass437_6159.method5812(i));
	...
	aBoolean6148 = true;
	anInt6149 = -954057527;
	this.anInt6150 = 1732902784;
	this.anInt6160 = 910525824;
	aBoolean6124 = false;
	aBoolean6155 = false;
	aBoolean6173 = false;
	this.anInt6137 = 0;
	...
	try {
	    ...
	    if (aByte6158 == -1) {
		if ((this.aClass507_6125.aClass411_6205) == Class411.game_rs)
		    aByte6158 = (byte) 1;
		else
		    aByte6158 = (byte) 0;
	    }
	...
	try {
		...
		for (int i_61_ = 0; i_61_ < i_60_; i_61_++)
		    this.aByteArray6135[i_61_] = stream.readByte(-12558881);
	    } else if (i == 44) {
		...
		this.anInt6150 = stream.readUnsignedShort() * -1227975681;
	    else if (98 == i)
		this.anInt6160 = stream.readUnsignedShort() * 745310987;
	    else if (i == 99)
		aBoolean6124 = true;
	    else if (i == 100)
		this.anInt6137 = stream.readByte(-12558881) * 2012631201;
	    else if (101 == i)
		this.anInt6156 = stream.readByte(-12558881) * 1653976405;
	    else if (i == 102)
		anInt6185 = stream.readUnsignedShort() * 945207309;
	    else if (103 == i)
		anInt6181 = stream.readUnsignedShort() * -1075872661;
	    else if (i == 106 || 118 == i) {
		this.anInt6171 = stream.readUnsignedShort() * -70774261;
		if (677538211 * this.anInt6171 == 65535)
		    this.anInt6171 = 70774261;
		this.anInt6162 = stream.readUnsignedShort() * -1169422749;
		...
		this.anIntArrayArray6166 = new int[anIntArray6129.length][];
		...
		if (!this.aClass507_6125.aBoolean6209)
		    aStringArray6142[i - 150] = null;
	    } else if (i == 155) {
		this.aByte6138 = stream.readByte(-12558881);
		this.aByte6139 = stream.readByte(-12558881);
		this.aByte6157 = stream.readByte(-12558881);
		this.aByte6141 = stream.readByte(-12558881);
	    } else if (158 == i)
		aByte6158 = (byte) 1;
	    else if (i == 159)
		aByte6158 = (byte) 0;
		...
		if (this.aClass437_6159 == null) {
		    ...
		    this.aClass437_6159 = new HashTable(i_73_);
		}
