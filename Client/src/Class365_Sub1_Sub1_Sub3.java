...
public class Class365_Sub1_Sub1_Sub3 extends Class365_Sub1_Sub1 {
	...
	try {
	    ...
	    if ((null == this.aClass351_10137 || (this.aClass351_10137.aBoolean3772)) && (class85s != null || class68s != null))
		this.aClass351_10137 = Class351.method4232(client.ticketCycle * 443738891, true);
	    if (null != this.aClass351_10137) {
		this.aClass351_10137.method4231(class_ra, 443738891 * client.ticketCycle, class85s, class68s, false);
		this.aClass351_10137.method4227(plane, aShort9798, aShort9796, aShort9795, aShort9797);
	    }
	}
	...
	try {
	    if (this.aClass351_10137 != null)
		this.aClass351_10137.method4221();
	}
	catch (RuntimeException runtimeexception) {
	...
	Class398 class398 = (Class158_Sub1.aClass389_8568.method4857(this.anInt10135 * -743331725, -2103306753));
	int i_11_ = 1505778629 * class398.anInt5205;
	if (i_11_ != -1) {
	    this.aClass438_10136 = new Class438_Sub2(this, false);
	    int i_12_ = class398.aBoolean5215 ? 0 : 2;
	    if (bool)
		i_12_ = 1;
	    this.aClass438_10136.method5824(i_11_, i_0_, i_12_, false, (byte) 0);
	}
	...
	try {
	    return (this.aClass438_10136 != null && !this.aClass438_10136.method5826(-65534));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    return ((this.aClass438_10136 != null && !this.aClass438_10136.method5832(1032843646)) ? class398.method4918(class_ra, i, true, class_xa, class_xa_15_, (int) class217.aFloat2451, (int) class217.aFloat2455, (int) class217.aFloat2454, (this.aClass438_10136), (byte) 2, 345220259) : class398.method4918(class_ra, i, true, class_xa, class_xa_15_, (int) class217.aFloat2451, (int) class217.aFloat2455, (int) class217.aFloat2454, null, (byte) 2, -2126228993));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class387 class387 = method4482(class_ra, 0, (-743331725 * this.anInt10135), -1760774279);
	    if (class387 != null)
	...
	try {
	    if (this.aClass438_10136 != null && !this.aClass438_10136.method5832(-891942946))
		this.aClass438_10136.method5822(i, 2083264997);
	}
	catch (RuntimeException runtimeexception) {
	...
	Class387 class387 = method4482(class_ra, 0x800 | (0 != (this.anInt10139) * -657768375 ? 5 : 0), (-743331725 * this.anInt10135), -1821357765);
	if (null == class387)
	    return null;
	...
	if (null != this.aClass351_10137) {
	    Class69 class69 = this.aClass351_10137.method4229();
	...
	Class387 class387 = method4482(class_ra, 0, (-743331725 * this.anInt10135), -1484520412);
	if (class387 != null)
	...
	Class387 class387 = method4482(class_ra, 0, (-743331725 * this.anInt10135), -1936222136);
	if (class387 != null)
	...
	try {
	    Class387 class387 = method4482(class_ra, 0x800 | (0 != (this.anInt10139) * -657768375 ? 5 : 0), (-743331725 * this.anInt10135), -1982313638);
	    if (null == class387)
		return null;
	    if (-657768375 * this.anInt10139 != 0)
		class387.f(1510098944 * this.anInt10139);
	...
	try {
	    return (null == this.aClass438_10136 || this.aClass438_10136.method5832(1776258671));
	}
	catch (RuntimeException runtimeexception) {
