...
public class Class339 {
	...
	try {
		...
		class352 = (Class352) this.aClass348_3633.method4184(i);
	    }
	    if (null != class352)
		return class352;
	    byte[] is;
	    synchronized (this.aClass243_3634) {
		is = (this.aClass243_3634.getFile(-1006924897 * Class120.aClass120_1441.anInt1460, i));
	    }
	...
	try {
	    synchronized (this.aClass348_3633) {
		this.aClass348_3633.method4186(i, -346772344);
	    }
	    synchronized (this.aClass348_3635) {
		this.aClass348_3635.method4186(i, -549143520);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    synchronized (this.aClass348_3633) {
		this.aClass348_3633.method4187();
	    }
	    synchronized (this.aClass348_3635) {
		this.aClass348_3635.method4187();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass348_3633 = new Class348(i);
	    this.aClass348_3635 = new Class348(i_2_);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    synchronized (this.aClass348_3633) {
		this.aClass348_3633.method4189();
	    }
	    synchronized (this.aClass348_3635) {
		this.aClass348_3635.method4189();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	this.aClass243_3634.method2316((-1006924897 * (Class120.aClass120_1441.anInt1460)), -1187243048);
    }

    static final void method4121(Class403 class403, int i) {
	try {
    ...
    static final void method4122(Class403 class403, byte i) {
	try {
    ...
    static final void method4123(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class165.aClass319_6366.method3883((byte) -67);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4124(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class82_Sub14.anInt6875 * 1196508279 + Class301.anInt3245;
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 1882038855 * Class376.anInt4090 + Class301.anInt3238;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4126(Class403 class403, int i) {
	try {
	    class403.aClass177_5243 = new Class177();
	    class403.aClass177_5243.anInt1787 = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) * -1496580327;
	    class403.aClass177_5243.aClass298_Sub37_Sub14_1788 = Class447.aClass469_5618.method6045((-2034569943 * (class403.aClass177_5243.anInt1787)), (short) -31803);
	    class403.aClass177_5243.anIntArray1789 = new int[class403.aClass177_5243.aClass298_Sub37_Sub14_1788.method3461((short) -407)];
	}
	catch (RuntimeException runtimeexception) {
