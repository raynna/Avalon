...
public class Class487 {
	...
	try {
		...
		class496 = (Class496) this.aClass348_6064.method4184(i);
	    }
	    if (class496 != null)
		return class496;
	    byte[] is;
	    synchronized (this.aClass243_6067) {
		is = (this.aClass243_6067.getFile(Class120.aClass120_1419.anInt1460 * -1006924897, i));
	    }
	    ...
	    synchronized (this.aClass348_6064) {
		this.aClass348_6064.method4194(class496, i);
	    }
	    return class496;
	}
	...
	try {
	    this.aClass348_6064 = new Class348(i);
	    this.aClass348_6065 = new Class348(i_1_);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    synchronized (this.aClass348_6064) {
		this.aClass348_6064.method4187();
	    }
	    synchronized (this.aClass348_6065) {
		this.aClass348_6065.method4187();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    synchronized (this.aClass348_6064) {
		this.aClass348_6064.method4189();
	    }
	    synchronized (this.aClass348_6065) {
		this.aClass348_6065.method4189();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	this.aClass243_6067.method2316((Class120.aClass120_1419.anInt1460) * -1006924897, 1339445894);
	Math.random();
	Math.random();
	Math.random();
	Math.random();
	...
	try {
	    synchronized (this.aClass348_6064) {
		this.aClass348_6064.method4186(i, -2105806073);
	    }
	    synchronized (this.aClass348_6065) {
		this.aClass348_6065.method4186(i, -1191128609);
	    }
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method6164(Class403 class403, int i) {
	try {
	    String string = (String) (class403.anObjectArray5240[(class403.anInt5241 -= 969361751) * -203050393]);
	    if (string != null)
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = string.length();
	    else
	...
	try {
	    ...
	    int i_17_ = -1;
	    int i_18_ = -1;
	    int[] is = Class372.anIntArrayArray4047[i_5_];
	    int i_19_ = i - i_12_;
	    int i_20_ = i + i_12_;
		...
		if (i_14_ >= 0) {
		    ...
		    i_14_ -= i_13_ << 1;
		    if (i_13_ >= i_12_) {
			int[] is_21_ = Class372.anIntArrayArray4047[i_5_ + i_13_];
			int[] is_22_ = Class372.anIntArrayArray4047[i_5_ - i_13_];
			int i_23_ = i + i_11_;
			int i_24_ = i - i_11_;
			Class82_Sub22.method940(is_21_, i_24_, i_23_, i_8_, 1051915434);
			Class82_Sub22.method940(is_22_, i_24_, i_23_, i_8_, 793440117);
		    } else {
			int[] is_25_ = Class372.anIntArrayArray4047[i_5_ + i_13_];
			int[] is_26_ = Class372.anIntArrayArray4047[i_5_ - i_13_];
		...
		int[] is_32_ = Class372.anIntArrayArray4047[i_5_ + i_11_];
		int[] is_33_ = Class372.anIntArrayArray4047[i_5_ - i_11_];
		int i_34_ = i + i_13_;
		int i_35_ = i - i_13_;
		if (i_11_ < i_12_) {
