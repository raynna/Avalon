...
public class Class395 {
	...
	try {
	    ...
	    synchronized (this.aClass348_5191) {
	...
	try {
		...
		this.aClass348_5192.method4187();
	    }
	    synchronized (this.aClass348_5191) {
		this.aClass348_5191.method4187();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    synchronized (this.aClass348_5192) {
		this.aClass348_5192.method4189();
	    }
	    synchronized (this.aClass348_5191) {
		this.aClass348_5191.method4189();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	this.aClass348_5191 = new Class348(100);
	this.aClass243_5189 = class243;
	if (null != this.aClass243_5189) {
	    int i = this.aClass243_5189.method2296(1196471561) - 1;
	    Class120.aClass120_1409.method1306((short) 21776);
	    this.aClass243_5189.method2316(i, -1829120689);
	}
	...
	try {
	    Class391 class391;
	    synchronized (this.aClass348_5192) {
		class391 = (Class391) this.aClass348_5192.method4184(i);
	    }
	    if (null != class391)
		return class391;
	    byte[] is;
	    synchronized (this.aClass243_5189) {
		is = (this.aClass243_5189.getFile(Class120.aClass120_1409.method1307(i, 180156567), Class120.aClass120_1409.method1305(i, -1217474734)));
	    }
	    class391 = new Class391();
	    class391.animationId = i * -523719415;
	    class391.aClass395_4170 = this;
	    if (is != null)
	...
	try {
	    synchronized (this.aClass348_5192) {
		this.aClass348_5192.method4186(i, -208985286);
	    }
	    synchronized (this.aClass348_5191) {
		this.aClass348_5191.method4186(i, -1704294236);
	    }
	}
	catch (RuntimeException runtimeexception) {
