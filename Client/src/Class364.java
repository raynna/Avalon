...
public class Class364 {
	...
	this.aClass217_3948 = new Class217(-50.0F, -60.0F, -50.0F);
	this.aClass348_3953 = new Class348(8);
	this.aClass348_3955 = new Class348(8);
	this.aClass_ra3943 = class_ra;
	this.aClass385ArrayArray3944 = new Class385[i][i_0_];
	...
	this.aClass385_3949 = new Class385();
	this.aClass385_3950 = new Class385();
	this.aClass385_3932 = new Class385();
	this.aClass385_3951 = new Class385();
	...
	try {
	    this.aClass348_3953.method4187();
	    this.aClass348_3955.method4187();
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass_ra3943.IA((0.7F + (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub1_7552.method5625(-712203354) * 0.1F) + client.aClass283_8716.method2633(2016671740)) * this.aClass385_3950.aFloat4130);
	    this.aClass_ra3943.m((-1951302757 * this.aClass385_3950.anInt4133), this.aClass385_3950.aFloat4131, this.aClass385_3950.aFloat4137, (int) this.aClass217_3948.aFloat2451 << 2, (int) this.aClass217_3948.aFloat2455 << 2, (int) this.aClass217_3948.aFloat2454 << 2);
	    this.aClass_ra3943.method5095(this.aClass385_3950.aClass66_4136);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class385 class385 = this.aClass385ArrayArray3944[i][i_5_];
	    if (class385 != null)
		this.aClass217_3948.method2013(class385.aClass217_4129);
	    method4318((byte) -41);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class385 class385 = this.aClass385ArrayArray3944[i][i_7_];
	    if (null == class385)
		class385 = this.aClass385_3949;
	    if (this.aBoolean3954) {
		this.aBoolean3954 = false;
		i_8_ = 0;
	    }
	    if (!this.aClass385_3951.method4708(class385, -759773054)) {
		this.aClass385_3951.method4704(class385, (byte) -51);
		this.aLong3934 = Class122.method1319((byte) 1) * 858881257410153067L;
		this.anInt3945 = ((this.anInt3946 = 1117911945 * i_8_) * -2145126213);
		if (913546523 * this.anInt3945 != 0) {
		    this.aClass385_3932.method4704(this.aClass385_3950, (byte) -80);
		    if ((this.aClass385_3950.aClass277_4140) != null) {
			if (this.aClass385_3950.aClass277_4140.method2586((byte) -18))
			    this.aClass385_3950.aClass277_4140 = this.aClass385_3932.aClass277_4140 = this.aClass385_3950.aClass277_4140.method2587(1076468319);
			if ((null != (this.aClass385_3950.aClass277_4140)) && ((this.aClass385_3951.aClass277_4140) != (this.aClass385_3950.aClass277_4140)))
			    this.aClass385_3950.aClass277_4140.method2584((this.aClass385_3951.aClass277_4140), -583959548);
		    }
		}
	    }
	}
	...
	try {
	    this.aClass_ra3943.method5152(this.aClass385_3950.aFloat4132, this.aClass385_3950.aFloat4139, this.aClass385_3950.aFloat4138, -1795302913);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass_ra3943.IA((0.7F + (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub1_7552.method5625(-1693044274) * 0.1F) + client.aClass283_8716.method2633(1910914073)) * 1.1523438F);
	    this.aClass_ra3943.m(anInt3952 * 332664479, 0.69921875F, 1.2F, -200.0F, -240.0F, -200.0F);
	    this.aClass_ra3943.c(anInt3933 * -1971415573, -1, 0);
	    this.aClass_ra3943.method5095(Class82_Sub12.aClass66_6864);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass385_3950.method4704((class364_12_.aClass385_3950), (byte) 37);
	    this.aClass385_3932.method4704((class364_12_.aClass385_3932), (byte) -76);
	    this.aClass385_3951.method4704((class364_12_.aClass385_3951), (byte) 34);
	    this.aLong3934 = class364_12_.aLong3934 * 1L;
	    this.anInt3945 = 1 * class364_12_.anInt3945;
	    this.anInt3946 = class364_12_.anInt3946 * 1;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    long l = ((i_13_ & 0xffffL) << 48 | (i_14_ & 0xffffL) << 32 | (i_15_ & 0xffffL) << 16 | i & 0xffffL);
	...
	try {
	    long l = (67481L * i ^ i_17_ * 97549L ^ 475427L * i_18_ ^ i_19_ * 986053L ^ i_20_ * 32147369L ^ i_21_ * 76724863L);
	    Class66 class66 = (Class66) this.aClass348_3953.method4184(l);
	    if (null != class66)
		return class66;
	...
	try {
		...
		this.anInt3946 -= ((l - 5777556104771211843L * this.aLong3934) * 1117911945L);
		if (-1051268423 * this.anInt3946 > 0)
		    this.aClass385_3950.method4705(this.aClass_ra3943, this.aClass385_3932, this.aClass385_3951, ((float) (913546523 * this.anInt3945 - this.anInt3946 * -1051268423) / (float) (913546523 * this.anInt3945)), 937279263);
		else {
		    this.aClass385_3950.method4704(this.aClass385_3951, (byte) -42);
		    if ((this.aClass385_3950.aClass277_4140) != null)
			this.aClass385_3950.aClass277_4140.method2585((byte) -128);
		    this.anInt3946 = -1117911945;
		}
		this.aLong3934 = 858881257410153067L * l;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    int i_23_ = 0;
	    int i_24_ = i_23_ + ((this.aClass385_3950.anInt4135) * -1939701499 + 256 << 2);
	    this.aClass_ra3943.c((this.aClass385_3950.anInt4134 * -1269717659), Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub3_7556.method5633(1323547629) == 1 ? i_24_ : -1, 0);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4332(Class403 class403, int i) {
	try {
	    ...
	    int i_25_ = (385051775 * class298_sub36.out.index);
	    class298_sub36.out.writeString(string, 2120587039);
	    class298_sub36.out.writeShort(class403.aClass177_5243.anInt1787 * -2034569943, 16711935);
	    class403.aClass177_5243.aClass298_Sub37_Sub14_1788.method3464(class298_sub36.out, class403.aClass177_5243.anIntArray1789, 535185989);
	    class298_sub36.out.method3649((class298_sub36.out.index * 385051775) - i_25_, (byte) -99);
    ...
    static final void method4333(Class403 class403, int i) {
	try {
    ...
    static final void method4335(Class403 class403, byte i) {
	try {
