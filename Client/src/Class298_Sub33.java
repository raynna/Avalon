...
public class Class298_Sub33 extends Class298 {
    ...
    static final void method3396(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
	    class105.aBoolean1246 = (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) == 1;
	    Tradution.method6054(class105, 1442702884);
	    if (-1309843523 * class105.anInt1154 == -1 && !class119.aBoolean1403)
		Class290.method2750(class105.ihash * -440872681, 475870643);
	}
