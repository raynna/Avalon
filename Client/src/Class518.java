...
public class Class518 {
	...
	this.aClass243_6271 = class243;
	this.aClass243_6271.method2316((-1006924897 * (Class120.aClass120_1427.anInt1460)), 689615038);
    }
	...
	try {
		...
		class298_sub37_sub10 = ((Class298_Sub37_Sub10) this.aClass348_6272.method4184(i));
	    }
	    if (null != class298_sub37_sub10)
		return class298_sub37_sub10;
	    byte[] is;
	    synchronized (this.aClass243_6271) {
		is = (this.aClass243_6271.getFile(-1006924897 * Class120.aClass120_1427.anInt1460, i));
	    }
	...
	try {
		...
		if (Class302.method3716((class298_sub37_sub15.anInt9662 * 946432351), -77764350) && (i == (class298_sub37_sub15.aLong9661) * 2236412381003659263L))
		    return true;
	    }
	    return false;
	}
	...
	try {
		...
		if (-1 != i) {
		    ...
		    IndexedImage class89 = class492.method6181(1479362312);
		    if (class89 != null) {
    ...
    static final void method6315(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
	    class105.anInt1251 = (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) * -1448553585;
