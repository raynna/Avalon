...
public class Class87 {
    ...
    public static Shortcut SHIFT_CLICK = new Shortcut(new int[] {81}), ESC_CLICK = new Shortcut(new int[] {13});

    static final void method968(Class403 class403, int i) {
	try {
    ...
    static final void method969(Class403 class403, int i) {
	try {
	...
	try {
		...
		if (client.method2801(class105).method3495(1299208806) && 0 != (Class298.anInt3192 * -112110875 & 0x20) && (null == class497 || (class105.method1117(Class132.anInt1508 * 831522399, (class497.anInt6100 * -388931549), -659898667) != -388931549 * class497.anInt6100)))
		    Class234.method2174(client.aString8838, new StringBuilder().append(client.aString8754).append(" ").append(Class26.aString351).append(" ").append(class105.aString1228).toString(), Class240.anInt2704 * 697885143, 58, class105.anInt1280 * -1232467723, 0L, class105.anInt1154 * -1309843523, -440872681 * class105.ihash, true, false, class105.anInt1154 * -1309843523 << 32 | class105.ihash * -440872681, false, -1876457786);
	    }
	    for (int i_8_ = 9; i_8_ >= 5; i_8_--) {
		String string = Class380.method4682(class105, i_8_, (byte) 123);
		if (string != null)
		    Class234.method2174(string, class105.aString1228, Class69.method794(class105, i_8_, -1663637577), 1007, class105.anInt1280 * -1232467723, 1 + i_8_, -1309843523 * class105.anInt1154, -440872681 * class105.ihash, true, false, -1309843523 * class105.anInt1154 << 32 | -440872681 * class105.ihash, false, -1971978132);
	    }
	    String string = Class88.method977(class105, -1338609331);
	    if (null != string)
		Class234.method2174(string, class105.aString1228, class105.anInt1232 * 2120029245, 25, -1232467723 * class105.anInt1280, 0L, -1309843523 * class105.anInt1154, class105.ihash * -440872681, true, false, (class105.anInt1154 * -1309843523 << 32) | -440872681 * class105.ihash, false, -1797794884);
	    for (int i_9_ = 4; i_9_ >= 0; i_9_--) {
		String string_10_ = Class380.method4682(class105, i_9_, (byte) 92);
		if (null != string_10_)
		    Class234.method2174(string_10_, class105.aString1228, Class69.method794(class105, i_9_, -1654084952), 57, class105.anInt1280 * -1232467723, 1 + i_9_, -1309843523 * class105.anInt1154, -440872681 * class105.ihash, true, false, class105.anInt1154 * -1309843523 << 32 | class105.ihash * -440872681, false, -1801587230);
	    }
	    //  String data = class105.aString1230 != null ? class105.aString1230 : Tradution.aClass470_5784.method6049(Class321.aClass429_3357, -875414210);
	    if (client.method2801(class105).method3492((byte) -120)) {
		//System.out.println("Client nonblocked simpleclick { " + data + "} :" + ((class105.ihash * -440872681) >> 16) + "," + ((class105.ihash * -440872681) & 0xFFFF) + "," + class105.anInt1154 * -1309843523);
		if (class105.aString1230 != null)
		    Class234.method2174(class105.aString1230, "", -1, 30, -1232467723 * class105.anInt1280, 0L, class105.anInt1154 * -1309843523, -440872681 * class105.ihash, true, false, -1309843523 * class105.anInt1154 << 32 | -440872681 * class105.ihash, false, -1225913379);
		else
		    Class234.method2174(Tradution.aClass470_5784.method6049(Class321.aClass429_3357, -875414210), "", -1, 30, class105.anInt1280 * -1232467723, 0L, -1309843523 * class105.anInt1154, -440872681 * class105.ihash, true, false, -1309843523 * class105.anInt1154 << 32 | -440872681 * class105.ihash, false, -1304653626);
	    } else {
		//System.out.println("Client blocked simpleclick { " + data + "} :" + ((class105.ihash * -440872681) >> 16) + "," + ((class105.ihash * -440872681) & 0xFFFF) + "," + class105.anInt1154 * -1309843523);
	    }
	}
	catch (RuntimeException runtimeexception) {
