...
public class Class86 {
	...
	try {
		...
		string_9_ = "_wip";
	    File file_10_ = new File(Class83.aString765, new StringBuilder().append("Avalon").append(string_7_).append("_preferences").append(string).append(string_9_).append(".dat").toString());
	    do {
