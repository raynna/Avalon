...
public class Class160 {
	...
	try {
	    if ((2334843941678543823L * class162.aLong1663 != -6211723929392173281L * this.aLong1643) || (this.anInt1631 * 2001926135 != -934549233 * class162.nextUpdateNumber))
		throw new RuntimeException("");
	    for (Class298_Sub40 class298_sub40 = (Class298_Sub40) this.aClass453_1632.method5939(1766612795); null != class298_sub40; class298_sub40 = ((Class298_Sub40) this.aClass453_1632.method5944(49146)))
		class298_sub40.method3510(class162, (byte) 1);
	    class162.nextUpdateNumber += 1441392111;
	}
	...
	try {
	    this.aLong1643 = (stream.readLong((short) 21326) * 8254773464748362975L); // has
										      // to
										      // be
										      // 0
										      // else
										      // crash
	    this.anInt1631 = stream.readInt((byte) -33) * 247396807;
		...
		this.aClass453_1632.add(class298_sub40);
	    }
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1709(Class403 class403, int i) {
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = class468.aStringArray5732[i_2_ - 1];
	    else
    ...
    static final void method1710(Class403 class403, int i) {
	try {
    ...
    static final void method1711(Class403 class403, byte i) {
	try {
