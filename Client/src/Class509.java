...
public class Class509 {
	...
	try {
		...
		return NPCDefinitions.method6247(class298_sub53, 1486124265);
    ...
    static final void method6285(Class403 class403, byte i) {
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = class468.aStringArray5723[i_2_ - 1];
	    else
