...
public class Class16 {
	...
	try {
		...
		int i_18_ = i_14_ + i_9_ - (1786832569 * Class261.anInt2825 * i_14_ / Class301.anInt3240) - i_16_;
		int i_19_ = -1996554240;
		if (Class411.game_stellardawn == client.gametype)
		    i_19_ = -1996488705;
		...
		if (Class137_Sub1.anInt6991 * -1983068885 > 0) {
		    ...
		    for (Class298_Sub52 class298_sub52 = (Class298_Sub52) Class301.aClass453_3236.method5939(1766612795); null != class298_sub52; class298_sub52 = (Class298_Sub52) Class301.aClass453_3236.method5944(49146)) {
			Class352 class352 = (Class301.aClass339_3251.method4116(-530122905 * class298_sub52.anInt7608, -1892291274));
			if (!Class422_Sub29.method5728(class352, 1502593597)) {
			    ...
			    int i_21_ = ((i_13_ * (2122110429 * class298_sub52.anInt7607) / Class301.anInt3239) + i);
			    int i_22_ = (i_9_ + ((Class301.anInt3240 - class298_sub52.anInt7610 * -372920341) * i_14_ / Class301.anInt3240));
			    ...
			    int i_23_ = i + (2122110429 * class298_sub52.anInt7607 * i_13_ / Class301.anInt3239);
			    int i_24_ = ((i_14_ * (Class301.anInt3240 - class298_sub52.anInt7610 * -372920341) / Class301.anInt3240) + i_9_);
