...
public class Class47_Sub6 extends Class47 {
	...
	aFloatArray6793[2] = 0.0F;
	aFloatArray6793[3] = ((this.aClass_ra_Sub2_491).anInt8062) * f % 1.0F;
	OpenGL.glTexGenfv(8193, 9474, aFloatArray6793, 0);
	if (!this.aClass45_6789.texture3d) {
	    int i_3_ = (int) (f_1_ * (this.aClass_ra_Sub2_491.anInt8062) * 16.0F);
	    this.aClass_ra_Sub2_491.method5256(this.aClass45_6789.aClass30_Sub2Array483[i_3_ % 16]);
	} else {
	    aFloatArray6793[0] = 0.0F;
	    aFloatArray6793[1] = 0.0F;
	    aFloatArray6793[2] = 0.0F;
	    aFloatArray6793[3] = (this.aClass_ra_Sub2_491.anInt8062 * f_1_ % 1.0F);
	...
	if (this.aClass45_6789.texture3d) {
	    this.aClass_ra_Sub2_491.method5255(1);
	    this.aClass_ra_Sub2_491.method5256(this.aClass45_6789.aClass30_Sub4_484);
	    this.aClass_ra_Sub2_491.method5255(0);
	}
    }
	...
	OpenGL.glTexGenfv(8193, 9474, aFloatArray6793, 0);
	if (!this.aClass45_6789.texture3d) {
	    int i_7_ = (int) (f_5_ * (this.aClass_ra_Sub2_491.anInt8062) * 16.0F);
	    this.aClass_ra_Sub2_491.method5256(this.aClass45_6789.aClass30_Sub2Array483[i_7_ % 16]);
	} else {
	    aFloatArray6793[0] = 0.0F;
	    aFloatArray6793[1] = 0.0F;
	    aFloatArray6793[2] = 0.0F;
	    aFloatArray6793[3] = (this.aClass_ra_Sub2_491.anInt8062 * f_5_ % 1.0F);
	    OpenGL.glTexGenfv(8194, 9473, aFloatArray6793, 0);
	}
	this.aClass_ra_Sub2_491.method5255(0);
    }
	...
	OpenGL.glTexGenfv(8193, 9474, aFloatArray6793, 0);
	if (!this.aClass45_6789.texture3d) {
	    int i_11_ = (int) (f_9_ * (this.aClass_ra_Sub2_491.anInt8062) * 16.0F);
	    this.aClass_ra_Sub2_491.method5256(this.aClass45_6789.aClass30_Sub2Array483[i_11_ % 16]);
	} else {
	    aFloatArray6793[0] = 0.0F;
	    aFloatArray6793[1] = 0.0F;
	    aFloatArray6793[2] = 0.0F;
	    aFloatArray6793[3] = (this.aClass_ra_Sub2_491.anInt8062 * f_9_ % 1.0F);
	    OpenGL.glTexGenfv(8194, 9473, aFloatArray6793, 0);
	}
	this.aClass_ra_Sub2_491.method5255(0);
    }
	...
	OpenGL.glTexGenfv(8193, 9474, aFloatArray6793, 0);
	if (!this.aClass45_6789.texture3d) {
	    int i_15_ = (int) (f_13_ * (this.aClass_ra_Sub2_491.anInt8062) * 16.0F);
	    this.aClass_ra_Sub2_491.method5256(this.aClass45_6789.aClass30_Sub2Array483[i_15_ % 16]);
	} else {
	    aFloatArray6793[0] = 0.0F;
	    aFloatArray6793[1] = 0.0F;
	    aFloatArray6793[2] = 0.0F;
	    aFloatArray6793[3] = (this.aClass_ra_Sub2_491.anInt8062 * f_13_ % 1.0F);
	    OpenGL.glTexGenfv(8194, 9473, aFloatArray6793, 0);
	}
	this.aClass_ra_Sub2_491.method5255(0);
    }
	...
	OpenGL.glTexGenfv(8193, 9474, aFloatArray6793, 0);
	if (!this.aClass45_6789.texture3d) {
	    int i_19_ = (int) (f_17_ * (this.aClass_ra_Sub2_491.anInt8062) * 16.0F);
	    this.aClass_ra_Sub2_491.method5256(this.aClass45_6789.aClass30_Sub2Array483[i_19_ % 16]);
	} else {
	    aFloatArray6793[0] = 0.0F;
	    aFloatArray6793[1] = 0.0F;
	    aFloatArray6793[2] = 0.0F;
	    aFloatArray6793[3] = (this.aClass_ra_Sub2_491.anInt8062 * f_17_ % 1.0F);
	    OpenGL.glTexGenfv(8194, 9473, aFloatArray6793, 0);
	}
	this.aClass_ra_Sub2_491.method5255(0);
    }
	...
	OpenGL.glTexGenfv(8193, 9474, aFloatArray6793, 0);
	if (!this.aClass45_6789.texture3d) {
	    int i_23_ = (int) (f_21_ * (this.aClass_ra_Sub2_491.anInt8062) * 16.0F);
	    this.aClass_ra_Sub2_491.method5256(this.aClass45_6789.aClass30_Sub2Array483[i_23_ % 16]);
	} else {
	    aFloatArray6793[0] = 0.0F;
	    aFloatArray6793[1] = 0.0F;
	    aFloatArray6793[2] = 0.0F;
	    aFloatArray6793[3] = (this.aClass_ra_Sub2_491.anInt8062 * f_21_ % 1.0F);
	    OpenGL.glTexGenfv(8194, 9473, aFloatArray6793, 0);
	}
	this.aClass_ra_Sub2_491.method5255(0);
    }
