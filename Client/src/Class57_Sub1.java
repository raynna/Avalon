...
public abstract class Class57_Sub1 extends Class57 {
	...
	if (method679(f, f_26_, f_27_, f_28_, f_29_, f_30_)) {
	    ...
	    method681(class_ta_sub2.anIntArray8443, class_ta_sub2.anIntArray8442, anInt8998 - i_31_, -i_32_ - (anInt9001 - anInt8994));
	}
    }
	...
	if (i != this.anInt9010 || i_48_ != this.anInt8989) {
	    float f_49_ = (f_44_ - f) / i;
	    float f_50_ = (f_45_ - f_43_) / i;
	    float f_51_ = (f_46_ - f) / i_48_;
	    float f_52_ = (f_47_ - f_43_) / i_48_;
	    float f_53_ = f_51_ * this.anInt9000;
	    float f_54_ = f_52_ * this.anInt9000;
	    float f_55_ = f_49_ * this.anInt8990;
	    float f_56_ = f_50_ * this.anInt8990;
	    float f_57_ = -f_49_ * this.anInt8997;
	    float f_58_ = -f_50_ * this.anInt8997;
	    float f_59_ = -f_51_ * this.anInt8993;
	    float f_60_ = -f_52_ * this.anInt8993;
	    f += f_55_ + f_53_;
	    f_43_ += f_56_ + f_54_;
	    f_44_ += f_57_ + f_53_;
	    f_45_ += f_58_ + f_54_;
	...
	if (f_62_ > f_66_)
	    f_66_ = f_62_;
	if (f_63_ < (this.aClass_ra_Sub1_9006).anInt7974 * -912871679)
	    f_63_ = (this.aClass_ra_Sub1_9006).anInt7974 * -912871679;
	if (f_64_ > (this.aClass_ra_Sub1_9006).anInt7991 * -1416794725)
	    f_64_ = (this.aClass_ra_Sub1_9006).anInt7991 * -1416794725;
	if (f_65_ < (this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)
	    f_65_ = (this.aClass_ra_Sub1_9006).anInt7976 * -1278653805;
	if (f_66_ > (this.aClass_ra_Sub1_9006).anInt7977 * 63686679)
	    f_66_ = (this.aClass_ra_Sub1_9006).anInt7977 * 63686679;
	f_64_ = f_63_ - f_64_;
	if (f_64_ >= 0.0F)
	    return false;
	f_66_ = f_65_ - f_66_;
	if (f_66_ >= 0.0F)
	    return false;
	anInt9020 = (this.aClass_ra_Sub1_9006.anInt7971) * 692106883;
	anInt9003 = (int) ((int) f_65_ * anInt9020 + f_63_);
	float f_67_ = (f_44_ - f) * (f_47_ - f_43_) - (f_45_ - f_43_) * (f_46_ - f);
	float f_68_ = (f_46_ - f) * (f_45_ - f_43_) - (f_47_ - f_43_) * (f_44_ - f);
	anInt9004 = (int) ((f_47_ - f_43_) * 4096.0F * this.anInt9010 / f_67_);
	anInt8991 = (int) ((f_45_ - f_43_) * 4096.0F * this.anInt8989 / f_68_);
	anInt9005 = (int) ((f_46_ - f) * 4096.0F * this.anInt9010 / f_68_);
	anInt9007 = (int) ((f_44_ - f) * 4096.0F * this.anInt8989 / f_67_);
	...
	if (method679(f, f_114_, f_115_, f_116_, f_117_, f_118_)) {
	    Class_ta_Sub2 class_ta_sub2 = (Class_ta_Sub2) class_ta;
	    method681(class_ta_sub2.anIntArray8443, class_ta_sub2.anIntArray8442, anInt8998 - i_119_, -i_120_ - (anInt9001 - anInt8994));
	}
    }
	...
	this.anInt8990 = i;
	this.anInt9000 = i_140_;
	this.anInt8997 = i_141_;
	this.anInt8993 = i_142_;
    }
	...
	this.aClass_ra_Sub1_9006.o((this.aClass_ra_Sub1_9006.anInt7974) * -912871679, (this.aClass_ra_Sub1_9006.anInt7976) * -1278653805, i + i_151_, i_150_ + i_152_);
	...
	this.aClass_ra_Sub1_9006.r(this.anIntArray9017[0], this.anIntArray9017[1], this.anIntArray9017[2], this.anIntArray9017[3]);
    }
	...
	if (this.anIntArray9017 == null)
	    this.anIntArray9017 = new int[4];
	this.aClass_ra_Sub1_9006.qa(this.anIntArray9017);
	this.aClass_ra_Sub1_9006.o((this.aClass_ra_Sub1_9006.anInt7974) * -912871679, (this.aClass_ra_Sub1_9006.anInt7976) * -1278653805, i + i_164_, i_163_ + i_165_);
	...
	if (this.anIntArray9017 == null)
	    this.anIntArray9017 = new int[4];
	this.aClass_ra_Sub1_9006.qa(this.anIntArray9017);
	this.aClass_ra_Sub1_9006.o((this.aClass_ra_Sub1_9006.anInt7974) * -912871679, (this.aClass_ra_Sub1_9006.anInt7976) * -1278653805, i + i_229_, i_228_ + i_230_);
	...
	if (method679(f, f_241_, f_242_, f_243_, f_244_, f_245_)) {
	    Class_ta_Sub2 class_ta_sub2 = (Class_ta_Sub2) class_ta;
	    method681(class_ta_sub2.anIntArray8443, class_ta_sub2.anIntArray8442, anInt8998 - i_246_, -i_247_ - (anInt9001 - anInt8994));
	}
    }
}
