...
public class Class116 {
	...
	try {
	    ...
	    for (Class298_Sub31 class298_sub31 = ((Class298_Sub31) this.aClass437_1392.method5812(l)); null != class298_sub31; class298_sub31 = (Class298_Sub31) this.aClass437_1392.method5813(-1712985598)) {
	...
	try {
		...
		this.aClass437_1392 = new HashTable(i_3_);
		for (int i_4_ = 0; i_4_ < this.aClass298_Sub31Array1390.length; i_4_++) {
			...
			this.aClass437_1392.method5817(class298_sub31_5_, (class298_sub31_5_.hash * 7051297995265073167L));
		}
	    ...
	    this.aClass437_1392.method5817(class298_sub31, this.anInterface4_1391.method47(string, (byte) -48));
	...
	this.aClass437_1392 = new HashTable(i_7_);
    ...
    static final void method1269(Class403 class403, int i) {
	try {
	...
	try {
		...
		for (int i_10_ = 0; i_10_ < class365_sub1_sub1_sub2.anIntArray10092.length; i_10_++) {
			...
			if (i_14_ != 0 || 0 != i_15_)
			    class365_sub1_sub1_sub2.method4417(i_10_, (int) (Math.atan2(i_14_, i_15_) * 2607.5945876176133) & 0x3fff, (byte) 21);
		    }
		}
		if (bool) {
    ...
    static final void method1271(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
	    class403.anInt5239 -= -1567522756;
	    class105.anInt1286 = (class403.anIntArray5244[class403.anInt5239 * 681479919]) * 2145953887;
	    class105.anInt1159 = (1215865909 * (class403.anIntArray5244[1 + 681479919 * class403.anInt5239]));
	    int i_22_ = (class403.anIntArray5244[681479919 * class403.anInt5239 + 2]);
	    if (i_22_ < 0)
		i_22_ = 0;
	    else if (i_22_ > 5)
		i_22_ = 5;
	    int i_23_ = (class403.anIntArray5244[681479919 * class403.anInt5239 + 3]);
	    if (i_23_ < 0)
		i_23_ = 0;
	    else if (i_23_ > 5)
		i_23_ = 5;
		...
		Class288.method2729(class105.ihash * -440872681, 1058352947);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.screenSizePreference, 0, -255450456);
    ...
    static final void method1273(Class403 class403, int i) {
	try {
	    Class390 class390 = (class403.aBoolean5261 ? class403.aClass390_5247 : class403.aClass390_5246);
	    IComponentDefinition class105 = class390.aClass105_4168;
