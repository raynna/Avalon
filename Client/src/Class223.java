...
public class Class223 implements Interface24 {
	...
	try {
	    if (this.aClass243_6664.method2292(380717281))
		return 100;
	    return this.aClass243_6664.method2293((byte) 4);
	}
	...
	try {
	    ...
	    Class320.method3913((class403.anIntArray5244[class403.anInt5239 * 681479919]), (class403.anIntArray5244[1 + class403.anInt5239 * 681479919]), (class403.anIntArray5244[2 + class403.anInt5239 * 681479919]), (class403.anIntArray5244[3 + class403.anInt5239 * 681479919]), false, 256, 1465436328);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (client.ticketCycle * 443738891 >= 591467947 * class302_sub4.anInt7655)
		    class302_sub4.method3714(1699061251);
		else {
		    Class139.method1549((class302_sub4.anInt7653 * 1759796085), 256 + ((class302_sub4.anInt7652 * 1495033107) << 9), 256 + ((-1852462101 * class302_sub4.anInt7656) << 9), 587842750 * class302_sub4.anInt7654, -549885479);
		    Class101.aClass264_1084.method2490(class302_sub4.aString7657, (int) (i + client.aFloatArray8891[0]), (int) (client.aFloatArray8891[1] + i_6_), ~0xffffff | 1160845051 * class302_sub4.anInt7651, 0, 8619684);
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
