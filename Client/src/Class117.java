...
public class Class117 {
    ...
    static final void method1277(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class435.method5804(-1233866115 * client.anInt8752, (byte) -20) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		Class285.method2710(1566028323 * class298_sub49.anInt7589, (byte) 69);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    String string = (null != AccountCreationStage.aString6063 ? AccountCreationStage.aString6063 : ClientScriptMap.method6131((byte) -3));
	...
	try {
	    ...
	    class298_sub36.out.writeInt(i, -1769259974);
	    class298_sub36.out.writeShort128(i_11_);
    ...
    static final void method1281(Class403 class403, short i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 1484045541 * Class301_Sub1.anInt7625;
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class413.anInt6590 * 1464638883;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class372.method4591(class105s, -440872681 * class105.ihash, i_13_, i_14_, bool, (short) 17804);
	    if (null != class105.aClass105Array1293)
		Class372.method4591(class105.aClass105Array1293, -440872681 * class105.ihash, i_13_, i_14_, bool, (short) -9832);
    ...
    static final void method1283(Class403 class403, int i) {
	try {
    ...
    static final void method1284(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_19_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    int i_20_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]);
	...
	try {
		...
		if (0 == class298_sub1.anInt7157 * -431456739)
		    interface3 = ((Interface3) class331.method4031(2108312995 * (class298_sub1.anInt7151), (class298_sub1.anInt7150 * 634196087), (-2146829167 * class298_sub1.anInt7155), 1297068206));
		if (class298_sub1.anInt7157 * -431456739 == 1)
		    interface3 = ((Interface3) class331.method4033(2108312995 * (class298_sub1.anInt7151), (634196087 * class298_sub1.anInt7150), (class298_sub1.anInt7155 * -2146829167), 1080081135));
		if (2 == -431456739 * class298_sub1.anInt7157)
		    interface3 = ((Interface3) (class331.method4035((2108312995 * class298_sub1.anInt7151), class298_sub1.anInt7150 * 634196087, -2146829167 * class298_sub1.anInt7155, client.anInterface17_8960, -2076271452)));
		if (-431456739 * class298_sub1.anInt7157 == 3)
		    interface3 = ((Interface3) class331.method4058(2108312995 * (class298_sub1.anInt7151), (634196087 * class298_sub1.anInt7150), (-2146829167 * class298_sub1.anInt7155), (byte) 16));
		if (interface3 != null) {
		    class298_sub1.anInt7148 = interface3.method32((byte) 29) * 1182121109;
		    class298_sub1.anInt7154 = interface3.method29(726839210) * -723189599;
		    class298_sub1.anInt7161 = interface3.method30((short) 24143) * 1338356755;
		} else {
		    class298_sub1.anInt7148 = -1182121109;
		    class298_sub1.anInt7154 = 0;
		    class298_sub1.anInt7161 = 0;
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
