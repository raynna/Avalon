...
public class Class298_Sub39 extends Class298 {
	...
	try {
		...
		int i_2_ = 0;
		for (Class298_Sub37_Sub15 class298_sub37_sub15 = ((Class298_Sub37_Sub15) class298_sub37_sub5.aClass461_9584.method5984(2119881606)); class298_sub37_sub15 != null; class298_sub37_sub15 = ((Class298_Sub37_Sub15) class298_sub37_sub5.aClass461_9584.method5985(-758930912))) {
		    int i_3_ = Class127_Sub1.method1425(class298_sub37_sub15, class505, 692106883);
		    if (i_3_ > i_2_)
			i_2_ = i_3_;
		}
		i_2_ += 8;
		int i_4_ = (21 + (class298_sub37_sub5.anInt9583 * -628325139 * (-411680299 * Class436.anInt5467)));
		Class389.anInt4166 = ((Class436.aBoolean5496 ? 26 : 22) + (-411680299 * Class436.anInt5467 * ((class298_sub37_sub5.anInt9583) * -628325139))) * 1396848787;
	...
	try {
	    ...
	    i_16_ = 256 + Class_xa.cameraLookViewLocalX * -589460992;
	    i_17_ = 256 + IPAddress.cameraLookViewLocalY * 1647476224;
	    i_18_ = (Class356.method4271(i_16_, i_17_, 1855729883 * Class99.anInt952, -1098953725) - 771695069 * Class18.cameraLookViewZ);
	    ...
	    int i_22_ = (int) Math.sqrt(i_21_ * i_21_ + i_19_ * i_19_);
	    int i_23_ = ((int) (Math.atan2(i_20_, i_22_) * 2607.5945876176133) & 0x3fff);
	    int i_24_ = ((int) (Math.atan2(i_19_, i_21_) * -2607.5945876176133) & 0x3fff);
	    if (i_23_ < 1024)
		i_23_ = 1024;
	    if (i_23_ > 3072)
		i_23_ = 3072;
	    if (client.anInt8756 * -104436553 < i_23_) {
		client.anInt8756 += ((((i_23_ - client.anInt8756 * -104436553 >> 3) * (1179258959 * Class427.cameraLookSpeed2) / 1000) + Class128_Sub1.cameraLookSpeed1 * 298687157) << 3) * -648269561;
		if (client.anInt8756 * -104436553 > i_23_)
		    client.anInt8756 = i_23_ * -648269561;
	    }
	    if (-104436553 * client.anInt8756 > i_23_) {
		client.anInt8756 -= (-648269561 * ((1179258959 * Class427.cameraLookSpeed2 * (client.anInt8756 * -104436553 - i_23_ >> 3) / 1000) + 298687157 * Class128_Sub1.cameraLookSpeed1 << 3));
		if (-104436553 * client.anInt8756 < i_23_)
		    client.anInt8756 = i_23_ * -648269561;
	    }
	    ...
	    i_25_ >>= 3;
	    if (i_25_ > 0) {
		Class135.anInt6384 += ((Class427.cameraLookSpeed2 * 1179258959 * i_25_ / 1000 + Class128_Sub1.cameraLookSpeed1 * 298687157) << 3) * -1587695039;
		Class135.anInt6384 = -1587695039 * (Class135.anInt6384 * -1847894591 & 0x3fff);
	    }
	    if (i_25_ < 0) {
		Class135.anInt6384 -= -1587695039 * ((Class128_Sub1.cameraLookSpeed1 * 298687157 + (-i_25_ * (1179258959 * Class427.cameraLookSpeed2) / 1000)) << 3);
    ...
    static final void method3507(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
