...
public class Class102 {
	...
	try {
	    ...
	    anInt1085 = -1698852737 * client.ticketCycle;
	...
	anInt1085 = client.ticketCycle * -1698852737;
	anInt1087 = i * 392659741;
    ...
    static final void method1083(Class403 class403, byte i) {
	try {
    ...
    static final void method1084(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 1243777389 * Class360.anInt3866;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1085(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
	    class105.anInt1173 = (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) * -1041514725;
