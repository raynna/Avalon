...
public class ConfigDefinitions {
    ...
    static final void method3978(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
	...
	try {
	    ...
	    class298_sub32.anInt7381 = class298_sub53.readUnsignedByte() * -2127296983;
    ...
    static final void method3982(Class403 class403, int i) {
	try {
	    String string = "";
    ...
    static final void method3984(Class403 class403, int i) {
	try {
