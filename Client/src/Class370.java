...
public class Class370 {
	...
	try {
		...
		this.aClass348_4029.method4186(i, -1076736355);
	    }
	}
	...
	try {
	    synchronized (this.aClass348_4029) {
		this.aClass348_4029.method4187();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    synchronized (this.aClass348_4029) {
		this.aClass348_4029.method4189();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class376 class376;
	    synchronized (this.aClass348_4029) {
		class376 = (Class376) this.aClass348_4029.method4184(i);
	    }
	    if (null != class376)
		return class376;
	    byte[] is;
	    synchronized (this.aClass243_4030) {
		is = (this.aClass243_4030.getFile(Class120.aClass120_1414.anInt1460 * -1006924897, i));
	    }
	    class376 = new Class376();
	    if (is != null)
		class376.method4655(new RsByteBuffer(is), 1705012994);
	    synchronized (this.aClass348_4029) {
		this.aClass348_4029.method4194(class376, i);
	    }
	    return class376;
	}
	catch (RuntimeException runtimeexception) {
	...
	if (null != this.aClass243_4030)
	    this.aClass243_4030.method2316(-1006924897 * Class120.aClass120_1414.anInt1460, -279300149);
    }
	...
	try {
		...
		if (i == (2108312995 * class298_sub1_9_.anInt7151) && i_3_ == 634196087 * class298_sub1_9_.anInt7150 && i_4_ == class298_sub1_9_.anInt7155 * -2146829167 && -431456739 * (class298_sub1_9_.anInt7157) == i_5_) {
		...
		class298_sub1.anInt7151 = i * -196260341;
		class298_sub1.anInt7157 = i_5_ * 1088435253;
		class298_sub1.anInt7150 = i_3_ * 656787783;
		class298_sub1.anInt7155 = 284247153 * i_4_;
		Class298_Sub1.aClass453_7162.add(class298_sub1);
	    }
	    class298_sub1.anInt7156 = i_6_ * 240885009;
	    class298_sub1.anInt7153 = i_7_ * 998055383;
	    class298_sub1.aClass435_7158 = class435;
	    class298_sub1.aBoolean7159 = true;
	    class298_sub1.aBoolean7160 = false;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("pj.f(").append(')').toString());
	}
