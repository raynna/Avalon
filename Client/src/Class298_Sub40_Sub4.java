...
public class Class298_Sub40_Sub4 extends Class298_Sub40 {
	...
	try {
	    this.aString9698 = class298_sub53.readString(1228886023);
	...
	class162.clanName = this.aString9698;
    }
	...
	this.aString9698 = class298_sub53.readString(553015411);
	class298_sub53.readInt((byte) 5);
    }

    @Override
    void method3509(RsByteBuffer class298_sub53) {
	this.aString9698 = class298_sub53.readString(-313501431);
