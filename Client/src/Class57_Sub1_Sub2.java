...
public class Class57_Sub1_Sub2 extends Class57_Sub1 {
	...
	if (is != null) {
	    int i_4_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
	    i += this.anInt8990;
	    i_0_ += this.anInt9000;
	    int i_5_ = i_0_ * i_4_ + i;
	    int i_6_ = 0;
	    int i_7_ = this.anInt8989;
	    int i_8_ = this.anInt9010;
	    int i_9_ = i_4_ - i_8_;
	    int i_10_ = 0;
	    if (i_0_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_11_ = ((this.aClass_ra_Sub1_9006.anInt7976) * -1278653805 - i_0_);
		i_7_ -= i_11_;
		i_0_ = ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805);
		i_6_ += i_11_ * i_8_;
		i_5_ += i_11_ * i_4_;
	    }
	    if (i_0_ + i_7_ > (this.aClass_ra_Sub1_9006.anInt7977) * 63686679)
		i_7_ -= (i_0_ + i_7_ - ((this.aClass_ra_Sub1_9006).anInt7977 * 63686679));
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_12_ = ((this.aClass_ra_Sub1_9006.anInt7974) * -912871679 - i);
		i_8_ -= i_12_;
	    ...
	    if (i + i_8_ > ((this.aClass_ra_Sub1_9006).anInt7991 * -1416794725)) {
		int i_13_ = i + i_8_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725;
		i_8_ -= i_13_;
		i_10_ += i_13_;
		i_9_ += i_13_;
	    }
		...
		if (i_3_ == 0) {
			...
			for (int i_14_ = -i_7_; i_14_ < 0; i_14_++) {
			    ...
			    while (i_5_ < i_15_) {
				is[i_5_++] = (this.anIntArray9966[i_6_++]);
				is[i_5_++] = (this.anIntArray9966[i_6_++]);
				is[i_5_++] = (this.anIntArray9966[i_6_++]);
				is[i_5_++] = (this.anIntArray9966[i_6_++]);
			    }
			...
			for (int i_19_ = -i_7_; i_19_ < 0; i_19_++) {
				...
				int i_21_ = (this.anIntArray9966[i_6_++]);
			...
			for (int i_25_ = -i_7_; i_25_ < 0; i_25_++) {
				...
				int i_27_ = (this.anIntArray9966[i_6_++]);
			...
			for (int i_35_ = -i_7_; i_35_ < 0; i_35_++) {
				...
				int i_37_ = (this.anIntArray9966[i_6_++]);
			...
			for (int i_38_ = -i_7_; i_38_ < 0; i_38_++) {
			    ...
			    while (i_5_ < i_39_) {
				int i_40_ = (this.anIntArray9966[i_6_++]);
				if (i_40_ != 0)
				    is[i_5_++] = i_40_;
				else
				    i_5_++;
				i_40_ = (this.anIntArray9966[i_6_++]);
				if (i_40_ != 0)
				    is[i_5_++] = i_40_;
				else
				    i_5_++;
			    ...
			    i_39_ += 3;
			    while (i_5_ < i_39_) {
				int i_41_ = (this.anIntArray9966[i_6_++]);
				if (i_41_ != 0)
				    is[i_5_++] = i_41_;
				else
				    i_5_++;
			...
			if ((i_2_ & 0xffffff) == 16777215) {
				...
				for (int i_45_ = -i_8_; i_45_ < 0; i_45_++) {
				    int i_46_ = (this.anIntArray9966[i_6_++]);
				    if (i_46_ != 0) {
					int i_47_ = is[i_5_];
				...
				for (int i_54_ = -i_8_; i_54_ < 0; i_54_++) {
				    int i_55_ = (this.anIntArray9966[i_6_++]);
				    if (i_55_ != 0) {
					if (i_51_ != 255) {
			...
			for (int i_65_ = -i_7_; i_65_ < 0; i_65_++) {
				...
				int i_67_ = (this.anIntArray9966[i_6_++]);
			...
			for (int i_75_ = -i_7_; i_75_ < 0; i_75_++) {
				...
				int i_77_ = (this.anIntArray9966[i_6_++]);
				if (i_77_ != 0) {
			...
			for (int i_78_ = -i_7_; i_78_ < 0; i_78_++) {
				...
				int i_80_ = (this.anIntArray9966[i_6_++]);
				if (i_80_ != 0) {
				    int i_81_ = is[i_5_];
			...
			for (int i_87_ = -i_7_; i_87_ < 0; i_87_++) {
				...
				int i_89_ = (this.anIntArray9966[i_6_++]);
				if (i_89_ != 0) {
			...
			for (int i_96_ = -i_7_; i_96_ < 0; i_96_++) {
				...
				int i_98_ = (this.anIntArray9966[i_6_++]);
			...
			for (int i_106_ = -i_7_; i_106_ < 0; i_106_++) {
				...
				int i_108_ = (this.anIntArray9966[i_6_++]);
				if (i_108_ != 0) {
	...
	i_112_ -= this.anInt9010;
	int i_115_ = 0;
	for (int i_116_ = 0; i_116_ < i_114_; i_116_++) {
	    for (int i_117_ = 0; i_117_ < i_113_; i_117_++) {
		int i_118_ = is[i++];
		if (i_118_ >>> 24 == 255)
		    this.anIntArray9966[i_115_++] = (i_118_ & 0xffffff) == 0 ? -16777215 : i_118_;
		else
		    this.anIntArray9966[i_115_++] = 0;
	    }
	    i += i_112_;
	}
    }
	...
	if (i_120_ > 0 && i_121_ > 0) {
		...
		int i_126_ = 0;
		int i_127_ = 0;
		int i_128_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
		int i_129_ = (this.anInt8990 + this.anInt9010 + this.anInt8997);
		int i_130_ = (this.anInt9000 + this.anInt8989 + this.anInt8993);
		int i_131_ = (i_129_ << 16) / i_120_;
		int i_132_ = (i_130_ << 16) / i_121_;
		if (this.anInt8990 > 0) {
		    int i_133_ = (((this.anInt8990 << 16) + i_131_ - 1) / i_131_);
		    i += i_133_;
		    i_126_ += (i_133_ * i_131_ - (this.anInt8990 << 16));
		}
		if (this.anInt9000 > 0) {
		    int i_134_ = (((this.anInt9000 << 16) + i_132_ - 1) / i_132_);
		    i_119_ += i_134_;
		    i_127_ += (i_134_ * i_132_ - (this.anInt9000 << 16));
		}
		if (this.anInt9010 < i_129_)
		    i_120_ = ((this.anInt9010 << 16) - i_126_ + i_131_ - 1) / i_131_;
		if (this.anInt8989 < i_130_)
		    i_121_ = ((this.anInt8989 << 16) - i_127_ + i_132_ - 1) / i_132_;
		int i_135_ = i + i_119_ * i_128_;
		int i_136_ = i_128_ - i_120_;
		if (i_119_ + i_121_ > ((this.aClass_ra_Sub1_9006).anInt7977 * 63686679))
		    i_121_ -= (i_119_ + i_121_ - ((this.aClass_ra_Sub1_9006).anInt7977) * 63686679);
		if (i_119_ < (this.aClass_ra_Sub1_9006.anInt7976) * -1278653805) {
		    int i_137_ = (((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_119_);
		    i_121_ -= i_137_;
		    i_135_ += i_137_ * i_128_;
		    i_127_ += i_132_ * i_137_;
		}
		if (i + i_120_ > ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725) {
		    int i_138_ = (i + i_120_ - (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725);
		    i_120_ -= i_138_;
		    i_136_ += i_138_;
		}
		if (i < ((this.aClass_ra_Sub1_9006).anInt7974 * -912871679)) {
		    int i_139_ = (((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
		    i_120_ -= i_139_;
		    i_135_ += i_139_;
		...
		if (i_124_ == 0) {
			...
			for (int i_141_ = -i_121_; i_141_ < 0; i_141_++) {
			    int i_142_ = ((i_127_ >> 16) * this.anInt9010);
			    for (int i_143_ = -i_120_; i_143_ < 0; i_143_++) {
				is[i_135_++] = (this.anIntArray9966[(i_126_ >> 16) + i_142_]);
				i_126_ += i_131_;
			    }
			    i_127_ += i_132_;
			    i_126_ = i_140_;
			...
			for (int i_148_ = -i_121_; i_148_ < 0; i_148_++) {
			    int i_149_ = ((i_127_ >> 16) * this.anInt9010);
			    for (int i_150_ = -i_120_; i_150_ < 0; i_150_++) {
				int i_151_ = (this.anIntArray9966[(i_126_ >> 16) + i_149_]);
			...
			for (int i_156_ = -i_121_; i_156_ < 0; i_156_++) {
			    int i_157_ = ((i_127_ >> 16) * this.anInt9010);
			    for (int i_158_ = -i_120_; i_158_ < 0; i_158_++) {
				int i_159_ = (this.anIntArray9966[(i_126_ >> 16) + i_157_]);
			...
			for (int i_168_ = -i_121_; i_168_ < 0; i_168_++) {
			    int i_169_ = ((i_127_ >> 16) * this.anInt9010);
			    for (int i_170_ = -i_120_; i_170_ < 0; i_170_++) {
				int i_171_ = (this.anIntArray9966[(i_126_ >> 16) + i_169_]);
			...
			for (int i_173_ = -i_121_; i_173_ < 0; i_173_++) {
			    int i_174_ = ((i_127_ >> 16) * this.anInt9010);
			    for (int i_175_ = -i_120_; i_175_ < 0; i_175_++) {
				int i_176_ = (this.anIntArray9966[(i_126_ >> 16) + i_174_]);
				if (i_176_ != 0)
				    is[i_135_++] = i_176_;
				else
				    i_135_++;
			...
			if ((i_123_ & 0xffffff) == 16777215) {
				...
				int i_181_ = ((i_127_ >> 16) * this.anInt9010);
				for (int i_182_ = -i_120_; i_182_ < 0; i_182_++) {
				    int i_183_ = (this.anIntArray9966[(i_126_ >> 16) + i_181_]);
				    if (i_183_ != 0) {
				...
				int i_191_ = ((i_127_ >> 16) * this.anInt9010);
				for (int i_192_ = -i_120_; i_192_ < 0; i_192_++) {
				    int i_193_ = (this.anIntArray9966[(i_126_ >> 16) + i_191_]);
				    if (i_193_ != 0) {
					if (i_188_ != 255) {
			...
			for (int i_204_ = -i_121_; i_204_ < 0; i_204_++) {
			    int i_205_ = ((i_127_ >> 16) * this.anInt9010);
			    for (int i_206_ = -i_120_; i_206_ < 0; i_206_++) {
				int i_207_ = (this.anIntArray9966[(i_126_ >> 16) + i_205_]);
			...
			for (int i_216_ = -i_121_; i_216_ < 0; i_216_++) {
			    int i_217_ = ((i_127_ >> 16) * this.anInt9010);
			    for (int i_218_ = -i_120_; i_218_ < 0; i_218_++) {
				int i_219_ = (this.anIntArray9966[(i_126_ >> 16) + i_217_]);
				if (i_219_ != 0) {
			...
			for (int i_221_ = -i_121_; i_221_ < 0; i_221_++) {
			    int i_222_ = ((i_127_ >> 16) * this.anInt9010);
			    for (int i_223_ = -i_120_; i_223_ < 0; i_223_++) {
				int i_224_ = (this.anIntArray9966[(i_126_ >> 16) + i_222_]);
				if (i_224_ != 0) {
			...
			for (int i_232_ = -i_121_; i_232_ < 0; i_232_++) {
			    int i_233_ = ((i_127_ >> 16) * this.anInt9010);
			    for (int i_234_ = -i_120_; i_234_ < 0; i_234_++) {
				int i_235_ = (this.anIntArray9966[(i_126_ >> 16) + i_233_]);
				if (i_235_ != 0) {
			...
			for (int i_243_ = -i_121_; i_243_ < 0; i_243_++) {
			    int i_244_ = ((i_127_ >> 16) * this.anInt9010);
			    for (int i_245_ = -i_120_; i_245_ < 0; i_245_++) {
				int i_246_ = (this.anIntArray9966[(i_126_ >> 16) + i_244_]);
			...
			for (int i_255_ = -i_121_; i_255_ < 0; i_255_++) {
			    int i_256_ = ((i_127_ >> 16) * this.anInt9010);
			    for (int i_257_ = -i_120_; i_257_ < 0; i_257_++) {
				int i_258_ = (this.anIntArray9966[(i_126_ >> 16) + i_256_]);
				if (i_258_ != 0) {
	...
	for (int i_267_ = 0; i_267_ < i_264_; i_267_++) {
	    int i_268_ = (i_262_ + i_267_) * this.anInt9010 + i;
	    int i_269_ = ((i_266_ + i_267_) * ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883)) + i_265_;
	    for (int i_270_ = 0; i_270_ < i_263_; i_270_++)
		this.anIntArray9966[i_268_ + i_270_] = is[i_269_ + i_270_];
	}
    }
	...
	return new Class24(this.anInt9010, this.anInt8989, this.anIntArray9966);
    }
	...
	if (is != null) {
	    i += this.anInt8990;
	    i_274_ += this.anInt9000;
	    int i_277_ = 0;
	    int i_278_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
	    int i_279_ = this.anInt9010;
	    int i_280_ = this.anInt8989;
	    int i_281_ = i_278_ - i_279_;
	    int i_282_ = 0;
	    int i_283_ = i + i_274_ * i_278_;
	    if (i_274_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_284_ = ((this.aClass_ra_Sub1_9006.anInt7976) * -1278653805 - i_274_);
		i_280_ -= i_284_;
		i_274_ = ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805);
		i_277_ += i_284_ * i_279_;
		i_283_ += i_284_ * i_278_;
	    }
	    if (i_274_ + i_280_ > ((this.aClass_ra_Sub1_9006).anInt7977) * 63686679)
		i_280_ -= (i_274_ + i_280_ - (this.aClass_ra_Sub1_9006.anInt7977) * 63686679);
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_285_ = ((this.aClass_ra_Sub1_9006.anInt7974) * -912871679 - i);
		i_279_ -= i_285_;
		i = (this.aClass_ra_Sub1_9006.anInt7974 * -912871679);
		i_277_ += i_285_;
		i_283_ += i_285_;
	    ...
	    if (i + i_279_ > (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725) {
		int i_286_ = (i + i_279_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725);
		i_279_ -= i_286_;
		i_282_ += i_286_;
		i_281_ += i_286_;
	    }
		...
		int[] is_287_ = class_ta_sub2.anIntArray8443;
		int[] is_288_ = class_ta_sub2.anIntArray8442;
		int i_289_ = i_274_;
		if (i_276_ > i_289_) {
		    i_289_ = i_276_;
		    i_283_ += (i_276_ - i_274_) * i_278_;
		    i_277_ += ((i_276_ - i_274_) * this.anInt9010);
		}
		...
		for (int i_291_ = i_289_; i_291_ < i_290_; i_291_++) {
			...
			int i_299_ = (this.anIntArray9966[i_277_++]);
			if (i_299_ != 0)
			    is[i_283_++] = i_299_;
			else
			    i_283_++;
	...
	if (i_301_ > 0 && i_302_ > 0) {
		...
		int i_307_ = 0;
		int i_308_ = 0;
		int i_309_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
		int i_310_ = (this.anInt8990 + this.anInt9010 + this.anInt8997);
		int i_311_ = (this.anInt9000 + this.anInt8989 + this.anInt8993);
		int i_312_ = (i_310_ << 16) / i_301_;
		int i_313_ = (i_311_ << 16) / i_302_;
		if (this.anInt8990 > 0) {
		    int i_314_ = (((this.anInt8990 << 16) + i_312_ - 1) / i_312_);
		    i += i_314_;
		    i_307_ += (i_314_ * i_312_ - (this.anInt8990 << 16));
		}
		if (this.anInt9000 > 0) {
		    int i_315_ = (((this.anInt9000 << 16) + i_313_ - 1) / i_313_);
		    i_300_ += i_315_;
		    i_308_ += (i_315_ * i_313_ - (this.anInt9000 << 16));
		}
		if (this.anInt9010 < i_310_)
		    i_301_ = ((this.anInt9010 << 16) - i_307_ + i_312_ - 1) / i_312_;
		if (this.anInt8989 < i_311_)
		    i_302_ = ((this.anInt8989 << 16) - i_308_ + i_313_ - 1) / i_313_;
		int i_316_ = i + i_300_ * i_309_;
		int i_317_ = i_309_ - i_301_;
		if (i_300_ + i_302_ > ((this.aClass_ra_Sub1_9006).anInt7977 * 63686679))
		    i_302_ -= (i_300_ + i_302_ - ((this.aClass_ra_Sub1_9006).anInt7977) * 63686679);
		if (i_300_ < (this.aClass_ra_Sub1_9006.anInt7976) * -1278653805) {
		    int i_318_ = (((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_300_);
		    i_302_ -= i_318_;
		    i_316_ += i_318_ * i_309_;
		    i_308_ += i_313_ * i_318_;
		}
		if (i + i_301_ > ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725) {
		    int i_319_ = (i + i_301_ - (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725);
		    i_301_ -= i_319_;
		    i_317_ += i_319_;
		}
		if (i < ((this.aClass_ra_Sub1_9006).anInt7974 * -912871679)) {
		    int i_320_ = (((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
		    i_301_ -= i_320_;
		    i_316_ += i_320_;
		...
		if (i_305_ == 0) {
			...
			for (int i_322_ = -i_302_; i_322_ < 0; i_322_++) {
			    int i_323_ = ((i_308_ >> 16) * this.anInt9010);
			    for (int i_324_ = -i_301_; i_324_ < 0; i_324_++) {
				is[i_316_++] = (this.anIntArray9966[(i_307_ >> 16) + i_323_]);
				i_307_ += i_312_;
			    }
			    i_308_ += i_313_;
			    i_307_ = i_321_;
			...
			for (int i_329_ = -i_302_; i_329_ < 0; i_329_++) {
			    int i_330_ = ((i_308_ >> 16) * this.anInt9010);
			    for (int i_331_ = -i_301_; i_331_ < 0; i_331_++) {
				int i_332_ = (this.anIntArray9966[(i_307_ >> 16) + i_330_]);
			...
			for (int i_337_ = -i_302_; i_337_ < 0; i_337_++) {
			    int i_338_ = ((i_308_ >> 16) * this.anInt9010);
			    for (int i_339_ = -i_301_; i_339_ < 0; i_339_++) {
				int i_340_ = (this.anIntArray9966[(i_307_ >> 16) + i_338_]);
			...
			for (int i_349_ = -i_302_; i_349_ < 0; i_349_++) {
			    int i_350_ = ((i_308_ >> 16) * this.anInt9010);
			    for (int i_351_ = -i_301_; i_351_ < 0; i_351_++) {
				int i_352_ = (this.anIntArray9966[(i_307_ >> 16) + i_350_]);
			...
			for (int i_354_ = -i_302_; i_354_ < 0; i_354_++) {
			    int i_355_ = ((i_308_ >> 16) * this.anInt9010);
			    for (int i_356_ = -i_301_; i_356_ < 0; i_356_++) {
				int i_357_ = (this.anIntArray9966[(i_307_ >> 16) + i_355_]);
				if (i_357_ != 0)
				    is[i_316_++] = i_357_;
				else
				    i_316_++;
			...
			if ((i_304_ & 0xffffff) == 16777215) {
				...
				int i_362_ = ((i_308_ >> 16) * this.anInt9010);
				for (int i_363_ = -i_301_; i_363_ < 0; i_363_++) {
				    int i_364_ = (this.anIntArray9966[(i_307_ >> 16) + i_362_]);
				    if (i_364_ != 0) {
				...
				int i_372_ = ((i_308_ >> 16) * this.anInt9010);
				for (int i_373_ = -i_301_; i_373_ < 0; i_373_++) {
				    int i_374_ = (this.anIntArray9966[(i_307_ >> 16) + i_372_]);
				    if (i_374_ != 0) {
					if (i_369_ != 255) {
			...
			for (int i_385_ = -i_302_; i_385_ < 0; i_385_++) {
			    int i_386_ = ((i_308_ >> 16) * this.anInt9010);
			    for (int i_387_ = -i_301_; i_387_ < 0; i_387_++) {
				int i_388_ = (this.anIntArray9966[(i_307_ >> 16) + i_386_]);
			...
			for (int i_397_ = -i_302_; i_397_ < 0; i_397_++) {
			    int i_398_ = ((i_308_ >> 16) * this.anInt9010);
			    for (int i_399_ = -i_301_; i_399_ < 0; i_399_++) {
				int i_400_ = (this.anIntArray9966[(i_307_ >> 16) + i_398_]);
				if (i_400_ != 0) {
			...
			for (int i_402_ = -i_302_; i_402_ < 0; i_402_++) {
			    int i_403_ = ((i_308_ >> 16) * this.anInt9010);
			    for (int i_404_ = -i_301_; i_404_ < 0; i_404_++) {
				int i_405_ = (this.anIntArray9966[(i_307_ >> 16) + i_403_]);
				if (i_405_ != 0) {
			...
			for (int i_413_ = -i_302_; i_413_ < 0; i_413_++) {
			    int i_414_ = ((i_308_ >> 16) * this.anInt9010);
			    for (int i_415_ = -i_301_; i_415_ < 0; i_415_++) {
				int i_416_ = (this.anIntArray9966[(i_307_ >> 16) + i_414_]);
				if (i_416_ != 0) {
			...
			for (int i_424_ = -i_302_; i_424_ < 0; i_424_++) {
			    int i_425_ = ((i_308_ >> 16) * this.anInt9010);
			    for (int i_426_ = -i_301_; i_426_ < 0; i_426_++) {
				int i_427_ = (this.anIntArray9966[(i_307_ >> 16) + i_425_]);
			...
			for (int i_436_ = -i_302_; i_436_ < 0; i_436_++) {
			    int i_437_ = ((i_308_ >> 16) * this.anInt9010);
			    for (int i_438_ = -i_301_; i_438_ < 0; i_438_++) {
				int i_439_ = (this.anIntArray9966[(i_307_ >> 16) + i_437_]);
				if (i_439_ != 0) {
	...
	if (i_446_ > 0 && i_447_ > 0 && (bool || bool_443_)) {
	    int i_453_ = 0;
	    int i_454_ = 0;
	    int i_455_ = (this.anInt8990 + this.anInt9010 + this.anInt8997);
	    int i_456_ = (this.anInt9000 + this.anInt8989 + this.anInt8993);
	    int i_457_ = (i_455_ << 16) / i_446_;
	    int i_458_ = (i_456_ << 16) / i_447_;
	    if (this.anInt8990 > 0) {
		int i_459_ = (((this.anInt8990 << 16) + i_457_ - 1) / i_457_);
		i += i_459_;
		i_453_ += i_459_ * i_457_ - (this.anInt8990 << 16);
	    }
	    if (this.anInt9000 > 0) {
		int i_460_ = (((this.anInt9000 << 16) + i_458_ - 1) / i_458_);
		i_445_ += i_460_;
		i_454_ += i_460_ * i_458_ - (this.anInt9000 << 16);
	    }
	    if (this.anInt9010 < i_455_)
		i_446_ = ((this.anInt9010 << 16) - i_453_ + i_457_ - 1) / i_457_;
	    if (this.anInt8989 < i_456_)
		i_447_ = ((this.anInt8989 << 16) - i_454_ + i_458_ - 1) / i_458_;
	    int i_461_ = i + i_445_ * (((this.aClass_ra_Sub1_9006).anInt7971) * 692106883);
	    int i_462_ = (((this.aClass_ra_Sub1_9006).anInt7971 * 692106883) - i_446_);
	    if (i_445_ + i_447_ > ((this.aClass_ra_Sub1_9006).anInt7977) * 63686679)
		i_447_ -= (i_445_ + i_447_ - (this.aClass_ra_Sub1_9006.anInt7977) * 63686679);
	    if (i_445_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_463_ = ((this.aClass_ra_Sub1_9006.anInt7976) * -1278653805 - i_445_);
		i_447_ -= i_463_;
		i_461_ += i_463_ * (((this.aClass_ra_Sub1_9006).anInt7971) * 692106883);
		i_454_ += i_458_ * i_463_;
	    }
	    if (i + i_446_ > (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725) {
		int i_464_ = (i + i_446_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725);
		i_446_ -= i_464_;
		i_462_ += i_464_;
	    }
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_465_ = ((this.aClass_ra_Sub1_9006.anInt7974) * -912871679 - i);
		i_446_ -= i_465_;
		i_461_ += i_465_;
		...
		if (i_448_ == 1) {
			...
			int i_468_ = ((i_454_ >> 16) * this.anInt9010);
			for (int i_469_ = -i_446_; i_469_ < 0; i_469_++) {
			    if (!bool_443_ || f < fs[i_461_]) {
				if (bool)
				    is[i_461_] = (this.anIntArray9966[(i_453_ >> 16) + i_468_]);
			...
			int i_475_ = ((i_454_ >> 16) * this.anInt9010);
			for (int i_476_ = -i_446_; i_476_ < 0; i_476_++) {
			    if (!bool_443_ || f < fs[i_461_]) {
				if (bool) {
				    int i_477_ = (this.anIntArray9966[(i_453_ >> 16) + i_475_]);
			...
			int i_483_ = ((i_454_ >> 16) * this.anInt9010);
			for (int i_484_ = -i_446_; i_484_ < 0; i_484_++) {
			    if (!bool_443_ || f < fs[i_461_]) {
				if (bool) {
				    int i_485_ = (this.anIntArray9966[(i_453_ >> 16) + i_483_]);
			...
			int i_495_ = ((i_454_ >> 16) * this.anInt9010);
			for (int i_496_ = -i_446_; i_496_ < 0; i_496_++) {
			    if (!bool_443_ || f < fs[i_461_]) {
				if (bool) {
				    int i_497_ = (this.anIntArray9966[(i_453_ >> 16) + i_495_]);
		...
		if (i_448_ == 1) {
			...
			int i_500_ = ((i_454_ >> 16) * this.anInt9010);
			for (int i_501_ = -i_446_; i_501_ < 0; i_501_++) {
			    if (!bool_443_ || f < fs[i_461_]) {
				int i_502_ = (this.anIntArray9966[(i_453_ >> 16) + i_500_]);
				if (i_502_ != 0) {
				    if (bool)
					is[i_461_] = i_502_;
				    if (bool_443_ && bool_452_)
			...
			for (int i_506_ = -i_447_; i_506_ < 0; i_506_++) {
			    int i_507_ = ((i_454_ >> 16) * this.anInt9010);
			    for (int i_508_ = -i_446_; i_508_ < 0; i_508_++) {
				if (!bool_443_ || f < fs[i_461_]) {
				    int i_509_ = (this.anIntArray9966[(i_453_ >> 16) + i_507_]);
				    if (i_509_ != 0) {
					if (bool) {
			...
			for (int i_516_ = -i_447_; i_516_ < 0; i_516_++) {
			    int i_517_ = ((i_454_ >> 16) * this.anInt9010);
			    for (int i_518_ = -i_446_; i_518_ < 0; i_518_++) {
				if (!bool_443_ || f < fs[i_461_]) {
				    int i_519_ = (this.anIntArray9966[(i_453_ >> 16) + i_517_]);
				    if (i_519_ != 0) {
					if (i_514_ != 255) {
					    if (bool) {
			...
			int i_531_ = ((i_454_ >> 16) * this.anInt9010);
			for (int i_532_ = -i_446_; i_532_ < 0; i_532_++) {
			    if (!bool_443_ || f < fs[i_461_]) {
				if (bool) {
				    int i_533_ = (this.anIntArray9966[(i_453_ >> 16) + i_531_]);
			...
			int i_543_ = ((i_454_ >> 16) * this.anInt9010);
			for (int i_544_ = -i_446_; i_544_ < 0; i_544_++) {
			    if (!bool_443_ || f < fs[i_461_]) {
				int i_545_ = (this.anIntArray9966[(i_453_ >> 16) + i_543_]);
				if (i_545_ != 0) {
				    if (bool) {
		...
		if (i_448_ == 1) {
			...
			int i_548_ = ((i_454_ >> 16) * this.anInt9010);
			for (int i_549_ = -i_446_; i_549_ < 0; i_549_++) {
			    if (!bool_443_ || f < fs[i_461_]) {
				int i_550_ = (this.anIntArray9966[(i_453_ >> 16) + i_548_]);
				if (i_550_ != 0) {
				    if (bool) {
			...
			int i_559_ = ((i_454_ >> 16) * this.anInt9010);
			for (int i_560_ = -i_446_; i_560_ < 0; i_560_++) {
			    if (!bool_443_ || f < fs[i_461_]) {
				int i_561_ = (this.anIntArray9966[(i_453_ >> 16) + i_559_]);
				if (i_561_ != 0) {
				    if (bool) {
			...
			int i_570_ = ((i_454_ >> 16) * this.anInt9010);
			for (int i_571_ = -i_446_; i_571_ < 0; i_571_++) {
			    if (!bool_443_ || f < fs[i_461_]) {
				if (bool) {
				    int i_572_ = (this.anIntArray9966[(i_453_ >> 16) + i_570_]);
			...
			int i_582_ = ((i_454_ >> 16) * this.anInt9010);
			for (int i_583_ = -i_446_; i_583_ < 0; i_583_++) {
			    if (!bool_443_ || f < fs[i_461_]) {
				int i_584_ = (this.anIntArray9966[(i_453_ >> 16) + i_582_]);
				if (i_584_ != 0) {
				    if (bool) {
	...
	if (is != null) {
		...
		if (anInt8991 == 0) {
			...
			if (i_591_ >= 0 && i_592_ >= 0 && i_591_ - (this.anInt9010 << 12) < 0 && i_592_ - (this.anInt8989 << 12) < 0) {
			    for (/**/; i_593_ < 0; i_593_++) {
				int i_594_ = (((i_592_ >> 12) * this.anInt9010) + (i_591_ >> 12));
				int i_595_ = i_590_++;
				if (i_588_ == 0) {
				    if (i == 1)
					is[i_595_] = (this.anIntArray9966[i_594_]);
				    else if (i == 0) {
					int i_596_ = (this.anIntArray9966[i_594_++]);
					...
					int i_600_ = (this.anIntArray9966[i_594_++]);
					...
					int i_605_ = (this.anIntArray9966[i_594_]);
				    ...
				    if (i == 1) {
					int i_608_ = (this.anIntArray9966[i_594_]);
					if (i_608_ != 0)
					    is[i_595_] = i_608_;
				    } else if (i == 0) {
					int i_609_ = (this.anIntArray9966[i_594_]);
					if (i_609_ != 0) {
					...
					int i_620_ = (this.anIntArray9966[i_594_]);
					...
					int i_625_ = (this.anIntArray9966[i_594_]);
					if (i_625_ != 0) {
				    ...
				    if (i == 1) {
					int i_628_ = (this.anIntArray9966[i_594_]);
					if (i_628_ != 0) {
					...
					int i_632_ = (this.anIntArray9966[i_594_]);
					if (i_632_ != 0) {
					...
					int i_639_ = (this.anIntArray9966[i_594_]);
					...
					int i_644_ = (this.anIntArray9966[i_594_]);
					if (i_644_ != 0) {
			...
			if (i_652_ >= 0 && i_652_ - (this.anInt9010 << 12) < 0) {
			    int i_655_;
			    if ((i_655_ = i_653_ - ((this.anInt8989) << 12)) >= 0) {
				...
				i_654_ = i_655_;
			    for (/**/; i_654_ < 0; i_654_++) {
				int i_656_ = (((i_653_ >> 12) * this.anInt9010) + (i_652_ >> 12));
				int i_657_ = i_651_++;
				if (i_588_ == 0) {
				    if (i == 1)
					is[i_657_] = (this.anIntArray9966[i_656_]);
				    else if (i == 0) {
					int i_658_ = (this.anIntArray9966[i_656_++]);
					...
					int i_662_ = (this.anIntArray9966[i_656_++]);
					...
					int i_667_ = (this.anIntArray9966[i_656_]);
				    ...
				    if (i == 1) {
					int i_670_ = (this.anIntArray9966[i_656_]);
					if (i_670_ != 0)
					    is[i_657_] = i_670_;
				    } else if (i == 0) {
					int i_671_ = (this.anIntArray9966[i_656_]);
					if (i_671_ != 0) {
					    if ((anInt9014 & 0xffffff) == 16777215) {
					...
					int i_682_ = (this.anIntArray9966[i_656_]);
					...
					int i_687_ = (this.anIntArray9966[i_656_]);
					if (i_687_ != 0) {
				    ...
				    if (i == 1) {
					int i_690_ = (this.anIntArray9966[i_656_]);
					if (i_690_ != 0) {
					...
					int i_694_ = (this.anIntArray9966[i_656_]);
					if (i_694_ != 0) {
					...
					int i_701_ = (this.anIntArray9966[i_656_]);
					...
					int i_706_ = (this.anIntArray9966[i_656_]);
					if (i_706_ != 0) {
			...
			if (i_714_ >= 0 && i_714_ - (this.anInt9010 << 12) < 0) {
			    if (i_715_ < 0) {
			    ...
			    int i_718_;
			    if ((i_718_ = (1 + i_715_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_716_)
				i_716_ = i_718_;
			    for (/**/; i_716_ < 0; i_716_++) {
				int i_719_ = (((i_715_ >> 12) * this.anInt9010) + (i_714_ >> 12));
				int i_720_ = i_713_++;
				if (i_588_ == 0) {
				    if (i == 1)
					is[i_720_] = (this.anIntArray9966[i_719_]);
				    else if (i == 0) {
					int i_721_ = (this.anIntArray9966[i_719_++]);
					...
					int i_725_ = (this.anIntArray9966[i_719_++]);
					...
					int i_730_ = (this.anIntArray9966[i_719_]);
				    ...
				    if (i == 1) {
					int i_733_ = (this.anIntArray9966[i_719_]);
					if (i_733_ != 0)
					    is[i_720_] = i_733_;
				    } else if (i == 0) {
					int i_734_ = (this.anIntArray9966[i_719_]);
					if (i_734_ != 0) {
					    if ((anInt9014 & 0xffffff) == 16777215) {
					...
					int i_745_ = (this.anIntArray9966[i_719_]);
					...
					int i_750_ = (this.anIntArray9966[i_719_]);
					if (i_750_ != 0) {
				    ...
				    if (i == 1) {
					int i_753_ = (this.anIntArray9966[i_719_]);
					if (i_753_ != 0) {
					...
					int i_757_ = (this.anIntArray9966[i_719_]);
					if (i_757_ != 0) {
					...
					int i_764_ = (this.anIntArray9966[i_719_]);
					...
					int i_769_ = (this.anIntArray9966[i_719_]);
					if (i_769_ != 0) {
		...
		if (anInt8991 == 0) {
			...
			if (i_778_ >= 0 && i_778_ - (this.anInt8989 << 12) < 0) {
			    int i_780_;
			    if ((i_780_ = i_777_ - ((this.anInt9010) << 12)) >= 0) {
				...
				i_779_ = i_780_;
			    for (/**/; i_779_ < 0; i_779_++) {
				int i_781_ = (((i_778_ >> 12) * this.anInt9010) + (i_777_ >> 12));
				int i_782_ = i_776_++;
				if (i_588_ == 0) {
				    if (i == 1)
					is[i_782_] = (this.anIntArray9966[i_781_]);
				    else if (i == 0) {
					int i_783_ = (this.anIntArray9966[i_781_++]);
					...
					int i_787_ = (this.anIntArray9966[i_781_++]);
					...
					int i_792_ = (this.anIntArray9966[i_781_]);
				    ...
				    if (i == 1) {
					int i_795_ = (this.anIntArray9966[i_781_]);
					if (i_795_ != 0)
					    is[i_782_] = i_795_;
				    } else if (i == 0) {
					int i_796_ = (this.anIntArray9966[i_781_]);
					if (i_796_ != 0) {
					    if ((anInt9014 & 0xffffff) == 16777215) {
					...
					int i_807_ = (this.anIntArray9966[i_781_]);
					...
					int i_812_ = (this.anIntArray9966[i_781_]);
					if (i_812_ != 0) {
				    ...
				    if (i == 1) {
					int i_815_ = (this.anIntArray9966[i_781_]);
					if (i_815_ != 0) {
					...
					int i_819_ = (this.anIntArray9966[i_781_]);
					if (i_819_ != 0) {
					...
					int i_826_ = (this.anIntArray9966[i_781_]);
					...
					int i_831_ = (this.anIntArray9966[i_781_]);
					if (i_831_ != 0) {
			...
			int i_842_;
			if ((i_842_ = i_839_ - (this.anInt9010 << 12)) >= 0) {
			...
			if ((i_842_ = (i_839_ - anInt9004) / anInt9004) > i_841_)
			    i_841_ = i_842_;
			if ((i_842_ = i_840_ - (this.anInt8989 << 12)) >= 0) {
			...
			if ((i_842_ = (i_840_ - anInt8991) / anInt8991) > i_841_)
			    i_841_ = i_842_;
			for (/**/; i_841_ < 0; i_841_++) {
			    int i_843_ = (((i_840_ >> 12) * this.anInt9010) + (i_839_ >> 12));
			    int i_844_ = i_838_++;
			    if (i_588_ == 0) {
				if (i == 1)
				    is[i_844_] = (this.anIntArray9966[i_843_]);
				else if (i == 0) {
				    int i_845_ = (this.anIntArray9966[i_843_++]);
				    ...
				    int i_849_ = (this.anIntArray9966[i_843_++]);
				    ...
				    int i_854_ = (this.anIntArray9966[i_843_]);
				...
				if (i == 1) {
				    int i_857_ = (this.anIntArray9966[i_843_]);
				    if (i_857_ != 0)
					is[i_844_] = i_857_;
				} else if (i == 0) {
				    int i_858_ = (this.anIntArray9966[i_843_]);
				    if (i_858_ != 0) {
					if ((anInt9014 & 0xffffff) == 16777215) {
				    ...
				    int i_869_ = (this.anIntArray9966[i_843_]);
				    ...
				    int i_874_ = (this.anIntArray9966[i_843_]);
				    if (i_874_ != 0) {
				...
				if (i == 1) {
				    int i_877_ = (this.anIntArray9966[i_843_]);
				    if (i_877_ != 0) {
				    ...
				    int i_881_ = (this.anIntArray9966[i_843_]);
				    if (i_881_ != 0) {
				    ...
				    int i_888_ = (this.anIntArray9966[i_843_]);
				    ...
				    int i_893_ = (this.anIntArray9966[i_843_]);
				    if (i_893_ != 0) {
			...
			int i_904_;
			if ((i_904_ = i_901_ - (this.anInt9010 << 12)) >= 0) {
			...
			if ((i_904_ = (1 + i_902_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_903_)
			    i_903_ = i_904_;
			for (/**/; i_903_ < 0; i_903_++) {
			    int i_905_ = (((i_902_ >> 12) * this.anInt9010) + (i_901_ >> 12));
			    int i_906_ = i_900_++;
			    if (i_588_ == 0) {
				if (i == 1)
				    is[i_906_] = (this.anIntArray9966[i_905_]);
				else if (i == 0) {
				    int i_907_ = (this.anIntArray9966[i_905_++]);
				    ...
				    int i_911_ = (this.anIntArray9966[i_905_++]);
				    ...
				    int i_916_ = (this.anIntArray9966[i_905_]);
				...
				if (i == 1) {
				    int i_919_ = (this.anIntArray9966[i_905_]);
				    if (i_919_ != 0)
					is[i_906_] = i_919_;
				} else if (i == 0) {
				    int i_920_ = (this.anIntArray9966[i_905_]);
				    if (i_920_ != 0) {
					if ((anInt9014 & 0xffffff) == 16777215) {
				    ...
				    int i_931_ = (this.anIntArray9966[i_905_]);
				    ...
				    int i_936_ = (this.anIntArray9966[i_905_]);
				    if (i_936_ != 0) {
				...
				if (i == 1) {
				    int i_939_ = (this.anIntArray9966[i_905_]);
				    if (i_939_ != 0) {
				    ...
				    int i_943_ = (this.anIntArray9966[i_905_]);
				    if (i_943_ != 0) {
				    ...
				    int i_950_ = (this.anIntArray9966[i_905_]);
				    ...
				    int i_955_ = (this.anIntArray9966[i_905_]);
				    if (i_955_ != 0) {
		...
		while (i_961_ < 0) {
		    ...
		    if (i_964_ >= 0 && i_964_ - (this.anInt8989 << 12) < 0) {
			if (i_963_ < 0) {
			...
			int i_967_;
			if ((i_967_ = (1 + i_963_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_965_)
			    i_965_ = i_967_;
			for (/**/; i_965_ < 0; i_965_++) {
			    int i_968_ = (((i_964_ >> 12) * this.anInt9010) + (i_963_ >> 12));
			    int i_969_ = i_962_++;
			    if (i_588_ == 0) {
				if (i == 1)
				    is[i_969_] = (this.anIntArray9966[i_968_]);
				else if (i == 0) {
				    int i_970_ = (this.anIntArray9966[i_968_++]);
				    ...
				    int i_974_ = (this.anIntArray9966[i_968_++]);
				    ...
				    int i_979_ = (this.anIntArray9966[i_968_]);
				...
				if (i == 1) {
				    int i_982_ = (this.anIntArray9966[i_968_]);
				    if (i_982_ != 0)
					is[i_969_] = i_982_;
				} else if (i == 0) {
				    int i_983_ = (this.anIntArray9966[i_968_]);
				    if (i_983_ != 0) {
					if ((anInt9014 & 0xffffff) == 16777215) {
				    ...
				    int i_994_ = (this.anIntArray9966[i_968_]);
				    ...
				    int i_999_ = (this.anIntArray9966[i_968_]);
				    if (i_999_ != 0) {
				...
				if (i == 1) {
				    int i_1002_ = (this.anIntArray9966[i_968_]);
				    if (i_1002_ != 0) {
				    ...
				    int i_1006_ = (this.anIntArray9966[i_968_]);
				    if (i_1006_ != 0) {
				    ...
				    int i_1013_ = (this.anIntArray9966[i_968_]);
				    ...
				    int i_1018_ = (this.anIntArray9966[i_968_]);
				    if (i_1018_ != 0) {
		...
		for (int i_1024_ = anInt9001; i_1024_ < 0; i_1024_++) {
		    ...
		    int i_1030_;
		    if ((i_1030_ = (1 + i_1026_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_1028_)
			i_1028_ = i_1030_;
		    if ((i_1030_ = i_1027_ - (this.anInt8989 << 12)) >= 0) {
			...
			int i_1031_ = (((i_1027_ >> 12) * this.anInt9010) + (i_1026_ >> 12));
			int i_1032_ = i_1025_++;
			if (i_588_ == 0) {
			    if (i == 1)
				is[i_1032_] = (this.anIntArray9966[i_1031_]);
			    else if (i == 0) {
				int i_1033_ = (this.anIntArray9966[i_1031_++]);
				...
				int i_1037_ = (this.anIntArray9966[i_1031_++]);
				...
				int i_1042_ = (this.anIntArray9966[i_1031_]);
			    ...
			    if (i == 1) {
				int i_1045_ = (this.anIntArray9966[i_1031_]);
				if (i_1045_ != 0)
				    is[i_1032_] = i_1045_;
			    } else if (i == 0) {
				int i_1046_ = (this.anIntArray9966[i_1031_]);
				if (i_1046_ != 0) {
				    if ((anInt9014 & 0xffffff) == 16777215) {
				...
				int i_1057_ = (this.anIntArray9966[i_1031_]);
				...
				int i_1062_ = (this.anIntArray9966[i_1031_]);
				if (i_1062_ != 0) {
			    ...
			    if (i == 1) {
				int i_1065_ = (this.anIntArray9966[i_1031_]);
				if (i_1065_ != 0) {
				...
				int i_1069_ = (this.anIntArray9966[i_1031_]);
				if (i_1069_ != 0) {
				...
				int i_1076_ = (this.anIntArray9966[i_1031_]);
				...
				int i_1081_ = (this.anIntArray9966[i_1031_]);
				if (i_1081_ != 0) {
		...
		for (int i_1087_ = anInt9001; i_1087_ < 0; i_1087_++) {
		    ...
		    int i_1093_;
		    if ((i_1093_ = (1 + i_1089_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_1091_)
			i_1091_ = i_1093_;
		    if (i_1090_ < 0) {
		    ...
		    if ((i_1093_ = (1 + i_1090_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_1091_)
			i_1091_ = i_1093_;
		    for (/**/; i_1091_ < 0; i_1091_++) {
			int i_1094_ = (((i_1090_ >> 12) * this.anInt9010) + (i_1089_ >> 12));
			int i_1095_ = i_1088_++;
			if (i_588_ == 0) {
			    if (i == 1)
				is[i_1095_] = (this.anIntArray9966[i_1094_]);
			    else if (i == 0) {
				int i_1096_ = (this.anIntArray9966[i_1094_++]);
				...
				int i_1100_ = (this.anIntArray9966[i_1094_++]);
				...
				int i_1105_ = (this.anIntArray9966[i_1094_]);
			    ...
			    if (i == 1) {
				int i_1108_ = (this.anIntArray9966[i_1094_]);
				if (i_1108_ != 0)
				    is[i_1095_] = i_1108_;
			    } else if (i == 0) {
				int i_1109_ = (this.anIntArray9966[i_1094_]);
				if (i_1109_ != 0) {
				    if ((anInt9014 & 0xffffff) == 16777215) {
				...
				int i_1120_ = (this.anIntArray9966[i_1094_]);
				...
				int i_1125_ = (this.anIntArray9966[i_1094_]);
				if (i_1125_ != 0) {
			    ...
			    if (i == 1) {
				int i_1128_ = (this.anIntArray9966[i_1094_]);
				if (i_1128_ != 0) {
				...
				int i_1132_ = (this.anIntArray9966[i_1094_]);
				if (i_1132_ != 0) {
				...
				int i_1139_ = (this.anIntArray9966[i_1094_]);
				...
				int i_1144_ = (this.anIntArray9966[i_1094_]);
				if (i_1144_ != 0) {
	...
	int[] is_1152_ = (this.aClass_ra_Sub1_9006.anIntArray7967);
	if (is_1152_ != null) {
	    if (anInt9004 == 0) {
		if (anInt8991 == 0) {
			...
			if (i_1154_ >= 0) {
			    ...
			    if (i_1156_ >= 0 && i_1157_ >= 0 && (i_1156_ - (this.anInt9010 << 12)) < 0 && (i_1157_ - (this.anInt8989 << 12)) < 0) {
				...
				for (/**/; i_1158_ < 0; i_1158_++) {
				    int i_1162_ = (this.anIntArray9966[(((i_1157_ >> 12) * (this.anInt9010)) + (i_1156_ >> 12))]);
				    if (i_1162_ != 0)
			...
			if (i_1164_ >= 0) {
			    ...
			    if (i_1166_ >= 0 && (i_1166_ - (this.anInt9010 << 12)) < 0) {
				int i_1169_;
				if ((i_1169_ = (i_1167_ - (this.anInt8989 << 12))) >= 0) {
				...
				for (/**/; i_1168_ < 0; i_1168_++) {
				    int i_1173_ = (this.anIntArray9966[(((i_1167_ >> 12) * (this.anInt9010)) + (i_1166_ >> 12))]);
				    if (i_1173_ != 0)
			...
			if (i_1175_ >= 0) {
			    ...
			    if (i_1177_ >= 0 && (i_1177_ - (this.anInt9010 << 12)) < 0) {
				if (i_1178_ < 0) {
				...
				int i_1181_;
				if ((i_1181_ = (1 + i_1178_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_1179_)
				    i_1179_ = i_1181_;
				...
				for (/**/; i_1179_ < 0; i_1179_++) {
				    int i_1185_ = (this.anIntArray9966[(((i_1178_ >> 12) * (this.anInt9010)) + (i_1177_ >> 12))]);
				    if (i_1185_ != 0)
		...
		if (anInt8991 == 0) {
			...
			if (i_1187_ >= 0) {
			    ...
			    if (i_1190_ >= 0 && (i_1190_ - (this.anInt8989 << 12)) < 0) {
				int i_1192_;
				if ((i_1192_ = (i_1189_ - (this.anInt9010 << 12))) >= 0) {
				...
				for (/**/; i_1191_ < 0; i_1191_++) {
				    int i_1196_ = (this.anIntArray9966[(((i_1190_ >> 12) * (this.anInt9010)) + (i_1189_ >> 12))]);
				    if (i_1196_ != 0)
			...
			if (i_1198_ >= 0) {
			    ...
			    int i_1203_;
			    if ((i_1203_ = (i_1200_ - (this.anInt9010 << 12))) >= 0) {
				...
				i_1202_ = i_1203_;
			    if ((i_1203_ = (i_1201_ - (this.anInt8989 << 12))) >= 0) {
				...
				int i_1207_ = (this.anIntArray9966[((i_1201_ >> 12) * this.anInt9010 + (i_1200_ >> 12))]);
				if (i_1207_ != 0)
			...
			if (i_1209_ >= 0) {
			    ...
			    int i_1214_;
			    if ((i_1214_ = (i_1211_ - (this.anInt9010 << 12))) >= 0) {
			    ...
			    if ((i_1214_ = (1 + i_1212_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_1213_)
				i_1213_ = i_1214_;
				...
				int i_1218_ = (this.anIntArray9966[((i_1212_ >> 12) * this.anInt9010 + (i_1211_ >> 12))]);
				if (i_1218_ != 0)
		...
		while (i_1219_ < 0) {
			...
			if (i_1223_ >= 0 && i_1223_ - (this.anInt8989 << 12) < 0) {
			    if (i_1222_ < 0) {
			    ...
			    int i_1226_;
			    if ((i_1226_ = (1 + i_1222_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_1224_)
				i_1224_ = i_1226_;
				...
				int i_1230_ = (this.anIntArray9966[((i_1223_ >> 12) * this.anInt9010 + (i_1222_ >> 12))]);
				if (i_1230_ != 0)
		...
		while (i_1231_ < 0) {
			...
			int i_1238_;
			if ((i_1238_ = (1 + i_1234_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_1236_)
			    i_1236_ = i_1238_;
			if ((i_1238_ = i_1235_ - (this.anInt8989 << 12)) >= 0) {
			...
			for (/**/; i_1236_ < 0; i_1236_++) {
			    int i_1242_ = (this.anIntArray9966[(((i_1235_ >> 12) * this.anInt9010) + (i_1234_ >> 12))]);
			    if (i_1242_ != 0)
		...
		while (i_1243_ < 0) {
			...
			int i_1250_;
			if ((i_1250_ = (1 + i_1246_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_1248_)
			    i_1248_ = i_1250_;
			if (i_1247_ < 0) {
			...
			if ((i_1250_ = (1 + i_1247_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_1248_)
			    i_1248_ = i_1250_;
			...
			for (/**/; i_1248_ < 0; i_1248_++) {
			    int i_1254_ = (this.anIntArray9966[(((i_1247_ >> 12) * this.anInt9010) + (i_1246_ >> 12))]);
			    if (i_1254_ != 0)
	...
	if (is != null) {
		...
		if (i_1258_ == 0) {
			...
			for (int i_1269_ = -i_1262_; i_1269_ < 0; i_1269_++) {
				...
				is[i_1260_++] = (this.anIntArray9966[i_1261_++]);
				is[i_1260_++] = (this.anIntArray9966[i_1261_++]);
				is[i_1260_++] = (this.anIntArray9966[i_1261_++]);
				is[i_1260_++] = (this.anIntArray9966[i_1261_++]);
			    }
			...
			for (int i_1274_ = -i_1262_; i_1274_ < 0; i_1274_++) {
				...
				int i_1276_ = (this.anIntArray9966[i_1261_++]);
			...
			for (int i_1280_ = -i_1262_; i_1280_ < 0; i_1280_++) {
				...
				int i_1282_ = (this.anIntArray9966[i_1261_++]);
			...
			for (int i_1290_ = -i_1262_; i_1290_ < 0; i_1290_++) {
				...
				int i_1292_ = (this.anIntArray9966[i_1261_++]);
			...
			for (int i_1293_ = -i_1262_; i_1293_ < 0; i_1293_++) {
				...
				int i_1295_ = (this.anIntArray9966[i_1261_++]);
				if (i_1295_ != 0)
				    is[i_1260_++] = i_1295_;
				else
				    i_1260_++;
				i_1295_ = (this.anIntArray9966[i_1261_++]);
				if (i_1295_ != 0)
				    is[i_1260_++] = i_1295_;
				else
				    i_1260_++;
			    ...
			    i_1294_ += 3;
			    while (i_1260_ < i_1294_) {
				int i_1296_ = (this.anIntArray9966[i_1261_++]);
				if (i_1296_ != 0)
				    is[i_1260_++] = i_1296_;
				else
				    i_1260_++;
			...
			if ((i_1257_ & 0xffffff) == 16777215) {
				...
				for (int i_1300_ = -i_1263_; i_1300_ < 0; i_1300_++) {
				    int i_1301_ = (this.anIntArray9966[i_1261_++]);
				    if (i_1301_ != 0) {
				...
				for (int i_1309_ = -i_1263_; i_1309_ < 0; i_1309_++) {
				    int i_1310_ = (this.anIntArray9966[i_1261_++]);
				    if (i_1310_ != 0) {
					if (i_1306_ != 255) {
			...
			for (int i_1320_ = -i_1262_; i_1320_ < 0; i_1320_++) {
				...
				int i_1322_ = (this.anIntArray9966[i_1261_++]);
			...
			for (int i_1330_ = -i_1262_; i_1330_ < 0; i_1330_++) {
				...
				int i_1332_ = (this.anIntArray9966[i_1261_++]);
				if (i_1332_ != 0) {
			...
			for (int i_1333_ = -i_1262_; i_1333_ < 0; i_1333_++) {
				...
				int i_1335_ = (this.anIntArray9966[i_1261_++]);
				if (i_1335_ != 0) {
			...
			for (int i_1342_ = -i_1262_; i_1342_ < 0; i_1342_++) {
				...
				int i_1344_ = (this.anIntArray9966[i_1261_++]);
				if (i_1344_ != 0) {
			...
			for (int i_1351_ = -i_1262_; i_1351_ < 0; i_1351_++) {
				...
				int i_1353_ = (this.anIntArray9966[i_1261_++]);
			...
			for (int i_1361_ = -i_1262_; i_1361_ < 0; i_1361_++) {
				...
				int i_1363_ = (this.anIntArray9966[i_1261_++]);
				if (i_1363_ != 0) {
	...
	int[] is = (this.aClass_ra_Sub1_9006.anIntArray7967);
	if (is != null) {
	    int i_1371_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
	    i += this.anInt8990;
	    i_1367_ += this.anInt9000;
	    int i_1372_ = i_1367_ * i_1371_ + i;
	    int i_1373_ = 0;
	    int i_1374_ = this.anInt8989;
	    int i_1375_ = this.anInt9010;
	    int i_1376_ = i_1371_ - i_1375_;
	    int i_1377_ = 0;
	    if (i_1367_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_1378_ = (((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_1367_);
		i_1374_ -= i_1378_;
		i_1367_ = ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805);
		i_1373_ += i_1378_ * i_1375_;
		i_1372_ += i_1378_ * i_1371_;
	    }
	    if (i_1367_ + i_1374_ > (this.aClass_ra_Sub1_9006.anInt7977 * 63686679))
		i_1374_ -= (i_1367_ + i_1374_ - (this.aClass_ra_Sub1_9006.anInt7977) * 63686679);
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_1379_ = (((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
		i_1375_ -= i_1379_;
		i = (this.aClass_ra_Sub1_9006.anInt7974 * -912871679);
		i_1373_ += i_1379_;
		i_1372_ += i_1379_;
	    ...
	    if (i + i_1375_ > (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725) {
		int i_1380_ = (i + i_1375_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725);
		i_1375_ -= i_1380_;
		i_1377_ += i_1380_;
		i_1376_ += i_1380_;
	    }
		...
		if (i_1370_ == 0) {
			...
			for (int i_1381_ = -i_1374_; i_1381_ < 0; i_1381_++) {
				...
				is[i_1372_++] = (this.anIntArray9966[i_1373_++]);
				is[i_1372_++] = (this.anIntArray9966[i_1373_++]);
				is[i_1372_++] = (this.anIntArray9966[i_1373_++]);
				is[i_1372_++] = (this.anIntArray9966[i_1373_++]);
			    }
			...
			for (int i_1386_ = -i_1374_; i_1386_ < 0; i_1386_++) {
				...
				int i_1388_ = (this.anIntArray9966[i_1373_++]);
			...
			for (int i_1392_ = -i_1374_; i_1392_ < 0; i_1392_++) {
				...
				int i_1394_ = (this.anIntArray9966[i_1373_++]);
			...
			for (int i_1402_ = -i_1374_; i_1402_ < 0; i_1402_++) {
				...
				int i_1404_ = (this.anIntArray9966[i_1373_++]);
			...
			for (int i_1405_ = -i_1374_; i_1405_ < 0; i_1405_++) {
				...
				int i_1407_ = (this.anIntArray9966[i_1373_++]);
				if (i_1407_ != 0)
				    is[i_1372_++] = i_1407_;
				else
				    i_1372_++;
				i_1407_ = (this.anIntArray9966[i_1373_++]);
				if (i_1407_ != 0)
				    is[i_1372_++] = i_1407_;
				else
				    i_1372_++;
			    ...
			    i_1406_ += 3;
			    while (i_1372_ < i_1406_) {
				int i_1408_ = (this.anIntArray9966[i_1373_++]);
				if (i_1408_ != 0)
				    is[i_1372_++] = i_1408_;
				else
				    i_1372_++;
			...
			if ((i_1369_ & 0xffffff) == 16777215) {
				...
				for (int i_1412_ = -i_1375_; i_1412_ < 0; i_1412_++) {
				    int i_1413_ = (this.anIntArray9966[i_1373_++]);
				    if (i_1413_ != 0) {
				...
				for (int i_1421_ = -i_1375_; i_1421_ < 0; i_1421_++) {
				    int i_1422_ = (this.anIntArray9966[i_1373_++]);
				    if (i_1422_ != 0) {
					if (i_1418_ != 255) {
			...
			for (int i_1432_ = -i_1374_; i_1432_ < 0; i_1432_++) {
				...
				int i_1434_ = (this.anIntArray9966[i_1373_++]);
			...
			for (int i_1442_ = -i_1374_; i_1442_ < 0; i_1442_++) {
				...
				int i_1444_ = (this.anIntArray9966[i_1373_++]);
				if (i_1444_ != 0) {
			...
			for (int i_1445_ = -i_1374_; i_1445_ < 0; i_1445_++) {
				...
				int i_1447_ = (this.anIntArray9966[i_1373_++]);
				if (i_1447_ != 0) {
			...
			for (int i_1454_ = -i_1374_; i_1454_ < 0; i_1454_++) {
				...
				int i_1456_ = (this.anIntArray9966[i_1373_++]);
				if (i_1456_ != 0) {
			...
			for (int i_1463_ = -i_1374_; i_1463_ < 0; i_1463_++) {
				...
				int i_1465_ = (this.anIntArray9966[i_1373_++]);
			...
			for (int i_1473_ = -i_1374_; i_1473_ < 0; i_1473_++) {
				...
				int i_1475_ = (this.anIntArray9966[i_1373_++]);
				if (i_1475_ != 0) {
	...
	int[] is = (this.aClass_ra_Sub1_9006.anIntArray7967);
	if (is != null) {
	    int i_1483_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
	    i += this.anInt8990;
	    i_1479_ += this.anInt9000;
	    int i_1484_ = i_1479_ * i_1483_ + i;
	    int i_1485_ = 0;
	    int i_1486_ = this.anInt8989;
	    int i_1487_ = this.anInt9010;
	    int i_1488_ = i_1483_ - i_1487_;
	    int i_1489_ = 0;
	    if (i_1479_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_1490_ = (((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_1479_);
		i_1486_ -= i_1490_;
		i_1479_ = ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805);
		i_1485_ += i_1490_ * i_1487_;
		i_1484_ += i_1490_ * i_1483_;
	    }
	    if (i_1479_ + i_1486_ > (this.aClass_ra_Sub1_9006.anInt7977 * 63686679))
		i_1486_ -= (i_1479_ + i_1486_ - (this.aClass_ra_Sub1_9006.anInt7977) * 63686679);
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_1491_ = (((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
		i_1487_ -= i_1491_;
		i = (this.aClass_ra_Sub1_9006.anInt7974 * -912871679);
		i_1485_ += i_1491_;
		i_1484_ += i_1491_;
	    ...
	    if (i + i_1487_ > (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725) {
		int i_1492_ = (i + i_1487_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725);
		i_1487_ -= i_1492_;
		i_1489_ += i_1492_;
		i_1488_ += i_1492_;
	    }
		...
		if (i_1482_ == 0) {
			...
			for (int i_1493_ = -i_1486_; i_1493_ < 0; i_1493_++) {
				...
				is[i_1484_++] = (this.anIntArray9966[i_1485_++]);
				is[i_1484_++] = (this.anIntArray9966[i_1485_++]);
				is[i_1484_++] = (this.anIntArray9966[i_1485_++]);
				is[i_1484_++] = (this.anIntArray9966[i_1485_++]);
			    }
			...
			for (int i_1498_ = -i_1486_; i_1498_ < 0; i_1498_++) {
				...
				int i_1500_ = (this.anIntArray9966[i_1485_++]);
			...
			for (int i_1504_ = -i_1486_; i_1504_ < 0; i_1504_++) {
				...
				int i_1506_ = (this.anIntArray9966[i_1485_++]);
			...
			for (int i_1514_ = -i_1486_; i_1514_ < 0; i_1514_++) {
				...
				int i_1516_ = (this.anIntArray9966[i_1485_++]);
			...
			for (int i_1517_ = -i_1486_; i_1517_ < 0; i_1517_++) {
				...
				if (i_1519_ != 0)
				    ...
				    i_1484_++;
				i_1519_ = (this.anIntArray9966[i_1485_++]);
				if (i_1519_ != 0)
				    is[i_1484_++] = i_1519_;
				else
				    i_1484_++;
			    ...
			    i_1518_ += 3;
			    while (i_1484_ < i_1518_) {
				int i_1520_ = (this.anIntArray9966[i_1485_++]);
				if (i_1520_ != 0)
				    is[i_1484_++] = i_1520_;
				else
				    i_1484_++;
			...
			if ((i_1481_ & 0xffffff) == 16777215) {
				...
				for (int i_1524_ = -i_1487_; i_1524_ < 0; i_1524_++) {
				    int i_1525_ = (this.anIntArray9966[i_1485_++]);
				    if (i_1525_ != 0) {
				...
				for (int i_1533_ = -i_1487_; i_1533_ < 0; i_1533_++) {
				    int i_1534_ = (this.anIntArray9966[i_1485_++]);
				    if (i_1534_ != 0) {
					if (i_1530_ != 255) {
			...
			for (int i_1544_ = -i_1486_; i_1544_ < 0; i_1544_++) {
				...
				int i_1546_ = (this.anIntArray9966[i_1485_++]);
			...
			for (int i_1554_ = -i_1486_; i_1554_ < 0; i_1554_++) {
				...
				int i_1556_ = (this.anIntArray9966[i_1485_++]);
				if (i_1556_ != 0) {
			...
			for (int i_1557_ = -i_1486_; i_1557_ < 0; i_1557_++) {
				...
				int i_1559_ = (this.anIntArray9966[i_1485_++]);
				if (i_1559_ != 0) {
			...
			for (int i_1566_ = -i_1486_; i_1566_ < 0; i_1566_++) {
				...
				int i_1568_ = (this.anIntArray9966[i_1485_++]);
				if (i_1568_ != 0) {
			...
			for (int i_1575_ = -i_1486_; i_1575_ < 0; i_1575_++) {
				...
				int i_1577_ = (this.anIntArray9966[i_1485_++]);
			...
			for (int i_1585_ = -i_1486_; i_1585_ < 0; i_1585_++) {
				...
				int i_1587_ = (this.anIntArray9966[i_1485_++]);
				if (i_1587_ != 0) {
	...
	if (i_1594_ > 0 && i_1595_ > 0 && (bool || bool_1591_)) {
	    int i_1601_ = 0;
	    int i_1602_ = 0;
	    int i_1603_ = (this.anInt8990 + this.anInt9010 + this.anInt8997);
	    int i_1604_ = (this.anInt9000 + this.anInt8989 + this.anInt8993);
	    int i_1605_ = (i_1603_ << 16) / i_1594_;
	    int i_1606_ = (i_1604_ << 16) / i_1595_;
	    if (this.anInt8990 > 0) {
		int i_1607_ = (((this.anInt8990 << 16) + i_1605_ - 1) / i_1605_);
		i += i_1607_;
		i_1601_ += (i_1607_ * i_1605_ - (this.anInt8990 << 16));
	    }
	    if (this.anInt9000 > 0) {
		int i_1608_ = (((this.anInt9000 << 16) + i_1606_ - 1) / i_1606_);
		i_1593_ += i_1608_;
		i_1602_ += (i_1608_ * i_1606_ - (this.anInt9000 << 16));
	    }
	    if (this.anInt9010 < i_1603_)
		i_1594_ = ((this.anInt9010 << 16) - i_1601_ + i_1605_ - 1) / i_1605_;
	    if (this.anInt8989 < i_1604_)
		i_1595_ = ((this.anInt8989 << 16) - i_1602_ + i_1606_ - 1) / i_1606_;
	    int i_1609_ = i + i_1593_ * (((this.aClass_ra_Sub1_9006).anInt7971) * 692106883);
	    int i_1610_ = (((this.aClass_ra_Sub1_9006).anInt7971 * 692106883) - i_1594_);
	    if (i_1593_ + i_1595_ > (this.aClass_ra_Sub1_9006.anInt7977 * 63686679))
		i_1595_ -= (i_1593_ + i_1595_ - (this.aClass_ra_Sub1_9006.anInt7977) * 63686679);
	    if (i_1593_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_1611_ = (((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_1593_);
		i_1595_ -= i_1611_;
		i_1609_ += i_1611_ * (((this.aClass_ra_Sub1_9006).anInt7971) * 692106883);
		i_1602_ += i_1606_ * i_1611_;
	    }
	    if (i + i_1594_ > (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725) {
		int i_1612_ = (i + i_1594_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725);
		i_1594_ -= i_1612_;
		i_1610_ += i_1612_;
	    }
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_1613_ = (((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
		i_1594_ -= i_1613_;
		i_1609_ += i_1613_;
		...
		if (i_1596_ == 1) {
			...
			int i_1616_ = ((i_1602_ >> 16) * this.anInt9010);
			for (int i_1617_ = -i_1594_; i_1617_ < 0; i_1617_++) {
			    if (!bool_1591_ || f < fs[i_1609_]) {
				if (bool)
				    is[i_1609_] = (this.anIntArray9966[(i_1601_ >> 16) + i_1616_]);
			...
			int i_1623_ = ((i_1602_ >> 16) * this.anInt9010);
			for (int i_1624_ = -i_1594_; i_1624_ < 0; i_1624_++) {
			    if (!bool_1591_ || f < fs[i_1609_]) {
				if (bool) {
				    int i_1625_ = (this.anIntArray9966[(i_1601_ >> 16) + i_1623_]);
			...
			int i_1631_ = ((i_1602_ >> 16) * this.anInt9010);
			for (int i_1632_ = -i_1594_; i_1632_ < 0; i_1632_++) {
			    if (!bool_1591_ || f < fs[i_1609_]) {
				if (bool) {
				    int i_1633_ = (this.anIntArray9966[(i_1601_ >> 16) + i_1631_]);
			...
			int i_1643_ = ((i_1602_ >> 16) * this.anInt9010);
			for (int i_1644_ = -i_1594_; i_1644_ < 0; i_1644_++) {
			    if (!bool_1591_ || f < fs[i_1609_]) {
				if (bool) {
				    int i_1645_ = (this.anIntArray9966[(i_1601_ >> 16) + i_1643_]);
		...
		if (i_1596_ == 1) {
			...
			int i_1648_ = ((i_1602_ >> 16) * this.anInt9010);
			for (int i_1649_ = -i_1594_; i_1649_ < 0; i_1649_++) {
			    if (!bool_1591_ || f < fs[i_1609_]) {
				int i_1650_ = (this.anIntArray9966[(i_1601_ >> 16) + i_1648_]);
				if (i_1650_ != 0) {
				    if (bool)
					is[i_1609_] = i_1650_;
				    if (bool_1591_ && bool_1600_)
			...
			for (int i_1654_ = -i_1595_; i_1654_ < 0; i_1654_++) {
			    int i_1655_ = ((i_1602_ >> 16) * this.anInt9010);
			    for (int i_1656_ = -i_1594_; i_1656_ < 0; i_1656_++) {
				if (!bool_1591_ || f < fs[i_1609_]) {
				    int i_1657_ = (this.anIntArray9966[(i_1601_ >> 16) + i_1655_]);
				    if (i_1657_ != 0) {
					if (bool) {
			...
			for (int i_1664_ = -i_1595_; i_1664_ < 0; i_1664_++) {
			    int i_1665_ = ((i_1602_ >> 16) * this.anInt9010);
			    for (int i_1666_ = -i_1594_; i_1666_ < 0; i_1666_++) {
				if (!bool_1591_ || f < fs[i_1609_]) {
				    int i_1667_ = (this.anIntArray9966[(i_1601_ >> 16) + i_1665_]);
				    if (i_1667_ != 0) {
					if (i_1662_ != 255) {
					    if (bool) {
			...
			int i_1679_ = ((i_1602_ >> 16) * this.anInt9010);
			for (int i_1680_ = -i_1594_; i_1680_ < 0; i_1680_++) {
			    if (!bool_1591_ || f < fs[i_1609_]) {
				if (bool) {
				    int i_1681_ = (this.anIntArray9966[(i_1601_ >> 16) + i_1679_]);
			...
			int i_1691_ = ((i_1602_ >> 16) * this.anInt9010);
			for (int i_1692_ = -i_1594_; i_1692_ < 0; i_1692_++) {
			    if (!bool_1591_ || f < fs[i_1609_]) {
				int i_1693_ = (this.anIntArray9966[(i_1601_ >> 16) + i_1691_]);
				if (i_1693_ != 0) {
				    if (bool) {
		...
		if (i_1596_ == 1) {
			...
			int i_1696_ = ((i_1602_ >> 16) * this.anInt9010);
			for (int i_1697_ = -i_1594_; i_1697_ < 0; i_1697_++) {
			    if (!bool_1591_ || f < fs[i_1609_]) {
				int i_1698_ = (this.anIntArray9966[(i_1601_ >> 16) + i_1696_]);
				if (i_1698_ != 0) {
				    if (bool) {
			...
			int i_1707_ = ((i_1602_ >> 16) * this.anInt9010);
			for (int i_1708_ = -i_1594_; i_1708_ < 0; i_1708_++) {
			    if (!bool_1591_ || f < fs[i_1609_]) {
				int i_1709_ = (this.anIntArray9966[(i_1601_ >> 16) + i_1707_]);
				if (i_1709_ != 0) {
				    if (bool) {
			...
			int i_1718_ = ((i_1602_ >> 16) * this.anInt9010);
			for (int i_1719_ = -i_1594_; i_1719_ < 0; i_1719_++) {
			    if (!bool_1591_ || f < fs[i_1609_]) {
				if (bool) {
				    int i_1720_ = (this.anIntArray9966[(i_1601_ >> 16) + i_1718_]);
			...
			int i_1730_ = ((i_1602_ >> 16) * this.anInt9010);
			for (int i_1731_ = -i_1594_; i_1731_ < 0; i_1731_++) {
			    if (!bool_1591_ || f < fs[i_1609_]) {
				int i_1732_ = (this.anIntArray9966[(i_1601_ >> 16) + i_1730_]);
				if (i_1732_ != 0) {
				    if (bool) {
	...
	if (is != null) {
		...
		if (anInt8991 == 0) {
			...
			if (i_1739_ >= 0 && i_1740_ >= 0 && i_1739_ - (this.anInt9010 << 12) < 0 && i_1740_ - (this.anInt8989 << 12) < 0) {
			    for (/**/; i_1741_ < 0; i_1741_++) {
				int i_1742_ = (((i_1740_ >> 12) * this.anInt9010) + (i_1739_ >> 12));
				int i_1743_ = i_1738_++;
				if (i_1736_ == 0) {
				    if (i == 1)
					is[i_1743_] = (this.anIntArray9966[i_1742_]);
				    else if (i == 0) {
					int i_1744_ = (this.anIntArray9966[i_1742_++]);
					...
					int i_1748_ = (this.anIntArray9966[i_1742_++]);
					...
					int i_1753_ = (this.anIntArray9966[i_1742_]);
				    ...
				    if (i == 1) {
					int i_1756_ = (this.anIntArray9966[i_1742_]);
					if (i_1756_ != 0)
					    is[i_1743_] = i_1756_;
				    } else if (i == 0) {
					int i_1757_ = (this.anIntArray9966[i_1742_]);
					if (i_1757_ != 0) {
					    if ((anInt9014 & 0xffffff) == 16777215) {
					...
					int i_1768_ = (this.anIntArray9966[i_1742_]);
					...
					int i_1773_ = (this.anIntArray9966[i_1742_]);
					if (i_1773_ != 0) {
				    ...
				    if (i == 1) {
					int i_1776_ = (this.anIntArray9966[i_1742_]);
					if (i_1776_ != 0) {
					...
					int i_1780_ = (this.anIntArray9966[i_1742_]);
					if (i_1780_ != 0) {
					...
					int i_1787_ = (this.anIntArray9966[i_1742_]);
					...
					int i_1792_ = (this.anIntArray9966[i_1742_]);
					if (i_1792_ != 0) {
			...
			if (i_1800_ >= 0 && i_1800_ - (this.anInt9010 << 12) < 0) {
			    int i_1803_;
			    if ((i_1803_ = (i_1801_ - (this.anInt8989 << 12))) >= 0) {
				...
				int i_1804_ = (((i_1801_ >> 12) * this.anInt9010) + (i_1800_ >> 12));
				int i_1805_ = i_1799_++;
				if (i_1736_ == 0) {
				    if (i == 1)
					is[i_1805_] = (this.anIntArray9966[i_1804_]);
				    else if (i == 0) {
					int i_1806_ = (this.anIntArray9966[i_1804_++]);
					...
					int i_1810_ = (this.anIntArray9966[i_1804_++]);
					...
					int i_1815_ = (this.anIntArray9966[i_1804_]);
				    ...
				    if (i == 1) {
					int i_1818_ = (this.anIntArray9966[i_1804_]);
					if (i_1818_ != 0)
					    is[i_1805_] = i_1818_;
				    } else if (i == 0) {
					int i_1819_ = (this.anIntArray9966[i_1804_]);
					if (i_1819_ != 0) {
					    if ((anInt9014 & 0xffffff) == 16777215) {
					...
					int i_1830_ = (this.anIntArray9966[i_1804_]);
					...
					int i_1835_ = (this.anIntArray9966[i_1804_]);
					if (i_1835_ != 0) {
				    ...
				    if (i == 1) {
					int i_1838_ = (this.anIntArray9966[i_1804_]);
					if (i_1838_ != 0) {
					...
					int i_1842_ = (this.anIntArray9966[i_1804_]);
					if (i_1842_ != 0) {
					...
					int i_1849_ = (this.anIntArray9966[i_1804_]);
					...
					int i_1854_ = (this.anIntArray9966[i_1804_]);
					if (i_1854_ != 0) {
			...
			if (i_1862_ >= 0 && i_1862_ - (this.anInt9010 << 12) < 0) {
			    if (i_1863_ < 0) {
			    ...
			    int i_1866_;
			    if ((i_1866_ = (1 + i_1863_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_1864_)
				i_1864_ = i_1866_;
			    for (/**/; i_1864_ < 0; i_1864_++) {
				int i_1867_ = (((i_1863_ >> 12) * this.anInt9010) + (i_1862_ >> 12));
				int i_1868_ = i_1861_++;
				if (i_1736_ == 0) {
				    if (i == 1)
					is[i_1868_] = (this.anIntArray9966[i_1867_]);
				    else if (i == 0) {
					int i_1869_ = (this.anIntArray9966[i_1867_++]);
					...
					int i_1873_ = (this.anIntArray9966[i_1867_++]);
					...
					int i_1878_ = (this.anIntArray9966[i_1867_]);
				    ...
				    if (i == 1) {
					int i_1881_ = (this.anIntArray9966[i_1867_]);
					if (i_1881_ != 0)
					    is[i_1868_] = i_1881_;
				    } else if (i == 0) {
					int i_1882_ = (this.anIntArray9966[i_1867_]);
					if (i_1882_ != 0) {
					    if ((anInt9014 & 0xffffff) == 16777215) {
					...
					int i_1893_ = (this.anIntArray9966[i_1867_]);
					...
					int i_1898_ = (this.anIntArray9966[i_1867_]);
					if (i_1898_ != 0) {
				    ...
				    if (i == 1) {
					int i_1901_ = (this.anIntArray9966[i_1867_]);
					if (i_1901_ != 0) {
					...
					int i_1905_ = (this.anIntArray9966[i_1867_]);
					if (i_1905_ != 0) {
					...
					int i_1912_ = (this.anIntArray9966[i_1867_]);
					...
					int i_1917_ = (this.anIntArray9966[i_1867_]);
					if (i_1917_ != 0) {
		...
		if (anInt8991 == 0) {
			...
			if (i_1926_ >= 0 && i_1926_ - (this.anInt8989 << 12) < 0) {
			    int i_1928_;
			    if ((i_1928_ = (i_1925_ - (this.anInt9010 << 12))) >= 0) {
				...
				int i_1929_ = (((i_1926_ >> 12) * this.anInt9010) + (i_1925_ >> 12));
				int i_1930_ = i_1924_++;
				if (i_1736_ == 0) {
				    if (i == 1)
					is[i_1930_] = (this.anIntArray9966[i_1929_]);
				    else if (i == 0) {
					int i_1931_ = (this.anIntArray9966[i_1929_++]);
					...
					int i_1935_ = (this.anIntArray9966[i_1929_++]);
					...
					int i_1940_ = (this.anIntArray9966[i_1929_]);
				    ...
				    if (i == 1) {
					int i_1943_ = (this.anIntArray9966[i_1929_]);
					if (i_1943_ != 0)
					    is[i_1930_] = i_1943_;
				    } else if (i == 0) {
					int i_1944_ = (this.anIntArray9966[i_1929_]);
					if (i_1944_ != 0) {
					    if ((anInt9014 & 0xffffff) == 16777215) {
					...
					int i_1955_ = (this.anIntArray9966[i_1929_]);
					...
					int i_1960_ = (this.anIntArray9966[i_1929_]);
					if (i_1960_ != 0) {
				    ...
				    if (i == 1) {
					int i_1963_ = (this.anIntArray9966[i_1929_]);
					if (i_1963_ != 0) {
					...
					int i_1967_ = (this.anIntArray9966[i_1929_]);
					if (i_1967_ != 0) {
					...
					int i_1974_ = (this.anIntArray9966[i_1929_]);
					...
					int i_1979_ = (this.anIntArray9966[i_1929_]);
					if (i_1979_ != 0) {
			...
			int i_1990_;
			if ((i_1990_ = i_1987_ - (this.anInt9010 << 12)) >= 0) {
			...
			if ((i_1990_ = (i_1987_ - anInt9004) / anInt9004) > i_1989_)
			    i_1989_ = i_1990_;
			if ((i_1990_ = i_1988_ - (this.anInt8989 << 12)) >= 0) {
			...
			for (/**/; i_1989_ < 0; i_1989_++) {
			    int i_1991_ = (((i_1988_ >> 12) * this.anInt9010) + (i_1987_ >> 12));
			    int i_1992_ = i_1986_++;
			    if (i_1736_ == 0) {
				if (i == 1)
				    is[i_1992_] = (this.anIntArray9966[i_1991_]);
				else if (i == 0) {
				    int i_1993_ = (this.anIntArray9966[i_1991_++]);
				    ...
				    int i_1997_ = (this.anIntArray9966[i_1991_++]);
				    ...
				    int i_2002_ = (this.anIntArray9966[i_1991_]);
				...
				if (i == 1) {
				    int i_2005_ = (this.anIntArray9966[i_1991_]);
				    if (i_2005_ != 0)
					is[i_1992_] = i_2005_;
				} else if (i == 0) {
				    int i_2006_ = (this.anIntArray9966[i_1991_]);
				    if (i_2006_ != 0) {
					if ((anInt9014 & 0xffffff) == 16777215) {
				    ...
				    int i_2017_ = (this.anIntArray9966[i_1991_]);
				    ...
				    int i_2022_ = (this.anIntArray9966[i_1991_]);
				    if (i_2022_ != 0) {
				...
				if (i == 1) {
				    int i_2025_ = (this.anIntArray9966[i_1991_]);
				    if (i_2025_ != 0) {
				    ...
				    int i_2029_ = (this.anIntArray9966[i_1991_]);
				    if (i_2029_ != 0) {
				    ...
				    int i_2036_ = (this.anIntArray9966[i_1991_]);
				    ...
				    int i_2041_ = (this.anIntArray9966[i_1991_]);
				    if (i_2041_ != 0) {
			...
			int i_2052_;
			if ((i_2052_ = i_2049_ - (this.anInt9010 << 12)) >= 0) {
			...
			if ((i_2052_ = (1 + i_2050_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_2051_)
			    i_2051_ = i_2052_;
			for (/**/; i_2051_ < 0; i_2051_++) {
			    int i_2053_ = (((i_2050_ >> 12) * this.anInt9010) + (i_2049_ >> 12));
			    int i_2054_ = i_2048_++;
			    if (i_1736_ == 0) {
				if (i == 1)
				    is[i_2054_] = (this.anIntArray9966[i_2053_]);
				else if (i == 0) {
				    int i_2055_ = (this.anIntArray9966[i_2053_++]);
				    ...
				    int i_2059_ = (this.anIntArray9966[i_2053_++]);
				    ...
				    int i_2064_ = (this.anIntArray9966[i_2053_]);
				...
				if (i == 1) {
				    int i_2067_ = (this.anIntArray9966[i_2053_]);
				    if (i_2067_ != 0)
					is[i_2054_] = i_2067_;
				} else if (i == 0) {
				    int i_2068_ = (this.anIntArray9966[i_2053_]);
				    if (i_2068_ != 0) {
					if ((anInt9014 & 0xffffff) == 16777215) {
				    ...
				    int i_2079_ = (this.anIntArray9966[i_2053_]);
				    ...
				    int i_2084_ = (this.anIntArray9966[i_2053_]);
				    if (i_2084_ != 0) {
				...
				if (i == 1) {
				    int i_2087_ = (this.anIntArray9966[i_2053_]);
				    if (i_2087_ != 0) {
				    ...
				    int i_2091_ = (this.anIntArray9966[i_2053_]);
				    if (i_2091_ != 0) {
				    ...
				    int i_2098_ = (this.anIntArray9966[i_2053_]);
				    ...
				    int i_2103_ = (this.anIntArray9966[i_2053_]);
				    if (i_2103_ != 0) {
		...
		while (i_2109_ < 0) {
		    ...
		    if (i_2112_ >= 0 && i_2112_ - (this.anInt8989 << 12) < 0) {
			if (i_2111_ < 0) {
			...
			int i_2115_;
			if ((i_2115_ = (1 + i_2111_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_2113_)
			    i_2113_ = i_2115_;
			for (/**/; i_2113_ < 0; i_2113_++) {
			    int i_2116_ = (((i_2112_ >> 12) * this.anInt9010) + (i_2111_ >> 12));
			    int i_2117_ = i_2110_++;
			    if (i_1736_ == 0) {
				if (i == 1)
				    is[i_2117_] = (this.anIntArray9966[i_2116_]);
				else if (i == 0) {
				    int i_2118_ = (this.anIntArray9966[i_2116_++]);
				    ...
				    int i_2122_ = (this.anIntArray9966[i_2116_++]);
				    ...
				    int i_2127_ = (this.anIntArray9966[i_2116_]);
				...
				if (i == 1) {
				    int i_2130_ = (this.anIntArray9966[i_2116_]);
				    if (i_2130_ != 0)
					is[i_2117_] = i_2130_;
				} else if (i == 0) {
				    int i_2131_ = (this.anIntArray9966[i_2116_]);
				    if (i_2131_ != 0) {
					if ((anInt9014 & 0xffffff) == 16777215) {
				    ...
				    int i_2142_ = (this.anIntArray9966[i_2116_]);
				    ...
				    int i_2147_ = (this.anIntArray9966[i_2116_]);
				    if (i_2147_ != 0) {
				...
				if (i == 1) {
				    int i_2150_ = (this.anIntArray9966[i_2116_]);
				    if (i_2150_ != 0) {
				    ...
				    int i_2154_ = (this.anIntArray9966[i_2116_]);
				    if (i_2154_ != 0) {
				    ...
				    int i_2161_ = (this.anIntArray9966[i_2116_]);
				    ...
				    int i_2166_ = (this.anIntArray9966[i_2116_]);
				    if (i_2166_ != 0) {
		...
		for (int i_2172_ = anInt9001; i_2172_ < 0; i_2172_++) {
		    ...
		    int i_2178_;
		    if ((i_2178_ = (1 + i_2174_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_2176_)
			i_2176_ = i_2178_;
		    if ((i_2178_ = i_2175_ - (this.anInt8989 << 12)) >= 0) {
			...
			int i_2179_ = (((i_2175_ >> 12) * this.anInt9010) + (i_2174_ >> 12));
			int i_2180_ = i_2173_++;
			if (i_1736_ == 0) {
			    if (i == 1)
				is[i_2180_] = (this.anIntArray9966[i_2179_]);
			    else if (i == 0) {
				int i_2181_ = (this.anIntArray9966[i_2179_++]);
				...
				int i_2185_ = (this.anIntArray9966[i_2179_++]);
				...
				int i_2190_ = (this.anIntArray9966[i_2179_]);
			    ...
			    if (i == 1) {
				int i_2193_ = (this.anIntArray9966[i_2179_]);
				if (i_2193_ != 0)
				    is[i_2180_] = i_2193_;
			    } else if (i == 0) {
				int i_2194_ = (this.anIntArray9966[i_2179_]);
				if (i_2194_ != 0) {
				    if ((anInt9014 & 0xffffff) == 16777215) {
				...
				int i_2205_ = (this.anIntArray9966[i_2179_]);
				...
				int i_2210_ = (this.anIntArray9966[i_2179_]);
				if (i_2210_ != 0) {
			    ...
			    if (i == 1) {
				int i_2213_ = (this.anIntArray9966[i_2179_]);
				if (i_2213_ != 0) {
				...
				int i_2217_ = (this.anIntArray9966[i_2179_]);
				if (i_2217_ != 0) {
				...
				int i_2224_ = (this.anIntArray9966[i_2179_]);
				...
				int i_2229_ = (this.anIntArray9966[i_2179_]);
				if (i_2229_ != 0) {
		...
		for (int i_2235_ = anInt9001; i_2235_ < 0; i_2235_++) {
		    ...
		    int i_2241_;
		    if ((i_2241_ = (1 + i_2237_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_2239_)
			i_2239_ = i_2241_;
		    if (i_2238_ < 0) {
		    ...
		    if ((i_2241_ = (1 + i_2238_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_2239_)
			i_2239_ = i_2241_;
		    for (/**/; i_2239_ < 0; i_2239_++) {
			int i_2242_ = (((i_2238_ >> 12) * this.anInt9010) + (i_2237_ >> 12));
			int i_2243_ = i_2236_++;
			if (i_1736_ == 0) {
			    if (i == 1)
				is[i_2243_] = (this.anIntArray9966[i_2242_]);
			    else if (i == 0) {
				int i_2244_ = (this.anIntArray9966[i_2242_++]);
				...
				int i_2248_ = (this.anIntArray9966[i_2242_++]);
				...
				int i_2253_ = (this.anIntArray9966[i_2242_]);
			    ...
			    if (i == 1) {
				int i_2256_ = (this.anIntArray9966[i_2242_]);
				if (i_2256_ != 0)
				    is[i_2243_] = i_2256_;
			    } else if (i == 0) {
				int i_2257_ = (this.anIntArray9966[i_2242_]);
				if (i_2257_ != 0) {
				    if ((anInt9014 & 0xffffff) == 16777215) {
				...
				int i_2268_ = (this.anIntArray9966[i_2242_]);
				...
				int i_2273_ = (this.anIntArray9966[i_2242_]);
				if (i_2273_ != 0) {
			    ...
			    if (i == 1) {
				int i_2276_ = (this.anIntArray9966[i_2242_]);
				if (i_2276_ != 0) {
				...
				int i_2280_ = (this.anIntArray9966[i_2242_]);
				if (i_2280_ != 0) {
				...
				int i_2287_ = (this.anIntArray9966[i_2242_]);
				...
				int i_2292_ = (this.anIntArray9966[i_2242_]);
				if (i_2292_ != 0) {
	...
	if (is != null) {
	    i += this.anInt8990;
	    i_2298_ += this.anInt9000;
	    int i_2301_ = 0;
	    int i_2302_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
	    int i_2303_ = this.anInt9010;
	    int i_2304_ = this.anInt8989;
	    int i_2305_ = i_2302_ - i_2303_;
	    int i_2306_ = 0;
	    int i_2307_ = i + i_2298_ * i_2302_;
	    if (i_2298_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_2308_ = (((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_2298_);
		i_2304_ -= i_2308_;
		i_2298_ = ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805);
		i_2301_ += i_2308_ * i_2303_;
		i_2307_ += i_2308_ * i_2302_;
	    }
	    if (i_2298_ + i_2304_ > (this.aClass_ra_Sub1_9006.anInt7977 * 63686679))
		i_2304_ -= (i_2298_ + i_2304_ - (this.aClass_ra_Sub1_9006.anInt7977) * 63686679);
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_2309_ = (((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
		i_2303_ -= i_2309_;
		i = (this.aClass_ra_Sub1_9006.anInt7974 * -912871679);
		i_2301_ += i_2309_;
		i_2307_ += i_2309_;
	    ...
	    if (i + i_2303_ > (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725) {
		int i_2310_ = (i + i_2303_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725);
		i_2303_ -= i_2310_;
		i_2306_ += i_2310_;
		i_2305_ += i_2310_;
	    }
		...
		Class_ta_Sub2 class_ta_sub2 = (Class_ta_Sub2) class_ta;
		int[] is_2311_ = class_ta_sub2.anIntArray8443;
		int[] is_2312_ = class_ta_sub2.anIntArray8442;
		int i_2313_ = i_2298_;
		if (i_2300_ > i_2313_) {
		    i_2313_ = i_2300_;
		    i_2307_ += (i_2300_ - i_2298_) * i_2302_;
		    i_2301_ += ((i_2300_ - i_2298_) * this.anInt9010);
		}
		...
		for (int i_2315_ = i_2313_; i_2315_ < i_2314_; i_2315_++) {
			...
			int i_2323_ = (this.anIntArray9966[i_2301_++]);
			if (i_2323_ != 0)
			    is[i_2307_++] = i_2323_;
			else
			    i_2307_++;
	...
	if (i_2327_ > 0 && i_2328_ > 0) {
		...
		int i_2333_ = 0;
		int i_2334_ = 0;
		int i_2335_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
		int i_2336_ = (this.anInt8990 + this.anInt9010 + this.anInt8997);
		int i_2337_ = (this.anInt9000 + this.anInt8989 + this.anInt8993);
		int i_2338_ = (i_2336_ << 16) / i_2327_;
		int i_2339_ = (i_2337_ << 16) / i_2328_;
		if (this.anInt8990 > 0) {
		    int i_2340_ = ((this.anInt8990 << 16) + i_2338_ - 1) / i_2338_;
		    i += i_2340_;
		    i_2333_ += (i_2340_ * i_2338_ - (this.anInt8990 << 16));
		}
		if (this.anInt9000 > 0) {
		    int i_2341_ = ((this.anInt9000 << 16) + i_2339_ - 1) / i_2339_;
		    i_2326_ += i_2341_;
		    i_2334_ += (i_2341_ * i_2339_ - (this.anInt9000 << 16));
		}
		if (this.anInt9010 < i_2336_)
		    i_2327_ = ((this.anInt9010 << 16) - i_2333_ + i_2338_ - 1) / i_2338_;
		if (this.anInt8989 < i_2337_)
		    i_2328_ = ((this.anInt8989 << 16) - i_2334_ + i_2339_ - 1) / i_2339_;
		int i_2342_ = i + i_2326_ * i_2335_;
		int i_2343_ = i_2335_ - i_2327_;
		if (i_2326_ + i_2328_ > ((this.aClass_ra_Sub1_9006).anInt7977 * 63686679))
		    i_2328_ -= (i_2326_ + i_2328_ - ((this.aClass_ra_Sub1_9006).anInt7977) * 63686679);
		if (i_2326_ < (this.aClass_ra_Sub1_9006.anInt7976) * -1278653805) {
		    int i_2344_ = ((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_2326_;
		    i_2328_ -= i_2344_;
		    i_2342_ += i_2344_ * i_2335_;
		    i_2334_ += i_2339_ * i_2344_;
		}
		if (i + i_2327_ > ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725) {
		    int i_2345_ = (i + i_2327_ - (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725);
		    i_2327_ -= i_2345_;
		    i_2343_ += i_2345_;
		}
		if (i < ((this.aClass_ra_Sub1_9006).anInt7974 * -912871679)) {
		    int i_2346_ = ((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i;
		    i_2327_ -= i_2346_;
		    i_2342_ += i_2346_;
		...
		if (i_2331_ == 0) {
			...
			for (int i_2348_ = -i_2328_; i_2348_ < 0; i_2348_++) {
			    int i_2349_ = ((i_2334_ >> 16) * this.anInt9010);
			    for (int i_2350_ = -i_2327_; i_2350_ < 0; i_2350_++) {
				is[i_2342_++] = (this.anIntArray9966[(i_2333_ >> 16) + i_2349_]);
				i_2333_ += i_2338_;
			    }
			    i_2334_ += i_2339_;
			    i_2333_ = i_2347_;
			...
			for (int i_2355_ = -i_2328_; i_2355_ < 0; i_2355_++) {
			    int i_2356_ = ((i_2334_ >> 16) * this.anInt9010);
			    for (int i_2357_ = -i_2327_; i_2357_ < 0; i_2357_++) {
				int i_2358_ = (this.anIntArray9966[(i_2333_ >> 16) + i_2356_]);
			...
			for (int i_2363_ = -i_2328_; i_2363_ < 0; i_2363_++) {
			    int i_2364_ = ((i_2334_ >> 16) * this.anInt9010);
			    for (int i_2365_ = -i_2327_; i_2365_ < 0; i_2365_++) {
				int i_2366_ = (this.anIntArray9966[(i_2333_ >> 16) + i_2364_]);
			...
			for (int i_2375_ = -i_2328_; i_2375_ < 0; i_2375_++) {
			    int i_2376_ = ((i_2334_ >> 16) * this.anInt9010);
			    for (int i_2377_ = -i_2327_; i_2377_ < 0; i_2377_++) {
				int i_2378_ = (this.anIntArray9966[(i_2333_ >> 16) + i_2376_]);
			...
			for (int i_2380_ = -i_2328_; i_2380_ < 0; i_2380_++) {
			    int i_2381_ = ((i_2334_ >> 16) * this.anInt9010);
			    for (int i_2382_ = -i_2327_; i_2382_ < 0; i_2382_++) {
				int i_2383_ = (this.anIntArray9966[(i_2333_ >> 16) + i_2381_]);
				if (i_2383_ != 0)
				    is[i_2342_++] = i_2383_;
				else
				    i_2342_++;
			...
			if ((i_2330_ & 0xffffff) == 16777215) {
				...
				int i_2388_ = ((i_2334_ >> 16) * this.anInt9010);
				for (int i_2389_ = -i_2327_; i_2389_ < 0; i_2389_++) {
				    int i_2390_ = (this.anIntArray9966[(i_2333_ >> 16) + i_2388_]);
				    if (i_2390_ != 0) {
				...
				int i_2398_ = ((i_2334_ >> 16) * this.anInt9010);
				for (int i_2399_ = -i_2327_; i_2399_ < 0; i_2399_++) {
				    int i_2400_ = (this.anIntArray9966[(i_2333_ >> 16) + i_2398_]);
				    if (i_2400_ != 0) {
					if (i_2395_ != 255) {
			...
			for (int i_2411_ = -i_2328_; i_2411_ < 0; i_2411_++) {
			    int i_2412_ = ((i_2334_ >> 16) * this.anInt9010);
			    for (int i_2413_ = -i_2327_; i_2413_ < 0; i_2413_++) {
				int i_2414_ = (this.anIntArray9966[(i_2333_ >> 16) + i_2412_]);
			...
			for (int i_2423_ = -i_2328_; i_2423_ < 0; i_2423_++) {
			    int i_2424_ = ((i_2334_ >> 16) * this.anInt9010);
			    for (int i_2425_ = -i_2327_; i_2425_ < 0; i_2425_++) {
				int i_2426_ = (this.anIntArray9966[(i_2333_ >> 16) + i_2424_]);
				if (i_2426_ != 0) {
			...
			for (int i_2428_ = -i_2328_; i_2428_ < 0; i_2428_++) {
			    int i_2429_ = ((i_2334_ >> 16) * this.anInt9010);
			    for (int i_2430_ = -i_2327_; i_2430_ < 0; i_2430_++) {
				int i_2431_ = (this.anIntArray9966[(i_2333_ >> 16) + i_2429_]);
				if (i_2431_ != 0) {
			...
			for (int i_2439_ = -i_2328_; i_2439_ < 0; i_2439_++) {
			    int i_2440_ = ((i_2334_ >> 16) * this.anInt9010);
			    for (int i_2441_ = -i_2327_; i_2441_ < 0; i_2441_++) {
				int i_2442_ = (this.anIntArray9966[(i_2333_ >> 16) + i_2440_]);
				if (i_2442_ != 0) {
			...
			for (int i_2450_ = -i_2328_; i_2450_ < 0; i_2450_++) {
			    int i_2451_ = ((i_2334_ >> 16) * this.anInt9010);
			    for (int i_2452_ = -i_2327_; i_2452_ < 0; i_2452_++) {
				int i_2453_ = (this.anIntArray9966[(i_2333_ >> 16) + i_2451_]);
			...
			for (int i_2462_ = -i_2328_; i_2462_ < 0; i_2462_++) {
			    int i_2463_ = ((i_2334_ >> 16) * this.anInt9010);
			    for (int i_2464_ = -i_2327_; i_2464_ < 0; i_2464_++) {
				int i_2465_ = (this.anIntArray9966[(i_2333_ >> 16) + i_2463_]);
				if (i_2465_ != 0) {
	...
	int[] is_2471_ = (this.aClass_ra_Sub1_9006.anIntArray7967);
	if (is_2471_ != null) {
	    if (anInt9004 == 0) {
		if (anInt8991 == 0) {
			...
			if (i_2473_ >= 0) {
			    ...
			    if (i_2475_ >= 0 && i_2476_ >= 0 && (i_2475_ - (this.anInt9010 << 12)) < 0 && (i_2476_ - (this.anInt8989 << 12)) < 0) {
				...
				for (/**/; i_2477_ < 0; i_2477_++) {
				    int i_2481_ = (this.anIntArray9966[(((i_2476_ >> 12) * (this.anInt9010)) + (i_2475_ >> 12))]);
				    if (i_2481_ != 0)
			...
			if (i_2483_ >= 0) {
			    ...
			    if (i_2485_ >= 0 && (i_2485_ - (this.anInt9010 << 12)) < 0) {
				int i_2488_;
				if ((i_2488_ = (i_2486_ - (this.anInt8989 << 12))) >= 0) {
				...
				for (/**/; i_2487_ < 0; i_2487_++) {
				    int i_2492_ = (this.anIntArray9966[(((i_2486_ >> 12) * (this.anInt9010)) + (i_2485_ >> 12))]);
				    if (i_2492_ != 0)
			...
			if (i_2494_ >= 0) {
			    ...
			    if (i_2496_ >= 0 && (i_2496_ - (this.anInt9010 << 12)) < 0) {
				if (i_2497_ < 0) {
				...
				int i_2500_;
				if ((i_2500_ = (1 + i_2497_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_2498_)
				    i_2498_ = i_2500_;
				...
				for (/**/; i_2498_ < 0; i_2498_++) {
				    int i_2504_ = (this.anIntArray9966[(((i_2497_ >> 12) * (this.anInt9010)) + (i_2496_ >> 12))]);
				    if (i_2504_ != 0)
		...
		if (anInt8991 == 0) {
			...
			if (i_2506_ >= 0) {
			    ...
			    if (i_2509_ >= 0 && (i_2509_ - (this.anInt8989 << 12)) < 0) {
				int i_2511_;
				if ((i_2511_ = (i_2508_ - (this.anInt9010 << 12))) >= 0) {
				...
				for (/**/; i_2510_ < 0; i_2510_++) {
				    int i_2515_ = (this.anIntArray9966[(((i_2509_ >> 12) * (this.anInt9010)) + (i_2508_ >> 12))]);
				    if (i_2515_ != 0)
			...
			if (i_2517_ >= 0) {
			    ...
			    int i_2522_;
			    if ((i_2522_ = (i_2519_ - (this.anInt9010 << 12))) >= 0) {
				...
				i_2521_ = i_2522_;
			    if ((i_2522_ = (i_2520_ - (this.anInt8989 << 12))) >= 0) {
				...
				int i_2526_ = (this.anIntArray9966[((i_2520_ >> 12) * this.anInt9010 + (i_2519_ >> 12))]);
				if (i_2526_ != 0)
			...
			if (i_2528_ >= 0) {
			    ...
			    int i_2533_;
			    if ((i_2533_ = (i_2530_ - (this.anInt9010 << 12))) >= 0) {
			    ...
			    if ((i_2533_ = (1 + i_2531_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_2532_)
				i_2532_ = i_2533_;
				...
				int i_2537_ = (this.anIntArray9966[((i_2531_ >> 12) * this.anInt9010 + (i_2530_ >> 12))]);
				if (i_2537_ != 0)
		...
		while (i_2538_ < 0) {
			...
			if (i_2542_ >= 0 && i_2542_ - (this.anInt8989 << 12) < 0) {
			    if (i_2541_ < 0) {
			    ...
			    int i_2545_;
			    if ((i_2545_ = (1 + i_2541_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_2543_)
				i_2543_ = i_2545_;
				...
				int i_2549_ = (this.anIntArray9966[((i_2542_ >> 12) * this.anInt9010 + (i_2541_ >> 12))]);
				if (i_2549_ != 0)
		...
		while (i_2550_ < 0) {
			...
			int i_2557_;
			if ((i_2557_ = (1 + i_2553_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_2555_)
			    i_2555_ = i_2557_;
			if ((i_2557_ = i_2554_ - (this.anInt8989 << 12)) >= 0) {
			...
			for (/**/; i_2555_ < 0; i_2555_++) {
			    int i_2561_ = (this.anIntArray9966[(((i_2554_ >> 12) * this.anInt9010) + (i_2553_ >> 12))]);
			    if (i_2561_ != 0)
		...
		while (i_2562_ < 0) {
			...
			int i_2569_;
			if ((i_2569_ = (1 + i_2565_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_2567_)
			    i_2567_ = i_2569_;
			if (i_2566_ < 0) {
			...
			if ((i_2569_ = (1 + i_2566_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_2567_)
			    i_2567_ = i_2569_;
			...
			for (/**/; i_2567_ < 0; i_2567_++) {
			    int i_2573_ = (this.anIntArray9966[(((i_2566_ >> 12) * this.anInt9010) + (i_2565_ >> 12))]);
			    if (i_2573_ != 0)
	...
	if (is != null) {
		...
		if (anInt8991 == 0) {
			...
			if (i_2578_ >= 0 && i_2579_ >= 0 && i_2578_ - (this.anInt9010 << 12) < 0 && i_2579_ - (this.anInt8989 << 12) < 0) {
			    for (/**/; i_2580_ < 0; i_2580_++) {
				int i_2581_ = (((i_2579_ >> 12) * this.anInt9010) + (i_2578_ >> 12));
				int i_2582_ = i_2577_++;
				if (i_2575_ == 0) {
				    if (i == 1)
					is[i_2582_] = (this.anIntArray9966[i_2581_]);
				    else if (i == 0) {
					int i_2583_ = (this.anIntArray9966[i_2581_++]);
					...
					int i_2587_ = (this.anIntArray9966[i_2581_++]);
					...
					int i_2592_ = (this.anIntArray9966[i_2581_]);
				    ...
				    if (i == 1) {
					int i_2595_ = (this.anIntArray9966[i_2581_]);
					if (i_2595_ != 0)
					    is[i_2582_] = i_2595_;
				    } else if (i == 0) {
					int i_2596_ = (this.anIntArray9966[i_2581_]);
					if (i_2596_ != 0) {
					    if ((anInt9014 & 0xffffff) == 16777215) {
					...
					int i_2607_ = (this.anIntArray9966[i_2581_]);
					...
					int i_2612_ = (this.anIntArray9966[i_2581_]);
					if (i_2612_ != 0) {
				    ...
				    if (i == 1) {
					int i_2615_ = (this.anIntArray9966[i_2581_]);
					if (i_2615_ != 0) {
					...
					int i_2619_ = (this.anIntArray9966[i_2581_]);
					if (i_2619_ != 0) {
					...
					int i_2626_ = (this.anIntArray9966[i_2581_]);
					...
					int i_2631_ = (this.anIntArray9966[i_2581_]);
					if (i_2631_ != 0) {
			...
			if (i_2639_ >= 0 && i_2639_ - (this.anInt9010 << 12) < 0) {
			    int i_2642_;
			    if ((i_2642_ = (i_2640_ - (this.anInt8989 << 12))) >= 0) {
				...
				int i_2643_ = (((i_2640_ >> 12) * this.anInt9010) + (i_2639_ >> 12));
				int i_2644_ = i_2638_++;
				if (i_2575_ == 0) {
				    if (i == 1)
					is[i_2644_] = (this.anIntArray9966[i_2643_]);
				    else if (i == 0) {
					int i_2645_ = (this.anIntArray9966[i_2643_++]);
					...
					int i_2649_ = (this.anIntArray9966[i_2643_++]);
					...
					int i_2654_ = (this.anIntArray9966[i_2643_]);
				    ...
				    if (i == 1) {
					int i_2657_ = (this.anIntArray9966[i_2643_]);
					if (i_2657_ != 0)
					    is[i_2644_] = i_2657_;
				    } else if (i == 0) {
					int i_2658_ = (this.anIntArray9966[i_2643_]);
					if (i_2658_ != 0) {
					    if ((anInt9014 & 0xffffff) == 16777215) {
					...
					int i_2669_ = (this.anIntArray9966[i_2643_]);
					...
					int i_2674_ = (this.anIntArray9966[i_2643_]);
					if (i_2674_ != 0) {
				    ...
				    if (i == 1) {
					int i_2677_ = (this.anIntArray9966[i_2643_]);
					if (i_2677_ != 0) {
					...
					int i_2681_ = (this.anIntArray9966[i_2643_]);
					if (i_2681_ != 0) {
					...
					int i_2688_ = (this.anIntArray9966[i_2643_]);
					...
					int i_2693_ = (this.anIntArray9966[i_2643_]);
					if (i_2693_ != 0) {
			...
			if (i_2701_ >= 0 && i_2701_ - (this.anInt9010 << 12) < 0) {
			    if (i_2702_ < 0) {
			    ...
			    int i_2705_;
			    if ((i_2705_ = (1 + i_2702_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_2703_)
				i_2703_ = i_2705_;
			    for (/**/; i_2703_ < 0; i_2703_++) {
				int i_2706_ = (((i_2702_ >> 12) * this.anInt9010) + (i_2701_ >> 12));
				int i_2707_ = i_2700_++;
				if (i_2575_ == 0) {
				    if (i == 1)
					is[i_2707_] = (this.anIntArray9966[i_2706_]);
				    else if (i == 0) {
					int i_2708_ = (this.anIntArray9966[i_2706_++]);
					...
					int i_2712_ = (this.anIntArray9966[i_2706_++]);
					...
					int i_2717_ = (this.anIntArray9966[i_2706_]);
				    ...
				    if (i == 1) {
					int i_2720_ = (this.anIntArray9966[i_2706_]);
					if (i_2720_ != 0)
					    is[i_2707_] = i_2720_;
				    } else if (i == 0) {
					int i_2721_ = (this.anIntArray9966[i_2706_]);
					if (i_2721_ != 0) {
					    if ((anInt9014 & 0xffffff) == 16777215) {
					...
					int i_2732_ = (this.anIntArray9966[i_2706_]);
					...
					int i_2737_ = (this.anIntArray9966[i_2706_]);
					if (i_2737_ != 0) {
				    ...
				    if (i == 1) {
					int i_2740_ = (this.anIntArray9966[i_2706_]);
					if (i_2740_ != 0) {
					...
					int i_2744_ = (this.anIntArray9966[i_2706_]);
					if (i_2744_ != 0) {
					...
					int i_2751_ = (this.anIntArray9966[i_2706_]);
					...
					int i_2756_ = (this.anIntArray9966[i_2706_]);
					if (i_2756_ != 0) {
		...
		if (anInt8991 == 0) {
			...
			if (i_2765_ >= 0 && i_2765_ - (this.anInt8989 << 12) < 0) {
			    int i_2767_;
			    if ((i_2767_ = (i_2764_ - (this.anInt9010 << 12))) >= 0) {
				...
				int i_2768_ = (((i_2765_ >> 12) * this.anInt9010) + (i_2764_ >> 12));
				int i_2769_ = i_2763_++;
				if (i_2575_ == 0) {
				    if (i == 1)
					is[i_2769_] = (this.anIntArray9966[i_2768_]);
				    else if (i == 0) {
					int i_2770_ = (this.anIntArray9966[i_2768_++]);
					...
					int i_2774_ = (this.anIntArray9966[i_2768_++]);
					...
					int i_2779_ = (this.anIntArray9966[i_2768_]);
				    ...
				    if (i == 1) {
					int i_2782_ = (this.anIntArray9966[i_2768_]);
					if (i_2782_ != 0)
					    is[i_2769_] = i_2782_;
				    } else if (i == 0) {
					int i_2783_ = (this.anIntArray9966[i_2768_]);
					if (i_2783_ != 0) {
					    if ((anInt9014 & 0xffffff) == 16777215) {
					...
					int i_2794_ = (this.anIntArray9966[i_2768_]);
					...
					int i_2799_ = (this.anIntArray9966[i_2768_]);
					if (i_2799_ != 0) {
				    ...
				    if (i == 1) {
					int i_2802_ = (this.anIntArray9966[i_2768_]);
					if (i_2802_ != 0) {
					...
					int i_2806_ = (this.anIntArray9966[i_2768_]);
					if (i_2806_ != 0) {
					...
					int i_2813_ = (this.anIntArray9966[i_2768_]);
					...
					int i_2818_ = (this.anIntArray9966[i_2768_]);
					if (i_2818_ != 0) {
			...
			int i_2829_;
			if ((i_2829_ = i_2826_ - (this.anInt9010 << 12)) >= 0) {
			...
			if ((i_2829_ = (i_2826_ - anInt9004) / anInt9004) > i_2828_)
			    i_2828_ = i_2829_;
			if ((i_2829_ = i_2827_ - (this.anInt8989 << 12)) >= 0) {
			...
			for (/**/; i_2828_ < 0; i_2828_++) {
			    int i_2830_ = (((i_2827_ >> 12) * this.anInt9010) + (i_2826_ >> 12));
			    int i_2831_ = i_2825_++;
			    if (i_2575_ == 0) {
				if (i == 1)
				    is[i_2831_] = (this.anIntArray9966[i_2830_]);
				else if (i == 0) {
				    int i_2832_ = (this.anIntArray9966[i_2830_++]);
				    ...
				    int i_2836_ = (this.anIntArray9966[i_2830_++]);
				    ...
				    int i_2841_ = (this.anIntArray9966[i_2830_]);
				...
				if (i == 1) {
				    int i_2844_ = (this.anIntArray9966[i_2830_]);
				    if (i_2844_ != 0)
					is[i_2831_] = i_2844_;
				} else if (i == 0) {
				    int i_2845_ = (this.anIntArray9966[i_2830_]);
				    if (i_2845_ != 0) {
					if ((anInt9014 & 0xffffff) == 16777215) {
				    ...
				    int i_2856_ = (this.anIntArray9966[i_2830_]);
				    ...
				    int i_2861_ = (this.anIntArray9966[i_2830_]);
				    if (i_2861_ != 0) {
				...
				if (i == 1) {
				    int i_2864_ = (this.anIntArray9966[i_2830_]);
				    if (i_2864_ != 0) {
				    ...
				    int i_2868_ = (this.anIntArray9966[i_2830_]);
				    if (i_2868_ != 0) {
				    ...
				    int i_2875_ = (this.anIntArray9966[i_2830_]);
				    ...
				    int i_2880_ = (this.anIntArray9966[i_2830_]);
				    if (i_2880_ != 0) {
			...
			int i_2891_;
			if ((i_2891_ = i_2888_ - (this.anInt9010 << 12)) >= 0) {
			...
			if ((i_2891_ = (1 + i_2889_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_2890_)
			    i_2890_ = i_2891_;
			for (/**/; i_2890_ < 0; i_2890_++) {
			    int i_2892_ = (((i_2889_ >> 12) * this.anInt9010) + (i_2888_ >> 12));
			    int i_2893_ = i_2887_++;
			    if (i_2575_ == 0) {
				if (i == 1)
				    is[i_2893_] = (this.anIntArray9966[i_2892_]);
				else if (i == 0) {
				    int i_2894_ = (this.anIntArray9966[i_2892_++]);
				    ...
				    int i_2898_ = (this.anIntArray9966[i_2892_++]);
				    ...
				    int i_2903_ = (this.anIntArray9966[i_2892_]);
				...
				if (i == 1) {
				    int i_2906_ = (this.anIntArray9966[i_2892_]);
				    if (i_2906_ != 0)
					is[i_2893_] = i_2906_;
				} else if (i == 0) {
				    int i_2907_ = (this.anIntArray9966[i_2892_]);
				    if (i_2907_ != 0) {
					if ((anInt9014 & 0xffffff) == 16777215) {
				    ...
				    int i_2918_ = (this.anIntArray9966[i_2892_]);
				    ...
				    int i_2923_ = (this.anIntArray9966[i_2892_]);
				    if (i_2923_ != 0) {
				...
				if (i == 1) {
				    int i_2926_ = (this.anIntArray9966[i_2892_]);
				    if (i_2926_ != 0) {
				    ...
				    int i_2930_ = (this.anIntArray9966[i_2892_]);
				    if (i_2930_ != 0) {
				    ...
				    int i_2937_ = (this.anIntArray9966[i_2892_]);
				    ...
				    int i_2942_ = (this.anIntArray9966[i_2892_]);
				    if (i_2942_ != 0) {
		...
		while (i_2948_ < 0) {
		    ...
		    if (i_2951_ >= 0 && i_2951_ - (this.anInt8989 << 12) < 0) {
			if (i_2950_ < 0) {
			...
			int i_2954_;
			if ((i_2954_ = (1 + i_2950_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_2952_)
			    i_2952_ = i_2954_;
			for (/**/; i_2952_ < 0; i_2952_++) {
			    int i_2955_ = (((i_2951_ >> 12) * this.anInt9010) + (i_2950_ >> 12));
			    int i_2956_ = i_2949_++;
			    if (i_2575_ == 0) {
				if (i == 1)
				    is[i_2956_] = (this.anIntArray9966[i_2955_]);
				else if (i == 0) {
				    int i_2957_ = (this.anIntArray9966[i_2955_++]);
				    ...
				    int i_2961_ = (this.anIntArray9966[i_2955_++]);
				    ...
				    int i_2966_ = (this.anIntArray9966[i_2955_]);
				...
				if (i == 1) {
				    int i_2969_ = (this.anIntArray9966[i_2955_]);
				    if (i_2969_ != 0)
					is[i_2956_] = i_2969_;
				} else if (i == 0) {
				    int i_2970_ = (this.anIntArray9966[i_2955_]);
				    if (i_2970_ != 0) {
					if ((anInt9014 & 0xffffff) == 16777215) {
				    ...
				    int i_2981_ = (this.anIntArray9966[i_2955_]);
				    ...
				    int i_2986_ = (this.anIntArray9966[i_2955_]);
				    if (i_2986_ != 0) {
				...
				if (i == 1) {
				    int i_2989_ = (this.anIntArray9966[i_2955_]);
				    if (i_2989_ != 0) {
				    ...
				    int i_2993_ = (this.anIntArray9966[i_2955_]);
				    if (i_2993_ != 0) {
				    ...
				    int i_3000_ = (this.anIntArray9966[i_2955_]);
				    ...
				    int i_3005_ = (this.anIntArray9966[i_2955_]);
				    if (i_3005_ != 0) {
		...
		for (int i_3011_ = anInt9001; i_3011_ < 0; i_3011_++) {
		    ...
		    int i_3017_;
		    if ((i_3017_ = (1 + i_3013_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3015_)
			i_3015_ = i_3017_;
		    if ((i_3017_ = i_3014_ - (this.anInt8989 << 12)) >= 0) {
			...
			int i_3018_ = (((i_3014_ >> 12) * this.anInt9010) + (i_3013_ >> 12));
			int i_3019_ = i_3012_++;
			if (i_2575_ == 0) {
			    if (i == 1)
				is[i_3019_] = (this.anIntArray9966[i_3018_]);
			    else if (i == 0) {
				int i_3020_ = (this.anIntArray9966[i_3018_++]);
				...
				int i_3024_ = (this.anIntArray9966[i_3018_++]);
				...
				int i_3029_ = (this.anIntArray9966[i_3018_]);
			    ...
			    if (i == 1) {
				int i_3032_ = (this.anIntArray9966[i_3018_]);
				if (i_3032_ != 0)
				    is[i_3019_] = i_3032_;
			    } else if (i == 0) {
				int i_3033_ = (this.anIntArray9966[i_3018_]);
				if (i_3033_ != 0) {
				    if ((anInt9014 & 0xffffff) == 16777215) {
				...
				int i_3044_ = (this.anIntArray9966[i_3018_]);
				...
				int i_3049_ = (this.anIntArray9966[i_3018_]);
				if (i_3049_ != 0) {
			    ...
			    if (i == 1) {
				int i_3052_ = (this.anIntArray9966[i_3018_]);
				if (i_3052_ != 0) {
				...
				int i_3056_ = (this.anIntArray9966[i_3018_]);
				if (i_3056_ != 0) {
				...
				int i_3063_ = (this.anIntArray9966[i_3018_]);
				...
				int i_3068_ = (this.anIntArray9966[i_3018_]);
				if (i_3068_ != 0) {
		...
		for (int i_3074_ = anInt9001; i_3074_ < 0; i_3074_++) {
		    ...
		    int i_3080_;
		    if ((i_3080_ = (1 + i_3076_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3078_)
			i_3078_ = i_3080_;
		    if (i_3077_ < 0) {
		    ...
		    if ((i_3080_ = (1 + i_3077_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_3078_)
			i_3078_ = i_3080_;
		    for (/**/; i_3078_ < 0; i_3078_++) {
			int i_3081_ = (((i_3077_ >> 12) * this.anInt9010) + (i_3076_ >> 12));
			int i_3082_ = i_3075_++;
			if (i_2575_ == 0) {
			    if (i == 1)
				is[i_3082_] = (this.anIntArray9966[i_3081_]);
			    else if (i == 0) {
				int i_3083_ = (this.anIntArray9966[i_3081_++]);
				...
				int i_3087_ = (this.anIntArray9966[i_3081_++]);
				...
				int i_3092_ = (this.anIntArray9966[i_3081_]);
			    ...
			    if (i == 1) {
				int i_3095_ = (this.anIntArray9966[i_3081_]);
				if (i_3095_ != 0)
				    is[i_3082_] = i_3095_;
			    } else if (i == 0) {
				int i_3096_ = (this.anIntArray9966[i_3081_]);
				if (i_3096_ != 0) {
				    if ((anInt9014 & 0xffffff) == 16777215) {
				...
				int i_3107_ = (this.anIntArray9966[i_3081_]);
				...
				int i_3112_ = (this.anIntArray9966[i_3081_]);
				if (i_3112_ != 0) {
			    ...
			    if (i == 1) {
				int i_3115_ = (this.anIntArray9966[i_3081_]);
				if (i_3115_ != 0) {
				...
				int i_3119_ = (this.anIntArray9966[i_3081_]);
				if (i_3119_ != 0) {
				...
				int i_3126_ = (this.anIntArray9966[i_3081_]);
				...
				int i_3131_ = (this.anIntArray9966[i_3081_]);
				if (i_3131_ != 0) {
	...
	int[] is_3139_ = (this.aClass_ra_Sub1_9006.anIntArray7967);
	if (is_3139_ != null) {
	    if (anInt9004 == 0) {
		if (anInt8991 == 0) {
			...
			if (i_3141_ >= 0) {
			    ...
			    if (i_3143_ >= 0 && i_3144_ >= 0 && (i_3143_ - (this.anInt9010 << 12)) < 0 && (i_3144_ - (this.anInt8989 << 12)) < 0) {
				...
				for (/**/; i_3145_ < 0; i_3145_++) {
				    int i_3149_ = (this.anIntArray9966[(((i_3144_ >> 12) * (this.anInt9010)) + (i_3143_ >> 12))]);
				    if (i_3149_ != 0)
			...
			if (i_3151_ >= 0) {
			    ...
			    if (i_3153_ >= 0 && (i_3153_ - (this.anInt9010 << 12)) < 0) {
				int i_3156_;
				if ((i_3156_ = (i_3154_ - (this.anInt8989 << 12))) >= 0) {
				...
				for (/**/; i_3155_ < 0; i_3155_++) {
				    int i_3160_ = (this.anIntArray9966[(((i_3154_ >> 12) * (this.anInt9010)) + (i_3153_ >> 12))]);
				    if (i_3160_ != 0)
			...
			if (i_3162_ >= 0) {
			    ...
			    if (i_3164_ >= 0 && (i_3164_ - (this.anInt9010 << 12)) < 0) {
				if (i_3165_ < 0) {
				...
				int i_3168_;
				if ((i_3168_ = (1 + i_3165_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_3166_)
				    i_3166_ = i_3168_;
				...
				for (/**/; i_3166_ < 0; i_3166_++) {
				    int i_3172_ = (this.anIntArray9966[(((i_3165_ >> 12) * (this.anInt9010)) + (i_3164_ >> 12))]);
				    if (i_3172_ != 0)
		...
		if (anInt8991 == 0) {
			...
			if (i_3174_ >= 0) {
			    ...
			    if (i_3177_ >= 0 && (i_3177_ - (this.anInt8989 << 12)) < 0) {
				int i_3179_;
				if ((i_3179_ = (i_3176_ - (this.anInt9010 << 12))) >= 0) {
				...
				for (/**/; i_3178_ < 0; i_3178_++) {
				    int i_3183_ = (this.anIntArray9966[(((i_3177_ >> 12) * (this.anInt9010)) + (i_3176_ >> 12))]);
				    if (i_3183_ != 0)
			...
			if (i_3185_ >= 0) {
			    ...
			    int i_3190_;
			    if ((i_3190_ = (i_3187_ - (this.anInt9010 << 12))) >= 0) {
				...
				i_3189_ = i_3190_;
			    if ((i_3190_ = (i_3188_ - (this.anInt8989 << 12))) >= 0) {
				...
				int i_3194_ = (this.anIntArray9966[((i_3188_ >> 12) * this.anInt9010 + (i_3187_ >> 12))]);
				if (i_3194_ != 0)
			...
			if (i_3196_ >= 0) {
			    ...
			    int i_3201_;
			    if ((i_3201_ = (i_3198_ - (this.anInt9010 << 12))) >= 0) {
			    ...
			    if ((i_3201_ = (1 + i_3199_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_3200_)
				i_3200_ = i_3201_;
				...
				int i_3205_ = (this.anIntArray9966[((i_3199_ >> 12) * this.anInt9010 + (i_3198_ >> 12))]);
				if (i_3205_ != 0)
		...
		while (i_3206_ < 0) {
			...
			if (i_3210_ >= 0 && i_3210_ - (this.anInt8989 << 12) < 0) {
			    if (i_3209_ < 0) {
			    ...
			    int i_3213_;
			    if ((i_3213_ = (1 + i_3209_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3211_)
				i_3211_ = i_3213_;
				...
				int i_3217_ = (this.anIntArray9966[((i_3210_ >> 12) * this.anInt9010 + (i_3209_ >> 12))]);
				if (i_3217_ != 0)
		...
		while (i_3218_ < 0) {
			...
			int i_3225_;
			if ((i_3225_ = (1 + i_3221_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3223_)
			    i_3223_ = i_3225_;
			if ((i_3225_ = i_3222_ - (this.anInt8989 << 12)) >= 0) {
			...
			for (/**/; i_3223_ < 0; i_3223_++) {
			    int i_3229_ = (this.anIntArray9966[(((i_3222_ >> 12) * this.anInt9010) + (i_3221_ >> 12))]);
			    if (i_3229_ != 0)
		...
		while (i_3230_ < 0) {
			...
			int i_3237_;
			if ((i_3237_ = (1 + i_3233_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3235_)
			    i_3235_ = i_3237_;
			if (i_3234_ < 0) {
			...
			if ((i_3237_ = (1 + i_3234_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_3235_)
			    i_3235_ = i_3237_;
			...
			for (/**/; i_3235_ < 0; i_3235_++) {
			    int i_3241_ = (this.anIntArray9966[(((i_3234_ >> 12) * this.anInt9010) + (i_3233_ >> 12))]);
			    if (i_3241_ != 0)
	...
	int[] is_3244_ = (this.aClass_ra_Sub1_9006.anIntArray7967);
	if (is_3244_ != null) {
	    if (anInt9004 == 0) {
		if (anInt8991 == 0) {
			...
			if (i_3246_ >= 0) {
			    ...
			    if (i_3248_ >= 0 && i_3249_ >= 0 && (i_3248_ - (this.anInt9010 << 12)) < 0 && (i_3249_ - (this.anInt8989 << 12)) < 0) {
				...
				for (/**/; i_3250_ < 0; i_3250_++) {
				    int i_3254_ = (this.anIntArray9966[(((i_3249_ >> 12) * (this.anInt9010)) + (i_3248_ >> 12))]);
				    if (i_3254_ != 0)
			...
			if (i_3256_ >= 0) {
			    ...
			    if (i_3258_ >= 0 && (i_3258_ - (this.anInt9010 << 12)) < 0) {
				int i_3261_;
				if ((i_3261_ = (i_3259_ - (this.anInt8989 << 12))) >= 0) {
				...
				for (/**/; i_3260_ < 0; i_3260_++) {
				    int i_3265_ = (this.anIntArray9966[(((i_3259_ >> 12) * (this.anInt9010)) + (i_3258_ >> 12))]);
				    if (i_3265_ != 0)
			...
			if (i_3267_ >= 0) {
			    ...
			    if (i_3269_ >= 0 && (i_3269_ - (this.anInt9010 << 12)) < 0) {
				if (i_3270_ < 0) {
				...
				int i_3273_;
				if ((i_3273_ = (1 + i_3270_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_3271_)
				    i_3271_ = i_3273_;
				...
				for (/**/; i_3271_ < 0; i_3271_++) {
				    int i_3277_ = (this.anIntArray9966[(((i_3270_ >> 12) * (this.anInt9010)) + (i_3269_ >> 12))]);
				    if (i_3277_ != 0)
		...
		if (anInt8991 == 0) {
			...
			if (i_3279_ >= 0) {
			    ...
			    if (i_3282_ >= 0 && (i_3282_ - (this.anInt8989 << 12)) < 0) {
				int i_3284_;
				if ((i_3284_ = (i_3281_ - (this.anInt9010 << 12))) >= 0) {
				...
				for (/**/; i_3283_ < 0; i_3283_++) {
				    int i_3288_ = (this.anIntArray9966[(((i_3282_ >> 12) * (this.anInt9010)) + (i_3281_ >> 12))]);
				    if (i_3288_ != 0)
			...
			if (i_3290_ >= 0) {
			    ...
			    int i_3295_;
			    if ((i_3295_ = (i_3292_ - (this.anInt9010 << 12))) >= 0) {
				...
				i_3294_ = i_3295_;
			    if ((i_3295_ = (i_3293_ - (this.anInt8989 << 12))) >= 0) {
				...
				int i_3299_ = (this.anIntArray9966[((i_3293_ >> 12) * this.anInt9010 + (i_3292_ >> 12))]);
				if (i_3299_ != 0)
			...
			if (i_3301_ >= 0) {
			    ...
			    int i_3306_;
			    if ((i_3306_ = (i_3303_ - (this.anInt9010 << 12))) >= 0) {
			    ...
			    if ((i_3306_ = (1 + i_3304_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_3305_)
				i_3305_ = i_3306_;
				...
				int i_3310_ = (this.anIntArray9966[((i_3304_ >> 12) * this.anInt9010 + (i_3303_ >> 12))]);
				if (i_3310_ != 0)
		...
		while (i_3311_ < 0) {
			...
			if (i_3315_ >= 0 && i_3315_ - (this.anInt8989 << 12) < 0) {
			    if (i_3314_ < 0) {
			    ...
			    int i_3318_;
			    if ((i_3318_ = (1 + i_3314_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3316_)
				i_3316_ = i_3318_;
				...
				int i_3322_ = (this.anIntArray9966[((i_3315_ >> 12) * this.anInt9010 + (i_3314_ >> 12))]);
				if (i_3322_ != 0)
		...
		while (i_3323_ < 0) {
			...
			int i_3330_;
			if ((i_3330_ = (1 + i_3326_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3328_)
			    i_3328_ = i_3330_;
			if ((i_3330_ = i_3327_ - (this.anInt8989 << 12)) >= 0) {
			...
			for (/**/; i_3328_ < 0; i_3328_++) {
			    int i_3334_ = (this.anIntArray9966[(((i_3327_ >> 12) * this.anInt9010) + (i_3326_ >> 12))]);
			    if (i_3334_ != 0)
		...
		while (i_3335_ < 0) {
			...
			int i_3342_;
			if ((i_3342_ = (1 + i_3338_ - (this.anInt9010 << 12) - anInt9004) / anInt9004) > i_3340_)
			    i_3340_ = i_3342_;
			if (i_3339_ < 0) {
			...
			if ((i_3342_ = (1 + i_3339_ - (this.anInt8989 << 12) - anInt8991) / anInt8991) > i_3340_)
			    i_3340_ = i_3342_;
			...
			for (/**/; i_3340_ < 0; i_3340_++) {
			    int i_3346_ = (this.anIntArray9966[(((i_3339_ >> 12) * this.anInt9010) + (i_3338_ >> 12))]);
			    if (i_3346_ != 0)
	...
	for (int i_3352_ = 0; i_3352_ < i_3349_; i_3352_++) {
	    int i_3353_ = ((i_3347_ + i_3352_) * this.anInt9010 + i);
	    int i_3354_ = (((i_3351_ + i_3352_) * ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883)) + i_3350_);
	    for (int i_3355_ = 0; i_3355_ < i_3348_; i_3355_++)
		this.anIntArray9966[i_3353_ + i_3355_] = is[i_3354_ + i_3355_];
	}
    }
	...
	for (int i_3361_ = 0; i_3361_ < i_3358_; i_3361_++) {
	    int i_3362_ = ((i_3356_ + i_3361_) * this.anInt9010 + i);
	    int i_3363_ = (((i_3360_ + i_3361_) * ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883)) + i_3359_);
	    for (int i_3364_ = 0; i_3364_ < i_3357_; i_3364_++)
		this.anIntArray9966[i_3362_ + i_3364_] = is[i_3363_ + i_3364_];
	}
    }
	...
	int[] is = (this.aClass_ra_Sub1_9006.anIntArray7967);
	if (is != null) {
	    int i_3369_ = ((this.aClass_ra_Sub1_9006).anInt7971 * 692106883);
	    i += this.anInt8990;
	    i_3365_ += this.anInt9000;
	    int i_3370_ = i_3365_ * i_3369_ + i;
	    int i_3371_ = 0;
	    int i_3372_ = this.anInt8989;
	    int i_3373_ = this.anInt9010;
	    int i_3374_ = i_3369_ - i_3373_;
	    int i_3375_ = 0;
	    if (i_3365_ < ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805)) {
		int i_3376_ = (((this.aClass_ra_Sub1_9006).anInt7976) * -1278653805 - i_3365_);
		i_3372_ -= i_3376_;
		i_3365_ = ((this.aClass_ra_Sub1_9006).anInt7976 * -1278653805);
		i_3371_ += i_3376_ * i_3373_;
		i_3370_ += i_3376_ * i_3369_;
	    }
	    if (i_3365_ + i_3372_ > (this.aClass_ra_Sub1_9006.anInt7977 * 63686679))
		i_3372_ -= (i_3365_ + i_3372_ - (this.aClass_ra_Sub1_9006.anInt7977) * 63686679);
	    if (i < (this.aClass_ra_Sub1_9006.anInt7974 * -912871679)) {
		int i_3377_ = (((this.aClass_ra_Sub1_9006).anInt7974) * -912871679 - i);
		i_3373_ -= i_3377_;
		i = (this.aClass_ra_Sub1_9006.anInt7974 * -912871679);
		i_3371_ += i_3377_;
		i_3370_ += i_3377_;
	    ...
	    if (i + i_3373_ > (this.aClass_ra_Sub1_9006.anInt7991) * -1416794725) {
		int i_3378_ = (i + i_3373_ - ((this.aClass_ra_Sub1_9006).anInt7991) * -1416794725);
		i_3373_ -= i_3378_;
		i_3375_ += i_3378_;
		i_3374_ += i_3378_;
	    }
		...
		if (i_3368_ == 0) {
			...
			for (int i_3379_ = -i_3372_; i_3379_ < 0; i_3379_++) {
				...
				is[i_3370_++] = (this.anIntArray9966[i_3371_++]);
				is[i_3370_++] = (this.anIntArray9966[i_3371_++]);
				is[i_3370_++] = (this.anIntArray9966[i_3371_++]);
				is[i_3370_++] = (this.anIntArray9966[i_3371_++]);
			    }
			...
			for (int i_3384_ = -i_3372_; i_3384_ < 0; i_3384_++) {
				...
				int i_3386_ = (this.anIntArray9966[i_3371_++]);
			...
			for (int i_3390_ = -i_3372_; i_3390_ < 0; i_3390_++) {
				...
				int i_3392_ = (this.anIntArray9966[i_3371_++]);
			...
			for (int i_3400_ = -i_3372_; i_3400_ < 0; i_3400_++) {
				...
				int i_3402_ = (this.anIntArray9966[i_3371_++]);
			...
			for (int i_3403_ = -i_3372_; i_3403_ < 0; i_3403_++) {
				...
				int i_3405_ = (this.anIntArray9966[i_3371_++]);
				if (i_3405_ != 0)
				    is[i_3370_++] = i_3405_;
				else
				    i_3370_++;
				i_3405_ = (this.anIntArray9966[i_3371_++]);
				if (i_3405_ != 0)
				    is[i_3370_++] = i_3405_;
				else
				    i_3370_++;
			    ...
			    i_3404_ += 3;
			    while (i_3370_ < i_3404_) {
				int i_3406_ = (this.anIntArray9966[i_3371_++]);
				if (i_3406_ != 0)
				    is[i_3370_++] = i_3406_;
				else
				    i_3370_++;
			...
			if ((i_3367_ & 0xffffff) == 16777215) {
				...
				for (int i_3410_ = -i_3373_; i_3410_ < 0; i_3410_++) {
				    int i_3411_ = (this.anIntArray9966[i_3371_++]);
				    if (i_3411_ != 0) {
				...
				for (int i_3419_ = -i_3373_; i_3419_ < 0; i_3419_++) {
				    int i_3420_ = (this.anIntArray9966[i_3371_++]);
				    if (i_3420_ != 0) {
					if (i_3416_ != 255) {
			...
			for (int i_3430_ = -i_3372_; i_3430_ < 0; i_3430_++) {
				...
				int i_3432_ = (this.anIntArray9966[i_3371_++]);
			...
			for (int i_3440_ = -i_3372_; i_3440_ < 0; i_3440_++) {
				...
				int i_3442_ = (this.anIntArray9966[i_3371_++]);
				if (i_3442_ != 0) {
			...
			for (int i_3443_ = -i_3372_; i_3443_ < 0; i_3443_++) {
				...
				int i_3445_ = (this.anIntArray9966[i_3371_++]);
				if (i_3445_ != 0) {
			...
			for (int i_3452_ = -i_3372_; i_3452_ < 0; i_3452_++) {
				...
				int i_3454_ = (this.anIntArray9966[i_3371_++]);
				if (i_3454_ != 0) {
			...
			for (int i_3461_ = -i_3372_; i_3461_ < 0; i_3461_++) {
				...
				int i_3463_ = (this.anIntArray9966[i_3371_++]);
			...
			for (int i_3471_ = -i_3372_; i_3471_ < 0; i_3471_++) {
				...
				int i_3473_ = (this.anIntArray9966[i_3371_++]);
				if (i_3473_ != 0) {
