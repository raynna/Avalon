...
public class Class30_Sub2 extends Class30 {
	...
	if (bool && this.anInt372 != 34037) {
	    method412(i, Class_ra_Sub2.method5274((this.aClass55_377), (this.aClass77_378)), i_0_, i_1_, class55_2_, is);
	    method414(true);
	} else {
	    OpenGL.glTexImage2Dub(this.anInt372, 0, Class_ra_Sub2.method5274(this.aClass55_377, this.aClass77_378), this.anInt6746, this.anInt6747, 0, Class_ra_Sub2.method5228(class55_2_), 5121, is, 0);
	    method414(false);
	}
	...
	this.aClass_ra_Sub2_381.method5256(this);
	if (this.anInt372 == 34037 || !bool || i_11_ != 0 || i_12_ != 0) {
	    OpenGL.glPixelStorei(3314, i_11_);
	    OpenGL.glTexImage2Di(this.anInt372, 0, Class_ra_Sub2.method5274(this.aClass55_377, this.aClass77_378), this.anInt6746, this.anInt6747, 0, 32993, (this.aClass_ra_Sub2_381.anInt8186), is, i_12_ * 4);
	    OpenGL.glPixelStorei(3314, 0);
	    method414(false);
	} else {
	    method411(this.anInt372, Class_ra_Sub2.method5274((this.aClass55_377), (this.aClass77_378)), this.anInt6746, this.anInt6747, 32993, this.aClass_ra_Sub2_381.anInt8186, is);
	    method414(true);
	}
	method410(true);
    }
	...
	Class52 class52 = this.aClass_ra_Sub2_381.method4992((short) -5396);
	if (class52 != null) {
	    int i_24_ = class52.method552() - (i_23_ + i_21_);
	    this.aClass_ra_Sub2_381.method5256(this);
	    OpenGL.glCopyTexSubImage2D(this.anInt372, 0, i, (this.anInt6747 - (i_19_ + i_21_)), i_22_, i_24_, i_20_, i_21_);
	    OpenGL.glFlush();
	}
    }
	...
	this.anInt6746 = i_25_;
	this.anInt6747 = i_26_;
	this.aClass_ra_Sub2_381.method5256(this);
	if (bool && this.anInt372 != 34037) {
	    method415(i, Class_ra_Sub2.method5274((this.aClass55_377), (this.aClass77_378)), i_25_, i_26_, class55_27_, fs);
	    method414(true);
	} else {
	    OpenGL.glTexImage2Df(this.anInt372, 0, Class_ra_Sub2.method5274(this.aClass55_377, this.aClass77_378), this.anInt6746, this.anInt6747, 0, Class_ra_Sub2.method5228(class55_27_), 5126, fs, 0);
	    method414(false);
	}
	method410(true);
    }
	...
	if (this.anInt372 == 3553) {
	    this.aClass_ra_Sub2_381.method5256(this);
	    OpenGL.glTexParameteri(this.anInt372, 10242, bool ? 10497 : 33071);
	    OpenGL.glTexParameteri(this.anInt372, 10243, bool_28_ ? 10497 : 33071);
	}
    }
	...
	OpenGL.glTexSubImage2Dub(this.anInt372, 0, i, (this.anInt6747 - i_29_ - i_31_), i_30_, i_31_, Class_ra_Sub2.method5228(class55), 5121, is, i_32_);
	if (i_33_ != i_30_)
	    OpenGL.glPixelStorei(3314, 0);
	OpenGL.glPixelStorei(3317, 4);
    }
	...
	OpenGL.glTexSubImage2Di(this.anInt372, 0, i, (this.anInt6747 - i_42_ - i_44_), i_43_, i_44_, 32993, (this.aClass_ra_Sub2_381.anInt8186), is, i_45_);
	if (i_43_ != i_46_)
	    OpenGL.glPixelStorei(3314, 0);
    }
	...
	this.anInt6746 = i_54_;
	this.anInt6747 = i_55_;
	this.aClass_ra_Sub2_381.method5256(this);
	Class52 class52 = this.aClass_ra_Sub2_381.method4992((short) -8855);
	if (class52 != null) {
	    int i_56_ = class52.method552() - (i_53_ + i_55_);
	    int i_57_ = Class_ra_Sub2.method5274(this.aClass55_377, this.aClass77_378);
	    OpenGL.glCopyTexImage2D(this.anInt372, 0, i_57_, i_52_, i_56_, i_54_, i_55_, 0);
	}
	method410(true);
    }
	...
	this.anInt6746 = i_58_;
	this.anInt6747 = i_59_;
	this.aClass_ra_Sub2_381.method5256(this);
	OpenGL.glTexImage2Dub(this.anInt372, 0, Class_ra_Sub2.method5274(this.aClass55_377, this.aClass77_378), i_58_, i_59_, 0, Class_ra_Sub2.method5228(this.aClass55_377), 5121, null, 0);
	method410(true);
    }
