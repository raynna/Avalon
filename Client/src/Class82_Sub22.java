...
public class Class82_Sub22 extends Class82 {
    ...
    boolean method939() {
	Class398 class398 = (Class158_Sub1.aClass389_8568.method4857(1632084697 * this.anInt6908, -1743709088));
	...
	if (i == 0) {
	    ...
	    this.anInt6905 = class298_sub53.readUnsignedShort() * -425099019;
	}
	if (0 == i_0_) {
	    ...
	    this.anInt6909 = class298_sub53.readUnsignedShort() * 514357691;
	}
	if (i == 0 && i_0_ == 0)
	    this.anInt6910 = class298_sub53.readUnsignedByte() * -776341541;
	else
	    this.anInt6910 = 776341541;
	this.anInt6908 = class298_sub53.readUnsignedShort() * 587513193;
	this.anInt6916 = class298_sub53.readUnsignedByte() * -479097679;
	this.anInt6912 = class298_sub53.readUnsignedByte() * -666257507;
	this.anInt6904 = class298_sub53.read24BitUnsignedInteger((byte) 75) * 856962157;
	this.anInt6915 = class298_sub53.readUnsignedShort() * 1304794705;
	this.anInt6914 = class298_sub53.readUnsignedByte() * -757238655;
    }

    @Override
    boolean method870(int i) {
	try {
	    Class398 class398 = Class158_Sub1.aClass389_8568.method4857((1632084697 * this.anInt6908), -1845152840);
	...
	Class365_Sub1_Sub1_Sub1 class365_sub1_sub1_sub1 = (new Class365_Sub1_Sub1_Sub1(client.aClass283_8716.method2675(-1611682495), this.anInt6908 * 1632084697, i_4_, i_4_, i, i_3_, this.anInt6916 * 266943569 << 2, client.ticketCycle * 443738891, (929559909 * this.anInt6904 + client.ticketCycle * 443738891), -1300008271 * this.anInt6915, i_7_, this.anInt6905 * -153670819 + 1, 1 + -1629854861 * this.anInt6909, this.anInt6912 * 172590773 << 2, false, 0));
	class365_sub1_sub1_sub1.method4405(i_5_, i_6_, 172590773 * this.anInt6912 << 2, (client.ticketCycle * 443738891 + 929559909 * this.anInt6904), -414343918);
	...
	class365_sub1_sub1_sub1.method4405(i_10_, i_11_, 172590773 * this.anInt6912 << 2, (client.ticketCycle * 443738891 + 929559909 * this.anInt6904), 1238518641);
	client.aClass453_8824.add(new Class298_Sub37_Sub2(class365_sub1_sub1_sub1));
    }
	...
	try {
	    ...
	    class365_sub1_sub1_sub1.method4405(i_16_, i_17_, 172590773 * this.anInt6912 << 2, (client.ticketCycle * 443738891 + 929559909 * this.anInt6904), 1057769456);
	    client.aClass453_8824.add(new Class298_Sub37_Sub2(class365_sub1_sub1_sub1));
	}
	catch (RuntimeException runtimeexception) {
