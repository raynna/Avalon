...
public class Class368 {
	...
	for (int i_0_ = 0; i_0_ < 120; i_0_++) {
	    int i_1_ = i_0_ + 1;
	    int i_2_ = (int) (i_1_ + 300.0 * Math.pow(2.0, i_1_ / 7.0));
	    i += i_2_;
	    anIntArray4003[i_0_] = i / 4;
	}
    }

    static final void method4553(Class403 class403, byte i) {
	try {
	...
	try {
		...
		l = (l << 5) - l + charsequence.charAt(i_4_);
	    return l;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (i_7_ < i_5_ + Class301.anInt3221) {
		    i_7_ = Class301.anInt3221;
		    i_14_ = i_10_ / 2 + (i_5_ / 2 + Class301.anInt3221 + i_6_) + 5;
		} else if (i_7_ > Class301.anInt3256 - i_5_) {
		    i_7_ = Class301.anInt3256 - i_5_;
		    i_14_ = (Class301.anInt3256 - i_5_ / 2 - i_6_ - i_10_ / 2 - 5);
		}
		if (i_8_ < i_5_ + Class301.anInt3255) {
		    i_8_ = Class301.anInt3255;
		    i_15_ = i_5_ / 2 + (Class301.anInt3255 + i_6_);
		} else if (i_8_ > Class301.anInt3257 - i_5_) {
		    i_8_ = Class301.anInt3257 - i_5_;
    ...
    static final void method4557(Class403 class403, int i) {
	try {
	    Class390 class390 = (class403.aBoolean5261 ? class403.aClass390_5247 : class403.aClass390_5246);
	    IComponentDefinition class105 = class390.aClass105_4168;
	    Class119 class119 = class390.aClass119_4167;
