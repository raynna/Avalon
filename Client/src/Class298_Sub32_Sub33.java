...
public class Class298_Sub32_Sub33 extends Class298_Sub32 {
	...
	switch (i) {
	    case 6:
		this.anInt9531 = class298_sub53.readUnsignedByte() * 1663137711;
		break;
	    case 7:
		this.anInt9532 = class298_sub53.readUnsignedShort() * 741927281;
		break;
	    case 1:
		this.anInt9526 = class298_sub53.readUnsignedShort() * -8002361;
		break;
	    case 0:
		this.anInt9525 = class298_sub53.readUnsignedByte() * -653192821;
		break;
	    case 4:
		this.anInt9519 = class298_sub53.readUnsignedShort() * 1340421019;
		break;
	    case 3:
		this.anInt9528 = class298_sub53.readUnsignedShort() * -2128158391;
		break;
	    case 5:
		this.anInt9530 = class298_sub53.readUnsignedShort() * -420846851;
		break;
	    case 2:
		this.anInt9523 = class298_sub53.readUnsignedShort() * 334398233;
		break;
	    case 8:
		this.anInt9533 = class298_sub53.readUnsignedShort() * 1393727635;
		break;
	}
    }
	...
	try {
		...
		int i_8_ = 0;
		int i_9_ = 0;
		int i_10_ = ((1499569399 * this.anInt9526 * (-1474554145 * Class250.anInt2755)) >> 12);
		int i_11_ = ((Class250.anInt2755 * -1474554145 * (-235001559 * this.anInt9523)) >> 12);
		int i_12_ = ((Class250.anInt2756 * 461985445 * (-1432887047 * this.anInt9528)) >> 12);
		int i_13_ = ((Class250.anInt2756 * 461985445 * (this.anInt9519 * 467335827)) >> 12);
		if (i_13_ <= 1)
		    return is_1_[i];
		this.anInt9534 = ((-1474554145 * Class250.anInt2755 / 8 * (this.anInt9530 * -1630516651)) >> 12) * 800544861;
		int i_14_ = 1 + -1474554145 * Class250.anInt2755 / i_10_;
		int[][] is_15_ = new int[i_14_][3];
		int[][] is_16_ = new int[i_14_][3];
		Random random = new Random((this.anInt9525) * -2017522141);
		for (;;) {
	...
	if (aClass257_7384.aBoolean2810) {
	    ...
	    int i_48_ = 0;
	    int i_49_ = 0;
	    int i_50_ = ((1499569399 * this.anInt9526 * (-1474554145 * Class250.anInt2755)) >> 12);
	    int i_51_ = ((Class250.anInt2755 * -1474554145 * (-235001559 * this.anInt9523)) >> 12);
	    int i_52_ = ((Class250.anInt2756 * 461985445 * (-1432887047 * this.anInt9528)) >> 12);
	    int i_53_ = ((Class250.anInt2756 * 461985445 * (this.anInt9519 * 467335827)) >> 12);
	    if (i_53_ <= 1)
		return is_41_[i];
	    this.anInt9534 = ((-1474554145 * Class250.anInt2755 / 8 * (this.anInt9530 * -1630516651)) >> 12) * 800544861;
	...
	if (aClass257_7384.aBoolean2810) {
	    ...
	    int i_89_ = 0;
	    int i_90_ = 0;
	    int i_91_ = ((1499569399 * this.anInt9526 * (-1474554145 * Class250.anInt2755)) >> 12);
	    int i_92_ = ((Class250.anInt2755 * -1474554145 * (-235001559 * this.anInt9523)) >> 12);
	    int i_93_ = ((Class250.anInt2756 * 461985445 * (-1432887047 * this.anInt9528)) >> 12);
	    int i_94_ = ((Class250.anInt2756 * 461985445 * (this.anInt9519 * 467335827)) >> 12);
	    if (i_94_ <= 1)
		return is_82_[i];
	    this.anInt9534 = ((-1474554145 * Class250.anInt2755 / 8 * (this.anInt9530 * -1630516651)) >> 12) * 800544861;
	...
	try {
	    int i_126_ = (this.anInt9533 * -2052438629 > 0 ? (4096 - Class298_Sub19_Sub3.method3039(random, (this.anInt9533 * -2052438629), (byte) 90)) : 4096);
	    int i_127_ = ((908540917 * this.anInt9534 * (this.anInt9532 * 19183505)) >> 12);
	    int i_128_ = (this.anInt9534 * 908540917 - (i_127_ > 0 ? Class298_Sub19_Sub3.method3039(random, i_127_, (byte) -95) : 0));
		...
		if (i_124_ > 0 && i_123_ > 0) {
			...
			if (i_135_ < i_132_) {
			    ...
			    if ((this.anInt9531 * 1833451343) == 0) {
	...
	super(0, true);
	this.anInt9523 = 1947781120;
	this.anInt9528 = 1461579169;
	this.anInt9519 = -1706813215;
	this.anInt9530 = -1450445824;
	this.anInt9531 = 0;
	this.anInt9532 = -475675648;
	this.anInt9533 = 1247955968;
    }
