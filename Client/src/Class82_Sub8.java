...
public class Class82_Sub8 extends Class82 {
	...
	try {
	    Class298_Sub35 class298_sub35 = ((Class298_Sub35) Class87.aClass437_793.method5812(8017746467363524815L * (this.aLong6853)));
	    if (class298_sub35 != null)
		class298_sub35.anInt7394 = -1178949921 * this.anInt6854;
	    else
		Class87.aClass437_793.method5817(new Class298_Sub35(825940513 * this.anInt6854), this.aLong6853 * 8017746467363524815L);
	}
	...
	if (bool)
	    this.aLong6853 = (0x100000000L | i) * -3845001125918771665L;
	else
	    this.aLong6853 = i * -3845001125918771665L;
	this.anInt6854 = class298_sub53.readInt((byte) -88) * -914937375;
    }
    ...
    static final void method892(Class403 class403, byte i) {
	try {
    ...
    static final void method894(Class403 class403, int i) {
	try {
	    int i_2_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7570.method5612(i_2_, 1352882135);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(6, i);
	    class298_sub37_sub12.method3449((byte) 15);
	    class298_sub37_sub12.type = i_3_ * 1274450087;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method897(Class403 class403, byte i) {
	try {
		...
		class298_sub36.out.writeInt(-1351839083 * Class117.anInt1399, -933492277);
