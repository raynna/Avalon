...
public class Class298_Sub32_Sub28 extends Class298_Sub32 {
	...
	try {
		...
		int i_1_ = 1 + (1615726345 * this.anInt9500 + (1615726345 * this.anInt9500));
		int i_2_ = 65536 / i_1_;
		int i_3_ = 1 + (this.anInt9499 * 484472729 + (484472729 * this.anInt9499));
		int i_4_ = 65536 / i_3_;
		int[][] is_5_ = new int[i_1_][];
		for (int i_6_ = i - 1615726345 * (this.anInt9500); (i_6_ <= (this.anInt9500 * 1615726345 + i)); i_6_++) {
		    int[] is_7_ = method3129(0, i_6_ & Class250.anInt2758 * -289063255, -1887337990);
		    int[] is_8_ = new int[Class250.anInt2755 * -1474554145];
		    int i_9_ = 0;
		    for (int i_10_ = -(this.anInt9499 * 484472729); i_10_ <= (484472729 * this.anInt9499); i_10_++)
			i_9_ += is_7_[i_10_ & -901777799 * Class250.anInt2753];
		    int i_11_ = 0;
		    while (i_11_ < Class250.anInt2755 * -1474554145) {
			is_8_[i_11_] = i_4_ * i_9_ >> 16;
			i_9_ -= is_7_[(i_11_ - (484472729 * (this.anInt9499)) & -901777799 * Class250.anInt2753)];
			i_11_++;
			i_9_ += is_7_[(i_11_ + (484472729 * (this.anInt9499)) & Class250.anInt2753 * -901777799)];
		    }
		    is_5_[(1615726345 * this.anInt9500 + i_6_ - i)] = is_8_;
		}
	...
	try {
		...
		int i_16_ = (1615726345 * this.anInt9500 + 1615726345 * this.anInt9500 + 1);
		int i_17_ = 65536 / i_16_;
		int i_18_ = 1 + (this.anInt9499 * 484472729 + (484472729 * this.anInt9499));
		int i_19_ = 65536 / i_18_;
		int[][][] is_20_ = new int[i_16_][][];
		for (int i_21_ = i - 1615726345 * this.anInt9500; (i_21_ <= (1615726345 * this.anInt9500 + i)); i_21_++) {
		    ...
		    int[] is_28_ = is_22_[1];
		    int[] is_29_ = is_22_[2];
		    for (int i_30_ = -(484472729 * this.anInt9499); i_30_ <= (484472729 * this.anInt9499); i_30_++) {
			...
			int i_36_ = (i_35_ - 484472729 * this.anInt9499 & Class250.anInt2753 * -901777799);
			i_24_ -= is_27_[i_36_];
			i_25_ -= is_28_[i_36_];
			i_26_ -= is_29_[i_36_];
			i_36_ = (++i_35_ + 484472729 * this.anInt9499 & Class250.anInt2753 * -901777799);
			i_24_ += is_27_[i_36_];
			i_25_ += is_28_[i_36_];
			i_26_ += is_29_[i_36_];
		    }
		    is_20_[1615726345 * (this.anInt9500) + i_21_ - i] = is_23_;
		}
		int[] is_37_ = is[0];
		int[] is_38_ = is[1];
		int[] is_39_ = is[2];
	...
	if (aClass257_7384.aBoolean2810) {
	    int i_46_ = 1 + (1615726345 * this.anInt9500 + 1615726345 * this.anInt9500);
	    int i_47_ = 65536 / i_46_;
	    int i_48_ = 1 + (this.anInt9499 * 484472729 + 484472729 * this.anInt9499);
	    int i_49_ = 65536 / i_48_;
	    int[][] is_50_ = new int[i_46_][];
	    for (int i_51_ = i - (1615726345 * this.anInt9500); (i_51_ <= this.anInt9500 * 1615726345 + i); i_51_++) {
		int[] is_52_ = method3129(0, i_51_ & Class250.anInt2758 * -289063255, -1887337990);
		int[] is_53_ = new int[Class250.anInt2755 * -1474554145];
		int i_54_ = 0;
		for (int i_55_ = -(this.anInt9499 * 484472729); (i_55_ <= 484472729 * this.anInt9499); i_55_++)
		    i_54_ += is_52_[i_55_ & -901777799 * Class250.anInt2753];
		int i_56_ = 0;
		while (i_56_ < Class250.anInt2755 * -1474554145) {
		    is_53_[i_56_] = i_49_ * i_54_ >> 16;
		    i_54_ -= is_52_[(i_56_ - 484472729 * this.anInt9499 & -901777799 * Class250.anInt2753)];
		    i_56_++;
		    i_54_ += is_52_[(i_56_ + 484472729 * this.anInt9499 & Class250.anInt2753 * -901777799)];
		}
		is_50_[(1615726345 * this.anInt9500 + i_51_ - i)] = is_53_;
	    }
	...
	try {
	    switch (i) {
		case 1:
		    this.anInt9500 = class298_sub53.readUnsignedByte() * -804145351;
		    break;
		case 0:
		    this.anInt9499 = class298_sub53.readUnsignedByte() * -938414935;
		    break;
		case 2:
	...
	if (aClass239_7380.aBoolean2607) {
	    int i_61_ = (1615726345 * this.anInt9500 + 1615726345 * this.anInt9500 + 1);
	    int i_62_ = 65536 / i_61_;
	    int i_63_ = 1 + (this.anInt9499 * 484472729 + 484472729 * this.anInt9499);
	    int i_64_ = 65536 / i_63_;
	    int[][][] is_65_ = new int[i_61_][][];
	    for (int i_66_ = i - (1615726345 * this.anInt9500); (i_66_ <= 1615726345 * this.anInt9500 + i); i_66_++) {
		...
		int[] is_73_ = is_67_[1];
		int[] is_74_ = is_67_[2];
		for (int i_75_ = -(484472729 * this.anInt9499); (i_75_ <= 484472729 * this.anInt9499); i_75_++) {
		...
		while (i_80_ < Class250.anInt2755 * -1474554145) {
		    ...
		    int i_81_ = (i_80_ - (484472729 * this.anInt9499) & Class250.anInt2753 * -901777799);
		    i_69_ -= is_72_[i_81_];
		    i_70_ -= is_73_[i_81_];
		    i_71_ -= is_74_[i_81_];
		    i_81_ = (++i_80_ + 484472729 * (this.anInt9499) & Class250.anInt2753 * -901777799);
		    i_69_ += is_72_[i_81_];
		    i_70_ += is_73_[i_81_];
		    i_71_ += is_74_[i_81_];
		}
		is_65_[(1615726345 * this.anInt9500 + i_66_ - i)] = is_68_;
	    }
	    int[] is_82_ = is[0];
	    int[] is_83_ = is[1];
	    int[] is_84_ = is[2];
	...
	if (aClass257_7384.aBoolean2810) {
	    int i_91_ = 1 + (1615726345 * this.anInt9500 + 1615726345 * this.anInt9500);
	    int i_92_ = 65536 / i_91_;
	    int i_93_ = 1 + (this.anInt9499 * 484472729 + 484472729 * this.anInt9499);
	    int i_94_ = 65536 / i_93_;
	    int[][] is_95_ = new int[i_91_][];
	    for (int i_96_ = i - (1615726345 * this.anInt9500); (i_96_ <= this.anInt9500 * 1615726345 + i); i_96_++) {
		int[] is_97_ = method3129(0, i_96_ & Class250.anInt2758 * -289063255, -1887337990);
		int[] is_98_ = new int[Class250.anInt2755 * -1474554145];
		int i_99_ = 0;
		for (int i_100_ = -(this.anInt9499 * 484472729); (i_100_ <= 484472729 * this.anInt9499); i_100_++)
		    i_99_ += is_97_[i_100_ & -901777799 * Class250.anInt2753];
		int i_101_ = 0;
		while (i_101_ < Class250.anInt2755 * -1474554145) {
		    is_98_[i_101_] = i_94_ * i_99_ >> 16;
		    i_99_ -= is_97_[(i_101_ - 484472729 * this.anInt9499 & -901777799 * Class250.anInt2753)];
		    i_101_++;
		    i_99_ += is_97_[(i_101_ + 484472729 * this.anInt9499 & Class250.anInt2753 * -901777799)];
		}
		is_95_[(1615726345 * this.anInt9500 + i_96_ - i)] = is_98_;
	    }
	...
	if (aClass239_7380.aBoolean2607) {
	    int i_105_ = (1615726345 * this.anInt9500 + 1615726345 * this.anInt9500 + 1);
	    int i_106_ = 65536 / i_105_;
	    int i_107_ = 1 + (this.anInt9499 * 484472729 + 484472729 * this.anInt9499);
	    int i_108_ = 65536 / i_107_;
	    int[][][] is_109_ = new int[i_105_][][];
	    for (int i_110_ = i - (1615726345 * this.anInt9500); (i_110_ <= 1615726345 * this.anInt9500 + i); i_110_++) {
		...
		for (int i_119_ = -(484472729 * this.anInt9499); (i_119_ <= 484472729 * this.anInt9499); i_119_++) {
		...
		while (i_124_ < Class250.anInt2755 * -1474554145) {
		    ...
		    int i_125_ = (i_124_ - (484472729 * this.anInt9499) & Class250.anInt2753 * -901777799);
		    i_113_ -= is_116_[i_125_];
		    i_114_ -= is_117_[i_125_];
		    i_115_ -= is_118_[i_125_];
		    i_125_ = (++i_124_ + 484472729 * this.anInt9499 & Class250.anInt2753 * -901777799);
		    i_113_ += is_116_[i_125_];
		    i_114_ += is_117_[i_125_];
		    i_115_ += is_118_[i_125_];
		}
		is_109_[(1615726345 * this.anInt9500 + i_110_ - i)] = is_112_;
	    }
	    int[] is_126_ = is[0];
	    int[] is_127_ = is[1];
	    int[] is_128_ = is[2];
