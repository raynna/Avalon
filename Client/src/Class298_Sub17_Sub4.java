...
public class Class298_Sub17_Sub4 extends Class298_Sub17 {
	...
	this.aString9203 = class298_sub53.readJNullString(-517364695);
	if (this.aString9203 != null) {
	    class298_sub53.readUnsignedByte();
	    this.aByte9204 = class298_sub53.readByte(-12558881);
	    this.aByte9202 = class298_sub53.readByte(-12558881);
	}
    }
	...
	try {
	    class298_sub25.aString7358 = this.aString9203;
	    if (null != this.aString9203) {
		class298_sub25.aByte7360 = this.aByte9204;
		class298_sub25.aByte7355 = this.aByte9202;
	    }
	}
    ...
    static final void method2925(Class403 class403, int i) {
	try {
	    int i_0_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    MapDetails class298_sub37_sub13 = Class301.method3705(i_0_);
	    if (class298_sub37_sub13 == null)
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = -1;
	    else
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = 1110271707 * class298_sub37_sub13.defaultZoom;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (!Class436.aBoolean5478) {
			...
			if (Class318.aClass298_Sub37_Sub15_3322 != null)
			    return ((Class318.aClass298_Sub37_Sub15_3322.anInt9659) * -1988795597);
		    } else if (Class298_Sub45.aClass298_Sub37_Sub15_7522 != null)
			return ((Class298_Sub45.aClass298_Sub37_Sub15_7522.anInt9659) * -1988795597);
		} else {
			...
			if (i_1_ > Class88.anInt806 * -1347746885 && i_1_ < (608683427 * Class134.anInt6343 + Class88.anInt806 * -1347746885)) {
				...
				for (Class298_Sub37_Sub15 class298_sub37_sub15 = ((Class298_Sub37_Sub15) class446.method5900(446818813)); null != class298_sub37_sub15; class298_sub37_sub15 = ((Class298_Sub37_Sub15) class446.next())) {
				    if (i_7_++ == i_3_)
					return (-1988795597 * (class298_sub37_sub15.anInt9659));
				}
			    }
			}
			...
			if (-1 != i_8_) {
				...
				if (i_12_++ == i_8_)
				    return (-1988795597 * (((Class298_Sub37_Sub15) (class298_sub37_sub5.aClass461_9584.aClass298_Sub37_5679.aClass298_Sub37_7405)).anInt9659));
			    }
			}
			...
			int i_13_ = -1;
			for (int i_14_ = 0; i_14_ < (Class436.aClass298_Sub37_Sub5_5472.anInt9583) * -628325139; i_14_++) {
			    if (Class436.aBoolean5496) {
			...
			if (i_13_ != -1) {
				...
				if (i_17_++ == i_13_)
				    return (class298_sub37_sub15.anInt9659 * -1988795597);
			    }
			}
		    }
		}
