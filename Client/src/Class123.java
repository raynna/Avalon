...
public abstract class Class123 {
	...
	try {
	    this.aClass110Array1469[-33664303 * anInt1475].method1161(class298_sub31_sub1, f, f_0_);
	}
	catch (RuntimeException runtimeexception) {
	...
	this.aClass110Array1469 = new Class110[class109.aClass108Array1327.length];
	for (int i = 0; i < class109.aClass108Array1327.length; i++)
	    this.aClass110Array1469[i] = method1326(class_ra_sub3, class109.aClass108Array1327[i]);
    }
	...
	try {
	    Class110[] class110s = this.aClass110Array1469;
	...
	try {
	    return this.aClass110Array1469.length;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    for (int i_3_ = 0; i_3_ < this.aClass110Array1469.length; i_3_++) {
		if (this.aClass110Array1469[i_3_] == class110)
		    return i_3_;
	    }
	    return -1;
	}
	...
	try {
	    return (-33664303 * anInt1475 >= 0 ? (this.aClass110Array1469[anInt1475 * -33664303]) : null);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass110Array1469[anInt1475 * -33664303].method1162(class298_sub31_sub1, f, f_5_, f_6_);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass110Array1469[-33664303 * anInt1475].method1176(class298_sub31_sub1, f);
	}
	catch (RuntimeException runtimeexception) {
    ...
    public final void method1336(int i, Class233 class233, byte i_7_) {
	try {
	    this.aClass110Array1469[-33664303 * anInt1475].method1173(i, class233);
	}
	catch (RuntimeException runtimeexception) {
    ...
    public final void method1337(Class298_Sub31_Sub1 class298_sub31_sub1, Class233 class233, byte i) {
	try {
	    this.aClass110Array1469[-33664303 * anInt1475].method1192(class298_sub31_sub1, class233);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass110Array1469[-33664303 * anInt1475].method1162(class298_sub31_sub1, class217.aFloat2451, class217.aFloat2455, class217.aFloat2454);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass110Array1469[anInt1475 * -33664303].method1163(class298_sub31_sub1, class232.aFloat2593, class232.aFloat2592, class232.aFloat2590, class232.aFloat2591);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass110Array1469[-33664303 * anInt1475].method1167(class298_sub31_sub1, i, interface9);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass110Array1469[-33664303 * anInt1475].method1169(i, f, f_9_, f_10_, f_11_);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass110Array1469[anInt1475 * -33664303].method1168(i, class217.aFloat2451, class217.aFloat2455, class217.aFloat2454);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass110Array1469[-33664303 * anInt1475].method1170(i, fs, i_14_);
	}
	catch (RuntimeException runtimeexception) {
    ...
    public final void method1345(int i, Class233 class233, byte i_16_) {
	try {
	    this.aClass110Array1469[anInt1475 * -33664303].method1171(i, class233);
	}
	catch (RuntimeException runtimeexception) {
    ...
    public final void method1346(int i, Class233 class233, int i_17_) {
	try {
	    this.aClass110Array1469[anInt1475 * -33664303].method1159(i, class233);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass110Array1469[anInt1475 * -33664303].method1164(class298_sub31_sub1, fs, fs.length);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass110Array1469[-33664303 * anInt1475].method1174(i, i_18_, interface9);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return ((Class298_Sub31_Sub1) this.aClass116_1471.method1263(string, -1795999546));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return ((Class298_Sub31_Sub1) this.aClass116_1468.method1266(i, (byte) -22));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class298_Sub31_Sub1 class298_sub31_sub1 = ((Class298_Sub31_Sub1) this.aClass116_1468.method1263(string, 542987786));
	...
	try {
	    ...
	    float f_22_ = (i >> 8 & 0xff) / 255.0F;
	    float f_23_ = (i & 0xff) / 255.0F;
	    float f_24_ = (i >> 24 & 0xff) / 255.0F;
	...
	try {
	    this.aClass110Array1469[-33664303 * anInt1475].method1168(i, f, f_25_, f_26_);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass110Array1469[anInt1475 * -33664303].method1163(class298_sub31_sub1, f, f_28_, f_29_, f_30_);
	}
	catch (RuntimeException runtimeexception) {
    ...
    public final void method1368(Class298_Sub31_Sub1 class298_sub31_sub1, Class233 class233, int i) {
	try {
	    this.aClass110Array1469[-33664303 * anInt1475].method1166(class298_sub31_sub1, class233);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return this.aClass110Array1469[i];
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return ((Class298_Sub31_Sub1) this.aClass116_1471.method1266(i, (byte) -95));
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1377(Class403 class403, byte i) {
	try {
    ...
    static final void method1379(Class403 class403, byte i) {
	try {
	    int i_42_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_42_).anInt5704) * 789409129 == 1 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
