...
public class Class359 implements Interface19 {
	...
	try {
		...
		} else if ((interface16.method218((byte) -42) == 843745169 * this.anInt6526) && (interface16.method220((byte) 0) == this.anInt6527 * -1785843037))
		    return true;
	    }
	    return false;
	}
	...
	for (int i_3_ = 0; i_3_ < i && i_3_ < interface16s.length; i_3_++) {
	    ...
	    if (interface16 != null && (interface16.method218((byte) -70) == 843745169 * this.anInt6526) && (interface16.method220((byte) 0) == this.anInt6527 * -1785843037))
		return true;
	}
	return false;
    }
	...
	for (int i_4_ = 0; i_4_ < i && i_4_ < interface16s.length; i_4_++) {
	    ...
	    if (interface16 != null && (interface16.method218((byte) -60) == 843745169 * this.anInt6526) && (interface16.method220((byte) 0) == this.anInt6527 * -1785843037))
		return true;
	}
	return false;
    }

    static void method4291(Class119 class119, int i, int i_5_, int i_6_, boolean bool, Class403 class403, int i_7_) {
	try {
	    if (i_5_ == 0)
	    ...
	    class105_11_.anInt1160 = (class105_11_.ihash = 1 * class105.ihash) * -293252211;
	    ...
	    class390.aClass119_4167 = class119;
	    class390.aClass105_4168 = class105_11_;
    ...
    static final void method4292(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
    ...
    static final void method4293(Class403 class403, byte i) {
	try {
	    Class79.method850((class403.aClass365_Sub1_Sub4_Sub1_5253), (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]), (byte) 14);
    ...
    static final void method4296(Class403 class403, int i) {
	try {
	    String string = (String) (class403.anObjectArray5240[(class403.anInt5241 -= 969361751) * -203050393]);
		...
		int i_14_ = (385051775 * class298_sub36.out.index);
		class298_sub36.out.writeString(string, 2125577708);
		class298_sub36.out.method3649((class298_sub36.out.index * 385051775) - i_14_, (byte) -53);
