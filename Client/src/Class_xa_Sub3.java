...
public class Class_xa_Sub3 extends Class_xa {
	...
	if ((this.aByteArrayArray8546[i][i_2_] & 0x1) == 0)
	    return null;
	int i_3_ = (anInt6288 * -1212653763 >> (this.aClass_ra_Sub2_8535.anInt8064));
	...
	if (class_na_sub1 != null && class_na_sub1.method3481(i_3_, i_3_)) {
	    ...
	    class_na_sub1_4_ = new Class_na_Sub1(this.aClass_ra_Sub2_8535, i_3_, i_3_);
	...
	if (this.aClass44_8541 != null && class_na != null) {
	    int i_8_ = (i - (i_5_ * ((this.aClass_ra_Sub2_8535).anInt8066) >> 8) >> (this.aClass_ra_Sub2_8535).anInt8064);
	    int i_9_ = (i_6_ - (i_5_ * (this.aClass_ra_Sub2_8535.anInt8026) >> 8) >> this.aClass_ra_Sub2_8535.anInt8064);
	    this.aClass44_8541.method491(class_na, i_8_, i_9_);
	}
    }
	...
	if (this.anInt8543 > 0) {
	    ...
	    this.aClass298Array8534 = new Class298[this.aClass440_8549.method5855(1429819619)];
	    ...
	    int i_11_ = Class422_Sub4.method5639((this.anInt8543 / 4), 1715118458);
	    if (i_11_ < 1)
		i_11_ = 1;
		...
		for (int i_14_ = 0; i_14_ < anInt6286 * -1148794921; i_14_++) {
			...
			for (int i_41_ = 0; i_41_ < is_19_.length; i_41_++) {
			    ...
			    long l = ((long) i_47_ << 48 | (long) i_46_ << 32 | i_44_ << 16 | i_45_);
				...
				if ((this.aClass_ra_Sub2_8535).aBoolean8143) {
				    stream.d(i_42_);
				    stream.d(method6340(i_42_, i_43_, -1789282838) + i_48_);
				    stream.d(i_43_);
				    ...
				    stream.u(i_42_);
				    stream.u(method6340(i_42_, i_43_, -1884194336) + i_48_);
				    stream.u(i_43_);
				    stream.p((byte) (i_69_ >> 16));
				    stream.p((byte) (i_69_ >> 8));
				    stream.p((byte) i_69_);
				...
				if (i_46_ != -1 && ((class298_sub5s_15_[i_41_].hash * 7051297995265073167L) < (class298_sub5s[i_68_].hash * 7051297995265073167L)))
				    class298_sub5s[i_68_] = class298_sub5s_15_[i_41_];
			    }
		...
		for (int i_78_ = 0; i_78_ < anInt6286 * -1148794921; i_78_++) {
			...
			while (i_81_ < is_79_.length) {
				...
				if (class298_sub5_87_ == null || ((class298_sub5_85_.hash * 7051297995265073167L) < (class298_sub5_87_.hash * 7051297995265073167L)))
				    class298_sub5_87_ = class298_sub5_85_;
			    }
			    if (class298_sub5_86_ != null) {
				class298_sub5_86_.method2856(i_77_, i_78_, i_80_);
				if (class298_sub5_87_ == null || ((class298_sub5_86_.hash * 7051297995265073167L) < (class298_sub5_87_.hash * 7051297995265073167L)))
		...
		ls[i_89_] = class298_sub5.hash * 7051297995265073167L;
	...
	Class52 class52 = this.aClass_ra_Sub2_8535.method4992((short) 23850);
	if (this.anInt8543 > 0 && class52 != null) {
	    ...
	    aFloatArray8524[0] = i_91_ / (128.0F * (anInt6288 * -1212653763) * class52.method545());
	    aFloatArray8524[1] = 0.0F;
	    aFloatArray8524[2] = 0.0F;
	    aFloatArray8524[3] = 0.0F;
	    aFloatArray8524[4] = 0.0F;
	    aFloatArray8524[5] = i_91_ / (128.0F * (anInt6288 * -1212653763) * class52.method552());
	    ...
	    aFloatArray8524[12] = -1.0F - ((i_92_ * i_91_ / 128.0F - i * 2) / class52.method545());
	    aFloatArray8524[13] = 1.0F - ((2 * i_90_ + i_95_ * i_91_ / 128.0F) / class52.method552());
		...
		this.aClass_ra_Sub2_8535.aClass298_Sub53_Sub1_8197.index = 0;
	    int i_96_ = 0;
		...
		for (int i_97_ = i_93_; i_97_ < i_95_; i_97_++) {
			...
			if (bools[i_99_ - i_92_][i_97_ - i_93_]) {
			    short[] is = (this.aShortArrayArray8550[i_98_]);
			    if (is != null) {
		...
		for (int i_101_ = i_93_; i_101_ < i_95_; i_101_++) {
			...
			if (bools[i_103_ - i_92_][i_101_ - i_93_]) {
			    short[] is = (this.aShortArrayArray8550[i_102_]);
			    if (is != null) {
	    ...
	    if (i_96_ > 0) {
		Class46_Sub1 class46_sub1 = new Class46_Sub1((this.aClass_ra_Sub2_8535), 5123, class298_sub53_sub1.buffer, (class298_sub53_sub1.index * 385051775));
		this.aClass_ra_Sub2_8535.method5254(class46_sub1, 4, 0, i_96_);
	    }
	}
    }
	...
	if (this.aClass298Array8534 != null) {
		...
		this.aClass_ra_Sub2_8535.c(0, i_121_, this.aClass_ra_Sub2_8535.anInt8195);
		this.aClass_ra_Sub2_8535.method5262(false);
		this.aClass_ra_Sub2_8535.method5281(false);
		...
		for (Class298 class298 = this.aClass458_8536.method5967(1797943581); class298 != null; class298 = this.aClass458_8536.method5969((byte) -37)) {
		...
		this.aClass_ra_Sub2_8535.method5256(null);
		this.aClass_ra_Sub2_8535.c(i_120_, i_121_, this.aClass_ra_Sub2_8535.anInt8195);
	    }
	    if (this.aClass44_8541 != null) {
		OpenGL.glPushMatrix();
	...
	Class52 class52 = this.aClass_ra_Sub2_8535.method4992((short) -628);
	if (this.anInt8543 > 0 && class52 != null) {
	    this.aClass_ra_Sub2_8535.method5291();
	    this.aClass_ra_Sub2_8535.method5226(false);
	    this.aClass_ra_Sub2_8535.method5262(false);
	    ...
	    this.aClass_ra_Sub2_8535.method5275(-2);
	    this.aClass_ra_Sub2_8535.method5256(null);
	    aFloatArray8524[0] = i_123_ / (128.0F * (anInt6288 * -1212653763) * class52.method545());
	    aFloatArray8524[1] = 0.0F;
	    aFloatArray8524[2] = 0.0F;
	    aFloatArray8524[3] = 0.0F;
	    aFloatArray8524[4] = 0.0F;
	    aFloatArray8524[5] = i_123_ / (128.0F * (anInt6288 * -1212653763) * class52.method552());
	    aFloatArray8524[6] = 0.0F;
	    aFloatArray8524[7] = 0.0F;
	    aFloatArray8524[8] = 0.0F;
	    aFloatArray8524[9] = 0.0F;
	    aFloatArray8524[10] = 0.0F;
	    aFloatArray8524[11] = 0.0F;
	    aFloatArray8524[12] = -1.0F - (i_124_ * i_123_ / 128.0F - i * 2) / class52.method545();
	    aFloatArray8524[13] = 1.0F - ((2 * i_122_ + i_127_ * i_123_ / 128.0F) / class52.method552());
	    aFloatArray8524[14] = 0.0F;
	    aFloatArray8524[15] = 1.0F;
	    OpenGL.glMatrixMode(5889);
	    OpenGL.glLoadMatrixf(aFloatArray8524, 0);
	...
	Interface_ma interface_ma = this.aClass_ra_Sub2_8535.anInterface_ma5299;
	...
	for (int i_164_ = 0; i_164_ < is_160_.length; i_164_++) {
	    ...
	    if ((this.anInt8523 & 0x20) != 0 && i_165_ != -1 && interface_ma.method174(i_165_, 602140986).aBoolean524) {
		i_166_ = 128;
		i_165_ = -1;
	    }
	    long l = ((long) (class78.anInt727 * -1475891183) << 48 | (long) (class78.anInt725 * 1996750669) << 42 | (long) (class78.anInt726 * -1212608691) << 28 | i_166_ << 14 | i_165_);
	    Class298 class298;
		...
		if (class298_sub5.anInt7199 == i_165_ && (class298_sub5.aFloat7196 == i_166_) && class298_sub5.aClass78_7198.method843(class78, (byte) -48))
		    break;
	    }
	    if (class298 == null) {
	...
	this.aClass458_8536.method5968(new Class298_Sub3(this.aClass_ra_Sub2_8535, this, class298_sub10, is), 136823922);
    }
	...
	Class52 class52 = this.aClass_ra_Sub2_8535.method4992((short) 8066);
	if (this.anInt8543 > 0 && class52 != null) {
	    this.aClass_ra_Sub2_8535.method5291();
	    this.aClass_ra_Sub2_8535.method5226(false);
	    this.aClass_ra_Sub2_8535.method5262(false);
	    ...
	    this.aClass_ra_Sub2_8535.method5275(-2);
	    this.aClass_ra_Sub2_8535.method5256(null);
	    aFloatArray8524[0] = i_223_ / (128.0F * (anInt6288 * -1212653763) * class52.method545());
	    aFloatArray8524[1] = 0.0F;
	    aFloatArray8524[2] = 0.0F;
	    aFloatArray8524[3] = 0.0F;
	    aFloatArray8524[4] = 0.0F;
	    aFloatArray8524[5] = i_223_ / (128.0F * (anInt6288 * -1212653763) * class52.method552());
	    aFloatArray8524[6] = 0.0F;
	    aFloatArray8524[7] = 0.0F;
	    aFloatArray8524[8] = 0.0F;
	    aFloatArray8524[9] = 0.0F;
	    aFloatArray8524[10] = 0.0F;
	    aFloatArray8524[11] = 0.0F;
	    aFloatArray8524[12] = -1.0F - (i_224_ * i_223_ / 128.0F - i * 2) / class52.method545();
	    aFloatArray8524[13] = 1.0F - ((2 * i_222_ + i_227_ * i_223_ / 128.0F) / class52.method552());
	    aFloatArray8524[14] = 0.0F;
	    aFloatArray8524[15] = 1.0F;
	    OpenGL.glMatrixMode(5889);
	    OpenGL.glLoadMatrixf(aFloatArray8524, 0);
		...
		for (int i_229_ = i_225_; i_229_ < i_227_; i_229_++) {
			...
			if (bools[i_231_ - i_224_][i_229_ - i_225_]) {
			    short[] is = (this.aShortArrayArray8550[i_230_]);
			    if (is != null) {
		...
		for (int i_233_ = i_225_; i_233_ < i_227_; i_233_++) {
			...
			if (bools[i_235_ - i_224_][i_233_ - i_225_]) {
			    short[] is = (this.aShortArrayArray8550[i_234_]);
			    if (is != null) {
	    ...
	    if (i_228_ > 0) {
		Class46_Sub1 class46_sub1 = new Class46_Sub1((this.aClass_ra_Sub2_8535), 5123, class298_sub53_sub1.buffer, (class298_sub53_sub1.index * 385051775));
		this.aClass_ra_Sub2_8535.method5254(class46_sub1, 4, 0, i_228_);
	    }
	}
    }
	...
	Interface_ma interface_ma = this.aClass_ra_Sub2_8535.anInterface_ma5299;
	if (is_240_ != null && this.anIntArrayArrayArray8533 == null)
	    this.anIntArrayArrayArray8533 = new int[anInt6287 * -506105871][anInt6286 * -1148794921][];
	if (is_238_ != null && this.anIntArrayArrayArray8532 == null)
	    this.anIntArrayArrayArray8532 = new int[anInt6287 * -506105871][anInt6286 * -1148794921][];
	this.anIntArrayArrayArray8537[i][i_237_] = is;
	this.anIntArrayArrayArray8531[i][i_237_] = is_239_;
	this.anIntArrayArrayArray8528[i][i_237_] = is_241_;
	this.anIntArrayArrayArray8529[i][i_237_] = is_242_;
	if (this.anIntArrayArrayArray8533 != null)
	    this.anIntArrayArrayArray8533[i][i_237_] = is_240_;
	if (this.anIntArrayArrayArray8532 != null)
	    this.anIntArrayArrayArray8532[i][i_237_] = is_238_;
	Class298_Sub5[] class298_sub5s = (this.aClass298_Sub5ArrayArrayArray8527[i][i_237_] = new Class298_Sub5[is_241_.length]);
	for (int i_245_ = 0; i_245_ < is_241_.length; i_245_++) {
	    int i_246_ = is_243_[i_245_];
	    int i_247_ = is_244_[i_245_];
	    if ((this.anInt8523 & 0x20) != 0 && i_246_ != -1 && interface_ma.method174(i_246_, 620135548).aBoolean524) {
		i_247_ = 128;
		i_246_ = -1;
	    }
	    long l = ((long) (class78.anInt727 * -1475891183) << 48 | (long) (class78.anInt725 * 1996750669) << 42 | (long) (class78.anInt726 * -1212608691) << 28 | i_247_ << 14 | i_246_);
	    Class298 class298;
	    for (class298 = this.aClass440_8549.method5852(l); class298 != null; class298 = this.aClass440_8549.method5853(-2069832948)) {
		Class298_Sub5 class298_sub5 = (Class298_Sub5) class298;
		if (class298_sub5.anInt7199 == i_246_ && (class298_sub5.aFloat7196 == i_247_) && class298_sub5.aClass78_7198.method843(class78, (byte) 30))
		    break;
	    }
	    if (class298 == null) {
		class298_sub5s[i_245_] = new Class298_Sub5(this, i_246_, i_247_, class78);
		this.aClass440_8549.method5858(class298_sub5s[i_245_], l);
	    } else
		class298_sub5s[i_245_] = (Class298_Sub5) class298;
	}
	if (bool)
	    this.aByteArrayArray8546[i][i_237_] |= 0x1;
	if (is_241_.length > this.anInt8544)
	    this.anInt8544 = is_241_.length;
	this.anInt8543 += is_241_.length;
    }
	...
	Interface_ma interface_ma = this.aClass_ra_Sub2_8535.anInterface_ma5299;
	if (is_251_ != null && this.anIntArrayArrayArray8533 == null)
	    this.anIntArrayArrayArray8533 = new int[anInt6287 * -506105871][anInt6286 * -1148794921][];
	if (is_249_ != null && this.anIntArrayArrayArray8532 == null)
	    this.anIntArrayArrayArray8532 = new int[anInt6287 * -506105871][anInt6286 * -1148794921][];
	this.anIntArrayArrayArray8537[i][i_248_] = is;
	this.anIntArrayArrayArray8531[i][i_248_] = is_250_;
	this.anIntArrayArrayArray8528[i][i_248_] = is_252_;
	this.anIntArrayArrayArray8529[i][i_248_] = is_253_;
	if (this.anIntArrayArrayArray8533 != null)
	    this.anIntArrayArrayArray8533[i][i_248_] = is_251_;
	if (this.anIntArrayArrayArray8532 != null)
	    this.anIntArrayArrayArray8532[i][i_248_] = is_249_;
	Class298_Sub5[] class298_sub5s = (this.aClass298_Sub5ArrayArrayArray8527[i][i_248_] = new Class298_Sub5[is_252_.length]);
	for (int i_256_ = 0; i_256_ < is_252_.length; i_256_++) {
	    int i_257_ = is_254_[i_256_];
	    int i_258_ = is_255_[i_256_];
	    if ((this.anInt8523 & 0x20) != 0 && i_257_ != -1 && interface_ma.method174(i_257_, 1671695698).aBoolean524) {
		i_258_ = 128;
		i_257_ = -1;
	    }
	    long l = ((long) (class78.anInt727 * -1475891183) << 48 | (long) (class78.anInt725 * 1996750669) << 42 | (long) (class78.anInt726 * -1212608691) << 28 | i_258_ << 14 | i_257_);
	    Class298 class298;
	    for (class298 = this.aClass440_8549.method5852(l); class298 != null; class298 = this.aClass440_8549.method5853(-1821853943)) {
		Class298_Sub5 class298_sub5 = (Class298_Sub5) class298;
		if (class298_sub5.anInt7199 == i_257_ && (class298_sub5.aFloat7196 == i_258_) && class298_sub5.aClass78_7198.method843(class78, (byte) -53))
		    break;
	    }
	    if (class298 == null) {
		class298_sub5s[i_256_] = new Class298_Sub5(this, i_257_, i_258_, class78);
		this.aClass440_8549.method5858(class298_sub5s[i_256_], l);
	    } else
		class298_sub5s[i_256_] = (Class298_Sub5) class298;
	}
	if (bool)
	    this.aByteArrayArray8546[i][i_248_] |= 0x1;
	if (is_252_.length > this.anInt8544)
	    this.anInt8544 = is_252_.length;
	this.anInt8543 += is_252_.length;
    }

    @Override
    public Class_na l(int i, int i_259_, Class_na class_na) {
	if ((this.aByteArrayArray8546[i][i_259_] & 0x1) == 0)
	    return null;
	int i_260_ = (anInt6288 * -1212653763 >> (this.aClass_ra_Sub2_8535.anInt8064));
	Class_na_Sub1 class_na_sub1 = (Class_na_Sub1) class_na;
	...
	if (class_na_sub1 != null && class_na_sub1.method3481(i_260_, i_260_)) {
	    ...
	    class_na_sub1_261_ = new Class_na_Sub1(this.aClass_ra_Sub2_8535, i_260_, i_260_);
	...
	if (this.anInt8543 > 0) {
		...
		for (int i_262_ = 1; i_262_ < anInt6286 * -1148794921; i_262_++)
		    is[i][i_262_] = (byte) (((this.aByteArrayArray8545[i - 1][i_262_]) >> 2) + ((this.aByteArrayArray8545[i + 1][i_262_]) >> 3) + ((this.aByteArrayArray8545[i][i_262_ - 1]) >> 2) + ((this.aByteArrayArray8545[i][i_262_ + 1]) >> 3) + ((this.aByteArrayArray8545[i][i_262_]) >> 1));
	    }
	    this.aClass298Array8534 = new Class298[this.aClass440_8549.method5855(-575368869)];
	    this.aClass440_8549.method5854(this.aClass298Array8534, 2072858153);
	    for (int i = 0; i < this.aClass298Array8534.length; i++)
		((Class298_Sub5) this.aClass298Array8534[i]).method2859(this.anInt8543);
	    int i = 24;
	    if (this.anIntArrayArrayArray8533 != null)
	    ...
	    Stream stream = new Stream(nativeheapbuffer);
	    Class298_Sub5[] class298_sub5s = new Class298_Sub5[this.anInt8543];
	    int i_263_ = Class422_Sub4.method5639((this.anInt8543 / 4), 1877653209);
	    if (i_263_ < 1)
		i_263_ = 1;
	    Class440 class440 = new Class440(i_263_);
	    Class298_Sub5[] class298_sub5s_264_ = new Class298_Sub5[this.anInt8544];
	    for (int i_265_ = 0; i_265_ < anInt6287 * -506105871; i_265_++) {
		for (int i_266_ = 0; i_266_ < anInt6286 * -1148794921; i_266_++) {
		    if ((this.anIntArrayArrayArray8528[i_265_][i_266_]) != null) {
			Class298_Sub5[] class298_sub5s_267_ = (this.aClass298_Sub5ArrayArrayArray8527[i_265_][i_266_]);
			int[] is_268_ = (this.anIntArrayArrayArray8537[i_265_][i_266_]);
			int[] is_269_ = (this.anIntArrayArrayArray8531[i_265_][i_266_]);
			int[] is_270_ = (this.anIntArrayArrayArray8529[i_265_][i_266_]);
			int[] is_271_ = (this.anIntArrayArrayArray8528[i_265_][i_266_]);
			int[] is_272_ = ((this.anIntArrayArrayArray8532 != null) ? (this.anIntArrayArrayArray8532[i_265_][i_266_]) : null);
			int[] is_273_ = ((this.anIntArrayArrayArray8533 != null) ? (this.anIntArrayArrayArray8533[i_265_][i_266_]) : null);
			if (is_270_ == null)
			    is_270_ = is_271_;
			float f = (this.aFloatArrayArray8530[i_265_][i_266_]);
			float f_274_ = (this.aFloatArrayArray8547[i_265_][i_266_]);
			float f_275_ = (this.aFloatArrayArray8548[i_265_][i_266_]);
			float f_276_ = (this.aFloatArrayArray8530[i_265_][i_266_ + 1]);
			float f_277_ = (this.aFloatArrayArray8547[i_265_][i_266_ + 1]);
			float f_278_ = (this.aFloatArrayArray8548[i_265_][i_266_ + 1]);
			float f_279_ = (this.aFloatArrayArray8530[i_265_ + 1][i_266_ + 1]);
			float f_280_ = (this.aFloatArrayArray8547[i_265_ + 1][i_266_ + 1]);
			float f_281_ = (this.aFloatArrayArray8548[i_265_ + 1][i_266_ + 1]);
			float f_282_ = (this.aFloatArrayArray8530[i_265_ + 1][i_266_]);
			float f_283_ = (this.aFloatArrayArray8547[i_265_ + 1][i_266_]);
			float f_284_ = (this.aFloatArrayArray8548[i_265_ + 1][i_266_]);
			...
			short[] is_292_ = (this.aShortArrayArray8550[i_266_ * (anInt6287 * -506105871) + i_265_] = new short[is_271_.length]);
			for (int i_293_ = 0; i_293_ < is_271_.length; i_293_++) {
			    ...
			    int i_296_ = i_294_ >> this.anInt8520;
			    int i_297_ = i_295_ >> this.anInt8520;
			    int i_298_ = is_271_[i_293_];
			    int i_299_ = is_270_[i_293_];
			    int i_300_ = is_272_ != null ? is_272_[i_293_] : 0;
			    long l = ((long) i_299_ << 48 | (long) i_298_ << 32 | i_296_ << 16 | i_297_);
				...
				if ((this.anInt8523 & 0x7) == 0) {
				    f_305_ = (((this.aClass_ra_Sub2_8535).aFloatArray8124[0]) * f_306_ + ((this.aClass_ra_Sub2_8535).aFloatArray8124[1]) * f_307_ + ((this.aClass_ra_Sub2_8535).aFloatArray8124[2]) * f_308_);
				    f_305_ = ((this.aClass_ra_Sub2_8535).aFloat8130 + (f_305_ * (f_305_ > 0.0F ? ((this.aClass_ra_Sub2_8535).aFloat8131) : ((this.aClass_ra_Sub2_8535).aFloat8132))));
				}
			    }
			    Class298 class298 = null;
			    if ((i_294_ & this.anInt8521 - 1) == 0 && ((i_295_ & this.anInt8521 - 1) == 0))
				class298 = class440.method5852(l);
			    int i_320_;
			    if (class298 == null) {
				int i_321_;
				if (i_299_ != i_298_) {
				    ...
				    if ((this.anInt8523 & 0x7) == 0) {
					float f_323_ = (((this.aClass_ra_Sub2_8535).aFloatArray8124[0]) * f_306_ + ((this.aClass_ra_Sub2_8535).aFloatArray8124[1]) * f_307_ + (((this.aClass_ra_Sub2_8535).aFloatArray8124[2]) * f_308_));
					f_323_ = (((this.aClass_ra_Sub2_8535).aFloat8130) + (f_305_ * (f_305_ > 0.0F ? ((this.aClass_ra_Sub2_8535).aFloat8131) : ((this.aClass_ra_Sub2_8535).aFloat8132))));
				...
				if ((this.aClass_ra_Sub2_8535).aBoolean8143) {
				    stream.d(i_294_);
				    stream.d(method6340(i_294_, i_295_, -1419532745) + i_300_);
				    stream.d(i_295_);
				    ...
				    stream.u(i_294_);
				    stream.u(method6340(i_294_, i_295_, -2119264527) + i_300_);
				    stream.u(i_295_);
				    stream.p((byte) (i_321_ >> 16));
				    stream.p((byte) (i_321_ >> 8));
				    stream.p((byte) i_321_);
				...
				if (i_298_ != -1 && ((class298_sub5s_267_[i_293_].hash * 7051297995265073167L) < (class298_sub5s[i_320_].hash * 7051297995265073167L)))
				    class298_sub5s[i_320_] = class298_sub5s_267_[i_293_];
			    }
	    ...
	    for (int i_328_ = 0; i_328_ < this.anInt8526; i_328_++) {
		...
		for (int i_330_ = 0; i_330_ < anInt6286 * -1148794921; i_330_++) {
		    short[] is_331_ = (this.aShortArrayArray8550[i_330_ * (anInt6287 * -506105871) + i_329_]);
		    if (is_331_ != null) {
			int i_332_ = 0;
			int i_333_ = 0;
			while (i_333_ < is_331_.length) {
				...
				if (class298_sub5_339_ == null || ((class298_sub5_337_.hash * 7051297995265073167L) < (class298_sub5_339_.hash * 7051297995265073167L)))
				    class298_sub5_339_ = class298_sub5_337_;
			    }
			    if (class298_sub5_338_ != null) {
				class298_sub5_338_.method2856(i_329_, i_330_, i_332_);
				if (class298_sub5_339_ == null || ((class298_sub5_338_.hash * 7051297995265073167L) < (class298_sub5_339_.hash * 7051297995265073167L)))
	    ...
	    if ((this.anInt8523 & 0x7) != 0)
		this.aClass32_8519 = new Class32(this.anInterface1_8538, 5126, 3, i_340_);
	    long[] ls = new long[this.aClass298Array8534.length];
	    for (int i_341_ = 0; i_341_ < this.aClass298Array8534.length; i_341_++) {
		Class298_Sub5 class298_sub5 = ((Class298_Sub5) this.aClass298Array8534[i_341_]);
		ls[i_341_] = class298_sub5.hash * 7051297995265073167L;
		class298_sub5.method2860(this.anInt8526);
	    }
	    Class365_Sub1_Sub3_Sub1.method4507(ls, (this.aClass298Array8534), (byte) -108);
	    if (this.aClass44_8541 != null)
		this.aClass44_8541.method489();
	} else
	    this.aClass44_8541 = null;
	...
	Interface_ma interface_ma = this.aClass_ra_Sub2_8535.anInterface_ma5299;
	if (is_348_ != null && this.anIntArrayArrayArray8533 == null)
	    this.anIntArrayArrayArray8533 = new int[anInt6287 * -506105871][anInt6286 * -1148794921][];
	if (is_346_ != null && this.anIntArrayArrayArray8532 == null)
	    this.anIntArrayArrayArray8532 = new int[anInt6287 * -506105871][anInt6286 * -1148794921][];
	this.anIntArrayArrayArray8537[i][i_345_] = is;
	this.anIntArrayArrayArray8531[i][i_345_] = is_347_;
	this.anIntArrayArrayArray8528[i][i_345_] = is_349_;
	this.anIntArrayArrayArray8529[i][i_345_] = is_350_;
	if (this.anIntArrayArrayArray8533 != null)
	    this.anIntArrayArrayArray8533[i][i_345_] = is_348_;
	if (this.anIntArrayArrayArray8532 != null)
	    this.anIntArrayArrayArray8532[i][i_345_] = is_346_;
	Class298_Sub5[] class298_sub5s = (this.aClass298_Sub5ArrayArrayArray8527[i][i_345_] = new Class298_Sub5[is_349_.length]);
	for (int i_353_ = 0; i_353_ < is_349_.length; i_353_++) {
	    int i_354_ = is_351_[i_353_];
	    int i_355_ = is_352_[i_353_];
	    if ((this.anInt8523 & 0x20) != 0 && i_354_ != -1 && interface_ma.method174(i_354_, 156111587).aBoolean524) {
		i_355_ = 128;
		i_354_ = -1;
	    }
	    long l = ((long) (class78.anInt727 * -1475891183) << 48 | (long) (class78.anInt725 * 1996750669) << 42 | (long) (class78.anInt726 * -1212608691) << 28 | i_355_ << 14 | i_354_);
	    Class298 class298;
	    for (class298 = this.aClass440_8549.method5852(l); class298 != null; class298 = this.aClass440_8549.method5853(-2112383276)) {
		Class298_Sub5 class298_sub5 = (Class298_Sub5) class298;
		if (class298_sub5.anInt7199 == i_354_ && (class298_sub5.aFloat7196 == i_355_) && class298_sub5.aClass78_7198.method843(class78, (byte) 12))
		    break;
	    }
	    if (class298 == null) {
		class298_sub5s[i_353_] = new Class298_Sub5(this, i_354_, i_355_, class78);
		this.aClass440_8549.method5858(class298_sub5s[i_353_], l);
	    } else
		class298_sub5s[i_353_] = (Class298_Sub5) class298;
	}
	if (bool)
	    this.aByteArrayArray8546[i][i_345_] |= 0x1;
	if (is_349_.length > this.anInt8544)
	    this.anInt8544 = is_349_.length;
	this.anInt8543 += is_349_.length;
    }

    @Override
    public void method6347(int i, int i_356_, int i_357_, int i_358_, int i_359_, int i_360_, int i_361_, boolean[][] bools) {
	Class52 class52 = this.aClass_ra_Sub2_8535.method4992((short) -5205);
	if (this.anInt8543 > 0 && class52 != null) {
	    this.aClass_ra_Sub2_8535.method5291();
	    this.aClass_ra_Sub2_8535.method5226(false);
	    this.aClass_ra_Sub2_8535.method5262(false);
	    ...
	    this.aClass_ra_Sub2_8535.method5275(-2);
	    this.aClass_ra_Sub2_8535.method5256(null);
	    aFloatArray8524[0] = i_357_ / (128.0F * (anInt6288 * -1212653763) * class52.method545());
	    aFloatArray8524[1] = 0.0F;
	    aFloatArray8524[2] = 0.0F;
	    aFloatArray8524[3] = 0.0F;
	    aFloatArray8524[4] = 0.0F;
	    aFloatArray8524[5] = i_357_ / (128.0F * (anInt6288 * -1212653763) * class52.method552());
	    aFloatArray8524[6] = 0.0F;
	    aFloatArray8524[7] = 0.0F;
	    aFloatArray8524[8] = 0.0F;
	    aFloatArray8524[9] = 0.0F;
	    aFloatArray8524[10] = 0.0F;
	    aFloatArray8524[11] = 0.0F;
	    aFloatArray8524[12] = -1.0F - (i_358_ * i_357_ / 128.0F - i * 2) / class52.method545();
	    aFloatArray8524[13] = 1.0F - ((2 * i_356_ + i_361_ * i_357_ / 128.0F) / class52.method552());
	    aFloatArray8524[14] = 0.0F;
	    aFloatArray8524[15] = 1.0F;
	    OpenGL.glMatrixMode(5889);
	    OpenGL.glLoadMatrixf(aFloatArray8524, 0);
		...
		for (int i_363_ = i_359_; i_363_ < i_361_; i_363_++) {
			...
			if (bools[i_365_ - i_358_][i_363_ - i_359_]) {
			    short[] is = (this.aShortArrayArray8550[i_364_]);
			    if (is != null) {
		...
		for (int i_367_ = i_359_; i_367_ < i_361_; i_367_++) {
			...
			if (bools[i_369_ - i_358_][i_367_ - i_359_]) {
			    short[] is = (this.aShortArrayArray8550[i_368_]);
			    if (is != null) {
	    ...
	    if (i_362_ > 0) {
		Class46_Sub1 class46_sub1 = new Class46_Sub1((this.aClass_ra_Sub2_8535), 5123, class298_sub53_sub1.buffer, (class298_sub53_sub1.index * 385051775));
		this.aClass_ra_Sub2_8535.method5254(class46_sub1, 4, 0, i_362_);
	    }
	}
    }
	...
	Class52 class52 = this.aClass_ra_Sub2_8535.method4992((short) -3637);
	if (this.anInt8543 > 0 && class52 != null) {
	    this.aClass_ra_Sub2_8535.method5291();
	    this.aClass_ra_Sub2_8535.method5226(false);
	    this.aClass_ra_Sub2_8535.method5262(false);
	    ...
	    this.aClass_ra_Sub2_8535.method5275(-2);
	    this.aClass_ra_Sub2_8535.method5256(null);
	    aFloatArray8524[0] = i_372_ / (128.0F * (anInt6288 * -1212653763) * class52.method545());
	    aFloatArray8524[1] = 0.0F;
	    aFloatArray8524[2] = 0.0F;
	    aFloatArray8524[3] = 0.0F;
	    aFloatArray8524[4] = 0.0F;
	    aFloatArray8524[5] = i_372_ / (128.0F * (anInt6288 * -1212653763) * class52.method552());
	    aFloatArray8524[6] = 0.0F;
	    aFloatArray8524[7] = 0.0F;
	    aFloatArray8524[8] = 0.0F;
	    aFloatArray8524[9] = 0.0F;
	    aFloatArray8524[10] = 0.0F;
	    aFloatArray8524[11] = 0.0F;
	    aFloatArray8524[12] = -1.0F - (i_373_ * i_372_ / 128.0F - i * 2) / class52.method545();
	    aFloatArray8524[13] = 1.0F - ((2 * i_371_ + i_376_ * i_372_ / 128.0F) / class52.method552());
	    aFloatArray8524[14] = 0.0F;
	    aFloatArray8524[15] = 1.0F;
	    OpenGL.glMatrixMode(5889);
	    OpenGL.glLoadMatrixf(aFloatArray8524, 0);
		...
		for (int i_378_ = i_374_; i_378_ < i_376_; i_378_++) {
			...
			if (bools[i_380_ - i_373_][i_378_ - i_374_]) {
			    short[] is = (this.aShortArrayArray8550[i_379_]);
			    if (is != null) {
		...
		for (int i_382_ = i_374_; i_382_ < i_376_; i_382_++) {
			...
			if (bools[i_384_ - i_373_][i_382_ - i_374_]) {
			    short[] is = (this.aShortArrayArray8550[i_383_]);
			    if (is != null) {
	    ...
	    if (i_377_ > 0) {
		Class46_Sub1 class46_sub1 = new Class46_Sub1((this.aClass_ra_Sub2_8535), 5123, class298_sub53_sub1.buffer, (class298_sub53_sub1.index * 385051775));
		this.aClass_ra_Sub2_8535.method5254(class46_sub1, 4, 0, i_377_);
	    }
	}
    }
	...
	this.aClass458_8536.method5968(new Class298_Sub3(this.aClass_ra_Sub2_8535, this, class298_sub10, is), 2091242360);
    }

    @Override
    public void method6352(int i, int i_391_, int i_392_, int i_393_, int i_394_, int i_395_, int i_396_, boolean[][] bools) {
	Class52 class52 = this.aClass_ra_Sub2_8535.method4992((short) 8148);
	if (this.anInt8543 > 0 && class52 != null) {
	    this.aClass_ra_Sub2_8535.method5291();
	    this.aClass_ra_Sub2_8535.method5226(false);
	    this.aClass_ra_Sub2_8535.method5262(false);
	    ...
	    this.aClass_ra_Sub2_8535.method5275(-2);
	    this.aClass_ra_Sub2_8535.method5256(null);
	    aFloatArray8524[0] = i_392_ / (128.0F * (anInt6288 * -1212653763) * class52.method545());
	    aFloatArray8524[1] = 0.0F;
	    aFloatArray8524[2] = 0.0F;
	    aFloatArray8524[3] = 0.0F;
	    aFloatArray8524[4] = 0.0F;
	    aFloatArray8524[5] = i_392_ / (128.0F * (anInt6288 * -1212653763) * class52.method552());
	    aFloatArray8524[6] = 0.0F;
	    aFloatArray8524[7] = 0.0F;
	    aFloatArray8524[8] = 0.0F;
	    aFloatArray8524[9] = 0.0F;
	    aFloatArray8524[10] = 0.0F;
	    aFloatArray8524[11] = 0.0F;
	    aFloatArray8524[12] = -1.0F - (i_393_ * i_392_ / 128.0F - i * 2) / class52.method545();
	    aFloatArray8524[13] = 1.0F - ((2 * i_391_ + i_396_ * i_392_ / 128.0F) / class52.method552());
	    aFloatArray8524[14] = 0.0F;
	    aFloatArray8524[15] = 1.0F;
	    OpenGL.glMatrixMode(5889);
	    OpenGL.glLoadMatrixf(aFloatArray8524, 0);
		...
		for (int i_398_ = i_394_; i_398_ < i_396_; i_398_++) {
			...
			if (bools[i_400_ - i_393_][i_398_ - i_394_]) {
			    short[] is = (this.aShortArrayArray8550[i_399_]);
			    if (is != null) {
		...
		for (int i_402_ = i_394_; i_402_ < i_396_; i_402_++) {
			...
			if (bools[i_404_ - i_393_][i_402_ - i_394_]) {
			    short[] is = (this.aShortArrayArray8550[i_403_]);
			    if (is != null) {
	    ...
	    if (i_397_ > 0) {
		Class46_Sub1 class46_sub1 = new Class46_Sub1((this.aClass_ra_Sub2_8535), 5123, class298_sub53_sub1.buffer, (class298_sub53_sub1.index * 385051775));
		this.aClass_ra_Sub2_8535.method5254(class46_sub1, 4, 0, i_397_);
	    }
	}
    }
	...
	if ((this.aByteArrayArray8546[i][i_431_] & 0x1) == 0)
	    return null;
	int i_432_ = (anInt6288 * -1212653763 >> (this.aClass_ra_Sub2_8535.anInt8064));
	Class_na_Sub1 class_na_sub1 = (Class_na_Sub1) class_na;
	...
	if (class_na_sub1 != null && class_na_sub1.method3481(i_432_, i_432_)) {
	    ...
	    class_na_sub1_433_ = new Class_na_Sub1(this.aClass_ra_Sub2_8535, i_432_, i_432_);
	...
	this.aClass_ra_Sub2_8535 = class_ra_sub2;
	...
	for (int i_439_ = 1; i_439_ < anInt6286 * -1148794921; i_439_++) {
		...
		float f = (float) (1.0 / Math.sqrt(i_441_ * i_441_ + 4 * i_438_ * i_438_ + i_442_ * i_442_));
		this.aFloatArrayArray8530[i_440_][i_439_] = i_441_ * f;
		this.aFloatArrayArray8547[i_440_][i_439_] = -i_438_ * 2 * f;
		this.aFloatArrayArray8548[i_440_][i_439_] = i_442_ * f;
	    }
	}
	...
	if (this.aClass44_8541 != null && class_na != null) {
	    int i_446_ = (i - (i_443_ * (this.aClass_ra_Sub2_8535.anInt8066) >> 8) >> this.aClass_ra_Sub2_8535.anInt8064);
	    int i_447_ = (i_444_ - (i_443_ * ((this.aClass_ra_Sub2_8535).anInt8026) >> 8) >> this.aClass_ra_Sub2_8535.anInt8064);
	    this.aClass44_8541.method496(class_na, i_446_, i_447_);
	}
    }
	...
	if (this.aClass44_8541 == null || class_na == null)
	    return false;
	int i_451_ = (i - (i_448_ * (this.aClass_ra_Sub2_8535).anInt8066 >> 8) >> (this.aClass_ra_Sub2_8535.anInt8064));
	int i_452_ = (i_449_ - (i_448_ * (this.aClass_ra_Sub2_8535.anInt8026) >> 8) >> (this.aClass_ra_Sub2_8535.anInt8064));
	return this.aClass44_8541.method492(class_na, i_451_, i_452_);
    }
	...
	if (this.aClass44_8541 == null || class_na == null)
	    return false;
	int i_456_ = (i - (i_453_ * (this.aClass_ra_Sub2_8535).anInt8066 >> 8) >> (this.aClass_ra_Sub2_8535.anInt8064));
	int i_457_ = (i_454_ - (i_453_ * (this.aClass_ra_Sub2_8535.anInt8026) >> 8) >> (this.aClass_ra_Sub2_8535.anInt8064));
	return this.aClass44_8541.method492(class_na, i_456_, i_457_);
    }
	...
	if ((this.aByteArrayArray8545[i][i_486_] & 0xff) < i_487_)
	    this.aByteArrayArray8545[i][i_486_] = (byte) i_487_;
    }

    @Override
    public void av(Class_na class_na, int i, int i_488_, int i_489_, int i_490_, boolean bool) {
	if (this.aClass44_8541 != null && class_na != null) {
	    int i_491_ = (i - (i_488_ * (this.aClass_ra_Sub2_8535.anInt8066) >> 8) >> this.aClass_ra_Sub2_8535.anInt8064);
	    int i_492_ = (i_489_ - (i_488_ * ((this.aClass_ra_Sub2_8535).anInt8026) >> 8) >> this.aClass_ra_Sub2_8535.anInt8064);
	    this.aClass44_8541.method491(class_na, i_491_, i_492_);
	}
    }

    @Override
    public void method6344(Class298_Sub10 class298_sub10, int[] is) {
	this.aClass458_8536.method5968(new Class298_Sub3(this.aClass_ra_Sub2_8535, this, class298_sub10, is), 1011020488);
    }
