...
public class Class209 {
	...
	try {
		...
		if (class391.anIntArrayArray4187[i].length > 1) {
		    int i_6_ = (int) (Math.random() * (class391.anIntArrayArray4187[i]).length);
		    if (i_6_ > 0)
			i_3_ = class391.anIntArrayArray4187[i][i_6_];
		}
		int i_7_ = 256;
		if (null != class391.anIntArray4183 && null != class391.anIntArray4190)
		    i_7_ = ((int) (Math.random() * (class391.anIntArray4190[i] - class391.anIntArray4183[i])) + class391.anIntArray4183[i]);
    ...
    static final void method1940(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_12_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    int i_13_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_12_ & -1 - (1 << i_13_);
	}
	catch (RuntimeException runtimeexception) {
