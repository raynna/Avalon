...
public class Class23 {
    ...
    static final void method375(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class352.anInt3817 * -804513353;
	}
	...
	try {
		...
		Class298_Sub24_Sub3 class298_sub24_sub3 = class298_sub49.aClass308_Sub1_7591.method3770((byte) 9);
	...
	try {
		...
		class298_sub36.out.writeShort((Class58.method693(string, -142100047) + Class58.method693(string_2_, -435846723) + Class58.method693(string_3_, 733332406) + 1), 16711935);
		class298_sub36.out.writeString(string, 2114181594);
		class298_sub36.out.writeString(string_2_, 2128054697);
		class298_sub36.out.writeString(string_3_, 2103261593);
		int i_5_ = 0;
		if (bool)
		    i_5_ |= 0x1;
		if (bool_4_)
		    i_5_ |= 0x2;
		class298_sub36.out.writeByte(i_5_);
    ...
    static final void method378(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = -278777595 * Class436.anInt5506;
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 1592446965 * Class436.anInt5479;
	}
	catch (RuntimeException runtimeexception) {
