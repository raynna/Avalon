...
public class Class491 {
	...
	try {
		...
		this.aClass348_6079.method4187();
	    }
	    synchronized (this.aClass348_6078) {
		this.aClass348_6078.method4187();
	    }
	}
	...
	try {
	    Class492 class492;
	    synchronized (this.aClass348_6079) {
		class492 = (Class492) this.aClass348_6079.method4184(i);
	    }
	    if (null != class492)
		return class492;
	    byte[] is;
	    synchronized (this.idx2) {
		is = (this.idx2.getFile(-1006924897 * Class120.aClass120_1438.anInt1460, i));
	    }
	    ...
	    synchronized (this.aClass348_6079) {
		this.aClass348_6079.method4194(class492, i);
	    }
	    return class492;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    synchronized (this.aClass348_6079) {
		this.aClass348_6079.method4189();
	    }
	    synchronized (this.aClass348_6078) {
		this.aClass348_6078.method4189();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    synchronized (this.aClass348_6079) {
		this.aClass348_6079.method4186(i, 677676972);
	    }
	    synchronized (this.aClass348_6078) {
		this.aClass348_6078.method4186(i, -452140449);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	this.aClass348_6078 = new Class348(2);
	this.idx2 = class243;
	this.aClass243_6077 = class243_2_;
	this.idx2.method2316((Class120.aClass120_1438.anInt1460) * -1006924897, -1015661848);
    }
	...
	try {
	    ...
	    client.aFloat8949 += l * client.aFloat8759 / 6.0F;
	    client.aFloat8757 += client.aFloat8760 * l / 6.0F;
    ...
    static final void method6177(IComponentDefinition class105, Class403 class403, int i) {
	try {
	    int i_8_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    int i_9_ = ((class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) - 1);
	    if (6 != 1548853569 * class105.anInt1184 && class105.anInt1184 * 1548853569 != 2)
		throw new RuntimeException("");
	    NPCDefinitions class503 = Class15.aClass507_224.method6269(class105.anInt1151 * 572201537, -834875221);
	...
	try {
	    Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(7, i);
	    class298_sub37_sub12.method3449((byte) 50);
	    class298_sub37_sub12.type = i_10_ * 1274450087;
	}
	catch (RuntimeException runtimeexception) {
