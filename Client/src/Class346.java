...
public class Class346 {
    ...
    static final void method4170(Class403 class403, short i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub16_7557.method5686(-550588042) ? 1 : 0;
	}
	...
	try {
	    IndexedImage[] class89s = IndexedImage.method993(class243, Class74.anInt692 * -1217066055, 0);
	    ...
	    class89s = IndexedImage.method993(class243, -355151363 * Class74.anInt694, 0);
	    ...
	    class89s = IndexedImage.method993(class243, 1838189665 * Class143.anInt1558, 0);
	    ...
	    class89s = IndexedImage.method993(class243, Class400.anInt5223 * 1862609057, 0);
	    ...
	    class89s = IndexedImage.method993(class243, -81301735 * Class74.anInt693, 0);
	    ...
	    class89s = IndexedImage.method993(class243, Class74.anInt696 * -2088314757, 0);
	    ...
	    class89s = IndexedImage.method993(class243, Class298_Sub36.anInt7398 * -1199789537, 0);
	    Class234.aClass57Array2598 = new Class57[class89s.length];
	    int i_21_ = 25;
	    for (int i_22_ = 0; i_22_ < class89s.length; i_22_++) {
		class89s[i_22_].method991(-i_21_ + (int) (Math.random() * i_21_ * 2.0), -i_21_ + (int) (Math.random() * i_21_ * 2.0), -i_21_ + (int) (Math.random() * i_21_ * 2.0));
		Class234.aClass57Array2598[i_22_] = class_ra.method5125(class89s[i_22_], true);
	    }
	    class89s = IndexedImage.method993(class243, Class82_Sub6.anInt6842 * -2107184677, 0);
	    ...
	    class89s = IndexedImage.method993(class243, Class494.anInt6092 * -1624054445, 0);
	    SubIncommingPacket.aClass57Array2349 = new Class57[class89s.length];
	    i_21_ = 12;
	    for (int i_24_ = 0; i_24_ < class89s.length; i_24_++) {
		class89s[i_24_].method991(-i_21_ + (int) (Math.random() * i_21_ * 2.0), -i_21_ + (int) (Math.random() * i_21_ * 2.0), -i_21_ + (int) (Math.random() * i_21_ * 2.0));
		SubIncommingPacket.aClass57Array2349[i_24_] = class_ra.method5125(class89s[i_24_], true);
	    }
	    class89s = IndexedImage.method993(class243, Class74.anInt697 * 1200791325, 0);
	    Class130_Sub2.aClass57Array6959 = new Class57[class89s.length];
	    i_21_ = 12;
	    for (int i_25_ = 0; i_25_ < class89s.length; i_25_++) {
		class89s[i_25_].method991(-i_21_ + (int) (Math.random() * i_21_ * 2.0), -i_21_ + (int) (Math.random() * i_21_ * 2.0), -i_21_ + (int) (Math.random() * i_21_ * 2.0));
		Class130_Sub2.aClass57Array6959[i_25_] = class_ra.method5125(class89s[i_25_], true);
	    }
	    Class144.aClass57_1562 = class_ra.method5125(IndexedImage.method987(class243, (Class237.anInt6667 * 1359711467), 0), true);
	    Graphics.aClass57_573 = class_ra.method5125(IndexedImage.method987(class243, ((Class128_Sub1.anInt8557) * -1848350339), 0), true);
	    class89s = IndexedImage.method993(class243, Class298_Sub24_Sub1.anInt9281 * -328242359, 0);
	...
	try {
	    return new StringBuilder().append(class298_sub37_sub5.aString9585).append(Class285.method2709(16777215, -1514789129)).append(" >").toString();
	}
	catch (RuntimeException runtimeexception) {
