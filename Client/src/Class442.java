...
public class Class442 {
    ...
    static final void method5873(Class403 class403, byte i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_0_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    boolean bool = 1 == (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]);
	    if (null != Class301_Sub1.aClass437_7637) {
		Class298 class298 = Class301_Sub1.aClass437_7637.method5812(i_0_);
		if (class298 != null && !bool)
		    class298.method2839(-1460969981);
		else if (null == class298 && bool) {
		    class298 = new Class298();
		    Class301_Sub1.aClass437_7637.method5817(class298, i_0_);
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method5874(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = ((Class365_Sub1) class403.anInterface3_5233).method4363((byte) 23);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method5875(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8646 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method5876(Class403 class403, int i) {
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = class352.aString3792;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method5877(Class403 class403, int i) {
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = class105.method1109(i_2_, class497.aString6101, 2117840940);
	    else
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = class105.method1117(i_2_, -388931549 * class497.anInt6100, -659898667);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method5878(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class190.method1859((byte) -52);
	}
	catch (RuntimeException runtimeexception) {
