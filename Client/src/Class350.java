...
public class Class350 {
    ...
    public static ClanChannel aClass298_Sub25_3757;
	...
	try {
		...
		if (anIntArrayArray3710 == null)
		    anIntArrayArray3710 = (new int[(this.aClass349_3725.aClass405_3707.anIntArray5267).length][]);
		...
		if (anIntArray3742 == null)
		    anIntArray3742 = (new int[(this.aClass349_3725.aClass405_3707.anIntArray5267).length]);
		int i_8_ = class298_sub53.readUnsignedByte();
		anIntArray3742[i_8_] = class298_sub53.readUnsignedShort();
	    } else if (i == 56) {
		if (null == anIntArrayArray3753)
		    anIntArrayArray3753 = (new int[(this.aClass349_3725.aClass405_3707.anIntArray5267).length][]);
	...
	try {
		...
		return null;
	    this.aClass222Array3718 = new Class222[anIntArrayArray3710.length];
		...
		if (i_12_ == 0 && 0 == i_13_ && 0 == i_14_ && 0 == i_15_ && 0 == i_16_ && i_17_ == 0) {
		    ...
		    Class222 class222 = (this.aClass222Array3718[i_11_] = new Class222());
		    if (0 != i_17_)
	...
	try {
		...
		int i_18_ = (int) (Math.random() * (-5125477 * this.anInt3714));
		int i_19_;
	...
	try {
		...
		is[i_24_++] = (int) (class298.hash * 7051297995265073167L);
	    }
	    return is;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4212(Class403 class403, short i) {
	try {
    ...
    static final void method4213(Class403 class403, int i) {
	try {
    ...
    static final void method4216(Class403 class403, int i) {
	try {
    ...
    static final void method4217(Class403 class403, int i) {
	try {
	    int i_32_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub2_7547.method5612(i_32_, 1352882135);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		for (int i_33_ = Class8.anInt104 * -917301319; i_33_ < Class8.aStringArray109.length; i_33_++) {
			...
			Class146.aLong1576 = (Class122.method1319((byte) 1) + 1000 * i_34_) * 6717445677357895093L;
			return;
		    }
