...
public class LividFarmControler extends Controler {
    ...
    private transient WorldTile fenceTile[] = {new WorldTile(2108, 3953, 0), new WorldTile(2116, 3953, 0), new WorldTile(2118, 3953, 0), new WorldTile(2120, 3951, 0), new WorldTile(2120, 3946, 0), new WorldTile(2120, 3945, 0)};
    ...
    private transient WorldTile patchTile[] = {
            // first row
            new WorldTile(2098, 3949, 0), new WorldTile(2100, 3949, 0), new WorldTile(2102, 3949, 0), new WorldTile(2104, 3949, 0), new WorldTile(2106, 3949, 0),

            // second row
            new WorldTile(2098, 3949 - 3, 0), new WorldTile(2100, 3949 - 3, 0), new WorldTile(2102, 3949 - 3, 0), new WorldTile(2104, 3949 - 3, 0), new WorldTile(2106, 3949 - 3, 0),

            // third row
            new WorldTile(2098, 3949 - 6, 0), new WorldTile(2100, 3949 - 6, 0), new WorldTile(2102, 3949 - 6, 0), new WorldTile(2104, 3949 - 6, 0), new WorldTile(2106, 3949 - 6, 0)};
