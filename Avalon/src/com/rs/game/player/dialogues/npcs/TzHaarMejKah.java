...
public class TzHaarMejKah extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case -1:
			stage = 0;
			sendOptionsDialogue(SEND_DEFAULT_OPTIONS_TITLE, "What is this place?", "Who's the current champion?",
		...
		case 23:
			...
			sendNPCDialogue(npcId, 9827, "Ah that would be Y'Haar-Mej-"
					+ (FightPits.currentChampion == null ? "none" : FightPits.currentChampion) + "!");
			break;
		default:
			end();
			break;
