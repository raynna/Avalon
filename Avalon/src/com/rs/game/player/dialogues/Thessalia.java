...
public class Thessalia extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case 3:
			stage = 4;
			sendOptionsDialogue(SEND_DEFAULT_OPTIONS_TITLE, "Tell me more about this makeover.",
		...
		case 8:
			stage = 9;
			sendOptionsDialogue(SEND_DEFAULT_OPTIONS_TITLE, "I'd like to change my outfit, please.",
