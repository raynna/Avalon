	...
	public void run(int interfaceId, int componentId) {
		...
		case 3:
			...
			case OPTION_1:
				...
				break;
			case OPTION_2:
				sendNPCDialogue(WARTFACE, PLAIN_TALKING,
		...
		case 6:
			...
			case OPTION_2:
				...
				break;
			case OPTION_3:
				sendNPCChat(Mood.CONFUSED, "That would mean me wrong... but at least Wartface " + " not right!");
				stageInt = 20;
				break;
			}
			break;
		...
		case 7:
			sendNPCDialogue(WARTFACE, ANGRY,
		...
		case 20:
			sendNPCDialogue(WARTFACE, CONFUSED,
		...
		case 29:
			switch (componentId) {
			case OPTION_1:
				sendNPCDialogue(WARTFACE, NORMAL,
		...
		case 51:
			sendNPCDialogue(WARTFACE, ANGRY, "You stupid! Only stupid goblins think red armour " + "better!");
			stageInt = 52;
			break;
