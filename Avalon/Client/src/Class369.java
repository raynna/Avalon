...
public class Class369 {
	...
	try {
		...
		this.anIntArrayArray4010 = new int[i_2_][3];
		for (int i_3_ = 0; i_3_ < i_2_; i_3_++) {
		    this.anIntArrayArray4010[i_3_][0] = class298_sub53.readUnsignedShort();
		    this.anIntArrayArray4010[i_3_][1] = class298_sub53.readInt((byte) 34);
		    this.anIntArrayArray4010[i_3_][2] = class298_sub53.readInt((byte) 72);
		}
	    } else if (4 == i) {
		int i_4_ = class298_sub53.readUnsignedByte();
		this.anIntArrayArray4021 = new int[i_4_][3];
		for (int i_5_ = 0; i_5_ < i_4_; i_5_++) {
		    this.anIntArrayArray4021[i_5_][0] = class298_sub53.readUnsignedShort();
		    this.anIntArrayArray4021[i_5_][1] = class298_sub53.readInt((byte) -80);
		    this.anIntArrayArray4021[i_5_][2] = class298_sub53.readInt((byte) -11);
		}
	    } else if (i == 5)
		...
		this.anIntArray4015 = new int[i_6_];
		for (int i_7_ = 0; i_7_ < i_6_; i_7_++)
		    this.anIntArray4015[i_7_] = class298_sub53.readInt((byte) 87);
	    } else if (12 == i)
		...
		this.anIntArray4020 = new int[i_12_];
		this.anIntArray4013 = new int[i_12_];
		aStringArray4022 = new String[i_12_];
		for (int i_13_ = 0; i_13_ < i_12_; i_13_++) {
		    anIntArray4019[i_13_] = class298_sub53.readInt((byte) 8);
		    this.anIntArray4020[i_13_] = class298_sub53.readInt((byte) -38);
		    this.anIntArray4013[i_13_] = class298_sub53.readInt((byte) -23);
		...
		this.anIntArray4024 = new int[i_14_];
		this.anIntArray4009 = new int[i_14_];
		aStringArray4026 = new String[i_14_];
		for (int i_15_ = 0; i_15_ < i_14_; i_15_++) {
		    anIntArray4023[i_15_] = class298_sub53.readInt((byte) 111);
		    this.anIntArray4024[i_15_] = class298_sub53.readInt((byte) -1);
		    this.anIntArray4009[i_15_] = class298_sub53.readInt((byte) -36);
		    aStringArray4026[i_15_] = class298_sub53.readString(166034178);
		}
	    } else if (i == 249) {
		int i_16_ = class298_sub53.readUnsignedByte();
		if (this.aClass437_4018 == null) {
		    int i_17_ = Class416.method5590(i_16_, (byte) 16);
		    this.aClass437_4018 = new HashTable(i_17_);
		}
		for (int i_18_ = 0; i_18_ < i_16_; i_18_++) {
		    ...
		    this.aClass437_4018.method5817(class298, i_19_);
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (null != this.anIntArrayArray4010) {
		for (int i_20_ = 0; i_20_ < this.anIntArrayArray4010.length; i_20_++) {
		    if (interface23.method252((this.anIntArrayArray4010[i_20_][0]), (byte) 19) >= this.anIntArrayArray4010[i_20_][1])
			return true;
		}
	    }
	    if (null != this.anIntArrayArray4021) {
		for (int i_21_ = 0; i_21_ < this.anIntArrayArray4021.length; i_21_++) {
		    if (interface23.method250((this.anIntArrayArray4021[i_21_][0]), (byte) 36) >= this.anIntArrayArray4021[i_21_][1])
			return true;
		}
	    }
	    return false;
	...
	try {
	    if (null != this.anIntArrayArray4010) {
		for (int i_22_ = 0; i_22_ < this.anIntArrayArray4010.length; i_22_++) {
		    if (interface23.method252((this.anIntArrayArray4010[i_22_][0]), (byte) 99) >= this.anIntArrayArray4010[i_22_][2])
			return true;
		}
	    }
	    if (null != this.anIntArrayArray4021) {
		for (int i_23_ = 0; i_23_ < this.anIntArrayArray4021.length; i_23_++) {
		    if (interface23.method250((this.anIntArrayArray4021[i_23_][0]), (byte) 110) >= this.anIntArrayArray4021[i_23_][2])
			return true;
		}
	    }
	    return false;
	...
	try {
	    if (this.aClass362_4007.method4308(interface23, -2006575627) < anInt4006 * 1327747841)
		return false;
		...
		for (int i_25_ = 0; i_25_ < anIntArray4016.length; i_25_++) {
		    if (!this.aClass362_4007.method4307(anIntArray4016[i_25_], 245040087).method4562(interface23, -1717639697))
			return false;
		}
	    }
		...
		for (int i_26_ = 0; i_26_ < anIntArray4019.length; i_26_++) {
		    ...
		    if (i_27_ < this.anIntArray4020[i_26_] || i_27_ > this.anIntArray4013[i_26_])
			return false;
		}
	    }
		...
		for (int i_28_ = 0; i_28_ < anIntArray4023.length; i_28_++) {
		    ...
		    if (i_29_ < this.anIntArray4024[i_28_] || i_29_ > this.anIntArray4009[i_28_])
			return false;
		}
	    }
	    return true;
	...
	try {
	    ...
	    if (i_31_ < this.anIntArray4024[i] || i_31_ > this.anIntArray4009[i])
		return false;
	    return true;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		return false;
	    if (!this.aClass362_4007.method4307(anIntArray4016[i], 245040087).method4562(interface23, -1717639697))
		return false;
	    return true;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (i_35_ < this.anIntArray4020[i] || i_35_ > this.anIntArray4013[i])
		return false;
	    return true;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (null == this.aClass437_4018)
		return i_36_;
	    Class298_Sub35 class298_sub35 = ((Class298_Sub35) this.aClass437_4018.method5812(i));
	...
	try {
	    if (this.aClass362_4007.method4308(interface23, -1427823636) < anInt4006 * 1327747841)
		return false;
	    return true;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (null == this.aClass437_4018)
		return string;
	    Class298_Sub29 class298_sub29 = ((Class298_Sub29) this.aClass437_4018.method5812(i));
    ...
    static final void method4571(Class403 class403, byte i) {
	try {
	    int i_39_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class403.aClass162_5252.anIntArray1666[i_39_];
	}
	catch (RuntimeException runtimeexception) {
