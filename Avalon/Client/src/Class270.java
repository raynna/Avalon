...
public class Class270 {
	...
	try {
		...
		int i_0_ = (int) ((long) is.length * (long) (this.anInt2892 * 278980631) / (this.anInt2888 * -931883257)) + 14;
	...
	try {
		...
		int i_11_ = ((int) ((long) (this.anInt2892 * 278980631) * (long) is.length / (this.anInt2888 * -931883257)) + 14);
	...
	try {
	    if (null != this.anIntArrayArray2893)
		i = (int) ((long) (278980631 * this.anInt2892) * (long) i / (-931883257 * this.anInt2888));
	    return i;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (this.anIntArrayArray2893 != null)
		i = (int) ((long) (278980631 * this.anInt2892) * (long) i / (-931883257 * this.anInt2888)) + 6;
	    return i;
	}
	catch (RuntimeException runtimeexception) {
	...
	if (i_24_ != i) {
		...
		for (/**/; i_27_ < i_28_; i_27_++) {
		    double d_30_ = (i_27_ - d) * 3.141592653589793;
		    double d_31_ = d_29_;
		    if (d_30_ < -1.0E-4 || d_30_ > 1.0E-4)
			d_31_ *= Math.sin(d_30_) / d_30_;
		    d_31_ *= 0.54 + 0.46 * Math.cos((i_27_ - d) * 0.2243994752564138);
    ...
    static final void method2536(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    class105.anInt1166 = -970389233 * (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    ...
	    class105.anInt1167 = (-1915192419 * (class403.anIntArray5244[1 + 681479919 * class403.anInt5239]));
		...
		Class422_Sub14.method5682(class105.ihash * -440872681, -754597349);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2537(Class403 class403, int i) {
	try {
	    if (client.anInt8932 * -1333485389 >= 5 && -1333485389 * client.anInt8932 <= 9)
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = -1333485389 * client.anInt8932;
	    else
    ...
    static final void method2538(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = i_36_;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (i >= Class372.anInt4051 * -1424479739 && i_37_ <= 1135094847 * Class372.anInt4048 && i_38_ >= Class372.anInt4049 * 1155384281 && i_39_ <= -1062447355 * Class372.anInt4050)
    ...
    static final void method2540(Class403 class403, int i) {
	try {
	    int i_42_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.screenSizePreference.method5612(i_42_, 1352882135);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2541(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub4_7563.method5638((byte) 78) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
