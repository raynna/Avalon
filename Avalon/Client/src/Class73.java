...
public final class Class73 {
    ...
    Class73(int i) {
	this.anInt688 = 547036117 * i;
    }

    public void method814(int i, int i_0_, int i_1_) {
	try {
	    if (null == this.aClass437_687)
		this.aClass437_687 = new HashTable(-1623767683 * this.anInt688);
	    Class298_Sub35 class298_sub35 = ((Class298_Sub35) this.aClass437_687.method5812(i));
	    if (null != class298_sub35)
		class298_sub35.anInt7394 = -898670337 * i_0_;
	    else {
		class298_sub35 = new Class298_Sub35(i_0_);
		this.aClass437_687.method5817(class298_sub35, i);
	    }
	}
	...
	try {
	    if (this.aClass437_687 != null)
		this.aClass437_687.method5811((byte) -14);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method819(Class403 class403, int i) {
	try {
    ...
    static final void method820(Class403 class403, byte i) {
	try {
    ...
    static final void method821(IComponentDefinition class105, Class119 class119, Class403 class403, short i) {
	try {
		...
		Class365_Sub1_Sub1_Sub5.method4490(-440872681 * class105.ihash, -1349352488);
	}
	catch (RuntimeException runtimeexception) {
