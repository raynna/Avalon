...
public class Class8 {
	...
	try {
	    if ((class298_sub37_sub15.aString9669 == null) || class298_sub37_sub15.aString9669.length() == 0) {
		if (null != (class298_sub37_sub15.aString9657) && class298_sub37_sub15.aString9657.length() > 0)
		    return new StringBuilder().append(class298_sub37_sub15.option).append(Tradution.aClass470_5916.method6049(Class321.aClass429_3357, -875414210)).append(class298_sub37_sub15.aString9657).toString();
		return (class298_sub37_sub15.option);
	    }
	    if ((null != class298_sub37_sub15.aString9657) && class298_sub37_sub15.aString9657.length() > 0)
		return new StringBuilder().append(class298_sub37_sub15.option).append(Tradution.aClass470_5916.method6049(Class321.aClass429_3357, -875414210)).append(class298_sub37_sub15.aString9657).append(Tradution.aClass470_5916.method6049(Class321.aClass429_3357, -875414210)).append(class298_sub37_sub15.aString9669).toString();
	    return new StringBuilder().append(class298_sub37_sub15.option).append(Tradution.aClass470_5916.method6049(Class321.aClass429_3357, -875414210)).append(class298_sub37_sub15.aString9669).toString();
	}
    ...
    static final void method316(Class403 class403, byte i) {
	try {
    ...
    static final void method317(Class403 class403, int i) {
	try {
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = class403.myClanChannel.aString7358;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method320(Class403 class403, int i) {
	try {
	    Class62 class62 = class403.aClass365_Sub1_Sub1_Sub2_5242.method4437(658355638);
	    if (null == class62)
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = "";
	    else
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = class62.method721((byte) 1);
	}
	catch (RuntimeException runtimeexception) {
