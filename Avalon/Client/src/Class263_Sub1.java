...
public class Class263_Sub1 extends Class263 implements Interface9_Impl2_Impl1 {
	...
	if (!bool || i_2_ != 0 || i_1_ != 0) {
	    ...
	    OpenGL.glTexImage2Di(this.anInt6415, 0, 6408, this.anInt9952, this.anInt9951, 0, 32993, (this.aClass_ra_Sub3_Sub1_6422).anInt9841, is, i_1_ * 4);
	...
	if (!bool || i_5_ != 0 || i_4_ != 0) {
		...
		if (class55_7_ == Class55.aClass55_558)
		    ...
		    OpenGL.glTexImage2Dub(this.anInt6415, 0, Class_ra_Sub3_Sub1.method5533((this.aClass55_6419), (this.aClass77_6420)), i, i_3_, 0, Class_ra_Sub3_Sub1.method5532(this.aClass55_6419), 5121, is, i_4_);
	    }
	    OpenGL.glPixelStorei(3314, 0);
	} else
	...
	OpenGL.glTexSubImage2Dub(this.anInt6415, 0, i, i_8_, i_9_, i_10_, Class_ra_Sub3_Sub1.method5532(class55), 5121, is, i_11_);
	OpenGL.glPixelStorei(3314, 0);
	OpenGL.glPixelStorei(3317, 4);
    }
	...
	OpenGL.glTexSubImage2Dub(this.anInt6415, 0, i, i_13_, i_14_, i_15_, Class_ra_Sub3_Sub1.method5532(class55), 5121, is, i_16_);
	OpenGL.glPixelStorei(3314, 0);
	OpenGL.glPixelStorei(3317, 4);
    }
	...
	OpenGL.glTexSubImage2Di(this.anInt6415, 0, i, i_18_, i_19_, i_20_, 32993, (this.aClass_ra_Sub3_Sub1_6422).anInt9841, is, i_21_);
	OpenGL.glPixelStorei(3314, 0);
    }
	...
	int[] is_33_ = new int[(this.anInt9952 * this.anInt9951)];
	this.aClass_ra_Sub3_Sub1_6422.method5358(this);
	OpenGL.glGetTexImagei(this.anInt6415, 0, 32993, 5121, is_33_, 0);
	for (int i_34_ = 0; i_34_ < i_31_; i_34_++)
	    System.arraycopy(is_33_, ((i_29_ + (i_31_ - 1) - i_34_) * this.anInt9952), is, i_32_ + i_34_ * i_30_, i_30_);
    }
	...
	OpenGL.glTexSubImage2Di(this.anInt6415, 0, i, i_35_, i_36_, i_37_, 32993, (this.aClass_ra_Sub3_Sub1_6422).anInt9841, is, i_38_);
	OpenGL.glPixelStorei(3314, 0);
    }
	...
	OpenGL.glTexParameteri(this.anInt6415, 10243, bool_40_ ? 10497 : 33071);
    }
	...
	this.aClass_ra_Sub3_Sub1_6422.method5358(this);
	OpenGL.glTexParameteri(this.anInt6415, 10242, bool ? 10497 : 33071);
	OpenGL.glTexParameteri(this.anInt6415, 10243, bool_41_ ? 10497 : 33071);
    }
	...
	this.aClass_ra_Sub3_Sub1_6422.method5358(this);
	OpenGL.glTexParameteri(this.anInt6415, 10242, bool ? 10497 : 33071);
	OpenGL.glTexParameteri(this.anInt6415, 10243, bool_42_ ? 10497 : 33071);
    }
	...
	this.aClass_ra_Sub3_Sub1_6422.method5358(this);
	OpenGL.glTexParameteri(this.anInt6415, 10242, bool ? 10497 : 33071);
	OpenGL.glTexParameteri(this.anInt6415, 10243, bool_43_ ? 10497 : 33071);
    }
	...
	this.aClass_ra_Sub3_Sub1_6422.method5358(this);
	OpenGL.glTexParameteri(this.anInt6415, 10242, bool ? 10497 : 33071);
	OpenGL.glTexParameteri(this.anInt6415, 10243, bool_44_ ? 10497 : 33071);
    }
	...
	OpenGL.glTexSubImage2Di(this.anInt6415, 0, i, i_45_, i_46_, i_47_, 32993, (this.aClass_ra_Sub3_Sub1_6422).anInt9841, is, i_48_);
	OpenGL.glPixelStorei(3314, 0);
    }
	...
	this.aClass_ra_Sub3_Sub1_6422.method5358(this);
	OpenGL.glTexImage2Dub(this.anInt6415, 0, Class_ra_Sub3_Sub1.method5533((this.aClass55_6419), (this.aClass77_6420)), i, i_50_, 0, Class_ra_Sub3_Sub1.method5532(this.aClass55_6419), Class_ra_Sub3_Sub1.method5537(this.aClass77_6420), null, 0);
    }
	...
	OpenGL.glTexSubImage2Dub(this.anInt6415, 0, i, i_51_, i_52_, i_53_, Class_ra_Sub3_Sub1.method5532(class55), 5121, is, i_54_);
	OpenGL.glPixelStorei(3314, 0);
	OpenGL.glPixelStorei(3317, 4);
    }
	...
	int[] is_61_ = new int[(this.anInt9952 * this.anInt9951)];
	this.aClass_ra_Sub3_Sub1_6422.method5358(this);
	OpenGL.glGetTexImagei(this.anInt6415, 0, 32993, 5121, is_61_, 0);
	for (int i_62_ = 0; i_62_ < i_59_; i_62_++)
	    System.arraycopy(is_61_, ((i_57_ + (i_59_ - 1) - i_62_) * this.anInt9952), is, i_60_ + i_62_ * i_58_, i_58_);
    }
	...
	OpenGL.glTexSubImage2Df(this.anInt6415, 0, i, i_63_, i_64_, i_65_, Class_ra_Sub3_Sub1.method5532(class55), 5121, fs, i_66_);
	OpenGL.glPixelStorei(3314, 0);
    }
	...
	OpenGL.glTexSubImage2Dub(this.anInt6415, 0, i, i_68_, i_69_, i_70_, Class_ra_Sub3_Sub1.method5532(class55), 5121, is, i_71_);
	OpenGL.glPixelStorei(3314, 0);
	OpenGL.glPixelStorei(3317, 4);
    }
	...
	if (!bool || i_75_ != 0 || i_74_ != 0) {
	    ...
	    OpenGL.glTexImage2Df(this.anInt6415, 0, (Class_ra_Sub3_Sub1.method5533(this.aClass55_6419, this.aClass77_6420)), i, i_73_, 0, Class_ra_Sub3_Sub1.method5532(this.aClass55_6419), 5126, fs, i_74_ * 4);
	    OpenGL.glPixelStorei(3314, 0);
	} else
