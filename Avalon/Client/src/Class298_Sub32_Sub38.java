...
public class Class298_Sub32_Sub38 extends Class298_Sub32 {
	...
	try {
		...
		for (int i_2_ = 0; i_2_ < Class250.anInt2755 * -1474554145; i_2_++) {
		    ...
		    int i_4_ = ((this.anInt9562 * -1801516933) + i_3_);
		    i_4_ = i_4_ < -2048 ? i_4_ + 4096 : i_4_;
		    i_4_ = i_4_ > 2048 ? i_4_ - 4096 : i_4_;
		    int i_5_ = i_1_ + (351466605 * this.anInt9559);
		    i_5_ = i_5_ < -2048 ? 4096 + i_5_ : i_5_;
		    i_5_ = i_5_ > 2048 ? i_5_ - 4096 : i_5_;
		    int i_6_ = (-670406741 * this.anInt9561 + i_3_);
		    i_6_ = i_6_ < -2048 ? 4096 + i_6_ : i_6_;
		    i_6_ = i_6_ > 2048 ? i_6_ - 4096 : i_6_;
		    int i_7_ = i_1_ + (this.anInt9565 * 939068299);
	...
	try {
	    int i_10_ = ((-1052090709 * this.anInt9563 * (i + i_8_)) >> 12);
	    int i_11_ = Class250.anIntArray2763[255 * i_10_ >> 12 & 0xff];
	    i_11_ = (i_11_ << 12) / (this.anInt9563 * -1052090709);
	    i_11_ = (i_11_ << 12) / (454265253 * this.anInt9564);
	    i_11_ = i_11_ * (679642301 * this.anInt9560) >> 12;
	...
	try {
	    int i_14_ = ((i_12_ - i) * (-1052090709 * this.anInt9563) >> 12);
	    int i_15_ = Class250.anIntArray2763[255 * i_14_ >> 12 & 0xff];
	    i_15_ = (i_15_ << 12) / (-1052090709 * this.anInt9563);
	    i_15_ = (i_15_ << 12) / (454265253 * this.anInt9564);
	    i_15_ = i_15_ * (this.anInt9560 * 679642301) >> 12;
	...
	switch (i) {
	    case 5:
		this.anInt9560 = class298_sub53.readUnsignedShort() * -1402300779;
		break;
	    case 0:
		this.anInt9562 = class298_sub53.readUnsignedShort() * -2115004749;
		break;
	    case 3:
		this.anInt9565 = class298_sub53.readUnsignedShort() * -1141390301;
		break;
	    case 2:
		this.anInt9561 = class298_sub53.readUnsignedShort() * -871015677;
		break;
	    case 6:
		this.anInt9564 = class298_sub53.readUnsignedShort() * 233322029;
		break;
	    case 4:
		this.anInt9563 = class298_sub53.readUnsignedShort() * 1435675651;
		break;
	    case 1:
		this.anInt9559 = class298_sub53.readUnsignedShort() * -925420187;
		break;
	}
    }
	...
	this.anInt9559 = 0;
	this.anInt9561 = 0;
	this.anInt9565 = -1105127424;
	this.anInt9563 = -2143252480;
	this.anInt9560 = -1452716032;
	this.anInt9564 = 113614848;
    }
