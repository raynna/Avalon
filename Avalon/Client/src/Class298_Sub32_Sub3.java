...
public class Class298_Sub32_Sub3 extends Class298_Sub32 {
    ...
    void method3151() {
	if (null == this.anIntArrayArray9330)
	    this.anIntArrayArray9330 = new int[][] { { 0, 0 }, { 4096, 4096 } };
	if (this.anIntArrayArray9330.length < 2)
	    throw new RuntimeException();
	if (2 == this.anInt9329 * -1105883703)
	    method3155((byte) -127);
	...
	try {
		...
		for (int i_2_ = 0; i_2_ < -1474554145 * Class250.anInt2755; i_2_++) {
		    ...
		    if (i_3_ > 256)
			i_3_ = 256;
		    is[i_2_] = this.aShortArray9331[i_3_];
		}
	    }
	    return is;
	}
	...
	try {
	    if (i < 0)
		return this.anIntArray9328;
	    if (i >= this.anIntArrayArray9330.length)
		return this.anIntArray9324;
	    return this.anIntArrayArray9330[i];
	}
	catch (RuntimeException runtimeexception) {
	...
	if (0 == i) {
	    this.anInt9329 = class298_sub53.readUnsignedByte() * 417209465;
	    this.anIntArrayArray9330 = new int[class298_sub53.readUnsignedByte()][2];
	    for (int i_5_ = 0; (i_5_ < this.anIntArrayArray9330.length); i_5_++) {
		this.anIntArrayArray9330[i_5_][0] = class298_sub53.readUnsignedShort();
		this.anIntArrayArray9330[i_5_][1] = class298_sub53.readUnsignedShort();
	    }
	}
    }
	...
	try {
	    switch (this.anInt9329 * -1105883703) {
		default:
		    for (int i_6_ = 0; i_6_ < 257; i_6_++) {
			int i_7_ = i_6_ << 4;
			int i_8_;
			for (i_8_ = 1; i_8_ < (this.anIntArrayArray9330).length - 1; i_8_++) {
			    if ((this.anIntArrayArray9330[i_8_][0]) > i_7_) {
				if (i != -1265044202) {
				    /* empty */
				}
				break;
			...
			int[] is = (this.anIntArrayArray9330[i_8_ - 1]);
			int[] is_9_ = (this.anIntArrayArray9330[i_8_]);
			...
			if (i_12_ >= 32768)
			    i_12_ = 32767;
			this.aShortArray9331[i_6_] = (short) i_12_;
		    }
		    break;
		case 1:
			...
			int i_14_ = i_13_ << 4;
			int i_15_;
			for (i_15_ = 1; i_15_ < (this.anIntArrayArray9330).length - 1; i_15_++) {
			    if ((this.anIntArrayArray9330[i_15_][0]) > i_14_) {
				if (i != -1265044202)
				    throw new IllegalStateException();
				break;
			    }
			}
			int[] is = (this.anIntArrayArray9330[i_15_ - 1]);
			int[] is_16_ = (this.anIntArrayArray9330[i_15_]);
			...
			if (i_20_ >= 32768)
			    i_20_ = 32767;
			this.aShortArray9331[i_13_] = (short) i_20_;
		    }
		    break;
		case 2:
			...
			int i_22_ = i_21_ << 4;
			int i_23_;
			for (i_23_ = 1; i_23_ < (this.anIntArrayArray9330).length - 1; i_23_++) {
			    if ((this.anIntArrayArray9330[i_23_][0]) > i_22_) {
				if (i != -1265044202) {
				    /* empty */
				}
				break;
			...
			int[] is = (this.anIntArrayArray9330[i_23_ - 1]);
			int[] is_24_ = (this.anIntArrayArray9330[i_23_]);
			...
			if (i_38_ >= 32768)
			    i_38_ = 32767;
			this.aShortArray9331[i_21_] = (short) i_38_;
		    }
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		this.anInt9329 = class298_sub53.readUnsignedByte() * 417209465;
		this.anIntArrayArray9330 = new int[class298_sub53.readUnsignedByte()][2];
		for (int i_40_ = 0; i_40_ < (this.anIntArrayArray9330).length; i_40_++) {
		    this.anIntArrayArray9330[i_40_][0] = class298_sub53.readUnsignedShort();
		    this.anIntArrayArray9330[i_40_][1] = class298_sub53.readUnsignedShort();
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    int[] is = this.anIntArrayArray9330[0];
	    int[] is_41_ = this.anIntArrayArray9330[1];
	    int[] is_42_ = (this.anIntArrayArray9330[(this.anIntArrayArray9330.length - 2)]);
	    int[] is_43_ = (this.anIntArrayArray9330[(this.anIntArrayArray9330.length - 1)]);
	    this.anIntArray9328 = new int[] { is[0] + (is[0] - is_41_[0]), is[1] - is_41_[1] + is[1] };
	    this.anIntArray9324 = new int[] { is_42_[0] - is_43_[0] + is_42_[0], is_42_[1] + (is_42_[1] - is_43_[1]) };
	}
	catch (RuntimeException runtimeexception) {
	...
	if (aClass257_7384.aBoolean2810) {
		...
		if (i_46_ > 256)
		    i_46_ = 256;
		is[i_45_] = this.aShortArray9331[i_46_];
	    }
	}
	return is;
    }
	...
	if (0 == i) {
	    this.anInt9329 = class298_sub53.readUnsignedByte() * 417209465;
	    this.anIntArrayArray9330 = new int[class298_sub53.readUnsignedByte()][2];
	    for (int i_47_ = 0; (i_47_ < this.anIntArrayArray9330.length); i_47_++) {
		this.anIntArrayArray9330[i_47_][0] = class298_sub53.readUnsignedShort();
		this.anIntArrayArray9330[i_47_][1] = class298_sub53.readUnsignedShort();
	    }
	}
    }
	...
	if (aClass257_7384.aBoolean2810) {
		...
		if (i_50_ > 256)
		    i_50_ = 256;
		is[i_49_] = this.aShortArray9331[i_50_];
	    }
	}
	return is;
    }
