...
public class Class30_Sub1 extends Class30 {
	...
	for (int i_0_ = 0; i_0_ < 6; i_0_++)
	    OpenGL.glTexImage2Dub(34069 + i_0_, 0, Class_ra_Sub2.method5274(this.aClass55_377, this.aClass77_378), i, i, 0, Class_ra_Sub2.method5228(this.aClass55_377), 5121, null, 0);
	method410(true);
    }
	...
	for (int i_2_ = 0; i_2_ < 6; i_2_++)
	    OpenGL.glTexImage2Dub(34069 + i_2_, 0, Class_ra_Sub2.method5274(this.aClass55_377, this.aClass77_378), i, i, 0, Class_ra_Sub2.method5228(class55_1_), 5121, is[i_2_], 0);
	method410(true);
    }
	...
	if (bool) {
		...
		method411(34069 + i_4_, Class_ra_Sub2.method5274((this.aClass55_377), (this.aClass77_378)), i, i, 32993, this.aClass_ra_Sub2_381.anInt8186, is[i_4_]);
	} else {
	    for (int i_5_ = 0; i_5_ < 6; i_5_++)
		OpenGL.glTexImage2Di(34069 + i_5_, 0, (Class_ra_Sub2.method5274(this.aClass55_377, this.aClass77_378)), i, i, 0, 32993, ((this.aClass_ra_Sub2_381).anInt8186), is[i_5_], 0);
	}
	method410(true);
    }
}
