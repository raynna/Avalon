...
public final class Class420 {
	...
	for (int i = 0; i < aLongArray5343.length; i++)
	    aLongArray5343[i] = (long) Math.pow(37.0, i);
    }
	...
	try {
		...
		if ((2108312995 * class298_sub1_7_.anInt7151 == i) && 634196087 * class298_sub1_7_.anInt7150 == i_0_ && -2146829167 * class298_sub1_7_.anInt7155 == i_1_ && i_2_ == -431456739 * (class298_sub1_7_.anInt7157)) {
		...
		class298_sub1.anInt7157 = i_2_ * 1088435253;
		...
		Class298_Sub1.aClass453_7152.add(class298_sub1);
	    }
	    class298_sub1.anInt7156 = 240885009 * i_3_;
	    class298_sub1.anInt7153 = i_4_ * 998055383;
	    class298_sub1.anInt7149 = 1034640391 * i_5_;
    ...
    static final void method5607(Class403 class403, int i) {
	try {
	    int i_8_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.GRAND_EXCHANGE_SLOTS[i_8_].anInt2769 * 1383593425;
	}
	catch (RuntimeException runtimeexception) {
