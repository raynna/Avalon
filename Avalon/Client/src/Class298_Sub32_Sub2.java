...
public class Class298_Sub32_Sub2 extends Class298_Sub32 {
	...
	try {
		...
		for (int i_2_ = 0; (i_2_ < this.aClass98Array9321.length); i_2_++) {
		    Class98 class98 = this.aClass98Array9321[i_2_];
	...
	try {
	    if (0 == i) {
		this.aClass98Array9321 = new Class98[class298_sub53.readUnsignedByte()];
		for (int i_20_ = 0; (i_20_ < this.aClass98Array9321.length); i_20_++) {
		    int i_21_ = class298_sub53.readUnsignedByte();
		    switch (i_21_) {
			case 0:
			    this.aClass98Array9321[i_20_] = Class298_Sub37.method3405(class298_sub53, -920913322);
			    break;
			case 3:
			    this.aClass98Array9321[i_20_] = Class7.method313(class298_sub53, 2061944382);
			    break;
			case 1:
			    this.aClass98Array9321[i_20_] = SubIncommingPacket.method1922(class298_sub53, -1403634291);
			    break;
			case 2:
			    this.aClass98Array9321[i_20_] = Class68.method783(class298_sub53, 505653408);
			    break;
		    }
		}
	    } else if (i == 1)
	...
	if (0 == i) {
	    this.aClass98Array9321 = new Class98[class298_sub53.readUnsignedByte()];
	    for (int i_22_ = 0; i_22_ < this.aClass98Array9321.length; i_22_++) {
		int i_23_ = class298_sub53.readUnsignedByte();
		switch (i_23_) {
		    case 0:
			this.aClass98Array9321[i_22_] = Class298_Sub37.method3405(class298_sub53, -205247731);
			break;
		    case 3:
			this.aClass98Array9321[i_22_] = Class7.method313(class298_sub53, -291977486);
			break;
		    case 1:
			this.aClass98Array9321[i_22_] = SubIncommingPacket.method1922(class298_sub53, -1904035175);
			break;
		    case 2:
			this.aClass98Array9321[i_22_] = Class68.method783(class298_sub53, 634970133);
			break;
		}
	    }
	} else if (i == 1)
	...
	if (0 == i) {
	    this.aClass98Array9321 = new Class98[class298_sub53.readUnsignedByte()];
	    for (int i_24_ = 0; i_24_ < this.aClass98Array9321.length; i_24_++) {
		int i_25_ = class298_sub53.readUnsignedByte();
		switch (i_25_) {
		    case 0:
			this.aClass98Array9321[i_24_] = Class298_Sub37.method3405(class298_sub53, 492697170);
			break;
		    case 3:
			this.aClass98Array9321[i_24_] = Class7.method313(class298_sub53, -646790238);
			break;
		    case 1:
			this.aClass98Array9321[i_24_] = SubIncommingPacket.method1922(class298_sub53, 388197853);
			break;
		    case 2:
			this.aClass98Array9321[i_24_] = Class68.method783(class298_sub53, 892412290);
			break;
		}
	    }
	} else if (i == 1)
    ...
    static final void method3150(Class403 class403, int i) {
	try {
	    int i_50_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
