...
public class Class386 {
    ...
    static void method4722(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[681479919 * class403.anInt5239 - 1] = (Class316.aClass362_3318.method4307((class403.anIntArray5244[class403.anInt5239 * 681479919 - 1]), 245040087).aBoolean4027) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4723(Class403 class403, int i) {
	try {
    ...
    static final void method4724(Class403 class403, byte i) {
	try {
	...
	try {
		...
		i_15_ = (Class301.anInt3221 + ((class298_sub52.anInt7607 * 2122110429 + class352.anInt3804 * 1281846757 - Class301.anInt3230) * (Class301.anInt3256 - Class301.anInt3221) / (Class301.anInt3252 - Class301.anInt3230)));
		i_16_ = (((class352.anInt3793 * 968926443 + class298_sub52.anInt7607 * 2122110429 - Class301.anInt3230) * (Class301.anInt3256 - Class301.anInt3221) / (Class301.anInt3252 - Class301.anInt3230)) + Class301.anInt3221);
		i_18_ = (Class301.anInt3257 - ((class352.anInt3805 * -1901940595 + class298_sub52.anInt7610 * -372920341 - Class301.anInt3242) * (Class301.anInt3257 - Class301.anInt3255) / (Class301.anInt3241 - Class301.anInt3242)));
		i_17_ = (Class301.anInt3257 - ((-1294057761 * class352.anInt3807 + -372920341 * class298_sub52.anInt7610 - Class301.anInt3242) * (Class301.anInt3257 - Class301.anInt3255) / (Class301.anInt3241 - Class301.anInt3242)));
	    }
		...
		if (class4 != null) {
		    ...
		    i_24_ = ((-366520063 * class352.anInt3812 * (Class301.anInt3256 - Class301.anInt3221) / (Class301.anInt3252 - Class301.anInt3230)) + class298_sub52.anInt7609 * 1333098669);
		    i_25_ = (-685779893 * class298_sub52.anInt7606 - (60900013 * class352.anInt3813 * (Class301.anInt3257 - Class301.anInt3255) / (Class301.anInt3241 - Class301.anInt3242)));
		    if (null == class57)
	    ...
	    if (i_16_ < Class301.anInt3221 || i_15_ > Class301.anInt3256 || i_18_ < Class301.anInt3255 || i_17_ > Class301.anInt3257)
		return true;
	    Class301.method3711(class_ra, class298_sub52, class352);
	    if (null != class57) {
		...
		Class476.aClass453_5986.add(class298_sub6);
	    }
	    return false;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static void method4727(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[681479919 * class403.anInt5239 - 1] = (Class316.aClass362_3318.method4307((class403.anIntArray5244[681479919 * class403.anInt5239 - 1]), 245040087).anInt4014) * 1646094589;
	}
	catch (RuntimeException runtimeexception) {
