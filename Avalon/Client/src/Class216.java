...
public class Class216 implements Interface24 {
	...
	try {
	    if (this.aClass243_6656.method2312(this.aString6655, -2147290732))
		return 100;
	    return this.aClass243_6656.method2305(this.aString6655, -1986969413);
	}
	...
	this.aClass243_6656 = class243;
	this.aString6655 = string;
    }

    @Override
    public int method258() {
	if (this.aClass243_6656.method2312(this.aString6655, -2133628727))
	    return 100;
	return this.aClass243_6656.method2305(this.aString6655, -162075659);
    }
	...
	try {
	    ClientScript class298_sub37_sub17 = ((ClientScript) Class399.aClass354_5218.method4253(i));
	    if (class298_sub37_sub17 != null)
		return class298_sub37_sub17;
	    byte[] is = Class377.aClass243_4092.getFile(i, 0);
	    ...
	    Class399.aClass354_5218.method4255(class298_sub37_sub17, i);
	    return class298_sub37_sub17;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("jc.f(").append(')').toString());
    ...
    static final void method1997(Class403 class403, int i) {
	try {
    ...
    static final void method2003(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class287.myPlayer.aClass386_10084.method4719((byte) 0) >> 3;
	}
	catch (RuntimeException runtimeexception) {
