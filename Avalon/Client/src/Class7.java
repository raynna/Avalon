...
public class Class7 {
    ...
    static final void method310(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
    ...
    static final void method311(Class403 class403, int i) {
	try {
	    int i_0_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.GRAND_EXCHANGE_SLOTS[i_0_].method2401((byte) 8);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method312(Class403 class403, int i) {
	try {
	    ...
	    int i_3_ = (class403.anIntArray5244[2 + class403.anInt5239 * 681479919]);
