...
public class GraphicsPresetPreference extends Class422 {
    ...
    public GraphicsPresetPreference(int i, Class298_Sub48 class298_sub48) {
    ...
    public GraphicsPresetPreference(Class298_Sub48 class298_sub48) {
