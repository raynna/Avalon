...
public class Class298_Sub37 extends Class298 {
    ...
    public static int calculateRoute(int startX, int startY, int size, PathStrategy class336, Class289 planeClipData, boolean alternativeRoute, int[] calculatedPositionXsArray, int[] calculatedPositionYsArray) {
	try {
    ...
    static final void method3404(Class403 class403, byte i) {
	try {
	    int i_29_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    MapDetails class298_sub37_sub13 = Class301.method3705(i_29_);
	    if (class298_sub37_sub13 == null) {
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = 0;
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = 0;
	    } else {
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = (-2052483955 * class298_sub37_sub13.anInt9647 - class298_sub37_sub13.anInt9650 * 1364716801);
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = (929385381 * class298_sub37_sub13.anInt9646 - class298_sub37_sub13.anInt9649 * 1345239131);
	    }
	}
	catch (RuntimeException runtimeexception) {
