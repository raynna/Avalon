...
public class Class298_Sub27 extends Class298 {
	...
	this.anInt7363 = -1100183665 * i;
	this.anInt7364 = -197779873 * i_0_;
    }
    ...
    static final void method3106(Class403 class403, short i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1168 * 1867913305;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (bool) {
		    int i_44_ = i_11_ + i;
		    int i_45_ = i - i_11_;
		    Class82_Sub22.method940((Class372.anIntArrayArray4047[i_40_]), i_43_, i_45_, i_6_, -1836919463);
		    Class82_Sub22.method940((Class372.anIntArrayArray4047[i_40_]), i_45_, i_44_, i_5_, -2035540755);
		    Class82_Sub22.method940((Class372.anIntArrayArray4047[i_40_]), i_44_, i_42_, i_6_, -981316535);
		    Class82_Sub22.method940((Class372.anIntArrayArray4047[i_41_]), i_43_, i_45_, i_6_, -235264647);
		    Class82_Sub22.method940((Class372.anIntArrayArray4047[i_41_]), i_45_, i_44_, i_5_, -955018458);
		    Class82_Sub22.method940((Class372.anIntArrayArray4047[i_41_]), i_44_, i_42_, i_6_, 614343007);
		} else {
		    Class82_Sub22.method940((Class372.anIntArrayArray4047[i_40_]), i_43_, i_42_, i_6_, 2012650318);
		    Class82_Sub22.method940((Class372.anIntArrayArray4047[i_41_]), i_43_, i_42_, i_6_, -1092242835);
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
