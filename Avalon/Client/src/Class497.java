...
public class Class497 {
	...
	try {
	    if (1 == i)
		this.aChar6099 = Class493.method6190(class298_sub53.readByte(-12558881), 1872893689);
	    else if (2 == i)
    ...
    static final void method6207(Class403 class403, int i) {
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub26_7577, (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]), -1529967366);
