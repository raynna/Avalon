...
public class Class264_Sub4 extends Class264 {
    ...
    Class264_Sub4(Class_ra_Sub1 class_ra_sub1, Class505 class505, IndexedImage[] class89s, int[] is, int[] is_0_) {
	...
	for (int i = 0; i < class89s.length; i++) {
	    this.aByteArrayArray7135[i] = class89s[i].aByteArray818;
	    this.anIntArray7136[i] = class89s[i].anInt811;
	    this.anIntArray7134[i] = class89s[i].anInt815;
	}
    }
	...
	if ((this.aClass_ra_Sub1_7137.anIntArray7967) != null) {
		...
		int i_20_ = (692106883 * (this.aClass_ra_Sub1_7137).anInt7971);
		...
		if (i_18_ > 0 && i_19_ > 0) {
			...
			method2510((this.aByteArrayArray7135[c]), ((this.aClass_ra_Sub1_7137).anIntArray7967), i_15_, i_24_, i_21_, i_18_, i_19_, i_22_, i_23_, i, i_14_, this.anIntArray7133[c], class_ta, i_16_, i_17_);
		    else
			method2512((this.aByteArrayArray7135[c]), ((this.aClass_ra_Sub1_7137).anIntArray7967), i_15_, i_24_, i_21_, i_18_, i_19_, i_22_, i_23_, i, i_14_, this.anIntArray7133[c], class_ta, i_16_, i_17_);
		}
	    }
	}
    }
	...
	if (i_39_ > i_42_) {
	    i_42_ = i_39_;
	    i_30_ += (this.aClass_ra_Sub1_7137.anInt7971 * 692106883 * (i_39_ - i_36_));
	...
	if (i_74_ > i_78_) {
	    i_78_ = i_74_;
	    i_65_ += ((i_74_ - i_71_) * (692106883 * ((this.aClass_ra_Sub1_7137).anInt7971)));
	...
	if (null != (this.aClass_ra_Sub1_7137.anIntArray7967)) {
	    i += this.anIntArray7134[c];
	    i_92_ += this.anIntArray7136[c];
	    int i_94_ = this.anIntArray7133[c];
	    int i_95_ = this.anIntArray7132[c];
	    int i_96_ = (692106883 * (this.aClass_ra_Sub1_7137).anInt7971);
	    int i_97_ = i + i_92_ * i_96_;
	    int i_98_ = i_96_ - i_94_;
	    int i_99_ = 0;
	    int i_100_ = 0;
	    if (i_92_ < (this.aClass_ra_Sub1_7137.anInt7976) * -1278653805) {
		int i_101_ = (-1278653805 * ((this.aClass_ra_Sub1_7137).anInt7976) - i_92_);
		i_95_ -= i_101_;
		i_92_ = (this.aClass_ra_Sub1_7137.anInt7976 * -1278653805);
		i_100_ += i_94_ * i_101_;
		i_97_ += i_101_ * i_96_;
	    }
	    if (i_95_ + i_92_ > 63686679 * (this.aClass_ra_Sub1_7137.anInt7977))
		i_95_ -= (i_92_ + i_95_ - ((this.aClass_ra_Sub1_7137).anInt7977 * 63686679));
	    if (i < (this.aClass_ra_Sub1_7137.anInt7974) * -912871679) {
		int i_102_ = (-912871679 * ((this.aClass_ra_Sub1_7137).anInt7974) - i);
		i_94_ -= i_102_;
	    ...
	    if (i_94_ + i > (this.aClass_ra_Sub1_7137.anInt7991) * -1416794725) {
		int i_103_ = (i_94_ + i - -1416794725 * (this.aClass_ra_Sub1_7137).anInt7991);
		i_94_ -= i_103_;
		i_99_ += i_103_;
		i_98_ += i_103_;
	    }
		...
		if ((i_93_ & ~0xffffff) == -16777216)
		    method2511(this.aByteArrayArray7135[c], (this.aClass_ra_Sub1_7137.anIntArray7967), i_93_, i_100_, i_97_, i_94_, i_95_, i_98_, i_99_);
		else if (0 != (i_93_ & ~0xffffff))
		    method2509(this.aByteArrayArray7135[c], (this.aClass_ra_Sub1_7137.anIntArray7967), i_93_, i_100_, i_97_, i_94_, i_95_, i_98_, i_99_);
	    }
	}
    }
	...
	if (null != (this.aClass_ra_Sub1_7137.anIntArray7967)) {
	    ...
	    int i_108_ = 692106883 * ((this.aClass_ra_Sub1_7137).anInt7971);
	...
	if (null != (this.aClass_ra_Sub1_7137.anIntArray7967)) {
	    i += this.anIntArray7134[c];
	    i_116_ += this.anIntArray7136[c];
	    int i_118_ = this.anIntArray7133[c];
	    int i_119_ = this.anIntArray7132[c];
	    int i_120_ = 692106883 * ((this.aClass_ra_Sub1_7137).anInt7971);
	    int i_121_ = i + i_116_ * i_120_;
	    int i_122_ = i_120_ - i_118_;
	    int i_123_ = 0;
	    int i_124_ = 0;
	    if (i_116_ < (this.aClass_ra_Sub1_7137.anInt7976) * -1278653805) {
		int i_125_ = (-1278653805 * ((this.aClass_ra_Sub1_7137).anInt7976) - i_116_);
		i_119_ -= i_125_;
		i_116_ = ((this.aClass_ra_Sub1_7137).anInt7976 * -1278653805);
		i_124_ += i_118_ * i_125_;
		i_121_ += i_125_ * i_120_;
	    }
	    if (i_119_ + i_116_ > 63686679 * (this.aClass_ra_Sub1_7137.anInt7977))
		i_119_ -= (i_116_ + i_119_ - (this.aClass_ra_Sub1_7137.anInt7977) * 63686679);
	    if (i < (this.aClass_ra_Sub1_7137.anInt7974) * -912871679) {
		int i_126_ = (-912871679 * ((this.aClass_ra_Sub1_7137).anInt7974) - i);
		i_118_ -= i_126_;
		i = (this.aClass_ra_Sub1_7137.anInt7974 * -912871679);
		i_124_ += i_126_;
		i_121_ += i_126_;
	    ...
	    if (i_118_ + i > (this.aClass_ra_Sub1_7137.anInt7991) * -1416794725) {
		int i_127_ = (i_118_ + i - -1416794725 * (this.aClass_ra_Sub1_7137).anInt7991);
		i_118_ -= i_127_;
		i_123_ += i_127_;
		i_122_ += i_127_;
	    }
		...
		if ((i_117_ & ~0xffffff) == -16777216)
		    method2511(this.aByteArrayArray7135[c], (this.aClass_ra_Sub1_7137.anIntArray7967), i_117_, i_124_, i_121_, i_118_, i_119_, i_122_, i_123_);
		else if (0 != (i_117_ & ~0xffffff))
		    method2509(this.aByteArrayArray7135[c], (this.aClass_ra_Sub1_7137.anIntArray7967), i_117_, i_124_, i_121_, i_118_, i_119_, i_122_, i_123_);
	    }
	}
    }
	...
	if ((this.aClass_ra_Sub1_7137.anIntArray7967) != null) {
		...
		i += this.anIntArray7134[c];
		i_128_ += this.anIntArray7136[c];
		int i_132_ = this.anIntArray7133[c];
		int i_133_ = this.anIntArray7132[c];
		int i_134_ = (692106883 * (this.aClass_ra_Sub1_7137).anInt7971);
		int i_135_ = i + i_128_ * i_134_;
		int i_136_ = i_134_ - i_132_;
		int i_137_ = 0;
		int i_138_ = 0;
		if (i_128_ < -1278653805 * ((this.aClass_ra_Sub1_7137).anInt7976)) {
		    int i_139_ = ((this.aClass_ra_Sub1_7137.anInt7976) * -1278653805 - i_128_);
		    i_133_ -= i_139_;
		    i_128_ = -1278653805 * (this.aClass_ra_Sub1_7137).anInt7976;
		    i_138_ += i_139_ * i_132_;
		    i_135_ += i_139_ * i_134_;
		}
		if (i_133_ + i_128_ > ((this.aClass_ra_Sub1_7137).anInt7977) * 63686679)
		    i_133_ -= (i_133_ + i_128_ - 63686679 * (this.aClass_ra_Sub1_7137).anInt7977);
		if (i < -912871679 * ((this.aClass_ra_Sub1_7137).anInt7974)) {
		    int i_140_ = (-912871679 * (this.aClass_ra_Sub1_7137).anInt7974 - i);
		    i_132_ -= i_140_;
		    i = -912871679 * ((this.aClass_ra_Sub1_7137).anInt7974);
		    i_138_ += i_140_;
		    i_135_ += i_140_;
		...
		if (i_132_ + i > -1416794725 * ((this.aClass_ra_Sub1_7137).anInt7991)) {
		    int i_141_ = (i_132_ + i - ((this.aClass_ra_Sub1_7137).anInt7991) * -1416794725);
		    i_132_ -= i_141_;
		    i_137_ += i_141_;
		    i_136_ += i_141_;
		}
		if (i_132_ > 0 && i_133_ > 0) {
			...
			method2510((this.aByteArrayArray7135[c]), ((this.aClass_ra_Sub1_7137).anIntArray7967), i_129_, i_138_, i_135_, i_132_, i_133_, i_136_, i_137_, i, i_128_, this.anIntArray7133[c], class_ta, i_130_, i_131_);
		    else
			method2512((this.aByteArrayArray7135[c]), ((this.aClass_ra_Sub1_7137).anIntArray7967), i_129_, i_138_, i_135_, i_132_, i_133_, i_136_, i_137_, i, i_128_, this.anIntArray7133[c], class_ta, i_130_, i_131_);
		}
	    }
	}
    }
	...
	try {
	    ...
	    int i_147_ = i_142_ - Class301.anInt3245;
	    int i_148_ = i_143_ - Class301.anInt3238;
	    for (Class298_Sub52 class298_sub52 = ((Class298_Sub52) Class301.aClass453_3236.method5939(1766612795)); class298_sub52 != null; class298_sub52 = (Class298_Sub52) Class301.aClass453_3236.method5944(49146)) {
		if (class298_sub52.anInt7608 * -530122905 != i) {
		    ...
		    int i_151_ = (i_149_ + Class301.anInt3245 << 14 | i_150_ + Class301.anInt3238);
    ...
    static final void method2516(Class403 class403, int i) {
	try {
	    int i_154_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
