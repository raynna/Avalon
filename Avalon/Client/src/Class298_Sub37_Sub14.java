...
public class Class298_Sub37_Sub14 extends Class298_Sub37 {
	...
	try {
		...
		for (int i_4_ = 0; (i_4_ < this.anIntArray9656.length); i_4_++) {
		    ...
		    stringbuilder.append(this.aClass469_9651.method6044(method3460(i_4_, -237770641), (this.anIntArrayArray9654[i_4_]), (class298_sub53.method3647((Class26.method398((this.anIntArray9656[i_4_]), -818645984).anInt3998) * 153532243, (byte) 67))));
		}
	    }
	...
	try {
		...
		return null;
	    return Class26.method398((this.anIntArray9656[i]), -1627067354);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (1 == i)
		this.aStringArray9652 = (Class365_Sub1_Sub3_Sub1.method4508(class298_sub53.readString(1602597054), '<', 1942688210));
	    else if (i == 2) {
		...
		for (int i_12_ = 0; i_12_ < i_11_; i_12_++) {
			...
			for (int i_14_ = 0; i_14_ < -213410761 * class367.anInt3985; i_14_++)
			    this.anIntArrayArray9654[i_12_][i_14_] = class298_sub53.readUnsignedShort();
		    }
		}
	    } else if (4 == i)
		aBoolean9655 = false;
	...
	try {
		...
		for (int i_15_ = 0; (i_15_ < (this.anIntArray9656).length && i_15_ < is.length); i_15_++) {
		    ...
		    if (i_16_ > 0)
			class298_sub53.method3603(is[i_15_], i_16_, -211202833);
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
