...
public class Class297 {
	...
	//System.out.println("SOund id=" + i_0_);//sheit crashed client
    }
	...
	try {
		...
		if (i_20_ > 0) {
			...
			int damage = -1;
			int i_24_ = -1;
			int mark = stream.readUnsignedSmart(1723054621);
			if (32767 == mark) {
			    mark = stream.readUnsignedSmart(1723054621);
			    ...
			    mark = -1;
			int hitDelay = stream.readUnsignedSmart(1723054621);
			int hpBarPercentage = stream.readUnsigned128Byte((byte) 93);
			player.method4420(mark, damage, i_22_, i_24_, 443738891 * client.ticketCycle, hitDelay, hpBarPercentage, (byte) 121);
		    }
		}
	    }
		...
		if ((i_40_ & 0x1) != 0)
		    Class242_Sub1.method2282(2, i_40_, player.method4470(true, -2017419584), player.method4475(false, (byte) -87), player.aString10200, string, 252423564);
		...
		player.anInt10086 = (1208636921 * client.ticketCycle + -1132907677 * player.anInt10087 + 1195117671 * player.anInt10088);
	    }
		...
		player.anInt10095 = (stream.readUnsignedShort() + client.ticketCycle * 443738891) * 996079737;
		player.anInt10103 = (stream.readUnsignedShort() + client.ticketCycle * 443738891) * 1000906529;
		...
		if (player == Class287.myPlayer)
		    Class242_Sub1.method2282(2, 0, player.method4470(true, -1880046656), player.method4475(false, (byte) -103), player.aString10200, string, -588173673);
		...
		player.anInt10105 = ((443738891 * client.ticketCycle + stream.readUnsignedShort()) * 1828453179);
		player.anInt10106 = ((client.ticketCycle * 443738891 + stream.readUnsignedShort()) * -473408095);
	    }
	    if ((mask & 0x80000) != 0) {
    ...
    static final void method2838(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class406.aBoolean5274 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
