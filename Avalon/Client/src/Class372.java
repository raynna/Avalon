...
public class Class372 {
    ...
    static final void method4587(Class403 class403, int i) {
	try {
	    ...
	    int i_3_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 3]);
    ...
    static final void method4588(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub25_7569.method5716((byte) -30);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final boolean method4593(int i, int i_13_, int i_14_, PathStrategy class336, Class289 class289, byte i_15_) {
	try {
	    int i_16_ = i;
	    int i_17_ = i_13_;
	    int i_18_ = 64;
