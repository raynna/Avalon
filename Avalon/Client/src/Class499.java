...
public class Class499 {
	...
	this.aClass243_6112.method2316((Class120.aClass120_1436.anInt1460) * -1006924897, 236791533);
    }

    public void method6212(byte i) {
	try {
	    synchronized (this.aClass348_6111) {
		this.aClass348_6111.method4187();
	    }
	}
	...
	try {
	    synchronized (this.aClass348_6111) {
		this.aClass348_6111.method4189();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class493 class493;
	    synchronized (this.aClass348_6111) {
		class493 = (Class493) this.aClass348_6111.method4184(i);
	    }
	    if (class493 != null)
		return class493;
	    byte[] is;
	    synchronized (this.aClass243_6112) {
		is = (this.aClass243_6112.getFile(-1006924897 * Class120.aClass120_1436.anInt1460, i));
	    }
	...
	try {
	    synchronized (this.aClass348_6111) {
		this.aClass348_6111.method4186(i, -862651401);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return (new Class411[] { Class411.aClass411_5318, Class411.game_rs, Class411.game_stellardawn, Class411.aClass411_5319, Class411.aClass411_5321 });
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("uq.a(").append(')').toString());
	}
    ...
    static final void method6217(Class403 class403, int i) {
	try {
    ...
    static final void method6218(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
