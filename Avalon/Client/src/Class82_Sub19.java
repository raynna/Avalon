...
public abstract class Class82_Sub19 extends Class82 {
	...
	this.anInt6895 = class298_sub53.readUnsignedShort() * -752019511;
	this.anInt6894 = class298_sub53.readUnsignedShort() * -1262871307;
	this.anInt6893 = class298_sub53.readUnsignedByte() * 1089946905;
    }

    @Override
    boolean method870(int i) {
	try {
	    Class398 class398 = Class158_Sub1.aClass389_8568.method4857((720810617 * this.anInt6895), -2111155708);
    ...
    boolean method924() {
	Class398 class398 = (Class158_Sub1.aClass389_8568.method4857(720810617 * this.anInt6895, -1729093071));
    ...
    static final void method925(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
	    class105.aBoolean1180 = (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) == 1;
    ...
    static final void method927(Class403 class403, int i) {
	try {
    ...
    static final void method928(Class403 class403, int i) {
	try {
    ...
    static final void method929(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 840270937 * class105.anInt1306;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method930(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = -1102843797 * class403.aClass162_5252.bannedMembersCount;
	}
	catch (RuntimeException runtimeexception) {
