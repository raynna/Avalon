...
public class Class228 {
    ...
    static final void method2115(Class403 class403, int i) {
	try {
    ...
    static final void method2116(Class403 class403, int i) {
	try {
	    ...
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = stringbuilder.toString();
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2118(Class403 class403, byte i) {
	try {
    ...
    static final boolean method2120(int i, int i_8_, PathStrategy class336, Class289 class289, int i_9_) {
	try {
	    int i_10_ = i;
	    int i_11_ = i_8_;
	    int i_12_ = 64;
