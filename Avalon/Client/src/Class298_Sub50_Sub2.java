...
public class Class298_Sub50_Sub2 extends Class298_Sub50 {
	...
	try {
	    return this.anInt9772 * -1497786335;
	}
	...
	try {
	    return 1151921009 * this.anInt9771;
	}
	catch (RuntimeException runtimeexception) {
	...
	return this.anInt9762 * 2113899933;
    }

    @Override
    public int method3546(int i) {
	try {
	    switch (this.anInt9771 * 1151921009) {
		case 167:
		case 169:
		case 519:
		case 521:
	...
	try {
	    return (-1729630536048907557L * this.aLong9768);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return -1537929791 * this.anInt9748;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.anInt9762 -= point.x * 1060004021;
	    this.anInt9748 -= point.y * 1196163649;
	}
	catch (RuntimeException runtimeexception) {
