...
public final class Class298_Sub1 extends Class298 {
	...
	try {
		...
		if (class298_sub9.anIntArray7226[i_4_] >= 0 && (class298_sub9.anIntArray7226[i_4_] < (-888767613 * Class298_Sub32_Sub14.aClass477_9400.itemDefinitionsLength))) {
		    ItemDefinitions class468 = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions((class298_sub9.anIntArray7226[i_4_])));
	...
	try {
	    ...
	    class298_sub37_sub12.type = i_6_ * 1274450087;
	}
	catch (RuntimeException runtimeexception) {
