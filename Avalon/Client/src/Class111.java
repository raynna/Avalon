...
public class Class111 {
    ...
    public static Class111 idx8;
    public static Class111 idx2;
    ...
    Class111(int i) {
	this.anInt1366 = i * 1424986353;
    }

    public int method1233(int i) {
	try {
	    return this.anInt1366 * -1047699439;
	}
	...
	try {
	    ...
	    int i_1_ = client.GRAND_EXCHANGE_SLOTS[i_0_].method2400(-574288948);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_1_ == 5 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub13_7549, (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]), -800925761);
