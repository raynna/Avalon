...
public class Class438 {
	...
	try {
	    return null != this.aClass391_5524;
	}
	...
	try {
	    if (null == this.aClass391_5524 || i == 0)
		return false;
	    if (this.anInt5526 * -1577984117 > 0) {
		if (-1577984117 * this.anInt5526 >= i) {
		    this.anInt5526 -= -2070327261 * i;
		    return false;
		}
		i -= this.anInt5526 * -1577984117;
		this.anInt5526 = 0;
		method5837(this.aClass391_5524, -8792169 * this.anInt5523, (byte) 71);
	    }
	    i += this.anInt5525 * 458730501;
	    boolean bool = (this.aClass391_5524.aBoolean4176 | Class391.aBoolean4186);
	    if (i > 100 && (this.aClass391_5524.anInt4175 * -658922537 > 0)) {
		int i_2_;
		for (i_2_ = ((this.aClass391_5524.anIntArray4172).length - (this.aClass391_5524.anInt4175 * -658922537)); (this.anInt5523 * -8792169 < i_2_ && i > (this.aClass391_5524.anIntArray4169[this.anInt5523 * -8792169])); this.anInt5523 += 282466343)
		    i -= (this.aClass391_5524.anIntArray4169[this.anInt5523 * -8792169]);
		if (this.anInt5523 * -8792169 >= i_2_) {
		    int i_3_ = 0;
		    for (int i_4_ = i_2_; i_4_ < (this.aClass391_5524.anIntArray4172).length; i_4_++)
			i_3_ += (this.aClass391_5524.anIntArray4169[i_4_]);
		    if (0 == this.anInt5532 * -1542612693)
			this.anInt5527 += 1129171511 * (i / i_3_);
		    i %= i_3_;
		}
		this.anInt5529 = -64061137 * this.anInt5523 + -1266936279;
		if (-112073191 * this.anInt5529 >= (this.aClass391_5524.anIntArray4172).length) {
		    if ((this.aClass391_5524.anInt4175 * -658922537) == -1 && this.aBoolean5533)
			this.anInt5529 = 0;
		    else
			this.anInt5529 -= (this.aClass391_5524.anInt4175 * 838055791);
	    ...
	    while (i > (this.aClass391_5524.anIntArray4169[-8792169 * this.anInt5523])) {
		bool = true;
		i -= (this.aClass391_5524.anIntArray4169[((this.anInt5523 += 282466343) * -8792169 - 1)]);
		if (-8792169 * this.anInt5523 >= (this.aClass391_5524.anIntArray4172).length) {
		    if ((this.aClass391_5524.anInt4175 * -658922537) != -1 && -1542612693 * this.anInt5532 != 2) {
			this.anInt5523 -= (this.aClass391_5524.anInt4175 * -782361151);
			if (-1542612693 * this.anInt5532 == 0)
			    this.anInt5527 += 1129171511;
		    }
		    if ((2063993735 * this.anInt5527 >= (this.aClass391_5524.anInt4181 * -23055529)) || -8792169 * this.anInt5523 < 0 || (-8792169 * this.anInt5523 >= (this.aClass391_5524.anIntArray4172).length)) {
			this.aBoolean5530 = true;
			break;
		    }
		}
		method5837(this.aClass391_5524, -8792169 * this.anInt5523, (byte) 75);
		this.anInt5529 = this.anInt5523 * -64061137 + -1266936279;
		if (-112073191 * this.anInt5529 >= (this.aClass391_5524.anIntArray4172).length) {
		    if (-1 == (this.aClass391_5524.anInt4175 * -658922537) && this.aBoolean5533)
			this.anInt5529 = 0;
		    else
			this.anInt5529 -= (838055791 * this.aClass391_5524.anInt4175);
		    if (-112073191 * this.anInt5529 < 0 || (this.anInt5529 * -112073191 >= (this.aClass391_5524.anIntArray4172).length))
			this.anInt5529 = 1266936279;
		}
	    }
	    this.anInt5525 = -993902387 * i;
	    if (bool)
	...
	try {
	    return (this.aClass391_5524 != null ? -1945308871 * this.aClass391_5524.animationId : -1);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		int i_13_ = 0;
		if (method5838((short) 225)) {
		    i_13_ |= (-1050600049 * (this.aClass441_5534.anInt5588));
		    if (this.aBoolean5531 && null != (this.aClass391_5524.anIntArray4174))
			i_13_ |= -1050600049 * ((this.aClass441_5535).anInt5588);
		}
		return i_13_;
	    }
	    return 0;
	...
	try {
	    if (null != this.aClass391_5524.anIntArray4172 && method5838((short) 225)) {
		class387.method4765((this.aClass441_5534.aClass298_Sub37_Sub4_5583), (this.aClass441_5534.anInt5584 * 806878007), (this.aClass441_5534.aClass298_Sub37_Sub4_5587), -643912397 * this.aClass441_5534.anInt5586, 458730501 * this.anInt5525, (this.aClass391_5524.anIntArray4169[-8792169 * this.anInt5523]), i, i_14_, this.aClass391_5524.aBoolean4185, null);
		if (this.aBoolean5531 && this.aClass391_5524.anIntArray4174 != null && (this.aClass441_5535.aBoolean5585))
		    class387.method4765((this.aClass441_5535.aClass298_Sub37_Sub4_5583), (this.aClass441_5535.anInt5584) * 806878007, (this.aClass441_5535.aClass298_Sub37_Sub4_5587), -643912397 * (this.aClass441_5535).anInt5586, 458730501 * this.anInt5525, (this.aClass391_5524.anIntArray4169[-8792169 * this.anInt5523]), i, i_14_, this.aClass391_5524.aBoolean4185, null);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (this.aClass391_5524.anIntArray4172 != null && method5838((short) 225)) {
		class387.method4737((this.aClass441_5534.aClass298_Sub37_Sub4_5583), ((this.aClass441_5534).anInt5584 * 806878007));
		if (this.aBoolean5531 && null != this.aClass391_5524.anIntArray4174 && (this.aClass441_5535.aBoolean5585))
		    class387.method4737((this.aClass441_5535.aClass298_Sub37_Sub4_5583), (this.aClass441_5535.anInt5584) * 806878007);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.anInt5523 = 0;
	    this.anInt5529 = -1266936279 * ((this.aClass391_5524.anIntArray4172).length > 1 ? 1 : -1);
	    this.anInt5525 = 0;
	    this.aBoolean5530 = false;
	    this.anInt5526 = i * -2070327261;
	    this.anInt5527 = 0;
	    if (null != this.aClass391_5524 & this.aClass391_5524.anIntArray4172 != null) {
		method5837(this.aClass391_5524, -8792169 * this.anInt5523, (byte) -16);
	...
	try {
	    if (this.aClass391_5524 == null | (i -= this.anInt5526 * -1577984117) <= 0)
		return false;
	    return (this.aClass391_5524.aBoolean4176 | (458730501 * this.anInt5525 + i > (this.aClass391_5524.anIntArray4169[-8792169 * this.anInt5523])));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (null != this.aClass391_5524) {
		boolean bool = (this.aClass441_5534.method5863(Class298_Sub2.aClass395_7165, this.aClass391_5524, this.anInt5523 * -8792169, -112073191 * this.anInt5529, this.aClass391_5524.anIntArray4172, (byte) 103));
		if (bool && this.aBoolean5531 && this.aClass391_5524.anIntArray4174 != null)
		    this.aClass441_5535.method5863(Class298_Sub2.aClass395_7165, this.aClass391_5524, this.anInt5523 * -8792169, this.anInt5529 * -112073191, this.aClass391_5524.anIntArray4174, (byte) 103);
		return bool;
	    }
	    return false;
	}
	...
	try {
		...
		if (null != this.aClass391_5524.anIntArray4172 && method5838((short) 225)) {
		    class387.method4735((this.aClass441_5534.aClass298_Sub37_Sub4_5583), (this.aClass441_5534.anInt5584) * 806878007, (this.aClass441_5534.aClass298_Sub37_Sub4_5587), (this.aClass441_5534.anInt5586) * -643912397, this.anInt5525 * 458730501, (this.aClass391_5524.anIntArray4169[-8792169 * this.anInt5523]), i, this.aClass391_5524.aBoolean4185);
		    if (this.aBoolean5531 && (null != this.aClass391_5524.anIntArray4174) && (this.aClass441_5535.aBoolean5585))
			class387.method4735((this.aClass441_5535.aClass298_Sub37_Sub4_5583), (this.aClass441_5535.anInt5584) * 806878007, (this.aClass441_5535.aClass298_Sub37_Sub4_5587), (-643912397 * (this.aClass441_5535.anInt5586)), this.anInt5525 * 458730501, (this.aClass391_5524.anIntArray4169[-8792169 * this.anInt5523]), i, this.aClass391_5524.aBoolean4185);
		}
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass391_5524 = class438_22_.aClass391_5524;
	    this.aBoolean5530 = class438_22_.aBoolean5530;
	    this.aBoolean5531 = class438_22_.aBoolean5531;
	    this.anInt5526 = 1 * class438_22_.anInt5526;
	    this.anInt5527 = class438_22_.anInt5527 * 1;
	    this.anInt5523 = class438_22_.anInt5523 * 1;
	    this.anInt5529 = class438_22_.anInt5529 * 1;
	    this.anInt5525 = 1 * class438_22_.anInt5525;
	...
	try {
	    this.aClass441_5534.method5864(-2015637843);
	    if (this.aBoolean5531)
		this.aClass441_5535.method5864(-2050586678);
	}
	catch (RuntimeException runtimeexception) {
