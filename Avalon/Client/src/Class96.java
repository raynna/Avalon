...
public class Class96 {
	...
	this.anInt925 = 0;
	this.aBoolean939 = false;
	this.aBoolean940 = false;
	this.aBoolean941 = false;
	this.aClass298_Sub15_931 = class298_sub15;
	try {
		...
		int i_5_ = (this.aClass298_Sub15_931.anIntArray7278[i_4_]);
		if (i_5_ == 0)
		    i_2_ = i_4_;
		...
		if (i_6_ > 0) {
			...
			this.aBoolean939 = true;
		    else if (i_5_ == 7)
			this.aBoolean940 = true;
	    ...
	    this.anInt925 = i_1_;
	    this.aShortArray933 = new short[i_1_];
	    this.aShortArray934 = new short[i_1_];
	    this.aShortArray930 = new short[i_1_];
	    this.aShortArray936 = new short[i_1_];
	    this.aShortArray937 = new short[i_1_];
	    this.aByteArray938 = new byte[i_1_];
	    for (int i_8_ = 0; i_8_ < i_1_; i_8_++) {
		this.aShortArray933[i_8_] = aShortArray927[i_8_];
		this.aShortArray934[i_8_] = aShortArray926[i_8_];
		this.aShortArray930[i_8_] = aShortArray932[i_8_];
		this.aShortArray936[i_8_] = aShortArray928[i_8_];
		this.aShortArray937[i_8_] = aShortArray929[i_8_];
		this.aByteArray938[i_8_] = aByteArray944[i_8_];
	    }
	}
