...
public class Class298_Sub32_Sub11 extends Class298_Sub32 {
	...
	if (0 == i)
	    this.anInt9395 = class298_sub53.readUnsignedShort() * -715315885;
    }
	...
	try {
		...
		IndexedImage class89 = (anInt9394 * -1132597157 >= 0 ? IndexedImage.method987(aClass243_9393, -1132597157 * anInt9394, (-2121898277 * (this.anInt9395))) : IndexedImage.method979(aClass243_9393, (this.anInt9395) * -2121898277));
		class89.method984();
		this.anIntArray9398 = class89.method990();
		this.anInt9396 = -506570825 * class89.anInt812;
		this.anInt9397 = -274319933 * class89.anInt816;
		return true;
	    }
	    return false;
	}
    ...
    static final void method3208(Class403 class403, int i) {
	try {
	    if (client.aString8919 != null)
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = client.aString8919;
	    else
