...
public class Class445 {
	...
	try {
		...
		this.aClass348_5610.method4189();
	    }
	}
	...
	try {
	    Class485 class485;
	    synchronized (this.aClass348_5610) {
		class485 = (Class485) this.aClass348_5610.method4184(i);
	    }
	    if (null != class485)
		return class485;
	    byte[] is = this.aClass243_5609.getFile(((Class120.aClass120_1411.anInt1460) * -1006924897), i);
	...
	try {
	    synchronized (this.aClass348_5610) {
		this.aClass348_5610.method4187();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    synchronized (this.aClass348_5610) {
		this.aClass348_5610.method4186(i, 187343477);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	this.aClass243_5609 = class243;
	if (null != this.aClass243_5609)
	    this.aClass243_5609.method2316(Class120.aClass120_1411.anInt1460 * -1006924897, 1281975621);
    }

    static void method5895(GraphicsToolkit class_ra, byte i) {
	try {
	    class_ra.r(0, 0, -2110394505 * Class462.anInt5683, 350);
	    class_ra.B(0, 0, -2110394505 * Class462.anInt5683, 350, Class8.anInt98 * 256666041 << 24 | 0x3366FF, 1);
		...
		//class_ra.B(Class462.anInt5683 * -2110394505 - 16, i_5_, 12, i_4_, Class8.anInt98 * 256666041 << 24 | 0xFF99FF, 4);
    ...
    static final void method5896(Class403 class403, byte i) {
	try {
