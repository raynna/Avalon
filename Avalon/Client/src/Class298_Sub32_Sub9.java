...
public class Class298_Sub32_Sub9 extends Class298_Sub32 {
	...
	if (aClass257_7384.aBoolean2810) {
	    int[] is_0_ = method3129(0, (this.aBoolean9389 ? -289063255 * Class250.anInt2758 - i : i), -1887337990);
	    if (this.aBoolean9388) {
	...
	if (aClass239_7380.aBoolean2607) {
	    int[][] is_2_ = method3134(0, (this.aBoolean9389 ? Class250.anInt2758 * -289063255 - i : i), (byte) 8);
	    int[] is_3_ = is_2_[0];
	    int[] is_4_ = is_2_[1];
	    int[] is_5_ = is_2_[2];
	    int[] is_6_ = is[0];
	...
	try {
	    ...
	    if (aClass257_7384.aBoolean2810) {
		int[] is_12_ = method3129(0, (this.aBoolean9389 ? -289063255 * Class250.anInt2758 - i : i), -1887337990);
		if (this.aBoolean9388) {
	...
	switch (i) {
		...
		break;
	    case 0:
		this.aBoolean9388 = class298_sub53.readUnsignedByte() == 1;
		break;
	    case 1:
		this.aBoolean9389 = class298_sub53.readUnsignedByte() == 1;
		break;
	}
    }
	...
	if (aClass257_7384.aBoolean2810) {
	    int[] is_14_ = method3129(0, (this.aBoolean9389 ? -289063255 * Class250.anInt2758 - i : i), -1887337990);
	    if (this.aBoolean9388) {
	...
	try {
	    ...
	    if (aClass239_7380.aBoolean2607) {
		int[][] is_18_ = method3134(0, (this.aBoolean9389 ? Class250.anInt2758 * -289063255 - i : i), (byte) 8);
		int[] is_19_ = is_18_[0];
		int[] is_20_ = is_18_[1];
		int[] is_21_ = is_18_[2];
		int[] is_22_ = is[0];
	...
	if (aClass239_7380.aBoolean2607) {
	    int[][] is_27_ = method3134(0, (this.aBoolean9389 ? Class250.anInt2758 * -289063255 - i : i), (byte) 8);
	    int[] is_28_ = is_27_[0];
	    int[] is_29_ = is_27_[1];
	    int[] is_30_ = is_27_[2];
	    int[] is_31_ = is[0];
