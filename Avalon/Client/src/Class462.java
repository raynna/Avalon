...
public class Class462 {
    ...
    static final void method5991(Class403 class403, int i) {
	try {
    ...
    static final void method5992(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class360.anInt3894 * 235445649;
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 508782749 * Class360.anInt3888;
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 1800450029 * Class360.anInt3906;
    ...
    static final void method5993(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_1_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    int i_2_ = (class403.anIntArray5244[1 + 681479919 * class403.anInt5239]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 0 != (i_1_ & 1 << i_2_) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
