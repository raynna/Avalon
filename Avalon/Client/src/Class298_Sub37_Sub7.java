...
public class Class298_Sub37_Sub7 extends Class298_Sub37 {
	...
	try {
		...
		return i_1_;
	    Class298_Sub35 class298_sub35 = (Class298_Sub35) this.aClass437_9594.method5812(i);
	...
	try {
		...
		if (null == this.aClass437_9594) {
		    int i_5_ = Class416.method5590(i_4_, (byte) 16);
		    this.aClass437_9594 = new HashTable(i_5_);
		}
    ...
    static final void method3429(Class403 class403, int i) {
	try {
	    String string = (String) (class403.anObjectArray5240[(class403.anInt5241 -= 969361751) * -203050393]);
	    int i_17_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = new StringBuilder().append(string).append(Class128_Sub1.method1440(i_17_, true, (byte) 8)).toString();
	}
	catch (RuntimeException runtimeexception) {
