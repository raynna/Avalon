...
public class Class455 {
	...
	try {
		...
		this.aByteArray5653[i_0_] = (byte) 0;
	    this.anInt5656 = 0;
	    this.anInt5647 = 0;
	    this.aByteArray5654[0] = (byte) 0;
	    for (int i_1_ = 0; i_1_ < 8; i_1_++)
		this.aLongArray5658[i_1_] = 0L;
	}
	...
	try {
	    ...
	    int i_3_ = this.anInt5647 * 1985592997 & 0x7;
	    long l_4_ = l;
	    int i_5_ = 31;
	    int i_6_ = 0;
	    for (/**/; i_5_ >= 0; i_5_--) {
		i_6_ += ((this.aByteArray5653[i_5_] & 0xff) + ((int) l_4_ & 0xff));
		this.aByteArray5653[i_5_] = (byte) i_6_;
		i_6_ >>>= 8;
		l_4_ >>>= 8;
	    }
	    while (l > 8L) {
		...
		this.aByteArray5654[(this.anInt5656 * 1412698381)] |= i_7_ >>> i_3_;
		this.anInt5656 += -715643451;
		this.anInt5647 += (8 - i_3_) * 833616173;
		if (512 == 1985592997 * this.anInt5647) {
		    method5956((byte) 4);
		    this.anInt5656 = 0;
		    this.anInt5647 = 0;
		}
		this.aByteArray5654[1412698381 * this.anInt5656] = (byte) (i_7_ << 8 - i_3_ & 0xff);
		this.anInt5647 += 833616173 * i_3_;
		l -= 8L;
		i++;
	    }
	    int i_8_;
	    if (l > 0L) {
		i_8_ = is[i] << i_2_ & 0xff;
		this.aByteArray5654[1412698381 * this.anInt5656] |= i_8_ >>> i_3_;
	    } else
		i_8_ = 0;
	    if (l + i_3_ < 8L)
		this.anInt5647 += 833616173L * l;
	    else {
		this.anInt5656 += -715643451;
		this.anInt5647 += (8 - i_3_) * 833616173;
		l -= 8 - i_3_;
		if (1985592997 * this.anInt5647 == 512) {
		    method5956((byte) 4);
		    this.anInt5656 = 0;
		    this.anInt5647 = 0;
		}
		this.aByteArray5654[1412698381 * this.anInt5656] = (byte) (i_8_ << 8 - i_3_ & 0xff);
		this.anInt5647 += 833616173 * (int) l;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aByteArray5654[(this.anInt5656 * 1412698381)] |= 128 >>> (1985592997 * this.anInt5647 & 0x7);
	    this.anInt5656 += -715643451;
	    if (1412698381 * this.anInt5656 > 32) {
		while (this.anInt5656 * 1412698381 < 64)
		    this.aByteArray5654[((this.anInt5656 += -715643451) * 1412698381) - 1] = (byte) 0;
		method5956((byte) 4);
		this.anInt5656 = 0;
	    }
	    while (this.anInt5656 * 1412698381 < 32)
		this.aByteArray5654[((this.anInt5656 += -715643451) * 1412698381 - 1)] = (byte) 0;
	    System.arraycopy(this.aByteArray5653, 0, this.aByteArray5654, 32, 32);
	    method5956((byte) 4);
	    int i_10_ = 0;
	    int i_11_ = i;
	    while (i_10_ < 8) {
		long l = this.aLongArray5658[i_10_];
	...
	try {
	    ...
	    int i_21_ = 0;
	    while (i_20_ < 8) {
		this.aLongArray5660[i_20_] = ((long) this.aByteArray5654[i_21_] << 56 ^ (this.aByteArray5654[1 + i_21_] & 0xffL) << 48 ^ (this.aByteArray5654[2 + i_21_] & 0xffL) << 40 ^ (this.aByteArray5654[i_21_ + 3] & 0xffL) << 32 ^ (this.aByteArray5654[4 + i_21_] & 0xffL) << 24 ^ (this.aByteArray5654[5 + i_21_] & 0xffL) << 16 ^ (this.aByteArray5654[6 + i_21_] & 0xffL) << 8 ^ (this.aByteArray5654[7 + i_21_] & 0xffL));
		i_20_++;
		i_21_ += 8;
	    }
	    for (i_20_ = 0; i_20_ < 8; i_20_++)
		this.aLongArray5661[i_20_] = (this.aLongArray5660[i_20_] ^ (this.aLongArray5657[i_20_] = this.aLongArray5658[i_20_]));
	    for (i_20_ = 1; i_20_ <= 10; i_20_++) {
		for (i_21_ = 0; i_21_ < 8; i_21_++) {
		    this.aLongArray5659[i_21_] = 0L;
		    int i_22_ = 0;
		    int i_23_ = 56;
		    while (i_22_ < 8) {
			this.aLongArray5659[i_21_] ^= (aLongArrayArray5651[i_22_][(int) ((this.aLongArray5657[i_21_ - i_22_ & 0x7]) >>> i_23_) & 0xff]);
			i_22_++;
			i_23_ -= 8;
		    }
		}
		for (i_21_ = 0; i_21_ < 8; i_21_++)
		    this.aLongArray5657[i_21_] = this.aLongArray5659[i_21_];
		this.aLongArray5657[0] ^= aLongArray5652[i_20_];
		for (i_21_ = 0; i_21_ < 8; i_21_++) {
		    this.aLongArray5659[i_21_] = this.aLongArray5657[i_21_];
		    int i_24_ = 0;
		    int i_25_ = 56;
		    while (i_24_ < 8) {
			this.aLongArray5659[i_21_] ^= (aLongArrayArray5651[i_24_][(int) ((this.aLongArray5661[i_21_ - i_24_ & 0x7]) >>> i_25_) & 0xff]);
			i_24_++;
			i_25_ -= 8;
		    }
		}
		for (i_21_ = 0; i_21_ < 8; i_21_++)
		    this.aLongArray5661[i_21_] = this.aLongArray5659[i_21_];
	    }
	    for (i_20_ = 0; i_20_ < 8; i_20_++)
		this.aLongArray5658[i_20_] ^= (this.aLongArray5661[i_20_] ^ this.aLongArray5660[i_20_]);
	}
	catch (RuntimeException runtimeexception) {
	...
	this.anInt5647 = 0;
	this.anInt5656 = 0;
	this.aLongArray5658 = new long[8];
	this.aLongArray5657 = new long[8];
	this.aLongArray5659 = new long[8];
	this.aLongArray5660 = new long[8];
	this.aLongArray5661 = new long[8];
    }
	...
	try {
	    ...
	    else if (i - i_27_ >= -1424479739 * Class372.anInt4051 && i_27_ + i <= Class372.anInt4048 * 1135094847 && (i_26_ - i_28_ >= 1155384281 * Class372.anInt4049) && (i_26_ + i_28_ <= -1062447355 * Class372.anInt4050))
