...
public class Class61 {
	...
	Object object = this.aClass348_605.method4184(i);
	if (object != null)
	    return (Class30_Sub2) object;
	if (!this.anInterface_ma604.method170(i, (short) 25920))
	    return null;
	Class53 class53 = this.anInterface_ma604.method174(i, 107897040);
	if (i_0_ == -1)
    ...
    void method717() {
	this.aClass348_605.method4186(5, -56778652);
    }

    void method718() {
	this.aClass348_605.method4187();
    }
