...
public final class Class138_Sub1 extends Class138 {
	...
	this.aClass123_7001.method1331(this.aClass110Array6992[1]);
	...
	this.aClass123_7001.method1346((this.anIntArray7007[4]), aClass233_1542, -1599730439);
	...
	try {
	    ...
	    Class298_Sub31_Sub1 class298_sub31_sub1 = this.aClass123_7001.method1360("WVPMatrix", -1337554714);
	    Class298_Sub31_Sub1 class298_sub31_sub1_0_ = this.aClass123_7001.method1360("SpriteSampler", -347092125);
	    Class298_Sub31_Sub1 class298_sub31_sub1_1_ = this.aClass123_7001.method1360("MaskSampler", -1001377482);
	    Class298_Sub31_Sub1 class298_sub31_sub1_2_ = this.aClass123_7001.method1360("MulColour", 116022092);
	    Class298_Sub31_Sub1 class298_sub31_sub1_3_ = this.aClass123_7001.method1360("AddColour", -797757613);
	    Class298_Sub31_Sub1 class298_sub31_sub1_4_ = this.aClass123_7001.method1360("SpriteTexCoordMatrix", 271809133);
	    Class298_Sub31_Sub1 class298_sub31_sub1_5_ = this.aClass123_7001.method1360("MaskTexCoordMatrix", 1713273798);
	    this.aClass110Array6992[0] = this.aClass123_7001.method1327("Normal", (byte) -30);
	    this.aClass110Array6992[1] = this.aClass123_7001.method1327("Masked", (byte) -23);
	    this.aClass110Array6992[2] = this.aClass123_7001.method1327("AlphaTex", (byte) -96);
	    for (int i_6_ = 0; i_6_ < 3; i_6_++) {
		int i_7_ = (this.aClass123_7001.method1329(this.aClass110Array6992[i_6_], -180449856));
	    ...
	    this.aClass123_7001.method1331(this.aClass110Array6992[0]);
	    return true;
	}
	...
	try {
	    ...
	    this.aClass123_7001.method1336(this.anIntArray7007[0], aClass233_1540, (byte) -62);
	    this.aClass123_7001.method1346(this.anIntArray7007[3], aClass233_1541, -1599730439);
    ...
    static final void method1541(Class403 class403, int i) {
	try {
	    int i_11_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub28_7573.method5612(i_11_, 1352882135);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1542(Class403 class403, int i) {
	try {
    ...
    static final void method1543(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -1959403445;
	    Class239.method2210((class403.anIntArray5244[class403.anInt5239 * 681479919]), (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]), (class403.anIntArray5244[681479919 * class403.anInt5239 + 2]), (class403.anIntArray5244[681479919 * class403.anInt5239 + 3]), (class403.anIntArray5244[4 + 681479919 * class403.anInt5239]), 1835382767);
	}
	catch (RuntimeException runtimeexception) {
