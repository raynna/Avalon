...
public class Class298_Sub40_Sub12 extends Class298_Sub40 {
	...
	try {
	    this.anInt9729 = class298_sub53.readInt((byte) -10) * 1958209175;
	    this.anInt9728 = class298_sub53.readInt((byte) -38) * 7382949;
	    this.anInt9726 = class298_sub53.readUnsignedByte() * -1712778619;
	    this.anInt9725 = class298_sub53.readUnsignedByte() * 548598847;
	}
	...
	this.anInt9729 = class298_sub53.readInt((byte) 51) * 1958209175;
	this.anInt9728 = class298_sub53.readInt((byte) 12) * 7382949;
	this.anInt9726 = class298_sub53.readUnsignedByte() * -1712778619;
	this.anInt9725 = class298_sub53.readUnsignedByte() * 548598847;
    }
	...
	this.anInt9729 = class298_sub53.readInt((byte) 68) * 1958209175;
	this.anInt9728 = class298_sub53.readInt((byte) -25) * 7382949;
	this.anInt9726 = class298_sub53.readUnsignedByte() * -1712778619;
	this.anInt9725 = class298_sub53.readUnsignedByte() * 548598847;
    }
