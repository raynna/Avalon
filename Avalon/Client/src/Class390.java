...
public class Class390 {
	...
	try {
	    return (this.aClass119_4167.method1297(this.aClass105_4168.ihash * -440872681, (short) 10433));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass119_4167 = null;
	    this.aClass105_4168 = null;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4870(Class403 class403, short i) {
	try {
	    Class301_Sub1.aBoolean7635 = (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) == 1;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4872(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1262 * -1086526073;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		Class82_Sub22.method940((Class372.anIntArrayArray4047[i_12_]), i, i_7_, i_10_, -1334363034);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4874(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (int) client.aFloat8757 >> 3;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4875(Class298_Sub37_Sub15 class298_sub37_sub15, Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class247.method2366(class298_sub37_sub15, (byte) -65);
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = Class73.method822(class298_sub37_sub15, 533229453);
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = Class104.method1107(class298_sub37_sub15, (byte) 14);
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = Class207.method1933(class298_sub37_sub15, -532801249);
	}
	catch (RuntimeException runtimeexception) {
