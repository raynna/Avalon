...
public class Class343_Sub1 extends Class343 {
    ...
    public String aString7718;
    public String aString7719;
    public int anInt7720 = 718385687;

    public Class353 method4163(int i) {
	try {
	    return (Class52_Sub2_Sub1_Sub1.aClass353Array9987[-1414474747 * this.anInt3672]);
	}
