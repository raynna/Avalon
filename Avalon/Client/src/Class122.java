...
public class Class122 {
	...
	try {
		...
		int i_19_ = (int) (i_11_ + client.aFloatArray8891[0] - 18.0F);
    ...
    static final void method1321(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub10_7548.method5661((byte) 92);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1322(Class403 class403, short i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_21_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    int i_22_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_21_ < i_22_ ? i_21_ : i_22_;
	}
	catch (RuntimeException runtimeexception) {
