...
public class EntityStrategy extends PathStrategy {
    int anInt7715;
    ...
    static final void method4098(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub16_7557.method5687(2118701003) == 1 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4099(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = -1993792969 * class105.anInt1223;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4100(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class483.method6129((byte) 77);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4101(Class403 class403, byte i) {
	try {
    ...
    static final void method4102(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class384.anInt4128 * -821031539;
	}
	catch (RuntimeException runtimeexception) {
