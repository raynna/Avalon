...
public class Class298_Sub32_Sub22 extends Class298_Sub32 {
	...
	try {
		...
		for (int i_8_ = 0; i_8_ < Class250.anInt2755 * -1474554145; i_8_++) {
		    ...
		    if (i_9_ < this.anInt9463 * -583223949)
			is_5_[i_8_] = (this.anInt9463 * -583223949);
		    else if (i_9_ > (-1910102135 * this.anInt9465))
			is_5_[i_8_] = (this.anInt9465 * -1910102135);
		    else
			is_5_[i_8_] = i_9_;
		    if (i_10_ < -583223949 * this.anInt9463)
			is_6_[i_8_] = (-583223949 * this.anInt9463);
		    else if (i_10_ > (this.anInt9465 * -1910102135))
			is_6_[i_8_] = (this.anInt9465 * -1910102135);
		    else
			is_6_[i_8_] = i_10_;
		    if (i_11_ < this.anInt9463 * -583223949)
			is_7_[i_8_] = (this.anInt9463 * -583223949);
		    else if (i_11_ > (-1910102135 * this.anInt9465))
			is_7_[i_8_] = (this.anInt9465 * -1910102135);
		    else
			is_7_[i_8_] = i_11_;
		}
	    }
	...
	try {
		...
		for (int i_14_ = 0; i_14_ < -1474554145 * Class250.anInt2755; i_14_++) {
		    ...
		    if (i_15_ < this.anInt9463 * -583223949)
			is[i_14_] = -583223949 * (this.anInt9463);
		    else if (i_15_ > (this.anInt9465 * -1910102135))
			is[i_14_] = (-1910102135 * this.anInt9465);
		    else
			is[i_14_] = i_15_;
		}
	    }
	...
	switch (i) {
	    case 0:
		this.anInt9463 = class298_sub53.readUnsignedShort() * 380991419;
		break;
	    case 1:
		this.anInt9465 = class298_sub53.readUnsignedShort() * -784826695;
		break;
	    case 2:
	...
	if (aClass239_7380.aBoolean2607) {
		...
		if (i_24_ < this.anInt9463 * -583223949)
		    is_20_[i_23_] = this.anInt9463 * -583223949;
		else if (i_24_ > (-1910102135 * this.anInt9465))
		    is_20_[i_23_] = (this.anInt9465 * -1910102135);
		else
		    is_20_[i_23_] = i_24_;
		if (i_25_ < -583223949 * this.anInt9463)
		    is_21_[i_23_] = -583223949 * this.anInt9463;
		else if (i_25_ > (this.anInt9465 * -1910102135))
		    is_21_[i_23_] = (this.anInt9465 * -1910102135);
		else
		    is_21_[i_23_] = i_25_;
		if (i_26_ < this.anInt9463 * -583223949)
		    is_22_[i_23_] = this.anInt9463 * -583223949;
		else if (i_26_ > (-1910102135 * this.anInt9465))
		    is_22_[i_23_] = (this.anInt9465 * -1910102135);
		else
		    is_22_[i_23_] = i_26_;
	    }
	}
	...
	if (aClass257_7384.aBoolean2810) {
		...
		if (i_29_ < this.anInt9463 * -583223949)
		    is[i_28_] = -583223949 * this.anInt9463;
		else if (i_29_ > (this.anInt9465 * -1910102135))
		    is[i_28_] = (-1910102135 * this.anInt9465);
		else
		    is[i_28_] = i_29_;
	    }
	}
	...
	if (aClass257_7384.aBoolean2810) {
		...
		if (i_32_ < this.anInt9463 * -583223949)
		    is[i_31_] = -583223949 * this.anInt9463;
		else if (i_32_ > (this.anInt9465 * -1910102135))
		    is[i_31_] = (-1910102135 * this.anInt9465);
		else
		    is[i_31_] = i_32_;
	    }
	}
	...
	if (aClass239_7380.aBoolean2607) {
		...
		if (i_41_ < this.anInt9463 * -583223949)
		    is_37_[i_40_] = this.anInt9463 * -583223949;
		else if (i_41_ > (-1910102135 * this.anInt9465))
		    is_37_[i_40_] = (this.anInt9465 * -1910102135);
		else
		    is_37_[i_40_] = i_41_;
		if (i_42_ < -583223949 * this.anInt9463)
		    is_38_[i_40_] = -583223949 * this.anInt9463;
		else if (i_42_ > (this.anInt9465 * -1910102135))
		    is_38_[i_40_] = (this.anInt9465 * -1910102135);
		else
		    is_38_[i_40_] = i_42_;
		if (i_43_ < this.anInt9463 * -583223949)
		    is_39_[i_40_] = this.anInt9463 * -583223949;
		else if (i_43_ > (-1910102135 * this.anInt9465))
		    is_39_[i_40_] = (this.anInt9465 * -1910102135);
		else
		    is_39_[i_40_] = i_43_;
	    }
	}
