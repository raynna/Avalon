...
public class Class513 implements Interface21 {
    ...
    static final void method6292(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1155 * -749038817;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		Class522.aClass_ra6285.method5136(1951505274);
