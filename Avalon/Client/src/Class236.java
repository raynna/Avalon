...
public class Class236 {
    ...
    static final void method2189(Class403 class403, byte i) {
	try {
	    class403.anInt5239 -= -1175642067;
	    int i_5_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    int i_6_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]);
	...
	try {
	    if (Class301.aClass453_3236 == null || null == Class301_Sub1.aClass446_7634)
		return null;
	    Class301_Sub1.aClass446_7634.method5898(Class301.aClass453_3236, 1595014600);
	    Class298_Sub52 class298_sub52 = ((Class298_Sub52) Class301_Sub1.aClass446_7634.method5900(1453357547));
	    if (class298_sub52 == null)
		return null;
	    Class352 class352 = Class301.aClass339_3251.method4116((-530122905 * (class298_sub52.anInt7608)), -113320818);
	    if (null == class352 || !class352.aBoolean3816 || !class352.method4237(Class301.anInterface23_3223, 391184195))
    ...
    static final void method2191(Class403 class403, byte i) {
	try {
