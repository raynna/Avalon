...
public class Class298_Sub51_Sub4 extends Interface {
	...
	Class365_Sub1_Sub4_Sub1 class365_sub1_sub4_sub1 = this.aClass400_9779.method4927((byte) -26);
	if (class365_sub1_sub4_sub1 != null) {
	    Class98_Sub2.method1064(Class502.aClass502_6731, -1617025021 * interfaceId, -1, (this.aClass400_9779), class365_sub1_sub4_sub1, -391880689);
	    return true;
	}
	return false;
    }
	...
	try {
	    Class365_Sub1_Sub4_Sub1 class365_sub1_sub4_sub1 = this.aClass400_9779.method4927((byte) -81);
	    if (class365_sub1_sub4_sub1 != null) {
		Class98_Sub2.method1064(Class502.aClass502_6731, -1617025021 * interfaceId, -1, (this.aClass400_9779), class365_sub1_sub4_sub1, -391880689);
		return true;
	    }
