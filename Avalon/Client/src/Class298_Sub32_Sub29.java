...
public class Class298_Sub32_Sub29 extends Class298_Sub32 {
	...
	if (i == 0)
	    this.anInt9503 = class298_sub53.readUnsignedShort() * 1358727707;
    }
	...
	try {
		...
		int i_1_ = (this.anInt9504 * -1304311833 * ((-275760121 * this.anInt9506 != Class250.anInt2756 * 461985445) ? (this.anInt9506 * -275760121 * i / (461985445 * Class250.anInt2756)) : i));
		int[] is_2_ = is[0];
		int[] is_3_ = is[1];
		int[] is_4_ = is[2];
		if (Class250.anInt2755 * -1474554145 == this.anInt9504 * -1304311833) {
		    for (int i_5_ = 0; i_5_ < Class250.anInt2755 * -1474554145; i_5_++) {
			int i_6_ = (this.anIntArray9505[i_1_++]);
			...
			int i_8_ = (i_7_ * (this.anInt9504 * -1304311833) / (Class250.anInt2755 * -1474554145));
			int i_9_ = (this.anIntArray9505[i_1_ + i_8_]);
	...
	this.anIntArray9505 = null;
    }

    @Override
    int method3136(byte i) {
	try {
	    return -69124077 * this.anInt9503;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (this.anInt9503 * -69124077 >= 0 && null != Class294.anInterface_ma3166) {
		int i_12_ = ((Class294.anInterface_ma3166.method174(-69124077 * this.anInt9503, 816226410).aBoolean518) ? 64 : 128);
		this.anIntArray9505 = (Class294.anInterface_ma3166.method171(-69124077 * this.anInt9503, 1.0F, i_12_, i_12_, false, 215810850));
		this.anInt9506 = 1374319031 * i_12_;
		this.anInt9504 = -1283564585 * i_12_;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	if (aClass239_7380.aBoolean2607) {
	    int i_13_ = (this.anInt9504 * -1304311833 * ((-275760121 * this.anInt9506 != Class250.anInt2756 * 461985445) ? (this.anInt9506 * -275760121 * i / (461985445 * Class250.anInt2756)) : i));
	    int[] is_14_ = is[0];
	    int[] is_15_ = is[1];
	    int[] is_16_ = is[2];
	    if (Class250.anInt2755 * -1474554145 == this.anInt9504 * -1304311833) {
		for (int i_17_ = 0; i_17_ < Class250.anInt2755 * -1474554145; i_17_++) {
		    int i_18_ = (this.anIntArray9505[i_13_++]);
		...
		for (int i_19_ = 0; i_19_ < -1474554145 * Class250.anInt2755; i_19_++) {
		    int i_20_ = (i_19_ * (this.anInt9504 * -1304311833) / (Class250.anInt2755 * -1474554145));
		    int i_21_ = (this.anIntArray9505[i_13_ + i_20_]);
	...
	if (aClass239_7380.aBoolean2607) {
	    int i_22_ = (this.anInt9504 * -1304311833 * ((-275760121 * this.anInt9506 != Class250.anInt2756 * 461985445) ? (this.anInt9506 * -275760121 * i / (461985445 * Class250.anInt2756)) : i));
	    int[] is_23_ = is[0];
	    int[] is_24_ = is[1];
	    int[] is_25_ = is[2];
	    if (Class250.anInt2755 * -1474554145 == this.anInt9504 * -1304311833) {
		for (int i_26_ = 0; i_26_ < Class250.anInt2755 * -1474554145; i_26_++) {
		    int i_27_ = (this.anIntArray9505[i_22_++]);
		...
		for (int i_28_ = 0; i_28_ < -1474554145 * Class250.anInt2755; i_28_++) {
		    int i_29_ = (i_28_ * (this.anInt9504 * -1304311833) / (Class250.anInt2755 * -1474554145));
		    int i_30_ = (this.anIntArray9505[i_22_ + i_29_]);
	...
	if (this.anInt9503 * -69124077 >= 0 && null != Class294.anInterface_ma3166) {
	    int i_32_ = ((Class294.anInterface_ma3166.method174(-69124077 * this.anInt9503, 1192750196).aBoolean518) ? 64 : 128);
	    this.anIntArray9505 = (Class294.anInterface_ma3166.method171(-69124077 * this.anInt9503, 1.0F, i_32_, i_32_, false, -234790231));
	    this.anInt9506 = 1374319031 * i_32_;
	    this.anInt9504 = -1283564585 * i_32_;
	}
    }
	...
	if (this.anInt9503 * -69124077 >= 0 && null != Class294.anInterface_ma3166) {
	    int i_35_ = ((Class294.anInterface_ma3166.method174(-69124077 * this.anInt9503, 607579585).aBoolean518) ? 64 : 128);
	    this.anIntArray9505 = (Class294.anInterface_ma3166.method171(-69124077 * this.anInt9503, 1.0F, i_35_, i_35_, false, 626013006));
	    this.anInt9506 = 1374319031 * i_35_;
	    this.anInt9504 = -1283564585 * i_35_;
	}
    }
