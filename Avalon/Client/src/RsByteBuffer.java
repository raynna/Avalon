...
public class RsByteBuffer extends Class298 {
	...
	try {
	    long l = readInt((byte) 35) & 0xffffffffL;
	    long l_10_ = readInt((byte) 13) & 0xffffffffL;
	    return (l << 32) + l_10_;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    long l_12_ = readInt((byte) 19) & 0xffffffffL;
	    return (l << 32) + l_12_;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    long l = 0L;
	    for (/**/; i_83_ >= 0; i_83_ -= 8)
		l |= ((buffer[(index += 116413311) * 385051775 - 1]) & 0xffL) << i_83_;
	    return l;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static void showItemOnInterface(int interfaceId, int itemId, int itemAmount) {
	try {
	    Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(9, interfaceId);
	    class298_sub37_sub12.method3449((byte) 105);
	    class298_sub37_sub12.type = 1274450087 * itemId;
	    class298_sub37_sub12.value = 293101103 * itemAmount;
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("acx.aw(").append(')').toString());
	}
	...
	try {
	    ...
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = new StringBuilder().append(string).append((char) i_93_).toString();
	}
	catch (RuntimeException runtimeexception) {
