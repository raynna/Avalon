...
public class Class_xa_Sub1 extends Class_xa {
	...
	if (this.anInt8473 > 0) {
		...
		for (int i_0_ = 1; i_0_ < anInt6286 * -1148794921; i_0_++)
		    is[i][i_0_] = (byte) (((this.aByteArrayArray8475[i - 1][i_0_]) >> 2) + ((this.aByteArrayArray8475[i + 1][i_0_]) >> 3) + ((this.aByteArrayArray8475[i][i_0_ - 1]) >> 2) + ((this.aByteArrayArray8475[i][i_0_ + 1]) >> 3) + ((this.aByteArrayArray8475[i][i_0_]) >> 1));
	    }
	    Class298[] class298s = new Class298[this.aClass440_8479.method5855(1016688966)];
	    this.aClass440_8479.method5854(class298s, 2103539357);
	    ...
	    jaclib.memory.heap.NativeHeapBuffer nativeheapbuffer_1_ = this.aClass_ra_Sub3_8467.aNativeHeap8221.f(this.anInt8473 * i, false);
	    ...
	    int i_3_ = Class422_Sub4.method5639((this.anInt8473 / 4), 1661685249);
	    if (i_3_ < 1)
		i_3_ = 1;
	    Class440 class440 = new Class440(i_3_);
	    Class298_Sub16[] class298_sub16s_4_ = new Class298_Sub16[this.anInt8474];
	    for (int i_5_ = 0; i_5_ < anInt6287 * -506105871; i_5_++) {
		for (int i_6_ = 0; i_6_ < anInt6286 * -1148794921; i_6_++) {
		    if ((this.anIntArrayArrayArray8483[i_5_][i_6_]) != null) {
			Class298_Sub16[] class298_sub16s_7_ = (this.aClass298_Sub16ArrayArrayArray8459[i_5_][i_6_]);
			int[] is_8_ = (this.anIntArrayArrayArray8462[i_5_][i_6_]);
			int[] is_9_ = (this.anIntArrayArrayArray8458[i_5_][i_6_]);
			int[] is_10_ = (this.anIntArrayArrayArray8461[i_5_][i_6_]);
			int[] is_11_ = (this.anIntArrayArrayArray8483[i_5_][i_6_]);
			int[] is_12_ = ((this.anIntArrayArrayArray8460 != null) ? (this.anIntArrayArrayArray8460[i_5_][i_6_]) : null);
			int[] is_13_ = ((this.anIntArrayArrayArray8465 != null) ? (this.anIntArrayArrayArray8465[i_5_][i_6_]) : null);
			if (is_10_ == null)
			    is_10_ = is_11_;
			float f = (this.aFloatArrayArray8476[i_5_][i_6_]);
			float f_14_ = (this.aFloatArrayArray8477[i_5_][i_6_]);
			float f_15_ = (this.aFloatArrayArray8466[i_5_][i_6_]);
			float f_16_ = (this.aFloatArrayArray8476[i_5_][i_6_ + 1]);
			float f_17_ = (this.aFloatArrayArray8477[i_5_][i_6_ + 1]);
			float f_18_ = (this.aFloatArrayArray8466[i_5_][i_6_ + 1]);
			float f_19_ = (this.aFloatArrayArray8476[i_5_ + 1][i_6_ + 1]);
			float f_20_ = (this.aFloatArrayArray8477[i_5_ + 1][i_6_ + 1]);
			float f_21_ = (this.aFloatArrayArray8466[i_5_ + 1][i_6_ + 1]);
			float f_22_ = (this.aFloatArrayArray8476[i_5_ + 1][i_6_]);
			float f_23_ = (this.aFloatArrayArray8477[i_5_ + 1][i_6_]);
			float f_24_ = (this.aFloatArrayArray8466[i_5_ + 1][i_6_]);
			...
			short[] is_32_ = (this.aShortArrayArray8456[i_6_ * (anInt6287 * -506105871) + i_5_] = new short[is_11_.length]);
			for (int i_33_ = 0; i_33_ < is_11_.length; i_33_++) {
			    ...
			    int i_36_ = i_34_ >> this.anInt8450;
			    int i_37_ = i_35_ >> this.anInt8450;
			    int i_38_ = is_11_[i_33_];
			    int i_39_ = is_10_[i_33_];
			    int i_40_ = is_12_ != null ? is_12_[i_33_] : 0;
			    long l = ((long) i_39_ << 48 | (long) i_38_ << 32 | i_36_ << 16 | i_37_);
				...
				if ((this.anInt8482 & 0x7) == 0) {
				    f_45_ = ((this.aClass_ra_Sub3_8467.aFloatArray8283[0]) * f_46_ + (this.aClass_ra_Sub3_8467.aFloatArray8283[1]) * f_47_ + (this.aClass_ra_Sub3_8467.aFloatArray8283[2]) * f_48_);
				    f_45_ = ((this.aClass_ra_Sub3_8467.aFloat8291) + f_45_ * (f_45_ > 0.0F ? (this.aClass_ra_Sub3_8467.aFloat8364) : (this.aClass_ra_Sub3_8467.aFloat8293)));
				}
			    }
			    Class298 class298 = null;
			    if (((i_34_ & this.anInt8451 - 1) == 0) && ((i_35_ & this.anInt8451 - 1) == 0))
				...
				if (i_39_ != i_38_) {
				    ...
				    if ((this.anInt8482 & 0x7) == 0) {
					float f_63_ = ((this.aClass_ra_Sub3_8467.aFloatArray8283[0]) * f_46_ + (this.aClass_ra_Sub3_8467.aFloatArray8283[1]) * f_47_ + ((this.aClass_ra_Sub3_8467.aFloatArray8283[2]) * f_48_));
					f_63_ = ((this.aClass_ra_Sub3_8467.aFloat8291) + (f_45_ * (f_45_ > 0.0F ? (this.aClass_ra_Sub3_8467.aFloat8364) : (this.aClass_ra_Sub3_8467.aFloat8293))));
				...
				if (Stream.r()) {
				    stream.d(i_34_);
				    stream.d(method6340(i_34_, i_35_, -1715806278) + i_40_);
				    stream.d(i_35_);
				    stream.d(i_34_);
				    stream.d(i_35_);
				    if ((this.anIntArrayArrayArray8465) != null)
				    ...
				    stream.u(i_34_);
				    stream.u(method6340(i_34_, i_35_, -2089316863) + i_40_);
				    stream.u(i_35_);
				    stream.u(i_34_);
				    stream.u(i_35_);
				    if ((this.anIntArrayArrayArray8465) != null)
				...
				if (((this.aClass_ra_Sub3_8467).anInt8346) == 0)
				    stream_2_.i(~0xffffff | i_61_);
				else
				    stream_2_.k(~0xffffff | i_61_);
				i_60_ = this.anInt8454++;
				...
				if (i_38_ != -1 && ((class298_sub16s_7_[i_33_].hash * 7051297995265073167L) < (class298_sub16s[i_60_].hash * 7051297995265073167L)))
				    class298_sub16s[i_60_] = class298_sub16s_7_[i_33_];
			    }
	    ...
	    for (int i_68_ = 0; i_68_ < this.anInt8454; i_68_++) {
		...
		for (int i_70_ = 0; i_70_ < anInt6286 * -1148794921; i_70_++) {
		    short[] is_71_ = (this.aShortArrayArray8456[i_70_ * (anInt6287 * -506105871) + i_69_]);
		    if (is_71_ != null) {
			int i_72_ = 0;
			int i_73_ = 0;
			while (i_73_ < is_71_.length) {
				...
				if (class298_sub16_79_ == null || ((class298_sub16_77_.hash * 7051297995265073167L) < (class298_sub16_79_.hash * 7051297995265073167L)))
				    class298_sub16_79_ = class298_sub16_77_;
			    }
			    if (class298_sub16_78_ != null) {
				class298_sub16_78_.method2912(i_69_, i_70_, i_72_);
				if (class298_sub16_79_ == null || ((class298_sub16_78_.hash * 7051297995265073167L) < (class298_sub16_79_.hash * 7051297995265073167L)))
	    ...
	    this.anInterface7_Impl1_8470.method71(this.anInt8454 * i, i, nativeheapbuffer_1_);
	    if ((this.anInt8482 & 0x7) != 0) {
		if (this.anIntArrayArrayArray8465 != null)
	    ...
	    this.aClass298Array8478 = new Class298[i_80_];
	    long[] ls = new long[i_80_];
	    for (int i_82_ = 0; i_82_ < i_80_; i_82_++) {
		Class298_Sub16 class298_sub16 = (Class298_Sub16) class298s[i_82_];
		ls[i_82_] = class298_sub16.hash * 7051297995265073167L;
		this.aClass298Array8478[i_82_] = class298_sub16;
		class298_sub16.method2914(this.anInt8454);
	    }
	    Class365_Sub1_Sub3_Sub1.method4507(ls, (this.aClass298Array8478), (byte) -43);
	...
	if (this.aClass169_8452 == null || class_na == null)
	    return false;
	int i_86_ = (i - (i_83_ * (this.aClass_ra_Sub3_8467).anInt8299 >> 8) >> (this.aClass_ra_Sub3_8467.anInt8313));
	int i_87_ = (i_84_ - (i_83_ * (this.aClass_ra_Sub3_8467.anInt8317) >> 8) >> (this.aClass_ra_Sub3_8467.anInt8313));
	return this.aClass169_8452.method1807(class_na, i_86_, i_87_);
    }
	...
	Interface_ma interface_ma = this.aClass_ra_Sub3_8467.anInterface_ma5299;
	...
	for (int i_96_ = 0; i_96_ < is_92_.length; i_96_++) {
	    ...
	    if ((this.anInt8482 & 0x20) != 0 && i_97_ != -1 && interface_ma.method174(i_97_, 1147162095).aBoolean524) {
		i_98_ = 128;
		i_97_ = -1;
	    }
	    long l = ((long) (class78.anInt727 * -1475891183) << 48 | (long) (class78.anInt725 * 1996750669) << 42 | (long) (class78.anInt726 * -1212608691) << 28 | i_98_ << 14 | i_97_);
	    Class298 class298;
		...
		if (class298_sub16.anInt7284 == i_97_ && (class298_sub16.aFloat7294 == i_98_) && class298_sub16.aClass78_7286.method843(class78, (byte) 61))
		    break;
	    }
	    if (class298 == null) {
	...
	if ((this.aByteArrayArray8469[i][i_99_] & 0x1) == 0)
	    return null;
	int i_100_ = (anInt6288 * -1212653763 >> (this.aClass_ra_Sub3_8467.anInt8313));
	...
	if (class_na_sub2 != null && class_na_sub2.method3489(i_100_, i_100_)) {
	    ...
	    class_na_sub2_101_ = new Class_na_Sub2(this.aClass_ra_Sub3_8467, i_100_, i_100_);
	...
	this.aClass458_8468 = new Class458();
	...
	for (int i_107_ = 0; i_107_ <= anInt6286 * -1148794921; i_107_++) {
		...
		if (i_109_ < this.aFloat8457)
		    this.aFloat8457 = i_109_;
		if (i_109_ > this.aFloat8447)
		    this.aFloat8447 = i_109_;
		if (i_108_ > 0 && i_107_ > 0 && i_108_ < anInt6287 * -506105871 && i_107_ < anInt6286 * -1148794921) {
		    ...
		    float f = (float) (1.0 / Math.sqrt(i_110_ * i_110_ + 4 * i_106_ * i_106_ + i_111_ * i_111_));
		    this.aFloatArrayArray8476[i_108_][i_107_] = i_110_ * f;
		    this.aFloatArrayArray8477[i_108_][i_107_] = -i_106_ * 2 * f;
		    this.aFloatArrayArray8466[i_108_][i_107_] = i_111_ * f;
		}
	    }
	}
	this.aFloat8457--;
	...
	Interface_ma interface_ma = this.aClass_ra_Sub3_8467.anInterface_ma5299;
	if (is_115_ != null && this.anIntArrayArrayArray8465 == null)
	    this.anIntArrayArrayArray8465 = new int[anInt6287 * -506105871][anInt6286 * -1148794921][];
	if (is_113_ != null && this.anIntArrayArrayArray8460 == null)
	    this.anIntArrayArrayArray8460 = new int[anInt6287 * -506105871][anInt6286 * -1148794921][];
	this.anIntArrayArrayArray8462[i][i_112_] = is;
	this.anIntArrayArrayArray8458[i][i_112_] = is_114_;
	this.anIntArrayArrayArray8483[i][i_112_] = is_116_;
	this.anIntArrayArrayArray8461[i][i_112_] = is_117_;
	if (this.anIntArrayArrayArray8465 != null)
	    this.anIntArrayArrayArray8465[i][i_112_] = is_115_;
	if (this.anIntArrayArrayArray8460 != null)
	    this.anIntArrayArrayArray8460[i][i_112_] = is_113_;
	Class298_Sub16[] class298_sub16s = (this.aClass298_Sub16ArrayArrayArray8459[i][i_112_] = new Class298_Sub16[is_116_.length]);
	for (int i_120_ = 0; i_120_ < is_116_.length; i_120_++) {
	    int i_121_ = is_118_[i_120_];
	    int i_122_ = is_119_[i_120_];
	    if ((this.anInt8482 & 0x20) != 0 && i_121_ != -1 && interface_ma.method174(i_121_, 469546768).aBoolean524) {
		i_122_ = 128;
		i_121_ = -1;
	    }
	    long l = ((long) (class78.anInt727 * -1475891183) << 48 | (long) (class78.anInt725 * 1996750669) << 42 | (long) (class78.anInt726 * -1212608691) << 28 | i_122_ << 14 | i_121_);
	    Class298 class298;
	    for (class298 = this.aClass440_8479.method5852(l); class298 != null; class298 = this.aClass440_8479.method5853(-1981494486)) {
		Class298_Sub16 class298_sub16 = (Class298_Sub16) class298;
		if (class298_sub16.anInt7284 == i_121_ && (class298_sub16.aFloat7294 == i_122_) && class298_sub16.aClass78_7286.method843(class78, (byte) -65))
		    break;
	    }
	    if (class298 == null) {
		class298_sub16s[i_120_] = new Class298_Sub16(this, i_121_, i_122_, class78);
		this.aClass440_8479.method5858(class298_sub16s[i_120_], l);
	    } else
		class298_sub16s[i_120_] = (Class298_Sub16) class298;
	}
	if (bool)
	    this.aByteArrayArray8469[i][i_112_] |= 0x1;
	if (is_116_.length > this.anInt8474)
	    this.anInt8474 = is_116_.length;
	this.anInt8473 += is_116_.length;
    }
	...
	if (this.anInt8473 > 0) {
		...
		this.aClass_ra_Sub3_8467.method5043(Class222.aClass222_2504);
		float f = this.aClass_ra_Sub3_8467.method4992((short) 2045).method545();
		float f_137_ = this.aClass_ra_Sub3_8467.method4992((short) -2467).method552();
		...
		class222_138_.method2065(i_124_ / (256.0F * (anInt6288 * -1212653763)), -i_124_ / (256.0F * (anInt6288 * -1212653763)), 1.0F / (this.aFloat8447 - this.aFloat8457));
		class222_138_.method2064(i - i_125_ * i_124_ / 256.0F, i_123_ + i_128_ * i_124_ / 256.0F, (-this.aFloat8457 / (this.aFloat8447 - this.aFloat8457)));
		...
		this.aClass_ra_Sub3_8467.aClass233_8236.method2145((this.aClass_ra_Sub3_8467).aClass222_8235);
		this.aClass_ra_Sub3_8467.method5182(this.aClass_ra_Sub3_8467.aClass233_8236);
		class137.method1506(Class233.aClass233_2595);
	...
	Interface_ma interface_ma = this.aClass_ra_Sub3_8467.anInterface_ma5299;
	if (is_193_ != null && this.anIntArrayArrayArray8465 == null)
	    this.anIntArrayArrayArray8465 = new int[anInt6287 * -506105871][anInt6286 * -1148794921][];
	if (is_191_ != null && this.anIntArrayArrayArray8460 == null)
	    this.anIntArrayArrayArray8460 = new int[anInt6287 * -506105871][anInt6286 * -1148794921][];
	this.anIntArrayArrayArray8462[i][i_190_] = is;
	this.anIntArrayArrayArray8458[i][i_190_] = is_192_;
	this.anIntArrayArrayArray8483[i][i_190_] = is_194_;
	this.anIntArrayArrayArray8461[i][i_190_] = is_195_;
	if (this.anIntArrayArrayArray8465 != null)
	    this.anIntArrayArrayArray8465[i][i_190_] = is_193_;
	if (this.anIntArrayArrayArray8460 != null)
	    this.anIntArrayArrayArray8460[i][i_190_] = is_191_;
	Class298_Sub16[] class298_sub16s = (this.aClass298_Sub16ArrayArrayArray8459[i][i_190_] = new Class298_Sub16[is_194_.length]);
	for (int i_198_ = 0; i_198_ < is_194_.length; i_198_++) {
	    int i_199_ = is_196_[i_198_];
	    int i_200_ = is_197_[i_198_];
	    if ((this.anInt8482 & 0x20) != 0 && i_199_ != -1 && interface_ma.method174(i_199_, 645709692).aBoolean524) {
		i_200_ = 128;
		i_199_ = -1;
	    }
	    long l = ((long) (class78.anInt727 * -1475891183) << 48 | (long) (class78.anInt725 * 1996750669) << 42 | (long) (class78.anInt726 * -1212608691) << 28 | i_200_ << 14 | i_199_);
	    Class298 class298;
	    for (class298 = this.aClass440_8479.method5852(l); class298 != null; class298 = this.aClass440_8479.method5853(-2025134225)) {
		Class298_Sub16 class298_sub16 = (Class298_Sub16) class298;
		if (class298_sub16.anInt7284 == i_199_ && (class298_sub16.aFloat7294 == i_200_) && class298_sub16.aClass78_7286.method843(class78, (byte) -112))
		    break;
	    }
	    if (class298 == null) {
		class298_sub16s[i_198_] = new Class298_Sub16(this, i_199_, i_200_, class78);
		this.aClass440_8479.method5858(class298_sub16s[i_198_], l);
	    } else
		class298_sub16s[i_198_] = (Class298_Sub16) class298;
	}
	if (bool)
	    this.aByteArrayArray8469[i][i_190_] |= 0x1;
	if (is_194_.length > this.anInt8474)
	    this.anInt8474 = is_194_.length;
	this.anInt8473 += is_194_.length;
    }
	...
	if ((this.aByteArrayArray8469[i][i_276_] & 0x1) == 0)
	    return null;
	int i_277_ = (anInt6288 * -1212653763 >> (this.aClass_ra_Sub3_8467.anInt8313));
	Class_na_Sub2 class_na_sub2 = (Class_na_Sub2) class_na;
	...
	if (class_na_sub2 != null && class_na_sub2.method3489(i_277_, i_277_)) {
	    ...
	    class_na_sub2_278_ = new Class_na_Sub2(this.aClass_ra_Sub3_8467, i_277_, i_277_);
	...
	if ((this.aByteArrayArray8469[i][i_282_] & 0x1) == 0)
	    return null;
	int i_283_ = (anInt6288 * -1212653763 >> (this.aClass_ra_Sub3_8467.anInt8313));
	Class_na_Sub2 class_na_sub2 = (Class_na_Sub2) class_na;
	...
	if (class_na_sub2 != null && class_na_sub2.method3489(i_283_, i_283_)) {
	    ...
	    class_na_sub2_284_ = new Class_na_Sub2(this.aClass_ra_Sub3_8467, i_283_, i_283_);
	...
	if (this.anInt8473 > 0) {
	    ...
	    Class298[] class298s = new Class298[this.aClass440_8479.method5855(1332224628)];
	    ...
	    Class298_Sub16[] class298_sub16s = new Class298_Sub16[this.anInt8473];
	    int i_288_ = Class422_Sub4.method5639((this.anInt8473 / 4), 2098856769);
	    if (i_288_ < 1)
		i_288_ = 1;
		...
		for (int i_291_ = 0; i_291_ < anInt6286 * -1148794921; i_291_++) {
			...
			for (int i_318_ = 0; i_318_ < is_296_.length; i_318_++) {
			    ...
			    long l = ((long) i_324_ << 48 | (long) i_323_ << 32 | i_321_ << 16 | i_322_);
				...
				if (Stream.r()) {
				    stream.d(i_319_);
				    stream.d(method6340(i_319_, i_320_, -1533098299) + i_325_);
				    stream.d(i_320_);
				    stream.d(i_319_);
				    stream.d(i_320_);
				    if ((this.anIntArrayArrayArray8465) != null)
				    ...
				    stream.u(i_319_);
				    stream.u(method6340(i_319_, i_320_, -1562205139) + i_325_);
				    stream.u(i_320_);
				    stream.u(i_319_);
				    stream.u(i_320_);
				    if ((this.anIntArrayArrayArray8465) != null)
				...
				if (i_323_ != -1 && ((class298_sub16s_292_[i_318_].hash * 7051297995265073167L) < (class298_sub16s[i_345_].hash * 7051297995265073167L)))
				    class298_sub16s[i_345_] = class298_sub16s_292_[i_318_];
			    }
		...
		for (int i_355_ = 0; i_355_ < anInt6286 * -1148794921; i_355_++) {
			...
			while (i_358_ < is_356_.length) {
				...
				if (class298_sub16_364_ == null || ((class298_sub16_362_.hash * 7051297995265073167L) < (class298_sub16_364_.hash * 7051297995265073167L)))
				    class298_sub16_364_ = class298_sub16_362_;
			    }
			    if (class298_sub16_363_ != null) {
				class298_sub16_363_.method2912(i_354_, i_355_, i_357_);
				if (class298_sub16_364_ == null || ((class298_sub16_363_.hash * 7051297995265073167L) < (class298_sub16_364_.hash * 7051297995265073167L)))
	    ...
	    this.aClass298Array8478 = new Class298[i_365_];
		...
		ls[i_367_] = class298_sub16.hash * 7051297995265073167L;
	...
	if (this.aClass298Array8478 != null) {
		...
		if (this.aClass_ra_Sub3_8467.anInt8233 > 0) {
		    ...
		    class137.aClass217_1522.method2007(((this.aClass_ra_Sub3_8467.anInt8332) >> 16 & 0xff) / 255.0F, ((this.aClass_ra_Sub3_8467.anInt8332) >> 8 & 0xff) / 255.0F, ((this.aClass_ra_Sub3_8467.anInt8332) >> 0 & 0xff) / 255.0F);
		    this.aClass_ra_Sub3_8467.aClass233_8236.method2142(this.aClass_ra_Sub3_8467.aClass233_8230);
		    this.aClass_ra_Sub3_8467.aClass233_8236.method2159();
		    class137.aClass232_1525.method2138(this.aClass_ra_Sub3_8467.aClass233_8236);
		...
		if ((this.anInt8482 & 0x37) == 0) {
			...
			if (class298_sub16.anInt7282 != 0) {
				...
				class137.aClass232_1523.method2135(0.0F, 1.0F, 0.0F, (((this.aClass_ra_Sub3_8467).anInt8328) + ((class298_sub16.aClass78_7286.anInt727) * -1475891183 / 255.0F * ((class298_sub16.aClass78_7286.anInt725) * 1996750669))));
				class137.aClass232_1523.method2139(1.0F / ((class298_sub16.aClass78_7286.anInt725) * 1996750669));
				class137.aClass217_1524.method2007((((class298_sub16.aClass78_7286.anInt726) * -1212608691) >> 16 & 0xff) / 255.0F, (((class298_sub16.aClass78_7286.anInt726) * -1212608691) >> 8 & 0xff) / 255.0F, (((class298_sub16.aClass78_7286.anInt726) * -1212608691) >> 0 & 0xff) / 255.0F);
			    } else {
				class137.aClass232_1523.method2135(0.0F, 0.0F, 0.0F, 0.0F);
				class137.aClass217_1524.method2007(0.0F, 0.0F, 0.0F);
			    }
				...
				Class53 class53 = (this.aClass_ra_Sub3_8467.anInterface_ma5299.method174((class298_sub16.anInt7284), 377396513));
			    ...
			    this.aClass_ra_Sub3_8467.method5455(this.aClass153_8472);
			    class137.aClass233_1519.method2147(1.0F / (class298_sub16.aFloat7294), 1.0F / (class298_sub16.aFloat7294), 1.0F, 1.0F);
		    ...
		    class137.aClass217_1527.method2007((this.aClass_ra_Sub3_8467.aFloatArray8283[0]), (this.aClass_ra_Sub3_8467.aFloatArray8283[1]), (this.aClass_ra_Sub3_8467.aFloatArray8283[2]));
		    class137.aClass217_1528.method2007((this.aClass_ra_Sub3_8467.aFloat8364 * (this.aClass_ra_Sub3_8467.aFloat8362)), (this.aClass_ra_Sub3_8467.aFloat8364 * (this.aClass_ra_Sub3_8467.aFloat8289)), (this.aClass_ra_Sub3_8467.aFloat8364 * (this.aClass_ra_Sub3_8467.aFloat8290)));
		    class137.aClass217_1529.method2007((-(this.aClass_ra_Sub3_8467.aFloat8293) * (this.aClass_ra_Sub3_8467.aFloat8362)), (-(this.aClass_ra_Sub3_8467.aFloat8293) * (this.aClass_ra_Sub3_8467.aFloat8289)), (-(this.aClass_ra_Sub3_8467.aFloat8293) * (this.aClass_ra_Sub3_8467.aFloat8290)));
		    class137.aClass217_1515.method2007((this.aClass_ra_Sub3_8467.aFloat8291 * (this.aClass_ra_Sub3_8467.aFloat8362)), (this.aClass_ra_Sub3_8467.aFloat8291 * (this.aClass_ra_Sub3_8467.aFloat8289)), (this.aClass_ra_Sub3_8467.aFloat8291 * (this.aClass_ra_Sub3_8467.aFloat8290)));
		    int i_386_ = 0;
			...
			if (class298_sub16.anInt7282 > 0) {
				...
				this.aClass_ra_Sub3_8467.method5058(0, (class298_sub16.aClass78_7286));
				float f = 0.15F;
				class137.aClass232_1523.method2135(0.0F, 1.0F / ((class298_sub16.aClass78_7286.anInt725) * 1996750669 * f), 0.0F, 256.0F / ((class298_sub16.aClass78_7286.anInt725) * 1996750669 * f));
				class137.aClass217_1524.method2007((((class298_sub16.aClass78_7286.anInt726) * -1212608691) >> 16 & 0xff) / 255.0F, (((class298_sub16.aClass78_7286.anInt726) * -1212608691) >> 8 & 0xff) / 255.0F, (((class298_sub16.aClass78_7286.anInt726) * -1212608691) >> 0 & 0xff) / 255.0F);
			    } else {
				class137.aClass232_1523.method2135(0.0F, 0.0F, 0.0F, 0.0F);
				class137.aClass217_1524.method2007(0.0F, 0.0F, 0.0F);
			    ...
			    byte i_388_ = 11;
			    if (class298_sub16.anInt7284 != -1) {
				Class53 class53 = (this.aClass_ra_Sub3_8467.anInterface_ma5299.method174((class298_sub16.anInt7284), 515352996));
			    ...
			    switch (i_388_) {
				case 7:
				    class137.aClass217_1530.method2007(((this.aClass_ra_Sub3_8467).aClass233_8231.aFloatArray2594[12]), ((this.aClass_ra_Sub3_8467).aClass233_8231.aFloatArray2594[13]), ((this.aClass_ra_Sub3_8467).aClass233_8231.aFloatArray2594[14]));
				...
				case 9:
					...
					class161_sub1_sub2.aClass233_9140.method2142(this.aClass_ra_Sub3_8467.aClass233_8251);
					class161_sub1_sub2.aClass233_9142.method2147(1.0F / (class298_sub16.aFloat7294 * ((class298_sub16.aClass78_7286.anInt729) * -28774789)), 1.0F / (class298_sub16.aFloat7294 * ((class298_sub16.aClass78_7286.anInt729) * -28774789)), 1.0F, 1.0F);
					class161_sub1_sub2.aClass217_9144.method2007(((this.aClass_ra_Sub3_8467).aClass233_8231.aFloatArray2594[12]), ((this.aClass_ra_Sub3_8467).aClass233_8231.aFloatArray2594[13]), ((this.aClass_ra_Sub3_8467).aClass233_8231.aFloatArray2594[14]));
					Class53 class53 = (this.aClass_ra_Sub3_8467.anInterface_ma5299.method174((class298_sub16.anInt7284), 191676686));
		...
		this.aClass_ra_Sub3_8467.method5383(1, this.anInterface7_Impl1_8449);
		this.aClass_ra_Sub3_8467.method5455(this.aClass153_8472);
		Class233 class233 = (this.aClass_ra_Sub3_8467.aClass233_8236);
		class233.method2172();
	...
	if (this.aClass298Array8478 != null) {
	    ...
	    ByteBuffer bytebuffer = this.aClass_ra_Sub3_8467.aByteBuffer8216;
	    bytebuffer.clear();
	    for (int i_402_ = 0; i_402_ < this.aClass298Array8478.length; i_402_++) {
		Class298_Sub16 class298_sub16 = ((Class298_Sub16) this.aClass298Array8478[i_402_]);
		class298_sub16.method2915(anIntArray8471, anInt8453);
	    }
	    int i_403_ = bytebuffer.position();
	    Class137 class137 = (this.aClass_ra_Sub3_8467.aClass137_8316);
	    if (i_403_ != 0) {
		Interface7_Impl2 interface7_impl2 = this.aClass_ra_Sub3_8467.method5312(i_403_ / 2);
		interface7_impl2.method63(0, i_403_, (this.aClass_ra_Sub3_8467.aLong8217));
		this.aClass_ra_Sub3_8467.method5393();
		this.aClass_ra_Sub3_8467.method5383(0, this.anInterface7_Impl1_8470);
		this.aClass_ra_Sub3_8467.method5384(interface7_impl2);
		class137.method1506(Class233.aClass233_2595);
		...
		if ((this.anInt8482 & 0x37) == 0) {
		    int i_404_ = 0;
		    for (int i_405_ = 0; (i_405_ < this.aClass298Array8478.length); i_405_++) {
			Class298_Sub16 class298_sub16 = (Class298_Sub16) (this.aClass298Array8478[i_405_]);
			if (class298_sub16.anInt7282 != 0) {
			    if (this.aClass_ra_Sub3_8467.aBoolean8326) {
				this.aClass_ra_Sub3_8467.method5058(0, (class298_sub16.aClass78_7286));
				class137.aClass232_1523.method2135(0.0F, 1.0F, 0.0F, (((this.aClass_ra_Sub3_8467).anInt8328) + ((class298_sub16.aClass78_7286.anInt727) * -1475891183 / 255.0F * ((class298_sub16.aClass78_7286.anInt725) * 1996750669))));
			    ...
			    if (class298_sub16.anInt7284 != -1) {
				class137.anInterface9_Impl2_1517 = ((this.aClass_ra_Sub3_8467).aClass157_8351.method1698(class298_sub16.anInt7284));
				Class53 class53 = (this.aClass_ra_Sub3_8467.anInterface_ma5299.method174((class298_sub16.anInt7284), 593985487));
			    ...
			    i_404_ += class298_sub16.anInt7282;
			}
		    }
		} else {
		    class137.aClass217_1527.method2007((this.aClass_ra_Sub3_8467.aFloatArray8283[0]), (this.aClass_ra_Sub3_8467.aFloatArray8283[1]), (this.aClass_ra_Sub3_8467.aFloatArray8283[2]));
		    ...
		    class137.aClass217_1515.method2007((this.aClass_ra_Sub3_8467.aFloat8291 * (this.aClass_ra_Sub3_8467.aFloat8362)), (this.aClass_ra_Sub3_8467.aFloat8291 * (this.aClass_ra_Sub3_8467.aFloat8289)), (this.aClass_ra_Sub3_8467.aFloat8291 * (this.aClass_ra_Sub3_8467.aFloat8290)));
		    int i_407_ = 0;
		    for (int i_408_ = 0; (i_408_ < this.aClass298Array8478.length); i_408_++) {
			Class298_Sub16 class298_sub16 = (Class298_Sub16) (this.aClass298Array8478[i_408_]);
			if (class298_sub16.anInt7282 > 0) {
			    if (this.aClass_ra_Sub3_8467.aBoolean8326) {
				this.aClass_ra_Sub3_8467.method5058(0, (class298_sub16.aClass78_7286));
				float f = 0.15F;
			    ...
			    byte i_409_ = 11;
			    if (class298_sub16.anInt7284 != -1) {
				Class53 class53 = (this.aClass_ra_Sub3_8467.anInterface_ma5299.method174((class298_sub16.anInt7284), 1262090784));
				...
				case 9:
					...
					class161_sub1_sub2.aClass233_9142.method2147(1.0F / (class298_sub16.aFloat7294 * ((class298_sub16.aClass78_7286.anInt729) * -28774789)), 1.0F / (class298_sub16.aFloat7294 * ((class298_sub16.aClass78_7286.anInt729) * -28774789)), 1.0F, 1.0F);
					class161_sub1_sub2.aClass217_9144.method2007(((this.aClass_ra_Sub3_8467).aClass233_8231.aFloatArray2594[12]), ((this.aClass_ra_Sub3_8467).aClass233_8231.aFloatArray2594[13]), ((this.aClass_ra_Sub3_8467).aClass233_8231.aFloatArray2594[14]));
					Class53 class53 = (this.aClass_ra_Sub3_8467.anInterface_ma5299.method174((class298_sub16.anInt7284), 1144477529));
					class161_sub1_sub2.anInt9145 = class53.aByte536 * -1021876967;
					class161_sub1_sub2.anInt9160 = (class298_sub16.anInt7291) * 1525453135;
					class161_sub1_sub2.anInt9158 = ((class298_sub16.anInt7292) - (class298_sub16.anInt7291) + 1) * 942867733;
			    ...
			    i_407_ += class298_sub16.anInt7282;
			}
		    }
		}
	    }
		...
		class233.aFloatArray2594[13] = -1.0F;
		class137.method1506(class233);
		this.aClass169_8452.method1800(class137, i, i_389_, i_390_, bools, bool);
	    }
	}
    }
	...
	if (this.anInt8473 > 0) {
		...
		for (int i_421_ = i_412_; i_421_ < i_414_; i_421_++) {
			...
			short[] is = (this.aShortArrayArray8456[i_420_]);
			if (is != null) {
		...
		this.aClass_ra_Sub3_8467.method5384(interface7_impl2);
		this.aClass_ra_Sub3_8467.method5043(Class222.aClass222_2504);
		float f = this.aClass_ra_Sub3_8467.method4992((short) 2365).method545();
		float f_424_ = this.aClass_ra_Sub3_8467.method4992((short) -15012).method552();
		Class222 class222 = new Class222();
		Class222 class222_425_ = new Class222();
		class222.method2057(1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 0.0F);
		class222_425_.method2065(i_411_ / (256.0F * (anInt6288 * -1212653763)), -i_411_ / (256.0F * (anInt6288 * -1212653763)), 1.0F / (this.aFloat8447 - this.aFloat8457));
		class222_425_.method2064(i - i_412_ * i_411_ / 256.0F, i_410_ + i_415_ * i_411_ / 256.0F, (-this.aFloat8457 / (this.aFloat8447 - this.aFloat8457)));
		class222_425_.method2061(2.0F / f, 2.0F / f_424_, 1.0F);
		class222_425_.method2064(-1.0F, -1.0F, 0.0F);
		this.aClass_ra_Sub3_8467.aClass222_8235.method2068(class222, class222_425_);
		this.aClass_ra_Sub3_8467.aClass233_8236.method2145((this.aClass_ra_Sub3_8467).aClass222_8235);
		this.aClass_ra_Sub3_8467.method5182(this.aClass_ra_Sub3_8467.aClass233_8236);
		class137.method1506(Class233.aClass233_2595);
		class137.aClass232_1525.method2135(0.0F, 0.0F, 0.0F, 0.0F);
	...
	if (this.anInt8473 > 0) {
		...
		for (int i_437_ = i_428_; i_437_ < i_430_; i_437_++) {
			...
			short[] is = (this.aShortArrayArray8456[i_436_]);
			if (is != null) {
		...
		this.aClass_ra_Sub3_8467.method5384(interface7_impl2);
		this.aClass_ra_Sub3_8467.method5043(Class222.aClass222_2504);
		float f = this.aClass_ra_Sub3_8467.method4992((short) -18098).method545();
		float f_440_ = this.aClass_ra_Sub3_8467.method4992((short) 2214).method552();
		Class222 class222 = new Class222();
		Class222 class222_441_ = new Class222();
		class222.method2057(1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 0.0F);
		class222_441_.method2065(i_427_ / (256.0F * (anInt6288 * -1212653763)), -i_427_ / (256.0F * (anInt6288 * -1212653763)), 1.0F / (this.aFloat8447 - this.aFloat8457));
		class222_441_.method2064(i - i_428_ * i_427_ / 256.0F, i_426_ + i_431_ * i_427_ / 256.0F, (-this.aFloat8457 / (this.aFloat8447 - this.aFloat8457)));
		class222_441_.method2061(2.0F / f, 2.0F / f_440_, 1.0F);
		class222_441_.method2064(-1.0F, -1.0F, 0.0F);
		this.aClass_ra_Sub3_8467.aClass222_8235.method2068(class222, class222_441_);
		this.aClass_ra_Sub3_8467.aClass233_8236.method2145((this.aClass_ra_Sub3_8467).aClass222_8235);
		this.aClass_ra_Sub3_8467.method5182(this.aClass_ra_Sub3_8467.aClass233_8236);
		class137.method1506(Class233.aClass233_2595);
		class137.aClass232_1525.method2135(0.0F, 0.0F, 0.0F, 0.0F);
	...
	if (this.anInt8473 > 0) {
		...
		for (int i_453_ = i_444_; i_453_ < i_446_; i_453_++) {
			...
			short[] is = (this.aShortArrayArray8456[i_452_]);
			if (is != null) {
		...
		this.aClass_ra_Sub3_8467.method5384(interface7_impl2);
		this.aClass_ra_Sub3_8467.method5043(Class222.aClass222_2504);
		float f = this.aClass_ra_Sub3_8467.method4992((short) -10639).method545();
		float f_456_ = this.aClass_ra_Sub3_8467.method4992((short) -13227).method552();
		Class222 class222 = new Class222();
		Class222 class222_457_ = new Class222();
		class222.method2057(1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 0.0F);
		class222_457_.method2065(i_443_ / (256.0F * (anInt6288 * -1212653763)), -i_443_ / (256.0F * (anInt6288 * -1212653763)), 1.0F / (this.aFloat8447 - this.aFloat8457));
		class222_457_.method2064(i - i_444_ * i_443_ / 256.0F, i_442_ + i_447_ * i_443_ / 256.0F, (-this.aFloat8457 / (this.aFloat8447 - this.aFloat8457)));
		class222_457_.method2061(2.0F / f, 2.0F / f_456_, 1.0F);
		class222_457_.method2064(-1.0F, -1.0F, 0.0F);
		this.aClass_ra_Sub3_8467.aClass222_8235.method2068(class222, class222_457_);
		this.aClass_ra_Sub3_8467.aClass233_8236.method2145((this.aClass_ra_Sub3_8467).aClass222_8235);
		this.aClass_ra_Sub3_8467.method5182(this.aClass_ra_Sub3_8467.aClass233_8236);
		class137.method1506(Class233.aClass233_2595);
		class137.aClass232_1525.method2135(0.0F, 0.0F, 0.0F, 0.0F);
	...
	if (this.aClass298Array8478 != null) {
	    ...
	    ByteBuffer bytebuffer = this.aClass_ra_Sub3_8467.aByteBuffer8216;
	    bytebuffer.clear();
	    for (int i_471_ = 0; i_471_ < this.aClass298Array8478.length; i_471_++) {
		Class298_Sub16 class298_sub16 = ((Class298_Sub16) this.aClass298Array8478[i_471_]);
		class298_sub16.method2915(anIntArray8471, anInt8453);
	    }
	    int i_472_ = bytebuffer.position();
	    Class137 class137 = (this.aClass_ra_Sub3_8467.aClass137_8316);
	    if (i_472_ != 0) {
		Interface7_Impl2 interface7_impl2 = this.aClass_ra_Sub3_8467.method5312(i_472_ / 2);
		interface7_impl2.method63(0, i_472_, (this.aClass_ra_Sub3_8467.aLong8217));
		this.aClass_ra_Sub3_8467.method5393();
		this.aClass_ra_Sub3_8467.method5383(0, this.anInterface7_Impl1_8470);
		this.aClass_ra_Sub3_8467.method5384(interface7_impl2);
		class137.method1506(Class233.aClass233_2595);
		...
		if ((this.anInt8482 & 0x37) == 0) {
		    int i_473_ = 0;
		    for (int i_474_ = 0; (i_474_ < this.aClass298Array8478.length); i_474_++) {
			Class298_Sub16 class298_sub16 = (Class298_Sub16) (this.aClass298Array8478[i_474_]);
			if (class298_sub16.anInt7282 != 0) {
			    if (this.aClass_ra_Sub3_8467.aBoolean8326) {
				this.aClass_ra_Sub3_8467.method5058(0, (class298_sub16.aClass78_7286));
				class137.aClass232_1523.method2135(0.0F, 1.0F, 0.0F, (((this.aClass_ra_Sub3_8467).anInt8328) + ((class298_sub16.aClass78_7286.anInt727) * -1475891183 / 255.0F * ((class298_sub16.aClass78_7286.anInt725) * 1996750669))));
			    ...
			    if (class298_sub16.anInt7284 != -1) {
				class137.anInterface9_Impl2_1517 = ((this.aClass_ra_Sub3_8467).aClass157_8351.method1698(class298_sub16.anInt7284));
				Class53 class53 = (this.aClass_ra_Sub3_8467.anInterface_ma5299.method174((class298_sub16.anInt7284), 444879772));
			    ...
			    i_473_ += class298_sub16.anInt7282;
			}
		    }
		} else {
		    class137.aClass217_1527.method2007((this.aClass_ra_Sub3_8467.aFloatArray8283[0]), (this.aClass_ra_Sub3_8467.aFloatArray8283[1]), (this.aClass_ra_Sub3_8467.aFloatArray8283[2]));
		    ...
		    class137.aClass217_1515.method2007((this.aClass_ra_Sub3_8467.aFloat8291 * (this.aClass_ra_Sub3_8467.aFloat8362)), (this.aClass_ra_Sub3_8467.aFloat8291 * (this.aClass_ra_Sub3_8467.aFloat8289)), (this.aClass_ra_Sub3_8467.aFloat8291 * (this.aClass_ra_Sub3_8467.aFloat8290)));
		    int i_476_ = 0;
		    for (int i_477_ = 0; (i_477_ < this.aClass298Array8478.length); i_477_++) {
			Class298_Sub16 class298_sub16 = (Class298_Sub16) (this.aClass298Array8478[i_477_]);
			if (class298_sub16.anInt7282 > 0) {
			    if (this.aClass_ra_Sub3_8467.aBoolean8326) {
				this.aClass_ra_Sub3_8467.method5058(0, (class298_sub16.aClass78_7286));
				float f = 0.15F;
			    ...
			    byte i_478_ = 11;
			    if (class298_sub16.anInt7284 != -1) {
				Class53 class53 = (this.aClass_ra_Sub3_8467.anInterface_ma5299.method174((class298_sub16.anInt7284), 2135192368));
				...
				case 9:
					...
					class161_sub1_sub2.aClass233_9142.method2147(1.0F / (class298_sub16.aFloat7294 * ((class298_sub16.aClass78_7286.anInt729) * -28774789)), 1.0F / (class298_sub16.aFloat7294 * ((class298_sub16.aClass78_7286.anInt729) * -28774789)), 1.0F, 1.0F);
					class161_sub1_sub2.aClass217_9144.method2007(((this.aClass_ra_Sub3_8467).aClass233_8231.aFloatArray2594[12]), ((this.aClass_ra_Sub3_8467).aClass233_8231.aFloatArray2594[13]), ((this.aClass_ra_Sub3_8467).aClass233_8231.aFloatArray2594[14]));
					Class53 class53 = (this.aClass_ra_Sub3_8467.anInterface_ma5299.method174((class298_sub16.anInt7284), 1719353613));
					class161_sub1_sub2.anInt9145 = class53.aByte536 * -1021876967;
					class161_sub1_sub2.anInt9160 = (class298_sub16.anInt7291) * 1525453135;
					class161_sub1_sub2.anInt9158 = ((class298_sub16.anInt7292) - (class298_sub16.anInt7291) + 1) * 942867733;
			    ...
			    i_476_ += class298_sub16.anInt7282;
			}
		    }
		}
	    }
		...
		class233.aFloatArray2594[13] = -1.0F;
		class137.method1506(class233);
		this.aClass169_8452.method1800(class137, i, i_458_, i_459_, bools, bool);
	    }
	}
    }
	...
	if (this.anInt8473 > 0) {
		...
		for (int i_490_ = i_481_; i_490_ < i_483_; i_490_++) {
			...
			short[] is = (this.aShortArrayArray8456[i_489_]);
			if (is != null) {
		...
		this.aClass_ra_Sub3_8467.method5384(interface7_impl2);
		this.aClass_ra_Sub3_8467.method5043(Class222.aClass222_2504);
		float f = this.aClass_ra_Sub3_8467.method4992((short) 12709).method545();
		float f_493_ = this.aClass_ra_Sub3_8467.method4992((short) -19432).method552();
		Class222 class222 = new Class222();
		Class222 class222_494_ = new Class222();
		class222.method2057(1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 0.0F);
		class222_494_.method2065(i_480_ / (256.0F * (anInt6288 * -1212653763)), -i_480_ / (256.0F * (anInt6288 * -1212653763)), 1.0F / (this.aFloat8447 - this.aFloat8457));
		class222_494_.method2064(i - i_481_ * i_480_ / 256.0F, i_479_ + i_484_ * i_480_ / 256.0F, (-this.aFloat8457 / (this.aFloat8447 - this.aFloat8457)));
		class222_494_.method2061(2.0F / f, 2.0F / f_493_, 1.0F);
		class222_494_.method2064(-1.0F, -1.0F, 0.0F);
		this.aClass_ra_Sub3_8467.aClass222_8235.method2068(class222, class222_494_);
		this.aClass_ra_Sub3_8467.aClass233_8236.method2145((this.aClass_ra_Sub3_8467).aClass222_8235);
		this.aClass_ra_Sub3_8467.method5182(this.aClass_ra_Sub3_8467.aClass233_8236);
		class137.method1506(Class233.aClass233_2595);
		class137.aClass232_1525.method2135(0.0F, 0.0F, 0.0F, 0.0F);
	...
	if (this.anInt8473 > 0) {
		...
		for (int i_506_ = i_497_; i_506_ < i_499_; i_506_++) {
			...
			short[] is = (this.aShortArrayArray8456[i_505_]);
			if (is != null) {
		...
		this.aClass_ra_Sub3_8467.method5384(interface7_impl2);
		this.aClass_ra_Sub3_8467.method5043(Class222.aClass222_2504);
		float f = this.aClass_ra_Sub3_8467.method4992((short) -2056).method545();
		float f_509_ = this.aClass_ra_Sub3_8467.method4992((short) 898).method552();
		Class222 class222 = new Class222();
		Class222 class222_510_ = new Class222();
		class222.method2057(1.0F, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F, 1.0F, 0.0F);
		class222_510_.method2065(i_496_ / (256.0F * (anInt6288 * -1212653763)), -i_496_ / (256.0F * (anInt6288 * -1212653763)), 1.0F / (this.aFloat8447 - this.aFloat8457));
		class222_510_.method2064(i - i_497_ * i_496_ / 256.0F, i_495_ + i_500_ * i_496_ / 256.0F, (-this.aFloat8457 / (this.aFloat8447 - this.aFloat8457)));
		class222_510_.method2061(2.0F / f, 2.0F / f_509_, 1.0F);
		class222_510_.method2064(-1.0F, -1.0F, 0.0F);
		this.aClass_ra_Sub3_8467.aClass222_8235.method2068(class222, class222_510_);
		this.aClass_ra_Sub3_8467.aClass233_8236.method2145((this.aClass_ra_Sub3_8467).aClass222_8235);
		this.aClass_ra_Sub3_8467.method5182(this.aClass_ra_Sub3_8467.aClass233_8236);
		class137.method1506(Class233.aClass233_2595);
		class137.aClass232_1525.method2135(0.0F, 0.0F, 0.0F, 0.0F);
	...
	this.aClass458_8468.method5968(new Class298_Sub18(this.aClass_ra_Sub3_8467, this, class298_sub10, is), 847764960);
    }
	...
	Interface_ma interface_ma = this.aClass_ra_Sub3_8467.anInterface_ma5299;
	if (is_514_ != null && this.anIntArrayArrayArray8465 == null)
	    this.anIntArrayArrayArray8465 = new int[anInt6287 * -506105871][anInt6286 * -1148794921][];
	if (is_512_ != null && this.anIntArrayArrayArray8460 == null)
	    this.anIntArrayArrayArray8460 = new int[anInt6287 * -506105871][anInt6286 * -1148794921][];
	this.anIntArrayArrayArray8462[i][i_511_] = is;
	this.anIntArrayArrayArray8458[i][i_511_] = is_513_;
	this.anIntArrayArrayArray8483[i][i_511_] = is_515_;
	this.anIntArrayArrayArray8461[i][i_511_] = is_516_;
	if (this.anIntArrayArrayArray8465 != null)
	    this.anIntArrayArrayArray8465[i][i_511_] = is_514_;
	if (this.anIntArrayArrayArray8460 != null)
	    this.anIntArrayArrayArray8460[i][i_511_] = is_512_;
	Class298_Sub16[] class298_sub16s = (this.aClass298_Sub16ArrayArrayArray8459[i][i_511_] = new Class298_Sub16[is_515_.length]);
	for (int i_519_ = 0; i_519_ < is_515_.length; i_519_++) {
	    int i_520_ = is_517_[i_519_];
	    int i_521_ = is_518_[i_519_];
	    if ((this.anInt8482 & 0x20) != 0 && i_520_ != -1 && interface_ma.method174(i_520_, 831412301).aBoolean524) {
		i_521_ = 128;
		i_520_ = -1;
	    }
	    long l = ((long) (class78.anInt727 * -1475891183) << 48 | (long) (class78.anInt725 * 1996750669) << 42 | (long) (class78.anInt726 * -1212608691) << 28 | i_521_ << 14 | i_520_);
	    Class298 class298;
	    for (class298 = this.aClass440_8479.method5852(l); class298 != null; class298 = this.aClass440_8479.method5853(-1980491334)) {
		Class298_Sub16 class298_sub16 = (Class298_Sub16) class298;
		if (class298_sub16.anInt7284 == i_520_ && (class298_sub16.aFloat7294 == i_521_) && class298_sub16.aClass78_7286.method843(class78, (byte) -64))
		    break;
	    }
	    if (class298 == null) {
		class298_sub16s[i_519_] = new Class298_Sub16(this, i_520_, i_521_, class78);
		this.aClass440_8479.method5858(class298_sub16s[i_519_], l);
	    } else
		class298_sub16s[i_519_] = (Class298_Sub16) class298;
	}
	if (bool)
	    this.aByteArrayArray8469[i][i_511_] |= 0x1;
	if (is_515_.length > this.anInt8474)
	    this.anInt8474 = is_515_.length;
	this.anInt8473 += is_515_.length;
    }

    @Override
    public void ak(Class_na class_na, int i, int i_522_, int i_523_, int i_524_, boolean bool) {
	if (this.aClass169_8452 != null && class_na != null) {
	    int i_525_ = (i - (i_522_ * (this.aClass_ra_Sub3_8467.anInt8299) >> 8) >> this.aClass_ra_Sub3_8467.anInt8313);
	    int i_526_ = (i_523_ - (i_522_ * ((this.aClass_ra_Sub3_8467).anInt8317) >> 8) >> this.aClass_ra_Sub3_8467.anInt8313);
	    this.aClass169_8452.method1805(class_na, i_525_, i_526_);
	}
    }
	...
	if (this.aClass169_8452 == null || class_na == null)
	    return false;
	int i_530_ = (i - (i_527_ * (this.aClass_ra_Sub3_8467).anInt8299 >> 8) >> (this.aClass_ra_Sub3_8467.anInt8313));
	int i_531_ = (i_528_ - (i_527_ * (this.aClass_ra_Sub3_8467.anInt8317) >> 8) >> (this.aClass_ra_Sub3_8467.anInt8313));
	return this.aClass169_8452.method1807(class_na, i_530_, i_531_);
    }
	...
	if (this.aClass169_8452 != null && class_na != null) {
	    int i_537_ = (i - (i_534_ * (this.aClass_ra_Sub3_8467.anInt8299) >> 8) >> this.aClass_ra_Sub3_8467.anInt8313);
	    int i_538_ = (i_535_ - (i_534_ * ((this.aClass_ra_Sub3_8467).anInt8317) >> 8) >> this.aClass_ra_Sub3_8467.anInt8313);
	    this.aClass169_8452.method1801(class_na, i_537_, i_538_);
	}
    }
	...
	if (this.aClass169_8452 != null && class_na != null) {
	    int i_542_ = (i - (i_539_ * (this.aClass_ra_Sub3_8467.anInt8299) >> 8) >> this.aClass_ra_Sub3_8467.anInt8313);
	    int i_543_ = (i_540_ - (i_539_ * ((this.aClass_ra_Sub3_8467).anInt8317) >> 8) >> this.aClass_ra_Sub3_8467.anInt8313);
	    this.aClass169_8452.method1801(class_na, i_542_, i_543_);
	}
    }

    @Override
    public void at(int i, int i_544_, int i_545_) {
	if ((this.aByteArrayArray8475[i][i_544_] & 0xff) < i_545_)
	    this.aByteArrayArray8475[i][i_544_] = (byte) i_545_;
    }

    @Override
    public void method6344(Class298_Sub10 class298_sub10, int[] is) {
	this.aClass458_8468.method5968(new Class298_Sub18(this.aClass_ra_Sub3_8467, this, class298_sub10, is), 1474142040);
    }

    @Override
    public void method6358(Class298_Sub10 class298_sub10, int[] is) {
	this.aClass458_8468.method5968(new Class298_Sub18(this.aClass_ra_Sub3_8467, this, class298_sub10, is), 2119427070);
    }
}
