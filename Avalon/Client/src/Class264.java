...
public abstract class Class264 {
	...
	try {
		...
		method2484(string, i - this.aClass505_2833.method6264(string, -1778440333), i_0_, null, null, null, 0, 0, 1766719318);
	    }
	}
	...
	try {
	    ...
	    if (0 == i_22_)
		i_22_ = this.aClass505_2833.anInt6200 * -2028004825;
	    int[] is_27_;
	    if (i_17_ < i_22_ + ((1110385787 * this.aClass505_2833.anInt6202) + -1883958527 * (this.aClass505_2833.anInt6197)) && i_17_ < i_22_ + i_22_)
		is_27_ = null;
	    else
	    ...
	    int i_29_;
	    if (0 == i_21_)
		i_29_ = i_15_ + (1110385787 * this.aClass505_2833.anInt6202);
	    else if (1 == i_21_)
		i_29_ = ((i_17_ - (this.aClass505_2833.anInt6202 * 1110385787) - (-1883958527 * this.aClass505_2833.anInt6197) - i_22_ * (i_28_ - 1)) / 2 + ((this.aClass505_2833.anInt6202 * 1110385787) + i_15_));
	    else if (i_21_ == 2)
		i_29_ = (i_17_ + i_15_ - (this.aClass505_2833.anInt6197 * -1883958527) - i_22_ * (i_28_ - 1));
	    else {
		int i_30_ = ((i_17_ - (this.aClass505_2833.anInt6202 * 1110385787) - (-1883958527 * this.aClass505_2833.anInt6197) - (i_28_ - 1) * i_22_) / (i_28_ + 1));
		if (i_30_ < 0)
		    i_30_ = 0;
		i_29_ = i_30_ + (i_15_ + 1110385787 * (this.aClass505_2833.anInt6202));
		i_22_ += i_30_;
	    }
	...
	try {
		...
		for (int i_38_ = 0; i_38_ < i_37_; i_38_++)
		    is[i_38_] = (int) (Math.sin(i_35_ / 5.0 + i_38_ / 2.0) * 5.0);
		method2487(string, i - this.aClass505_2833.method6264(string, 840724490) / 2, i_32_, null, null, null, is, 873938952);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		for (int i_46_ = 0; i_46_ < i_44_; i_46_++) {
		    is[i_46_] = (int) (Math.sin(i_46_ / 5.0 + i_42_ / 5.0) * 5.0);
		    is_45_[i_46_] = (int) (Math.sin(i_46_ / 3.0 + i_42_ / 5.0) * 5.0);
		}
		method2487(string, i - this.aClass505_2833.method6264(string, -748991968) / 2, i_39_, null, null, is, is_45_, 1570757467);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		double d = 7.0 - i_51_ / 8.0;
		if (d < 0.0)
		    d = 0.0;
		int i_53_ = string.length();
		int[] is = new int[i_53_];
		for (int i_54_ = 0; i_54_ < i_53_; i_54_++)
		    is[i_54_] = (int) (Math.sin(i_50_ / 1.0 + i_54_ / 1.5) * d);
		method2487(string, i - this.aClass505_2833.method6264(string, -795569792) / 2, i_47_, null, null, null, is, 1802136078);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (i_68_ > 0)
		anInt2836 = (i - this.aClass505_2833.method6264(string, 1926010004) << 8) / i_68_ * -1196619179;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (60 == c)
		    ...
		    if (i_74_ == -1) {
			if (i_75_ != -1)
			    i += this.aClass505_2833.method6253(i_75_, c, -1391207992);
			if (32 != c) {
			    if (class_ta == null) {
			...
			int i_81_ = this.aClass505_2833.method6255(c, 2062861193);
			if (anInt2830 * -1546042335 != -1)
			    this.aClass_ra2827.method4990(i, i_70_ + (int) ((this.aClass505_2833.anInt6200) * -2028004825 * 0.7), i_81_, -1546042335 * anInt2830, -1768183212);
			if (-1731221141 * anInt2837 != -1)
			    this.aClass_ra2827.method4990(i, (-2028004825 * (this.aClass505_2833.anInt6200) + i_70_ + 1), i_81_, -1731221141 * anInt2837, -1909269175);
			i += i_81_;
			i_75_ = c;
		    }
		}
	...
	try {
	    ...
	    int i_97_ = i;
	    int i_98_ = (this.aClass505_2833.anInt6202 * 1110385787 + i_82_);
	    int i_99_ = -1;
	    if (1 == i_88_)
		i_98_ += (i_84_ - (1110385787 * this.aClass505_2833.anInt6202) - -1883958527 * (this.aClass505_2833.anInt6197)) / 2;
	    else if (2 == i_88_)
		i_98_ = i_84_ + i_82_ - (this.aClass505_2833.anInt6197) * -1883958527;
	    if (1 == i_87_) {
		i_99_ = (this.aClass505_2833.method6264(string, 428489518) + i_95_);
		i_97_ += (i_83_ - i_99_) / 2;
	    } else if (i_87_ == 2) {
		...
		is[0] = i_97_;
		is[1] = i_98_ - (1110385787 * this.aClass505_2833.anInt6202);
		is[2] = i_99_;
		is[3] = (-1883958527 * this.aClass505_2833.anInt6197 + (1110385787 * this.aClass505_2833.anInt6202));
	    }
	    return i_95_;
	}
	catch (RuntimeException runtimeexception) {
	...
	this.aClass_ra2827 = class_ra;
	this.aClass505_2833 = class505;
    }
	...
	try {
		...
		if (c == 60)
		    ...
		    if (i_112_ == -1) {
			if (-1 != i_113_)
			    i += this.aClass505_2833.method6253(i_113_, c, -1391207992);
			int i_122_;
			if (null != is_109_)
			...
			int i_124_ = this.aClass505_2833.method6255(c, 901349390);
			if (-1 != -1546042335 * anInt2830)
			    this.aClass_ra2827.method4990(i, (int) (0.7 * ((this.aClass505_2833.anInt6200) * -2028004825)) + i_108_, i_124_, -1546042335 * anInt2830, -1291304845);
			if (anInt2837 * -1731221141 != -1)
			    this.aClass_ra2827.method4990(i, i_108_ + -2028004825 * (this.aClass505_2833.anInt6200), i_124_, -1731221141 * anInt2837, -1265660857);
			i += i_124_;
			i_113_ = c;
		    }
		}
	...
	try {
		...
		method2484(string, i - this.aClass505_2833.method6264(string, 1243151471) / 2, i_135_, null, null, null, 0, 0, 2121400127);
	    }
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2493(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_141_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    int i_142_ = (class403.anIntArray5244[1 + 681479919 * class403.anInt5239]);
	    Class390 class390;
	    if (class403.aBoolean5261)
		class390 = class403.aClass390_5247;
	    else
		class390 = class403.aClass390_5246;
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class390.method4866((class403.aClass365_Sub1_Sub1_Sub2_5242.aClass119_10131), i_141_, i_142_, 867608709) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2494(Class403 class403, int i) {
	try {
	    int i_143_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (class403.myClanChannel.members[i_143_].aByte1683);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2495(Class403 class403, byte i) {
	try {
	...
	try {
		...
		Class82_Sub22.method940((Class372.anIntArrayArray4047[i_154_]), i, i_145_, i_149_, 1917920916);
	    for (int i_155_ = i_147_; i_155_ > i_153_; i_155_--)
		Class82_Sub22.method940((Class372.anIntArrayArray4047[i_155_]), i, i_145_, i_149_, 1834727218);
	    int i_156_ = i_150_ + i;
	    int i_157_ = i_145_ - i_150_;
	    for (int i_158_ = i_152_; i_158_ <= i_153_; i_158_++) {
		int[] is = Class372.anIntArrayArray4047[i_158_];
    ...
    static final void method2498(Class403 class403, int i) {
	try {
	    Class390 class390 = (class403.aBoolean5261 ? class403.aClass390_5247 : class403.aClass390_5246);
	    IComponentDefinition class105 = class390.aClass105_4168;
	    Class119 class119 = class390.aClass119_4167;
