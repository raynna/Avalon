...
public class Class384 {
    ...
    static final void method4695(Class403 class403, int i) {
	try {
	    ...
	    AccountCreationStage.method6157(class105, class119, class403, (byte) 1);
	}
    ...
    static final void method4696(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -1567522756;
	    int i_1_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    int i_2_ = (class403.anIntArray5244[1 + class403.anInt5239 * 681479919]);
	    ...
	    if (i_2_ == 115)
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = class483.method6122(i_4_, (byte) 60);
	    else
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = class483.method6125(i_4_, 2053522267);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4697(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub12_7543.method5669((byte) 45);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4698(Class403 class403, int i) {
	try {
	    int i_5_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub11_7558.method5612(i_5_, 1352882135);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		strings[i_16_] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(is[i_16_]).name);
    ...
    static final void method4700(Class403 class403, int i) {
	try {
    ...
    static final void method4701(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class315.method3837((byte) -27) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4702(Class403 class403, int i) {
	try {
	    MapDetails class298_sub37_sub13 = Class298_Sub7.method2864(-598938437);
