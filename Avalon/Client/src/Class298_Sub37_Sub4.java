...
public class Class298_Sub37_Sub4 extends Class298_Sub37 {
	...
	try {
	    if (this.aClass96Array9579 != null)
		return true;
	    if (this.aByteArrayArray9581 == null) {
		synchronized (Class317.aClass243_3321) {
		    if (!Class317.aClass243_3321.method2291(1899473659 * this.anInt9580, 334179097)) {
			boolean bool = false;
			return bool;
		    }
		    int[] is = (Class317.aClass243_3321.getFileIds((this.anInt9580 * 1899473659)));
		    this.aByteArrayArray9581 = new byte[is.length][];
		    for (int i_0_ = 0; i_0_ < is.length; i_0_++)
			this.aByteArrayArray9581[i_0_] = (Class317.aClass243_3321.getFile((1899473659 * this.anInt9580), is[i_0_]));
		}
	    }
	    boolean bool = true;
	    for (int i_1_ = 0; (i_1_ < this.aByteArrayArray9581.length); i_1_++) {
		byte[] is = this.aByteArrayArray9581[i_1_];
	    ...
	    int[] is;
	    synchronized (Class317.aClass243_3321) {
		int i_3_ = (Class317.aClass243_3321.method2316(this.anInt9580 * 1899473659, -222662329));
		this.aClass96Array9579 = new Class96[i_3_];
		is = Class317.aClass243_3321.getFileIds((this.anInt9580 * 1899473659));
	    }
	    for (int i_4_ = 0; i_4_ < is.length; i_4_++) {
		byte[] is_5_ = this.aByteArrayArray9581[i_4_];
		...
		for (Class298_Sub15 class298_sub15_7_ = (Class298_Sub15) class458.method5967(2084946117); class298_sub15_7_ != null; class298_sub15_7_ = (Class298_Sub15) class458.method5969((byte) -23)) {
		    if (i_6_ == (class298_sub15_7_.anInt7276 * 1029066723)) {
		...
		this.aClass96Array9579[is[i_4_]] = new Class96(is_5_, class298_sub15);
	    }
	    this.aByteArrayArray9581 = null;
	    return true;
	}
	...
	try {
	    return (this.aClass96Array9579[i].aBoolean940);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return (this.aClass96Array9579[i].aBoolean941);
	}
	catch (RuntimeException runtimeexception) {
	...
	this.anInt9580 = -2073571277 * i;
    }

    public boolean method3415(int i, int i_10_) {
	try {
	    return (this.aClass96Array9579[i].aBoolean939);
	}
	catch (RuntimeException runtimeexception) {
