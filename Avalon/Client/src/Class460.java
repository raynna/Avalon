...
public class Class460 implements Iterator {
	...
	try {
	    if ((this.aClass437_5675.aClass298Array5512[1772241843 * this.anInt5677 - 1]) != this.aClass298_5676)
		return true;
	    while (this.anInt5677 * 1772241843 < 577108745 * (this.aClass437_5675.anInt5515)) {
		if ((this.aClass437_5675.aClass298Array5512[((this.anInt5677 += -317185157) * 1772241843 - 1)].aClass298_3187) != (this.aClass437_5675.aClass298Array5512[this.anInt5677 * 1772241843 - 1])) {
		    this.aClass298_5676 = (this.aClass437_5675.aClass298Array5512[this.anInt5677 * 1772241843 - 1].aClass298_3187);
		    return true;
		}
		this.aClass298_5676 = (this.aClass437_5675.aClass298Array5512[1772241843 * this.anInt5677 - 1]);
	    }
	    return false;
	}
	...
	try {
	    this.aClass298_5676 = (this.aClass437_5675.aClass298Array5512[0].aClass298_3187);
	...
	try {
	    ...
	    this.aClass298_5678.method2839(-1460969981);
	    this.aClass298_5678 = null;
	}
	catch (RuntimeException runtimeexception) {
    ...
    public Object next() {
	try {
	    if ((this.aClass437_5675.aClass298Array5512[this.anInt5677 * 1772241843 - 1]) != this.aClass298_5676) {
		Class298 class298 = this.aClass298_5676;
		this.aClass298_5676 = class298.aClass298_3187;
		...
		Class298 class298;
		do {
		    if (this.anInt5677 * 1772241843 >= (577108745 * (this.aClass437_5675.anInt5515)))
			break while_106_;
		    class298 = (this.aClass437_5675.aClass298Array5512[((this.anInt5677 += -317185157) * 1772241843) - 1].aClass298_3187);
		}
		while (class298 == (this.aClass437_5675.aClass298Array5512[this.anInt5677 * 1772241843 - 1]));
		this.aClass298_5676 = class298.aClass298_3187;
		this.aClass298_5678 = class298;
		return class298;
	    }
	...
	try {
		...
		do {
			...
			if (12 == Class360.anInt3896 * -707576455) {
				...
				class298_sub53.writeByte(Class321.aClass429_3357.getType(694163818));
				...
				class298_sub53.writeByte((-937307905 * (client.gametype.gameType)));
				...
				class298_sub36.out.writeBytes(class298_sub53.buffer, 0, 385051775 * class298_sub53.index, (short) -29754);
				class298_sub36.out.method3593(385051775 * (class298_sub36.out.index) - i_1_, 1585504133);
			    } else
				class298_sub36.out.writeByte((-1813470547 * HandshakePacket.aClass211_2416.opcode));
			...
			if (Class360.anInt3896 * -707576455 == 30) {
			    ...
			    int i_3_ = ((Class360.aClass25_3905.aClass298_Sub53_Sub2_333.buffer[0]) & 0xff);
			    if (0 != i_3_) {
				Class360.anInt3896 = -395862839;
			...
			if (Class360.anInt3896 * -707576455 == 62) {
			    ...
			    if (((Class360.aClass25_3905.aClass298_Sub53_Sub2_333.buffer[0]) & 0xff) == 1)
			...
			if (Class360.anInt3896 * -707576455 == 72) {
			    ...
			    Class360.aClass25_3905.aClass298_Sub53_Sub2_333.method3610(Class360.anIntArray3889, 642509947);
			    Class360.aClass25_3905.aClass298_Sub53_Sub2_333.index = 0;
			    Class360.aLong3874 = (Class360.aClass25_3905.aClass298_Sub53_Sub2_333.readLong((short) 27770) * -2742373017286080113L);
			...
			if (-707576455 * Class360.anInt3896 == 82) {
			    ...
			    RsBitsBuffer stream = class298_sub36.out;
			    if (264 == -122629167 * Class360.anInt3868) { // WORLD
									  // LOGIN
				HandshakePacket class211;
				if (Class360.aBoolean3886)
				    class211 = HandshakePacket.aClass211_2417;
				else
				    class211 = HandshakePacket.aClass211_2409;
				stream.writeByte(-1813470547 * class211.opcode);
				...
				if (Class360.aBoolean3886)
				    ...
				    class211 = HandshakePacket.aClass211_2411;
				stream.writeByte(-1813470547 * class211.opcode);
				stream.writeShort(0, 16711935);
				...
				stream.writeByte((-937307905 * client.gametype.gameType));
				stream.writeByte(Class321.aClass429_3357.getType(694163818));
				...
				AccountCreationStage.writeCacheCRCs(stream, -535015918);
				byte[] bs = NetworkInterface.getByInetAddress(InetAddress.getLocalHost()).getHardwareAddress();
			...
			if (94 == -707576455 * Class360.anInt3896) {
			    ...
			    int loginOpcode = ((Class360.aClass25_3905.aClass298_Sub53_Sub2_333.buffer[0]) & 0xff);
			    if (21 == loginOpcode)
			...
			if (Class360.anInt3896 * -707576455 == 117) {
			    ...
			    RsBitsBuffer class298_sub53_sub2 = class298_sub36.out;
			    class298_sub53_sub2.method3665((Class360.aClass25_3905.aClass449_330), (byte) 41);
			    class298_sub53_sub2.method3668((-1813470547 * (HandshakePacket.aClass211_2419.opcode)), (byte) 1);
				...
				int i_13_ = (Class360.aClass25_3905.aClass298_Sub53_Sub2_333.buffer[0]) & 0xff;
				...
				Class360.anInt3866 = ((((Class360.aClass25_3905.aClass298_Sub53_Sub2_333.buffer[0]) & 0xff) << 8) + ((Class360.aClass25_3905.aClass298_Sub53_Sub2_333.buffer[1]) & 0xff)) * -1156978587;
				Class360.anInt3896 = 1443598798;
			    }
				...
				Class360.anInt3910 = (1200969765 * ((Class360.aClass25_3905.aClass298_Sub53_Sub2_333.buffer[0]) & 0xff));
				...
				Class360.anInt3910 = (1200969765 * ((Class360.aClass25_3905.aClass298_Sub53_Sub2_333.buffer[0]) & 0xff));
				Class360.anInt3909 = (1719895145 * (((Class360.aClass25_3905.aClass298_Sub53_Sub2_333.buffer[2]) & 0xff) + (((Class360.aClass25_3905.aClass298_Sub53_Sub2_333.buffer[1]) & 0xff) << 8)));
			    } else
				throw new IllegalStateException();
			    Class360.anInt3896 = -395862839;
				...
				Class360.loginConfigsSize = (1962471985 * ((Class360.aClass25_3905.aClass298_Sub53_Sub2_333.buffer[0]) & 0xff));
			    ...
			    if (-707576455 * Class360.anInt3896 == 148) { // if
									  // world
									  // login
				RsBitsBuffer stream = (Class360.aClass25_3905.aClass298_Sub53_Sub2_333);
				...
				Class360.aClass25_3905.INCOMMING_PACKET = (Class510.method6290(-1456212765)[stream.readUnsignedSmart(250607366)]); // receives
																		   // packet
																		   // id
				Class360.aClass25_3905.anInt336 = (stream.readUnsignedShort() * -1265692267); // stream
													      // required
													      // size,
													      // prob
													      // packet
				...
				if (Class360.aClass25_3905.method387(537308016).isAvailable((-866602563 * (Class360.aClass25_3905.anInt336)), (byte) -22)) {
				    ...
				    Class360.aClass25_3905.aClass298_Sub53_Sub2_333.index = 0;
				    int packetSize = ((Class360.aClass25_3905.anInt336) * -866602563);
				    Class360.anInt3896 = -395862839;
				    ...
				    int i_16_ = packetSize - (Class360.aClass25_3905.aClass298_Sub53_Sub2_333.index) * 385051775;
				    ...
				    Class360.aClass25_3905.aClass298_Sub53_Sub2_333.index += i_16_ * 116413311;
				    ...
				    if (packetSize != (Class360.aClass25_3905.aClass298_Sub53_Sub2_333.index) * 385051775)
					throw new RuntimeException(new StringBuilder().append(385051775 * ((Class360.aClass25_3905).aClass298_Sub53_Sub2_333.index)).append(" ").append(packetSize).toString());
				    Class360.aClass25_3905.INCOMMING_PACKET = null;
				}
			    } else {
				...
				if (Class360.aClass25_3905.method387(537308016).isAvailable((-866602563 * (Class360.aClass25_3905.anInt336)), (byte) 77)) {
				    ...
				    Class360.aClass25_3905.aClass298_Sub53_Sub2_333.index = 0;
				    int i_17_ = ((Class360.aClass25_3905.anInt336) * -866602563);
				    Class360.anInt3896 = -395862839;
					...
					throw new RuntimeException(new StringBuilder().append(((Class360.aClass25_3905).aClass298_Sub53_Sub2_333.index) * 385051775).append(" ").append(i_17_).toString());
				    Class360.aClass25_3905.INCOMMING_PACKET = null;
				}
			    }
			}
