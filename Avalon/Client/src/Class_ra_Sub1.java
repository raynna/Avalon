...
public class Class_ra_Sub1 extends GraphicsToolkit {
	...
	float f_4_ = (float) Math.sqrt(f_2_ * f_2_ + f_1_ * f_1_ + f_3_ * f_3_);
	...
	this.aClass348_7970 = new Class348(16);
	this.anInt8006 = -2116530773;
	try {
	    this.aClass348_7975 = new Class348(256);
	    this.aClass222_7984 = new Class222();
	    this.aClass233_8000 = new Class233();
	    this.aClass233_7986 = new Class233();
	    this.aClass233_7987 = new Class233();
	    method5210(1);
	    method5201(0);
	    Class374_Sub1.method4640(true, true, -162450455);
	    this.aBoolean7994 = true;
	    this.anInt7968 = (int) Class122.method1319((byte) 1) * -1260974911;
	}
	...
	synchronized (this.aClass348_7975) {
	    class298_sub4 = ((Class298_Sub4) this.aClass348_7975.method4184(i | ~0x7fffffffffffffffL));
	...
	int i_14_ = 0;
	float f = (i_10_ * (this.aClass233_7987.aFloatArray2594[10]) + ((this.aClass233_7987.aFloatArray2594[6] * i_9_) + (i * (this.aClass233_7987.aFloatArray2594[2]) + (this.aClass233_7987.aFloatArray2594[14]))));
	float f_15_ = ((i_13_ * this.aClass233_7987.aFloatArray2594[10]) + ((this.aClass233_7987.aFloatArray2594[6] * i_12_) + (this.aClass233_7987.aFloatArray2594[14] + i_11_ * (this.aClass233_7987.aFloatArray2594[2]))));
	float f_16_ = ((i * this.aClass233_7987.aFloatArray2594[3]) + this.aClass233_7987.aFloatArray2594[15] + (this.aClass233_7987.aFloatArray2594[7] * i_9_) + i_10_ * (this.aClass233_7987.aFloatArray2594[11]));
	float f_17_ = ((i_11_ * this.aClass233_7987.aFloatArray2594[3]) + this.aClass233_7987.aFloatArray2594[15] + (this.aClass233_7987.aFloatArray2594[7] * i_12_) + (this.aClass233_7987.aFloatArray2594[11] * i_13_));
	if (f < -f_16_ && f_15_ < -f_17_)
	    i_14_ |= 0x10;
	else if (f > f_16_ && f_15_ > f_17_)
	    i_14_ |= 0x20;
	float f_18_ = ((this.aClass233_7987.aFloatArray2594[4] * i_9_) + (this.aClass233_7987.aFloatArray2594[12] + (this.aClass233_7987.aFloatArray2594[0] * i)) + (this.aClass233_7987.aFloatArray2594[8] * i_10_));
	float f_19_ = ((this.aClass233_7987.aFloatArray2594[8] * i_13_) + ((i_11_ * this.aClass233_7987.aFloatArray2594[0]) + this.aClass233_7987.aFloatArray2594[12] + (this.aClass233_7987.aFloatArray2594[4] * i_12_)));
	if (f_18_ < -f_16_ && f_19_ < -f_17_)
	    i_14_ |= 0x1;
	if (f_18_ > f_16_ && f_19_ > f_17_)
	    i_14_ |= 0x2;
	float f_20_ = ((i_9_ * this.aClass233_7987.aFloatArray2594[5]) + ((this.aClass233_7987.aFloatArray2594[1] * i) + this.aClass233_7987.aFloatArray2594[13]) + (this.aClass233_7987.aFloatArray2594[9] * i_10_));
	float f_21_ = ((i_11_ * this.aClass233_7987.aFloatArray2594[1]) + this.aClass233_7987.aFloatArray2594[13] + (i_12_ * this.aClass233_7987.aFloatArray2594[5]) + (this.aClass233_7987.aFloatArray2594[9] * i_13_));
	...
	for (int i_24_ = 0; i_24_ < this.aClass15Array8001.length; i_24_++) {
	    Class15 class15 = this.aClass15Array8001[i_24_];
	    class15.anInt184 = 1903335279 * (i & 0xffffff);
	    int i_25_ = 688695183 * class15.anInt184 >>> 16 & 0xff;
	    if (i_25_ < 2)
		i_25_ = 2;
	    int i_26_ = 688695183 * class15.anInt184 >> 8 & 0xff;
	    if (i_26_ < 2)
		i_26_ = 2;
	    int i_27_ = class15.anInt184 * 688695183 & 0xff;
	    if (i_27_ < 2)
		i_27_ = 2;
	    class15.anInt184 = (i_25_ << 16 | i_26_ << 8 | i_27_) * 1903335279;
	    if (i_22_ < 0)
		class15.aBoolean216 = false;
	    else
		class15.aBoolean216 = true;
	}
    }

    @Override
    public void ey(float f, float f_28_) {
	this.aFloat7997 = f_28_ - f;
	this.aFloat8004 = f_28_ + f - 1.0F;
	...
	if ((i & 0x1) != 0)
	    B(0, 0, 692106883 * this.anInt7971, this.anInt7972 * 918677455, i_29_, 0);
	if ((i & 0x2) != 0)
	    method5198();
    }
	...
	for (int i_33_ = 0; i_33_ < this.aClass15Array8001.length; i_33_++) {
	    Class15 class15 = this.aClass15Array8001[i_33_];
	    class15.anInt184 = 1903335279 * (i & 0xffffff);
	    int i_34_ = 688695183 * class15.anInt184 >>> 16 & 0xff;
	    if (i_34_ < 2)
		i_34_ = 2;
	    int i_35_ = 688695183 * class15.anInt184 >> 8 & 0xff;
	    if (i_35_ < 2)
		i_35_ = 2;
	    int i_36_ = class15.anInt184 * 688695183 & 0xff;
	    if (i_36_ < 2)
		i_36_ = 2;
	    class15.anInt184 = (i_34_ << 16 | i_35_ << 8 | i_36_) * 1903335279;
	    if (i_31_ < 0)
		class15.aBoolean216 = false;
	    else
		class15.aBoolean216 = true;
	...
	is[0] = 692106883 * this.anInt7971;
	is[1] = this.anInt7972 * 918677455;
    }

    void method5198() {
	if (null != this.aFloatArray7973) {
	    if (0 == -912871679 * this.anInt7974 && (this.anInt7991 * -1416794725 == this.anInt7971 * 692106883) && -1278653805 * this.anInt7976 == 0 && (63686679 * this.anInt7977 == 918677455 * this.anInt7972)) {
		...
		int i_40_ = 692106883 * this.anInt7971 - i;
		int i_41_ = ((-1278653805 * this.anInt7976 * (692106883 * this.anInt7971)) + this.anInt7974 * -912871679);
		int i_42_ = i >> 3;
		int i_43_ = i & 0x7;
		i = i_41_ - 1;
	...
	this.anInt7989 = 0;
	this.anInt7990 = 0;
	this.anInt7980 = 845086741 * this.anInt7971;
	this.anInt7969 = -1768491203 * this.anInt7972;
	method5209();
    }
	...
	this.anInt7974 = 0;
	this.anInt7976 = 0;
	this.anInt7991 = 2046188857 * this.anInt7971;
	this.anInt7977 = -482117367 * this.anInt7972;
	method5209();
    }
	...
	if (i_48_ < 0)
	    i_48_ = 0;
	if (i_49_ > 692106883 * this.anInt7971)
	    i_49_ = 692106883 * this.anInt7971;
	if (i_50_ > this.anInt7972 * 918677455)
	    i_50_ = 918677455 * this.anInt7972;
	this.anInt7974 = i * -1291169535;
	this.anInt7991 = i_49_ * -1912131437;
	this.anInt7976 = i_48_ * 104031131;
	this.anInt7977 = 1656090535 * i_50_;
	method5209();
    }
	...
	if (this.aBoolean8003 || anInterface_ma5299.method174(i, 507704159).aBoolean518)
	    return true;
	return false;
    }
	...
	if (null != this.anIntArray7967 && (i_52_ >= -1278653805 * this.anInt7976 && i_52_ < 63686679 * this.anInt7977)) {
	    if (i < -912871679 * this.anInt7974) {
		i_53_ -= -912871679 * this.anInt7974 - i;
		i = this.anInt7974 * -912871679;
	    }
	    if (i + i_53_ > -1416794725 * this.anInt7991)
		i_53_ = -1416794725 * this.anInt7991 - i;
	    int i_56_ = i + 692106883 * this.anInt7971 * i_52_;
	    int i_57_ = i_54_ >>> 24;
	    if (i_55_ == 0 || i_55_ == 1 && i_57_ == 255) {
		for (int i_58_ = 0; i_58_ < i_53_; i_58_++)
		    this.anIntArray7967[i_56_ + i_58_] = i_54_;
	    } else if (i_55_ == 1) {
		...
		for (int i_60_ = 0; i_60_ < i_53_; i_60_++) {
		    ...
		    this.anIntArray7967[i_60_ + i_56_] = i_54_ + i_61_;
		}
	    } else if (i_55_ == 2) {
	...
	if (null != this.anIntArray7967) {
		...
		i_72_ -= -912871679 * this.anInt7974 - i;
		i = this.anInt7974 * -912871679;
	    }
	    if (i_71_ < -1278653805 * this.anInt7976) {
		i_73_ -= -1278653805 * this.anInt7976 - i_71_;
		i_71_ = -1278653805 * this.anInt7976;
	    }
	    if (i + i_72_ > this.anInt7991 * -1416794725)
		i_72_ = -1416794725 * this.anInt7991 - i;
	    if (i_73_ + i_71_ > 63686679 * this.anInt7977)
		i_73_ = 63686679 * this.anInt7977 - i_71_;
	    if (i_72_ > 0 && i_73_ > 0 && i <= this.anInt7991 * -1416794725 && i_71_ <= this.anInt7977 * 63686679) {
		int i_76_ = this.anInt7971 * 692106883 - i_72_;
		int i_77_ = (i_71_ * (this.anInt7971 * 692106883) + i);
		int i_78_ = i_74_ >>> 24;
		if (0 == i_75_ || i_75_ == 1 && 255 == i_78_) {
			...
			if (i_79_ > 0) {
			    i = i_79_;
			    do {
				this.anIntArray7967[++i_72_] = i_74_;
				this.anIntArray7967[++i_72_] = i_74_;
				this.anIntArray7967[++i_72_] = i_74_;
				this.anIntArray7967[++i_72_] = i_74_;
				this.anIntArray7967[++i_72_] = i_74_;
			...
			for (int i_84_ = -i_72_; i_84_ < 0; i_84_++) {
			    ...
			    this.anIntArray7967[i_77_++] = i_85_ + i_74_;
			}
			i_77_ += i_76_;
		    }
		} else if (i_75_ == 2) {
	...
	if (this.anIntArray7967 != null && (i_92_ > 0 && i_93_ > 0)) {
	    ...
	    int i_102_ = i + i_91_ * (692106883 * this.anInt7971);
	    int i_103_ = 692106883 * this.anInt7971 - i_92_;
		...
		i_93_ -= i_104_;
		i_102_ += i_104_ * (this.anInt7971 * 692106883);
		i_99_ += i_104_ * i_101_;
	    }
	...
	if (this.anIntArray7967 != null) {
		...
		while (i_135_ < i_129_) {
		    ...
		    int i_144_ = i_142_ + (this.anInt7971 * 692106883 * i_135_);
		...
		while (i_135_ < i_134_) {
		    ...
		    int i_148_ = (i_135_ * (692106883 * this.anInt7971) + i_146_);
		...
		while (i_135_ < i_129_) {
		    ...
		    int i_153_ = ((this.anInt7971 * 692106883 * i_135_) + i_151_);
		...
		while (i_135_ < i_134_) {
		    ...
		    int i_158_ = ((692106883 * this.anInt7971 * i_135_) + i_156_);
		...
		while (i_135_ < i_129_) {
		    ...
		    int i_163_ = ((this.anInt7971 * 692106883 * i_135_) + i_161_);
		...
		while (i_135_ < i_134_) {
		    ...
		    int i_170_ = i_168_ + i_135_ * (this.anInt7971 * 692106883);
	...
	int i_178_ = i_175_ * (692106883 * this.anInt7971) + i;
	int i_179_ = 692106883 * this.anInt7971 - i_176_;
	for (int i_180_ = 0; i_180_ < i_177_; i_180_++) {
	    int i_181_ = i_176_ * i_180_;
	    for (int i_182_ = 0; i_182_ < i_176_; i_182_++)
		is[i_182_ + i_181_] = this.anIntArray7967[i_178_++];
	    i_178_ += i_179_;
	}
	if (bool)
	...
	if (null != this.anIntArray7967 && (i >= this.anInt7974 * -912871679 && i < this.anInt7991 * -1416794725)) {
	    ...
	    int i_187_ = i + i_183_ * (this.anInt7971 * 692106883);
	    int i_188_ = i_185_ >>> 24;
	    if (i_186_ == 0 || 1 == i_186_ && 255 == i_188_) {
		for (int i_189_ = 0; i_189_ < i_184_; i_189_++)
		    this.anIntArray7967[i_187_ + i_189_ * (this.anInt7971 * 692106883)] = i_185_;
	    } else if (i_186_ == 1) {
		...
		for (int i_191_ = 0; i_191_ < i_184_; i_191_++) {
		    int i_192_ = (i_191_ * (692106883 * this.anInt7971) + i_187_);
		...
		for (int i_194_ = 0; i_194_ < i_184_; i_194_++) {
		    int i_195_ = (i_194_ * (692106883 * this.anInt7971) + i_187_);
	...
	if (null != this.anIntArray7967) {
		...
		i_209_ %= i_212_;
		if (i_204_ + i_203_ < 0) {
		    int i_213_ = (int) (Math.sqrt(i_204_ * i_204_ + i_203_ * i_203_) * 256.0);
		...
		if (i_203_ > i_204_) {
		    ...
		    int i_217_ = (int) Math.sqrt(65536 + (i_215_ >> 8) * (i_215_ >> 8));
			...
			while (i <= i_203_) {
				...
				this.anIntArray7967[(this.anInt7971 * 692106883 * i_218_) + i] = i_205_;
			    i_202_ += i_215_;
			    i++;
			    i_209_ += i_217_;
			    i_209_ %= i_212_;
			...
			while (i <= i_203_) {
				...
				int i_221_ = i + i_220_ * (692106883 * (this.anInt7971));
			...
			while (i <= i_203_) {
				...
				int i_224_ = i + (i_223_ * (this.anInt7971 * 692106883));
		    ...
		    int i_230_ = (int) Math.sqrt((i_228_ >> 8) * (i_228_ >> 8) + 65536);
			...
			while (i_202_ <= i_204_) {
				...
				this.anIntArray7967[i_202_ * (this.anInt7971 * 692106883) + i_231_] = i_205_;
			    i += i_228_;
			    i_202_++;
			    i_209_ += i_230_;
			    i_209_ %= i_212_;
			...
			while (i_202_ <= i_204_) {
				...
				int i_234_ = ((692106883 * this.anInt7971 * i_202_) + i_233_);
				int i_235_ = (this.anIntArray7967[i_234_]);
				i_235_ = ((i_232_ * (i_235_ & 0xff00) >> 8 & 0xff00) + (i_232_ * (i_235_ & 0xff00ff) >> 8 & 0xff00ff));
				this.anIntArray7967[(692106883 * this.anInt7971 * i_202_) + i_233_] = i_205_ + i_235_;
			    }
			    i += i_228_;
			    i_202_++;
			    i_209_ += i_230_;
			...
			while (i_202_ <= i_204_) {
				...
				int i_237_ = (i_236_ + i_202_ * (692106883 * (this.anInt7971)));
	...
	if (null != this.anIntArray7967) {
	    ...
	    i_243_ -= i_241_;
	    if (i_243_ + i_242_ < 0) {
		int i_255_ = (int) (Math.sqrt(i_243_ * i_243_ + i_242_ * i_242_) * 256.0);
		...
		int i_259_ = (int) Math.sqrt(65536 + (i_257_ >> 8) * (i_257_ >> 8));
		if (0 == i_245_ || i_245_ == 1 && 255 == i_258_) {
			...
			if (i >= this.anInt7974 * -912871679 && i < (-1416794725 * this.anInt7991) && i_260_ >= i_252_ && i_260_ < i_253_ && i_250_ < i_248_) {
				...
				this.anIntArray7967[i + (692106883 * this.anInt7971 * i_260_)] = i_244_;
			}
			i_241_ += i_257_;
			i++;
			i_250_ += i_259_;
			...
			if (i >= -912871679 * this.anInt7974 && i < (this.anInt7991 * -1416794725) && i_264_ >= i_252_ && i_264_ < i_253_ && i_250_ < i_248_) {
				...
				int i_267_ = i + (this.anInt7971 * 692106883 * i_264_);
			...
			if (i >= this.anInt7974 * -912871679 && i < (-1416794725 * this.anInt7991) && i_269_ >= i_252_ && i_269_ < i_253_ && i_250_ < i_248_) {
				...
				int i_272_ = ((692106883 * this.anInt7971 * i_269_) + i);
		...
		int i_277_ = (int) Math.sqrt((i_276_ >> 8) * (i_276_ >> 8) + 65536);
		i_243_ += i_241_;
		...
		if (i_245_ == 0 || i_245_ == 1 && i_278_ == 255) {
			...
			if (i_241_ >= i_252_ && i_241_ < i_253_ && i_279_ >= (this.anInt7974 * -912871679) && i_279_ < (this.anInt7991 * -1416794725) && i_250_ < i_248_ && i_279_ >= i_246_ + is[i_280_] && i_279_ < is_251_[i_280_] + (i_246_ + is[i_280_]))
			    this.anIntArray7967[(i_241_ * (692106883 * this.anInt7971) + i_279_)] = i_244_;
			i += i_276_;
			i_241_++;
			i_250_ += i_277_;
			i_250_ %= i_254_;
			...
			if (i_241_ >= i_252_ && i_241_ < i_253_ && i_282_ >= (this.anInt7974 * -912871679) && i_282_ < (this.anInt7991 * -1416794725) && i_250_ < i_248_ && i_282_ >= i_246_ + is[i_283_] && (i_282_ < is[i_283_] + i_246_ + is_251_[i_283_])) {
			    int i_284_ = (i_282_ + i_241_ * (this.anInt7971 * 692106883));
			    int i_285_ = (this.anIntArray7967[i_284_]);
			    i_285_ = ((i_281_ * (i_285_ & 0xff00) >> 8 & 0xff00) + ((i_285_ & 0xff00ff) * i_281_ >> 8 & 0xff00ff));
			    this.anIntArray7967[(i_282_ + i_241_ * (this.anInt7971 * 692106883))] = i_244_ + i_285_;
			}
			i += i_276_;
			i_241_++;
			i_250_ += i_277_;
			...
			if (i_241_ >= i_252_ && i_241_ < i_253_ && i_286_ >= (this.anInt7974 * -912871679) && i_286_ < (this.anInt7991 * -1416794725) && i_250_ < i_248_ && i_286_ >= i_246_ + is[i_287_] && (i_286_ < is[i_287_] + i_246_ + is_251_[i_287_])) {
			    int i_288_ = (692106883 * this.anInt7971 * i_241_) + i_286_;
	...
	if (null != this.anIntArray7967) {
		...
		if (i_297_ == 0)
		    ...
		    class2.anInt19 = 255 - (i_295_ >>> 24);
		else
		    throw new IllegalArgumentException();
		RA(false);
		class2.aBoolean20 = (i_309_ < 0 || i_309_ > class2.anInt22 || i_310_ < 0 || i_310_ > class2.anInt22 || i_311_ < 0 || i_311_ > class2.anInt22);
		class2.method293(true, false, false, i_313_, i_314_, i_315_, i_309_, i_310_, i_311_, 100.0F, 100.0F, 100.0F, i_295_);
		class2.aBoolean20 = (i_309_ < 0 || i_309_ > class2.anInt22 || i_311_ < 0 || i_311_ > class2.anInt22 || i_312_ < 0 || i_312_ > class2.anInt22);
		class2.method293(true, false, false, i_313_, i_315_, i_316_, i_309_, i_311_, i_312_, 100.0F, 100.0F, 100.0F, i_295_);
		RA(true);
	    }
	}
    }
	...
	int i_327_ = i_324_ * (692106883 * this.anInt7971) + i;
	int i_328_ = 692106883 * this.anInt7971 - i_325_;
	...
	if (null != this.anIntArray7967) {
		...
		i_336_ = 0;
	    if (i_335_ - i_336_ > 0) {
		int i_337_ = 692106883 * this.anInt7971 * i_333_;
		for (int i_338_ = i_336_; i_338_ < i_335_; i_338_++) {
		    ...
		    i_337_ += this.anInt7971 * 692106883;
		}
	    }
	}
    }
	...
	for (int i_349_ = 0; i_349_ < this.aClass15Array8001.length; i_349_++) {
	    Class15 class15 = this.aClass15Array8001[i_349_];
	    class15.anInt184 = 1903335279 * (i & 0xffffff);
	    int i_350_ = 688695183 * class15.anInt184 >>> 16 & 0xff;
	    if (i_350_ < 2)
		i_350_ = 2;
	    int i_351_ = 688695183 * class15.anInt184 >> 8 & 0xff;
	    if (i_351_ < 2)
		i_351_ = 2;
	    int i_352_ = class15.anInt184 * 688695183 & 0xff;
	    if (i_352_ < 2)
		i_352_ = 2;
	    class15.anInt184 = (i_350_ << 16 | i_351_ << 8 | i_352_) * 1903335279;
	    if (i_347_ < 0)
		class15.aBoolean216 = false;
	    else
		class15.aBoolean216 = true;
	...
	for (Class302_Sub3 class302_sub3_365_ = class302_sub3.aClass302_Sub3_7650; class302_sub3_365_ != class302_sub3; class302_sub3_365_ = class302_sub3_365_.aClass302_Sub3_7650) {
	    ...
	    float f = ((i * this.aClass233_7987.aFloatArray2594[2]) + i_366_ * (this.aClass233_7987.aFloatArray2594[6]) + (this.aClass233_7987.aFloatArray2594[10] * i_367_) + (this.aClass233_7987.aFloatArray2594[14]));
	    float f_368_ = (this.aClass233_7987.aFloatArray2594[15] + ((this.aClass233_7987.aFloatArray2594[11]) * i_367_ + ((this.aClass233_7987.aFloatArray2594[7]) * i_366_ + i * (this.aClass233_7987.aFloatArray2594[3]))));
	    if (!(f < -f_368_)) {
		float f_369_ = (this.aFloat7997 * f / f_368_ + this.aFloat8004);
		if (!(f > class15.aFloat205)) {
		    float f_370_ = ((this.aClass233_7987.aFloatArray2594[12]) + (i_366_ * (this.aClass233_7987.aFloatArray2594[4]) + i * (this.aClass233_7987.aFloatArray2594[0]) + (this.aClass233_7987.aFloatArray2594[8]) * i_367_));
		    float f_371_ = ((this.aClass233_7987.aFloatArray2594[13]) + (i_367_ * (this.aClass233_7987.aFloatArray2594[9]) + (i_366_ * (this.aClass233_7987.aFloatArray2594[5]) + (this.aClass233_7987.aFloatArray2594[1]) * i)));
		    if (!(f_370_ < -f_368_) && !(f_370_ > f_368_) && !(f_371_ < -f_368_) && !(f_371_ > f_368_)) {
			float f_372_ = class302_sub3_sub1.anInt9791 / 4096.0F;
			float f_373_ = f_370_ + (this.aClass233_7986.aFloatArray2594[0]) * f_372_;
			float f_374_ = (f_372_ * (this.aClass233_7986.aFloatArray2594[3]) + f_368_);
	...
	this.anInt7971 = -1336293333 * i;
	this.anInt7972 = i_395_ * -1138901201;
	this.anIntArray7967 = is;
	this.aFloatArray7973 = fs;
	for (int i_396_ = 0; i_396_ < this.anInt7999 * -922307687; i_396_++)
	    this.aClass15Array8001[i_396_].method348(-455629367);
	L();
	method5011();
    }
	...
	float f_399_ = ((this.aClass233_7987.aFloatArray2594[11] * f_398_) + (f * this.aClass233_7987.aFloatArray2594[3] + this.aClass233_7987.aFloatArray2594[15] + f_397_ * (this.aClass233_7987.aFloatArray2594[7])));
	float f_400_ = ((f_398_ * this.aClass233_7987.aFloatArray2594[8]) + (this.aClass233_7987.aFloatArray2594[12] + (this.aClass233_7987.aFloatArray2594[0] * f) + f_397_ * (this.aClass233_7987.aFloatArray2594[4])));
	float f_401_ = ((this.aClass233_7987.aFloatArray2594[5] * f_397_) + (this.aClass233_7987.aFloatArray2594[1] * f + this.aClass233_7987.aFloatArray2594[13]) + (this.aClass233_7987.aFloatArray2594[9] * f_398_));
	float f_402_ = (f * this.aClass233_8000.aFloatArray2594[2] + this.aClass233_8000.aFloatArray2594[14] + (this.aClass233_8000.aFloatArray2594[6] * f_397_) + (this.aClass233_8000.aFloatArray2594[10] * f_398_));
	fs[0] = (f_400_ * this.aFloat7993 / f_399_ + this.aFloat8005);
	fs[1] = (this.aFloat7996 + this.aFloat7995 * f_401_ / f_399_);
	fs[2] = f_402_;
    }

    @Override
    public void method5182(Class233 class233) {
	this.aClass233_7986.method2142(class233);
	method5208();
    }

    @Override
    public Class233 method5045() {
	return new Class233(this.aClass233_7986);
    }
    ...
    void method5208() {
	this.aClass233_8000.method2145(this.aClass222_7984);
	this.aClass233_7987.method2142(this.aClass233_8000);
	this.aClass233_7987.method2144(this.aClass233_7986);
	this.aClass233_7987.method2157(this.aFloatArrayArray7988[0]);
	this.aClass233_7987.method2158(this.aFloatArrayArray7988[1]);
	this.aClass233_7987.method2156(this.aFloatArrayArray7988[2]);
	this.aClass233_7987.method2170(this.aFloatArrayArray7988[3]);
	this.aClass233_7987.method2171(this.aFloatArrayArray7988[4]);
	this.aClass233_7987.method2163(this.aFloatArrayArray7988[5]);
	float f = this.aClass233_7986.method2155();
	float f_403_ = ((this.aClass233_7986.aFloatArray2594[10] * (f - 255.0F)) + this.aClass233_7986.aFloatArray2594[14]);
	float f_404_ = (this.aClass233_7986.aFloatArray2594[10] * f + this.aClass233_7986.aFloatArray2594[14]);
	...
	for (int i_410_ = 0; i_410_ < i_408_; i_410_++) {
	    int i_411_ = i + (this.anInt7971 * 692106883 * (i_406_ + i_410_));
	    for (int i_412_ = 0; i_412_ < i_407_; i_412_++)
		is[i_409_++] = this.anIntArray7967[i_412_ + i_411_];
	}
	return is;
    }
	...
	float f = (this.aFloat7993 = (-1840027081 * this.anInt7980 / 2.0F));
	float f_414_ = (this.aFloat7995 = this.anInt7969 * 1936944123 / 2.0F);
	this.aFloat8005 = f + this.anInt7989 * 1767406117;
	this.aFloat7996 = f_414_ + -457799237 * this.anInt7990;
	for (int i_415_ = 0; i_415_ < -922307687 * this.anInt7999; i_415_++) {
	    ...
	    class2.aFloat23 = (this.aFloat8005 - -912871679 * this.anInt7974);
	    class2.aFloat25 = (this.aFloat7996 - -1278653805 * this.anInt7976);
	    class2.anInt22 = i;
	    class2.anInt38 = i_413_;
	}
	int i_416_ = ((-1278653805 * this.anInt7976 * (this.anInt7971 * 692106883)) + -912871679 * this.anInt7974);
	for (int i_417_ = this.anInt7976 * -1278653805; i_417_ < 63686679 * this.anInt7977; i_417_++) {
	    ...
	    i_416_ += 692106883 * this.anInt7971;
	}
    }
	...
	if (this.anIntArray7967 != null) {
		...
		if (0 == i_423_ || i_423_ == 1 && 255 == i_430_) {
			...
			if (i_431_ >= i_427_ && i_431_ < i_428_) {
				...
				this.anIntArray7967[(this.anInt7971 * 692106883 * i_431_) + i] = i_422_;
			}
			i_419_ += i_429_;
		    }
		} else if (1 == i_423_) {
			...
			if (i_435_ >= i_427_ && i_435_ < i_428_) {
				...
				int i_438_ = i + (this.anInt7971 * 692106883 * i_435_);
			...
			if (i_440_ >= i_427_ && i_440_ < i_428_) {
				...
				int i_443_ = i + (i_440_ * (this.anInt7971 * 692106883));
		...
		if (i_423_ == 0 || 1 == i_423_ && i_448_ == 255) {
			...
			if ((i_449_ >= this.anInt7974 * -912871679) && i_449_ < (-1416794725 * this.anInt7991) && i_449_ >= i_451_ && i_449_ < is_426_[i_450_] + i_451_)
			    this.anIntArray7967[(692106883 * this.anInt7971 * i_419_) + i_449_] = i_422_;
			i += i_447_;
		    }
		} else if (i_423_ == 1) {
			...
			if ((i_453_ >= -912871679 * this.anInt7974) && i_453_ < (-1416794725 * this.anInt7991) && i_453_ >= i_455_ && i_453_ < is_426_[i_454_] + i_455_) {
			    int i_456_ = (692106883 * this.anInt7971 * i_419_) + i_453_;
			    int i_457_ = (this.anIntArray7967[i_456_]);
			    i_457_ = (((i_457_ & 0xff00) * i_452_ >> 8 & 0xff00) + (i_452_ * (i_457_ & 0xff00ff) >> 8 & 0xff00ff));
			    this.anIntArray7967[(i_419_ * (692106883 * this.anInt7971) + i_453_)] = i_457_ + i_422_;
			}
			i += i_447_;
		    }
		} else if (i_423_ == 2) {
			...
			if ((i_458_ >= -912871679 * this.anInt7974) && i_458_ < (-1416794725 * this.anInt7991) && i_458_ >= i_460_ && i_458_ < i_460_ + is_426_[i_459_]) {
			    int i_461_ = ((this.anInt7971 * 692106883 * i_419_) + i_458_);
	...
	this.aClass348_7975.method4187();
    }

    @Override
    public Class233 method5036() {
	Class15 class15 = method5202(Thread.currentThread());
	return class15.aClass233_190;
    }
	...
	if (bool || bool_478_) {
		...
		class2.method292(bool, bool_478_, false, i_467_, i_469_, i_472_, i, i_468_, i_471_, f, f_470_, f_473_, i_474_, i_475_, i_476_);
	    } else if (1 == i_477_) {
	...
	float f_482_ = ((this.aClass233_7987.aFloatArray2594[11] * f_481_) + (f * this.aClass233_7987.aFloatArray2594[3] + this.aClass233_7987.aFloatArray2594[15] + f_480_ * (this.aClass233_7987.aFloatArray2594[7])));
	float f_483_ = ((f_481_ * this.aClass233_7987.aFloatArray2594[8]) + (this.aClass233_7987.aFloatArray2594[12] + (this.aClass233_7987.aFloatArray2594[0] * f) + f_480_ * (this.aClass233_7987.aFloatArray2594[4])));
	float f_484_ = ((this.aClass233_7987.aFloatArray2594[5] * f_480_) + (this.aClass233_7987.aFloatArray2594[1] * f + this.aClass233_7987.aFloatArray2594[13]) + (this.aClass233_7987.aFloatArray2594[9] * f_481_));
	float f_485_ = (f * this.aClass233_8000.aFloatArray2594[2] + this.aClass233_8000.aFloatArray2594[14] + (this.aClass233_8000.aFloatArray2594[6] * f_480_) + (this.aClass233_8000.aFloatArray2594[10] * f_481_));
	...
	float f_488_ = ((f_487_ * this.aClass233_7987.aFloatArray2594[10]) + (this.aClass233_7987.aFloatArray2594[2] * f + this.aClass233_7987.aFloatArray2594[14] + (this.aClass233_7987.aFloatArray2594[6] * f_486_)));
	float f_489_ = ((f_487_ * this.aClass233_7987.aFloatArray2594[11]) + (this.aClass233_7987.aFloatArray2594[15] + (this.aClass233_7987.aFloatArray2594[3] * f) + f_486_ * (this.aClass233_7987.aFloatArray2594[7])));
	if (f_488_ < -f_489_ || f_488_ > f_489_) {
	    ...
	    float f_492_ = (this.aClass233_7987.aFloatArray2594[12] + f * (this.aClass233_7987.aFloatArray2594[0]) + f_486_ * (this.aClass233_7987.aFloatArray2594[4]) + f_487_ * (this.aClass233_7987.aFloatArray2594[8]));
		...
		float f_495_ = ((this.aClass233_7987.aFloatArray2594[5]) * f_486_ + ((this.aClass233_7987.aFloatArray2594[13]) + f * (this.aClass233_7987.aFloatArray2594[1])) + (this.aClass233_7987.aFloatArray2594[9]) * f_487_);
		if (f_495_ < -f_489_ || f_495_ > f_489_) {
		    ...
		    float f_498_ = ((this.aClass233_8000.aFloatArray2594[10]) * f_487_ + (f * (this.aClass233_8000.aFloatArray2594[2]) + (this.aClass233_8000.aFloatArray2594[14]) + (this.aClass233_8000.aFloatArray2594[6]) * f_486_));
	...
	boolean bool = null != this.anIntArray7967;
	boolean bool_510_ = this.aFloatArray7973 != null;
	if (bool || bool_510_) {
	    Class15 class15 = method5202(Thread.currentThread());
	    Class2 class2 = class15.aClass2_192;
	    class2.aBoolean16 = false;
	    i -= -912871679 * this.anInt7974;
	    i_500_ -= -912871679 * this.anInt7974;
	    i_503_ -= -912871679 * this.anInt7974;
	    i_499_ -= this.anInt7976 * -1278653805;
	    i_501_ -= this.anInt7976 * -1278653805;
	    i_504_ -= this.anInt7976 * -1278653805;
	    class2.aBoolean20 = (i < 0 || i > class2.anInt22 || i_500_ < 0 || i_500_ > class2.anInt22 || i_503_ < 0 || i_503_ > class2.anInt22);
	    int i_511_ = i_506_ >>> 24;
	    if (0 == i_509_ || i_509_ == 1 && 255 == i_511_) {
		class2.anInt19 = 0;
		class2.aBoolean48 = false;
		class2.method292(bool, bool_510_, false, i_499_, i_501_, i_504_, i, i_500_, i_503_, f, f_502_, f_505_, i_506_, i_507_, i_508_);
	    } else if (1 == i_509_) {
		class2.anInt19 = 255 - i_511_;
		class2.aBoolean48 = false;
		class2.method292(bool, bool_510_, false, i_499_, i_501_, i_504_, i, i_500_, i_503_, f, f_502_, f_505_, i_506_, i_507_, i_508_);
	    } else if (2 == i_509_) {
		class2.anInt19 = 128;
	...
	int i_515_ = i - -1633713343 * this.anInt7968;
	for (Class298_Sub4 class298_sub4 = (Class298_Sub4) this.aClass348_7975.method4190(2090581524); null != class298_sub4; class298_sub4 = (Class298_Sub4) this.aClass348_7975.method4191(-1973419432)) {
	    if (class298_sub4.aBoolean7189) {
		class298_sub4.anInt7188 += i_515_;
		int i_516_ = class298_sub4.anInt7188 / 50;
		if (i_516_ > 0) {
		    Class53 class53 = anInterface_ma5299.method174((class298_sub4.anInt7190), 2122690510);
		    float f = class53.aBoolean518 ? 64.0F : 128.0F;
		    class298_sub4.method2855((int) (i_515_ / 1000.0F * class53.aByte535 / 64.0F * f), (int) (f * (class53.aByte509 * (i_515_ / 1000.0F) / 64.0F)));
		    class298_sub4.anInt7188 -= 50 * i_516_;
		}
		class298_sub4.aBoolean7189 = false;
	    }
	}
	this.anInt7968 = -1260974911 * i;
	this.aClass348_7970.method4186(5, -574753301);
	this.aClass348_7975.method4186(5, -271424616);
    }
	...
	if (-912871679 * this.anInt7974 < i)
	    this.anInt7974 = i * -1291169535;
	if (this.anInt7976 * -1278653805 < i_517_)
	    this.anInt7976 = i_517_ * 104031131;
	if (this.anInt7991 * -1416794725 > i_518_)
	    this.anInt7991 = i_518_ * -1912131437;
	if (63686679 * this.anInt7977 > i_519_)
	    this.anInt7977 = i_519_ * 1656090535;
	method5209();
    }
	...
	if ((i & 0x1) != 0)
	    B(0, 0, 692106883 * this.anInt7971, this.anInt7972 * 918677455, i_520_, 0);
	if ((i & 0x2) != 0)
	    method5198();
    }
	...
	if (null != this.anIntArray7967) {
		...
		if (i_526_ == 0)
		    ...
		    class2.anInt19 = 255 - (i_524_ >>> 24);
		else
		    throw new IllegalArgumentException();
		RA(false);
		class2.aBoolean20 = (i_538_ < 0 || i_538_ > class2.anInt22 || i_539_ < 0 || i_539_ > class2.anInt22 || i_540_ < 0 || i_540_ > class2.anInt22);
		class2.method293(true, false, false, i_542_, i_543_, i_544_, i_538_, i_539_, i_540_, 100.0F, 100.0F, 100.0F, i_524_);
		class2.aBoolean20 = (i_538_ < 0 || i_538_ > class2.anInt22 || i_540_ < 0 || i_540_ > class2.anInt22 || i_541_ < 0 || i_541_ > class2.anInt22);
		class2.method293(true, false, false, i_542_, i_544_, i_545_, i_538_, i_540_, i_541_, 100.0F, 100.0F, 100.0F, i_524_);
		RA(true);
	    }
	}
    }
	...
	if ((i & 0x1) != 0)
	    B(0, 0, 692106883 * this.anInt7971, this.anInt7972 * 918677455, i_550_, 0);
	if ((i & 0x2) != 0)
	    method5198();
    }
	...
	boolean bool = null != this.anIntArray7967;
	boolean bool_562_ = this.aFloatArray7973 != null;
	if (bool || bool_562_) {
	    Class15 class15 = method5202(Thread.currentThread());
	    Class2 class2 = class15.aClass2_192;
	    class2.aBoolean16 = false;
	    i -= -912871679 * this.anInt7974;
	    i_552_ -= -912871679 * this.anInt7974;
	    i_555_ -= -912871679 * this.anInt7974;
	    i_551_ -= this.anInt7976 * -1278653805;
	    i_553_ -= this.anInt7976 * -1278653805;
	    i_556_ -= this.anInt7976 * -1278653805;
	    class2.aBoolean20 = (i < 0 || i > class2.anInt22 || i_552_ < 0 || i_552_ > class2.anInt22 || i_555_ < 0 || i_555_ > class2.anInt22);
	    int i_563_ = i_558_ >>> 24;
	    if (0 == i_561_ || i_561_ == 1 && 255 == i_563_) {
		class2.anInt19 = 0;
		class2.aBoolean48 = false;
		class2.method292(bool, bool_562_, false, i_551_, i_553_, i_556_, i, i_552_, i_555_, f, f_554_, f_557_, i_558_, i_559_, i_560_);
	    } else if (1 == i_561_) {
		class2.anInt19 = 255 - i_563_;
		class2.aBoolean48 = false;
		class2.method292(bool, bool_562_, false, i_551_, i_553_, i_556_, i, i_552_, i_555_, f, f_554_, f_557_, i_558_, i_559_, i_560_);
	    } else if (2 == i_561_) {
		class2.anInt19 = 128;
	...
	float f_566_ = ((this.aClass233_7987.aFloatArray2594[11] * f_565_) + (f * this.aClass233_7987.aFloatArray2594[3] + this.aClass233_7987.aFloatArray2594[15] + f_564_ * (this.aClass233_7987.aFloatArray2594[7])));
	float f_567_ = ((f_565_ * this.aClass233_7987.aFloatArray2594[8]) + (this.aClass233_7987.aFloatArray2594[12] + (this.aClass233_7987.aFloatArray2594[0] * f) + f_564_ * (this.aClass233_7987.aFloatArray2594[4])));
	float f_568_ = ((this.aClass233_7987.aFloatArray2594[5] * f_564_) + (this.aClass233_7987.aFloatArray2594[1] * f + this.aClass233_7987.aFloatArray2594[13]) + (this.aClass233_7987.aFloatArray2594[9] * f_565_));
	float f_569_ = (f * this.aClass233_8000.aFloatArray2594[2] + this.aClass233_8000.aFloatArray2594[14] + (this.aClass233_8000.aFloatArray2594[6] * f_564_) + (this.aClass233_8000.aFloatArray2594[10] * f_565_));
	fs[0] = (f_567_ * this.aFloat7993 / f_566_ + this.aFloat8005);
	fs[1] = (this.aFloat7996 + this.aFloat7995 * f_568_ / f_566_);
	fs[2] = f_569_;
    }
	...
	for (int i_582_ = 0; i_582_ < i_580_; i_582_++) {
	    int i_583_ = i + (this.anInt7971 * 692106883 * (i_578_ + i_582_));
	...
	for (int i_589_ = 0; i_589_ < i_587_; i_589_++) {
	    int i_590_ = i + (this.anInt7971 * 692106883 * (i_585_ + i_589_));
	    for (int i_591_ = 0; i_591_ < i_586_; i_591_++)
		is[i_588_++] = this.anIntArray7967[i_591_ + i_590_];
	}
	return is;
    }
	...
	this.aFloat7997 = f_592_ - f;
	this.aFloat8004 = f_592_ + f - 1.0F;
	for (int i = 0; i < this.anInt7999 * -922307687; i++) {
	    Class15 class15 = this.aClass15Array8001[i];
	    Class2 class2 = class15.aClass2_192;
	    class2.aFloat46 = this.aFloat7997;
	...
	if (null != this.anIntArray7967) {
	    Class_ta_Sub2 class_ta_sub2 = (Class_ta_Sub2) class_ta;
	    int[] is = class_ta_sub2.anIntArray8443;
	    int[] is_599_ = class_ta_sub2.anIntArray8442;
	    int i_600_;
	    if (63686679 * this.anInt7977 < is.length + i_598_)
		i_600_ = this.anInt7977 * 63686679 - i_598_;
	    else
		i_600_ = is.length;
	    int i_601_;
	    if (this.anInt7976 * -1278653805 > i_598_) {
		i_601_ = this.anInt7976 * -1278653805 - i_598_;
		i_598_ = this.anInt7976 * -1278653805;
	    } else
		i_601_ = 0;
	    if (i_600_ - i_601_ > 0) {
		int i_602_ = 692106883 * this.anInt7971 * i_598_;
		for (int i_603_ = i_601_; i_603_ < i_600_; i_603_++) {
		    int i_604_ = i_597_ + is[i_603_];
		    int i_605_ = is_599_[i_603_];
		    if (this.anInt7974 * -912871679 > i_604_) {
			i_605_ -= (-912871679 * this.anInt7974 - i_604_);
			i_604_ = -912871679 * this.anInt7974;
		    }
		    if (-1416794725 * this.anInt7991 < i_604_ + i_605_)
			i_605_ = (-1416794725 * this.anInt7991 - i_604_);
		    i_604_ += i_602_;
		    for (int i_606_ = -i_605_; i_606_ < 0; i_606_++)
			this.anIntArray7967[i_604_++] = i;
		    i_602_ += this.anInt7971 * 692106883;
		}
	    }
	}
    }
	...
	this.aFloat7997 = f_607_ - f;
	this.aFloat8004 = f_607_ + f - 1.0F;
	for (int i = 0; i < this.anInt7999 * -922307687; i++) {
	    Class15 class15 = this.aClass15Array8001[i];
	    Class2 class2 = class15.aClass2_192;
	    class2.aFloat46 = this.aFloat7997;
	...
	if (this.anIntArray7967 != null && (i_609_ > 0 && i_610_ > 0)) {
	    int i_615_ = 0;
	    int i_616_ = 0;
	    int i_617_ = (i_613_ << 16) / i_609_;
	    int i_618_ = (is.length / i_613_ << 16) / i_610_;
	    int i_619_ = i + i_608_ * (692106883 * this.anInt7971);
	    int i_620_ = 692106883 * this.anInt7971 - i_609_;
	    if (i_610_ + i_608_ > this.anInt7977 * 63686679)
		i_610_ -= (i_608_ + i_610_ - 63686679 * this.anInt7977);
	    if (i_608_ < this.anInt7976 * -1278653805) {
		int i_621_ = -1278653805 * this.anInt7976 - i_608_;
		i_610_ -= i_621_;
		i_619_ += i_621_ * (this.anInt7971 * 692106883);
		i_616_ += i_621_ * i_618_;
	    }
	    if (i + i_609_ > -1416794725 * this.anInt7991) {
		int i_622_ = (i + i_609_ - this.anInt7991 * -1416794725);
		i_609_ -= i_622_;
		i_620_ += i_622_;
	    }
	    if (i < this.anInt7974 * -912871679) {
		int i_623_ = -912871679 * this.anInt7974 - i;
		i_609_ -= i_623_;
		i_619_ += i_623_;
		...
		for (int i_627_ = -i_610_; i_627_ < 0; i_627_++) {
			...
			if (is[(i_615_ >> 16) + i_628_] != 0)
			    this.anIntArray7967[i_619_++] = i_612_;
			else
			    this.anIntArray7967[i_619_++] = i_611_;
			i_615_ += i_617_;
		    }
		    i_616_ += i_618_;
		    i_615_ = i_626_;
		...
		for (int i_631_ = -i_610_; i_631_ < 0; i_631_++) {
			...
			int i_637_ = this.anIntArray7967[i_619_];
			this.anIntArray7967[i_619_++] = (((i_635_ * (i_634_ & 0xff00) + (i_637_ & 0xff00) * i_636_) & 0xff0000) + (((i_637_ & 0xff00ff) * i_636_ + (i_634_ & 0xff00ff) * i_635_) & ~0xff00ff)) >> 8;
			i_615_ += i_617_;
		    }
		    i_616_ += i_618_;
		    i_615_ = i_630_;
	...
	float f_648_ = ((f_647_ * this.aClass233_7987.aFloatArray2594[10]) + (this.aClass233_7987.aFloatArray2594[2] * f + this.aClass233_7987.aFloatArray2594[14] + (this.aClass233_7987.aFloatArray2594[6] * f_646_)));
	float f_649_ = ((f_647_ * this.aClass233_7987.aFloatArray2594[11]) + (this.aClass233_7987.aFloatArray2594[15] + (this.aClass233_7987.aFloatArray2594[3] * f) + f_646_ * (this.aClass233_7987.aFloatArray2594[7])));
	if (f_648_ < -f_649_ || f_648_ > f_649_) {
	    ...
	    float f_652_ = (this.aClass233_7987.aFloatArray2594[12] + f * (this.aClass233_7987.aFloatArray2594[0]) + f_646_ * (this.aClass233_7987.aFloatArray2594[4]) + f_647_ * (this.aClass233_7987.aFloatArray2594[8]));
		...
		float f_655_ = ((this.aClass233_7987.aFloatArray2594[5]) * f_646_ + ((this.aClass233_7987.aFloatArray2594[13]) + f * (this.aClass233_7987.aFloatArray2594[1])) + (this.aClass233_7987.aFloatArray2594[9]) * f_647_);
		if (f_655_ < -f_649_ || f_655_ > f_649_) {
		    ...
		    float f_658_ = ((this.aClass233_8000.aFloatArray2594[10]) * f_647_ + (f * (this.aClass233_8000.aFloatArray2594[2]) + (this.aClass233_8000.aFloatArray2594[14]) + (this.aClass233_8000.aFloatArray2594[6]) * f_646_));
		    fs[0] = (this.aFloat8005 + (f_652_ * this.aFloat7993 / f_649_));
		    fs[1] = (this.aFloat7995 * f_655_ / f_649_ + this.aFloat7996);
		    fs[2] = f_658_;
		}
	    }
	}
	...
	if (i_659_ < 0)
	    i_659_ = 0;
	if (i_660_ > 692106883 * this.anInt7971)
	    i_660_ = 692106883 * this.anInt7971;
	if (i_661_ > this.anInt7972 * 918677455)
	    i_661_ = 918677455 * this.anInt7972;
	this.anInt7974 = i * -1291169535;
	this.anInt7991 = i_660_ * -1912131437;
	this.anInt7976 = i_659_ * 104031131;
	this.anInt7977 = 1656090535 * i_661_;
	method5209();
    }
	...
	if (i_662_ < 0)
	    i_662_ = 0;
	if (i_663_ > 692106883 * this.anInt7971)
	    i_663_ = 692106883 * this.anInt7971;
	if (i_664_ > this.anInt7972 * 918677455)
	    i_664_ = 918677455 * this.anInt7972;
	this.anInt7974 = i * -1291169535;
	this.anInt7991 = i_663_ * -1912131437;
	this.anInt7976 = i_662_ * 104031131;
	this.anInt7977 = 1656090535 * i_664_;
	method5209();
    }
	...
	if ((i & 0x1) != 0)
	    B(0, 0, 692106883 * this.anInt7971, this.anInt7972 * 918677455, i_671_, 0);
	if ((i & 0x2) != 0)
	    method5198();
    }
	...
	if ((i & 0x1) != 0)
	    B(0, 0, 692106883 * this.anInt7971, this.anInt7972 * 918677455, i_672_, 0);
	if ((i & 0x2) != 0)
	    method5198();
    }
	...
	if (null != this.anIntArray7967) {
	    if (i < this.anInt7974 * -912871679) {
		i_677_ -= -912871679 * this.anInt7974 - i;
		i = this.anInt7974 * -912871679;
	    }
	    if (i_676_ < -1278653805 * this.anInt7976) {
		i_678_ -= -1278653805 * this.anInt7976 - i_676_;
		i_676_ = -1278653805 * this.anInt7976;
	    }
	    if (i + i_677_ > this.anInt7991 * -1416794725)
		i_677_ = -1416794725 * this.anInt7991 - i;
	    if (i_678_ + i_676_ > 63686679 * this.anInt7977)
		i_678_ = 63686679 * this.anInt7977 - i_676_;
	    if (i_677_ > 0 && i_678_ > 0 && i <= this.anInt7991 * -1416794725 && i_676_ <= this.anInt7977 * 63686679) {
		int i_681_ = this.anInt7971 * 692106883 - i_677_;
		int i_682_ = (i_676_ * (this.anInt7971 * 692106883) + i);
		...
		if (0 == i_680_ || i_680_ == 1 && 255 == i_683_) {
			...
			if (i_684_ > 0) {
			    i = i_684_;
			    do {
				this.anIntArray7967[++i_677_] = i_679_;
				this.anIntArray7967[++i_677_] = i_679_;
				this.anIntArray7967[++i_677_] = i_679_;
				this.anIntArray7967[++i_677_] = i_679_;
				this.anIntArray7967[++i_677_] = i_679_;
			...
			for (int i_689_ = -i_677_; i_689_ < 0; i_689_++) {
			    int i_690_ = (this.anIntArray7967[i_682_]);
			    i_690_ = (((i_690_ & 0xff00ff) * i_687_ >> 8 & 0xff00ff) + (i_687_ * ((i_690_ & ~0xff00ff) >>> 8) & ~0xff00ff));
			    this.anIntArray7967[i_682_++] = i_690_ + i_679_;
			}
			i_682_ += i_681_;
		    }
		} else if (i_680_ == 2) {
	...
	if (this.anIntArray7967 != null && (i_697_ > 0 && i_698_ > 0)) {
	    int i_703_ = 0;
	    int i_704_ = 0;
	    int i_705_ = (i_701_ << 16) / i_697_;
	    int i_706_ = (is.length / i_701_ << 16) / i_698_;
	    int i_707_ = i + i_696_ * (692106883 * this.anInt7971);
	    int i_708_ = 692106883 * this.anInt7971 - i_697_;
	    if (i_698_ + i_696_ > this.anInt7977 * 63686679)
		i_698_ -= (i_696_ + i_698_ - 63686679 * this.anInt7977);
	    if (i_696_ < this.anInt7976 * -1278653805) {
		int i_709_ = -1278653805 * this.anInt7976 - i_696_;
		i_698_ -= i_709_;
		i_707_ += i_709_ * (this.anInt7971 * 692106883);
		i_704_ += i_709_ * i_706_;
	    }
	    if (i + i_697_ > -1416794725 * this.anInt7991) {
		int i_710_ = (i + i_697_ - this.anInt7991 * -1416794725);
		i_697_ -= i_710_;
		i_708_ += i_710_;
	    }
	    if (i < this.anInt7974 * -912871679) {
		int i_711_ = -912871679 * this.anInt7974 - i;
		i_697_ -= i_711_;
		i_707_ += i_711_;
		...
		for (int i_715_ = -i_698_; i_715_ < 0; i_715_++) {
			...
			if (is[(i_703_ >> 16) + i_716_] != 0)
			    this.anIntArray7967[i_707_++] = i_700_;
			else
			    this.anIntArray7967[i_707_++] = i_699_;
			i_703_ += i_705_;
		    }
		    i_704_ += i_706_;
		    i_703_ = i_714_;
		...
		for (int i_719_ = -i_698_; i_719_ < 0; i_719_++) {
			...
			int i_725_ = this.anIntArray7967[i_707_];
			this.anIntArray7967[i_707_++] = (((i_723_ * (i_722_ & 0xff00) + (i_725_ & 0xff00) * i_724_) & 0xff0000) + (((i_725_ & 0xff00ff) * i_724_ + (i_722_ & 0xff00ff) * i_723_) & ~0xff00ff)) >> 8;
			i_703_ += i_705_;
		    }
		    i_704_ += i_706_;
		    i_703_ = i_718_;
	...
	if (this.anIntArray7967 != null) {
	    ...
	    if (i_739_ < -1278653805 * this.anInt7976)
		i_739_ = this.anInt7976 * -1278653805;
	    int i_740_ = i_736_ + i_735_ + 1;
	    if (i_740_ > this.anInt7977 * 63686679)
		i_740_ = 63686679 * this.anInt7977;
	    int i_741_ = i_739_;
		...
		while (i_741_ < i_735_) {
		    ...
		    if (i_748_ < this.anInt7974 * -912871679)
			i_748_ = -912871679 * this.anInt7974;
		    int i_749_ = i_743_ + i;
		    if (i_749_ > this.anInt7991 * -1416794725)
			i_749_ = this.anInt7991 * -1416794725;
		    int i_750_ = i_748_ + (this.anInt7971 * 692106883 * i_741_);
		    for (int i_751_ = i_748_; i_751_ < i_749_; i_751_++)
			this.anIntArray7967[i_750_++] = i_737_;
		    i_741_++;
		...
		while (i_741_ < i_740_) {
		    ...
		    int i_752_ = i - i_743_;
		    if (i_752_ < this.anInt7974 * -912871679)
			i_752_ = this.anInt7974 * -912871679;
		    int i_753_ = i + i_743_;
		    if (i_753_ > -1416794725 * this.anInt7991 - 1)
			i_753_ = (-1416794725 * this.anInt7991 - 1);
		    int i_754_ = (i_741_ * (692106883 * this.anInt7971) + i_752_);
		    for (int i_755_ = i_752_; i_755_ <= i_753_; i_755_++)
			this.anIntArray7967[i_754_++] = i_737_;
		    i_741_++;
		    i_746_ += i_744_ + i_744_;
		    i_745_ += i_744_++ + i_744_;
		}
		...
		while (i_741_ < i_735_) {
		    ...
		    if (i_757_ < -912871679 * this.anInt7974)
			i_757_ = this.anInt7974 * -912871679;
		    int i_758_ = i + i_743_;
		    if (i_758_ > -1416794725 * this.anInt7991)
			i_758_ = this.anInt7991 * -1416794725;
		    int i_759_ = ((this.anInt7971 * 692106883 * i_741_) + i_757_);
		    for (int i_760_ = i_757_; i_760_ < i_758_; i_760_++) {
			int i_761_ = this.anIntArray7967[i_759_];
			i_761_ = (((i_761_ & 0xff00ff) * i_756_ >> 8 & 0xff00ff) + (i_756_ * (i_761_ & 0xff00) >> 8 & 0xff00));
			this.anIntArray7967[i_759_++] = i_737_ + i_761_;
		    }
		    i_741_++;
		    i_745_ -= i_744_-- + i_744_;
		    i_746_ -= i_744_ + i_744_;
		...
		while (i_741_ < i_740_) {
			...
			i_746_ -= i_743_-- + i_743_;
		    int i_762_ = i - i_743_;
		    if (i_762_ < this.anInt7974 * -912871679)
			i_762_ = this.anInt7974 * -912871679;
		    int i_763_ = i + i_743_;
		    if (i_763_ > this.anInt7991 * -1416794725 - 1)
			i_763_ = (-1416794725 * this.anInt7991 - 1);
		    int i_764_ = ((692106883 * this.anInt7971 * i_741_) + i_762_);
		    for (int i_765_ = i_762_; i_765_ <= i_763_; i_765_++) {
			int i_766_ = this.anIntArray7967[i_764_];
			i_766_ = (((i_766_ & 0xff00ff) * i_756_ >> 8 & 0xff00ff) + (i_756_ * (i_766_ & 0xff00) >> 8 & 0xff00));
			this.anIntArray7967[i_764_++] = i_737_ + i_766_;
		    }
		    i_741_++;
		    i_746_ += i_744_ + i_744_;
		    i_745_ += i_744_++ + i_744_;
		...
		while (i_741_ < i_735_) {
		    ...
		    if (i_767_ < -912871679 * this.anInt7974)
			i_767_ = this.anInt7974 * -912871679;
		    int i_768_ = i + i_743_;
		    if (i_768_ > -1416794725 * this.anInt7991)
			i_768_ = this.anInt7991 * -1416794725;
		    int i_769_ = ((this.anInt7971 * 692106883 * i_741_) + i_767_);
		    for (int i_770_ = i_767_; i_770_ < i_768_; i_770_++) {
			int i_771_ = this.anIntArray7967[i_769_];
			int i_772_ = i_737_ + i_771_;
			int i_773_ = (i_737_ & 0xff00ff) + (i_771_ & 0xff00ff);
			i_771_ = (i_773_ & 0x1000100) + (i_772_ - i_773_ & 0x10000);
			this.anIntArray7967[i_769_++] = i_772_ - i_771_ | i_771_ - (i_771_ >>> 8);
		    }
		    i_741_++;
		    i_745_ -= i_744_-- + i_744_;
		    i_746_ -= i_744_ + i_744_;
		...
		while (i_741_ < i_740_) {
			...
			i_746_ -= i_743_-- + i_743_;
		    int i_774_ = i - i_743_;
		    if (i_774_ < this.anInt7974 * -912871679)
			i_774_ = -912871679 * this.anInt7974;
		    int i_775_ = i + i_743_;
		    if (i_775_ > this.anInt7991 * -1416794725 - 1)
			i_775_ = (this.anInt7991 * -1416794725 - 1);
		    int i_776_ = i_774_ + i_741_ * (this.anInt7971 * 692106883);
		    for (int i_777_ = i_774_; i_777_ <= i_775_; i_777_++) {
			int i_778_ = this.anIntArray7967[i_776_];
			int i_779_ = i_778_ + i_737_;
			int i_780_ = (i_778_ & 0xff00ff) + (i_737_ & 0xff00ff);
			i_778_ = (i_779_ - i_780_ & 0x10000) + (i_780_ & 0x1000100);
			this.anIntArray7967[i_776_++] = i_779_ - i_778_ | i_778_ - (i_778_ >>> 8);
		    }
		    i_741_++;
		    i_746_ += i_744_ + i_744_;
		    i_745_ += i_744_++ + i_744_;
	...
	if (this.anIntArray7967 != null) {
	    ...
	    if (i_785_ < -1278653805 * this.anInt7976)
		i_785_ = this.anInt7976 * -1278653805;
	    int i_786_ = i_782_ + i_781_ + 1;
	    if (i_786_ > this.anInt7977 * 63686679)
		i_786_ = 63686679 * this.anInt7977;
	    int i_787_ = i_785_;
		...
		while (i_787_ < i_781_) {
		    ...
		    if (i_794_ < this.anInt7974 * -912871679)
			i_794_ = -912871679 * this.anInt7974;
		    int i_795_ = i_789_ + i;
		    if (i_795_ > this.anInt7991 * -1416794725)
			i_795_ = this.anInt7991 * -1416794725;
		    int i_796_ = i_794_ + (this.anInt7971 * 692106883 * i_787_);
		    for (int i_797_ = i_794_; i_797_ < i_795_; i_797_++)
			this.anIntArray7967[i_796_++] = i_783_;
		    i_787_++;
		...
		while (i_787_ < i_786_) {
		    ...
		    int i_798_ = i - i_789_;
		    if (i_798_ < this.anInt7974 * -912871679)
			i_798_ = this.anInt7974 * -912871679;
		    int i_799_ = i + i_789_;
		    if (i_799_ > -1416794725 * this.anInt7991 - 1)
			i_799_ = (-1416794725 * this.anInt7991 - 1);
		    int i_800_ = (i_787_ * (692106883 * this.anInt7971) + i_798_);
		    for (int i_801_ = i_798_; i_801_ <= i_799_; i_801_++)
			this.anIntArray7967[i_800_++] = i_783_;
		    i_787_++;
		    i_792_ += i_790_ + i_790_;
		    i_791_ += i_790_++ + i_790_;
		}
		...
		while (i_787_ < i_781_) {
		    ...
		    if (i_803_ < -912871679 * this.anInt7974)
			i_803_ = this.anInt7974 * -912871679;
		    int i_804_ = i + i_789_;
		    if (i_804_ > -1416794725 * this.anInt7991)
			i_804_ = this.anInt7991 * -1416794725;
		    int i_805_ = ((this.anInt7971 * 692106883 * i_787_) + i_803_);
		    for (int i_806_ = i_803_; i_806_ < i_804_; i_806_++) {
			int i_807_ = this.anIntArray7967[i_805_];
			i_807_ = (((i_807_ & 0xff00ff) * i_802_ >> 8 & 0xff00ff) + (i_802_ * (i_807_ & 0xff00) >> 8 & 0xff00));
			this.anIntArray7967[i_805_++] = i_783_ + i_807_;
		    }
		    i_787_++;
		    i_791_ -= i_790_-- + i_790_;
		    i_792_ -= i_790_ + i_790_;
		...
		while (i_787_ < i_786_) {
			...
			i_792_ -= i_789_-- + i_789_;
		    int i_808_ = i - i_789_;
		    if (i_808_ < this.anInt7974 * -912871679)
			i_808_ = this.anInt7974 * -912871679;
		    int i_809_ = i + i_789_;
		    if (i_809_ > this.anInt7991 * -1416794725 - 1)
			i_809_ = (-1416794725 * this.anInt7991 - 1);
		    int i_810_ = ((692106883 * this.anInt7971 * i_787_) + i_808_);
		    for (int i_811_ = i_808_; i_811_ <= i_809_; i_811_++) {
			int i_812_ = this.anIntArray7967[i_810_];
			i_812_ = (((i_812_ & 0xff00ff) * i_802_ >> 8 & 0xff00ff) + (i_802_ * (i_812_ & 0xff00) >> 8 & 0xff00));
			this.anIntArray7967[i_810_++] = i_783_ + i_812_;
		    }
		    i_787_++;
		    i_792_ += i_790_ + i_790_;
		    i_791_ += i_790_++ + i_790_;
		...
		while (i_787_ < i_781_) {
		    ...
		    if (i_813_ < -912871679 * this.anInt7974)
			i_813_ = this.anInt7974 * -912871679;
		    int i_814_ = i + i_789_;
		    if (i_814_ > -1416794725 * this.anInt7991)
			i_814_ = this.anInt7991 * -1416794725;
		    int i_815_ = ((this.anInt7971 * 692106883 * i_787_) + i_813_);
		    for (int i_816_ = i_813_; i_816_ < i_814_; i_816_++) {
			int i_817_ = this.anIntArray7967[i_815_];
			int i_818_ = i_783_ + i_817_;
			int i_819_ = (i_783_ & 0xff00ff) + (i_817_ & 0xff00ff);
			i_817_ = (i_819_ & 0x1000100) + (i_818_ - i_819_ & 0x10000);
			this.anIntArray7967[i_815_++] = i_818_ - i_817_ | i_817_ - (i_817_ >>> 8);
		    }
		    i_787_++;
		    i_791_ -= i_790_-- + i_790_;
		    i_792_ -= i_790_ + i_790_;
		...
		while (i_787_ < i_786_) {
			...
			i_792_ -= i_789_-- + i_789_;
		    int i_820_ = i - i_789_;
		    if (i_820_ < this.anInt7974 * -912871679)
			i_820_ = -912871679 * this.anInt7974;
		    int i_821_ = i + i_789_;
		    if (i_821_ > this.anInt7991 * -1416794725 - 1)
			i_821_ = (this.anInt7991 * -1416794725 - 1);
		    int i_822_ = i_820_ + i_787_ * (this.anInt7971 * 692106883);
		    for (int i_823_ = i_820_; i_823_ <= i_821_; i_823_++) {
			int i_824_ = this.anIntArray7967[i_822_];
			int i_825_ = i_824_ + i_783_;
			int i_826_ = (i_824_ & 0xff00ff) + (i_783_ & 0xff00ff);
			i_824_ = (i_825_ - i_826_ & 0x10000) + (i_826_ & 0x1000100);
			this.anIntArray7967[i_822_++] = i_825_ - i_824_ | i_824_ - (i_824_ >>> 8);
		    }
		    i_787_++;
		    i_792_ += i_790_ + i_790_;
		    i_791_ += i_790_++ + i_790_;
	...
	if (null != this.anIntArray7967 && (i_827_ >= -1278653805 * this.anInt7976 && i_827_ < 63686679 * this.anInt7977)) {
	    if (i < -912871679 * this.anInt7974) {
		i_828_ -= -912871679 * this.anInt7974 - i;
		i = this.anInt7974 * -912871679;
	    }
	    if (i + i_828_ > -1416794725 * this.anInt7991)
		i_828_ = -1416794725 * this.anInt7991 - i;
	    int i_831_ = i + 692106883 * this.anInt7971 * i_827_;
	    int i_832_ = i_829_ >>> 24;
	    if (i_830_ == 0 || i_830_ == 1 && i_832_ == 255) {
		for (int i_833_ = 0; i_833_ < i_828_; i_833_++)
		    this.anIntArray7967[i_831_ + i_833_] = i_829_;
	    } else if (i_830_ == 1) {
	...
	if (null != this.anIntArray7967 && (i_841_ >= -1278653805 * this.anInt7976 && i_841_ < 63686679 * this.anInt7977)) {
	    if (i < -912871679 * this.anInt7974) {
		i_842_ -= -912871679 * this.anInt7974 - i;
		i = this.anInt7974 * -912871679;
	    }
	    if (i + i_842_ > -1416794725 * this.anInt7991)
		i_842_ = -1416794725 * this.anInt7991 - i;
	    int i_845_ = i + 692106883 * this.anInt7971 * i_841_;
	    int i_846_ = i_843_ >>> 24;
	    if (i_844_ == 0 || i_844_ == 1 && i_846_ == 255) {
		for (int i_847_ = 0; i_847_ < i_842_; i_847_++)
		    this.anIntArray7967[i_845_ + i_847_] = i_843_;
	    } else if (i_844_ == 1) {
	...
	if (null != this.anIntArray7967 && (i >= this.anInt7974 * -912871679 && i < this.anInt7991 * -1416794725)) {
	    if (i_855_ < -1278653805 * this.anInt7976) {
		i_856_ -= this.anInt7976 * -1278653805 - i_855_;
		i_855_ = this.anInt7976 * -1278653805;
	    }
	    if (i_856_ + i_855_ > 63686679 * this.anInt7977)
		i_856_ = 63686679 * this.anInt7977 - i_855_;
	    int i_859_ = i + i_855_ * (this.anInt7971 * 692106883);
	    int i_860_ = i_857_ >>> 24;
	    if (i_858_ == 0 || 1 == i_858_ && 255 == i_860_) {
		for (int i_861_ = 0; i_861_ < i_856_; i_861_++)
		    this.anIntArray7967[i_859_ + i_861_ * (this.anInt7971 * 692106883)] = i_857_;
	    } else if (i_858_ == 1) {
		...
		for (int i_863_ = 0; i_863_ < i_856_; i_863_++) {
		    int i_864_ = (i_863_ * (692106883 * this.anInt7971) + i_859_);
		    int i_865_ = this.anIntArray7967[i_864_];
		    i_865_ = ((i_862_ * (i_865_ & 0xff00ff) >> 8 & 0xff00ff) + ((i_865_ & 0xff00) * i_862_ >> 8 & 0xff00));
		    this.anIntArray7967[i_864_] = i_865_ + i_857_;
		}
	    } else if (2 == i_858_) {
		for (int i_866_ = 0; i_866_ < i_856_; i_866_++) {
		    int i_867_ = (i_866_ * (692106883 * this.anInt7971) + i_859_);
		    int i_868_ = this.anIntArray7967[i_867_];
		    int i_869_ = i_857_ + i_868_;
		    int i_870_ = (i_868_ & 0xff00ff) + (i_857_ & 0xff00ff);
		    i_868_ = (i_870_ & 0x1000100) + (i_869_ - i_870_ & 0x10000);
		    this.anIntArray7967[i_867_] = i_869_ - i_868_ | i_868_ - (i_868_ >>> 8);
		}
	    } else
		throw new IllegalArgumentException();
	}
	...
	if (-912871679 * this.anInt7974 < i)
	    this.anInt7974 = i * -1291169535;
	if (this.anInt7976 * -1278653805 < i_871_)
	    this.anInt7976 = i_871_ * 104031131;
	if (this.anInt7991 * -1416794725 > i_872_)
	    this.anInt7991 = i_872_ * -1912131437;
	if (63686679 * this.anInt7977 > i_873_)
	    this.anInt7977 = i_873_ * 1656090535;
	method5209();
    }
	...
	if (null != this.anIntArray7967 && (i >= this.anInt7974 * -912871679 && i < this.anInt7991 * -1416794725)) {
	    if (i_874_ < -1278653805 * this.anInt7976) {
		i_875_ -= this.anInt7976 * -1278653805 - i_874_;
		i_874_ = this.anInt7976 * -1278653805;
	    }
	    if (i_875_ + i_874_ > 63686679 * this.anInt7977)
		i_875_ = 63686679 * this.anInt7977 - i_874_;
	    int i_878_ = i + i_874_ * (this.anInt7971 * 692106883);
	    int i_879_ = i_876_ >>> 24;
	    if (i_877_ == 0 || 1 == i_877_ && 255 == i_879_) {
		for (int i_880_ = 0; i_880_ < i_875_; i_880_++)
		    this.anIntArray7967[i_878_ + i_880_ * (this.anInt7971 * 692106883)] = i_876_;
	    } else if (i_877_ == 1) {
		...
		for (int i_882_ = 0; i_882_ < i_875_; i_882_++) {
		    int i_883_ = (i_882_ * (692106883 * this.anInt7971) + i_878_);
		    int i_884_ = this.anIntArray7967[i_883_];
		    i_884_ = ((i_881_ * (i_884_ & 0xff00ff) >> 8 & 0xff00ff) + ((i_884_ & 0xff00) * i_881_ >> 8 & 0xff00));
		    this.anIntArray7967[i_883_] = i_884_ + i_876_;
		}
	    } else if (2 == i_877_) {
		for (int i_885_ = 0; i_885_ < i_875_; i_885_++) {
		    int i_886_ = (i_885_ * (692106883 * this.anInt7971) + i_878_);
		    int i_887_ = this.anIntArray7967[i_886_];
		    int i_888_ = i_876_ + i_887_;
		    int i_889_ = (i_887_ & 0xff00ff) + (i_876_ & 0xff00ff);
		    i_887_ = (i_889_ & 0x1000100) + (i_888_ - i_889_ & 0x10000);
		    this.anIntArray7967[i_886_] = i_888_ - i_887_ | i_887_ - (i_887_ >>> 8);
		}
	    } else
		throw new IllegalArgumentException();
	}
	...
	if (this.anIntArray7967 != null) {
	    Class_ta_Sub2 class_ta_sub2 = (Class_ta_Sub2) class_ta;
	    int[] is = class_ta_sub2.anIntArray8443;
	    int[] is_897_ = class_ta_sub2.anIntArray8442;
	    int i_898_ = (this.anInt7976 * -1278653805 > i_896_ ? this.anInt7976 * -1278653805 : i_896_);
	    int i_899_ = ((63686679 * this.anInt7977 < i_896_ + is.length) ? 63686679 * this.anInt7977 : i_896_ + is.length);
	    i_891_ -= i;
	    i_892_ -= i_890_;
	    if (i_891_ + i_892_ < 0) {
		i += i_891_;
		...
		i_891_ += i;
		if (i < this.anInt7974 * -912871679) {
		    i_890_ += (-912871679 * this.anInt7974 - i) * i_900_;
		    i = -912871679 * this.anInt7974;
		}
		if (i_891_ >= -1416794725 * this.anInt7991)
		    i_891_ = -1416794725 * this.anInt7991 - 1;
		...
		if (0 == i_894_ || i_894_ == 1 && 255 == i_901_) {
			...
			if (i_902_ >= i_898_ && i_902_ < i_899_) {
				...
				this.anIntArray7967[(this.anInt7971 * 692106883 * i_902_) + i] = i_893_;
			}
			i_890_ += i_900_;
		    }
		} else if (1 == i_894_) {
			...
			if (i_906_ >= i_898_ && i_906_ < i_899_) {
				...
				int i_909_ = i + (this.anInt7971 * 692106883 * i_906_);
				int i_910_ = (this.anIntArray7967[i_909_]);
				i_910_ = (((i_910_ & 0xff00) * i_905_ >> 8 & 0xff00) + (i_905_ * (i_910_ & 0xff00ff) >> 8 & 0xff00ff));
				this.anIntArray7967[i_909_] = i_910_ + i_893_;
			    }
			}
			i_890_ += i_900_;
		    }
			...
			if (i_911_ >= i_898_ && i_911_ < i_899_) {
				...
				int i_914_ = i + (i_911_ * (this.anInt7971 * 692106883));
				int i_915_ = (this.anIntArray7967[i_914_]);
				int i_916_ = i_893_ + i_915_;
				int i_917_ = ((i_893_ & 0xff00ff) + (i_915_ & 0xff00ff));
				i_915_ = (i_917_ & 0x1000100) + (i_916_ - i_917_ & 0x10000);
				this.anIntArray7967[i_914_] = i_916_ - i_915_ | i_915_ - (i_915_ >>> 8);
			    }
			}
			i_890_ += i_900_;
		    }
		...
		if (i_894_ == 0 || 1 == i_894_ && i_919_ == 255) {
			...
			if ((i_920_ >= this.anInt7974 * -912871679) && i_920_ < (-1416794725 * this.anInt7991) && i_920_ >= i_922_ && i_920_ < is_897_[i_921_] + i_922_)
			    this.anIntArray7967[(692106883 * this.anInt7971 * i_890_) + i_920_] = i_893_;
			i += i_918_;
		    }
		} else if (i_894_ == 1) {
			...
			if ((i_924_ >= -912871679 * this.anInt7974) && i_924_ < (-1416794725 * this.anInt7991) && i_924_ >= i_926_ && i_924_ < is_897_[i_925_] + i_926_) {
			    int i_927_ = (692106883 * this.anInt7971 * i_890_) + i_924_;
			    int i_928_ = (this.anIntArray7967[i_927_]);
			    i_928_ = (((i_928_ & 0xff00) * i_923_ >> 8 & 0xff00) + (i_923_ * (i_928_ & 0xff00ff) >> 8 & 0xff00ff));
			    this.anIntArray7967[(i_890_ * (692106883 * this.anInt7971) + i_924_)] = i_928_ + i_893_;
			}
			i += i_918_;
		    }
		} else if (i_894_ == 2) {
			...
			if ((i_929_ >= -912871679 * this.anInt7974) && i_929_ < (-1416794725 * this.anInt7991) && i_929_ >= i_931_ && i_929_ < i_931_ + is_897_[i_930_]) {
			    int i_932_ = ((this.anInt7971 * 692106883 * i_890_) + i_929_);
			    int i_933_ = (this.anIntArray7967[i_932_]);
			    int i_934_ = i_933_ + i_893_;
			    int i_935_ = (i_893_ & 0xff00ff) + (i_933_ & 0xff00ff);
			    i_933_ = (i_934_ - i_935_ & 0x10000) + (i_935_ & 0x1000100);
			    this.anIntArray7967[i_932_] = i_934_ - i_933_ | i_933_ - (i_933_ >>> 8);
			}
			i += i_918_;
		    }
		} else
	...
	if (this.anIntArray7967 != null) {
	    Class_ta_Sub2 class_ta_sub2 = (Class_ta_Sub2) class_ta;
	    int[] is = class_ta_sub2.anIntArray8443;
	    int[] is_943_ = class_ta_sub2.anIntArray8442;
	    int i_944_ = (this.anInt7976 * -1278653805 > i_942_ ? this.anInt7976 * -1278653805 : i_942_);
	    int i_945_ = ((63686679 * this.anInt7977 < i_942_ + is.length) ? 63686679 * this.anInt7977 : i_942_ + is.length);
	    i_937_ -= i;
	    i_938_ -= i_936_;
	    if (i_937_ + i_938_ < 0) {
		i += i_937_;
		...
		i_937_ += i;
		if (i < this.anInt7974 * -912871679) {
		    i_936_ += (-912871679 * this.anInt7974 - i) * i_946_;
		    i = -912871679 * this.anInt7974;
		}
		if (i_937_ >= -1416794725 * this.anInt7991)
		    i_937_ = -1416794725 * this.anInt7991 - 1;
		...
		if (0 == i_940_ || i_940_ == 1 && 255 == i_947_) {
			...
			if (i_948_ >= i_944_ && i_948_ < i_945_) {
				...
				this.anIntArray7967[(this.anInt7971 * 692106883 * i_948_) + i] = i_939_;
			}
			i_936_ += i_946_;
		    }
		} else if (1 == i_940_) {
			...
			if (i_952_ >= i_944_ && i_952_ < i_945_) {
				...
				int i_955_ = i + (this.anInt7971 * 692106883 * i_952_);
				int i_956_ = (this.anIntArray7967[i_955_]);
				i_956_ = (((i_956_ & 0xff00) * i_951_ >> 8 & 0xff00) + (i_951_ * (i_956_ & 0xff00ff) >> 8 & 0xff00ff));
				this.anIntArray7967[i_955_] = i_956_ + i_939_;
			    }
			}
			i_936_ += i_946_;
		    }
			...
			if (i_957_ >= i_944_ && i_957_ < i_945_) {
				...
				int i_960_ = i + (i_957_ * (this.anInt7971 * 692106883));
				int i_961_ = (this.anIntArray7967[i_960_]);
				int i_962_ = i_939_ + i_961_;
				int i_963_ = ((i_939_ & 0xff00ff) + (i_961_ & 0xff00ff));
				i_961_ = (i_963_ & 0x1000100) + (i_962_ - i_963_ & 0x10000);
				this.anIntArray7967[i_960_] = i_962_ - i_961_ | i_961_ - (i_961_ >>> 8);
			    }
			}
			i_936_ += i_946_;
		    }
		...
		if (i_940_ == 0 || 1 == i_940_ && i_965_ == 255) {
			...
			if ((i_966_ >= this.anInt7974 * -912871679) && i_966_ < (-1416794725 * this.anInt7991) && i_966_ >= i_968_ && i_966_ < is_943_[i_967_] + i_968_)
			    this.anIntArray7967[(692106883 * this.anInt7971 * i_936_) + i_966_] = i_939_;
			i += i_964_;
		    }
		} else if (i_940_ == 1) {
			...
			if ((i_970_ >= -912871679 * this.anInt7974) && i_970_ < (-1416794725 * this.anInt7991) && i_970_ >= i_972_ && i_970_ < is_943_[i_971_] + i_972_) {
			    int i_973_ = (692106883 * this.anInt7971 * i_936_) + i_970_;
			    int i_974_ = (this.anIntArray7967[i_973_]);
			    i_974_ = (((i_974_ & 0xff00) * i_969_ >> 8 & 0xff00) + (i_969_ * (i_974_ & 0xff00ff) >> 8 & 0xff00ff));
			    this.anIntArray7967[(i_936_ * (692106883 * this.anInt7971) + i_970_)] = i_974_ + i_939_;
			}
			i += i_964_;
		    }
		} else if (i_940_ == 2) {
			...
			if ((i_975_ >= -912871679 * this.anInt7974) && i_975_ < (-1416794725 * this.anInt7991) && i_975_ >= i_977_ && i_975_ < i_977_ + is_943_[i_976_]) {
			    int i_978_ = ((this.anInt7971 * 692106883 * i_936_) + i_975_);
			    int i_979_ = (this.anIntArray7967[i_978_]);
			    int i_980_ = i_979_ + i_939_;
			    int i_981_ = (i_939_ & 0xff00ff) + (i_979_ & 0xff00ff);
			    i_979_ = (i_980_ - i_981_ & 0x10000) + (i_981_ & 0x1000100);
			    this.anIntArray7967[i_978_] = i_980_ - i_979_ | i_979_ - (i_979_ >>> 8);
			}
			i += i_964_;
		    }
		} else
	...
	if (this.anIntArray7967 != null) {
	    Class_ta_Sub2 class_ta_sub2 = (Class_ta_Sub2) class_ta;
	    int[] is = class_ta_sub2.anIntArray8443;
	    int[] is_989_ = class_ta_sub2.anIntArray8442;
	    int i_990_ = (this.anInt7976 * -1278653805 > i_988_ ? this.anInt7976 * -1278653805 : i_988_);
	    int i_991_ = ((63686679 * this.anInt7977 < i_988_ + is.length) ? 63686679 * this.anInt7977 : i_988_ + is.length);
	    i_983_ -= i;
	    i_984_ -= i_982_;
	    if (i_983_ + i_984_ < 0) {
		i += i_983_;
		...
		i_983_ += i;
		if (i < this.anInt7974 * -912871679) {
		    i_982_ += (-912871679 * this.anInt7974 - i) * i_992_;
		    i = -912871679 * this.anInt7974;
		}
		if (i_983_ >= -1416794725 * this.anInt7991)
		    i_983_ = -1416794725 * this.anInt7991 - 1;
		...
		if (0 == i_986_ || i_986_ == 1 && 255 == i_993_) {
			...
			if (i_994_ >= i_990_ && i_994_ < i_991_) {
				...
				this.anIntArray7967[(this.anInt7971 * 692106883 * i_994_) + i] = i_985_;
			}
			i_982_ += i_992_;
		    }
		} else if (1 == i_986_) {
			...
			if (i_998_ >= i_990_ && i_998_ < i_991_) {
				...
				int i_1001_ = i + (this.anInt7971 * 692106883 * i_998_);
				int i_1002_ = (this.anIntArray7967[i_1001_]);
				i_1002_ = (((i_1002_ & 0xff00) * i_997_ >> 8 & 0xff00) + (i_997_ * (i_1002_ & 0xff00ff) >> 8 & 0xff00ff));
				this.anIntArray7967[i_1001_] = i_1002_ + i_985_;
			    }
			}
			i_982_ += i_992_;
		    }
			...
			if (i_1003_ >= i_990_ && i_1003_ < i_991_) {
				...
				int i_1006_ = i + (i_1003_ * (this.anInt7971 * 692106883));
				int i_1007_ = (this.anIntArray7967[i_1006_]);
				int i_1008_ = i_985_ + i_1007_;
				int i_1009_ = ((i_985_ & 0xff00ff) + (i_1007_ & 0xff00ff));
				i_1007_ = ((i_1009_ & 0x1000100) + (i_1008_ - i_1009_ & 0x10000));
				this.anIntArray7967[i_1006_] = i_1008_ - i_1007_ | i_1007_ - (i_1007_ >>> 8);
			    }
			}
			i_982_ += i_992_;
		    }
		...
		if (i_986_ == 0 || 1 == i_986_ && i_1011_ == 255) {
			...
			if ((i_1012_ >= this.anInt7974 * -912871679) && i_1012_ < (-1416794725 * this.anInt7991) && i_1012_ >= i_1014_ && i_1012_ < is_989_[i_1013_] + i_1014_)
			    this.anIntArray7967[(692106883 * this.anInt7971 * i_982_) + i_1012_] = i_985_;
			i += i_1010_;
		    }
		} else if (i_986_ == 1) {
			...
			if ((i_1016_ >= -912871679 * this.anInt7974) && i_1016_ < (-1416794725 * this.anInt7991) && i_1016_ >= i_1018_ && i_1016_ < is_989_[i_1017_] + i_1018_) {
			    int i_1019_ = (692106883 * this.anInt7971 * i_982_) + i_1016_;
			    int i_1020_ = (this.anIntArray7967[i_1019_]);
			    i_1020_ = (((i_1020_ & 0xff00) * i_1015_ >> 8 & 0xff00) + (i_1015_ * (i_1020_ & 0xff00ff) >> 8 & 0xff00ff));
			    this.anIntArray7967[(i_982_ * (692106883 * this.anInt7971) + i_1016_)] = i_1020_ + i_985_;
			}
			i += i_1010_;
		    }
		} else if (i_986_ == 2) {
			...
			if ((i_1021_ >= -912871679 * this.anInt7974) && i_1021_ < (-1416794725 * this.anInt7991) && i_1021_ >= i_1023_ && i_1021_ < i_1023_ + is_989_[i_1022_]) {
			    int i_1024_ = ((this.anInt7971 * 692106883 * i_982_) + i_1021_);
			    int i_1025_ = (this.anIntArray7967[i_1024_]);
			    int i_1026_ = i_1025_ + i_985_;
			    int i_1027_ = (i_985_ & 0xff00ff) + (i_1025_ & 0xff00ff);
			    i_1025_ = ((i_1026_ - i_1027_ & 0x10000) + (i_1027_ & 0x1000100));
			    this.anIntArray7967[i_1024_] = i_1026_ - i_1025_ | i_1025_ - (i_1025_ >>> 8);
			}
			i += i_1010_;
		    }
		} else
	...
	if (null != this.anIntArray7967) {
	    Class_ta_Sub2 class_ta_sub2 = (Class_ta_Sub2) class_ta;
	    int[] is = class_ta_sub2.anIntArray8443;
	    int[] is_1038_ = class_ta_sub2.anIntArray8442;
	    int i_1039_ = (this.anInt7976 * -1278653805 > i_1034_ ? -1278653805 * this.anInt7976 : i_1034_);
	    int i_1040_ = ((this.anInt7977 * 63686679 < i_1034_ + is.length) ? this.anInt7977 * 63686679 : i_1034_ + is.length);
	    i_1037_ <<= 8;
	    i_1035_ <<= 8;
	    i_1036_ <<= 8;
		...
		int i_1042_ = (int) (Math.sqrt(i_1030_ * i_1030_ + i_1029_ * i_1029_) * 256.0);
		...
		int i_1046_ = (int) Math.sqrt(65536 + (i_1044_ >> 8) * (i_1044_ >> 8));
		if (0 == i_1032_ || i_1032_ == 1 && 255 == i_1045_) {
		    while (i <= i_1029_) {
			int i_1047_ = i_1028_ >> 16;
			int i_1048_ = i_1047_ - i_1034_;
			if (i >= this.anInt7974 * -912871679 && i < (-1416794725 * this.anInt7991) && i_1047_ >= i_1039_ && i_1047_ < i_1040_ && i_1037_ < i_1035_) {
			    int i_1049_ = is[i_1048_] + i_1033_;
			    if (i >= i_1049_ && i < i_1049_ + is_1038_[i_1048_])
				this.anIntArray7967[i + (692106883 * this.anInt7971 * i_1047_)] = i_1031_;
			}
			i_1028_ += i_1044_;
			i++;
			i_1037_ += i_1046_;
			...
			if (i >= -912871679 * this.anInt7974 && i < (this.anInt7991 * -1416794725) && i_1051_ >= i_1039_ && i_1051_ < i_1040_ && i_1037_ < i_1035_) {
			    int i_1053_ = i_1033_ + is[i_1052_];
			    if (i >= i_1053_ && i < is_1038_[i_1052_] + i_1053_) {
				int i_1054_ = i + (this.anInt7971 * 692106883 * i_1051_);
				int i_1055_ = (this.anIntArray7967[i_1054_]);
				i_1055_ = ((i_1050_ * (i_1055_ & 0xff00) >> 8 & 0xff00) + (i_1050_ * (i_1055_ & 0xff00ff) >> 8 & 0xff00ff));
				this.anIntArray7967[i_1054_] = i_1055_ + i_1031_;
			    }
			}
			i_1028_ += i_1044_;
			i++;
			...
			if (i >= this.anInt7974 * -912871679 && i < (-1416794725 * this.anInt7991) && i_1056_ >= i_1039_ && i_1056_ < i_1040_ && i_1037_ < i_1035_) {
			    int i_1058_ = is[i_1057_] + i_1033_;
			    if (i >= i_1058_ && i < i_1058_ + is_1038_[i_1057_]) {
				int i_1059_ = ((692106883 * this.anInt7971 * i_1056_) + i);
				int i_1060_ = (this.anIntArray7967[i_1059_]);
				...
				this.anIntArray7967[i_1059_] = i_1061_ - i_1060_ | i_1060_ - (i_1060_ >>> 8);
			    }
			}
			i_1028_ += i_1044_;
			i++;
		...
		int i_1064_ = (int) Math.sqrt((i_1063_ >> 8) * (i_1063_ >> 8) + 65536);
		i_1030_ += i_1028_;
		...
		if (i_1032_ == 0 || i_1032_ == 1 && i_1065_ == 255) {
			...
			if (i_1028_ >= i_1039_ && i_1028_ < i_1040_ && i_1066_ >= (this.anInt7974 * -912871679) && i_1066_ < (this.anInt7991 * -1416794725) && i_1037_ < i_1035_ && i_1066_ >= i_1033_ + is[i_1067_] && i_1066_ < is_1038_[i_1067_] + (i_1033_ + is[i_1067_]))
			    this.anIntArray7967[i_1028_ * (692106883 * (this.anInt7971)) + i_1066_] = i_1031_;
			i += i_1063_;
			i_1028_++;
			i_1037_ += i_1064_;
			i_1037_ %= i_1041_;
			...
			if (i_1028_ >= i_1039_ && i_1028_ < i_1040_ && i_1069_ >= (this.anInt7974 * -912871679) && i_1069_ < (this.anInt7991 * -1416794725) && i_1037_ < i_1035_ && i_1069_ >= i_1033_ + is[i_1070_] && (i_1069_ < is[i_1070_] + i_1033_ + is_1038_[i_1070_])) {
			    int i_1071_ = i_1069_ + i_1028_ * ((this.anInt7971) * 692106883);
			    int i_1072_ = (this.anIntArray7967[i_1071_]);
			    i_1072_ = ((i_1068_ * (i_1072_ & 0xff00) >> 8 & 0xff00) + ((i_1072_ & 0xff00ff) * i_1068_ >> 8 & 0xff00ff));
			    this.anIntArray7967[(i_1069_ + i_1028_ * (this.anInt7971 * 692106883))] = i_1031_ + i_1072_;
			}
			i += i_1063_;
			i_1028_++;
			i_1037_ += i_1064_;
			...
			if (i_1028_ >= i_1039_ && i_1028_ < i_1040_ && i_1073_ >= (this.anInt7974 * -912871679) && i_1073_ < (this.anInt7991 * -1416794725) && i_1037_ < i_1035_ && i_1073_ >= i_1033_ + is[i_1074_] && (i_1073_ < is[i_1074_] + i_1033_ + is_1038_[i_1074_])) {
			    int i_1075_ = (692106883 * this.anInt7971 * i_1028_) + i_1073_;
			    int i_1076_ = (this.anIntArray7967[i_1075_]);
			    ...
			    this.anIntArray7967[i_1075_] = i_1077_ - i_1076_ | i_1076_ - (i_1076_ >>> 8);
			}
			i += i_1063_;
			i_1028_++;
			i_1037_ += i_1064_;
	...
	int i_1084_ = 0;
	float f = (i_1080_ * (this.aClass233_7987.aFloatArray2594[10]) + ((this.aClass233_7987.aFloatArray2594[6] * i_1079_) + (i * (this.aClass233_7987.aFloatArray2594[2]) + (this.aClass233_7987.aFloatArray2594[14]))));
	float f_1085_ = ((i_1083_ * this.aClass233_7987.aFloatArray2594[10]) + ((this.aClass233_7987.aFloatArray2594[6] * i_1082_) + (this.aClass233_7987.aFloatArray2594[14] + i_1081_ * (this.aClass233_7987.aFloatArray2594[2]))));
	float f_1086_ = ((i * this.aClass233_7987.aFloatArray2594[3]) + this.aClass233_7987.aFloatArray2594[15] + (this.aClass233_7987.aFloatArray2594[7] * i_1079_) + i_1080_ * (this.aClass233_7987.aFloatArray2594[11]));
	float f_1087_ = ((i_1081_ * this.aClass233_7987.aFloatArray2594[3]) + this.aClass233_7987.aFloatArray2594[15] + (this.aClass233_7987.aFloatArray2594[7] * i_1082_) + (this.aClass233_7987.aFloatArray2594[11] * i_1083_));
	if (f < -f_1086_ && f_1085_ < -f_1087_)
	    i_1084_ |= 0x10;
	else if (f > f_1086_ && f_1085_ > f_1087_)
	    i_1084_ |= 0x20;
	float f_1088_ = ((this.aClass233_7987.aFloatArray2594[4] * i_1079_) + (this.aClass233_7987.aFloatArray2594[12] + (this.aClass233_7987.aFloatArray2594[0] * i)) + (this.aClass233_7987.aFloatArray2594[8] * i_1080_));
	float f_1089_ = ((this.aClass233_7987.aFloatArray2594[8] * i_1083_) + ((i_1081_ * this.aClass233_7987.aFloatArray2594[0]) + this.aClass233_7987.aFloatArray2594[12] + (this.aClass233_7987.aFloatArray2594[4] * i_1082_)));
	if (f_1088_ < -f_1086_ && f_1089_ < -f_1087_)
	    i_1084_ |= 0x1;
	if (f_1088_ > f_1086_ && f_1089_ > f_1087_)
	    i_1084_ |= 0x2;
	float f_1090_ = ((i_1079_ * this.aClass233_7987.aFloatArray2594[5]) + ((this.aClass233_7987.aFloatArray2594[1] * i) + this.aClass233_7987.aFloatArray2594[13]) + (this.aClass233_7987.aFloatArray2594[9] * i_1080_));
	float f_1091_ = ((i_1081_ * this.aClass233_7987.aFloatArray2594[1]) + this.aClass233_7987.aFloatArray2594[13] + (i_1082_ * this.aClass233_7987.aFloatArray2594[5]) + (this.aClass233_7987.aFloatArray2594[9] * i_1083_));
	...
	for (Class298_Sub4 class298_sub4 = (Class298_Sub4) this.aClass348_7975.method4190(1895439164); null != class298_sub4; class298_sub4 = (Class298_Sub4) this.aClass348_7975.method4191(-150689583)) {
	    if (class298_sub4.aBoolean7189) {
		class298_sub4.anInt7188 += i_1092_;
		int i_1093_ = class298_sub4.anInt7188 / 50;
		if (i_1093_ > 0) {
		    Class53 class53 = anInterface_ma5299.method174((class298_sub4.anInt7190), 1049472051);
		    float f = class53.aBoolean518 ? 64.0F : 128.0F;
		    class298_sub4.method2855((int) (i_1092_ / 1000.0F * class53.aByte535 / 64.0F * f), (int) (f * (class53.aByte509 * (i_1092_ / 1000.0F) / 64.0F)));
	...
	this.anInt7968 = -1260974911 * i;
	this.aClass348_7970.method4186(5, -253785523);
	this.aClass348_7975.method4186(5, -559517412);
    }
	...
	if (null != this.anIntArray7967) {
		...
		if (i_1155_ > i_1156_) {
		    ...
		    i_1155_ += i;
		    if (i < this.anInt7974 * -912871679) {
			i_1154_ += i_1159_ * ((this.anInt7974 * -912871679) - i);
			i = this.anInt7974 * -912871679;
		    }
		    if (i_1155_ >= this.anInt7991 * -1416794725)
			i_1155_ = (-1416794725 * this.anInt7991 - 1);
			...
			for (/**/; i <= i_1155_; i++) {
				...
				this.anIntArray7967[i + i_1161_ * (692106883 * (this.anInt7971))] = i_1157_;
			    i_1154_ += i_1159_;
			}
		    } else if (1 == i_1158_) {
			...
			for (/**/; i <= i_1155_; i++) {
				...
				int i_1167_ = ((i_1166_ * (692106883 * this.anInt7971)) + i);
		    ...
		    i_1156_ += i_1154_;
		    if (i_1154_ < this.anInt7976 * -1278653805) {
			i += (this.anInt7976 * -1278653805 - i_1154_) * i_1171_;
			i_1154_ = this.anInt7976 * -1278653805;
		    }
		    if (i_1156_ >= 63686679 * this.anInt7977)
			i_1156_ = this.anInt7977 * 63686679 - 1;
			...
			for (/**/; i_1154_ <= i_1156_; i_1154_++) {
				...
				this.anIntArray7967[(this.anInt7971 * 692106883 * i_1154_) + i_1173_] = i_1157_;
			    i += i_1171_;
			}
		    } else if (1 == i_1158_) {
			...
			for (/**/; i_1154_ <= i_1156_; i_1154_++) {
				...
				int i_1176_ = (i_1175_ + (692106883 * this.anInt7971 * i_1154_));
				int i_1177_ = (this.anIntArray7967[i_1176_]);
				i_1177_ = ((i_1174_ * (i_1177_ & 0xff00ff) >> 8 & 0xff00ff) + (i_1174_ * (i_1177_ & 0xff00) >> 8 & 0xff00));
				this.anIntArray7967[i_1175_ + i_1154_ * (692106883 * this.anInt7971)] = i_1157_ + i_1177_;
			    }
			    i += i_1171_;
			}
		    } else if (2 == i_1158_) {
			for (/**/; i_1154_ <= i_1156_; i_1154_++) {
				...
				int i_1179_ = (i_1178_ + (i_1154_ * (this.anInt7971 * 692106883)));
	...
	if (null != this.anIntArray7967) {
	    Class_ta_Sub2 class_ta_sub2 = (Class_ta_Sub2) class_ta;
	    int[] is = class_ta_sub2.anIntArray8443;
	    int[] is_1189_ = class_ta_sub2.anIntArray8442;
	    int i_1190_;
	    if (63686679 * this.anInt7977 < is.length + i_1188_)
		i_1190_ = this.anInt7977 * 63686679 - i_1188_;
	    else
		i_1190_ = is.length;
	    int i_1191_;
	    if (this.anInt7976 * -1278653805 > i_1188_) {
		i_1191_ = this.anInt7976 * -1278653805 - i_1188_;
		i_1188_ = this.anInt7976 * -1278653805;
	    } else
		i_1191_ = 0;
	    if (i_1190_ - i_1191_ > 0) {
		int i_1192_ = 692106883 * this.anInt7971 * i_1188_;
		for (int i_1193_ = i_1191_; i_1193_ < i_1190_; i_1193_++) {
		    int i_1194_ = i_1187_ + is[i_1193_];
		    int i_1195_ = is_1189_[i_1193_];
		    if (this.anInt7974 * -912871679 > i_1194_) {
			i_1195_ -= (-912871679 * this.anInt7974 - i_1194_);
			i_1194_ = -912871679 * this.anInt7974;
		    }
		    if (-1416794725 * this.anInt7991 < i_1194_ + i_1195_)
			i_1195_ = (-1416794725 * this.anInt7991 - i_1194_);
		    i_1194_ += i_1192_;
		    for (int i_1196_ = -i_1195_; i_1196_ < 0; i_1196_++)
			this.anIntArray7967[i_1194_++] = i;
		    i_1192_ += this.anInt7971 * 692106883;
		}
	    }
	}
    }
	...
	if (null != this.anIntArray7967) {
	    Class_ta_Sub2 class_ta_sub2 = (Class_ta_Sub2) class_ta;
	    int[] is = class_ta_sub2.anIntArray8443;
	    int[] is_1199_ = class_ta_sub2.anIntArray8442;
	    int i_1200_;
	    if (63686679 * this.anInt7977 < is.length + i_1198_)
		i_1200_ = this.anInt7977 * 63686679 - i_1198_;
	    else
		i_1200_ = is.length;
	    int i_1201_;
	    if (this.anInt7976 * -1278653805 > i_1198_) {
		i_1201_ = this.anInt7976 * -1278653805 - i_1198_;
		i_1198_ = this.anInt7976 * -1278653805;
	    } else
		i_1201_ = 0;
	    if (i_1200_ - i_1201_ > 0) {
		int i_1202_ = 692106883 * this.anInt7971 * i_1198_;
		for (int i_1203_ = i_1201_; i_1203_ < i_1200_; i_1203_++) {
		    int i_1204_ = i_1197_ + is[i_1203_];
		    int i_1205_ = is_1199_[i_1203_];
		    if (this.anInt7974 * -912871679 > i_1204_) {
			i_1205_ -= (-912871679 * this.anInt7974 - i_1204_);
			i_1204_ = -912871679 * this.anInt7974;
		    }
		    if (-1416794725 * this.anInt7991 < i_1204_ + i_1205_)
			i_1205_ = (-1416794725 * this.anInt7991 - i_1204_);
		    i_1204_ += i_1202_;
		    for (int i_1206_ = -i_1205_; i_1206_ < 0; i_1206_++)
			this.anIntArray7967[i_1204_++] = i;
		    i_1202_ += this.anInt7971 * 692106883;
		}
	    }
	}
    }
	...
	return new Class222(this.aClass222_7984);
    }
	...
	if (null != this.anIntArray7967 && (i >= this.anInt7974 * -912871679 && i < -1416794725 * this.anInt7991)) {
	    int i_1241_ = this.anInt7971 * 692106883 * i_1234_ + i;
		...
		while (i_1245_ < i_1235_) {
			...
			this.anIntArray7967[(i_1245_ * (692106883 * this.anInt7971) + i_1241_)] = i_1236_;
		    i_1245_++;
		...
		while (i_1247_ < i_1235_) {
			...
			int i_1248_ = (i_1247_ * (692106883 * this.anInt7971) + i_1241_);
		...
		while (i_1250_ < i_1235_) {
			...
			int i_1251_ = (i_1250_ * (this.anInt7971 * 692106883) + i_1241_);
	...
	int i_1260_ = 0;
	float f = (i_1256_ * (this.aClass233_7987.aFloatArray2594[10]) + ((this.aClass233_7987.aFloatArray2594[6] * i_1255_) + (i * (this.aClass233_7987.aFloatArray2594[2]) + (this.aClass233_7987.aFloatArray2594[14]))));
	float f_1261_ = ((i_1259_ * this.aClass233_7987.aFloatArray2594[10]) + ((this.aClass233_7987.aFloatArray2594[6] * i_1258_) + (this.aClass233_7987.aFloatArray2594[14] + i_1257_ * (this.aClass233_7987.aFloatArray2594[2]))));
	float f_1262_ = ((i * this.aClass233_7987.aFloatArray2594[3]) + this.aClass233_7987.aFloatArray2594[15] + (this.aClass233_7987.aFloatArray2594[7] * i_1255_) + i_1256_ * (this.aClass233_7987.aFloatArray2594[11]));
	float f_1263_ = ((i_1257_ * this.aClass233_7987.aFloatArray2594[3]) + this.aClass233_7987.aFloatArray2594[15] + (this.aClass233_7987.aFloatArray2594[7] * i_1258_) + (this.aClass233_7987.aFloatArray2594[11] * i_1259_));
	if (f < -f_1262_ && f_1261_ < -f_1263_)
	    i_1260_ |= 0x10;
	else if (f > f_1262_ && f_1261_ > f_1263_)
	    i_1260_ |= 0x20;
	float f_1264_ = ((this.aClass233_7987.aFloatArray2594[4] * i_1255_) + (this.aClass233_7987.aFloatArray2594[12] + (this.aClass233_7987.aFloatArray2594[0] * i)) + (this.aClass233_7987.aFloatArray2594[8] * i_1256_));
	float f_1265_ = ((this.aClass233_7987.aFloatArray2594[8] * i_1259_) + ((i_1257_ * this.aClass233_7987.aFloatArray2594[0]) + this.aClass233_7987.aFloatArray2594[12] + (this.aClass233_7987.aFloatArray2594[4] * i_1258_)));
	if (f_1264_ < -f_1262_ && f_1265_ < -f_1263_)
	    i_1260_ |= 0x1;
	if (f_1264_ > f_1262_ && f_1265_ > f_1263_)
	    i_1260_ |= 0x2;
	float f_1266_ = ((i_1255_ * this.aClass233_7987.aFloatArray2594[5]) + ((this.aClass233_7987.aFloatArray2594[1] * i) + this.aClass233_7987.aFloatArray2594[13]) + (this.aClass233_7987.aFloatArray2594[9] * i_1256_));
	float f_1267_ = ((i_1257_ * this.aClass233_7987.aFloatArray2594[1]) + this.aClass233_7987.aFloatArray2594[13] + (i_1258_ * this.aClass233_7987.aFloatArray2594[5]) + (this.aClass233_7987.aFloatArray2594[9] * i_1259_));
	...
	if (-912871679 * this.anInt7974 < i)
	    this.anInt7974 = i * -1291169535;
	if (this.anInt7976 * -1278653805 < i_1268_)
	    this.anInt7976 = i_1268_ * 104031131;
	if (this.anInt7991 * -1416794725 > i_1269_)
	    this.anInt7991 = i_1269_ * -1912131437;
	if (63686679 * this.anInt7977 > i_1270_)
	    this.anInt7977 = i_1270_ * 1656090535;
	method5209();
    }
	...
	if (this.anIntArray7967 != null && (i_1275_ >= this.anInt7976 * -1278653805 && i_1275_ < 63686679 * this.anInt7977)) {
	    int i_1282_ = i_1275_ * (692106883 * this.anInt7971) + i;
	...
	if (null != this.anIntArray7967 && (i >= this.anInt7974 * -912871679 && i < this.anInt7991 * -1416794725)) {
	    if (i_1295_ < -1278653805 * this.anInt7976) {
		i_1296_ -= (this.anInt7976 * -1278653805 - i_1295_);
		i_1295_ = this.anInt7976 * -1278653805;
	    }
	    if (i_1296_ + i_1295_ > 63686679 * this.anInt7977)
		i_1296_ = 63686679 * this.anInt7977 - i_1295_;
	    int i_1299_ = i + i_1295_ * (this.anInt7971 * 692106883);
	    int i_1300_ = i_1297_ >>> 24;
	    if (i_1298_ == 0 || 1 == i_1298_ && 255 == i_1300_) {
		for (int i_1301_ = 0; i_1301_ < i_1296_; i_1301_++)
		    this.anIntArray7967[i_1299_ + i_1301_ * (this.anInt7971 * 692106883)] = i_1297_;
	    } else if (i_1298_ == 1) {
		...
		for (int i_1303_ = 0; i_1303_ < i_1296_; i_1303_++) {
		    int i_1304_ = (i_1303_ * (692106883 * this.anInt7971) + i_1299_);
		    int i_1305_ = this.anIntArray7967[i_1304_];
		    i_1305_ = ((i_1302_ * (i_1305_ & 0xff00ff) >> 8 & 0xff00ff) + ((i_1305_ & 0xff00) * i_1302_ >> 8 & 0xff00));
		    this.anIntArray7967[i_1304_] = i_1305_ + i_1297_;
		}
	    } else if (2 == i_1298_) {
		for (int i_1306_ = 0; i_1306_ < i_1296_; i_1306_++) {
		    int i_1307_ = (i_1306_ * (692106883 * this.anInt7971) + i_1299_);
		    int i_1308_ = this.anIntArray7967[i_1307_];
		    ...
		    this.anIntArray7967[i_1307_] = i_1309_ - i_1308_ | i_1308_ - (i_1308_ >>> 8);
		}
	    } else
		throw new IllegalArgumentException();
	}
	...
	if (null != this.anIntArray7967) {
		...
		if (i_1324_ + i_1323_ < 0) {
		    int i_1333_ = (int) (Math.sqrt(i_1324_ * i_1324_ + i_1323_ * i_1323_) * 256.0);
		...
		if (i_1323_ > i_1324_) {
		    ...
		    int i_1337_ = (int) Math.sqrt(65536 + ((i_1335_ >> 8) * (i_1335_ >> 8)));
		    if (0 == i_1326_ || 1 == i_1326_ && i_1336_ == 255) {
			while (i <= i_1323_) {
			    int i_1338_ = i_1322_ >> 16;
			    if (i >= (this.anInt7974 * -912871679) && i < (-1416794725 * this.anInt7991) && i_1338_ >= (this.anInt7976 * -1278653805) && i_1338_ < (this.anInt7977 * 63686679) && i_1329_ < i_1327_)
				this.anIntArray7967[(this.anInt7971 * 692106883 * i_1338_) + i] = i_1325_;
			    i_1322_ += i_1335_;
			    i++;
			    i_1329_ += i_1337_;
			    i_1329_ %= i_1332_;
			...
			while (i <= i_1323_) {
			    ...
			    if (i >= (this.anInt7974 * -912871679) && i < (this.anInt7991 * -1416794725) && i_1340_ >= (this.anInt7976 * -1278653805) && i_1340_ < 63686679 * (this.anInt7977) && i_1329_ < i_1327_) {
				int i_1341_ = i + i_1340_ * (692106883 * (this.anInt7971));
				int i_1342_ = (this.anIntArray7967[i_1341_]);
				i_1342_ = (((i_1342_ & 0xff00ff) * i_1339_ >> 8 & 0xff00ff) + (i_1339_ * (i_1342_ & 0xff00) >> 8 & 0xff00));
				this.anIntArray7967[i_1341_] = i_1342_ + i_1325_;
			    }
			    i_1322_ += i_1335_;
			    i++;
			    i_1329_ += i_1337_;
			...
			while (i <= i_1323_) {
			    ...
			    if (i >= (this.anInt7974 * -912871679) && i < (-1416794725 * this.anInt7991) && i_1343_ >= -1278653805 * this.anInt7976 && i_1343_ < 63686679 * (this.anInt7977) && i_1329_ < i_1327_) {
				int i_1344_ = i + (i_1343_ * (this.anInt7971 * 692106883));
				int i_1345_ = (this.anIntArray7967[i_1344_]);
				...
				this.anIntArray7967[i_1344_] = i_1346_ - i_1345_ | i_1345_ - (i_1345_ >>> 8);
			    }
			    i_1322_ += i_1335_;
			    i++;
			    i_1329_ += i_1337_;
		    ...
		    int i_1350_ = (int) Math.sqrt((i_1348_ >> 8) * (i_1348_ >> 8) + 65536);
		    if (i_1326_ == 0 || 1 == i_1326_ && i_1349_ == 255) {
			while (i_1322_ <= i_1324_) {
			    int i_1351_ = i >> 16;
			    if (i_1322_ >= (this.anInt7976 * -1278653805) && i_1322_ < 63686679 * (this.anInt7977) && i_1351_ >= -912871679 * this.anInt7974 && i_1351_ < -1416794725 * this.anInt7991 && i_1329_ < i_1327_)
				this.anIntArray7967[(i_1322_ * (this.anInt7971 * 692106883)) + i_1351_] = i_1325_;
			    i += i_1348_;
			    i_1322_++;
			    i_1329_ += i_1350_;
			    i_1329_ %= i_1332_;
			...
			while (i_1322_ <= i_1324_) {
			    int i_1353_ = i >> 16;
			    if (i_1322_ >= (this.anInt7976 * -1278653805) && i_1322_ < 63686679 * (this.anInt7977) && i_1353_ >= -912871679 * this.anInt7974 && i_1353_ < -1416794725 * this.anInt7991 && i_1329_ < i_1327_) {
				int i_1354_ = ((692106883 * this.anInt7971 * i_1322_) + i_1353_);
				int i_1355_ = (this.anIntArray7967[i_1354_]);
				i_1355_ = ((i_1352_ * (i_1355_ & 0xff00) >> 8 & 0xff00) + (i_1352_ * (i_1355_ & 0xff00ff) >> 8 & 0xff00ff));
				this.anIntArray7967[(692106883 * this.anInt7971 * i_1322_) + i_1353_] = i_1325_ + i_1355_;
			    }
			    i += i_1348_;
			    i_1322_++;
			    i_1329_ += i_1350_;
			...
			while (i_1322_ <= i_1324_) {
			    int i_1356_ = i >> 16;
			    if (i_1322_ >= (this.anInt7976 * -1278653805) && i_1322_ < (this.anInt7977 * 63686679) && i_1356_ >= -912871679 * this.anInt7974 && i_1356_ < (this.anInt7991 * -1416794725) && i_1329_ < i_1327_) {
				int i_1357_ = (i_1356_ + i_1322_ * (692106883 * (this.anInt7971)));
				int i_1358_ = (this.anIntArray7967[i_1357_]);
				...
				this.anIntArray7967[i_1357_] = i_1359_ - i_1358_ | i_1358_ - (i_1358_ >>> 8);
			    }
			    i += i_1348_;
			    i_1322_++;
			    i_1329_ += i_1350_;
	...
	for (int i_1363_ = 0; i_1363_ < this.aClass15Array8001.length; i_1363_++) {
	    Class15 class15 = this.aClass15Array8001[i_1363_];
	    class15.anInt184 = 1903335279 * (i & 0xffffff);
	    int i_1364_ = 688695183 * class15.anInt184 >>> 16 & 0xff;
	    if (i_1364_ < 2)
		i_1364_ = 2;
	    int i_1365_ = 688695183 * class15.anInt184 >> 8 & 0xff;
	    if (i_1365_ < 2)
		i_1365_ = 2;
	    int i_1366_ = class15.anInt184 * 688695183 & 0xff;
	    if (i_1366_ < 2)
		i_1366_ = 2;
	    class15.anInt184 = (i_1364_ << 16 | i_1365_ << 8 | i_1366_) * 1903335279;
	    if (i_1361_ < 0)
		class15.aBoolean216 = false;
	    else
		class15.aBoolean216 = true;
	...
	this.anInt7998 = (int) (f * 65535.0F) * 295067571;
	this.anInt7982 = -2064023785 * (int) (f_1367_ * 65535.0F);
	float f_1371_ = (float) Math.sqrt(f_1369_ * f_1369_ + f_1368_ * f_1368_ + f_1370_ * f_1370_);
	this.anInt7978 = (int) (f_1368_ * 65535.0F / f_1371_) * -666627277;
	this.anInt7979 = (int) (65535.0F * f_1369_ / f_1371_) * 1031065997;
	this.anInt7981 = 1231602687 * (int) (f_1370_ * 65535.0F / f_1371_);
    }
	...
	int i_1391_ = 0;
	float f = (i_1387_ * (this.aClass233_7987.aFloatArray2594[10]) + ((this.aClass233_7987.aFloatArray2594[6] * i_1386_) + (i * (this.aClass233_7987.aFloatArray2594[2]) + (this.aClass233_7987.aFloatArray2594[14]))));
	float f_1392_ = ((i_1390_ * this.aClass233_7987.aFloatArray2594[10]) + ((this.aClass233_7987.aFloatArray2594[6] * i_1389_) + (this.aClass233_7987.aFloatArray2594[14] + i_1388_ * (this.aClass233_7987.aFloatArray2594[2]))));
	float f_1393_ = ((i * this.aClass233_7987.aFloatArray2594[3]) + this.aClass233_7987.aFloatArray2594[15] + (this.aClass233_7987.aFloatArray2594[7] * i_1386_) + i_1387_ * (this.aClass233_7987.aFloatArray2594[11]));
	float f_1394_ = ((i_1388_ * this.aClass233_7987.aFloatArray2594[3]) + this.aClass233_7987.aFloatArray2594[15] + (this.aClass233_7987.aFloatArray2594[7] * i_1389_) + (this.aClass233_7987.aFloatArray2594[11] * i_1390_));
	if (f < -f_1393_ && f_1392_ < -f_1394_)
	    i_1391_ |= 0x10;
	else if (f > f_1393_ && f_1392_ > f_1394_)
	    i_1391_ |= 0x20;
	float f_1395_ = ((this.aClass233_7987.aFloatArray2594[4] * i_1386_) + (this.aClass233_7987.aFloatArray2594[12] + (this.aClass233_7987.aFloatArray2594[0] * i)) + (this.aClass233_7987.aFloatArray2594[8] * i_1387_));
	float f_1396_ = ((this.aClass233_7987.aFloatArray2594[8] * i_1390_) + ((i_1388_ * this.aClass233_7987.aFloatArray2594[0]) + this.aClass233_7987.aFloatArray2594[12] + (this.aClass233_7987.aFloatArray2594[4] * i_1389_)));
	if (f_1395_ < -f_1393_ && f_1396_ < -f_1394_)
	    i_1391_ |= 0x1;
	if (f_1395_ > f_1393_ && f_1396_ > f_1394_)
	    i_1391_ |= 0x2;
	float f_1397_ = ((i_1386_ * this.aClass233_7987.aFloatArray2594[5]) + ((this.aClass233_7987.aFloatArray2594[1] * i) + this.aClass233_7987.aFloatArray2594[13]) + (this.aClass233_7987.aFloatArray2594[9] * i_1387_));
	float f_1398_ = ((i_1388_ * this.aClass233_7987.aFloatArray2594[1]) + this.aClass233_7987.aFloatArray2594[13] + (i_1389_ * this.aClass233_7987.aFloatArray2594[5]) + (this.aClass233_7987.aFloatArray2594[9] * i_1390_));
	...
	for (int i_1414_ = 0; i_1414_ < this.aClass15Array8001.length; i_1414_++) {
	    this.aClass15Array8001[i_1414_].anInt185 = 329691201 * ((this.aClass15Array8001[i_1414_]).anInt184);
	    this.aClass15Array8001[i_1414_].anInt196 = 1450505545 * i;
	    this.aClass15Array8001[i_1414_].anInt184 = class78.anInt726 * -1634857629;
	    this.aClass15Array8001[i_1414_].anInt215 = class78.anInt725 * -296597081;
	    this.aClass15Array8001[i_1414_].aBoolean186 = true;
	}
    }

    @Override
    public void method5156(int i, Class78 class78) {
	for (int i_1415_ = 0; i_1415_ < this.aClass15Array8001.length; i_1415_++) {
	    this.aClass15Array8001[i_1415_].anInt185 = 329691201 * ((this.aClass15Array8001[i_1415_]).anInt184);
	    this.aClass15Array8001[i_1415_].anInt196 = 1450505545 * i;
	    this.aClass15Array8001[i_1415_].anInt184 = class78.anInt726 * -1634857629;
	    this.aClass15Array8001[i_1415_].anInt215 = class78.anInt725 * -296597081;
	    this.aClass15Array8001[i_1415_].aBoolean186 = true;
	}
    }
	...
	boolean bool = null != this.anIntArray7967;
	boolean bool_1446_ = this.aFloatArray7973 != null;
	if (bool || bool_1446_) {
	    Class15 class15 = method5202(Thread.currentThread());
	    Class2 class2 = class15.aClass2_192;
	    class2.aBoolean16 = false;
	    i -= -912871679 * this.anInt7974;
	    i_1436_ -= -912871679 * this.anInt7974;
	    i_1439_ -= -912871679 * this.anInt7974;
	    i_1435_ -= this.anInt7976 * -1278653805;
	    i_1437_ -= this.anInt7976 * -1278653805;
	    i_1440_ -= this.anInt7976 * -1278653805;
	    class2.aBoolean20 = (i < 0 || i > class2.anInt22 || i_1436_ < 0 || i_1436_ > class2.anInt22 || i_1439_ < 0 || i_1439_ > class2.anInt22);
	    int i_1447_ = i_1442_ >>> 24;
	    if (0 == i_1445_ || i_1445_ == 1 && 255 == i_1447_) {
		class2.anInt19 = 0;
		class2.aBoolean48 = false;
		class2.method292(bool, bool_1446_, false, i_1435_, i_1437_, i_1440_, i, i_1436_, i_1439_, f, f_1438_, f_1441_, i_1442_, i_1443_, i_1444_);
	    } else if (1 == i_1445_) {
		class2.anInt19 = 255 - i_1447_;
		class2.aBoolean48 = false;
		class2.method292(bool, bool_1446_, false, i_1435_, i_1437_, i_1440_, i, i_1436_, i_1439_, f, f_1438_, f_1441_, i_1442_, i_1443_, i_1444_);
	    } else if (2 == i_1445_) {
		class2.anInt19 = 128;
	...
	float f_1456_ = ((this.aClass233_7987.aFloatArray2594[11] * f_1455_) + (f * this.aClass233_7987.aFloatArray2594[3] + this.aClass233_7987.aFloatArray2594[15] + f_1454_ * (this.aClass233_7987.aFloatArray2594[7])));
	float f_1457_ = ((f_1455_ * this.aClass233_7987.aFloatArray2594[8]) + (this.aClass233_7987.aFloatArray2594[12] + (this.aClass233_7987.aFloatArray2594[0] * f) + f_1454_ * (this.aClass233_7987.aFloatArray2594[4])));
	float f_1458_ = ((this.aClass233_7987.aFloatArray2594[5] * f_1454_) + (this.aClass233_7987.aFloatArray2594[1] * f + this.aClass233_7987.aFloatArray2594[13]) + (this.aClass233_7987.aFloatArray2594[9] * f_1455_));
	float f_1459_ = (f * this.aClass233_8000.aFloatArray2594[2] + this.aClass233_8000.aFloatArray2594[14] + (this.aClass233_8000.aFloatArray2594[6] * f_1454_) + (this.aClass233_8000.aFloatArray2594[10] * f_1455_));
	fs[0] = (f_1457_ * this.aFloat7993 / f_1456_ + this.aFloat8005);
	fs[1] = (this.aFloat7996 + this.aFloat7995 * f_1458_ / f_1456_);
	fs[2] = f_1459_;
    }
	...
	float f_1463_ = ((f_1462_ * this.aClass233_7987.aFloatArray2594[10]) + (this.aClass233_7987.aFloatArray2594[2] * f + this.aClass233_7987.aFloatArray2594[14] + (this.aClass233_7987.aFloatArray2594[6] * f_1461_)));
	float f_1464_ = ((f_1462_ * this.aClass233_7987.aFloatArray2594[11]) + (this.aClass233_7987.aFloatArray2594[15] + (this.aClass233_7987.aFloatArray2594[3] * f) + f_1461_ * (this.aClass233_7987.aFloatArray2594[7])));
	if (f_1463_ < -f_1464_ || f_1463_ > f_1464_) {
	    ...
	    float f_1467_ = (this.aClass233_7987.aFloatArray2594[12] + f * (this.aClass233_7987.aFloatArray2594[0]) + f_1461_ * (this.aClass233_7987.aFloatArray2594[4]) + f_1462_ * (this.aClass233_7987.aFloatArray2594[8]));
		...
		float f_1470_ = ((this.aClass233_7987.aFloatArray2594[5]) * f_1461_ + ((this.aClass233_7987.aFloatArray2594[13]) + f * (this.aClass233_7987.aFloatArray2594[1])) + (this.aClass233_7987.aFloatArray2594[9]) * f_1462_);
		if (f_1470_ < -f_1464_ || f_1470_ > f_1464_) {
		    ...
		    float f_1473_ = ((this.aClass233_8000.aFloatArray2594[10]) * f_1462_ + (f * (this.aClass233_8000.aFloatArray2594[2]) + (this.aClass233_8000.aFloatArray2594[14]) + (this.aClass233_8000.aFloatArray2594[6]) * f_1461_));
		    fs[0] = (this.aFloat8005 + (f_1467_ * this.aFloat7993 / f_1464_));
		    fs[1] = (this.aFloat7995 * f_1470_ / f_1464_) + this.aFloat7996;
		    fs[2] = f_1473_;
		}
	    }
	}
	...
	if (null != this.anIntArray7967) {
		...
		if (i_1476_ > i_1477_) {
		    ...
		    i_1476_ += i;
		    if (i < this.anInt7974 * -912871679) {
			i_1475_ += i_1480_ * ((this.anInt7974 * -912871679) - i);
			i = this.anInt7974 * -912871679;
		    }
		    if (i_1476_ >= this.anInt7991 * -1416794725)
			i_1476_ = (-1416794725 * this.anInt7991 - 1);
		    int i_1481_ = i_1478_ >>> 24;
		    if (i_1479_ == 0 || i_1479_ == 1 && i_1481_ == 255) {
			for (/**/; i <= i_1476_; i++) {
			    int i_1482_ = i_1475_ >> 16;
			    if (i_1482_ >= (-1278653805 * this.anInt7976) && i_1482_ < (this.anInt7977 * 63686679))
				this.anIntArray7967[i + i_1482_ * (692106883 * (this.anInt7971))] = i_1478_;
			    i_1475_ += i_1480_;
			}
		    } else if (1 == i_1479_) {
			...
			for (/**/; i <= i_1476_; i++) {
			    ...
			    if (i_1484_ >= (this.anInt7976 * -1278653805) && i_1484_ < (this.anInt7977 * 63686679)) {
				int i_1485_ = i + (i_1484_ * (this.anInt7971 * 692106883));
				int i_1486_ = (this.anIntArray7967[i_1485_]);
				i_1486_ = ((i_1483_ * (i_1486_ & 0xff00) >> 8 & 0xff00) + ((i_1486_ & 0xff00ff) * i_1483_ >> 8 & 0xff00ff));
				this.anIntArray7967[i_1485_] = i_1478_ + i_1486_;
			    }
			    i_1475_ += i_1480_;
			}
		    } else if (2 == i_1479_) {
			for (/**/; i <= i_1476_; i++) {
			    ...
			    if (i_1487_ >= (this.anInt7976 * -1278653805) && i_1487_ < (this.anInt7977 * 63686679)) {
				int i_1488_ = ((i_1487_ * (692106883 * this.anInt7971)) + i);
				int i_1489_ = (this.anIntArray7967[i_1488_]);
				...
				this.anIntArray7967[i_1488_] = i_1490_ - i_1489_ | i_1489_ - (i_1489_ >>> 8);
			    }
			    i_1475_ += i_1480_;
			}
		    } else
		    ...
		    i_1477_ += i_1475_;
		    if (i_1475_ < this.anInt7976 * -1278653805) {
			i += (this.anInt7976 * -1278653805 - i_1475_) * i_1492_;
			i_1475_ = this.anInt7976 * -1278653805;
		    }
		    if (i_1477_ >= 63686679 * this.anInt7977)
			i_1477_ = this.anInt7977 * 63686679 - 1;
		    int i_1493_ = i_1478_ >>> 24;
		    if (i_1479_ == 0 || i_1479_ == 1 && i_1493_ == 255) {
			for (/**/; i_1475_ <= i_1477_; i_1475_++) {
			    int i_1494_ = i >> 16;
			    if (i_1494_ >= (this.anInt7974 * -912871679) && i_1494_ < (this.anInt7991 * -1416794725))
				this.anIntArray7967[(this.anInt7971 * 692106883 * i_1475_) + i_1494_] = i_1478_;
			    i += i_1492_;
			}
		    } else if (1 == i_1479_) {
			...
			for (/**/; i_1475_ <= i_1477_; i_1475_++) {
			    int i_1496_ = i >> 16;
			    if (i_1496_ >= (-912871679 * this.anInt7974) && i_1496_ < -1416794725 * this.anInt7991) {
				int i_1497_ = (i_1496_ + (692106883 * this.anInt7971 * i_1475_));
				int i_1498_ = (this.anIntArray7967[i_1497_]);
				i_1498_ = ((i_1495_ * (i_1498_ & 0xff00ff) >> 8 & 0xff00ff) + (i_1495_ * (i_1498_ & 0xff00) >> 8 & 0xff00));
				this.anIntArray7967[i_1496_ + i_1475_ * (692106883 * this.anInt7971)] = i_1478_ + i_1498_;
			    }
			    i += i_1492_;
			}
		    } else if (2 == i_1479_) {
			for (/**/; i_1475_ <= i_1477_; i_1475_++) {
			    int i_1499_ = i >> 16;
			    if (i_1499_ >= (this.anInt7974 * -912871679) && i_1499_ < (this.anInt7991 * -1416794725)) {
				int i_1500_ = (i_1499_ + (i_1475_ * (this.anInt7971 * 692106883)));
				int i_1501_ = (this.anIntArray7967[i_1500_]);
				...
				this.anIntArray7967[i_1500_] = i_1502_ - i_1501_ | i_1501_ - (i_1501_ >>> 8);
			    }
			    i += i_1492_;
			}
		    } else
	...
	if (null != this.anIntArray7967) {
		...
		if (i_1509_ == 0)
		    ...
		    class2.anInt19 = 255 - (i_1507_ >>> 24);
		else
		    throw new IllegalArgumentException();
		RA(false);
		class2.aBoolean20 = (i_1521_ < 0 || i_1521_ > class2.anInt22 || i_1522_ < 0 || i_1522_ > class2.anInt22 || i_1523_ < 0 || i_1523_ > class2.anInt22);
		class2.method293(true, false, false, i_1525_, i_1526_, i_1527_, i_1521_, i_1522_, i_1523_, 100.0F, 100.0F, 100.0F, i_1507_);
		class2.aBoolean20 = (i_1521_ < 0 || i_1521_ > class2.anInt22 || i_1523_ < 0 || i_1523_ > class2.anInt22 || i_1524_ < 0 || i_1524_ > class2.anInt22);
		class2.method293(true, false, false, i_1525_, i_1527_, i_1528_, i_1521_, i_1523_, i_1524_, 100.0F, 100.0F, 100.0F, i_1507_);
		RA(true);
	    }
	}
    }
	...
	if (null != this.anIntArray7967) {
		...
		while (i_1535_ < i_1529_) {
		    ...
		    int i_1544_ = (i_1535_ * (692106883 * this.anInt7971) + i_1542_);
		...
		while (i_1535_ < i_1534_) {
		    ...
		    int i_1548_ = (i_1546_ + i_1535_ * (692106883 * this.anInt7971));
		...
		while (i_1535_ < i_1529_) {
		    ...
		    int i_1553_ = (i_1551_ + i_1535_ * (692106883 * this.anInt7971));
		...
		while (i_1535_ < i_1534_) {
		    ...
		    int i_1558_ = (i_1535_ * (692106883 * this.anInt7971) + i_1556_);
		...
		while (i_1535_ < i_1529_) {
		    ...
		    int i_1563_ = i_1561_ + (this.anInt7971 * 692106883 * i_1535_);
		...
		while (i_1535_ < i_1534_) {
		    ...
		    int i_1570_ = ((this.anInt7971 * 692106883 * i_1535_) + i_1568_);
	...
	this.anInt7989 = 1021645229 * i;
	this.anInt7990 = i_1575_ * 574739315;
	this.anInt7980 = 626158471 * i_1576_;
	this.anInt7969 = 370599731 * i_1577_;
	method5209();
    }
