...
public class Class10 {
    ...
    static final void method323(Class403 class403, int i) {
	try {
    ...
    static final void method324(Class403 class403, int i) {
	try {
	    Class359.method4295((class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]), (byte) 0);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method325(Class403 class403, byte i) {
	try {
	    System.out.println(class403.anObjectArray5240[((class403.anInt5241 -= 969361751) * -203050393)]);
	}
	catch (RuntimeException runtimeexception) {
