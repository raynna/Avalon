...
public class Class298_Sub32_Sub20 extends Class298_Sub32 {
	...
	if (aClass257_7384.aBoolean2810) {
		...
		int i_3_ = ((this.anInt9450 * -1845605287 * i_1_) >> 12);
		int i_4_ = ((this.anInt9451 * -1403879197 * i_2_) >> 12);
		int i_5_ = (this.anInt9450 * -1845605287 * (i_1_ % (4096 / (-1845605287 * this.anInt9450))));
		int i_6_ = (i_2_ % (4096 / (this.anInt9451 * -1403879197)) * (this.anInt9451 * -1403879197));
		if (i_6_ < this.anInt9449 * -881136511) {
		    ...
		    if (i_5_ < (this.anInt9449 * -881136511)) {
			is[i_0_] = 0;
			continue;
		    }
		}
	...
	try {
		...
		for (/**/; i_8_ < -1474554145 * Class250.anInt2755; i_8_++) {
		    ...
		    int i_11_ = ((this.anInt9450 * -1845605287 * i_9_) >> 12);
		    int i_12_ = ((this.anInt9451 * -1403879197 * i_10_) >> 12);
		    int i_13_ = (this.anInt9450 * -1845605287 * (i_9_ % (4096 / (-1845605287 * (this.anInt9450)))));
		    int i_14_ = (i_10_ % (4096 / (this.anInt9451 * -1403879197)) * (this.anInt9451 * -1403879197));
		    if (i_14_ < (this.anInt9449 * -881136511)) {
			...
			if (i_13_ < (this.anInt9449 * -881136511)) {
			    is[i_8_] = 0;
			    continue;
			}
		    }
	...
	try {
	    switch (i) {
		case 1:
		    this.anInt9451 = class298_sub53.readUnsignedByte() * 325240011;
		    break;
		case 2:
		    this.anInt9449 = class298_sub53.readUnsignedShort() * 1071731585;
		    break;
		case 0:
		    this.anInt9450 = class298_sub53.readUnsignedByte() * 1427389417;
		    break;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	if (aClass257_7384.aBoolean2810) {
		...
		int i_19_ = ((this.anInt9450 * -1845605287 * i_17_) >> 12);
		int i_20_ = ((this.anInt9451 * -1403879197 * i_18_) >> 12);
		int i_21_ = (this.anInt9450 * -1845605287 * (i_17_ % (4096 / (-1845605287 * this.anInt9450))));
		int i_22_ = (i_18_ % (4096 / (this.anInt9451 * -1403879197)) * (this.anInt9451 * -1403879197));
		if (i_22_ < this.anInt9449 * -881136511) {
		    ...
		    if (i_21_ < (this.anInt9449 * -881136511)) {
			is[i_16_] = 0;
			continue;
		    }
		}
