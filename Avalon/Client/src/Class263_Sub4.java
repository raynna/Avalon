...
public class Class263_Sub4 extends Class263 implements Interface9_Impl2_Impl1 {
	...
	OpenGL.glTexImage2Dub(this.anInt6415, 0, (Class_ra_Sub3_Sub1.method5533(this.aClass55_6419, this.aClass77_6420)), i, i_0_, 0, Class_ra_Sub3_Sub1.method5532(this.aClass55_6419), 5121, is, i_1_);
	...
	OpenGL.glTexImage2Df(this.anInt6415, 0, (Class_ra_Sub3_Sub1.method5533(this.aClass55_6419, this.aClass77_6420)), i, i_3_, 0, Class_ra_Sub3_Sub1.method5532(this.aClass55_6419), 5126, fs, i_4_ * 4);
	OpenGL.glPixelStorei(3314, 0);
    }
	...
	OpenGL.glTexSubImage2Di(this.anInt6415, 0, i, i_8_, i_9_, i_10_, 32993, (this.aClass_ra_Sub3_Sub1_6422).anInt9841, is, i_11_);
	if (i_9_ != i_12_)
	    OpenGL.glPixelStorei(3314, 0);
    }
	...
	OpenGL.glTexSubImage2Dub(this.anInt6415, 0, i, i_19_, i_20_, i_21_, Class_ra_Sub3_Sub1.method5532(class55), 5121, is, i_22_);
	if (i_23_ != i_20_)
	    OpenGL.glPixelStorei(3314, 0);
	OpenGL.glPixelStorei(3317, 4);
    }
	...
	this.aClass_ra_Sub3_Sub1_6422.method5358(this);
	OpenGL.glTexImage2Dub(this.anInt6415, 0, Class_ra_Sub3_Sub1.method5533((this.aClass55_6419), (this.aClass77_6420)), i, i_24_, 0, Class_ra_Sub3_Sub1.method5532(this.aClass55_6419), Class_ra_Sub3_Sub1.method5537(this.aClass77_6420), null, 0);
    }
	...
	OpenGL.glTexSubImage2Dub(this.anInt6415, 0, i, i_28_, i_29_, i_30_, Class_ra_Sub3_Sub1.method5532(class55), 5121, is, i_31_);
	if (i_32_ != i_29_)
	    OpenGL.glPixelStorei(3314, 0);
	OpenGL.glPixelStorei(3317, 4);
    }
	...
	OpenGL.glTexImage2Di(this.anInt6415, 0, 6408, this.anInt9954, this.anInt9953, 0, 32993, (this.aClass_ra_Sub3_Sub1_6422.anInt9841), is, i_34_ * 4);
	OpenGL.glPixelStorei(3314, 0);
    }
	...
	OpenGL.glTexSubImage2Di(this.anInt6415, 0, i, i_36_, i_37_, i_38_, 32993, (this.aClass_ra_Sub3_Sub1_6422).anInt9841, is, i_39_);
	if (i_37_ != i_40_)
	    OpenGL.glPixelStorei(3314, 0);
    }
	...
	OpenGL.glTexSubImage2Di(this.anInt6415, 0, i, i_41_, i_42_, i_43_, 32993, (this.aClass_ra_Sub3_Sub1_6422).anInt9841, is, i_44_);
	if (i_42_ != i_45_)
	    OpenGL.glPixelStorei(3314, 0);
    }
	...
	OpenGL.glTexSubImage2Dub(this.anInt6415, 0, i, i_46_, i_47_, i_48_, Class_ra_Sub3_Sub1.method5532(class55), 5121, is, i_49_);
	if (i_50_ != i_47_)
	    OpenGL.glPixelStorei(3314, 0);
	OpenGL.glPixelStorei(3317, 4);
    }
	...
	int[] is_61_ = new int[(this.anInt9954 * this.anInt9953)];
	this.aClass_ra_Sub3_Sub1_6422.method5358(this);
	OpenGL.glGetTexImagei(this.anInt6415, 0, 32993, 5121, is_61_, 0);
	for (int i_62_ = 0; i_62_ < i_59_; i_62_++)
	    System.arraycopy(is_61_, ((i_57_ + (i_59_ - 1) - i_62_) * this.anInt9954), is, i_60_ + i_62_ * i_58_, i_58_);
    }
	...
	int[] is_67_ = new int[(this.anInt9954 * this.anInt9953)];
	this.aClass_ra_Sub3_Sub1_6422.method5358(this);
	OpenGL.glGetTexImagei(this.anInt6415, 0, 32993, 5121, is_67_, 0);
	for (int i_68_ = 0; i_68_ < i_65_; i_68_++)
	    System.arraycopy(is_67_, ((i_63_ + (i_65_ - 1) - i_68_) * this.anInt9954), is, i_66_ + i_68_ * i_64_, i_64_);
    }
