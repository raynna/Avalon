...
public class Class422_Sub2 extends Class422 {
	...
	try {
	    if (aClass298_Sub48_5346.method3541((byte) -7) != Class411.game_rs)
	...
	if (aClass298_Sub48_5346.method3541((byte) -16) == Class411.game_rs)
	    return 1;
	return 3;
    }
	...
	try {
	    if (aClass298_Sub48_5346.method3541((byte) -10) == Class411.game_rs)
		return true;
	    return false;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (aClass298_Sub48_5346.method3541((byte) -75) == Class411.game_rs)
		return 1;
	    return 3;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method5630(Class403 class403, int i) {
	try {
	    int i_2_ = Class505.method6265(-1206667424);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (Class11.anInt156 = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-460463412) * 1970440745) * -1111444967;
