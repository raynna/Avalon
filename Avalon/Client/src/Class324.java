...
public class Class324 {
    ...
    static final void method3958(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
    ...
    static final void method3959(Class403 class403, int i) {
	try {
    ...
    static void method3960(Class403 class403, byte i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (null == class369.anIntArray4016 ? 0 : class369.anIntArray4016.length);
	}
	catch (RuntimeException runtimeexception) {
