...
public class Class74 {
    ...
    static final void method826(Class403 class403, int i) {
	try {
    ...
    static final void method827(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub18_7561.method5692((byte) 0) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method828(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub3_7556.method5632((byte) -40) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method829(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class201.method1902((byte) 89);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-1456138007) != 0) {
		Class301_Sub1.anInt7626 = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-993679742) * 485258093;
	...
	try {
	    float f = ((float) Class301.anInt3240 / (float) Class301.anInt3239);
	    int i_9_ = i_6_;
	    int i_10_ = i_7_;
	    if (f < 1.0F)
		i_10_ = (int) (f * i_6_);
	    ...
	    i -= (i_6_ - i_9_) / 2;
	    i_5_ -= (i_7_ - i_10_) / 2;
	    Class82_Sub14.anInt6875 = -2076584633 * (Class301.anInt3239 * i / i_9_);
	    Class376.anInt4090 = -435591305 * (Class301.anInt3240 - Class301.anInt3240 * i_5_ / i_10_);
	...
	try {
		...
		if (class19 != null && 0 != class19.anInt266 * 958933333 && client.ticketCycle * 443738891 % 20 < 10) {
			...
			if (null != class298_sub29) {
			    ...
			    Class397.method4914(class105, class117, i_12_, i_13_, i_16_, i_17_, -92466201 * class19.anInt258, 360000L);
			}
		    }
		    if (class19.anInt266 * 958933333 == 2) {
			int i_18_ = class19.anInt260 * -1338192389 / 128 - i / 128;
			int i_19_ = (class19.anInt261 * 1018128075 / 128 - i_11_ / 128);
			long l = class19.anInt257 * 2140036693 << 7;
			l *= l;
			...
			if (null != class365_sub1_sub1_sub2_sub2) {
			    ...
			    Class397.method4914(class105, class117, i_12_, i_13_, i_20_, i_21_, (class19.anInt258 * -92466201), 360000L);
			}
		    }
		}
	    }
