...
public class Class298_Sub32_Sub35 extends Class298_Sub32 {
	...
	try {
		...
		for (int i_7_ = 0; i_7_ < -1474554145 * Class250.anInt2755; i_7_++) {
		    int i_8_ = ((is_3_[i_7_] - is_1_[i_7_]) * (347966039 * this.anInt9550));
		    int i_9_ = (this.anInt9550 * 347966039 * (is_2_[i_7_ + 1 & -901777799 * Class250.anInt2753] - is_2_[(i_7_ - 1 & -901777799 * Class250.anInt2753)]));
		    int i_10_ = i_9_ >> 12;
		    int i_11_ = i_8_ >> 12;
		    int i_12_ = i_10_ * i_10_ >> 12;
		    int i_13_ = i_11_ * i_11_ >> 12;
		    int i_14_ = (int) (Math.sqrt((4096 + (i_13_ + i_12_)) / 4096.0F) * 4096.0);
		    int i_15_;
		    int i_16_;
		    int i_17_;
		    if (i_14_ != 0) {
	...
	try {
	    switch (i) {
		case 0:
		    this.anInt9550 = class298_sub53.readUnsignedShort() * 1837433191;
		    break;
		case 1:
		    this.aBoolean9552 = class298_sub53.readUnsignedByte() == 1;
		    break;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	if (aClass239_7380.aBoolean2607) {
		...
		int i_26_ = ((is_21_[i_25_] - is_19_[i_25_]) * (347966039 * this.anInt9550));
		int i_27_ = (this.anInt9550 * 347966039 * (is_20_[i_25_ + 1 & -901777799 * Class250.anInt2753] - (is_20_[i_25_ - 1 & -901777799 * Class250.anInt2753])));
		int i_28_ = i_27_ >> 12;
		int i_29_ = i_26_ >> 12;
		int i_30_ = i_28_ * i_28_ >> 12;
		int i_31_ = i_29_ * i_29_ >> 12;
		int i_32_ = (int) (Math.sqrt((4096 + (i_31_ + i_30_)) / 4096.0F) * 4096.0);
		int i_33_;
		int i_34_;
		int i_35_;
		if (i_32_ != 0) {
	...
	if (aClass239_7380.aBoolean2607) {
		...
		int i_43_ = ((is_38_[i_42_] - is_36_[i_42_]) * (347966039 * this.anInt9550));
		int i_44_ = (this.anInt9550 * 347966039 * (is_37_[i_42_ + 1 & -901777799 * Class250.anInt2753] - (is_37_[i_42_ - 1 & -901777799 * Class250.anInt2753])));
		int i_45_ = i_44_ >> 12;
		int i_46_ = i_43_ >> 12;
		int i_47_ = i_45_ * i_45_ >> 12;
		int i_48_ = i_46_ * i_46_ >> 12;
		int i_49_ = (int) (Math.sqrt((4096 + (i_48_ + i_47_)) / 4096.0F) * 4096.0);
		int i_50_;
		int i_51_;
		int i_52_;
		if (i_49_ != 0) {
