...
public class Class317 {
	...
	this.aClass243_3319 = class243;
	this.aClass243_3319.method2316((-1006924897 * (Class120.aClass120_1434.anInt1460)), -1713499559);
    }
	...
	try {
	    ...
	    if (class325.anIntArray3451 != null) {
		class276s = (new Class276[class325.anIntArray3451.length]);
		for (int i_4_ = 0; i_4_ < class276s.length; i_4_++) {
		    Class125 class125 = class131.method1467((class325.anIntArray3451[i_4_]), -1248511043);
	    ...
	    return new Class277(-1474936555 * class325.anInt3450, class276s, -1877970137 * class325.anInt3449, i_0_, i_1_, i_2_, class325.aClass320_3452, class325.anInt3453 * -630450499);
	}
	...
	try {
	    synchronized (this.aClass348_3320) {
		this.aClass348_3320.method4187();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    synchronized (this.aClass348_3320) {
		this.aClass348_3320.method4186(i, 21848590);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    synchronized (this.aClass348_3320) {
		this.aClass348_3320.method4189();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class325 class325;
	    synchronized (this.aClass348_3320) {
		class325 = (Class325) this.aClass348_3320.method4184(i);
	    }
	    if (class325 != null)
		return class325;
	    byte[] is;
	    synchronized (this.aClass243_3319) {
		is = (this.aClass243_3319.getFile(Class120.aClass120_1434.anInt1460 * -1006924897, i));
	    }
	    class325 = new Class325();
	    if (null != is)
		class325.method3962(new RsByteBuffer(is), (byte) -47);
	    synchronized (this.aClass348_3320) {
		this.aClass348_3320.method4194(class325, i);
	    }
	    return class325;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method3850(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -1567522756;
	    class105.anInt1151 = (-1825442367 * (class403.anIntArray5244[681479919 * class403.anInt5239]));
	    class105.anInt1140 = ((class403.anIntArray5244[1 + class403.anInt5239 * 681479919]) * 908204397);
	    if (1 == (class403.anIntArray5244[681479919 * class403.anInt5239 + 2]))
		class105.anInt1184 = -886348599;
	    else
		class105.anInt1184 = 643790344;
	    if ((class403.anIntArray5244[class403.anInt5239 * 681479919 + 3]) == 1)
		class105.aBoolean1213 = true;
	    else
		class105.aBoolean1213 = false;
	    if (-1 == class105.anInt1154 * -1309843523 && !class119.aBoolean1403)
		Class422.method5623(class105.ihash * -440872681, 1592451280);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method3851(Class403 class403, int i) {
	try {
	    if (client.aString8656 != null)
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = client.aString8656;
	    else
    ...
    static final void method3852(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (class105_8_ == null ? -1 : -440872681 * class105_8_.ihash);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method3854(Class403 class403, int i) {
	try {
	    int i_9_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_9_ >> 28;
	}
	catch (RuntimeException runtimeexception) {
