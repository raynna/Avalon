...
public class Class14 {
    static int anInt168;
    static IndexedImage[] aClass89Array169;
    static int anInt170;
    ...
    static final void method342(Class403 class403, int i) {
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub30_7575, (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) != 0 ? 1 : 0, -261887884);
    ...
    static final void method343(Class403 class403, int i) {
	try {
    ...
    static final void method345(Class403 class403, int i) {
	try {
	...
	try {
		...
		Class365_Sub1_Sub1_Sub1 class365_sub1_sub1_sub1 = (class298_sub37_sub2.aClass365_Sub1_Sub1_Sub1_9577);
		if (443738891 * client.ticketCycle > class365_sub1_sub1_sub1.anInt10049 * -1349988959) {
			...
			if (null != class365_sub1_sub1_sub2_sub2) {
				...
				class365_sub1_sub1_sub1.method4405((int) class217.aFloat2451, (int) class217.aFloat2454, ((Class356.method4271((int) class217.aFloat2451, (int) class217.aFloat2454, class365_sub1_sub1_sub1.plane, -1135065402)) - (class365_sub1_sub1_sub1.anInt10045 * 2134079017)), 443738891 * client.ticketCycle, 1831333850);
			}
		    }
