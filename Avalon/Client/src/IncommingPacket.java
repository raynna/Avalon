...
public class IncommingPacket {
	...
	ITEM_ON_ICOMPONENT_PACKET = new IncommingPacket(152, 11);
	...
	SYSTEM_TRAY_MESSAGE_PACKET = new IncommingPacket(160, -2);
	CUSTOM_PACKET_161 = new IncommingPacket(161, 1);
		DEVELOPER_PACKET = new IncommingPacket(162, 1);
    }
	...
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub3_7556, (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) == 1 ? 1 : 0, -802327901);
	...
	try {
	    ...
	    class298_sub36.out.writeInt(i_5_, -1055367891);
