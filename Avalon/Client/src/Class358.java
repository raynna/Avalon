...
public class Class358 {
	...
	try {
		...
		this.anInt3855 = class298_sub53.readBigSmart(1235052657) * 315680607;
	    else if (i == 4)
		this.anInt3857 = class298_sub53.readBigSmart(1235052657) * -1871987079;
	    else if (i == 5)
		this.anInt3860 = class298_sub53.readBigSmart(1235052657) * -1006502127;
	    else if (i == 6)
		this.anInt3858 = class298_sub53.readBigSmart(1235052657) * -818871601;
	    else if (i == 7)
		anInt3859 = class298_sub53.readShort(1738296677) * -1393539651;
	    else if (8 == i) {
		this.aString3846 = class298_sub53.readJagString(681479919);
	    } else if (9 == i)
	...
	try {
	    String string = this.aString3846;
	    for (;;) {
	...
	this.anInt3855 = -315680607;
	this.anInt3860 = 1006502127;
	this.anInt3857 = 1871987079;
	this.anInt3858 = 818871601;
	anInt3859 = 0;
	anInt3852 = 0;
	anInt3861 = -310090321;
	this.aString3846 = "";
    ...
    static final void method4285(Class403 class403, short i) {
	try {
	    class403.anInt5239 -= -1175642067;
	    Class86.method967((class403.anIntArray5244[681479919 * class403.anInt5239]), (class403.anIntArray5244[(class403.anInt5239 * 681479919 + 1)]), (class403.anIntArray5244[2 + (class403.anInt5239 * 681479919)]), -507940004);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static void method4286(Class403 class403, int i) {
	try {
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = (Class316.aClass362_3318.method4307((class403.anIntArray5244[class403.anInt5239 * 681479919 - 2]), 245040087).aStringArray4022[(class403.anIntArray5244[class403.anInt5239 * 681479919 - 1])]);
    ...
    static final void method4289(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_7_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    int i_8_ = (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]);
	    if (i_7_ == 0)
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = 0;
	    else if (i_8_ == 0)
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = 2147483647;
	    else
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = (int) Math.pow(i_7_, 1.0 / i_8_);
	}
	catch (RuntimeException runtimeexception) {
