...
public class Class298_Sub48 extends Class298 {
    ...
    public Class422_Sub13 aClass422_Sub13_7550;
    ...
    public ScreenSizePreference screenSizePreference;
    ...
    public Class422_Sub14 aClass422_Sub14_7571;
    ...
    public GraphicsPresetPreference aClass422_Sub23_7576;
	...
	try {
	    System.out.println("Class298_Sub48 - method3536 - line 52");
	    aClass422_Sub13_7549.method5673((byte) 52);
	    aClass422_Sub13_7550.method5673((byte) 99);
	    ...
	    screenSizePreference.method5652((short) 769);
	    ...
	    aClass422_Sub14_7571.method5678((byte) -80);
	...
	try {
	    System.out.println("Class298_Sub48 - method3537 - line 99");
	    if (bool || aClass422_Sub13_7549 == null)
		aClass422_Sub13_7549 = new Class422_Sub13(this);
	    if (bool || aClass422_Sub13_7550 == null)
		aClass422_Sub13_7550 = new Class422_Sub13(aClass422_Sub13_7549.method5675(-2009967400), this);
	    if (bool || null == aClass422_Sub6_7551)
		aClass422_Sub6_7551 = new Class422_Sub6(this);
	    if (bool || null == aClass422_Sub1_7552)
		aClass422_Sub1_7552 = new Class422_Sub1(this);
	    if (bool || null == aClass422_Sub11_7558)
	    ...
	    if (bool || null == screenSizePreference)
		screenSizePreference = new ScreenSizePreference(0, this);
	    if (bool || aClass422_Sub19_7567 == null)
		aClass422_Sub19_7567 = new Class422_Sub19(this);
	    if (bool || null == aClass422_Sub18_7561)
		aClass422_Sub18_7561 = new Class422_Sub18(this);
	    if (bool || null == aClass422_Sub16_7557)
		aClass422_Sub16_7557 = new Class422_Sub16(this);
	    if (bool || null == aClass422_Sub14_7570)
		aClass422_Sub14_7570 = new Class422_Sub14(this);
	    if (bool || aClass422_Sub14_7571 == null)
		aClass422_Sub14_7571 = new Class422_Sub14(aClass422_Sub14_7570.method5677(-1476305765), this);
	    if (bool || aClass422_Sub5_7572 == null)
	    ...
	    if (bool || null == aClass422_Sub30_7575)
		aClass422_Sub30_7575 = new Class422_Sub30(this);
	    if (bool || null == aClass422_Sub23_7576)
		aClass422_Sub23_7576 = new GraphicsPresetPreference(this);
	    if (bool || aClass422_Sub26_7577 == null)
		aClass422_Sub26_7577 = new Class422_Sub26(this);
	    if (bool || null == aClass422_Sub20_7578)
		aClass422_Sub20_7578 = new Class422_Sub20(this);
	    if (bool || null == aClass422_Sub27_7579)
    ...
    void method3538(RsByteBuffer class298_sub53, int i, int i_0_) {
	try {
	    System.out.println("Class298_Sub48 - method3538 - line 183");
	    ...
	    if (i >= 6)
		aClass422_Sub12_7543 = new Class422_Sub12(class298_sub53.readUnsignedByte(), this);
	    if (i >= 7)
	    ...
	    if (i >= 18)
		aClass422_Sub23_7576 = new GraphicsPresetPreference(class298_sub53.readUnsignedByte(), this);
	    if (i >= 19)
		screenSizePreference = new ScreenSizePreference(class298_sub53.readUnsignedByte(), this);//1 fixed, 2 resizable
	    if (i >= 22)
    ...
    public void method3540(Class422 class422, int i, int i_4_) {
	try {
    ...
    public RsByteBuffer method3542(int i) {
	try {
	    System.out.println("Class298_Sub48 - method3542 - line 299");
	    RsByteBuffer class298_sub53 = new RsByteBuffer(40);
	    class298_sub53.writeByte(27);
	    ...
	    class298_sub53.writeByte(screenSizePreference.method5654(-1747444886));
	    ...
	    class298_sub53.writeByte(aClass422_Sub12_7543.method5669((byte) 99));
    ...
    void method3544(RsByteBuffer packet, int i) {
	try {
	    if (packet == null || null == packet.buffer)
		method3537(true, -273116061);
	    else {
		int i_5_ = packet.readUnsignedByte();
		if (i_5_ < 23) {
		    try {
			method3538(packet, i_5_, 1254790663);
		    }
		    ...
		    aClass422_Sub13_7549 = new Class422_Sub13(packet.readUnsignedByte(), this);
		    aClass422_Sub13_7550 = new Class422_Sub13(aClass422_Sub13_7549.method5675(-1467162774), this);
		    aClass422_Sub6_7551 = new Class422_Sub6(packet.readUnsignedByte(), this);
		    aClass422_Sub1_7552 = new Class422_Sub1(packet.readUnsignedByte(), this);
		    aClass422_Sub11_7558 = new Class422_Sub11(packet.readUnsignedByte(), this);
		    if (i_5_ >= 27)
			aClass422_Sub24_7554 = new Class422_Sub24(packet.readUnsignedByte(), this);
		    aClass422_Sub9_7555 = new Class422_Sub9(packet.readUnsignedByte(), this);
		    aClass422_Sub3_7556 = new Class422_Sub3(packet.readUnsignedByte(), this);
		    aClass422_Sub28_7573 = new Class422_Sub28(packet.readUnsignedByte(), this);
		    aClass422_Sub2_7547 = new Class422_Sub2(packet.readUnsignedByte(), this);
		    aClass422_Sub25_7569 = new Class422_Sub25(packet.readUnsignedByte(), this);
		    aClass422_Sub15_7560 = new Class422_Sub15(packet.readUnsignedByte(), this);
		    aClass422_Sub7_7581 = new Class422_Sub7(packet.readUnsignedByte(), this);
		    if (i_5_ >= 24)
			aClass422_Sub10_7548 = new Class422_Sub10(packet.readUnsignedByte(), this);
		    aClass422_Sub4_7563 = new Class422_Sub4(packet.readUnsignedByte(), this);
		    aClass422_Sub17_7564 = new Class422_Sub17(packet.readUnsignedByte(), this);
		    aClass422_Sub17_7565 = new Class422_Sub17(aClass422_Sub17_7564.method5689(-2013953489), this);
		    screenSizePreference = new ScreenSizePreference(packet.readUnsignedByte(), this);//fixed 1, resizable 2
		    if (i_5_ >= 25)
			aClass422_Sub19_7567 = new Class422_Sub19(packet.readUnsignedByte(), this);
		    aClass422_Sub18_7561 = new Class422_Sub18(packet.readUnsignedByte(), this);
		    if (i_5_ <= 25)
			packet.index += 116413311;
		    aClass422_Sub16_7557 = new Class422_Sub16(packet.readUnsignedByte(), this);
		    aClass422_Sub14_7570 = new Class422_Sub14(packet.readUnsignedByte(), this);
		    aClass422_Sub14_7571 = new Class422_Sub14(aClass422_Sub14_7570.method5677(-1765693260), this);
		    packet.readUnsignedByte();
		    aClass422_Sub5_7572 = new Class422_Sub5(packet.readUnsignedByte(), this);
		    ...
		    aClass422_Sub30_7575 = new Class422_Sub30(packet.readUnsignedByte(), this);
		    aClass422_Sub23_7576 = new GraphicsPresetPreference(packet.readUnsignedByte(), this);
		    aClass422_Sub26_7577 = new Class422_Sub26(packet.readUnsignedByte(), this);
		    aClass422_Sub20_7578 = new Class422_Sub20(packet.readUnsignedByte(), this);
		    aClass422_Sub27_7579 = new Class422_Sub27(packet.readUnsignedByte(), this);
		    if (i_5_ >= 26)
			aClass422_Sub21_7580 = new Class422_Sub21(packet.readUnsignedByte(), this);
		    aClass422_Sub29_7553 = new Class422_Sub29(packet.readUnsignedByte(), this);
		    aClass422_Sub29_7582 = new Class422_Sub29(packet.readUnsignedByte(), this);
		    aClass422_Sub29_7583 = new Class422_Sub29(packet.readUnsignedByte(), this);
		    aClass422_Sub29_7584 = new Class422_Sub29(packet.readUnsignedByte(), this);
		    aClass422_Sub29_7587 = new Class422_Sub29(packet.readUnsignedByte(), this);
    ...
    public Class298_Sub48(Class411 class411, int i) {
	this.aClass411_7568 = class411;
	this.aClass417_7562 = new Class417(Class291.maximumMemory * 1126040225, Class291.availableCPU * 1090452523, (Class344.aString3687.toLowerCase().indexOf("arm") != -1));
	aClass422_Sub14_7571 = new Class422_Sub14(i, this);
	method3537(true, -214971626);
    }

    public Class298_Sub48(RsByteBuffer class298_sub53, Class411 class411, int i) {
	this.aClass411_7568 = class411;
	this.aClass417_7562 = new Class417(Class291.maximumMemory * 1126040225, 1090452523 * Class291.availableCPU, Class344.aString3687.indexOf("arm") != -1);
	aClass422_Sub14_7571 = new Class422_Sub14(i, this);
