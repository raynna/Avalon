...
public class Class298_Sub32_Sub17 extends Class298_Sub32 {
	...
	try {
		...
		int i_1_ = ((-1818338063 * this.anInt9429 * Class250.anIntArray2760[i]) + 2048);
		int i_2_ = i_1_ >> 12;
		int i_3_ = 1 + i_2_;
		for (int i_4_ = 0; i_4_ < Class250.anInt2755 * -1474554145; i_4_++) {
		    ...
		    int i_5_ = ((883178403 * this.anInt9428 * Class250.anIntArray2762[i_4_]) + 2048);
		    int i_6_ = i_5_ >> 12;
		    int i_7_ = 1 + i_6_;
		    for (int i_8_ = i_2_ - 1; i_8_ <= i_3_; i_8_++) {
			int i_9_ = ((this.aByteArray9418[(i_8_ >= -1818338063 * this.anInt9429 ? i_8_ - (this.anInt9429) * -1818338063 : i_8_) & 0xff]) & 0xff);
			for (int i_10_ = i_6_ - 1; i_10_ <= i_7_; i_10_++) {
			    int i_11_ = (((this.aByteArray9418[(i_10_ >= (this.anInt9428) * 883178403 ? i_10_ - (this.anInt9428) * 883178403 : i_10_) + i_9_ & 0xff]) & 0xff) * 2);
			    int i_12_ = i_5_ - ((this.aShortArray9415[i_11_++]) + (i_10_ << 12));
			    int i_13_ = i_1_ - ((i_8_ << 12) + (this.aShortArray9415[i_11_]));
			    int i_14_;
			    switch (this.anInt9431 * -1013656491) {
				case 5:
				    i_12_ *= i_12_;
				    i_13_ *= i_13_;
				    i_14_ = (int) ((Math.sqrt(Math.sqrt((i_12_ + i_13_) / 1.6777216E7F))) * 4096.0);
				    break;
				default:
				    i_14_ = (int) ((Math.sqrt((i_13_ * i_13_ + (i_12_ * i_12_)) / 1.6777216E7F)) * 4096.0);
				    break;
				case 1:
				    i_14_ = i_12_ * i_12_ + i_13_ * i_13_ >> 12;
				    break;
				case 4:
				    i_12_ = (int) ((Math.sqrt((i_12_ < 0 ? -i_12_ : i_12_) / 4096.0F)) * 4096.0);
				    i_13_ = (int) ((Math.sqrt((i_13_ < 0 ? -i_13_ : i_13_) / 4096.0F)) * 4096.0);
				    i_14_ = i_13_ + i_12_;
		    ...
		    switch (-94219657 * this.anInt9430) {
			case 1:
	...
	try {
	    this.aByteArray9418 = Class250.method2395(35399273 * (this.anInt9426), (byte) 47);
    ...
    void method3235() {
	this.aByteArray9418 = Class250.method2395((35399273 * this.anInt9426), (byte) 50);
	method3236(-975250951);
    }

    void method3236(int i) {
	try {
	    Random random = new Random(this.anInt9426 * 35399273);
	    this.aShortArray9415 = new short[512];
	    if (this.anInt9427 * -1261812447 > 0) {
		for (int i_15_ = 0; i_15_ < 512; i_15_++)
		    this.aShortArray9415[i_15_] = (short) (Class298_Sub19_Sub3.method3039(random, -1261812447 * this.anInt9427, (byte) 14));
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	if (aClass257_7384.aBoolean2810) {
	    int i_16_ = ((-1818338063 * this.anInt9429 * Class250.anIntArray2760[i]) + 2048);
	    int i_17_ = i_16_ >> 12;
	    int i_18_ = 1 + i_17_;
		...
		Class411.anInt5325 = -586878723;
		Class298_Sub32_Sub23.anInt9477 = -1158324685;
		int i_20_ = ((883178403 * this.anInt9428 * Class250.anIntArray2762[i_19_]) + 2048);
		int i_21_ = i_20_ >> 12;
		int i_22_ = 1 + i_21_;
		for (int i_23_ = i_17_ - 1; i_23_ <= i_18_; i_23_++) {
		    int i_24_ = (this.aByteArray9418[(i_23_ >= -1818338063 * this.anInt9429 ? i_23_ - (this.anInt9429 * -1818338063) : i_23_) & 0xff]) & 0xff;
		    for (int i_25_ = i_21_ - 1; i_25_ <= i_22_; i_25_++) {
			int i_26_ = (((this.aByteArray9418[(i_25_ >= (this.anInt9428) * 883178403 ? i_25_ - (this.anInt9428) * 883178403 : i_25_) + i_24_ & 0xff]) & 0xff) * 2);
			int i_27_ = i_20_ - ((this.aShortArray9415[i_26_++]) + (i_25_ << 12));
			int i_28_ = i_16_ - ((i_23_ << 12) + (this.aShortArray9415[i_26_]));
			int i_29_;
			switch (this.anInt9431 * -1013656491) {
			    case 5:
				i_27_ *= i_27_;
				i_28_ *= i_28_;
				i_29_ = (int) (Math.sqrt(Math.sqrt((i_27_ + i_28_) / 1.6777216E7F)) * 4096.0);
				break;
			    default:
				i_29_ = (int) ((Math.sqrt((i_28_ * i_28_ + i_27_ * i_27_) / 1.6777216E7F)) * 4096.0);
				break;
			    case 1:
				i_29_ = i_27_ * i_27_ + i_28_ * i_28_ >> 12;
				break;
			    case 4:
				i_27_ = (int) (Math.sqrt((i_27_ < 0 ? -i_27_ : i_27_) / 4096.0F) * 4096.0);
				i_28_ = (int) (Math.sqrt((i_28_ < 0 ? -i_28_ : i_28_) / 4096.0F) * 4096.0);
				i_29_ = i_28_ + i_27_;
	...
	if (aClass257_7384.aBoolean2810) {
	    int i_30_ = ((-1818338063 * this.anInt9429 * Class250.anIntArray2760[i]) + 2048);
	    int i_31_ = i_30_ >> 12;
	    int i_32_ = 1 + i_31_;
		...
		Class411.anInt5325 = -586878723;
		Class298_Sub32_Sub23.anInt9477 = -1158324685;
		int i_34_ = ((883178403 * this.anInt9428 * Class250.anIntArray2762[i_33_]) + 2048);
		int i_35_ = i_34_ >> 12;
		int i_36_ = 1 + i_35_;
		for (int i_37_ = i_31_ - 1; i_37_ <= i_32_; i_37_++) {
		    int i_38_ = (this.aByteArray9418[(i_37_ >= -1818338063 * this.anInt9429 ? i_37_ - (this.anInt9429 * -1818338063) : i_37_) & 0xff]) & 0xff;
		    for (int i_39_ = i_35_ - 1; i_39_ <= i_36_; i_39_++) {
			int i_40_ = (((this.aByteArray9418[(i_39_ >= (this.anInt9428) * 883178403 ? i_39_ - (this.anInt9428) * 883178403 : i_39_) + i_38_ & 0xff]) & 0xff) * 2);
			int i_41_ = i_34_ - ((this.aShortArray9415[i_40_++]) + (i_39_ << 12));
			int i_42_ = i_30_ - ((i_37_ << 12) + (this.aShortArray9415[i_40_]));
			int i_43_;
			switch (this.anInt9431 * -1013656491) {
			    case 5:
				i_41_ *= i_41_;
				i_42_ *= i_42_;
				i_43_ = (int) (Math.sqrt(Math.sqrt((i_41_ + i_42_) / 1.6777216E7F)) * 4096.0);
				break;
			    default:
				i_43_ = (int) ((Math.sqrt((i_42_ * i_42_ + i_41_ * i_41_) / 1.6777216E7F)) * 4096.0);
				break;
			    case 1:
				i_43_ = i_41_ * i_41_ + i_42_ * i_42_ >> 12;
				break;
			    case 4:
				i_41_ = (int) (Math.sqrt((i_41_ < 0 ? -i_41_ : i_41_) / 4096.0F) * 4096.0);
				i_42_ = (int) (Math.sqrt((i_42_ < 0 ? -i_42_ : i_42_) / 4096.0F) * 4096.0);
				i_43_ = i_42_ + i_41_;
	...
	try {
	    switch (i) {
		case 5:
		    this.anInt9428 = class298_sub53.readUnsignedByte() * -648032245;
		    break;
		case 6:
		    this.anInt9429 = class298_sub53.readUnsignedByte() * 2059998225;
		    break;
		case 4:
		    this.anInt9431 = class298_sub53.readUnsignedByte() * -1784051459;
		    break;
		case 2:
		    this.anInt9427 = class298_sub53.readUnsignedShort() * 1389592289;
		    break;
		case 3:
		    this.anInt9430 = class298_sub53.readUnsignedByte() * -1527961785;
		    break;
		case 1:
		    this.anInt9426 = class298_sub53.readUnsignedByte() * -893138471;
		    break;
		case 0:
		    this.anInt9428 = ((this.anInt9429 = class298_sub53.readUnsignedByte() * 2059998225) * -910111141);
		    break;
	    }
	}
	catch (RuntimeException runtimeexception) {
    ...
    void method3239() {
	this.aByteArray9418 = Class250.method2395((35399273 * this.anInt9426), (byte) -59);
	method3236(1419756353);
    }

    public Class298_Sub32_Sub17() {
	super(0, true);
	this.aByteArray9418 = new byte[512];
	this.aShortArray9415 = new short[512];
    }
    ...
    void method3242() {
	this.aByteArray9418 = Class250.method2395((35399273 * this.anInt9426), (byte) -39);
