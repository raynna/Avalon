...
public class Class477 {
	...
	try {
		...
		synchronized (this.aClass348_5993) {
		    itemdefinition = (ItemDefinitions) this.aClass348_5993.method4184(itemId);
		}
		...
		is = (this.index19.getFile(Class120.aClass120_1429.method1307(itemId + (Class298_Sub32_Sub14.aClass477_9400.itemDefinitionsLength * -888767613), -100335020), Class120.aClass120_1429.method1305(itemId + (Class298_Sub32_Sub14.aClass477_9400.itemDefinitionsLength * -888767613), -1698958016)));
		oldItem = true;
	    }
	    if (is == null) {
		synchronized (this.index19) {
		    is = (this.index19.getFile(Class120.aClass120_1429.method1307(itemId, -100335020), Class120.aClass120_1429.method1305(itemId, -1698958016)));
		    oldItem = false;
		}
	    }
	    itemdefinition = new ItemDefinitions();
	    itemdefinition.aClass477_5751 = this;
	    itemdefinition.anInt5740 = 1824752127 * itemId;
	    itemdefinition.aStringArray5723 = this.aStringArray5988.clone();
	    itemdefinition.aStringArray5732 = this.aStringArray6000.clone();
	    if (null != is && !itemdefinition.name.toLowerCase().contains("tinderbox") && itemdefinition.id != 13663)
		...
		itemdefinition.method6039(getItemDefinitions(itemdefinition.anInt5719 * 465190555, forceNew), getItemDefinitions((-783380935 * (itemdefinition.anInt5756)), forceNew), -1676050822);
	    if (-1 != 2083650097 * itemdefinition.anInt5770)
		itemdefinition.method6036(getItemDefinitions(itemdefinition.anInt5770 * 2083650097, forceNew), getItemDefinitions((1981372535 * (itemdefinition.anInt5769)), forceNew), -1733915014);
	    if (!this.aBoolean5999 && itemdefinition.aBoolean5731) {
		itemdefinition.anInt5700 = 0;
		itemdefinition.aStringArray5723 = this.aStringArray5988;
		itemdefinition.aStringArray5732 = this.aStringArray6000;
		itemdefinition.aBoolean5734 = false;
		itemdefinition.anIntArray5767 = null;
		if (null != itemdefinition.aClass437_5766) {
		    boolean bool = false;
		    for (Class298 class298 = itemdefinition.aClass437_5766.method5816(1739772889); class298 != null; class298 = itemdefinition.aClass437_5766.method5815((byte) -94)) {
			Class497 class497 = (this.aClass504_5989.method6251((int) (class298.hash * 7051297995265073167L), -1474104007));
		    ...
		    if (!bool)
			itemdefinition.aClass437_5766 = null;
		}
	    }
	    synchronized (this.aClass348_5993) {
    ...
    /*
     * public ItemDefinitions getItemDefinitions(int itemId) { try {
     * ItemDefinitions itemdefinition; synchronized (((Class477)
     * this).aClass348_5993) { itemdefinition = (ItemDefinitions) ((Class477)
     * this).aClass348_5993.method4184((long) itemId); } if (itemdefinition !=
     * null) return itemdefinition; byte[] data; synchronized (((Class477)
     * this).index19) { data = (((Class477)
     * this).index19.getFile(Class120.aClass120_1429.method1307(itemId,
     * -100335020), Class120.aClass120_1429.method1305(itemId, -1698958016))); }
     * itemdefinition = new ItemDefinitions(); itemdefinition.id = itemId;
     * ((ItemDefinitions) itemdefinition).aClass477_5751 = this;
     * ((ItemDefinitions) itemdefinition).anInt5740 = 1824752127 * itemId;
     * itemdefinition.aStringArray5723 = (String[]) ((Class477)
     * this).aStringArray5988.clone(); itemdefinition.aStringArray5732 =
     * (String[]) ((Class477) this).aStringArray6000.clone(); if (null != data)
     * { itemdefinition.decode(new RsByteBuffer(data)); } if (OLD_ITEMS ||
     * itemdefinition.name.contains("shortbow")) itemdefinition.setOldDefs();
     * itemdefinition.method6025(16711935); if (-1 != itemdefinition.anInt5755 *
     * -1673957995)
     * itemdefinition.method6027(getItemDefinitions((itemdefinition.anInt5755 *
     * -1673957995)), getItemDefinitions(809765849 * itemdefinition.anInt5709),
     * 219692629); if (itemdefinition.anInt5719 * 465190555 != -1)
     * itemdefinition.method6039(getItemDefinitions(itemdefinition.anInt5719 *
     * 465190555), getItemDefinitions((-783380935 * (((ItemDefinitions)
     * itemdefinition).anInt5756))), -1676050822); if (-1 != 2083650097 *
     * itemdefinition.anInt5770)
     * itemdefinition.method6036(getItemDefinitions(itemdefinition.anInt5770 *
     * 2083650097), getItemDefinitions((1981372535 * (((ItemDefinitions)
     * itemdefinition).anInt5769))), -1733915014); if (!((Class477)
     * this).aBoolean5999 && itemdefinition.aBoolean5731) {
     * itemdefinition.anInt5700 = 0; itemdefinition.aStringArray5723 =
     * ((Class477) this).aStringArray5988; itemdefinition.aStringArray5732 =
     * ((Class477) this).aStringArray6000; itemdefinition.aBoolean5734 = false;
     * itemdefinition.anIntArray5767 = null; if (null != ((ItemDefinitions)
     * itemdefinition).aClass437_5766) { boolean bool = false; for (Class298
     * class298 = ((ItemDefinitions)
     * itemdefinition).aClass437_5766.method5816(1739772889); class298 != null;
     * class298 = ((ItemDefinitions)
     * itemdefinition).aClass437_5766.method5815((byte) -94)) { Class497
     * class497 = (((Class477) this).aClass504_5989.method6251((int)
     * (class298.hash * 7051297995265073167L), -1474104007)); if
     * (class497.aBoolean6102) class298.method2839(-1460969981); else bool =
     * true; } if (!bool) ((ItemDefinitions) itemdefinition).aClass437_5766 =
     * null; } } synchronized (((Class477) this).aClass348_5993) { ((Class477)
     * this).aClass348_5993.method4194(itemdefinition, (long) itemId); } return
     * itemdefinition; } catch (RuntimeException runtimeexception) { throw
     * Class346.method4175(runtimeexception, new
	...
	try {
		...
		for (int i_14_ = 0; i_14_ < 10; i_14_++) {
		    if (i_7_ >= class468.anIntArray5753[i_14_] && 0 != class468.anIntArray5753[i_14_])
			i_13_ = class468.anIntArray5752[i_14_];
		}
		if (i_13_ != -1)
		...
		class465.anInt6515 = i_7_ * -1199949713;
	...
	try {
		...
		this.aClass348_5994.method4187();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    synchronized (this.aClass348_5993) {
		this.aClass348_5993.method4187();
	    }
	    synchronized (this.aClass348_5994) {
		this.aClass348_5994.method4187();
	    }
	...
	this.aClass411_5998 = class411;
	this.aClass429_5997 = class429;
	this.aBoolean5999 = bool;
	this.aClass504_5989 = class504;
	this.index19 = class243;
	this.aClass243_5992 = class243_16_;
	if (null != this.index19) {
	    int i = this.index19.method2296(1070333047) - 1;
	    if (true)
		itemDefinitionsLength = 30000 * -1797723349;
	    else
		itemDefinitionsLength = (i * Class120.aClass120_1429.method1306((short) 15063) + this.index19.method2316(i, -1996628421)) * -1797723349;
	} else
	    itemDefinitionsLength = 0;
	if (this.aClass411_5998 == Class411.game_rs)
	    this.aStringArray5988 = (new String[] { null, null, Tradution.aClass470_5790.method6049((this.aClass429_5997), -875414210), null, null, Tradution.aClass470_5905.method6049((this.aClass429_5997), -875414210) });
	else
	    this.aStringArray5988 = (new String[] { null, null, Tradution.aClass470_5790.method6049((this.aClass429_5997), -875414210), null, null, null });
	this.aStringArray6000 = (new String[] { null, null, null, null, Tradution.aClass470_5939.method6049((this.aClass429_5997), -875414210) });
    }

    public void method6090(int i, byte i_17_) {
	try {
	    synchronized (this.aClass348_5993) {
		this.aClass348_5993.method4186(i, -2090918778);
	    }
	    synchronized (this.aClass348_5994) {
		this.aClass348_5994.method4186(i, -1948181413);
	    }
	    synchronized (aClass340_5995) {
	...
	try {
	    synchronized (this.aClass348_5993) {
		this.aClass348_5993.method4189();
	    }
	    synchronized (this.aClass348_5994) {
		this.aClass348_5994.method4189();
	    }
	    synchronized (aClass340_5995) {
	...
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = -505673857 * client.anInt8664;
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 1387083365 * client.anInt8939;
	}
	catch (RuntimeException runtimeexception) {
