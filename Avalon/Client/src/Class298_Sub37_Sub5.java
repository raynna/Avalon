...
public class Class298_Sub37_Sub5 extends Class298_Sub37 {
	...
	try {
	    ...
	    Class298_Sub37_Sub15 class298_sub37_sub15_0_ = ((Class298_Sub37_Sub15) this.aClass461_9584.method5984(-1933327286));
	    while (class298_sub37_sub15_0_ != null) {
		if (Class473.method6069((class298_sub37_sub15.anInt9662 * 946432351), (class298_sub37_sub15_0_.anInt9662 * 946432351), -537262415)) {
		    Class63.method742(class298_sub37_sub15, class298_sub37_sub15_0_, (byte) -70);
		    this.anInt9583 += -130647835;
		    return !bool;
		}
		class298_sub37_sub15_0_ = (Class298_Sub37_Sub15) this.aClass461_9584.method5985(729407080);
		bool = false;
	    }
	    this.aClass461_9584.method5982(class298_sub37_sub15, (byte) -34);
	    this.anInt9583 += -130647835;
	    return bool;
	}
	...
	this.aClass461_9584 = new Class461();
    }

    int method3417(int i) {
	try {
	    if ((this.aClass461_9584.aClass298_Sub37_5679) != (this.aClass461_9584.aClass298_Sub37_5679.aClass298_Sub37_7405))
		return ((((Class298_Sub37_Sub15) (this.aClass461_9584.aClass298_Sub37_5679.aClass298_Sub37_7405)).anInt9662) * 946432351);
	    return -1;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method3419(Class403 class403, int i) {
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = -66163287 * class105.anInt1281;
	    else
