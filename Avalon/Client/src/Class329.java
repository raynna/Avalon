...
public final class Class329 {
	...
	try {
	    synchronized (this.aClass484_3490) {
		boolean bool_2_;
		try {
		    int i_3_;
		    if (bool) {
			if (this.aClass484_3492.method6135(-1460152461) < i * 6 + 6) {
			    boolean bool_4_ = false;
			    return bool_4_;
			}
			this.aClass484_3492.method6140(6 * i);
			this.aClass484_3492.method6139(aByteArray3491, 0, 6, -1945961108);
			i_3_ = (((aByteArray3491[3] & 0xff) << 16) + ((aByteArray3491[4] & 0xff) << 8) + (aByteArray3491[5] & 0xff));
			if (i_3_ <= 0 || i_3_ > (this.aClass484_3490.method6135(-1513278544) / 520L)) {
			    boolean bool_5_ = false;
			    return bool_5_;
			}
		    } else {
			i_3_ = (int) ((this.aClass484_3490.method6135(-1893675250) + 519L) / 520L);
			if (i_3_ == 0)
			    i_3_ = 1;
		    }
		    ...
		    this.aClass484_3492.method6140(i * 6);
		    this.aClass484_3492.method6134(aByteArray3491, 0, 6, 1699083209);
		    int i_6_ = 0;
		    int i_7_ = 0;
		    while (i_6_ < i_0_) {
			int i_8_ = 0;
			if (bool) {
			    this.aClass484_3490.method6140(i_3_ * 520);
			    int i_9_;
			    int i_10_;
			    int i_11_;
			    if (i > 65535) {
				try {
				    this.aClass484_3490.method6139(aByteArray3491, 0, 10, -1753859317);
				}
				...
				try {
				    this.aClass484_3490.method6139(aByteArray3491, 0, 8, -1374964621);
				}
				catch (EOFException eofexception) {
				    break;
				}
			    ...
			    if (i_8_ < 0 || (i_8_ > this.aClass484_3490.method6135(-1633796509) / 520L)) {
			...
			if (i_8_ == 0) {
			    bool = false;
			    i_8_ = (int) ((this.aClass484_3490.method6135(-1603705353) + 519L) / 520L);
			    if (0 == i_8_)
				i_8_++;
			    if (i_8_ == i_3_)
				i_8_++;
			...
			if (i > 65535) {
			    ...
			    aByteArray3491[9] = (byte) (-1194991041 * this.anInt3493);
			    this.aClass484_3490.method6140(i_3_ * 520);
			    this.aClass484_3490.method6134(aByteArray3491, 0, 10, 1531111935);
			    int i_14_ = i_0_ - i_6_;
			    if (i_14_ > 510)
				i_14_ = 510;
			    this.aClass484_3490.method6134(is, i_6_, i_14_, 1227506688);
			    i_6_ += i_14_;
			} else {
			    ...
			    aByteArray3491[7] = (byte) (this.anInt3493 * -1194991041);
			    this.aClass484_3490.method6140(i_3_ * 520);
			    this.aClass484_3490.method6134(aByteArray3491, 0, 8, 1542282258);
			    int i_15_ = i_0_ - i_6_;
			    if (i_15_ > 512)
				i_15_ = 512;
			    this.aClass484_3490.method6134(is, i_6_, i_15_, 1907873622);
			    i_6_ += i_15_;
			}
			i_3_ = i_8_;
			i_7_++;
	...
	try {
		...
		byte[] is;
		try {
		    if (this.aClass484_3492.method6135(-1862419954) < 6 * i + 6) {
			byte[] is_18_ = null;
			return is_18_;
		    }
		    this.aClass484_3492.method6140(6 * i);
		    this.aClass484_3492.method6139(aByteArray3491, 0, 6, -1665251619);
		    ...
		    if (i_20_ <= 0 || i_20_ > (this.aClass484_3490.method6135(-1393462746) / 520L)) {
			byte[] is_22_ = null;
			return is_22_;
		    }
			...
			this.aClass484_3490.method6140(520 * i_20_);
			...
			if (i > 65535) {
				...
				i_27_ = 510;
			    i_28_ = 10;
			    this.aClass484_3490.method6139(aByteArray3491, 0, i_28_ + i_27_, -2124921702);
				...
				i_27_ = 512;
			    i_28_ = 8;
			    this.aClass484_3490.method6139(aByteArray3491, 0, i_28_ + i_27_, -1642020087);
			...
			if (i_31_ < 0 || i_31_ > (this.aClass484_3490.method6135(-1934019874) / 520L)) {
			    byte[] is_34_ = null;
			    return is_34_;
			}
	...
	this.aClass484_3490 = class484;
	this.aClass484_3492 = class484_41_;
	...
	try {
		...
		for (int i_43_ = 0; i_43_ < 65536; i_43_++) {
		    double d_44_ = (i_43_ >> 10 & 0x3f) / 64.0 + 0.0078125;
		    double d_45_ = 0.0625 + (i_43_ >> 7 & 0x7) / 8.0;
		    double d_46_ = (i_43_ & 0x7f) / 128.0;
		    double d_47_ = d_46_;
		    double d_48_ = d_46_;
		    double d_49_ = d_46_;
		    if (0.0 != d_45_) {
    ...
    static final void method3995(Class403 class403, byte i) {
	try {
	    int i_60_ = (class403.anIntArray5257[class403.anInt5259 * 1883543357]);
	    String string = (class403.aClass162_5252.method1755(-937307905 * client.gametype.gameType << 16 | i_60_, -1713280768));
	    String string_61_;
	    if (null == string)
		string_61_ = "";
	    else
		string_61_ = string;
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = string_61_;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method3996(Class403 class403, int i) {
	try {
	    int i_62_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
    ...
    static final void method3997(Class403 class403, int i) {
	try {
	    ...
	    class298_sub36.out.writeString(string, 2108270585);
