/* Class127_Sub1_Sub1 - Decompiled by JODE
...
public class Class127_Sub1_Sub1 extends Class127_Sub1 {
	...
	int i_9_ = this.aClass57_8572.method271();
	int i_10_ = (((Class128_Sub3_Sub1) this.aClass128_6375).anInt9942 * 851871347 * Class74.method823(1139144319) / 10 % i_9_);
	this.aClass57_8572.method636(i_10_ + (i - i_9_), i_6_, i_9_ + i_7_ - i_10_, i_8_);
    }

    void method1430(int i, int i_11_, int i_12_, int i_13_) {
	int i_14_ = this.aClass57_8572.method271();
	int i_15_ = (((Class128_Sub3_Sub1) this.aClass128_6375).anInt9942 * 851871347 * Class74.method823(1139144319) / 10 % i_14_);
	this.aClass57_8572.method636(i_15_ + (i - i_14_), i_11_, i_14_ + i_12_ - i_15_, i_13_);
    }

    Class127_Sub1_Sub1(Class243 class243, Class243 class243_16_, Class128_Sub3_Sub1 class128_sub3_sub1) {
