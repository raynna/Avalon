...
public class Class508 {
	...
	anInt6214 = (this.aClass243_6215.method2316((-1006924897 * (Class120.aClass120_1420.anInt1460)), -2127064505) * 809853823);
    }
	...
	try {
	    ...
	    Class359.method4291((class403.aClass365_Sub1_Sub1_Sub2_5242.aClass119_10131), i_0_ & 0xffff, i_1_, i_2_, class403.aBoolean5261, class403, 2022077336);
	}
	...
	try {
	    ...
	    for (;;) {
		if (stream.method3660((-866602563 * (client.aClass25_8711.anInt336)), (byte) -70) < 15) {
		    if (i != 596994841)
			break;
		    return;
		}
		...
		Class298_Sub29 class298_sub29 = ((Class298_Sub29) client.aClass437_8696.method5812(i_3_));
		if (class298_sub29 == null) {
		    ...
		    client.aClass437_8696.method5817(class298_sub29, i_3_);
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class495.method6195((byte) -1);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    class298_sub37_sub12.type = (bool ? 1 : 0) * 1274450087;
	}
	catch (RuntimeException runtimeexception) {
