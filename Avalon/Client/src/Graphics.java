...
public class Graphics {
	...
	try {
		...
		if (null == class297.aClass298_Sub19_Sub2_3184) {
			...
			if (class297.aByte3176 == 1 && class297.aClass278_3181 == null) {
			    class297.aClass278_3181 = Class278.method2604(Class52.aClass243_507, (-320389285 * (class297.anInt3175)), 0);
				...
				class297.aClass298_Sub23_3186 = (Class298_Sub23.method3066(Class439.aClass243_5575, (class297.anInt3175 * -320389285)));
			    if (class297.aClass298_Sub23_3186 == null) {
				if (i >= 16385)
				    throw new IllegalStateException();
				continue;
			...
			if (-99363405 * class297.anInt3177 < 0) {
				...
				if (i_10_ == (Class287.myPlayer.plane)) {
				    ...
				    if (i_17_ < 0)
					i_17_ = 0;
				    i_9_ = ((i_11_ - i_17_) * Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7582.method5726(-2145949986) * (class297.anInt3182 * -1716484165) / i_11_) >> 2;
				    if (-1 != (class297.anInt3185 * -1271617995)) {
					i_13_ = (class297.anInt3185 * -1271617995);
					i_15_ = (class297.anInt3173 * -1577764425);
				    }
				    if (i_14_ != 0 || i_16_ != 0) {
					int i_18_ = ((-(-1847894591 * Class135.anInt6384) - (int) ((Math.atan2(i_14_, i_16_)) * 2607.5945876176133) - 4096) & 0x3fff);
					if (i_18_ > 8192)
					    i_18_ = 16384 - i_18_;
					int i_19_;
					if (i_17_ <= 0)
				...
				i_9_ = ((class297.anInt3182 * -1716484165 * (3 == class297.aByte3176 ? Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7583.method5726(-2143768151) : Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7553.method5726(-2142178675))) >> 2);
			    if (i_9_ > 0) {
			...
			bool = true;
		} else if (!class297.aClass298_Sub19_Sub2_3184.method2840(-629325116))
		    bool = true;
		if (bool) {
		...
		class298_sub36.out.writeInt(-1256171511 * Class300.anInt3207, -1115837876);
	...
	try {
		...
		for (Class298_Sub37_Sub15 class298_sub37_sub15 = ((Class298_Sub37_Sub15) Class436.aClass453_5480.method5939(1766612795)); class298_sub37_sub15 != null; class298_sub37_sub15 = ((Class298_Sub37_Sub15) Class436.aClass453_5480.method5944(49146))) {
		    int i_21_ = 946432351 * class298_sub37_sub15.anInt9662;
		    if (i_21_ < 1000) {
			class298_sub37_sub15.method2839(-1460969981);
			if (59 == i_21_ || i_21_ == 2 || 8 == i_21_ || i_21_ == 17 || i_21_ == 15 || 16 == i_21_ || i_21_ == 58)
			    Class436.aClass453_5505.add(class298_sub37_sub15);
			else
			    Class436.aClass453_5511.add(class298_sub37_sub15);
		    }
		}
		...
		if (Class436.anInt5506 * -278777595 > 1) {
			...
			Class298_Sub45.aClass298_Sub37_Sub15_7522 = ((Class298_Sub37_Sub15) (Class436.aClass453_5480.aClass298_5643.aClass298_3189.aClass298_3189));
		    else
			Class298_Sub45.aClass298_Sub37_Sub15_7522 = (Class298_Sub37_Sub15) (Class436.aClass453_5480.aClass298_5643.aClass298_3189);
		    Class436.aClass298_Sub37_Sub15_5477 = (Class298_Sub37_Sub15) (Class436.aClass453_5480.aClass298_5643.aClass298_3189);
		    if (-278777595 * Class436.anInt5506 > 2)
			Class318.aClass298_Sub37_Sub15_3322 = ((Class298_Sub37_Sub15) (Class436.aClass298_Sub37_Sub15_5477.aClass298_3189));
		    else
		...
		if (Class436.aBoolean5478) {
			...
			if (null != Class436.aClass298_Sub37_Sub5_5472 && i_22_ >= Class461.anInt5681 * 805710735 && i_22_ <= (805710735 * Class461.anInt5681 + 2054409059 * Class420.anInt5345) && i_23_ >= Class501.anInt6119 * -1370784315 && i_23_ <= (Class501.anInt6119 * -1370784315 + Class389.anInt4166 * -1855216229)) {
			    int i_24_ = -1;
			    for (int i_25_ = 0; (i_25_ < (-628325139 * (Class436.aClass298_Sub37_Sub5_5472.anInt9583))); i_25_++) {
			    ...
			    if (-1 != i_24_) {
				int i_28_ = 0;
				Class447 class447 = (new Class447(Class436.aClass298_Sub37_Sub5_5472.aClass461_9584));
				...
				if (-1 != i_34_) {
					...
					if (i_38_ == i_34_) {
					    Class401.method4939(((Class298_Sub37_Sub15) (class298_sub37_sub5.aClass461_9584.aClass298_Sub37_5679.aClass298_Sub37_7405)), i_22_, i_23_, (short) 916);
					    Class194.method1868(2025307040);
					    break;
					}
					i_38_++;
			...
			if (!bool) {
				...
				if (i_39_ != -1) {
					...
					if (i_39_ == i_44_) {
					    if ((class298_sub37_sub5.anInt9583) * -628325139 > 1)
	...
	try {
		...
		if (class105.anObjectArray1257 != null) {
		    ...
		    class298_sub46.arguements = class105.anObjectArray1257;
    ...
    static final void method612(Class403 class403, byte i) {
	try {
	    int i_49_ = (class403.anIntArray5257[1883543357 * class403.anInt5259]);
	    class403.anInt5239 -= -783761378;
	    int i_50_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    if (i_50_ < 0 || i_50_ >= class403.anIntArray5236[i_49_])
		throw new RuntimeException();
	    class403.anIntArrayArray5238[i_49_][i_50_] = (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method613(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
	    int i_51_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    int i_52_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    if (i_52_ >= 1 && i_52_ <= 10)
    ...
    static final void method614(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 457937409 * class105.anInt1162;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method615(Class403 class403, int i) {
	try {
	    Class390 class390 = (class403.aBoolean5261 ? class403.aClass390_5247 : class403.aClass390_5246);
	    IComponentDefinition class105 = class390.aClass105_4168;
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1160 * 1573706803;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method617(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_55_;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method618(Class403 class403, int i) {
	try {
	    Class390 class390 = (class403.aBoolean5261 ? class403.aClass390_5247 : class403.aClass390_5246);
	    IComponentDefinition class105 = class390.aClass105_4168;
    ...
    static final void method619(Class403 class403, int i) {
	try {
