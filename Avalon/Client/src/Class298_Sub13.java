...
public class Class298_Sub13 extends Class298 {
    byte[] aByteArray7258;
	...
	this.aByteArray7258 = new byte[i_1_];
	RsByteBuffer class298_sub53_53_ = new RsByteBuffer(this.aByteArray7258);
    ...
    void method2904() {
	if (this.aClass440_7259 == null) {
	    this.aClass440_7259 = new Class440(16);
	    int[] is = new int[16];
	    int[] is_67_ = new int[16];
	    int[] is_68_ = is;
	    is_67_[9] = 128;
	    is_68_[9] = 128;
	    Class103 class103 = new Class103(this.aByteArray7258);
		...
		int i_71_ = class103.anIntArray1105[i_70_];
		while (class103.anIntArray1105[i_70_] == i_71_) {
			...
			if (i_81_ > 0) {
			    ...
			    Class298_Sub28 class298_sub28 = ((Class298_Sub28) this.aClass440_7259.method5852(i_82_));
			    if (class298_sub28 == null) {
				class298_sub28 = new Class298_Sub28(new byte[128]);
				this.aClass440_7259.method5858(class298_sub28, i_82_);
			    }
	...
	byte[] is = class243.getFile(i, i_83_);
	if (is == null)
	    return null;
