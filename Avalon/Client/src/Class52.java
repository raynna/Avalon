...
public abstract class Class52 {
    ...
    static final void method553(Class403 class403, int i) {
	try {
    ...
    static final void method554(Class403 class403, int i) {
	try {
	    String string = (String) (class403.anObjectArray5240[(class403.anInt5241 -= 969361751) * -203050393]);
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = Class248.decryptStringMessage(string, 757970283);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (i == 0) {
		if (3.0 == Class301.aFloat3233)
		    return Class381.aClass4_4119;
		if (4.0 == Class301.aFloat3233)
		    return Class255.aClass4_2795;
		if (6.0 == Class301.aFloat3233)
		    return aClass4_508;
		if (Class301.aFloat3233 >= 8.0)
