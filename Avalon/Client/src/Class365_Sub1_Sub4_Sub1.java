...
public class Class365_Sub1_Sub4_Sub1 extends Class365_Sub1_Sub4 {
	...
	try {
		...
		class217.aFloat2455 += i_0_ - anInt10142 * -1184748693;
		method4340(class217);
		...
		if (i_23_ != 0)
		    class222.method2064(0.0F, i_23_, 0.0F);
	    }
	    class217.method2006();
		...
		Class387 class387 = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(anInt10146 * -1651799761).method6029(class_ra, 526336, 1271433065 * anInt10147, null, null, (1191848641 * this.anInt10151), (this.anInt10148 * 943545391), (-1436336999 * this.anInt10153), (-1595812509 * this.anInt10154), 1919430109));
		if (null != class387) {
		...
		Class387 class387 = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(anInt10150 * -909380271).method6029(class_ra, 526336, 442323255 * anInt10145, null, null, (1191848641 * this.anInt10151), (this.anInt10148 * 943545391), (-1436336999 * this.anInt10153), (-1595812509 * this.anInt10154), 1944203535));
		if (null != class387) {
	    ...
	    Class387 class387 = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(-441234013 * anInt10152).method6029(class_ra, 526336, 825822935 * anInt10143, null, null, this.anInt10151 * 1191848641, this.anInt10148 * 943545391, -1436336999 * this.anInt10153, -1595812509 * this.anInt10154, 1623001467));
	    if (null != class387) {
	...
	if (-1184748693 * anInt10142 != i) {
	    class217.aFloat2455 += i - anInt10142 * -1184748693;
	    method4340(class217);
	...
	if (anInt10142 * -1184748693 == 0) {
	    ...
	    Class_xa class_xa = aClass331_7722.aClass_xaArray3517[aByte7724];
	    int i_27_ = 455610861 * this.anInt10149 << 1;
	    int i_28_ = i_27_;
	    int i_29_ = -i_27_ / 2;
	    int i_30_ = -i_28_ / 2;
	    ...
	    if (i_28_ != 0) {
		int i_45_ = ((int) (Math.atan2(i_41_ - i_42_, i_28_) * 2607.5945876176133) & 0x3fff);
		if (i_45_ != 0)
		    class222.method2071(1.0F, 0.0F, 0.0F, Class220.method2049(i_45_));
	    }
	    if (i_27_ != 0) {
		int i_46_ = ((int) (Math.atan2(i_44_ - i_43_, i_27_) * 2607.5945876176133) & 0x3fff);
		if (i_46_ != 0)
	    ...
	    if (i_47_ != 0)
		class222.method2064(0.0F, i_47_, 0.0F);
	}
	class217.method2006();
	...
	this.anInt10149 = 0;
	if (anInt10146 * -1651799761 != -1) {
	    Class387 class387 = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(anInt10146 * -1651799761).method6029(class_ra, 526336, 1271433065 * anInt10147, null, null, 1191848641 * this.anInt10151, this.anInt10148 * 943545391, -1436336999 * this.anInt10153, -1595812509 * this.anInt10154, 1928416812));
	    if (null != class387) {
		class387.method4739(class222, aClass302_Sub1Array7726[2], 0);
		this.aBoolean10144 |= class387.i();
		this.anInt10149 = class387.n() * 674558949;
	...
	if (-1 != -909380271 * anInt10150) {
	    Class387 class387 = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(anInt10150 * -909380271).method6029(class_ra, 526336, 442323255 * anInt10145, null, null, 1191848641 * this.anInt10151, this.anInt10148 * 943545391, -1436336999 * this.anInt10153, -1595812509 * this.anInt10154, 1479435475));
	    if (null != class387) {
		class387.method4739(class222, aClass302_Sub1Array7726[1], 0);
		this.aBoolean10144 |= class387.i();
		if (class387.n() > 455610861 * this.anInt10149)
	...
	Class387 class387 = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(-441234013 * anInt10152).method6029(class_ra, 526336, 825822935 * anInt10143, null, null, this.anInt10151 * 1191848641, this.anInt10148 * 943545391, -1436336999 * this.anInt10153, -1595812509 * this.anInt10154, 1686923112));
	if (null != class387) {
	    class387.method4739(class222, aClass302_Sub1Array7726[0], 0);
	    this.aBoolean10144 |= class387.i();
	    if (class387.n() > 455610861 * this.anInt10149)
