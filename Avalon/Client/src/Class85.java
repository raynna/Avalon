...
public class Class85 {
	...
	try {
	    return Class151.method1643(this.anInt778 * 108680029, 675004457);
	}
	...
	try {
	    return new Class85(108680029 * this.anInt778, i, i_4_, i_5_, aByte780);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 1097409519 * (class403.aClass365_Sub1_Sub1_Sub2_5242.anInt10132);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(19, (long) i_7_ << 32 | i);
