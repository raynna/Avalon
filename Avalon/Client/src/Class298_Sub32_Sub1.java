...
public class Class298_Sub32_Sub1 extends Class298_Sub32 {
	...
	try {
	    if (i == 0)
		this.anInt9319 = class298_sub53.readUnsignedShort() * 1334499193;
	}
	...
	if (aClass257_7384.aBoolean2810) {
		...
		int i_5_ = (585425609 * this.anInt9319 * (is_3_[i_4_] - is_1_[i_4_]));
		int i_6_ = (585425609 * this.anInt9319 * (is_2_[i_4_ + 1 & Class250.anInt2753 * -901777799] - (is_2_[i_4_ - 1 & -901777799 * Class250.anInt2753])));
		int i_7_ = i_6_ >> 12;
		int i_8_ = i_5_ >> 12;
		int i_9_ = i_7_ * i_7_ >> 12;
		int i_10_ = i_8_ * i_8_ >> 12;
		int i_11_ = (int) (Math.sqrt((i_9_ + i_10_ + 4096) / 4096.0F) * 4096.0);
	...
	if (aClass257_7384.aBoolean2810) {
		...
		int i_17_ = (585425609 * this.anInt9319 * (is_15_[i_16_] - is_13_[i_16_]));
		int i_18_ = (585425609 * this.anInt9319 * (is_14_[i_16_ + 1 & Class250.anInt2753 * -901777799] - (is_14_[i_16_ - 1 & -901777799 * Class250.anInt2753])));
		int i_19_ = i_18_ >> 12;
		int i_20_ = i_17_ >> 12;
		int i_21_ = i_19_ * i_19_ >> 12;
		int i_22_ = i_20_ * i_20_ >> 12;
		int i_23_ = (int) (Math.sqrt((i_21_ + i_22_ + 4096) / 4096.0F) * 4096.0);
	...
	try {
		...
		for (int i_29_ = 0; i_29_ < -1474554145 * Class250.anInt2755; i_29_++) {
		    int i_30_ = (585425609 * this.anInt9319 * (is_28_[i_29_] - is_26_[i_29_]));
		    int i_31_ = (585425609 * this.anInt9319 * ((is_27_[i_29_ + 1 & Class250.anInt2753 * -901777799]) - is_27_[(i_29_ - 1 & -901777799 * Class250.anInt2753)]));
		    int i_32_ = i_31_ >> 12;
		    int i_33_ = i_30_ >> 12;
		    int i_34_ = i_32_ * i_32_ >> 12;
		    int i_35_ = i_33_ * i_33_ >> 12;
		    int i_36_ = (int) (Math.sqrt((i_34_ + i_35_ + 4096) / 4096.0F) * 4096.0);
