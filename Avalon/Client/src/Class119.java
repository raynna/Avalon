...
public class Class119 {
	...
	try {
	    return (null == this.aClass105Array1404 ? aClass105Array1405 : this.aClass105Array1404);
	}
	...
	try {
	    if (this.aClass105Array1404 == null) {
		int i_0_ = aClass105Array1405.length;
		this.aClass105Array1404 = new IComponentDefinition[i_0_];
		System.arraycopy(aClass105Array1405, 0, this.aClass105Array1404, 0, aClass105Array1405.length);
	    }
	    return this.aClass105Array1404;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (aClass105Array1405[0].ihash * -440872681 >>> 16 != i >>> 16)
    ...
    static final void method1298(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
		...
		Class422.method5623(class105.ihash * -440872681, 1429753437);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1299(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.screenSizePreference.method5654(-1747444886);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		class298_sub49.aClass308_Sub1_7591.method3776(class298_sub49.aBoolean7592, -480568150);
	    }
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("ev.f(").append(')').toString());
	...
	try {
	    ...
	    long l_6_ = i | i_3_ << 7 | interface3.method29(726839210) << 14 | interface3.method30((short) 11182) << 20 | 0x40000000;
    ...
    static final void method1302(Class403 class403, int i) {
	try {
    ...
    static void method1303(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[681479919 * class403.anInt5239 - 2] = (Class316.aClass362_3318.method4307((class403.anIntArray5244[681479919 * class403.anInt5239 - 2]), 245040087).anIntArray4016[(class403.anIntArray5244[class403.anInt5239 * 681479919 - 1])]);
