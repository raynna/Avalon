...
final class Class121 implements Interface4 {
    ...
    static final void method1314(Class403 class403, byte i) {
	try {
	...
	try {
	    ...
	    Class298_Sub48 class298_sub48 = new Class298_Sub48(client.gametype, 0);
	    try {
		class476 = Class86.method962("", client.gametype.aString5317, false, -1804643872);
		...
		class298_sub48 = new Class298_Sub48(new RsByteBuffer(is), client.gametype, 0);
	    }
    ...
    static final void method1316(Class403 class403, int i) {
	try {
