...
public class Class492 {
	...
	try {
	    if (i == 1)
		this.anInt6083 = class298_sub53.readBigSmart(1235052657) * -1732871629;
	    else if (2 == i) {
    ...
    public synchronized IndexedImage method6181(int i) {
	try {
	    IndexedImage class89 = ((IndexedImage) (this.aClass491_6082.aClass348_6078.method4184(this.anInt6083 * 1338052859)));
	    if (class89 != null)
		return class89;
	...
	try {
		...
		for (int i_15_ = i_12_; i_15_ < i_11_; i_15_++)
		    Class372.anIntArrayArray4047[i_15_][i] = i_13_;
	    } else {
		for (int i_16_ = i_11_; i_16_ < i_12_; i_16_++)
		    Class372.anIntArrayArray4047[i_16_][i] = i_13_;
	    }
	}
	catch (RuntimeException runtimeexception) {
    ...
    static boolean method6184(Shortcut class355, int i) {
	try {
	    return Class170.method1814(class355, null, (byte) -87);
	}
	catch (RuntimeException runtimeexception) {
