...
public class Class277 {
	...
	try {
	    ...
	    else if (class277_2_ != null && class277_2_.aBoolean2959)
		this.anInt2947 = (-910867015 - 967778107 * class277_2_.anInt2961);
	    else
		this.anInt2947 = 0;
	    this.aBoolean2959 = true;
	    this.aClass277_2960 = class277_2_;
	    this.anInt2961 = 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (null != this.aClass276Array2949) {
			...
			if (class276.method2579(this.anInt2957 * 1173193129, 796478559 * this.anInt2948, -226559159 * this.anInt2962, this.anInt2963 * -51566561)) {
			    is[this.anInt2945 * 1858024591] = class276.anInt2919;
			    this.aClass276Array2953[((this.anInt2945 += 400255599) * 1858024591) - 1] = class276;
			}
		    }
		    Class419.method5602(is, this.aClass276Array2953, 0, (1858024591 * this.anInt2945) - 1, -641027314);
		}
		...
		for (int i_7_ = this.anInt2945 * 1858024591 - 1; i_7_ >= 0; i_7_--) {
		    boolean bool_8_ = (this.aClass276Array2953[i_7_].method2575(class_ra, this.aClass276_2942));
		...
		this.aClass277_2960.method2585((byte) -39);
		bool |= this.aClass277_2960.method2588(class_ra, i, i_3_, -136782694);
	    }
	    return bool;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    try {
		boolean bool = Class465.aClass243_6520.method2291((-680590445 * (this.anInt2956)), 581664063);
		if (bool) {
		    class_ra.m(16777215, 0.0F, 0.0F, 1.0F, 0.0F, 0.0F);
		    Model class64 = Model.method751(Class465.aClass243_6520, (this.anInt2956 * -680590445), 0);
		    this.aClass387_2941 = class_ra.method5037(class64, 1099776, 0, 255, 1);
		    byte[] is = this.aClass387_2941.ah();
		    if (null == is)
			this.aByteArray2958 = null;
		    else {
			this.aByteArray2958 = new byte[is.length];
			System.arraycopy(is, 0, this.aByteArray2958, 0, is.length);
		    }
		}
	    }
	...
	try {
		...
		Class277 class277_31_ = this.aClass277_2960;
		if (class277_30_.hashCode() > class277_31_.hashCode()) {
		    class277_30_ = this.aClass277_2960;
		    class277_31_ = this;
		    i_29_ = 255 - i_29_;
		}
	...
	try {
	    ...
	    this.aClass387_2941.method4739(class222_37_, null, 0);
	...
	try {
		...
		if (this.anInt2940 * 1461948177 != -1 && this.anInt2946 * -1994130525 != 0) {
			...
			if (this.aClass320_2944 == Class320.aClass320_6547) {
				...
				class_ra.method5015(0, i_51_ + i_39_ + i_41_, i_40_, i_41_ - (i_41_ + (i_51_ + i_39_)), this.anInt2952 * 1184429967, (byte) 7);
			} else {
		...
		this.aClass276Array2953[i_57_].method2577(class_ra, i_38_, i_39_, i_40_, i_41_, i_42_, i_43_, 1173193129 * this.anInt2957, this.anInt2948 * 796478559, this.anInt2962 * -226559159, i_49_);
	    class_ra.ba(2, 0);
	}
	catch (RuntimeException runtimeexception) {
	...
	this.aBoolean2954 = true;
	this.anInt2957 = i_59_ * 91665049;
	this.anInt2948 = i_60_ * -2049962081;
	this.anInt2962 = i_61_ * 2095769337;
	this.anInt2940 = 318980593 * i;
    ...
    static final void method2594(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
	    class105.anInt1306 = (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) * -216431639;
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (int) client.aFloat8949 >> 3;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    packet.out.writeShort128(class341.gameSceneBaseX * -1760580017 + localX);
	    packet.out.write128Byte(Class151.method1644(-545107710) ? 1 : 0, (byte) 1);
	    packet.out.writeShort128(localY + class341.gameSceneBaseY * 283514611);
	...
	try {
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = new StringBuilder().append(Class465.method6017((class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) * 60000L, Class321.aClass429_3357.getType(694163818), true, -1759893587)).append(" UTC").toString();
	}
	catch (RuntimeException runtimeexception) {
