...
public abstract class Class57 implements Interface28 {
	...
	if (i != 0) {
	    double d = (i_52_ & 0xffff) * 9.587379924285257E-5;
	    float f_56_ = (float) Math.sin(d) * i;
	    float f_57_ = (float) Math.cos(d) * i;
	    float f_58_ = (-f_50_ * f_57_ + -f_51_ * f_56_) / 4096.0F + f;
	    float f_59_ = (--f_50_ * f_56_ + -f_51_ * f_57_) / 4096.0F + f_49_;
	    float f_60_ = (((method271() - f_50_) * f_57_ + -f_51_ * f_56_) / 4096.0F + f);
	    float f_61_ = ((-(method271() - f_50_) * f_56_ + -f_51_ * f_57_) / 4096.0F + f_49_);
	    float f_62_ = ((-f_50_ * f_57_ + (method626() - f_51_) * f_56_) / 4096.0F + f);
	    float f_63_ = ((--f_50_ * f_56_ + (method626() - f_51_) * f_57_) / 4096.0F + f_49_);
	...
	method637(f, f_64_, method271() / 2.0F, method626() / 2.0F, i, i_65_, i_66_, i_67_, i_68_);
    }

    public final void method639(float f, float f_69_, int i, int i_70_, Class_ta class_ta, int i_71_, int i_72_) {
	method659(f, f_69_, method271() / 2.0F, method626() / 2.0F, i, i_70_, class_ta, i_71_, i_72_);
    }
	...
	if (i != 0) {
	    double d = (i_142_ & 0xffff) * 9.587379924285257E-5;
	    float f_145_ = (float) Math.sin(d) * i;
	    float f_146_ = (float) Math.cos(d) * i;
	    float f_147_ = (-f_140_ * f_146_ + -f_141_ * f_145_) / 4096.0F + f;
	    float f_148_ = (--f_140_ * f_145_ + -f_141_ * f_146_) / 4096.0F + f_139_;
	    float f_149_ = (((method271() - f_140_) * f_146_ + -f_141_ * f_145_) / 4096.0F + f);
	    float f_150_ = ((-(method271() - f_140_) * f_145_ + -f_141_ * f_146_) / 4096.0F + f_139_);
	    float f_151_ = ((-f_140_ * f_146_ + (method626() - f_141_) * f_145_) / 4096.0F + f);
	    float f_152_ = ((--f_140_ * f_145_ + (method626() - f_141_) * f_146_) / 4096.0F + f_139_);
	...
	method637(f, f_221_, method271() / 2.0F, method626() / 2.0F, i, i_222_, 1, 0, 1);
    }
