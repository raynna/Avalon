...
public class Class50 {
    ...
    Loader.usingRS ? (new BigInteger("ac548ab1174bf4dc38ff9a47be125012b9dd859bb4a5a7e9b1b655f16697740410813e98a46091042f3bc873ddb3e38e7e9432b5466b21a7feec65f0eee0a147", 16)) : (new BigInteger(""));;
	...
	(new BigInteger("", 16)) : (new BigInteger(""));
	...
	try {
	    ...
	    class298_sub36.out.writeInt(-1, -106491517);
    ...
    static final void method532(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = -1168328513 * client.anInt8837;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    int i_13_ = (client.ticketCycle * 443738891 - client.anInt8921 * -1656615113);
	    if (i_13_ >= 100) {
		...
		float f = 1.0F - ((100 - i_13_) * ((100 - i_13_) * (100 - i_13_)) / 1000000.0F);
		Class367.anInt4000 = ((int) (Class301_Sub1.anInt7639 * -1806467999 + f * (Class367.anInt4000 * -1740717447 - (-1806467999 * Class301_Sub1.anInt7639))) * 547882953);
		Class110.anInt6403 = (1078403147 * (int) ((1449634147 * Class110.anInt6403 - 2032233737 * Class409.anInt5284) * f + Class409.anInt5284 * 2032233737));
		Class146.anInt1575 = ((int) (f * (Class146.anInt1575 * -299812095 - (1368015401 * Class82_Sub2.anInt6822)) + 1368015401 * Class82_Sub2.anInt6822) * 309839105);
		client.anInt8756 = ((int) ((-104436553 * client.anInt8756 - Class21.anInt277 * 827399463) * f + Class21.anInt277 * 827399463) * -648269561);
		int i_16_ = (Class135.anInt6384 * -1847894591 - -883946017 * Class298_Sub9.anInt7228);
		if (i_16_ > 8192)
		    i_16_ -= 16384;
		else if (i_16_ < -8192)
		    i_16_ += 16384;
		Class135.anInt6384 = ((int) (i_16_ * f + Class298_Sub9.anInt7228 * -883946017) * -1587695039);
    ...
    static final void method536(Class403 class403, byte i) {
	try {
	    ...
	    int i_19_ = (class403.anIntArray5244[2 + 681479919 * class403.anInt5239]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class403.aClass162_5252.method1752(i_17_, i_18_, i_19_, 1489690746);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method537(Class403 class403, byte i) {
	try {
	    int i_20_ = ((class403.anIntArray5257[class403.anInt5259 * 1883543357]) >> 16);
	    int i_21_ = ((class403.anIntArray5257[1883543357 * class403.anInt5259]) & 0xffff);
	    int i_22_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    if (i_22_ < 0 || i_22_ > 5000)
		throw new RuntimeException();
	    class403.anIntArray5236[i_20_] = i_22_;
	    int i_23_ = -1;
	    if (105 == i_21_)
		i_23_ = 0;
	    for (int i_24_ = 0; i_24_ < i_22_; i_24_++)
		class403.anIntArrayArray5238[i_20_][i_24_] = i_23_;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method538(Class403 class403, byte i) {
	try {
