...
public class Class387_Sub2 extends Class387 {
	...
	if (i != 1 && i != 2 && i != 3 && i != 5 || (i_5_ >= 0 && ((i_6_ + class_xa.anInt6288 * -1212653763 >> class_xa.anInt6289 * -2137349879) < class_xa.anInt6287 * -506105871) && i_7_ >= 0 && ((i_8_ + class_xa.anInt6288 * -1212653763 >> class_xa.anInt6289 * -2137349879) < class_xa.anInt6286 * -1148794921))) {
		...
		for (int i_9_ = 0; i_9_ < this.anInt7833; i_9_++)
		    this.anIntArray7835[i_9_] = (this.anIntArray7835[i_9_] + class_xa.method6340(((this.anIntArray7834[i_9_]) + i_2_), ((this.anIntArray7836[i_9_]) + i_4_), -1779061199) - i_3_);
	    } else if (i == 2) {
		...
		for (int i_11_ = 0; i_11_ < this.anInt7833; i_11_++) {
		    ...
		    if (i_12_ < i_0_)
			this.anIntArray7835[i_11_] = (this.anIntArray7835[i_11_] + (class_xa.method6340(((this.anIntArray7834[i_11_]) + i_2_), ((this.anIntArray7836[i_11_]) + i_4_), -1741700419) - i_3_) * (i_0_ - i_12_) / i_0_);
		}
	    } else if (i == 3) {
		...
		for (int i_18_ = 0; i_18_ < this.anInt7833; i_18_++)
		    this.anIntArray7835[i_18_] = (this.anIntArray7835[i_18_] + (class_xa_1_.method6340(((this.anIntArray7834[i_18_]) + i_2_), ((this.anIntArray7836[i_18_]) + i_4_), -1374072813) - i_3_) + i_17_);
	    } else if (i == 5) {
	...
	if (this.anInt7847 != 0 && class387_sub2_28_.anInt7847 != 0) {
	    int i_29_ = class387_sub2_28_.anInt7833;
	    int[] is = class387_sub2_28_.anIntArray7834;
	    int[] is_30_ = class387_sub2_28_.anIntArray7835;
	    int[] is_31_ = class387_sub2_28_.anIntArray7836;
		...
		is_36_ = (this.aClass67_7844.aShortArray669);
		is_37_ = (this.aClass67_7844.aShortArray668);
		is_38_ = (this.aClass67_7844.aShortArray667);
		is_39_ = (this.aClass67_7844.aByteArray670);
	    } else {
		is_36_ = null;
		is_37_ = null;
		is_38_ = null;
	    ...
	    for (int i_52_ = 0; i_52_ < this.anInt7833; i_52_++) {
		int i_53_ = this.anIntArray7835[i_52_] - i_26_;
		if (i_53_ >= i_46_ && i_53_ <= i_47_) {
		    int i_54_ = this.anIntArray7834[i_52_] - i;
		    if (i_54_ >= i_48_ && i_54_ <= i_49_) {
			int i_55_ = (this.anIntArray7836[i_52_] - i_27_);
			if (i_55_ >= i_50_ && i_55_ <= i_51_) {
			    int i_56_ = -1;
			    int i_57_ = this.anIntArray7854[i_52_];
			    int i_58_ = (this.anIntArray7854[i_52_ + 1]);
			    for (int i_59_ = i_57_; i_59_ < i_58_; i_59_++) {
				i_56_ = (this.aShortArray7830[i_59_]) - 1;
				if (i_56_ == -1 || (this.aByteArray7887[i_56_]) != 0)
				    break;
			    }
			    if (i_56_ != -1) {
				for (int i_60_ = 0; i_60_ < i_29_; i_60_++) {
					...
					if (i_61_ != -1) {
						...
						is_36_ = (this.aClass67_7844).aShortArray669 = (Class378.method4670((this.aShortArray7829), (byte) -2));
						is_37_ = (this.aClass67_7844).aShortArray668 = (Class378.method4670((this.aShortArray7841), (byte) -56));
						is_38_ = (this.aClass67_7844).aShortArray667 = (Class378.method4670((this.aShortArray7842), (byte) -66));
						is_39_ = (this.aClass67_7844).aByteArray670 = (Class409.method4978((this.aByteArray7887), 1194497584));
					    }
					    if (is_40_ == null) {
					    ...
					    short i_63_ = (this.aShortArray7829[i_56_]);
					    short i_64_ = (this.aShortArray7841[i_56_]);
					    short i_65_ = (this.aShortArray7842[i_56_]);
					    byte i_66_ = (this.aByteArray7887[i_56_]);
					    i_57_ = is_44_[i_60_];
					    i_58_ = is_44_[i_60_ + 1];
					    ...
					    i_65_ = is_34_[i_61_];
					    i_66_ = is_35_[i_61_];
					    i_57_ = (this.anIntArray7854[i_52_]);
					    i_58_ = (this.anIntArray7854[i_52_ + 1]);
					    for (int i_69_ = i_57_; i_69_ < i_58_; i_69_++) {
						int i_70_ = ((this.aShortArray7830[i_69_]) - 1);
						if (i_70_ == -1)
						    break;
						if (is_39_[i_70_] != 0) {
						    is_36_[i_70_] += i_63_;
	...
	int i;
	int i_72_;
	if ((this.aClass_ra_Sub2_7824.anInt8066) > 0) {
	    i = ((this.aShort7870 - ((this.aShort7874 * this.aClass_ra_Sub2_7824.anInt8066) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	    i_72_ = ((this.aShort7871 - ((this.aShort7868 * (this.aClass_ra_Sub2_7824).anInt8066) >> 8)) >> (this.aClass_ra_Sub2_7824).anInt8064);
	} else {
	    i = ((this.aShort7870 - ((this.aShort7868 * this.aClass_ra_Sub2_7824.anInt8066) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	    i_72_ = ((this.aShort7871 - ((this.aShort7874 * (this.aClass_ra_Sub2_7824).anInt8066) >> 8)) >> (this.aClass_ra_Sub2_7824).anInt8064);
	}
	int i_73_;
	int i_74_;
	if ((this.aClass_ra_Sub2_7824.anInt8026) > 0) {
	    i_73_ = ((this.aShort7872 - ((this.aShort7874 * (this.aClass_ra_Sub2_7824).anInt8026) >> 8)) >> (this.aClass_ra_Sub2_7824).anInt8064);
	    i_74_ = ((this.aShort7876 - ((this.aShort7868 * (this.aClass_ra_Sub2_7824).anInt8026) >> 8)) >> (this.aClass_ra_Sub2_7824).anInt8064);
	} else {
	    i_73_ = ((this.aShort7872 - ((this.aShort7868 * (this.aClass_ra_Sub2_7824).anInt8026) >> 8)) >> (this.aClass_ra_Sub2_7824).anInt8064);
	    i_74_ = ((this.aShort7876 - ((this.aShort7874 * (this.aClass_ra_Sub2_7824).anInt8026) >> 8)) >> (this.aClass_ra_Sub2_7824).anInt8064);
	}
	int i_75_ = i_72_ - i + 1;
	...
	if (class_na_sub1 != null && class_na_sub1.method3481(i_75_, i_76_)) {
	    ...
	    class_na_sub1_77_ = new Class_na_Sub1(this.aClass_ra_Sub2_7824, i_75_, i_76_);
	...
	this.anInt7863 = i;
	if (this.aClass67_7844 != null && (this.anInt7863 & 0x10000) == 0) {
	...
	class387_sub2_79_.anInt7826 = this.anInt7826;
	class387_sub2_79_.aShort7828 = this.aShort7828;
	class387_sub2_79_.aShort7869 = this.aShort7869;
	class387_sub2_79_.anInt7832 = this.anInt7832;
	class387_sub2_79_.anInt7833 = this.anInt7833;
	class387_sub2_79_.anInt7839 = this.anInt7839;
	class387_sub2_79_.anInt7847 = this.anInt7847;
	class387_sub2_79_.anInt7885 = this.anInt7885;
	class387_sub2_79_.anInt7877 = this.anInt7877;
	if ((i & 0x100) != 0)
	    class387_sub2_79_.aBoolean7840 = true;
	else
	    class387_sub2_79_.aBoolean7840 = this.aBoolean7840;
	class387_sub2_79_.aBoolean7862 = this.aBoolean7862;
	...
	if (bool_85_) {
	    if (bool_82_) {
		if (class387_sub2_80_.anIntArray7834 == null || ((class387_sub2_80_.anIntArray7834).length < this.anInt7832))
		    class387_sub2_79_.anIntArray7834 = class387_sub2_80_.anIntArray7834 = new int[this.anInt7832];
		else
		    class387_sub2_79_.anIntArray7834 = class387_sub2_80_.anIntArray7834;
	    } else
		class387_sub2_79_.anIntArray7834 = this.anIntArray7834;
	    if (bool_83_) {
		if (class387_sub2_80_.anIntArray7835 == null || ((class387_sub2_80_.anIntArray7835).length < this.anInt7832))
		    class387_sub2_79_.anIntArray7835 = class387_sub2_80_.anIntArray7835 = new int[this.anInt7832];
		else
		    class387_sub2_79_.anIntArray7835 = class387_sub2_80_.anIntArray7835;
	    } else
		class387_sub2_79_.anIntArray7835 = this.anIntArray7835;
	    if (bool_84_) {
		if (class387_sub2_80_.anIntArray7836 == null || ((class387_sub2_80_.anIntArray7836).length < this.anInt7832))
		    class387_sub2_79_.anIntArray7836 = class387_sub2_80_.anIntArray7836 = new int[this.anInt7832];
		else
		    class387_sub2_79_.anIntArray7836 = class387_sub2_80_.anIntArray7836;
	    } else
		class387_sub2_79_.anIntArray7836 = this.anIntArray7836;
	    for (int i_86_ = 0; i_86_ < this.anInt7832; i_86_++) {
		if (bool_82_)
		    class387_sub2_79_.anIntArray7834[i_86_] = this.anIntArray7834[i_86_];
		if (bool_83_)
		    class387_sub2_79_.anIntArray7835[i_86_] = this.anIntArray7835[i_86_];
		if (bool_84_)
		    class387_sub2_79_.anIntArray7836[i_86_] = this.anIntArray7836[i_86_];
	    }
	} else {
	    class387_sub2_79_.anIntArray7834 = this.anIntArray7834;
	    class387_sub2_79_.anIntArray7835 = this.anIntArray7835;
	...
	if (Class38.method457(i, this.anInt7826)) {
	    ...
	    class387_sub2_79_.aClass32_7831.aByte398 = this.aClass32_7831.aByte398;
	    class387_sub2_79_.aClass32_7831.anInterface1_397 = (this.aClass32_7831.anInterface1_397);
	} else if (Class38.method471(i, this.anInt7826))
	    class387_sub2_79_.aClass32_7831 = this.aClass32_7831;
	else
	    class387_sub2_79_.aClass32_7831 = null;
	if (Class38.method448(i, this.anInt7826)) {
	    if (class387_sub2_80_.aShortArray7849 == null || (class387_sub2_80_.aShortArray7849.length < this.anInt7847))
		class387_sub2_79_.aShortArray7849 = class387_sub2_80_.aShortArray7849 = new short[this.anInt7847];
	    else
		class387_sub2_79_.aShortArray7849 = class387_sub2_80_.aShortArray7849;
	    for (int i_87_ = 0; i_87_ < this.anInt7847; i_87_++)
		class387_sub2_79_.aShortArray7849[i_87_] = this.aShortArray7849[i_87_];
	} else
	    class387_sub2_79_.aShortArray7849 = this.aShortArray7849;
	if (Class38.method467(i, this.anInt7826)) {
	    if (class387_sub2_80_.aByteArray7850 == null || (class387_sub2_80_.aByteArray7850.length < this.anInt7847))
		class387_sub2_79_.aByteArray7850 = class387_sub2_80_.aByteArray7850 = new byte[this.anInt7847];
	    else
		class387_sub2_79_.aByteArray7850 = class387_sub2_80_.aByteArray7850;
	    for (int i_88_ = 0; i_88_ < this.anInt7847; i_88_++)
		class387_sub2_79_.aByteArray7850[i_88_] = this.aByteArray7850[i_88_];
	} else
	    class387_sub2_79_.aByteArray7850 = this.aByteArray7850;
	if (Class38.method470(i, this.anInt7826)) {
	    ...
	    class387_sub2_79_.aClass32_7858.aByte398 = this.aClass32_7858.aByte398;
	    class387_sub2_79_.aClass32_7858.anInterface1_397 = (this.aClass32_7858.anInterface1_397);
	} else if (Class38.method458(i, this.anInt7826))
	    class387_sub2_79_.aClass32_7858 = this.aClass32_7858;
	else
	    class387_sub2_79_.aClass32_7858 = null;
	if (Class38.method474(i, this.anInt7826)) {
	    if (class387_sub2_80_.aShortArray7829 == null || (class387_sub2_80_.aShortArray7829.length < this.anInt7839)) {
		...
		for (int i_91_ = 0; i_91_ < this.anInt7839; i_91_++) {
		    class387_sub2_79_.aShortArray7829[i_91_] = this.aShortArray7829[i_91_];
		    class387_sub2_79_.aShortArray7841[i_91_] = this.aShortArray7841[i_91_];
		    class387_sub2_79_.aShortArray7842[i_91_] = this.aShortArray7842[i_91_];
		...
		for (int i_92_ = 0; i_92_ < this.anInt7839; i_92_++) {
		    class387_sub2_79_.aShortArray7829[i_92_] = this.aShortArray7829[i_92_];
		    class387_sub2_79_.aShortArray7841[i_92_] = this.aShortArray7841[i_92_];
		    class387_sub2_79_.aShortArray7842[i_92_] = this.aShortArray7842[i_92_];
		}
	    }
	    class387_sub2_79_.aByteArray7887 = this.aByteArray7887;
	} else {
	    class387_sub2_79_.aClass67_7844 = this.aClass67_7844;
	    class387_sub2_79_.aShortArray7829 = this.aShortArray7829;
	    class387_sub2_79_.aShortArray7841 = this.aShortArray7841;
	    class387_sub2_79_.aShortArray7842 = this.aShortArray7842;
	    class387_sub2_79_.aByteArray7887 = this.aByteArray7887;
	}
	if (Class38.method464(i, this.anInt7826)) {
	    ...
	    class387_sub2_79_.aClass32_7889.aByte398 = this.aClass32_7889.aByte398;
	    class387_sub2_79_.aClass32_7889.anInterface1_397 = (this.aClass32_7889.anInterface1_397);
	} else if (Class38.method475(i, this.anInt7826))
	    class387_sub2_79_.aClass32_7889 = this.aClass32_7889;
	else
	    class387_sub2_79_.aClass32_7889 = null;
	if (Class38.method450(i, this.anInt7826)) {
	    if (class387_sub2_80_.aFloatArray7845 == null || (class387_sub2_80_.aFloatArray7845.length < this.anInt7847)) {
		...
		class387_sub2_79_.aFloatArray7845[i_94_] = this.aFloatArray7845[i_94_];
		class387_sub2_79_.aFloatArray7846[i_94_] = this.aFloatArray7846[i_94_];
	    }
	} else {
	    class387_sub2_79_.aFloatArray7845 = this.aFloatArray7845;
	    class387_sub2_79_.aFloatArray7846 = this.aFloatArray7846;
	}
	if (Class38.method476(i, this.anInt7826)) {
	    ...
	    class387_sub2_79_.aClass32_7860.aByte398 = this.aClass32_7860.aByte398;
	    class387_sub2_79_.aClass32_7860.anInterface1_397 = (this.aClass32_7860.anInterface1_397);
	} else if (Class38.method455(i, this.anInt7826))
	    class387_sub2_79_.aClass32_7860 = this.aClass32_7860;
	else
	    class387_sub2_79_.aClass32_7860 = null;
	if (Class38.method468(i, this.anInt7826)) {
	    if (class387_sub2_80_.aShortArray7851 == null || (class387_sub2_80_.aShortArray7851.length < this.anInt7847)) {
		...
		class387_sub2_79_.aShortArray7851[i_96_] = this.aShortArray7851[i_96_];
		class387_sub2_79_.aShortArray7852[i_96_] = this.aShortArray7852[i_96_];
		class387_sub2_79_.aShortArray7853[i_96_] = this.aShortArray7853[i_96_];
	    }
	} else {
	    class387_sub2_79_.aShortArray7851 = this.aShortArray7851;
	    class387_sub2_79_.aShortArray7852 = this.aShortArray7852;
	    class387_sub2_79_.aShortArray7853 = this.aShortArray7853;
	}
	if (Class38.method447(i, this.anInt7826)) {
	    ...
	    class387_sub2_79_.aClass41_7879.anInterface2_441 = (this.aClass41_7879.anInterface2_441);
	} else if (Class38.method456(i, this.anInt7826))
	    class387_sub2_79_.aClass41_7879 = this.aClass41_7879;
	else
	    class387_sub2_79_.aClass41_7879 = null;
	if (Class38.method451(i, this.anInt7826)) {
	    if (class387_sub2_80_.aShortArray7861 == null || (class387_sub2_80_.aShortArray7861.length < this.anInt7847)) {
		...
		class387_sub2_79_.aShortArray7861[i_98_] = this.aShortArray7861[i_98_];
	} else
	    class387_sub2_79_.aShortArray7861 = this.aShortArray7861;
	if (Class38.method452(i, this.anInt7826)) {
	    if (class387_sub2_80_.aClass36Array7875 == null || ((class387_sub2_80_.aClass36Array7875).length < this.anInt7877)) {
		...
		for (int i_100_ = 0; i_100_ < this.anInt7877; i_100_++)
		    class387_sub2_79_.aClass36Array7875[i_100_] = this.aClass36Array7875[i_100_].method442();
	    } else {
		class387_sub2_79_.aClass36Array7875 = class387_sub2_80_.aClass36Array7875;
		for (int i_101_ = 0; i_101_ < this.anInt7877; i_101_++)
		    class387_sub2_79_.aClass36Array7875[i_101_].method441(this.aClass36Array7875[i_101_]);
	    }
	} else
	    class387_sub2_79_.aClass36Array7875 = this.aClass36Array7875;
	class387_sub2_79_.aClass54Array7880 = this.aClass54Array7880;
	if (this.aBoolean7843) {
	    class387_sub2_79_.anInt7865 = this.anInt7865;
	    class387_sub2_79_.anInt7891 = this.anInt7891;
	    class387_sub2_79_.aShort7870 = this.aShort7870;
	    class387_sub2_79_.aShort7871 = this.aShort7871;
	    class387_sub2_79_.aShort7868 = this.aShort7868;
	    class387_sub2_79_.aShort7874 = this.aShort7874;
	    class387_sub2_79_.aShort7872 = this.aShort7872;
	    class387_sub2_79_.aShort7876 = this.aShort7876;
	    class387_sub2_79_.aBoolean7843 = true;
	} else
	    class387_sub2_79_.aBoolean7843 = false;
	class387_sub2_79_.anIntArrayArray7837 = this.anIntArrayArray7837;
	class387_sub2_79_.anIntArrayArray7855 = this.anIntArrayArray7855;
	class387_sub2_79_.anIntArrayArray7882 = this.anIntArrayArray7882;
	class387_sub2_79_.aShortArray7830 = this.aShortArray7830;
	class387_sub2_79_.anIntArray7854 = this.anIntArray7854;
	class387_sub2_79_.aShortArray7838 = this.aShortArray7838;
	class387_sub2_79_.aShortArray7856 = this.aShortArray7856;
	class387_sub2_79_.anIntArray7859 = this.anIntArray7859;
	class387_sub2_79_.aClass85Array7825 = this.aClass85Array7825;
	class387_sub2_79_.aClass68Array7857 = this.aClass68Array7857;
	...
	if (this.aBoolean7864) {
	    ...
	    if (this.aClass85Array7825 == null && this.aClass68Array7857 == null && this.aClass54Array7880 == null && !Class38.method446(this.anInt7863, this.anInt7826)) {
		boolean bool = false;
		boolean bool_102_ = false;
		boolean bool_103_ = false;
		if (this.anIntArray7834 != null && !Class38.method469(this.anInt7863, this.anInt7826)) {
		...
		if (this.anIntArray7835 != null && !Class38.method460(this.anInt7863, this.anInt7826)) {
		    if (this.aClass32_7831 == null || (this.aClass32_7831.anInterface1_397) != null) {
			if (!this.aBoolean7843)
			    method4831();
			bool_102_ = true;
		...
		if (this.anIntArray7836 != null && !Class38.method473(this.anInt7863, this.anInt7826)) {
		    if (this.aClass32_7831 == null || (this.aClass32_7831.anInterface1_397) != null) {
			if (!this.aBoolean7843)
			    method4831();
			bool_103_ = true;
	    ...
	    if (this.aByteArray7887 != null && !Class38.method461(this.anInt7863, this.anInt7826)) {
		if (this.aClass32_7889 != null) {
	    ...
	    if (this.aShortArray7849 != null && !Class38.method472(this.anInt7863, this.anInt7826)) {
		if (this.aClass32_7858 == null || (this.aClass32_7858.anInterface1_397) != null)
		    this.aShortArray7849 = null;
		else
		    this.aBoolean7864 = true;
	    }
	    if (this.aByteArray7850 != null && !Class38.method453(this.anInt7863, this.anInt7826)) {
		if (this.aClass32_7858 == null || (this.aClass32_7858.anInterface1_397) != null)
		    this.aByteArray7850 = null;
		else
		    this.aBoolean7864 = true;
	    }
	    if (this.aFloatArray7845 != null && !Class38.method462(this.anInt7863, this.anInt7826)) {
	    ...
	    if (this.aShortArray7861 != null && !Class38.method466(this.anInt7863, this.anInt7826)) {
		if (this.aClass32_7858 == null || (this.aClass32_7858.anInterface1_397) != null)
		    this.aShortArray7861 = null;
		else
		    this.aBoolean7864 = true;
	    }
	    if (this.aShortArray7851 != null && !Class38.method449(this.anInt7863, this.anInt7826)) {
	    ...
	    if (this.anIntArrayArray7855 != null && !Class38.method463(this.anInt7863, this.anInt7826)) {
		this.anIntArrayArray7855 = null;
		this.aShortArray7856 = null;
	    }
	    if (this.anIntArrayArray7837 != null && !Class38.method459(this.anInt7863, this.anInt7826)) {
		this.anIntArrayArray7837 = null;
		this.aShortArray7838 = null;
	    }
	    if (this.anIntArrayArray7882 != null && !Class38.method465(this.anInt7863, this.anInt7826))
		this.anIntArrayArray7882 = null;
	    if (this.anIntArray7859 != null && (this.anInt7863 & 0x800) == 0 && (this.anInt7863 & 0x40000) == 0)
	...
	if (this.anInt7839 != 0) {
	    Class233 class233 = (this.aClass_ra_Sub2_7824.aClass233_8041);
	    Class233 class233_110_ = (this.aClass_ra_Sub2_7824.aClass233_8104);
	    Class233 class233_111_ = (this.aClass_ra_Sub2_7824.aClass233_8184);
	    class233_110_.method2145(class222);
	    class233_111_.method2142(class233_110_);
	    class233_111_.method2144((this.aClass_ra_Sub2_7824).aClass233_8069);
	    if (!this.aBoolean7843)
		method4831();
	    float[] fs = (this.aClass_ra_Sub2_7824.aFloatArray8094);
	    class233_110_.method2149(0.0F, this.aShort7868, 0.0F, fs);
	    float f = fs[0];
	    float f_112_ = fs[1];
	    float f_113_ = fs[2];
	    class233_110_.method2149(0.0F, this.aShort7874, 0.0F, fs);
	    float f_114_ = fs[0];
	    float f_115_ = fs[1];
	    float f_116_ = fs[2];
	    for (int i_117_ = 0; i_117_ < 6; i_117_++) {
		float[] fs_118_ = (this.aClass_ra_Sub2_7824.aFloatArrayArray8077[i_117_]);
		float f_119_ = (fs_118_[0] * f + fs_118_[1] * f_112_ + fs_118_[2] * f_113_ + fs_118_[3] + this.anInt7891);
		float f_120_ = (fs_118_[0] * f_114_ + fs_118_[1] * f_115_ + fs_118_[2] * f_116_ + fs_118_[3] + this.anInt7891);
		...
		if (f_129_ >= -f_130_) {
		    class302_sub1.anInt7641 = (int) ((this.aClass_ra_Sub2_7824.aFloat8095) + ((this.aClass_ra_Sub2_7824).aFloat8096) * f_127_ / f_130_);
		    class302_sub1.anInt7642 = (int) ((this.aClass_ra_Sub2_7824.aFloat8097) + ((this.aClass_ra_Sub2_7824).aFloat8098) * f_128_ / f_130_);
		} else
		    bool = true;
		i_124_ = i_122_;
		...
		if (f_133_ >= -f_134_) {
		    class302_sub1.anInt7643 = (int) ((this.aClass_ra_Sub2_7824.aFloat8095) + ((this.aClass_ra_Sub2_7824).aFloat8096) * f_131_ / f_134_);
		    class302_sub1.anInt7640 = (int) ((this.aClass_ra_Sub2_7824.aFloat8097) + ((this.aClass_ra_Sub2_7824).aFloat8098) * f_132_ / f_134_);
		} else
		    bool = true;
		if (bool) {
			...
			class302_sub1.anInt7641 = (int) (((this.aClass_ra_Sub2_7824).aFloat8095) + ((this.aClass_ra_Sub2_7824).aFloat8096 * f_136_ / f_138_));
			class302_sub1.anInt7642 = (int) (((this.aClass_ra_Sub2_7824).aFloat8097) + ((this.aClass_ra_Sub2_7824).aFloat8098 * f_137_ / f_138_));
			...
			class302_sub1.anInt7643 = (int) (((this.aClass_ra_Sub2_7824).aFloat8095) + ((this.aClass_ra_Sub2_7824).aFloat8096 * f_140_ / f_142_));
			class302_sub1.anInt7640 = (int) (((this.aClass_ra_Sub2_7824).aFloat8097) + ((this.aClass_ra_Sub2_7824).aFloat8098 * f_141_ / f_142_));
		    }
		}
		if (bool_121_) {
		    if (f_129_ / f_130_ > f_133_ / f_134_) {
			float f_143_ = (f_127_ + (class233.aFloatArray2594[0] * this.anInt7891) + class233.aFloatArray2594[12]);
			float f_144_ = (f_130_ + (class233.aFloatArray2594[3] * this.anInt7891) + class233.aFloatArray2594[15]);
			class302_sub1.anInt7645 = (int) (((this.aClass_ra_Sub2_7824).aFloat8095) - class302_sub1.anInt7641 + ((this.aClass_ra_Sub2_7824).aFloat8096 * f_143_ / f_144_));
		    } else {
			float f_145_ = (f_131_ + (class233.aFloatArray2594[0] * this.anInt7891) + class233.aFloatArray2594[12]);
			float f_146_ = (f_134_ + (class233.aFloatArray2594[3] * this.anInt7891) + class233.aFloatArray2594[15]);
			class302_sub1.anInt7645 = (int) (((this.aClass_ra_Sub2_7824).aFloat8095) - class302_sub1.anInt7643 + ((this.aClass_ra_Sub2_7824).aFloat8096 * f_145_ / f_146_));
		    }
		    class302_sub1.aBoolean7644 = true;
		}
	    }
	    this.aClass_ra_Sub2_7824.method5252();
	    this.aClass_ra_Sub2_7824.method5283(class233_110_);
	    method4823();
	    this.aClass_ra_Sub2_7824.method5287();
	    class233_110_.method2144((this.aClass_ra_Sub2_7824).aClass233_8110);
	...
	if (i == 0) {
	    ...
	    anInt7866 = 0;
	    anInt7890 = 0;
	    for (int i_155_ = 0; i_155_ < this.anInt7833; i_155_++) {
		anInt7888 += this.anIntArray7834[i_155_];
		anInt7866 += this.anIntArray7835[i_155_];
		anInt7890 += this.anIntArray7836[i_155_];
		i_154_++;
	    }
	    if (i_154_ > 0) {
	    ...
	    for (int i_156_ = 0; i_156_ < this.anInt7833; i_156_++) {
		this.anIntArray7834[i_156_] += i_151_;
		this.anIntArray7835[i_156_] += i_152_;
		this.anIntArray7836[i_156_] += i_153_;
	    }
	} else if (i == 2) {
	    for (int i_157_ = 0; i_157_ < this.anInt7833; i_157_++) {
		this.anIntArray7834[i_157_] -= anInt7888;
		this.anIntArray7835[i_157_] -= anInt7866;
		this.anIntArray7836[i_157_] -= anInt7890;
		if (i_153_ != 0) {
		    int i_158_ = Class220.anIntArray2483[i_153_];
		    int i_159_ = Class220.anIntArray2474[i_153_];
		    int i_160_ = (((this.anIntArray7835[i_157_] * i_158_) + (this.anIntArray7834[i_157_] * i_159_) + 16383) >> 14);
		    this.anIntArray7835[i_157_] = ((this.anIntArray7835[i_157_] * i_159_) - (this.anIntArray7834[i_157_] * i_158_) + 16383) >> 14;
		    this.anIntArray7834[i_157_] = i_160_;
		}
		if (i_151_ != 0) {
		    int i_161_ = Class220.anIntArray2483[i_151_];
		    int i_162_ = Class220.anIntArray2474[i_151_];
		    int i_163_ = (((this.anIntArray7835[i_157_] * i_162_) - (this.anIntArray7836[i_157_] * i_161_) + 16383) >> 14);
		    this.anIntArray7836[i_157_] = ((this.anIntArray7835[i_157_] * i_161_) + (this.anIntArray7836[i_157_] * i_162_) + 16383) >> 14;
		    this.anIntArray7835[i_157_] = i_163_;
		}
		if (i_152_ != 0) {
		    int i_164_ = Class220.anIntArray2483[i_152_];
		    int i_165_ = Class220.anIntArray2474[i_152_];
		    int i_166_ = (((this.anIntArray7836[i_157_] * i_164_) + (this.anIntArray7834[i_157_] * i_165_) + 16383) >> 14);
		    this.anIntArray7836[i_157_] = ((this.anIntArray7836[i_157_] * i_165_) - (this.anIntArray7834[i_157_] * i_164_) + 16383) >> 14;
		    this.anIntArray7834[i_157_] = i_166_;
		}
		this.anIntArray7834[i_157_] += anInt7888;
		this.anIntArray7835[i_157_] += anInt7866;
		this.anIntArray7836[i_157_] += anInt7890;
	    ...
	    for (int i_167_ = 0; i_167_ < this.anInt7833; i_167_++) {
		this.anIntArray7834[i_167_] -= anInt7888;
		this.anIntArray7835[i_167_] -= anInt7866;
		this.anIntArray7836[i_167_] -= anInt7890;
		this.anIntArray7834[i_167_] = (this.anIntArray7834[i_167_] * i_151_ / 128);
		this.anIntArray7835[i_167_] = (this.anIntArray7835[i_167_] * i_152_ / 128);
		this.anIntArray7836[i_167_] = (this.anIntArray7836[i_167_] * i_153_ / 128);
		this.anIntArray7834[i_167_] += anInt7888;
		this.anIntArray7835[i_167_] += anInt7866;
		this.anIntArray7836[i_167_] += anInt7890;
	    }
	} else if (i == 5) {
	    for (int i_168_ = 0; i_168_ < this.anInt7847; i_168_++) {
		int i_169_ = ((this.aByteArray7850[i_168_] & 0xff) + i_151_ * 8);
		if (i_169_ < 0)
		    i_169_ = 0;
		else if (i_169_ > 255)
		    i_169_ = 255;
		this.aByteArray7850[i_168_] = (byte) i_169_;
	    }
	    if (this.aClass32_7858 != null)
		this.aClass32_7858.anInterface1_397 = null;
	    if (this.aClass54Array7880 != null) {
		for (int i_170_ = 0; i_170_ < this.anInt7877; i_170_++) {
		    Class54 class54 = this.aClass54Array7880[i_170_];
		    Class36 class36 = this.aClass36Array7875[i_170_];
		    class36.anInt424 = (class36.anInt424 & 0xffffff | 255 - ((this.aByteArray7850[class54.anInt549]) & 0xff) << 24);
		}
	    }
	} else if (i == 7) {
	    for (int i_171_ = 0; i_171_ < this.anInt7847; i_171_++) {
		int i_172_ = this.aShortArray7849[i_171_] & 0xffff;
		...
		if (i_175_ < 0)
		    ...
		    i_175_ = 127;
		this.aShortArray7849[i_171_] = (short) (i_173_ << 10 | i_174_ << 7 | i_175_);
	    }
	    if (this.aClass32_7858 != null)
		this.aClass32_7858.anInterface1_397 = null;
	    if (this.aClass54Array7880 != null) {
		for (int i_176_ = 0; i_176_ < this.anInt7877; i_176_++) {
		    Class54 class54 = this.aClass54Array7880[i_176_];
		    Class36 class36 = this.aClass36Array7875[i_176_];
		    class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
		}
	    }
	} else if (i == 8) {
	    for (int i_177_ = 0; i_177_ < this.anInt7877; i_177_++) {
		Class36 class36 = this.aClass36Array7875[i_177_];
		class36.anInt422 += i_151_;
		class36.anInt419 += i_152_;
	    }
	} else if (i == 10) {
	    for (int i_178_ = 0; i_178_ < this.anInt7877; i_178_++) {
		Class36 class36 = this.aClass36Array7875[i_178_];
		class36.anInt420 = class36.anInt420 * i_151_ >> 7;
		class36.anInt421 = class36.anInt421 * i_152_ >> 7;
	    }
	} else if (i == 9) {
	    for (int i_179_ = 0; i_179_ < this.anInt7877; i_179_++) {
		Class36 class36 = this.aClass36Array7875[i_179_];
	...
	if (this.anInt7847 != 0 && class387_sub2_192_.anInt7847 != 0) {
	    int i_193_ = class387_sub2_192_.anInt7833;
	    int[] is = class387_sub2_192_.anIntArray7834;
	    int[] is_194_ = class387_sub2_192_.anIntArray7835;
	    int[] is_195_ = class387_sub2_192_.anIntArray7836;
			...
			if (i_219_ >= i_214_ && i_219_ <= i_215_) {
				...
				for (int i_224_ = 0; i_224_ < i_193_; i_224_++) {
					...
					if (i_225_ != -1) {
						...
						is_203_ = (this.aClass67_7844).aByteArray670 = (Class409.method4978((this.aByteArray7887), 1194497584));
					    }
					    if (is_204_ == null) {
	...
	for (int i = 0; i < this.aShortArray7861.length; i++) {
	    if (this.aShortArray7861[i] != -1 && !(this.aClass_ra_Sub2_7824.anInterface_ma5299.method170(this.aShortArray7861[i], (short) 29809)))
		return false;
	}
	return true;
    }
	...
	if (i > 0 && i <= 7) {
	    class387_sub2_241_ = (this.aClass_ra_Sub2_7824.aClass387_Sub2Array8084[i - 1]);
	    class387_sub2_240_ = (this.aClass_ra_Sub2_7824.aClass387_Sub2Array8189[i - 1]);
	    bool_239_ = true;
	} else
	    class387_sub2_240_ = class387_sub2_241_ = new Class387_Sub2(this.aClass_ra_Sub2_7824);
	...
	if (this.aShortArray7838 != null) {
	    ...
	    if (bool) {
		class222_242_ = (this.aClass_ra_Sub2_7824).aClass222_8103;
		class222_242_.method2074(class222);
	    }
	    float[] fs = new float[3];
	    for (int i_243_ = 0; i_243_ < this.anInt7833; i_243_++) {
		if ((i & this.aShortArray7838[i_243_]) != 0) {
		    class222_242_.method2077(this.anIntArray7834[i_243_], this.anIntArray7835[i_243_], this.anIntArray7836[i_243_], fs);
		    this.anIntArray7834[i_243_] = (int) fs[0];
		    this.anIntArray7835[i_243_] = (int) fs[1];
		    this.anIntArray7836[i_243_] = (int) fs[2];
		}
	    }
	}
    }
	...
	if (i == 0) {
		...
		this.anIntArray7834[i_249_] += i_244_;
		this.anIntArray7835[i_249_] += i_245_;
		this.anIntArray7836[i_249_] += i_246_;
	    }
	} else if (i == 2) {
		...
		this.anIntArray7834[i_260_] = (this.anIntArray7834[i_260_] * i_244_ / 128);
		this.anIntArray7835[i_260_] = (this.anIntArray7835[i_260_] * i_245_ / 128);
		this.anIntArray7836[i_260_] = (this.anIntArray7836[i_260_] * i_246_ / 128);
		this.anIntArray7834[i_260_] += anInt7888;
		this.anIntArray7835[i_260_] += anInt7866;
		this.anIntArray7836[i_260_] += anInt7890;
	    }
		...
		int i_262_ = ((this.aByteArray7850[i_261_] & 0xff) + i_244_ * 8);
		if (i_262_ < 0)
		    i_262_ = 0;
		else if (i_262_ > 255)
		    i_262_ = 255;
	...
	for (int i_372_ = 0; i_372_ < this.anInt7833; i_372_++) {
	    if (i != 0)
		this.anIntArray7834[i_372_] += i;
	    if (i_370_ != 0)
		this.anIntArray7835[i_372_] += i_370_;
	    if (i_371_ != 0)
		this.anIntArray7836[i_372_] += i_371_;
	}
	if (this.aClass32_7831 != null)
	    this.aClass32_7831.anInterface1_397 = null;
	this.aBoolean7843 = false;
	...
	for (int i_375_ = 0; i_375_ < this.anInt7833; i_375_++) {
	    if (i != 0)
		this.anIntArray7834[i_375_] += i;
	    if (i_373_ != 0)
		this.anIntArray7835[i_375_] += i_373_;
	    if (i_374_ != 0)
		this.anIntArray7836[i_375_] += i_374_;
	}
	if (this.aClass32_7831 != null)
	    this.aClass32_7831.anInterface1_397 = null;
	this.aBoolean7843 = false;
	...
	Class233 class233 = (this.aClass_ra_Sub2_7824.aClass233_8104);
	class233.method2145(class222);
	class233.method2144(this.aClass_ra_Sub2_7824.aClass233_8069);
	...
	for (int i_395_ = 0; i_395_ < 8; i_395_++) {
		...
		int i_402_ = (int) (((this.aClass_ra_Sub2_7824).aFloat8095) + ((this.aClass_ra_Sub2_7824).aFloat8096) * f_400_ / f_399_);
		int i_403_ = (int) (((this.aClass_ra_Sub2_7824).aFloat8097) + ((this.aClass_ra_Sub2_7824).aFloat8098) * f_401_ / f_399_);
		if (i_402_ < i_379_)
		    i_379_ = i_402_;
		if (i_402_ > i_380_)
		    i_380_ = i_402_;
	...
	if (bool_378_ && i > i_379_ && i < i_380_ && i_376_ > i_381_ && i_376_ < i_382_) {
	    if (bool)
		return true;
	    if ((this.aClass_ra_Sub2_7824.anIntArray8198).length < this.anInt7839) {
		this.aClass_ra_Sub2_7824.anIntArray8198 = new int[this.anInt7839];
		this.aClass_ra_Sub2_7824.anIntArray8199 = new int[this.anInt7839];
	    }
	    int[] is = (this.aClass_ra_Sub2_7824.anIntArray8198);
	    int[] is_404_ = (this.aClass_ra_Sub2_7824.anIntArray8199);
		...
		if (f >= -f_409_) {
			...
			if (i_415_ == -1)
			    break;
			is[i_415_] = (int) (((this.aClass_ra_Sub2_7824).aFloat8095) + ((this.aClass_ra_Sub2_7824).aFloat8096 * f_410_ / f_409_));
			is_404_[i_415_] = (int) (((this.aClass_ra_Sub2_7824).aFloat8097) + ((this.aClass_ra_Sub2_7824).aFloat8098 * f_411_ / f_409_));
		    }
		} else {
	...
	if ((this.aClass_ra_Sub2_7824.anInt8066) > 0) {
	    i = ((this.aShort7870 - ((this.aShort7874 * this.aClass_ra_Sub2_7824.anInt8066) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	    i_428_ = ((this.aShort7871 - ((this.aShort7868 * (this.aClass_ra_Sub2_7824).anInt8066) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	} else {
	    i = ((this.aShort7870 - ((this.aShort7868 * this.aClass_ra_Sub2_7824.anInt8066) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	    i_428_ = ((this.aShort7871 - ((this.aShort7874 * (this.aClass_ra_Sub2_7824).anInt8066) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	}
	int i_429_;
	int i_430_;
	if ((this.aClass_ra_Sub2_7824.anInt8026) > 0) {
	    i_429_ = ((this.aShort7872 - ((this.aShort7874 * (this.aClass_ra_Sub2_7824).anInt8026) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	    i_430_ = ((this.aShort7876 - ((this.aShort7868 * (this.aClass_ra_Sub2_7824).anInt8026) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	} else {
	    i_429_ = ((this.aShort7872 - ((this.aShort7868 * (this.aClass_ra_Sub2_7824).anInt8026) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	    i_430_ = ((this.aShort7876 - ((this.aShort7874 * (this.aClass_ra_Sub2_7824).anInt8026) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	}
	...
	if (class_na_sub1 != null && class_na_sub1.method3481(i_431_, i_432_)) {
	    ...
	    class_na_sub1_433_ = new Class_na_Sub1(this.aClass_ra_Sub2_7824, i_431_, i_432_);
	...
	int[] is = (this.aClass_ra_Sub2_7824.anIntArray8198);
	int[] is_434_ = (this.aClass_ra_Sub2_7824.anIntArray8199);
	for (int i = 0; i < this.anInt7833; i++) {
	    int i_435_ = (((this.anIntArray7834[i] - ((this.anIntArray7835[i] * (this.aClass_ra_Sub2_7824).anInt8066) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064) - class_na_sub1.anInt10012);
	    int i_436_ = (((this.anIntArray7836[i] - ((this.anIntArray7835[i] * (this.aClass_ra_Sub2_7824).anInt8026) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064) - class_na_sub1.anInt10016);
	...
	if ((this.aClass_ra_Sub2_7824.anInt8066) > 0) {
	    i = ((this.aShort7870 - ((this.aShort7874 * this.aClass_ra_Sub2_7824.anInt8066) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	    i_450_ = ((this.aShort7871 - ((this.aShort7868 * (this.aClass_ra_Sub2_7824).anInt8066) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	} else {
	    i = ((this.aShort7870 - ((this.aShort7868 * this.aClass_ra_Sub2_7824.anInt8066) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	    i_450_ = ((this.aShort7871 - ((this.aShort7874 * (this.aClass_ra_Sub2_7824).anInt8066) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	}
	int i_451_;
	int i_452_;
	if ((this.aClass_ra_Sub2_7824.anInt8026) > 0) {
	    i_451_ = ((this.aShort7872 - ((this.aShort7874 * (this.aClass_ra_Sub2_7824).anInt8026) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	    i_452_ = ((this.aShort7876 - ((this.aShort7868 * (this.aClass_ra_Sub2_7824).anInt8026) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	} else {
	    i_451_ = ((this.aShort7872 - ((this.aShort7868 * (this.aClass_ra_Sub2_7824).anInt8026) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	    i_452_ = ((this.aShort7876 - ((this.aShort7874 * (this.aClass_ra_Sub2_7824).anInt8026) >> 8)) >> this.aClass_ra_Sub2_7824.anInt8064);
	}
	...
	if (class_na_sub1 != null && class_na_sub1.method3481(i_453_, i_454_)) {
	    ...
	    class_na_sub1_455_ = new Class_na_Sub1(this.aClass_ra_Sub2_7824, i_453_, i_454_);
	...
	if (this.anInt7885 != 0) {
		...
		if ((this.aClass41_7879.anInterface2_441) != null) {
		    this.aClass_ra_Sub2_7824.method5262(this.aClass32_7889 != null);
		    this.aClass_ra_Sub2_7824.method5248(this.aClass32_7831, this.aClass32_7889, this.aClass32_7858, this.aClass32_7860);
			...
			if (i_459_ == 65535)
			    i_459_ = -1;
			this.aClass_ra_Sub2_7824.method5253(i_459_, this.aClass32_7889 != null);
			this.aClass_ra_Sub2_7824.method5254((this.aClass41_7879.anInterface2_441), 4, i_457_ * 3, (i_458_ - i_457_) * 3);
		    }
		}
	    }
	    method4820();
	...
	if (this.aClass54Array7880 != null) {
	    Class233 class233_460_ = (this.aClass_ra_Sub2_7824.aClass233_8030);
	    this.aClass_ra_Sub2_7824.method5236();
	    this.aClass_ra_Sub2_7824.RA(!this.aBoolean7840);
	    this.aClass_ra_Sub2_7824.method5262(false);
	    this.aClass_ra_Sub2_7824.method5248((this.aClass_ra_Sub2_7824.aClass32_8092), null, null, (this.aClass_ra_Sub2_7824.aClass32_8193));
	    for (int i = 0; i < this.anInt7877; i++) {
		Class54 class54 = this.aClass54Array7880[i];
		Class36 class36 = this.aClass36Array7875[i];
		if (!class54.aBoolean554 || !this.aClass_ra_Sub2_7824.method5054()) {
		    float f = (((this.anIntArray7834[class54.anInt555]) + (this.anIntArray7834[class54.anInt547]) + (this.anIntArray7834[class54.anInt548])) * 0.3333333F);
		    float f_461_ = (((this.anIntArray7835[class54.anInt555]) + (this.anIntArray7835[class54.anInt547]) + (this.anIntArray7835[class54.anInt548])) * 0.3333333F);
		    float f_462_ = (((this.anIntArray7836[class54.anInt555]) + (this.anIntArray7836[class54.anInt547]) + (this.anIntArray7836[class54.anInt548])) * 0.3333333F);
		    ...
		    this.aClass_ra_Sub2_7824.method5233(class233_460_);
		    int i_467_ = class36.anInt424;
		    OpenGL.glColor4ub((byte) (i_467_ >> 16), (byte) (i_467_ >> 8), (byte) i_467_, (byte) (i_467_ >> 24));
		    this.aClass_ra_Sub2_7824.method5275(class54.aShort552);
		    this.aClass_ra_Sub2_7824.method5266(class54.aByte553);
		    this.aClass_ra_Sub2_7824.method5285(7, 0, 4);
		}
	    }
	    this.aClass_ra_Sub2_7824.RA(true);
	    this.aClass_ra_Sub2_7824.method5287();
	}
    }
	...
	if (i != 0) {
	    if ((this.aClass_ra_Sub2_7824.aClass298_Sub53_Sub1_8197.buffer).length < this.anInt7839 * i)
		this.aClass_ra_Sub2_7824.aClass298_Sub53_Sub1_8197 = new RsFloatBuffer((this.anInt7839 + 100) * i);
	    else
		this.aClass_ra_Sub2_7824.aClass298_Sub53_Sub1_8197.index = 0;
	    RsFloatBuffer class298_sub53_sub1 = (this.aClass_ra_Sub2_7824.aClass298_Sub53_Sub1_8197);
	    if (bool_470_) {
		if (this.aClass_ra_Sub2_7824.aBoolean8143) {
		    for (int i_476_ = 0; i_476_ < this.anInt7833; i_476_++) {
			int i_477_ = Stream.floatToRawIntBits(this.anIntArray7834[i_476_]);
			int i_478_ = Stream.floatToRawIntBits(this.anIntArray7835[i_476_]);
			int i_479_ = Stream.floatToRawIntBits(this.anIntArray7836[i_476_]);
			...
			int i_485_ = Stream.floatToRawIntBits(this.anIntArray7834[i_484_]);
			int i_486_ = Stream.floatToRawIntBits(this.anIntArray7835[i_484_]);
			int i_487_ = Stream.floatToRawIntBits(this.anIntArray7836[i_484_]);
		...
		if (this.aClass32_7889 == null) {
		    ...
		    float f = (this.aClass_ra_Sub2_7824.aFloatArray8124[0]);
		    float f_495_ = ((this.aClass_ra_Sub2_7824).aFloatArray8124[1]);
		    float f_496_ = ((this.aClass_ra_Sub2_7824).aFloatArray8124[2]);
		    float f_497_ = ((this.aClass_ra_Sub2_7824).aFloat8130);
		    float f_498_ = ((this.aClass_ra_Sub2_7824).aFloat8131 * 768.0F / this.aShort7869);
		    float f_499_ = ((this.aClass_ra_Sub2_7824).aFloat8132 * 768.0F / this.aShort7869);
			...
			float f_502_ = ((i_501_ >>> 24) * (this.aClass_ra_Sub2_7824.aFloat8125));
			float f_503_ = ((i_501_ >> 16 & 0xff) * (this.aClass_ra_Sub2_7824.aFloat8128));
			float f_504_ = ((i_501_ >> 8 & 0xff) * (this.aClass_ra_Sub2_7824.aFloat8191));
			...
			class298_sub53_sub1.index = (i_473_ + ((this.aShortArray7851[i_512_]) & 0xffff) * i) * 116413311;
			class298_sub53_sub1.writeInt(i_513_, -2055604033);
			class298_sub53_sub1.index = (i_473_ + ((this.aShortArray7852[i_512_]) & 0xffff) * i) * 116413311;
			class298_sub53_sub1.writeInt(i_513_, -1511620106);
			class298_sub53_sub1.index = (i_473_ + ((this.aShortArray7853[i_512_]) & 0xffff) * i) * 116413311;
		...
		float f = 3.0F / this.aShort7869;
		float f_517_ = 3.0F / (this.aShort7869 + this.aShort7869 / 2);
	    ...
	    class298_sub53_sub1.index = i * this.anInt7839 * 116413311;
	    Interface1 interface1;
	    if (bool) {
		if (this.anInterface1_7873 == null)
		    this.anInterface1_7873 = (this.aClass_ra_Sub2_7824.method5244(i, class298_sub53_sub1.buffer, class298_sub53_sub1.index * 385051775, true));
		else
		    this.anInterface1_7873.method8(i, class298_sub53_sub1.buffer, class298_sub53_sub1.index * 385051775);
		interface1 = this.anInterface1_7873;
		this.aByte7827 = (byte) 0;
	    } else {
		interface1 = (this.aClass_ra_Sub2_7824.method5244(i, class298_sub53_sub1.buffer, class298_sub53_sub1.index * 385051775, false));
		this.aBoolean7864 = true;
	    }
	    if (bool_470_) {
	...
	if (i_526_ != -1) {
	    Class53 class53 = this.aClass_ra_Sub2_7824.anInterface_ma5299.method174(i_526_ & 0xffff, 633788173);
	...
	if (i == 0) {
		...
		if (i_546_ < this.anIntArrayArray7837.length) {
		    int[] is_547_ = this.anIntArrayArray7837[i_546_];
		    for (int i_548_ = 0; i_548_ < is_547_.length; i_548_++) {
			int i_549_ = is_547_[i_548_];
			anInt7888 += this.anIntArray7834[i_549_];
			anInt7866 += this.anIntArray7835[i_549_];
			anInt7890 += this.anIntArray7836[i_549_];
			i_544_++;
		    }
		}
	    }
		...
		if (i_551_ < this.anIntArrayArray7837.length) {
		    int[] is_552_ = this.anIntArrayArray7837[i_551_];
		    for (int i_553_ = 0; i_553_ < is_552_.length; i_553_++) {
			int i_554_ = is_552_[i_553_];
			this.anIntArray7834[i_554_] += i_539_;
			this.anIntArray7835[i_554_] += i_540_;
			this.anIntArray7836[i_554_] += i_541_;
		    }
		}
	    }
	} else if (i == 2) {
		...
		if (i_556_ < this.anIntArrayArray7837.length) {
		    int[] is_557_ = this.anIntArrayArray7837[i_556_];
		    if ((i_542_ & 0x1) == 0) {
			for (int i_558_ = 0; i_558_ < is_557_.length; i_558_++) {
			    int i_559_ = is_557_[i_558_];
			    this.anIntArray7834[i_559_] -= anInt7888;
			    this.anIntArray7835[i_559_] -= anInt7866;
			    this.anIntArray7836[i_559_] -= anInt7890;
			    if (i_541_ != 0) {
				int i_560_ = Class220.anIntArray2483[i_541_];
				int i_561_ = Class220.anIntArray2474[i_541_];
				int i_562_ = (((this.anIntArray7835[i_559_]) * i_560_ + (this.anIntArray7834[i_559_]) * i_561_ + 16383) >> 14);
				this.anIntArray7835[i_559_] = ((this.anIntArray7835[i_559_]) * i_561_ - (this.anIntArray7834[i_559_]) * i_560_ + 16383) >> 14;
				this.anIntArray7834[i_559_] = i_562_;
			    }
			    if (i_539_ != 0) {
				int i_563_ = Class220.anIntArray2483[i_539_];
				int i_564_ = Class220.anIntArray2474[i_539_];
				int i_565_ = (((this.anIntArray7835[i_559_]) * i_564_ - (this.anIntArray7836[i_559_]) * i_563_ + 16383) >> 14);
				this.anIntArray7836[i_559_] = ((this.anIntArray7835[i_559_]) * i_563_ + (this.anIntArray7836[i_559_]) * i_564_ + 16383) >> 14;
				this.anIntArray7835[i_559_] = i_565_;
			    }
			    if (i_540_ != 0) {
				int i_566_ = Class220.anIntArray2483[i_540_];
				int i_567_ = Class220.anIntArray2474[i_540_];
				int i_568_ = (((this.anIntArray7836[i_559_]) * i_566_ + (this.anIntArray7834[i_559_]) * i_567_ + 16383) >> 14);
				this.anIntArray7836[i_559_] = ((this.anIntArray7836[i_559_]) * i_567_ - (this.anIntArray7834[i_559_]) * i_566_ + 16383) >> 14;
				this.anIntArray7834[i_559_] = i_568_;
			    }
			    this.anIntArray7834[i_559_] += anInt7888;
			    this.anIntArray7835[i_559_] += anInt7866;
			    this.anIntArray7836[i_559_] += anInt7890;
			...
			for (int i_569_ = 0; i_569_ < is_557_.length; i_569_++) {
			    ...
			    this.anIntArray7834[i_570_] -= anInt7888;
			    this.anIntArray7835[i_570_] -= anInt7866;
			    this.anIntArray7836[i_570_] -= anInt7890;
			    if (i_539_ != 0) {
				int i_571_ = Class220.anIntArray2483[i_539_];
				int i_572_ = Class220.anIntArray2474[i_539_];
				int i_573_ = (((this.anIntArray7835[i_570_]) * i_572_ - (this.anIntArray7836[i_570_]) * i_571_ + 16383) >> 14);
				this.anIntArray7836[i_570_] = ((this.anIntArray7835[i_570_]) * i_571_ + (this.anIntArray7836[i_570_]) * i_572_ + 16383) >> 14;
				this.anIntArray7835[i_570_] = i_573_;
			    }
			    if (i_541_ != 0) {
				int i_574_ = Class220.anIntArray2483[i_541_];
				int i_575_ = Class220.anIntArray2474[i_541_];
				int i_576_ = (((this.anIntArray7835[i_570_]) * i_574_ + (this.anIntArray7834[i_570_]) * i_575_ + 16383) >> 14);
				this.anIntArray7835[i_570_] = ((this.anIntArray7835[i_570_]) * i_575_ - (this.anIntArray7834[i_570_]) * i_574_ + 16383) >> 14;
				this.anIntArray7834[i_570_] = i_576_;
			    }
			    if (i_540_ != 0) {
				int i_577_ = Class220.anIntArray2483[i_540_];
				int i_578_ = Class220.anIntArray2474[i_540_];
				int i_579_ = (((this.anIntArray7836[i_570_]) * i_577_ + (this.anIntArray7834[i_570_]) * i_578_ + 16383) >> 14);
				this.anIntArray7836[i_570_] = ((this.anIntArray7836[i_570_]) * i_578_ - (this.anIntArray7834[i_570_]) * i_577_ + 16383) >> 14;
				this.anIntArray7834[i_570_] = i_579_;
			    }
			    this.anIntArray7834[i_570_] += anInt7888;
			    this.anIntArray7835[i_570_] += anInt7866;
			    this.anIntArray7836[i_570_] += anInt7890;
		...
		for (int i_580_ = 0; i_580_ < i_543_; i_580_++) {
		    ...
		    if (i_581_ < this.anIntArrayArray7837.length) {
			int[] is_582_ = (this.anIntArrayArray7837[i_581_]);
			for (int i_583_ = 0; i_583_ < is_582_.length; i_583_++) {
			    int i_584_ = is_582_[i_583_];
			    int i_585_ = (this.anIntArray7854[i_584_]);
			    int i_586_ = (this.anIntArray7854[i_584_ + 1]);
			    for (int i_587_ = i_585_; i_587_ < i_586_; i_587_++) {
				int i_588_ = ((this.aShortArray7830[i_587_]) - 1);
				if (i_588_ == -1)
				    break;
				if (i_541_ != 0) {
				    int i_589_ = Class220.anIntArray2483[i_541_];
				    int i_590_ = Class220.anIntArray2474[i_541_];
				    int i_591_ = (((this.aShortArray7841[i_588_]) * i_589_ + ((this.aShortArray7829[i_588_]) * i_590_) + 16383) >> 14);
				    this.aShortArray7841[i_588_] = (short) ((((this.aShortArray7841[i_588_]) * i_590_) - (this.aShortArray7829[i_588_]) * i_589_ + 16383) >> 14);
				    this.aShortArray7829[i_588_] = (short) i_591_;
				}
				if (i_539_ != 0) {
				    int i_592_ = Class220.anIntArray2483[i_539_];
				    int i_593_ = Class220.anIntArray2474[i_539_];
				    int i_594_ = (((this.aShortArray7841[i_588_]) * i_593_ - ((this.aShortArray7842[i_588_]) * i_592_) + 16383) >> 14);
				    this.aShortArray7842[i_588_] = (short) ((((this.aShortArray7841[i_588_]) * i_592_) + (this.aShortArray7842[i_588_]) * i_593_ + 16383) >> 14);
				    this.aShortArray7841[i_588_] = (short) i_594_;
				}
				if (i_540_ != 0) {
				    int i_595_ = Class220.anIntArray2483[i_540_];
				    int i_596_ = Class220.anIntArray2474[i_540_];
				    int i_597_ = (((this.aShortArray7842[i_588_]) * i_595_ + ((this.aShortArray7829[i_588_]) * i_596_) + 16383) >> 14);
				    this.aShortArray7842[i_588_] = (short) ((((this.aShortArray7842[i_588_]) * i_596_) - (this.aShortArray7829[i_588_]) * i_595_ + 16383) >> 14);
				    this.aShortArray7829[i_588_] = (short) i_597_;
				}
			    }
			}
		    }
		...
		if (i_599_ < this.anIntArrayArray7837.length) {
		    int[] is_600_ = this.anIntArrayArray7837[i_599_];
		    for (int i_601_ = 0; i_601_ < is_600_.length; i_601_++) {
			int i_602_ = is_600_[i_601_];
			this.anIntArray7834[i_602_] -= anInt7888;
			this.anIntArray7835[i_602_] -= anInt7866;
			this.anIntArray7836[i_602_] -= anInt7890;
			this.anIntArray7834[i_602_] = (this.anIntArray7834[i_602_] * i_539_) >> 7;
			this.anIntArray7835[i_602_] = (this.anIntArray7835[i_602_] * i_540_) >> 7;
			this.anIntArray7836[i_602_] = (this.anIntArray7836[i_602_] * i_541_) >> 7;
			this.anIntArray7834[i_602_] += anInt7888;
			this.anIntArray7835[i_602_] += anInt7866;
			this.anIntArray7836[i_602_] += anInt7890;
		    }
		...
		for (int i_603_ = 0; i_603_ < i_543_; i_603_++) {
		    ...
		    if (i_604_ < this.anIntArrayArray7855.length) {
			int[] is_605_ = (this.anIntArrayArray7855[i_604_]);
			for (int i_606_ = 0; i_606_ < is_605_.length; i_606_++) {
			    int i_607_ = is_605_[i_606_];
			    int i_608_ = (((this.aByteArray7850[i_607_]) & 0xff) + i_539_ * 8);
			    if (i_608_ < 0)
				i_608_ = 0;
			    else if (i_608_ > 255)
				i_608_ = 255;
			    this.aByteArray7850[i_607_] = (byte) i_608_;
			}
			if (is_605_.length > 0 && this.aClass32_7858 != null)
			    this.aClass32_7858.anInterface1_397 = null;
		    }
		}
		if (this.aClass54Array7880 != null) {
		    for (int i_609_ = 0; i_609_ < this.anInt7877; i_609_++) {
			Class54 class54 = this.aClass54Array7880[i_609_];
			Class36 class36 = this.aClass36Array7875[i_609_];
			class36.anInt424 = (class36.anInt424 & 0xffffff | 255 - ((this.aByteArray7850[class54.anInt549]) & 0xff) << 24);
		    }
		}
	    }
		...
		for (int i_610_ = 0; i_610_ < i_543_; i_610_++) {
		    ...
		    if (i_611_ < this.anIntArrayArray7855.length) {
			int[] is_612_ = (this.anIntArrayArray7855[i_611_]);
			for (int i_613_ = 0; i_613_ < is_612_.length; i_613_++) {
			    int i_614_ = is_612_[i_613_];
			    int i_615_ = ((this.aShortArray7849[i_614_]) & 0xffff);
				...
				i_618_ = 127;
			    this.aShortArray7849[i_614_] = (short) (i_616_ << 10 | i_617_ << 7 | i_618_);
			}
			if (is_612_.length > 0 && this.aClass32_7858 != null)
			    this.aClass32_7858.anInterface1_397 = null;
		    }
		}
		if (this.aClass54Array7880 != null) {
		    for (int i_619_ = 0; i_619_ < this.anInt7877; i_619_++) {
			Class54 class54 = this.aClass54Array7880[i_619_];
			Class36 class36 = this.aClass36Array7875[i_619_];
			class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
		    }
		}
	    }
		...
		for (int i_620_ = 0; i_620_ < i_543_; i_620_++) {
		    ...
		    if (i_621_ < this.anIntArrayArray7882.length) {
			int[] is_622_ = (this.anIntArrayArray7882[i_621_]);
			for (int i_623_ = 0; i_623_ < is_622_.length; i_623_++) {
			    Class36 class36 = (this.aClass36Array7875[is_622_[i_623_]]);
		...
		for (int i_624_ = 0; i_624_ < i_543_; i_624_++) {
		    ...
		    if (i_625_ < this.anIntArrayArray7882.length) {
			int[] is_626_ = (this.anIntArrayArray7882[i_625_]);
			for (int i_627_ = 0; i_627_ < is_626_.length; i_627_++) {
			    Class36 class36 = (this.aClass36Array7875[is_626_[i_627_]]);
		...
		for (int i_628_ = 0; i_628_ < i_543_; i_628_++) {
		    ...
		    if (i_629_ < this.anIntArrayArray7882.length) {
			int[] is_630_ = (this.anIntArrayArray7882[i_629_]);
			for (int i_631_ = 0; i_631_ < is_630_.length; i_631_++) {
			    Class36 class36 = (this.aClass36Array7875[is_630_[i_631_]]);
	...
	if (this.anInt7847 != 0 && class387_sub2_634_.anInt7847 != 0) {
	    int i_635_ = class387_sub2_634_.anInt7833;
	    int[] is = class387_sub2_634_.anIntArray7834;
	    int[] is_636_ = class387_sub2_634_.anIntArray7835;
	    int[] is_637_ = class387_sub2_634_.anIntArray7836;
	    ...
	    byte[] is_645_;
	    if (this.aClass67_7844 != null) {
		is_642_ = (this.aClass67_7844.aShortArray669);
		is_643_ = (this.aClass67_7844.aShortArray668);
		is_644_ = (this.aClass67_7844.aShortArray667);
		is_645_ = (this.aClass67_7844.aByteArray670);
	    } else {
		is_642_ = null;
		is_643_ = null;
		is_644_ = null;
	    ...
	    for (int i_658_ = 0; i_658_ < this.anInt7833; i_658_++) {
		int i_659_ = this.anIntArray7835[i_658_] - i_632_;
		if (i_659_ >= i_652_ && i_659_ <= i_653_) {
		    int i_660_ = this.anIntArray7834[i_658_] - i;
		    if (i_660_ >= i_654_ && i_660_ <= i_655_) {
			int i_661_ = (this.anIntArray7836[i_658_] - i_633_);
			if (i_661_ >= i_656_ && i_661_ <= i_657_) {
			    int i_662_ = -1;
			    int i_663_ = (this.anIntArray7854[i_658_]);
			    int i_664_ = (this.anIntArray7854[i_658_ + 1]);
			    for (int i_665_ = i_663_; i_665_ < i_664_; i_665_++) {
				i_662_ = (this.aShortArray7830[i_665_]) - 1;
				if (i_662_ == -1 || (this.aByteArray7887[i_662_]) != 0)
				    break;
			    }
			    if (i_662_ != -1) {
				for (int i_666_ = 0; i_666_ < i_635_; i_666_++) {
					...
					if (i_667_ != -1) {
					    if (is_642_ == null) {
						this.aClass67_7844 = new Class67();
						is_642_ = (this.aClass67_7844).aShortArray669 = (Class378.method4670((this.aShortArray7829), (byte) -55));
						is_643_ = (this.aClass67_7844).aShortArray668 = (Class378.method4670((this.aShortArray7841), (byte) -75));
						is_644_ = (this.aClass67_7844).aShortArray667 = (Class378.method4670((this.aShortArray7842), (byte) -112));
						is_645_ = (this.aClass67_7844).aByteArray670 = (Class409.method4978((this.aByteArray7887), 1194497584));
					    }
					    if (is_646_ == null) {
					    ...
					    short i_669_ = (this.aShortArray7829[i_662_]);
					    short i_670_ = (this.aShortArray7841[i_662_]);
					    short i_671_ = (this.aShortArray7842[i_662_]);
					    byte i_672_ = (this.aByteArray7887[i_662_]);
					    i_663_ = is_650_[i_666_];
					    i_664_ = is_650_[i_666_ + 1];
					    ...
					    i_663_ = (this.anIntArray7854[i_658_]);
					    i_664_ = (this.anIntArray7854[i_658_ + 1]);
					    for (int i_675_ = i_663_; i_675_ < i_664_; i_675_++) {
						int i_676_ = ((this.aShortArray7830[i_675_]) - 1);
						if (i_676_ == -1)
						    break;
						if (is_645_[i_676_] != 0) {
	...
	if (i > 0 && i <= 7) {
	    class387_sub2_680_ = (this.aClass_ra_Sub2_7824.aClass387_Sub2Array8084[i - 1]);
	    class387_sub2_679_ = (this.aClass_ra_Sub2_7824.aClass387_Sub2Array8189[i - 1]);
	    bool_678_ = true;
	} else
	    class387_sub2_679_ = class387_sub2_680_ = new Class387_Sub2(this.aClass_ra_Sub2_7824);
	...
	if (i > 0 && i <= 7) {
	    class387_sub2_684_ = (this.aClass_ra_Sub2_7824.aClass387_Sub2Array8084[i - 1]);
	    class387_sub2_683_ = (this.aClass_ra_Sub2_7824.aClass387_Sub2Array8189[i - 1]);
	    bool_682_ = true;
	} else
	    class387_sub2_683_ = class387_sub2_684_ = new Class387_Sub2(this.aClass_ra_Sub2_7824);
	...
	if (i > 0 && i <= 7) {
	    class387_sub2_688_ = (this.aClass_ra_Sub2_7824.aClass387_Sub2Array8084[i - 1]);
	    class387_sub2_687_ = (this.aClass_ra_Sub2_7824.aClass387_Sub2Array8189[i - 1]);
	    bool_686_ = true;
	} else
	    class387_sub2_687_ = class387_sub2_688_ = new Class387_Sub2(this.aClass_ra_Sub2_7824);
	...
	Class233 class233 = (this.aClass_ra_Sub2_7824.aClass233_8104);
	class233.method2145(class222);
	if (this.aClass85Array7825 != null) {
	    for (int i = 0; i < this.aClass85Array7825.length; i++) {
		Class85 class85 = this.aClass85Array7825[i];
		Class85 class85_689_ = class85;
		if (class85.aClass85_776 != null)
		    class85_689_ = class85.aClass85_776;
		class85_689_.anInt777 = ((int) (class233.aFloatArray2594[12] + ((class233.aFloatArray2594[0] * (this.anIntArray7834[class85.anInt773 * -710317103])) + (class233.aFloatArray2594[4] * (this.anIntArray7835[(class85.anInt773 * -710317103)])) + (class233.aFloatArray2594[8] * (this.anIntArray7836[(class85.anInt773 * -710317103)])))) * -1879868075);
		class85_689_.anInt783 = ((int) (class233.aFloatArray2594[13] + ((class233.aFloatArray2594[1] * (this.anIntArray7834[class85.anInt773 * -710317103])) + (class233.aFloatArray2594[5] * (this.anIntArray7835[(class85.anInt773 * -710317103)])) + (class233.aFloatArray2594[9] * (this.anIntArray7836[(class85.anInt773 * -710317103)])))) * -2041556771);
		class85_689_.anInt779 = ((int) (class233.aFloatArray2594[14] + ((class233.aFloatArray2594[2] * (this.anIntArray7834[class85.anInt773 * -710317103])) + (class233.aFloatArray2594[6] * (this.anIntArray7835[(class85.anInt773 * -710317103)])) + (class233.aFloatArray2594[10] * (this.anIntArray7836[(class85.anInt773 * -710317103)])))) * -1434499227);
		class85_689_.anInt772 = ((int) (class233.aFloatArray2594[12] + ((class233.aFloatArray2594[0] * (this.anIntArray7834[class85.anInt774 * 1705862021])) + (class233.aFloatArray2594[4] * (this.anIntArray7835[(class85.anInt774 * 1705862021)])) + (class233.aFloatArray2594[8] * (this.anIntArray7836[(class85.anInt774 * 1705862021)])))) * 1070341177);
		class85_689_.anInt781 = ((int) (class233.aFloatArray2594[13] + ((class233.aFloatArray2594[1] * (this.anIntArray7834[class85.anInt774 * 1705862021])) + (class233.aFloatArray2594[5] * (this.anIntArray7835[(class85.anInt774 * 1705862021)])) + (class233.aFloatArray2594[9] * (this.anIntArray7836[(class85.anInt774 * 1705862021)])))) * 1802851857);
		class85_689_.anInt782 = (int) (class233.aFloatArray2594[14] + ((class233.aFloatArray2594[2] * (this.anIntArray7834[class85.anInt774 * 1705862021])) + (class233.aFloatArray2594[6] * (this.anIntArray7835[class85.anInt774 * 1705862021])) + (class233.aFloatArray2594[10] * (this.anIntArray7836[(class85.anInt774 * 1705862021)])))) * 103846281;
		class85_689_.anInt771 = ((int) (class233.aFloatArray2594[12] + ((class233.aFloatArray2594[0] * (this.anIntArray7834[class85.anInt775 * 1636170731])) + (class233.aFloatArray2594[4] * (this.anIntArray7835[(class85.anInt775 * 1636170731)])) + (class233.aFloatArray2594[8] * (this.anIntArray7836[(class85.anInt775 * 1636170731)])))) * -2103324039);
		class85_689_.anInt784 = ((int) (class233.aFloatArray2594[13] + ((class233.aFloatArray2594[1] * (this.anIntArray7834[class85.anInt775 * 1636170731])) + (class233.aFloatArray2594[5] * (this.anIntArray7835[(class85.anInt775 * 1636170731)])) + (class233.aFloatArray2594[9] * (this.anIntArray7836[(class85.anInt775 * 1636170731)])))) * -526039059);
		class85_689_.anInt785 = (int) (class233.aFloatArray2594[14] + ((class233.aFloatArray2594[2] * (this.anIntArray7834[class85.anInt775 * 1636170731])) + (class233.aFloatArray2594[6] * (this.anIntArray7835[class85.anInt775 * 1636170731])) + (class233.aFloatArray2594[10] * (this.anIntArray7836[(class85.anInt775 * 1636170731)])))) * 491030489;
	    }
	}
	if (this.aClass68Array7857 != null) {
	    for (int i = 0; i < this.aClass68Array7857.length; i++) {
		Class68 class68 = this.aClass68Array7857[i];
		...
		class68_690_.anInt671 = ((int) (class233.aFloatArray2594[12] + ((class233.aFloatArray2594[0] * (this.anIntArray7834[class68.anInt674 * -180596249])) + (class233.aFloatArray2594[4] * (this.anIntArray7835[(class68.anInt674 * -180596249)])) + (class233.aFloatArray2594[8] * (this.anIntArray7836[(class68.anInt674 * -180596249)])))) * -1436341053);
		class68_690_.anInt675 = (int) (class233.aFloatArray2594[13] + ((class233.aFloatArray2594[1] * (this.anIntArray7834[class68.anInt674 * -180596249])) + (class233.aFloatArray2594[5] * (this.anIntArray7835[class68.anInt674 * -180596249])) + (class233.aFloatArray2594[9] * (this.anIntArray7836[(class68.anInt674 * -180596249)])))) * 449866009;
		class68_690_.anInt676 = ((int) (class233.aFloatArray2594[14] + ((class233.aFloatArray2594[2] * (this.anIntArray7834[class68.anInt674 * -180596249])) + (class233.aFloatArray2594[6] * (this.anIntArray7835[(class68.anInt674 * -180596249)])) + (class233.aFloatArray2594[10] * (this.anIntArray7836[(class68.anInt674 * -180596249)])))) * 1336328763);
	    }
	}
    }
	...
	for (int i_693_ = 0; i_693_ < this.anInt7833; i_693_++) {
	    int i_694_ = ((this.anIntArray7836[i_693_] * i_691_ + this.anIntArray7834[i_693_] * i_692_) >> 14);
	    this.anIntArray7836[i_693_] = ((this.anIntArray7836[i_693_] * i_692_ - this.anIntArray7834[i_693_] * i_691_) >> 14);
	    this.anIntArray7834[i_693_] = i_694_;
	}
	for (int i_695_ = 0; i_695_ < this.anInt7839; i_695_++) {
	    int i_696_ = ((this.aShortArray7842[i_695_] * i_691_ + this.aShortArray7829[i_695_] * i_692_) >> 14);
	    this.aShortArray7842[i_695_] = (short) (((this.aShortArray7842[i_695_] * i_692_) - (this.aShortArray7829[i_695_] * i_691_)) >> 14);
	    this.aShortArray7829[i_695_] = (short) i_696_;
	}
	if (this.aClass32_7889 == null && this.aClass32_7858 != null)
	    this.aClass32_7858.anInterface1_397 = null;
	if (this.aClass32_7889 != null)
	...
	Interface_ma interface_ma = this.aClass_ra_Sub2_7824.anInterface_ma5299;
	for (int i_698_ = 0; i_698_ < this.anInt7847; i_698_++) {
	    if (this.aShortArray7861[i_698_] == i)
		this.aShortArray7861[i_698_] = i_697_;
	}
	byte i_699_ = 0;
	byte i_700_ = 0;
	if (i != -1) {
	...
	if (i_699_ != i_701_ | i_700_ != i_702_) {
	    if (this.aClass54Array7880 != null) {
		for (int i_703_ = 0; i_703_ < this.anInt7877; i_703_++) {
		    Class54 class54 = this.aClass54Array7880[i_703_];
		    Class36 class36 = this.aClass36Array7875[i_703_];
		    class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
		}
	    }
	    if (this.aClass32_7858 != null)
	...
	for (int i_716_ = 0; i_716_ < this.anInt7833; i_716_++) {
	    int i_717_ = ((this.anIntArray7836[i_716_] * i_714_ + this.anIntArray7834[i_716_] * i_715_) >> 14);
	    this.anIntArray7836[i_716_] = ((this.anIntArray7836[i_716_] * i_715_ - this.anIntArray7834[i_716_] * i_714_) >> 14);
	    this.anIntArray7834[i_716_] = i_717_;
	}
	for (int i_718_ = 0; i_718_ < this.anInt7839; i_718_++) {
	    int i_719_ = ((this.aShortArray7842[i_718_] * i_714_ + this.aShortArray7829[i_718_] * i_715_) >> 14);
	    this.aShortArray7842[i_718_] = (short) (((this.aShortArray7842[i_718_] * i_715_) - (this.aShortArray7829[i_718_] * i_714_)) >> 14);
	    this.aShortArray7829[i_718_] = (short) i_719_;
	}
	if (this.aClass32_7889 == null && this.aClass32_7858 != null)
	    this.aClass32_7858.anInterface1_397 = null;
	if (this.aClass32_7889 != null)
	...
	for (int i_722_ = 0; i_722_ < this.anInt7833; i_722_++) {
	    int i_723_ = ((this.anIntArray7836[i_722_] * i_720_ + this.anIntArray7834[i_722_] * i_721_) >> 14);
	    this.anIntArray7836[i_722_] = ((this.anIntArray7836[i_722_] * i_721_ - this.anIntArray7834[i_722_] * i_720_) >> 14);
	    this.anIntArray7834[i_722_] = i_723_;
	}
	for (int i_724_ = 0; i_724_ < this.anInt7839; i_724_++) {
	    int i_725_ = ((this.aShortArray7842[i_724_] * i_720_ + this.aShortArray7829[i_724_] * i_721_) >> 14);
	    this.aShortArray7842[i_724_] = (short) (((this.aShortArray7842[i_724_] * i_721_) - (this.aShortArray7829[i_724_] * i_720_)) >> 14);
	    this.aShortArray7829[i_724_] = (short) i_725_;
	}
	if (this.aClass32_7889 == null && this.aClass32_7858 != null)
	    this.aClass32_7858.anInterface1_397 = null;
	if (this.aClass32_7889 != null)
	...
	if (i == 0) {
		...
		if (i_734_ < this.anIntArrayArray7837.length) {
		    int[] is_735_ = this.anIntArrayArray7837[i_734_];
		    for (int i_736_ = 0; i_736_ < is_735_.length; i_736_++) {
			int i_737_ = is_735_[i_736_];
			if (this.aShortArray7838 == null || (i_729_ & (this.aShortArray7838[i_737_])) != 0) {
			    anInt7888 += (this.anIntArray7834[i_737_]);
			    anInt7866 += (this.anIntArray7835[i_737_]);
			    anInt7890 += (this.anIntArray7836[i_737_]);
			    i_732_++;
			}
		    }
		}
		...
		if (i_742_ < this.anIntArrayArray7837.length) {
		    int[] is_743_ = this.anIntArrayArray7837[i_742_];
		    for (int i_744_ = 0; i_744_ < is_743_.length; i_744_++) {
			int i_745_ = is_743_[i_744_];
			if (this.aShortArray7838 == null || (i_729_ & (this.aShortArray7838[i_745_])) != 0) {
			    this.anIntArray7834[i_745_] += i_726_;
			    this.anIntArray7835[i_745_] += i_727_;
			    this.anIntArray7836[i_745_] += i_728_;
			}
		    }
		}
	    }
		...
		for (int i_786_ = 0; i_786_ < i_731_; i_786_++) {
		    ...
		    if (i_787_ < this.anIntArrayArray7837.length) {
			int[] is_788_ = (this.anIntArrayArray7837[i_787_]);
			for (int i_789_ = 0; i_789_ < is_788_.length; i_789_++) {
			    int i_790_ = is_788_[i_789_];
			    if (this.aShortArray7838 == null || ((i_729_ & (this.aShortArray7838[i_790_])) != 0)) {
				int i_791_ = (is_778_[0] * (this.anIntArray7834[i_790_]) + is_778_[1] * (this.anIntArray7835[i_790_]) + is_778_[2] * (this.anIntArray7836[i_790_]) + 8192) >> 14;
				int i_792_ = (is_778_[3] * (this.anIntArray7834[i_790_]) + is_778_[4] * (this.anIntArray7835[i_790_]) + is_778_[5] * (this.anIntArray7836[i_790_]) + 8192) >> 14;
				int i_793_ = (is_778_[6] * (this.anIntArray7834[i_790_]) + is_778_[7] * (this.anIntArray7835[i_790_]) + is_778_[8] * (this.anIntArray7836[i_790_]) + 8192) >> 14;
				i_791_ += i_783_;
				i_792_ += i_784_;
				i_793_ += i_785_;
				this.anIntArray7834[i_790_] = i_791_;
				this.anIntArray7835[i_790_] = i_792_;
				this.anIntArray7836[i_790_] = i_793_;
			    }
			}
		    }
		}
		...
		for (int i_794_ = 0; i_794_ < i_731_; i_794_++) {
		    ...
		    if (i_795_ < this.anIntArrayArray7837.length) {
			int[] is_796_ = (this.anIntArrayArray7837[i_795_]);
			for (int i_797_ = 0; i_797_ < is_796_.length; i_797_++) {
			    int i_798_ = is_796_[i_797_];
			    if (this.aShortArray7838 == null || ((i_729_ & (this.aShortArray7838[i_798_])) != 0)) {
				this.anIntArray7834[i_798_] -= anInt7888;
				this.anIntArray7835[i_798_] -= anInt7866;
				this.anIntArray7836[i_798_] -= anInt7890;
				if (i_728_ != 0) {
				    int i_799_ = Class220.anIntArray2483[i_728_];
				    int i_800_ = Class220.anIntArray2474[i_728_];
				    int i_801_ = ((this.anIntArray7835[i_798_]) * i_799_ + (this.anIntArray7834[i_798_]) * i_800_ + 16383) >> 14;
				    this.anIntArray7835[i_798_] = ((this.anIntArray7835[i_798_]) * i_800_ - (this.anIntArray7834[i_798_]) * i_799_ + 16383) >> 14;
				    this.anIntArray7834[i_798_] = i_801_;
				}
				if (i_726_ != 0) {
				    int i_802_ = Class220.anIntArray2483[i_726_];
				    int i_803_ = Class220.anIntArray2474[i_726_];
				    int i_804_ = ((this.anIntArray7835[i_798_]) * i_803_ - (this.anIntArray7836[i_798_]) * i_802_ + 16383) >> 14;
				    this.anIntArray7836[i_798_] = ((this.anIntArray7835[i_798_]) * i_802_ + (this.anIntArray7836[i_798_]) * i_803_ + 16383) >> 14;
				    this.anIntArray7835[i_798_] = i_804_;
				}
				if (i_727_ != 0) {
				    int i_805_ = Class220.anIntArray2483[i_727_];
				    int i_806_ = Class220.anIntArray2474[i_727_];
				    int i_807_ = ((this.anIntArray7836[i_798_]) * i_805_ + (this.anIntArray7834[i_798_]) * i_806_ + 16383) >> 14;
				    this.anIntArray7836[i_798_] = ((this.anIntArray7836[i_798_]) * i_806_ - (this.anIntArray7834[i_798_]) * i_805_ + 16383) >> 14;
				    this.anIntArray7834[i_798_] = i_807_;
				}
				this.anIntArray7834[i_798_] += anInt7888;
				this.anIntArray7835[i_798_] += anInt7866;
				this.anIntArray7836[i_798_] += anInt7890;
		...
		if (bool) {
			...
			if (i_809_ < (this.anIntArrayArray7837).length) {
			    int[] is_810_ = (this.anIntArrayArray7837[i_809_]);
			    for (int i_811_ = 0; i_811_ < is_810_.length; i_811_++) {
				int i_812_ = is_810_[i_811_];
				if ((this.aShortArray7838 == null) || ((i_729_ & (this.aShortArray7838[i_812_])) != 0)) {
				    int i_813_ = (this.anIntArray7854[i_812_]);
				    int i_814_ = (this.anIntArray7854[i_812_ + 1]);
				    for (int i_815_ = i_813_; i_815_ < i_814_; i_815_++) {
					int i_816_ = ((this.aShortArray7830[i_815_]) - 1);
					if (i_816_ == -1)
					    break;
					if (i_728_ != 0) {
					    int i_817_ = (Class220.anIntArray2483[i_728_]);
					    int i_818_ = (Class220.anIntArray2474[i_728_]);
					    int i_819_ = ((((this.aShortArray7841[i_816_]) * i_817_) + (this.aShortArray7829[i_816_]) * i_818_ + 16383) >> 14);
					    this.aShortArray7841[i_816_] = (short) (((this.aShortArray7841[i_816_]) * i_818_ - (this.aShortArray7829[i_816_]) * i_817_ + 16383) >> 14);
					    this.aShortArray7829[i_816_] = (short) i_819_;
					}
					if (i_726_ != 0) {
					    int i_820_ = (Class220.anIntArray2483[i_726_]);
					    int i_821_ = (Class220.anIntArray2474[i_726_]);
					    int i_822_ = ((((this.aShortArray7841[i_816_]) * i_821_) - (this.aShortArray7842[i_816_]) * i_820_ + 16383) >> 14);
					    this.aShortArray7842[i_816_] = (short) (((this.aShortArray7841[i_816_]) * i_820_ + (this.aShortArray7842[i_816_]) * i_821_ + 16383) >> 14);
					    this.aShortArray7841[i_816_] = (short) i_822_;
					}
					if (i_727_ != 0) {
					    int i_823_ = (Class220.anIntArray2483[i_727_]);
					    int i_824_ = (Class220.anIntArray2474[i_727_]);
					    int i_825_ = ((((this.aShortArray7842[i_816_]) * i_823_) + (this.aShortArray7829[i_816_]) * i_824_ + 16383) >> 14);
					    this.aShortArray7842[i_816_] = (short) (((this.aShortArray7842[i_816_]) * i_824_ - (this.aShortArray7829[i_816_]) * i_823_ + 16383) >> 14);
					    this.aShortArray7829[i_816_] = (short) i_825_;
					}
				    }
				}
			    }
		...
		for (int i_856_ = 0; i_856_ < i_731_; i_856_++) {
		    ...
		    if (i_857_ < this.anIntArrayArray7837.length) {
			int[] is_858_ = (this.anIntArrayArray7837[i_857_]);
			for (int i_859_ = 0; i_859_ < is_858_.length; i_859_++) {
			    int i_860_ = is_858_[i_859_];
			    if (this.aShortArray7838 == null || ((i_729_ & (this.aShortArray7838[i_860_])) != 0)) {
				int i_861_ = (is_848_[0] * (this.anIntArray7834[i_860_]) + is_848_[1] * (this.anIntArray7835[i_860_]) + is_848_[2] * (this.anIntArray7836[i_860_]) + 8192) >> 14;
				int i_862_ = (is_848_[3] * (this.anIntArray7834[i_860_]) + is_848_[4] * (this.anIntArray7835[i_860_]) + is_848_[5] * (this.anIntArray7836[i_860_]) + 8192) >> 14;
				int i_863_ = (is_848_[6] * (this.anIntArray7834[i_860_]) + is_848_[7] * (this.anIntArray7835[i_860_]) + is_848_[8] * (this.anIntArray7836[i_860_]) + 8192) >> 14;
				i_861_ += i_853_;
				i_862_ += i_854_;
				i_863_ += i_855_;
				this.anIntArray7834[i_860_] = i_861_;
				this.anIntArray7835[i_860_] = i_862_;
				this.anIntArray7836[i_860_] = i_863_;
			    }
			}
		    }
		}
		...
		for (int i_864_ = 0; i_864_ < i_731_; i_864_++) {
		    ...
		    if (i_865_ < this.anIntArrayArray7837.length) {
			int[] is_866_ = (this.anIntArrayArray7837[i_865_]);
			for (int i_867_ = 0; i_867_ < is_866_.length; i_867_++) {
			    int i_868_ = is_866_[i_867_];
			    if (this.aShortArray7838 == null || ((i_729_ & (this.aShortArray7838[i_868_])) != 0)) {
				this.anIntArray7834[i_868_] -= anInt7888;
				this.anIntArray7835[i_868_] -= anInt7866;
				this.anIntArray7836[i_868_] -= anInt7890;
				this.anIntArray7834[i_868_] = (this.anIntArray7834[i_868_]) * i_726_ >> 7;
				this.anIntArray7835[i_868_] = (this.anIntArray7835[i_868_]) * i_727_ >> 7;
				this.anIntArray7836[i_868_] = (this.anIntArray7836[i_868_]) * i_728_ >> 7;
				this.anIntArray7834[i_868_] += anInt7888;
				this.anIntArray7835[i_868_] += anInt7866;
				this.anIntArray7836[i_868_] += anInt7890;
			    }
		...
		for (int i_869_ = 0; i_869_ < i_731_; i_869_++) {
		    ...
		    if (i_870_ < this.anIntArrayArray7855.length) {
			int[] is_871_ = (this.anIntArrayArray7855[i_870_]);
			for (int i_872_ = 0; i_872_ < is_871_.length; i_872_++) {
			    int i_873_ = is_871_[i_872_];
			    if (this.aShortArray7856 == null || ((i_729_ & (this.aShortArray7856[i_873_])) != 0)) {
				int i_874_ = (((this.aByteArray7850[i_873_]) & 0xff) + i_726_ * 8);
				if (i_874_ < 0)
				    i_874_ = 0;
				else if (i_874_ > 255)
				    i_874_ = 255;
				this.aByteArray7850[i_873_] = (byte) i_874_;
				if (this.aClass32_7858 != null)
				    this.aClass32_7858.anInterface1_397 = null;
			    }
			}
		...
		if (this.aClass54Array7880 != null) {
		    for (int i_875_ = 0; i_875_ < this.anInt7877; i_875_++) {
			Class54 class54 = this.aClass54Array7880[i_875_];
			Class36 class36 = this.aClass36Array7875[i_875_];
			class36.anInt424 = (class36.anInt424 & 0xffffff | 255 - ((this.aByteArray7850[class54.anInt549]) & 0xff) << 24);
		    }
		}
	    }
		...
		for (int i_876_ = 0; i_876_ < i_731_; i_876_++) {
		    ...
		    if (i_877_ < this.anIntArrayArray7855.length) {
			int[] is_878_ = (this.anIntArrayArray7855[i_877_]);
			for (int i_879_ = 0; i_879_ < is_878_.length; i_879_++) {
			    int i_880_ = is_878_[i_879_];
			    if (this.aShortArray7856 == null || ((i_729_ & (this.aShortArray7856[i_880_])) != 0)) {
				int i_881_ = ((this.aShortArray7849[i_880_]) & 0xffff);
				...
				if (i_884_ < 0)
				    ...
				    i_884_ = 127;
				this.aShortArray7849[i_880_] = (short) (i_882_ << 10 | i_883_ << 7 | i_884_);
				if (this.aClass32_7858 != null)
				    this.aClass32_7858.anInterface1_397 = null;
			    }
			}
		...
		if (this.aClass54Array7880 != null) {
		    for (int i_885_ = 0; i_885_ < this.anInt7877; i_885_++) {
			Class54 class54 = this.aClass54Array7880[i_885_];
			Class36 class36 = this.aClass36Array7875[i_885_];
			class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
		    }
		}
	    }
		...
		for (int i_886_ = 0; i_886_ < i_731_; i_886_++) {
		    ...
		    if (i_887_ < this.anIntArrayArray7882.length) {
			int[] is_888_ = (this.anIntArrayArray7882[i_887_]);
			for (int i_889_ = 0; i_889_ < is_888_.length; i_889_++) {
			    Class36 class36 = (this.aClass36Array7875[is_888_[i_889_]]);
		...
		for (int i_890_ = 0; i_890_ < i_731_; i_890_++) {
		    ...
		    if (i_891_ < this.anIntArrayArray7882.length) {
			int[] is_892_ = (this.anIntArrayArray7882[i_891_]);
			for (int i_893_ = 0; i_893_ < is_892_.length; i_893_++) {
			    Class36 class36 = (this.aClass36Array7875[is_892_[i_893_]]);
		...
		for (int i_894_ = 0; i_894_ < i_731_; i_894_++) {
		    ...
		    if (i_895_ < this.anIntArrayArray7882.length) {
			int[] is_896_ = (this.anIntArrayArray7882[i_895_]);
			for (int i_897_ = 0; i_897_ < is_896_.length; i_897_++) {
			    Class36 class36 = (this.aClass36Array7875[is_896_[i_897_]]);
	...
	for (int i_900_ = 0; i_900_ < this.anInt7833; i_900_++) {
	    if (i != 0)
		this.anIntArray7834[i_900_] += i;
	    if (i_898_ != 0)
		this.anIntArray7835[i_900_] += i_898_;
	    if (i_899_ != 0)
		this.anIntArray7836[i_900_] += i_899_;
	}
	if (this.aClass32_7831 != null)
	    this.aClass32_7831.anInterface1_397 = null;
	this.aBoolean7843 = false;
	...
	for (int i_903_ = 0; i_903_ < this.anInt7833; i_903_++) {
	    int i_904_ = ((this.anIntArray7835[i_903_] * i_902_ - this.anIntArray7836[i_903_] * i_901_) >> 14);
	    this.anIntArray7836[i_903_] = ((this.anIntArray7835[i_903_] * i_901_ + this.anIntArray7836[i_903_] * i_902_) >> 14);
	    this.anIntArray7835[i_903_] = i_904_;
	}
	if (this.aClass32_7831 != null)
	    this.aClass32_7831.anInterface1_397 = null;
	this.aBoolean7843 = false;
	...
	for (int i_907_ = 0; i_907_ < this.anInt7833; i_907_++) {
	    int i_908_ = ((this.anIntArray7835[i_907_] * i_905_ + this.anIntArray7834[i_907_] * i_906_) >> 14);
	    this.anIntArray7835[i_907_] = ((this.anIntArray7835[i_907_] * i_906_ - this.anIntArray7834[i_907_] * i_905_) >> 14);
	    this.anIntArray7834[i_907_] = i_908_;
	}
	if (this.aClass32_7831 != null)
	    this.aClass32_7831.anInterface1_397 = null;
	this.aBoolean7843 = false;
	...
	for (int i_911_ = 0; i_911_ < this.anInt7833; i_911_++) {
	    if (i != 0)
		this.anIntArray7834[i_911_] += i;
	    if (i_909_ != 0)
		this.anIntArray7835[i_911_] += i_909_;
	    if (i_910_ != 0)
		this.anIntArray7836[i_911_] += i_910_;
	}
	if (this.aClass32_7831 != null)
	    this.aClass32_7831.anInterface1_397 = null;
	this.aBoolean7843 = false;
	...
	if (this.anInt7839 != 0) {
	    Class233 class233 = (this.aClass_ra_Sub2_7824.aClass233_8041);
	    Class233 class233_912_ = (this.aClass_ra_Sub2_7824.aClass233_8104);
	    Class233 class233_913_ = (this.aClass_ra_Sub2_7824.aClass233_8184);
	    class233_912_.method2145(class222);
	    class233_913_.method2142(class233_912_);
	    class233_913_.method2144((this.aClass_ra_Sub2_7824).aClass233_8069);
	    if (!this.aBoolean7843)
		method4831();
	    float[] fs = (this.aClass_ra_Sub2_7824.aFloatArray8094);
	    class233_912_.method2149(0.0F, this.aShort7868, 0.0F, fs);
	    float f = fs[0];
	    float f_914_ = fs[1];
	    float f_915_ = fs[2];
	    class233_912_.method2149(0.0F, this.aShort7874, 0.0F, fs);
	    float f_916_ = fs[0];
	    float f_917_ = fs[1];
	    float f_918_ = fs[2];
	    for (int i_919_ = 0; i_919_ < 6; i_919_++) {
		float[] fs_920_ = (this.aClass_ra_Sub2_7824.aFloatArrayArray8077[i_919_]);
		float f_921_ = (fs_920_[0] * f + fs_920_[1] * f_914_ + fs_920_[2] * f_915_ + fs_920_[3] + this.anInt7891);
		float f_922_ = (fs_920_[0] * f_916_ + fs_920_[1] * f_917_ + fs_920_[2] * f_918_ + fs_920_[3] + this.anInt7891);
		...
		int i_924_ = ((this.aShort7870 + this.aShort7871) >> 1);
		int i_925_ = ((this.aShort7872 + this.aShort7876) >> 1);
		int i_926_ = i_924_;
		short i_927_ = this.aShort7868;
		int i_928_ = i_925_;
		...
		if (f_931_ >= -f_932_) {
		    class302_sub1.anInt7641 = (int) ((this.aClass_ra_Sub2_7824.aFloat8095) + ((this.aClass_ra_Sub2_7824).aFloat8096) * f_929_ / f_932_);
		    class302_sub1.anInt7642 = (int) ((this.aClass_ra_Sub2_7824.aFloat8097) + ((this.aClass_ra_Sub2_7824).aFloat8098) * f_930_ / f_932_);
		} else
		    bool = true;
		i_926_ = i_924_;
		i_927_ = this.aShort7874;
		i_928_ = i_925_;
		...
		if (f_935_ >= -f_936_) {
		    class302_sub1.anInt7643 = (int) ((this.aClass_ra_Sub2_7824.aFloat8095) + ((this.aClass_ra_Sub2_7824).aFloat8096) * f_933_ / f_936_);
		    class302_sub1.anInt7640 = (int) ((this.aClass_ra_Sub2_7824.aFloat8097) + ((this.aClass_ra_Sub2_7824).aFloat8098) * f_934_ / f_936_);
		} else
		    bool = true;
		if (bool) {
			...
			class302_sub1.anInt7641 = (int) (((this.aClass_ra_Sub2_7824).aFloat8095) + ((this.aClass_ra_Sub2_7824).aFloat8096 * f_938_ / f_940_));
			class302_sub1.anInt7642 = (int) (((this.aClass_ra_Sub2_7824).aFloat8097) + ((this.aClass_ra_Sub2_7824).aFloat8098 * f_939_ / f_940_));
			...
			class302_sub1.anInt7643 = (int) (((this.aClass_ra_Sub2_7824).aFloat8095) + ((this.aClass_ra_Sub2_7824).aFloat8096 * f_942_ / f_944_));
			class302_sub1.anInt7640 = (int) (((this.aClass_ra_Sub2_7824).aFloat8097) + ((this.aClass_ra_Sub2_7824).aFloat8098 * f_943_ / f_944_));
		    }
		}
		if (bool_923_) {
		    if (f_931_ / f_932_ > f_935_ / f_936_) {
			float f_945_ = (f_929_ + (class233.aFloatArray2594[0] * this.anInt7891) + class233.aFloatArray2594[12]);
			float f_946_ = (f_932_ + (class233.aFloatArray2594[3] * this.anInt7891) + class233.aFloatArray2594[15]);
			class302_sub1.anInt7645 = (int) (((this.aClass_ra_Sub2_7824).aFloat8095) - class302_sub1.anInt7641 + ((this.aClass_ra_Sub2_7824).aFloat8096 * f_945_ / f_946_));
		    } else {
			float f_947_ = (f_933_ + (class233.aFloatArray2594[0] * this.anInt7891) + class233.aFloatArray2594[12]);
			float f_948_ = (f_936_ + (class233.aFloatArray2594[3] * this.anInt7891) + class233.aFloatArray2594[15]);
			class302_sub1.anInt7645 = (int) (((this.aClass_ra_Sub2_7824).aFloat8095) - class302_sub1.anInt7643 + ((this.aClass_ra_Sub2_7824).aFloat8096 * f_947_ / f_948_));
		    }
		    class302_sub1.aBoolean7644 = true;
		}
	    }
	    this.aClass_ra_Sub2_7824.method5252();
	    this.aClass_ra_Sub2_7824.method5283(class233_912_);
	    method4823();
	    this.aClass_ra_Sub2_7824.method5287();
	    class233_912_.method2144((this.aClass_ra_Sub2_7824).aClass233_8110);
	...
	if (this.aShortArray7861 == null)
	    return true;
	for (int i = 0; i < this.aShortArray7861.length; i++) {
	    if (this.aShortArray7861[i] != -1 && !(this.aClass_ra_Sub2_7824.anInterface_ma5299.method170(this.aShortArray7861[i], (short) 27068)))
		return false;
	}
	return true;
    }
	...
	for (int i_951_ = 0; i_951_ < this.anInt7833; i_951_++) {
	    if (i != 128)
		this.anIntArray7834[i_951_] = this.anIntArray7834[i_951_] * i >> 7;
	    if (i_949_ != 128)
		this.anIntArray7835[i_951_] = (this.anIntArray7835[i_951_] * i_949_ >> 7);
	    if (i_950_ != 128)
		this.anIntArray7836[i_951_] = (this.anIntArray7836[i_951_] * i_950_ >> 7);
	}
	if (this.aClass32_7831 != null)
	    this.aClass32_7831.anInterface1_397 = null;
	this.aBoolean7843 = false;
	...
	if (!this.aBoolean7843)
	    method4831();
	int i_957_ = i_954_ + this.aShort7870;
	int i_958_ = i_954_ + this.aShort7871;
	int i_959_ = i_956_ + this.aShort7872;
	int i_960_ = i_956_ + this.aShort7876;
	if (i != 1 && i != 2 && i != 3 && i != 5 || (i_957_ >= 0 && ((i_958_ + class_xa.anInt6288 * -1212653763 >> class_xa.anInt6289 * -2137349879) < class_xa.anInt6287 * -506105871) && i_959_ >= 0 && ((i_960_ + class_xa.anInt6288 * -1212653763 >> class_xa.anInt6289 * -2137349879) < class_xa.anInt6286 * -1148794921))) {
	    ...
	    if (i == 1) {
		for (int i_961_ = 0; i_961_ < this.anInt7833; i_961_++)
		    this.anIntArray7835[i_961_] = (this.anIntArray7835[i_961_] + class_xa.method6340(((this.anIntArray7834[i_961_]) + i_954_), ((this.anIntArray7836[i_961_]) + i_956_), -1638557088) - i_955_);
	    } else if (i == 2) {
		int i_962_ = this.aShort7868;
		if (i_962_ == 0)
		    return;
		for (int i_963_ = 0; i_963_ < this.anInt7833; i_963_++) {
		    int i_964_ = (this.anIntArray7835[i_963_] << 16) / i_962_;
		    if (i_964_ < i_952_)
			this.anIntArray7835[i_963_] = (this.anIntArray7835[i_963_] + (class_xa.method6340((this.anIntArray7834[i_963_]) + i_954_, (this.anIntArray7836[i_963_]) + i_956_, -1342639356) - i_955_) * (i_952_ - i_964_) / i_952_);
		}
	    } else if (i == 3) {
		...
		int i_969_ = (this.aShort7874 - this.aShort7868);
		for (int i_970_ = 0; i_970_ < this.anInt7833; i_970_++)
		    this.anIntArray7835[i_970_] = (this.anIntArray7835[i_970_] + (class_xa_953_.method6340((this.anIntArray7834[i_970_]) + i_954_, (this.anIntArray7836[i_970_]) + i_956_, -1704762228) - i_955_) + i_969_);
	    } else if (i == 5) {
		int i_971_ = (this.aShort7874 - this.aShort7868);
		for (int i_972_ = 0; i_972_ < this.anInt7833; i_972_++) {
		    int i_973_ = (this.anIntArray7834[i_972_] + i_954_);
		    int i_974_ = (this.anIntArray7836[i_972_] + i_956_);
		    ...
		    this.anIntArray7835[i_972_] = ((this.anIntArray7835[i_972_] << 8) / i_971_ * i_977_ >> 8) - (i_955_ - i_975_);
		}
	    }
	    if (this.aClass32_7831 != null)
		this.aClass32_7831.anInterface1_397 = null;
	...
	if (!this.aBoolean7843)
	    method4831();
	int i_986_ = i_983_ + this.aShort7870;
	int i_987_ = i_983_ + this.aShort7871;
	int i_988_ = i_985_ + this.aShort7872;
	int i_989_ = i_985_ + this.aShort7876;
	if (i != 1 && i != 2 && i != 3 && i != 5 || (i_986_ >= 0 && ((i_987_ + class_xa.anInt6288 * -1212653763 >> class_xa.anInt6289 * -2137349879) < class_xa.anInt6287 * -506105871) && i_988_ >= 0 && ((i_989_ + class_xa.anInt6288 * -1212653763 >> class_xa.anInt6289 * -2137349879) < class_xa.anInt6286 * -1148794921))) {
	    ...
	    if (i == 1) {
		for (int i_990_ = 0; i_990_ < this.anInt7833; i_990_++)
		    this.anIntArray7835[i_990_] = (this.anIntArray7835[i_990_] + class_xa.method6340(((this.anIntArray7834[i_990_]) + i_983_), ((this.anIntArray7836[i_990_]) + i_985_), -1476448694) - i_984_);
	    } else if (i == 2) {
		int i_991_ = this.aShort7868;
		if (i_991_ == 0)
		    return;
		for (int i_992_ = 0; i_992_ < this.anInt7833; i_992_++) {
		    int i_993_ = (this.anIntArray7835[i_992_] << 16) / i_991_;
		    if (i_993_ < i_981_)
			this.anIntArray7835[i_992_] = (this.anIntArray7835[i_992_] + (class_xa.method6340((this.anIntArray7834[i_992_]) + i_983_, (this.anIntArray7836[i_992_]) + i_985_, -1876492928) - i_984_) * (i_981_ - i_993_) / i_981_);
		}
	    } else if (i == 3) {
		...
		int i_998_ = (this.aShort7874 - this.aShort7868);
		for (int i_999_ = 0; i_999_ < this.anInt7833; i_999_++)
		    this.anIntArray7835[i_999_] = (this.anIntArray7835[i_999_] + (class_xa_982_.method6340((this.anIntArray7834[i_999_]) + i_983_, (this.anIntArray7836[i_999_]) + i_985_, -1422344049) - i_984_) + i_998_);
	    } else if (i == 5) {
		int i_1000_ = (this.aShort7874 - this.aShort7868);
		for (int i_1001_ = 0; i_1001_ < this.anInt7833; i_1001_++) {
		    int i_1002_ = (this.anIntArray7834[i_1001_] + i_983_);
		    int i_1003_ = (this.anIntArray7836[i_1001_] + i_985_);
		    ...
		    this.anIntArray7835[i_1001_] = ((this.anIntArray7835[i_1001_] << 8) / i_1000_ * i_1006_ >> 8) - (i_984_ - i_1004_);
		}
	    }
	    if (this.aClass32_7831 != null)
		this.aClass32_7831.anInterface1_397 = null;
	...
	for (int i_1009_ = 0; i_1009_ < this.anInt7833; i_1009_++) {
	    int i_1010_ = ((this.anIntArray7836[i_1009_] * i_1007_ + this.anIntArray7834[i_1009_] * i_1008_) >> 14);
	    this.anIntArray7836[i_1009_] = ((this.anIntArray7836[i_1009_] * i_1008_ - this.anIntArray7834[i_1009_] * i_1007_) >> 14);
	    this.anIntArray7834[i_1009_] = i_1010_;
	}
	if (this.aClass32_7831 != null)
	    this.aClass32_7831.anInterface1_397 = null;
	this.aBoolean7843 = false;
	...
	if (i == 0) {
		...
		if (i_1018_ < this.anIntArrayArray7837.length) {
		    int[] is_1019_ = this.anIntArrayArray7837[i_1018_];
		    for (int i_1020_ = 0; i_1020_ < is_1019_.length; i_1020_++) {
			int i_1021_ = is_1019_[i_1020_];
			anInt7888 += this.anIntArray7834[i_1021_];
			anInt7866 += this.anIntArray7835[i_1021_];
			anInt7890 += this.anIntArray7836[i_1021_];
			i_1016_++;
		    }
		}
	    }
		...
		if (i_1023_ < this.anIntArrayArray7837.length) {
		    int[] is_1024_ = this.anIntArrayArray7837[i_1023_];
		    for (int i_1025_ = 0; i_1025_ < is_1024_.length; i_1025_++) {
			int i_1026_ = is_1024_[i_1025_];
			this.anIntArray7834[i_1026_] += i_1011_;
			this.anIntArray7835[i_1026_] += i_1012_;
			this.anIntArray7836[i_1026_] += i_1013_;
		    }
		}
	    }
	} else if (i == 2) {
		...
		if (i_1028_ < this.anIntArrayArray7837.length) {
		    int[] is_1029_ = this.anIntArrayArray7837[i_1028_];
		    if ((i_1014_ & 0x1) == 0) {
			for (int i_1030_ = 0; i_1030_ < is_1029_.length; i_1030_++) {
			    int i_1031_ = is_1029_[i_1030_];
			    this.anIntArray7834[i_1031_] -= anInt7888;
			    this.anIntArray7835[i_1031_] -= anInt7866;
			    this.anIntArray7836[i_1031_] -= anInt7890;
			    if (i_1013_ != 0) {
				int i_1032_ = Class220.anIntArray2483[i_1013_];
				int i_1033_ = Class220.anIntArray2474[i_1013_];
				int i_1034_ = (((this.anIntArray7835[i_1031_]) * i_1032_ + (this.anIntArray7834[i_1031_]) * i_1033_ + 16383) >> 14);
				this.anIntArray7835[i_1031_] = ((this.anIntArray7835[i_1031_]) * i_1033_ - (this.anIntArray7834[i_1031_]) * i_1032_ + 16383) >> 14;
				this.anIntArray7834[i_1031_] = i_1034_;
			    }
			    if (i_1011_ != 0) {
				int i_1035_ = Class220.anIntArray2483[i_1011_];
				int i_1036_ = Class220.anIntArray2474[i_1011_];
				int i_1037_ = (((this.anIntArray7835[i_1031_]) * i_1036_ - (this.anIntArray7836[i_1031_]) * i_1035_ + 16383) >> 14);
				this.anIntArray7836[i_1031_] = ((this.anIntArray7835[i_1031_]) * i_1035_ + (this.anIntArray7836[i_1031_]) * i_1036_ + 16383) >> 14;
				this.anIntArray7835[i_1031_] = i_1037_;
			    }
			    if (i_1012_ != 0) {
				int i_1038_ = Class220.anIntArray2483[i_1012_];
				int i_1039_ = Class220.anIntArray2474[i_1012_];
				int i_1040_ = (((this.anIntArray7836[i_1031_]) * i_1038_ + (this.anIntArray7834[i_1031_]) * i_1039_ + 16383) >> 14);
				this.anIntArray7836[i_1031_] = ((this.anIntArray7836[i_1031_]) * i_1039_ - (this.anIntArray7834[i_1031_]) * i_1038_ + 16383) >> 14;
				this.anIntArray7834[i_1031_] = i_1040_;
			    }
			    this.anIntArray7834[i_1031_] += anInt7888;
			    this.anIntArray7835[i_1031_] += anInt7866;
			    this.anIntArray7836[i_1031_] += anInt7890;
			...
			for (int i_1041_ = 0; i_1041_ < is_1029_.length; i_1041_++) {
			    ...
			    this.anIntArray7834[i_1042_] -= anInt7888;
			    this.anIntArray7835[i_1042_] -= anInt7866;
			    this.anIntArray7836[i_1042_] -= anInt7890;
			    if (i_1011_ != 0) {
				int i_1043_ = Class220.anIntArray2483[i_1011_];
				int i_1044_ = Class220.anIntArray2474[i_1011_];
				int i_1045_ = (((this.anIntArray7835[i_1042_]) * i_1044_ - (this.anIntArray7836[i_1042_]) * i_1043_ + 16383) >> 14);
				this.anIntArray7836[i_1042_] = ((this.anIntArray7835[i_1042_]) * i_1043_ + (this.anIntArray7836[i_1042_]) * i_1044_ + 16383) >> 14;
				this.anIntArray7835[i_1042_] = i_1045_;
			    }
			    if (i_1013_ != 0) {
				int i_1046_ = Class220.anIntArray2483[i_1013_];
				int i_1047_ = Class220.anIntArray2474[i_1013_];
				int i_1048_ = (((this.anIntArray7835[i_1042_]) * i_1046_ + (this.anIntArray7834[i_1042_]) * i_1047_ + 16383) >> 14);
				this.anIntArray7835[i_1042_] = ((this.anIntArray7835[i_1042_]) * i_1047_ - (this.anIntArray7834[i_1042_]) * i_1046_ + 16383) >> 14;
				this.anIntArray7834[i_1042_] = i_1048_;
			    }
			    if (i_1012_ != 0) {
				int i_1049_ = Class220.anIntArray2483[i_1012_];
				int i_1050_ = Class220.anIntArray2474[i_1012_];
				int i_1051_ = (((this.anIntArray7836[i_1042_]) * i_1049_ + (this.anIntArray7834[i_1042_]) * i_1050_ + 16383) >> 14);
				this.anIntArray7836[i_1042_] = ((this.anIntArray7836[i_1042_]) * i_1050_ - (this.anIntArray7834[i_1042_]) * i_1049_ + 16383) >> 14;
				this.anIntArray7834[i_1042_] = i_1051_;
			    }
			    this.anIntArray7834[i_1042_] += anInt7888;
			    this.anIntArray7835[i_1042_] += anInt7866;
			    this.anIntArray7836[i_1042_] += anInt7890;
		...
		for (int i_1052_ = 0; i_1052_ < i_1015_; i_1052_++) {
		    ...
		    if (i_1053_ < this.anIntArrayArray7837.length) {
			int[] is_1054_ = (this.anIntArrayArray7837[i_1053_]);
			for (int i_1055_ = 0; i_1055_ < is_1054_.length; i_1055_++) {
			    int i_1056_ = is_1054_[i_1055_];
			    int i_1057_ = (this.anIntArray7854[i_1056_]);
			    int i_1058_ = (this.anIntArray7854[i_1056_ + 1]);
			    for (int i_1059_ = i_1057_; i_1059_ < i_1058_; i_1059_++) {
				int i_1060_ = ((this.aShortArray7830[i_1059_]) - 1);
				if (i_1060_ == -1)
				    break;
				if (i_1013_ != 0) {
				    int i_1061_ = Class220.anIntArray2483[i_1013_];
				    int i_1062_ = Class220.anIntArray2474[i_1013_];
				    int i_1063_ = (((this.aShortArray7841[i_1060_]) * i_1061_ + (this.aShortArray7829[i_1060_]) * i_1062_ + 16383) >> 14);
				    this.aShortArray7841[i_1060_] = (short) (((this.aShortArray7841[i_1060_]) * i_1062_ - (this.aShortArray7829[i_1060_]) * i_1061_ + 16383) >> 14);
				    this.aShortArray7829[i_1060_] = (short) i_1063_;
				}
				if (i_1011_ != 0) {
				    int i_1064_ = Class220.anIntArray2483[i_1011_];
				    int i_1065_ = Class220.anIntArray2474[i_1011_];
				    int i_1066_ = (((this.aShortArray7841[i_1060_]) * i_1065_ - (this.aShortArray7842[i_1060_]) * i_1064_ + 16383) >> 14);
				    this.aShortArray7842[i_1060_] = (short) (((this.aShortArray7841[i_1060_]) * i_1064_ + (this.aShortArray7842[i_1060_]) * i_1065_ + 16383) >> 14);
				    this.aShortArray7841[i_1060_] = (short) i_1066_;
				}
				if (i_1012_ != 0) {
				    int i_1067_ = Class220.anIntArray2483[i_1012_];
				    int i_1068_ = Class220.anIntArray2474[i_1012_];
				    int i_1069_ = (((this.aShortArray7842[i_1060_]) * i_1067_ + (this.aShortArray7829[i_1060_]) * i_1068_ + 16383) >> 14);
				    this.aShortArray7842[i_1060_] = (short) (((this.aShortArray7842[i_1060_]) * i_1068_ - (this.aShortArray7829[i_1060_]) * i_1067_ + 16383) >> 14);
				    this.aShortArray7829[i_1060_] = (short) i_1069_;
				}
			    }
			}
		    }
		...
		if (i_1071_ < this.anIntArrayArray7837.length) {
		    int[] is_1072_ = this.anIntArrayArray7837[i_1071_];
		    for (int i_1073_ = 0; i_1073_ < is_1072_.length; i_1073_++) {
			int i_1074_ = is_1072_[i_1073_];
			this.anIntArray7834[i_1074_] -= anInt7888;
			this.anIntArray7835[i_1074_] -= anInt7866;
			this.anIntArray7836[i_1074_] -= anInt7890;
			this.anIntArray7834[i_1074_] = (this.anIntArray7834[i_1074_] * i_1011_) >> 7;
			this.anIntArray7835[i_1074_] = (this.anIntArray7835[i_1074_] * i_1012_) >> 7;
			this.anIntArray7836[i_1074_] = (this.anIntArray7836[i_1074_] * i_1013_) >> 7;
			this.anIntArray7834[i_1074_] += anInt7888;
			this.anIntArray7835[i_1074_] += anInt7866;
			this.anIntArray7836[i_1074_] += anInt7890;
		    }
		...
		for (int i_1075_ = 0; i_1075_ < i_1015_; i_1075_++) {
		    ...
		    if (i_1076_ < this.anIntArrayArray7855.length) {
			int[] is_1077_ = (this.anIntArrayArray7855[i_1076_]);
			for (int i_1078_ = 0; i_1078_ < is_1077_.length; i_1078_++) {
			    int i_1079_ = is_1077_[i_1078_];
			    int i_1080_ = (((this.aByteArray7850[i_1079_]) & 0xff) + i_1011_ * 8);
			    if (i_1080_ < 0)
				i_1080_ = 0;
			    else if (i_1080_ > 255)
				i_1080_ = 255;
			    this.aByteArray7850[i_1079_] = (byte) i_1080_;
			}
			if (is_1077_.length > 0 && this.aClass32_7858 != null)
			    this.aClass32_7858.anInterface1_397 = null;
		    }
		}
		if (this.aClass54Array7880 != null) {
		    for (int i_1081_ = 0; i_1081_ < this.anInt7877; i_1081_++) {
			Class54 class54 = (this.aClass54Array7880[i_1081_]);
			Class36 class36 = (this.aClass36Array7875[i_1081_]);
			class36.anInt424 = (class36.anInt424 & 0xffffff | 255 - ((this.aByteArray7850[class54.anInt549]) & 0xff) << 24);
		    }
		}
	    }
		...
		for (int i_1082_ = 0; i_1082_ < i_1015_; i_1082_++) {
		    ...
		    if (i_1083_ < this.anIntArrayArray7855.length) {
			int[] is_1084_ = (this.anIntArrayArray7855[i_1083_]);
			for (int i_1085_ = 0; i_1085_ < is_1084_.length; i_1085_++) {
			    int i_1086_ = is_1084_[i_1085_];
			    int i_1087_ = ((this.aShortArray7849[i_1086_]) & 0xffff);
				...
				i_1090_ = 127;
			    this.aShortArray7849[i_1086_] = (short) (i_1088_ << 10 | i_1089_ << 7 | i_1090_);
			}
			if (is_1084_.length > 0 && this.aClass32_7858 != null)
			    this.aClass32_7858.anInterface1_397 = null;
		    }
		}
		if (this.aClass54Array7880 != null) {
		    for (int i_1091_ = 0; i_1091_ < this.anInt7877; i_1091_++) {
			Class54 class54 = (this.aClass54Array7880[i_1091_]);
			Class36 class36 = (this.aClass36Array7875[i_1091_]);
			class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
		    }
		}
	    }
		...
		for (int i_1092_ = 0; i_1092_ < i_1015_; i_1092_++) {
		    ...
		    if (i_1093_ < this.anIntArrayArray7882.length) {
			int[] is_1094_ = (this.anIntArrayArray7882[i_1093_]);
			for (int i_1095_ = 0; i_1095_ < is_1094_.length; i_1095_++) {
			    Class36 class36 = (this.aClass36Array7875[is_1094_[i_1095_]]);
		...
		for (int i_1096_ = 0; i_1096_ < i_1015_; i_1096_++) {
		    ...
		    if (i_1097_ < this.anIntArrayArray7882.length) {
			int[] is_1098_ = (this.anIntArrayArray7882[i_1097_]);
			for (int i_1099_ = 0; i_1099_ < is_1098_.length; i_1099_++) {
			    Class36 class36 = (this.aClass36Array7875[is_1098_[i_1099_]]);
		...
		for (int i_1100_ = 0; i_1100_ < i_1015_; i_1100_++) {
		    ...
		    if (i_1101_ < this.anIntArrayArray7882.length) {
			int[] is_1102_ = (this.anIntArrayArray7882[i_1101_]);
			for (int i_1103_ = 0; i_1103_ < is_1102_.length; i_1103_++) {
			    Class36 class36 = (this.aClass36Array7875[is_1102_[i_1103_]]);
	...
	if (i == 0) {
		...
		if (i_1112_ < this.anIntArrayArray7837.length) {
		    int[] is_1113_ = this.anIntArrayArray7837[i_1112_];
		    for (int i_1114_ = 0; i_1114_ < is_1113_.length; i_1114_++) {
			int i_1115_ = is_1113_[i_1114_];
			if (this.aShortArray7838 == null || (i_1107_ & (this.aShortArray7838[i_1115_])) != 0) {
			    anInt7888 += (this.anIntArray7834[i_1115_]);
			    anInt7866 += (this.anIntArray7835[i_1115_]);
			    anInt7890 += (this.anIntArray7836[i_1115_]);
			    i_1110_++;
			}
		    }
		}
		...
		if (i_1120_ < this.anIntArrayArray7837.length) {
		    int[] is_1121_ = this.anIntArrayArray7837[i_1120_];
		    for (int i_1122_ = 0; i_1122_ < is_1121_.length; i_1122_++) {
			int i_1123_ = is_1121_[i_1122_];
			if (this.aShortArray7838 == null || (i_1107_ & (this.aShortArray7838[i_1123_])) != 0) {
			    this.anIntArray7834[i_1123_] += i_1104_;
			    this.anIntArray7835[i_1123_] += i_1105_;
			    this.anIntArray7836[i_1123_] += i_1106_;
			}
		    }
		}
	    }
		...
		for (int i_1164_ = 0; i_1164_ < i_1109_; i_1164_++) {
		    ...
		    if (i_1165_ < this.anIntArrayArray7837.length) {
			int[] is_1166_ = (this.anIntArrayArray7837[i_1165_]);
			for (int i_1167_ = 0; i_1167_ < is_1166_.length; i_1167_++) {
			    int i_1168_ = is_1166_[i_1167_];
			    if (this.aShortArray7838 == null || ((i_1107_ & (this.aShortArray7838[i_1168_])) != 0)) {
				int i_1169_ = (is_1156_[0] * (this.anIntArray7834[i_1168_]) + is_1156_[1] * (this.anIntArray7835[i_1168_]) + is_1156_[2] * (this.anIntArray7836[i_1168_]) + 8192) >> 14;
				int i_1170_ = (is_1156_[3] * (this.anIntArray7834[i_1168_]) + is_1156_[4] * (this.anIntArray7835[i_1168_]) + is_1156_[5] * (this.anIntArray7836[i_1168_]) + 8192) >> 14;
				int i_1171_ = (is_1156_[6] * (this.anIntArray7834[i_1168_]) + is_1156_[7] * (this.anIntArray7835[i_1168_]) + is_1156_[8] * (this.anIntArray7836[i_1168_]) + 8192) >> 14;
				i_1169_ += i_1161_;
				i_1170_ += i_1162_;
				i_1171_ += i_1163_;
				this.anIntArray7834[i_1168_] = i_1169_;
				this.anIntArray7835[i_1168_] = i_1170_;
				this.anIntArray7836[i_1168_] = i_1171_;
			    }
			}
		    }
		}
		...
		for (int i_1172_ = 0; i_1172_ < i_1109_; i_1172_++) {
		    ...
		    if (i_1173_ < this.anIntArrayArray7837.length) {
			int[] is_1174_ = (this.anIntArrayArray7837[i_1173_]);
			for (int i_1175_ = 0; i_1175_ < is_1174_.length; i_1175_++) {
			    int i_1176_ = is_1174_[i_1175_];
			    if (this.aShortArray7838 == null || ((i_1107_ & (this.aShortArray7838[i_1176_])) != 0)) {
				this.anIntArray7834[i_1176_] -= anInt7888;
				this.anIntArray7835[i_1176_] -= anInt7866;
				this.anIntArray7836[i_1176_] -= anInt7890;
				if (i_1106_ != 0) {
				    int i_1177_ = Class220.anIntArray2483[i_1106_];
				    int i_1178_ = Class220.anIntArray2474[i_1106_];
				    int i_1179_ = ((this.anIntArray7835[i_1176_]) * i_1177_ + ((this.anIntArray7834[i_1176_]) * i_1178_) + 16383) >> 14;
				    this.anIntArray7835[i_1176_] = ((this.anIntArray7835[i_1176_]) * i_1178_ - ((this.anIntArray7834[i_1176_]) * i_1177_) + 16383) >> 14;
				    this.anIntArray7834[i_1176_] = i_1179_;
				}
				if (i_1104_ != 0) {
				    int i_1180_ = Class220.anIntArray2483[i_1104_];
				    int i_1181_ = Class220.anIntArray2474[i_1104_];
				    int i_1182_ = ((this.anIntArray7835[i_1176_]) * i_1181_ - ((this.anIntArray7836[i_1176_]) * i_1180_) + 16383) >> 14;
				    this.anIntArray7836[i_1176_] = ((this.anIntArray7835[i_1176_]) * i_1180_ + ((this.anIntArray7836[i_1176_]) * i_1181_) + 16383) >> 14;
				    this.anIntArray7835[i_1176_] = i_1182_;
				}
				if (i_1105_ != 0) {
				    int i_1183_ = Class220.anIntArray2483[i_1105_];
				    int i_1184_ = Class220.anIntArray2474[i_1105_];
				    int i_1185_ = ((this.anIntArray7836[i_1176_]) * i_1183_ + ((this.anIntArray7834[i_1176_]) * i_1184_) + 16383) >> 14;
				    this.anIntArray7836[i_1176_] = ((this.anIntArray7836[i_1176_]) * i_1184_ - ((this.anIntArray7834[i_1176_]) * i_1183_) + 16383) >> 14;
				    this.anIntArray7834[i_1176_] = i_1185_;
				}
				this.anIntArray7834[i_1176_] += anInt7888;
				this.anIntArray7835[i_1176_] += anInt7866;
				this.anIntArray7836[i_1176_] += anInt7890;
		...
		if (bool) {
			...
			if (i_1187_ < (this.anIntArrayArray7837).length) {
			    int[] is_1188_ = (this.anIntArrayArray7837[i_1187_]);
			    for (int i_1189_ = 0; i_1189_ < is_1188_.length; i_1189_++) {
				int i_1190_ = is_1188_[i_1189_];
				if ((this.aShortArray7838 == null) || ((i_1107_ & (this.aShortArray7838[i_1190_])) != 0)) {
				    int i_1191_ = (this.anIntArray7854[i_1190_]);
				    int i_1192_ = (this.anIntArray7854[i_1190_ + 1]);
				    for (int i_1193_ = i_1191_; i_1193_ < i_1192_; i_1193_++) {
					int i_1194_ = ((this.aShortArray7830[i_1193_]) - 1);
					if (i_1194_ == -1)
					    break;
					if (i_1106_ != 0) {
					    int i_1195_ = (Class220.anIntArray2483[i_1106_]);
					    int i_1196_ = (Class220.anIntArray2474[i_1106_]);
					    int i_1197_ = (((this.aShortArray7841[i_1194_]) * i_1195_ + (this.aShortArray7829[i_1194_]) * i_1196_ + 16383) >> 14);
					    this.aShortArray7841[i_1194_] = (short) ((((this.aShortArray7841[i_1194_]) * i_1196_) - ((this.aShortArray7829[i_1194_]) * i_1195_) + 16383) >> 14);
					    this.aShortArray7829[i_1194_] = (short) i_1197_;
					}
					if (i_1104_ != 0) {
					    int i_1198_ = (Class220.anIntArray2483[i_1104_]);
					    int i_1199_ = (Class220.anIntArray2474[i_1104_]);
					    int i_1200_ = (((this.aShortArray7841[i_1194_]) * i_1199_ - (this.aShortArray7842[i_1194_]) * i_1198_ + 16383) >> 14);
					    this.aShortArray7842[i_1194_] = (short) ((((this.aShortArray7841[i_1194_]) * i_1198_) + ((this.aShortArray7842[i_1194_]) * i_1199_) + 16383) >> 14);
					    this.aShortArray7841[i_1194_] = (short) i_1200_;
					}
					if (i_1105_ != 0) {
					    int i_1201_ = (Class220.anIntArray2483[i_1105_]);
					    int i_1202_ = (Class220.anIntArray2474[i_1105_]);
					    int i_1203_ = (((this.aShortArray7842[i_1194_]) * i_1201_ + (this.aShortArray7829[i_1194_]) * i_1202_ + 16383) >> 14);
					    this.aShortArray7842[i_1194_] = (short) ((((this.aShortArray7842[i_1194_]) * i_1202_) - ((this.aShortArray7829[i_1194_]) * i_1201_) + 16383) >> 14);
					    this.aShortArray7829[i_1194_] = (short) i_1203_;
					}
				    }
				}
			    }
		...
		for (int i_1234_ = 0; i_1234_ < i_1109_; i_1234_++) {
		    ...
		    if (i_1235_ < this.anIntArrayArray7837.length) {
			int[] is_1236_ = (this.anIntArrayArray7837[i_1235_]);
			for (int i_1237_ = 0; i_1237_ < is_1236_.length; i_1237_++) {
			    int i_1238_ = is_1236_[i_1237_];
			    if (this.aShortArray7838 == null || ((i_1107_ & (this.aShortArray7838[i_1238_])) != 0)) {
				int i_1239_ = (is_1226_[0] * (this.anIntArray7834[i_1238_]) + is_1226_[1] * (this.anIntArray7835[i_1238_]) + is_1226_[2] * (this.anIntArray7836[i_1238_]) + 8192) >> 14;
				int i_1240_ = (is_1226_[3] * (this.anIntArray7834[i_1238_]) + is_1226_[4] * (this.anIntArray7835[i_1238_]) + is_1226_[5] * (this.anIntArray7836[i_1238_]) + 8192) >> 14;
				int i_1241_ = (is_1226_[6] * (this.anIntArray7834[i_1238_]) + is_1226_[7] * (this.anIntArray7835[i_1238_]) + is_1226_[8] * (this.anIntArray7836[i_1238_]) + 8192) >> 14;
				i_1239_ += i_1231_;
				i_1240_ += i_1232_;
				i_1241_ += i_1233_;
				this.anIntArray7834[i_1238_] = i_1239_;
				this.anIntArray7835[i_1238_] = i_1240_;
				this.anIntArray7836[i_1238_] = i_1241_;
			    }
			}
		    }
		}
		...
		for (int i_1242_ = 0; i_1242_ < i_1109_; i_1242_++) {
		    ...
		    if (i_1243_ < this.anIntArrayArray7837.length) {
			int[] is_1244_ = (this.anIntArrayArray7837[i_1243_]);
			for (int i_1245_ = 0; i_1245_ < is_1244_.length; i_1245_++) {
			    int i_1246_ = is_1244_[i_1245_];
			    if (this.aShortArray7838 == null || ((i_1107_ & (this.aShortArray7838[i_1246_])) != 0)) {
				this.anIntArray7834[i_1246_] -= anInt7888;
				this.anIntArray7835[i_1246_] -= anInt7866;
				this.anIntArray7836[i_1246_] -= anInt7890;
				this.anIntArray7834[i_1246_] = (this.anIntArray7834[i_1246_]) * i_1104_ >> 7;
				this.anIntArray7835[i_1246_] = (this.anIntArray7835[i_1246_]) * i_1105_ >> 7;
				this.anIntArray7836[i_1246_] = (this.anIntArray7836[i_1246_]) * i_1106_ >> 7;
				this.anIntArray7834[i_1246_] += anInt7888;
				this.anIntArray7835[i_1246_] += anInt7866;
				this.anIntArray7836[i_1246_] += anInt7890;
			    }
		...
		for (int i_1247_ = 0; i_1247_ < i_1109_; i_1247_++) {
		    ...
		    if (i_1248_ < this.anIntArrayArray7855.length) {
			int[] is_1249_ = (this.anIntArrayArray7855[i_1248_]);
			for (int i_1250_ = 0; i_1250_ < is_1249_.length; i_1250_++) {
			    int i_1251_ = is_1249_[i_1250_];
			    if (this.aShortArray7856 == null || ((i_1107_ & (this.aShortArray7856[i_1251_])) != 0)) {
				int i_1252_ = (((this.aByteArray7850[i_1251_]) & 0xff) + i_1104_ * 8);
				if (i_1252_ < 0)
				    i_1252_ = 0;
				else if (i_1252_ > 255)
				    i_1252_ = 255;
				this.aByteArray7850[i_1251_] = (byte) i_1252_;
				if (this.aClass32_7858 != null)
				    this.aClass32_7858.anInterface1_397 = null;
			    }
			}
		...
		if (this.aClass54Array7880 != null) {
		    for (int i_1253_ = 0; i_1253_ < this.anInt7877; i_1253_++) {
			Class54 class54 = (this.aClass54Array7880[i_1253_]);
			Class36 class36 = (this.aClass36Array7875[i_1253_]);
			class36.anInt424 = (class36.anInt424 & 0xffffff | 255 - ((this.aByteArray7850[class54.anInt549]) & 0xff) << 24);
		    }
		}
	    }
		...
		for (int i_1254_ = 0; i_1254_ < i_1109_; i_1254_++) {
		    ...
		    if (i_1255_ < this.anIntArrayArray7855.length) {
			int[] is_1256_ = (this.anIntArrayArray7855[i_1255_]);
			for (int i_1257_ = 0; i_1257_ < is_1256_.length; i_1257_++) {
			    int i_1258_ = is_1256_[i_1257_];
			    if (this.aShortArray7856 == null || ((i_1107_ & (this.aShortArray7856[i_1258_])) != 0)) {
				int i_1259_ = ((this.aShortArray7849[i_1258_]) & 0xffff);
				...
				if (i_1262_ < 0)
				    ...
				    i_1262_ = 127;
				this.aShortArray7849[i_1258_] = (short) (i_1260_ << 10 | i_1261_ << 7 | i_1262_);
				if (this.aClass32_7858 != null)
				    this.aClass32_7858.anInterface1_397 = null;
			    }
			}
		...
		if (this.aClass54Array7880 != null) {
		    for (int i_1263_ = 0; i_1263_ < this.anInt7877; i_1263_++) {
			Class54 class54 = (this.aClass54Array7880[i_1263_]);
			Class36 class36 = (this.aClass36Array7875[i_1263_]);
			class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
		    }
		}
	    }
		...
		for (int i_1264_ = 0; i_1264_ < i_1109_; i_1264_++) {
		    ...
		    if (i_1265_ < this.anIntArrayArray7882.length) {
			int[] is_1266_ = (this.anIntArrayArray7882[i_1265_]);
			for (int i_1267_ = 0; i_1267_ < is_1266_.length; i_1267_++) {
			    Class36 class36 = (this.aClass36Array7875[is_1266_[i_1267_]]);
		...
		for (int i_1268_ = 0; i_1268_ < i_1109_; i_1268_++) {
		    ...
		    if (i_1269_ < this.anIntArrayArray7882.length) {
			int[] is_1270_ = (this.anIntArrayArray7882[i_1269_]);
			for (int i_1271_ = 0; i_1271_ < is_1270_.length; i_1271_++) {
			    Class36 class36 = (this.aClass36Array7875[is_1270_[i_1271_]]);
		...
		for (int i_1272_ = 0; i_1272_ < i_1109_; i_1272_++) {
		    ...
		    if (i_1273_ < this.anIntArrayArray7882.length) {
			int[] is_1274_ = (this.anIntArrayArray7882[i_1273_]);
			for (int i_1275_ = 0; i_1275_ < is_1274_.length; i_1275_++) {
			    Class36 class36 = (this.aClass36Array7875[is_1274_[i_1275_]]);
	...
	if (i == 0) {
		...
		if (i_1284_ < this.anIntArrayArray7837.length) {
		    int[] is_1285_ = this.anIntArrayArray7837[i_1284_];
		    for (int i_1286_ = 0; i_1286_ < is_1285_.length; i_1286_++) {
			int i_1287_ = is_1285_[i_1286_];
			if (this.aShortArray7838 == null || (i_1279_ & (this.aShortArray7838[i_1287_])) != 0) {
			    anInt7888 += (this.anIntArray7834[i_1287_]);
			    anInt7866 += (this.anIntArray7835[i_1287_]);
			    anInt7890 += (this.anIntArray7836[i_1287_]);
			    i_1282_++;
			}
		    }
		}
		...
		if (i_1292_ < this.anIntArrayArray7837.length) {
		    int[] is_1293_ = this.anIntArrayArray7837[i_1292_];
		    for (int i_1294_ = 0; i_1294_ < is_1293_.length; i_1294_++) {
			int i_1295_ = is_1293_[i_1294_];
			if (this.aShortArray7838 == null || (i_1279_ & (this.aShortArray7838[i_1295_])) != 0) {
			    this.anIntArray7834[i_1295_] += i_1276_;
			    this.anIntArray7835[i_1295_] += i_1277_;
			    this.anIntArray7836[i_1295_] += i_1278_;
			}
		    }
		}
	    }
		...
		for (int i_1336_ = 0; i_1336_ < i_1281_; i_1336_++) {
		    ...
		    if (i_1337_ < this.anIntArrayArray7837.length) {
			int[] is_1338_ = (this.anIntArrayArray7837[i_1337_]);
			for (int i_1339_ = 0; i_1339_ < is_1338_.length; i_1339_++) {
			    int i_1340_ = is_1338_[i_1339_];
			    if (this.aShortArray7838 == null || ((i_1279_ & (this.aShortArray7838[i_1340_])) != 0)) {
				int i_1341_ = (is_1328_[0] * (this.anIntArray7834[i_1340_]) + is_1328_[1] * (this.anIntArray7835[i_1340_]) + is_1328_[2] * (this.anIntArray7836[i_1340_]) + 8192) >> 14;
				int i_1342_ = (is_1328_[3] * (this.anIntArray7834[i_1340_]) + is_1328_[4] * (this.anIntArray7835[i_1340_]) + is_1328_[5] * (this.anIntArray7836[i_1340_]) + 8192) >> 14;
				int i_1343_ = (is_1328_[6] * (this.anIntArray7834[i_1340_]) + is_1328_[7] * (this.anIntArray7835[i_1340_]) + is_1328_[8] * (this.anIntArray7836[i_1340_]) + 8192) >> 14;
				i_1341_ += i_1333_;
				i_1342_ += i_1334_;
				i_1343_ += i_1335_;
				this.anIntArray7834[i_1340_] = i_1341_;
				this.anIntArray7835[i_1340_] = i_1342_;
				this.anIntArray7836[i_1340_] = i_1343_;
			    }
			}
		    }
		}
		...
		for (int i_1344_ = 0; i_1344_ < i_1281_; i_1344_++) {
		    ...
		    if (i_1345_ < this.anIntArrayArray7837.length) {
			int[] is_1346_ = (this.anIntArrayArray7837[i_1345_]);
			for (int i_1347_ = 0; i_1347_ < is_1346_.length; i_1347_++) {
			    int i_1348_ = is_1346_[i_1347_];
			    if (this.aShortArray7838 == null || ((i_1279_ & (this.aShortArray7838[i_1348_])) != 0)) {
				this.anIntArray7834[i_1348_] -= anInt7888;
				this.anIntArray7835[i_1348_] -= anInt7866;
				this.anIntArray7836[i_1348_] -= anInt7890;
				if (i_1278_ != 0) {
				    int i_1349_ = Class220.anIntArray2483[i_1278_];
				    int i_1350_ = Class220.anIntArray2474[i_1278_];
				    int i_1351_ = ((this.anIntArray7835[i_1348_]) * i_1349_ + ((this.anIntArray7834[i_1348_]) * i_1350_) + 16383) >> 14;
				    this.anIntArray7835[i_1348_] = ((this.anIntArray7835[i_1348_]) * i_1350_ - ((this.anIntArray7834[i_1348_]) * i_1349_) + 16383) >> 14;
				    this.anIntArray7834[i_1348_] = i_1351_;
				}
				if (i_1276_ != 0) {
				    int i_1352_ = Class220.anIntArray2483[i_1276_];
				    int i_1353_ = Class220.anIntArray2474[i_1276_];
				    int i_1354_ = ((this.anIntArray7835[i_1348_]) * i_1353_ - ((this.anIntArray7836[i_1348_]) * i_1352_) + 16383) >> 14;
				    this.anIntArray7836[i_1348_] = ((this.anIntArray7835[i_1348_]) * i_1352_ + ((this.anIntArray7836[i_1348_]) * i_1353_) + 16383) >> 14;
				    this.anIntArray7835[i_1348_] = i_1354_;
				}
				if (i_1277_ != 0) {
				    int i_1355_ = Class220.anIntArray2483[i_1277_];
				    int i_1356_ = Class220.anIntArray2474[i_1277_];
				    int i_1357_ = ((this.anIntArray7836[i_1348_]) * i_1355_ + ((this.anIntArray7834[i_1348_]) * i_1356_) + 16383) >> 14;
				    this.anIntArray7836[i_1348_] = ((this.anIntArray7836[i_1348_]) * i_1356_ - ((this.anIntArray7834[i_1348_]) * i_1355_) + 16383) >> 14;
				    this.anIntArray7834[i_1348_] = i_1357_;
				}
				this.anIntArray7834[i_1348_] += anInt7888;
				this.anIntArray7835[i_1348_] += anInt7866;
				this.anIntArray7836[i_1348_] += anInt7890;
		...
		if (bool) {
			...
			if (i_1359_ < (this.anIntArrayArray7837).length) {
			    int[] is_1360_ = (this.anIntArrayArray7837[i_1359_]);
			    for (int i_1361_ = 0; i_1361_ < is_1360_.length; i_1361_++) {
				int i_1362_ = is_1360_[i_1361_];
				if ((this.aShortArray7838 == null) || ((i_1279_ & (this.aShortArray7838[i_1362_])) != 0)) {
				    int i_1363_ = (this.anIntArray7854[i_1362_]);
				    int i_1364_ = (this.anIntArray7854[i_1362_ + 1]);
				    for (int i_1365_ = i_1363_; i_1365_ < i_1364_; i_1365_++) {
					int i_1366_ = ((this.aShortArray7830[i_1365_]) - 1);
					if (i_1366_ == -1)
					    break;
					if (i_1278_ != 0) {
					    int i_1367_ = (Class220.anIntArray2483[i_1278_]);
					    int i_1368_ = (Class220.anIntArray2474[i_1278_]);
					    int i_1369_ = (((this.aShortArray7841[i_1366_]) * i_1367_ + (this.aShortArray7829[i_1366_]) * i_1368_ + 16383) >> 14);
					    this.aShortArray7841[i_1366_] = (short) ((((this.aShortArray7841[i_1366_]) * i_1368_) - ((this.aShortArray7829[i_1366_]) * i_1367_) + 16383) >> 14);
					    this.aShortArray7829[i_1366_] = (short) i_1369_;
					}
					if (i_1276_ != 0) {
					    int i_1370_ = (Class220.anIntArray2483[i_1276_]);
					    int i_1371_ = (Class220.anIntArray2474[i_1276_]);
					    int i_1372_ = (((this.aShortArray7841[i_1366_]) * i_1371_ - (this.aShortArray7842[i_1366_]) * i_1370_ + 16383) >> 14);
					    this.aShortArray7842[i_1366_] = (short) ((((this.aShortArray7841[i_1366_]) * i_1370_) + ((this.aShortArray7842[i_1366_]) * i_1371_) + 16383) >> 14);
					    this.aShortArray7841[i_1366_] = (short) i_1372_;
					}
					if (i_1277_ != 0) {
					    int i_1373_ = (Class220.anIntArray2483[i_1277_]);
					    int i_1374_ = (Class220.anIntArray2474[i_1277_]);
					    int i_1375_ = (((this.aShortArray7842[i_1366_]) * i_1373_ + (this.aShortArray7829[i_1366_]) * i_1374_ + 16383) >> 14);
					    this.aShortArray7842[i_1366_] = (short) ((((this.aShortArray7842[i_1366_]) * i_1374_) - ((this.aShortArray7829[i_1366_]) * i_1373_) + 16383) >> 14);
					    this.aShortArray7829[i_1366_] = (short) i_1375_;
					}
				    }
				}
			    }
		...
		for (int i_1406_ = 0; i_1406_ < i_1281_; i_1406_++) {
		    ...
		    if (i_1407_ < this.anIntArrayArray7837.length) {
			int[] is_1408_ = (this.anIntArrayArray7837[i_1407_]);
			for (int i_1409_ = 0; i_1409_ < is_1408_.length; i_1409_++) {
			    int i_1410_ = is_1408_[i_1409_];
			    if (this.aShortArray7838 == null || ((i_1279_ & (this.aShortArray7838[i_1410_])) != 0)) {
				int i_1411_ = (is_1398_[0] * (this.anIntArray7834[i_1410_]) + is_1398_[1] * (this.anIntArray7835[i_1410_]) + is_1398_[2] * (this.anIntArray7836[i_1410_]) + 8192) >> 14;
				int i_1412_ = (is_1398_[3] * (this.anIntArray7834[i_1410_]) + is_1398_[4] * (this.anIntArray7835[i_1410_]) + is_1398_[5] * (this.anIntArray7836[i_1410_]) + 8192) >> 14;
				int i_1413_ = (is_1398_[6] * (this.anIntArray7834[i_1410_]) + is_1398_[7] * (this.anIntArray7835[i_1410_]) + is_1398_[8] * (this.anIntArray7836[i_1410_]) + 8192) >> 14;
				i_1411_ += i_1403_;
				i_1412_ += i_1404_;
				i_1413_ += i_1405_;
				this.anIntArray7834[i_1410_] = i_1411_;
				this.anIntArray7835[i_1410_] = i_1412_;
				this.anIntArray7836[i_1410_] = i_1413_;
			    }
			}
		    }
		}
		...
		for (int i_1414_ = 0; i_1414_ < i_1281_; i_1414_++) {
		    ...
		    if (i_1415_ < this.anIntArrayArray7837.length) {
			int[] is_1416_ = (this.anIntArrayArray7837[i_1415_]);
			for (int i_1417_ = 0; i_1417_ < is_1416_.length; i_1417_++) {
			    int i_1418_ = is_1416_[i_1417_];
			    if (this.aShortArray7838 == null || ((i_1279_ & (this.aShortArray7838[i_1418_])) != 0)) {
				this.anIntArray7834[i_1418_] -= anInt7888;
				this.anIntArray7835[i_1418_] -= anInt7866;
				this.anIntArray7836[i_1418_] -= anInt7890;
				this.anIntArray7834[i_1418_] = (this.anIntArray7834[i_1418_]) * i_1276_ >> 7;
				this.anIntArray7835[i_1418_] = (this.anIntArray7835[i_1418_]) * i_1277_ >> 7;
				this.anIntArray7836[i_1418_] = (this.anIntArray7836[i_1418_]) * i_1278_ >> 7;
				this.anIntArray7834[i_1418_] += anInt7888;
				this.anIntArray7835[i_1418_] += anInt7866;
				this.anIntArray7836[i_1418_] += anInt7890;
			    }
		...
		for (int i_1419_ = 0; i_1419_ < i_1281_; i_1419_++) {
		    ...
		    if (i_1420_ < this.anIntArrayArray7855.length) {
			int[] is_1421_ = (this.anIntArrayArray7855[i_1420_]);
			for (int i_1422_ = 0; i_1422_ < is_1421_.length; i_1422_++) {
			    int i_1423_ = is_1421_[i_1422_];
			    if (this.aShortArray7856 == null || ((i_1279_ & (this.aShortArray7856[i_1423_])) != 0)) {
				int i_1424_ = (((this.aByteArray7850[i_1423_]) & 0xff) + i_1276_ * 8);
				if (i_1424_ < 0)
				    i_1424_ = 0;
				else if (i_1424_ > 255)
				    i_1424_ = 255;
				this.aByteArray7850[i_1423_] = (byte) i_1424_;
				if (this.aClass32_7858 != null)
				    this.aClass32_7858.anInterface1_397 = null;
			    }
			}
		...
		if (this.aClass54Array7880 != null) {
		    for (int i_1425_ = 0; i_1425_ < this.anInt7877; i_1425_++) {
			Class54 class54 = (this.aClass54Array7880[i_1425_]);
			Class36 class36 = (this.aClass36Array7875[i_1425_]);
			class36.anInt424 = (class36.anInt424 & 0xffffff | 255 - ((this.aByteArray7850[class54.anInt549]) & 0xff) << 24);
		    }
		}
	    }
		...
		for (int i_1426_ = 0; i_1426_ < i_1281_; i_1426_++) {
		    ...
		    if (i_1427_ < this.anIntArrayArray7855.length) {
			int[] is_1428_ = (this.anIntArrayArray7855[i_1427_]);
			for (int i_1429_ = 0; i_1429_ < is_1428_.length; i_1429_++) {
			    int i_1430_ = is_1428_[i_1429_];
			    if (this.aShortArray7856 == null || ((i_1279_ & (this.aShortArray7856[i_1430_])) != 0)) {
				int i_1431_ = ((this.aShortArray7849[i_1430_]) & 0xffff);
				...
				if (i_1434_ < 0)
				    ...
				    i_1434_ = 127;
				this.aShortArray7849[i_1430_] = (short) (i_1432_ << 10 | i_1433_ << 7 | i_1434_);
				if (this.aClass32_7858 != null)
				    this.aClass32_7858.anInterface1_397 = null;
			    }
			}
		...
		if (this.aClass54Array7880 != null) {
		    for (int i_1435_ = 0; i_1435_ < this.anInt7877; i_1435_++) {
			Class54 class54 = (this.aClass54Array7880[i_1435_]);
			Class36 class36 = (this.aClass36Array7875[i_1435_]);
			class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
		    }
		}
	    }
		...
		for (int i_1436_ = 0; i_1436_ < i_1281_; i_1436_++) {
		    ...
		    if (i_1437_ < this.anIntArrayArray7882.length) {
			int[] is_1438_ = (this.anIntArrayArray7882[i_1437_]);
			for (int i_1439_ = 0; i_1439_ < is_1438_.length; i_1439_++) {
			    Class36 class36 = (this.aClass36Array7875[is_1438_[i_1439_]]);
		...
		for (int i_1440_ = 0; i_1440_ < i_1281_; i_1440_++) {
		    ...
		    if (i_1441_ < this.anIntArrayArray7882.length) {
			int[] is_1442_ = (this.anIntArrayArray7882[i_1441_]);
			for (int i_1443_ = 0; i_1443_ < is_1442_.length; i_1443_++) {
			    Class36 class36 = (this.aClass36Array7875[is_1442_[i_1443_]]);
		...
		for (int i_1444_ = 0; i_1444_ < i_1281_; i_1444_++) {
		    ...
		    if (i_1445_ < this.anIntArrayArray7882.length) {
			int[] is_1446_ = (this.anIntArrayArray7882[i_1445_]);
			for (int i_1447_ = 0; i_1447_ < is_1446_.length; i_1447_++) {
			    Class36 class36 = (this.aClass36Array7875[is_1446_[i_1447_]]);
	...
	if (this.aClass85Array7825 != null) {
		...
		class85_1448_.anInt777 = ((int) (class233.aFloatArray2594[12] + ((class233.aFloatArray2594[0] * (this.anIntArray7834[class85.anInt773 * -710317103])) + (class233.aFloatArray2594[4] * (this.anIntArray7835[(class85.anInt773 * -710317103)])) + (class233.aFloatArray2594[8] * (this.anIntArray7836[(class85.anInt773 * -710317103)])))) * -1879868075);
		class85_1448_.anInt783 = ((int) (class233.aFloatArray2594[13] + ((class233.aFloatArray2594[1] * (this.anIntArray7834[class85.anInt773 * -710317103])) + (class233.aFloatArray2594[5] * (this.anIntArray7835[(class85.anInt773 * -710317103)])) + (class233.aFloatArray2594[9] * (this.anIntArray7836[(class85.anInt773 * -710317103)])))) * -2041556771);
		class85_1448_.anInt779 = ((int) (class233.aFloatArray2594[14] + ((class233.aFloatArray2594[2] * (this.anIntArray7834[class85.anInt773 * -710317103])) + (class233.aFloatArray2594[6] * (this.anIntArray7835[(class85.anInt773 * -710317103)])) + (class233.aFloatArray2594[10] * (this.anIntArray7836[(class85.anInt773 * -710317103)])))) * -1434499227);
		class85_1448_.anInt772 = ((int) (class233.aFloatArray2594[12] + ((class233.aFloatArray2594[0] * (this.anIntArray7834[class85.anInt774 * 1705862021])) + (class233.aFloatArray2594[4] * (this.anIntArray7835[(class85.anInt774 * 1705862021)])) + (class233.aFloatArray2594[8] * (this.anIntArray7836[(class85.anInt774 * 1705862021)])))) * 1070341177);
		class85_1448_.anInt781 = ((int) (class233.aFloatArray2594[13] + ((class233.aFloatArray2594[1] * (this.anIntArray7834[class85.anInt774 * 1705862021])) + (class233.aFloatArray2594[5] * (this.anIntArray7835[(class85.anInt774 * 1705862021)])) + (class233.aFloatArray2594[9] * (this.anIntArray7836[(class85.anInt774 * 1705862021)])))) * 1802851857);
		class85_1448_.anInt782 = (int) (class233.aFloatArray2594[14] + ((class233.aFloatArray2594[2] * (this.anIntArray7834[class85.anInt774 * 1705862021])) + (class233.aFloatArray2594[6] * (this.anIntArray7835[class85.anInt774 * 1705862021])) + (class233.aFloatArray2594[10] * (this.anIntArray7836[(class85.anInt774 * 1705862021)])))) * 103846281;
		class85_1448_.anInt771 = ((int) (class233.aFloatArray2594[12] + ((class233.aFloatArray2594[0] * (this.anIntArray7834[class85.anInt775 * 1636170731])) + (class233.aFloatArray2594[4] * (this.anIntArray7835[(class85.anInt775 * 1636170731)])) + (class233.aFloatArray2594[8] * (this.anIntArray7836[(class85.anInt775 * 1636170731)])))) * -2103324039);
		class85_1448_.anInt784 = ((int) (class233.aFloatArray2594[13] + ((class233.aFloatArray2594[1] * (this.anIntArray7834[class85.anInt775 * 1636170731])) + (class233.aFloatArray2594[5] * (this.anIntArray7835[(class85.anInt775 * 1636170731)])) + (class233.aFloatArray2594[9] * (this.anIntArray7836[(class85.anInt775 * 1636170731)])))) * -526039059);
		class85_1448_.anInt785 = (int) (class233.aFloatArray2594[14] + ((class233.aFloatArray2594[2] * (this.anIntArray7834[class85.anInt775 * 1636170731])) + (class233.aFloatArray2594[6] * (this.anIntArray7835[class85.anInt775 * 1636170731])) + (class233.aFloatArray2594[10] * (this.anIntArray7836[(class85.anInt775 * 1636170731)])))) * 491030489;
	    }
	}
	if (this.aClass68Array7857 != null) {
	    for (int i = 0; i < this.aClass68Array7857.length; i++) {
		...
		if (class68.aClass233_677 != null)
		    ...
		    class68.aClass233_677 = new Class233(class233);
		class68_1449_.anInt671 = ((int) (class233.aFloatArray2594[12] + ((class233.aFloatArray2594[0] * (this.anIntArray7834[class68.anInt674 * -180596249])) + (class233.aFloatArray2594[4] * (this.anIntArray7835[(class68.anInt674 * -180596249)])) + (class233.aFloatArray2594[8] * (this.anIntArray7836[(class68.anInt674 * -180596249)])))) * -1436341053);
		class68_1449_.anInt675 = (int) (class233.aFloatArray2594[13] + ((class233.aFloatArray2594[1] * (this.anIntArray7834[class68.anInt674 * -180596249])) + (class233.aFloatArray2594[5] * (this.anIntArray7835[class68.anInt674 * -180596249])) + (class233.aFloatArray2594[9] * (this.anIntArray7836[(class68.anInt674 * -180596249)])))) * 449866009;
		class68_1449_.anInt676 = ((int) (class233.aFloatArray2594[14] + ((class233.aFloatArray2594[2] * (this.anIntArray7834[class68.anInt674 * -180596249])) + (class233.aFloatArray2594[6] * (this.anIntArray7835[(class68.anInt674 * -180596249)])) + (class233.aFloatArray2594[10] * (this.anIntArray7836[(class68.anInt674 * -180596249)])))) * 1336328763);
	    }
	}
    }
	...
	if (i > 0 && i <= 7) {
	    class387_sub2_1453_ = (this.aClass_ra_Sub2_7824.aClass387_Sub2Array8084[i - 1]);
	    class387_sub2_1452_ = (this.aClass_ra_Sub2_7824.aClass387_Sub2Array8189[i - 1]);
	    bool_1451_ = true;
	} else
	    class387_sub2_1452_ = class387_sub2_1453_ = new Class387_Sub2(this.aClass_ra_Sub2_7824);
	...
	if (i == 0) {
	    ...
	    anInt7866 = 0;
	    anInt7890 = 0;
	    for (int i_1458_ = 0; i_1458_ < this.anInt7833; i_1458_++) {
		anInt7888 += this.anIntArray7834[i_1458_];
		anInt7866 += this.anIntArray7835[i_1458_];
		anInt7890 += this.anIntArray7836[i_1458_];
		i_1457_++;
	    }
	    if (i_1457_ > 0) {
	    ...
	    for (int i_1459_ = 0; i_1459_ < this.anInt7833; i_1459_++) {
		this.anIntArray7834[i_1459_] += i_1454_;
		this.anIntArray7835[i_1459_] += i_1455_;
		this.anIntArray7836[i_1459_] += i_1456_;
	    }
	} else if (i == 2) {
	    for (int i_1460_ = 0; i_1460_ < this.anInt7833; i_1460_++) {
		this.anIntArray7834[i_1460_] -= anInt7888;
		this.anIntArray7835[i_1460_] -= anInt7866;
		this.anIntArray7836[i_1460_] -= anInt7890;
		if (i_1456_ != 0) {
		    int i_1461_ = Class220.anIntArray2483[i_1456_];
		    int i_1462_ = Class220.anIntArray2474[i_1456_];
		    int i_1463_ = (((this.anIntArray7835[i_1460_] * i_1461_) + (this.anIntArray7834[i_1460_] * i_1462_) + 16383) >> 14);
		    this.anIntArray7835[i_1460_] = ((this.anIntArray7835[i_1460_] * i_1462_) - (this.anIntArray7834[i_1460_] * i_1461_) + 16383) >> 14;
		    this.anIntArray7834[i_1460_] = i_1463_;
		}
		if (i_1454_ != 0) {
		    int i_1464_ = Class220.anIntArray2483[i_1454_];
		    int i_1465_ = Class220.anIntArray2474[i_1454_];
		    int i_1466_ = (((this.anIntArray7835[i_1460_] * i_1465_) - (this.anIntArray7836[i_1460_] * i_1464_) + 16383) >> 14);
		    this.anIntArray7836[i_1460_] = ((this.anIntArray7835[i_1460_] * i_1464_) + (this.anIntArray7836[i_1460_] * i_1465_) + 16383) >> 14;
		    this.anIntArray7835[i_1460_] = i_1466_;
		}
		if (i_1455_ != 0) {
		    int i_1467_ = Class220.anIntArray2483[i_1455_];
		    int i_1468_ = Class220.anIntArray2474[i_1455_];
		    int i_1469_ = (((this.anIntArray7836[i_1460_] * i_1467_) + (this.anIntArray7834[i_1460_] * i_1468_) + 16383) >> 14);
		    this.anIntArray7836[i_1460_] = ((this.anIntArray7836[i_1460_] * i_1468_) - (this.anIntArray7834[i_1460_] * i_1467_) + 16383) >> 14;
		    this.anIntArray7834[i_1460_] = i_1469_;
		}
		this.anIntArray7834[i_1460_] += anInt7888;
		this.anIntArray7835[i_1460_] += anInt7866;
		this.anIntArray7836[i_1460_] += anInt7890;
	    ...
	    for (int i_1470_ = 0; i_1470_ < this.anInt7833; i_1470_++) {
		this.anIntArray7834[i_1470_] -= anInt7888;
		this.anIntArray7835[i_1470_] -= anInt7866;
		this.anIntArray7836[i_1470_] -= anInt7890;
		this.anIntArray7834[i_1470_] = (this.anIntArray7834[i_1470_] * i_1454_ / 128);
		this.anIntArray7835[i_1470_] = (this.anIntArray7835[i_1470_] * i_1455_ / 128);
		this.anIntArray7836[i_1470_] = (this.anIntArray7836[i_1470_] * i_1456_ / 128);
		this.anIntArray7834[i_1470_] += anInt7888;
		this.anIntArray7835[i_1470_] += anInt7866;
		this.anIntArray7836[i_1470_] += anInt7890;
	    }
	} else if (i == 5) {
	    for (int i_1471_ = 0; i_1471_ < this.anInt7847; i_1471_++) {
		int i_1472_ = ((this.aByteArray7850[i_1471_] & 0xff) + i_1454_ * 8);
		if (i_1472_ < 0)
		    i_1472_ = 0;
		else if (i_1472_ > 255)
		    i_1472_ = 255;
		this.aByteArray7850[i_1471_] = (byte) i_1472_;
	    }
	    if (this.aClass32_7858 != null)
		this.aClass32_7858.anInterface1_397 = null;
	    if (this.aClass54Array7880 != null) {
		for (int i_1473_ = 0; i_1473_ < this.anInt7877; i_1473_++) {
		    Class54 class54 = this.aClass54Array7880[i_1473_];
		    Class36 class36 = this.aClass36Array7875[i_1473_];
		    class36.anInt424 = (class36.anInt424 & 0xffffff | 255 - ((this.aByteArray7850[class54.anInt549]) & 0xff) << 24);
		}
	    }
	} else if (i == 7) {
	    for (int i_1474_ = 0; i_1474_ < this.anInt7847; i_1474_++) {
		int i_1475_ = this.aShortArray7849[i_1474_] & 0xffff;
		...
		if (i_1478_ < 0)
		    ...
		    i_1478_ = 127;
		this.aShortArray7849[i_1474_] = (short) (i_1476_ << 10 | i_1477_ << 7 | i_1478_);
	    }
	    if (this.aClass32_7858 != null)
		this.aClass32_7858.anInterface1_397 = null;
	    if (this.aClass54Array7880 != null) {
		for (int i_1479_ = 0; i_1479_ < this.anInt7877; i_1479_++) {
		    Class54 class54 = this.aClass54Array7880[i_1479_];
		    Class36 class36 = this.aClass36Array7875[i_1479_];
		    class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
		}
	    }
	} else if (i == 8) {
	    for (int i_1480_ = 0; i_1480_ < this.anInt7877; i_1480_++) {
		Class36 class36 = this.aClass36Array7875[i_1480_];
		class36.anInt422 += i_1454_;
		class36.anInt419 += i_1455_;
	    }
	} else if (i == 10) {
	    for (int i_1481_ = 0; i_1481_ < this.anInt7877; i_1481_++) {
		Class36 class36 = this.aClass36Array7875[i_1481_];
		class36.anInt420 = class36.anInt420 * i_1454_ >> 7;
		class36.anInt421 = class36.anInt421 * i_1455_ >> 7;
	    }
	} else if (i == 9) {
	    for (int i_1482_ = 0; i_1482_ < this.anInt7877; i_1482_++) {
		Class36 class36 = this.aClass36Array7875[i_1482_];
	...
	if (this.aShortArray7838 != null) {
	    ...
	    if (bool) {
		class222_1483_ = (this.aClass_ra_Sub2_7824).aClass222_8103;
		class222_1483_.method2074(class222);
	    }
	    float[] fs = new float[3];
	    for (int i_1484_ = 0; i_1484_ < this.anInt7833; i_1484_++) {
		if ((i & this.aShortArray7838[i_1484_]) != 0) {
		    class222_1483_.method2077((this.anIntArray7834[i_1484_]), (this.anIntArray7835[i_1484_]), (this.anIntArray7836[i_1484_]), fs);
		    this.anIntArray7834[i_1484_] = (int) fs[0];
		    this.anIntArray7835[i_1484_] = (int) fs[1];
		    this.anIntArray7836[i_1484_] = (int) fs[2];
		}
	    }
	}
    }
	...
	if (this.anInt7839 != 0) {
	    Class233 class233 = (this.aClass_ra_Sub2_7824.aClass233_8041);
	    Class233 class233_1486_ = (this.aClass_ra_Sub2_7824.aClass233_8104);
	    Class233 class233_1487_ = (this.aClass_ra_Sub2_7824.aClass233_8184);
	    class233_1486_.method2145(class222);
	    class233_1487_.method2142(class233_1486_);
	    class233_1487_.method2144((this.aClass_ra_Sub2_7824).aClass233_8069);
	    if (!this.aBoolean7843)
		method4831();
	    float[] fs = (this.aClass_ra_Sub2_7824.aFloatArray8094);
	    class233_1486_.method2149(0.0F, (this.aShort7868), 0.0F, fs);
	    float f = fs[0];
	    float f_1488_ = fs[1];
	    float f_1489_ = fs[2];
	    class233_1486_.method2149(0.0F, (this.aShort7874), 0.0F, fs);
	    float f_1490_ = fs[0];
	    float f_1491_ = fs[1];
	    float f_1492_ = fs[2];
	    for (int i_1493_ = 0; i_1493_ < 6; i_1493_++) {
		float[] fs_1494_ = ((this.aClass_ra_Sub2_7824).aFloatArrayArray8077[i_1493_]);
		float f_1495_ = (fs_1494_[0] * f + fs_1494_[1] * f_1488_ + fs_1494_[2] * f_1489_ + fs_1494_[3] + this.anInt7891);
		float f_1496_ = (fs_1494_[0] * f_1490_ + fs_1494_[1] * f_1491_ + fs_1494_[2] * f_1492_ + fs_1494_[3] + this.anInt7891);
		...
		int i_1498_ = ((this.aShort7870 + this.aShort7871) >> 1);
		int i_1499_ = ((this.aShort7872 + this.aShort7876) >> 1);
		int i_1500_ = i_1498_;
		short i_1501_ = this.aShort7868;
		int i_1502_ = i_1499_;
		...
		if (f_1505_ >= -f_1506_) {
		    class302_sub1.anInt7641 = (int) ((this.aClass_ra_Sub2_7824.aFloat8095) + ((this.aClass_ra_Sub2_7824).aFloat8096) * f_1503_ / f_1506_);
		    class302_sub1.anInt7642 = (int) ((this.aClass_ra_Sub2_7824.aFloat8097) + ((this.aClass_ra_Sub2_7824).aFloat8098) * f_1504_ / f_1506_);
		} else
		    bool = true;
		i_1500_ = i_1498_;
		i_1501_ = this.aShort7874;
		i_1502_ = i_1499_;
		...
		if (f_1509_ >= -f_1510_) {
		    class302_sub1.anInt7643 = (int) ((this.aClass_ra_Sub2_7824.aFloat8095) + ((this.aClass_ra_Sub2_7824).aFloat8096) * f_1507_ / f_1510_);
		    class302_sub1.anInt7640 = (int) ((this.aClass_ra_Sub2_7824.aFloat8097) + ((this.aClass_ra_Sub2_7824).aFloat8098) * f_1508_ / f_1510_);
		} else
		    bool = true;
		if (bool) {
			...
			class302_sub1.anInt7641 = (int) (((this.aClass_ra_Sub2_7824).aFloat8095) + ((this.aClass_ra_Sub2_7824).aFloat8096 * f_1512_ / f_1514_));
			class302_sub1.anInt7642 = (int) (((this.aClass_ra_Sub2_7824).aFloat8097) + ((this.aClass_ra_Sub2_7824).aFloat8098 * f_1513_ / f_1514_));
			...
			class302_sub1.anInt7643 = (int) (((this.aClass_ra_Sub2_7824).aFloat8095) + ((this.aClass_ra_Sub2_7824).aFloat8096 * f_1516_ / f_1518_));
			class302_sub1.anInt7640 = (int) (((this.aClass_ra_Sub2_7824).aFloat8097) + ((this.aClass_ra_Sub2_7824).aFloat8098 * f_1517_ / f_1518_));
		    }
		}
		if (bool_1497_) {
		    if (f_1505_ / f_1506_ > f_1509_ / f_1510_) {
			float f_1519_ = (f_1503_ + (class233.aFloatArray2594[0] * this.anInt7891) + class233.aFloatArray2594[12]);
			float f_1520_ = (f_1506_ + (class233.aFloatArray2594[3] * this.anInt7891) + class233.aFloatArray2594[15]);
			class302_sub1.anInt7645 = (int) (((this.aClass_ra_Sub2_7824).aFloat8095) - class302_sub1.anInt7641 + ((this.aClass_ra_Sub2_7824).aFloat8096 * f_1519_ / f_1520_));
		    } else {
			float f_1521_ = (f_1507_ + (class233.aFloatArray2594[0] * this.anInt7891) + class233.aFloatArray2594[12]);
			float f_1522_ = (f_1510_ + (class233.aFloatArray2594[3] * this.anInt7891) + class233.aFloatArray2594[15]);
			class302_sub1.anInt7645 = (int) (((this.aClass_ra_Sub2_7824).aFloat8095) - class302_sub1.anInt7643 + ((this.aClass_ra_Sub2_7824).aFloat8096 * f_1521_ / f_1522_));
		    }
		    class302_sub1.aBoolean7644 = true;
		}
	    }
	    this.aClass_ra_Sub2_7824.method5252();
	    this.aClass_ra_Sub2_7824.method5283(class233_1486_);
	    method4823();
	    this.aClass_ra_Sub2_7824.method5287();
	    class233_1486_.method2144((this.aClass_ra_Sub2_7824).aClass233_8110);
	...
	if (!this.aBoolean7843)
	    method4831();
	int i_1530_ = ((this.aShort7871 - this.aShort7870) >> 1);
	int i_1531_ = ((this.aShort7874 - this.aShort7868) >> 1);
	int i_1532_ = ((this.aShort7876 - this.aShort7872) >> 1);
	int i_1533_ = this.aShort7870 + i_1530_;
	int i_1534_ = this.aShort7868 + i_1531_;
	int i_1535_ = this.aShort7872 + i_1532_;
	...
	for (int i_1542_ = 0; i_1542_ < 8; i_1542_++) {
		...
		int i_1549_ = (int) ((this.aClass_ra_Sub2_7824.aFloat8095) + (this.aClass_ra_Sub2_7824.aFloat8096) * f_1547_ / f_1546_);
		int i_1550_ = (int) ((this.aClass_ra_Sub2_7824.aFloat8097) + (this.aClass_ra_Sub2_7824.aFloat8098) * f_1548_ / f_1546_);
		if (i_1549_ < i_1526_)
		    i_1526_ = i_1549_;
		if (i_1549_ > i_1527_)
		    i_1527_ = i_1549_;
	...
	if (bool_1525_ && i > i_1526_ && i < i_1527_ && i_1523_ > i_1528_ && i_1523_ < i_1529_) {
	    ...
	    int[] is = (this.aClass_ra_Sub2_7824.anIntArray8198);
	    int[] is_1551_ = (this.aClass_ra_Sub2_7824.anIntArray8199);
	    for (int i_1552_ = 0; i_1552_ < this.anInt7833; i_1552_++) {
		int i_1553_ = this.anIntArray7834[i_1552_];
		int i_1554_ = this.anIntArray7835[i_1552_];
		int i_1555_ = this.anIntArray7836[i_1552_];
		...
		if (f >= -f_1556_) {
		    ...
		    int i_1559_ = this.anIntArray7854[i_1552_];
		    int i_1560_ = this.anIntArray7854[i_1552_ + 1];
		    for (int i_1561_ = i_1559_; i_1561_ < i_1560_; i_1561_++) {
			int i_1562_ = (this.aShortArray7830[i_1561_] - 1);
			if (i_1562_ == -1)
			    break;
			is[i_1562_] = (int) (((this.aClass_ra_Sub2_7824).aFloat8095) + ((this.aClass_ra_Sub2_7824).aFloat8096 * f_1557_ / f_1556_));
			is_1551_[i_1562_] = (int) (((this.aClass_ra_Sub2_7824).aFloat8097) + ((this.aClass_ra_Sub2_7824).aFloat8098 * f_1558_ / f_1556_));
		    }
		} else {
		    int i_1563_ = this.anIntArray7854[i_1552_];
		    int i_1564_ = this.anIntArray7854[i_1552_ + 1];
		    for (int i_1565_ = i_1563_; i_1565_ < i_1564_; i_1565_++) {
			int i_1566_ = (this.aShortArray7830[i_1565_] - 1);
			if (i_1566_ == -1)
			    break;
			is[this.aShortArray7830[i_1565_] - 1] = -999999;
		    }
		}
	    }
	    for (int i_1567_ = 0; i_1567_ < this.anInt7847; i_1567_++) {
		if ((is[this.aShortArray7851[i_1567_]] != -999999) && (is[this.aShortArray7852[i_1567_]] != -999999) && (is[this.aShortArray7853[i_1567_]] != -999999) && method4821(i, i_1523_, is_1551_[(this.aShortArray7851[i_1567_])], is_1551_[(this.aShortArray7852[i_1567_])], is_1551_[(this.aShortArray7853[i_1567_])], is[(this.aShortArray7851[i_1567_])], is[(this.aShortArray7852[i_1567_])], is[(this.aShortArray7853[i_1567_])]))
		    return true;
	    }
	}
	return false;
	...
	if (!this.aBoolean7843)
	    method4831();
	int i_1575_ = ((this.aShort7871 - this.aShort7870) >> 1);
	int i_1576_ = ((this.aShort7874 - this.aShort7868) >> 1);
	int i_1577_ = ((this.aShort7876 - this.aShort7872) >> 1);
	int i_1578_ = this.aShort7870 + i_1575_;
	int i_1579_ = this.aShort7868 + i_1576_;
	int i_1580_ = this.aShort7872 + i_1577_;
	...
	for (int i_1587_ = 0; i_1587_ < 8; i_1587_++) {
		...
		int i_1594_ = (int) ((this.aClass_ra_Sub2_7824.aFloat8095) + (this.aClass_ra_Sub2_7824.aFloat8096) * f_1592_ / f_1591_);
		int i_1595_ = (int) ((this.aClass_ra_Sub2_7824.aFloat8097) + (this.aClass_ra_Sub2_7824.aFloat8098) * f_1593_ / f_1591_);
		if (i_1594_ < i_1571_)
		    i_1571_ = i_1594_;
		if (i_1594_ > i_1572_)
		    i_1572_ = i_1594_;
	...
	if (bool_1570_ && i > i_1571_ && i < i_1572_ && i_1568_ > i_1573_ && i_1568_ < i_1574_) {
	    ...
	    int[] is = (this.aClass_ra_Sub2_7824.anIntArray8198);
	    int[] is_1596_ = (this.aClass_ra_Sub2_7824.anIntArray8199);
	    for (int i_1597_ = 0; i_1597_ < this.anInt7833; i_1597_++) {
		int i_1598_ = this.anIntArray7834[i_1597_];
		int i_1599_ = this.anIntArray7835[i_1597_];
		int i_1600_ = this.anIntArray7836[i_1597_];
		...
		if (f >= -f_1601_) {
		    ...
		    int i_1604_ = this.anIntArray7854[i_1597_];
		    int i_1605_ = this.anIntArray7854[i_1597_ + 1];
		    for (int i_1606_ = i_1604_; i_1606_ < i_1605_; i_1606_++) {
			int i_1607_ = (this.aShortArray7830[i_1606_] - 1);
			if (i_1607_ == -1)
			    break;
			is[i_1607_] = (int) (((this.aClass_ra_Sub2_7824).aFloat8095) + ((this.aClass_ra_Sub2_7824).aFloat8096 * f_1602_ / f_1601_));
			is_1596_[i_1607_] = (int) (((this.aClass_ra_Sub2_7824).aFloat8097) + ((this.aClass_ra_Sub2_7824).aFloat8098 * f_1603_ / f_1601_));
		    }
		} else {
		    int i_1608_ = this.anIntArray7854[i_1597_];
		    int i_1609_ = this.anIntArray7854[i_1597_ + 1];
		    for (int i_1610_ = i_1608_; i_1610_ < i_1609_; i_1610_++) {
			int i_1611_ = (this.aShortArray7830[i_1610_] - 1);
			if (i_1611_ == -1)
			    break;
			is[this.aShortArray7830[i_1610_] - 1] = -999999;
		    }
		}
	    }
	    for (int i_1612_ = 0; i_1612_ < this.anInt7847; i_1612_++) {
		if ((is[this.aShortArray7851[i_1612_]] != -999999) && (is[this.aShortArray7852[i_1612_]] != -999999) && (is[this.aShortArray7853[i_1612_]] != -999999) && method4821(i, i_1568_, is_1596_[(this.aShortArray7851[i_1612_])], is_1596_[(this.aShortArray7852[i_1612_])], is_1596_[(this.aShortArray7853[i_1612_])], is[(this.aShortArray7851[i_1612_])], is[(this.aShortArray7852[i_1612_])], is[(this.aShortArray7853[i_1612_])]))
		    return true;
	    }
	}
	return false;
	...
	this.aBoolean7864 = true;
	this.aBoolean7843 = false;
	this.aClass_ra_Sub2_7824 = class_ra_sub2;
	...
	Interface_ma interface_ma = this.aClass_ra_Sub2_7824.anInterface_ma5299;
	for (int i_1621_ = 0; i_1621_ < this.anInt7847; i_1621_++) {
	    if (this.aShortArray7861[i_1621_] == i)
		this.aShortArray7861[i_1621_] = i_1620_;
	}
	byte i_1622_ = 0;
	byte i_1623_ = 0;
	if (i != -1) {
	...
	if (i_1622_ != i_1624_ | i_1623_ != i_1625_) {
	    if (this.aClass54Array7880 != null) {
		for (int i_1626_ = 0; i_1626_ < this.anInt7877; i_1626_++) {
		    Class54 class54 = this.aClass54Array7880[i_1626_];
		    Class36 class36 = this.aClass36Array7875[i_1626_];
		    class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
		}
	    }
	    if (this.aClass32_7858 != null)
	...
	Interface_ma interface_ma = this.aClass_ra_Sub2_7824.anInterface_ma5299;
	for (int i_1628_ = 0; i_1628_ < this.anInt7847; i_1628_++) {
	    if (this.aShortArray7861[i_1628_] == i)
		this.aShortArray7861[i_1628_] = i_1627_;
	}
	byte i_1629_ = 0;
	byte i_1630_ = 0;
	if (i != -1) {
	...
	if (i_1629_ != i_1631_ | i_1630_ != i_1632_) {
	    if (this.aClass54Array7880 != null) {
		for (int i_1633_ = 0; i_1633_ < this.anInt7877; i_1633_++) {
		    Class54 class54 = this.aClass54Array7880[i_1633_];
		    Class36 class36 = this.aClass36Array7875[i_1633_];
		    class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
		}
	    }
	    if (this.aClass32_7858 != null)
	...
	if (is == null) {
	    for (int i_1806_ = 0; i_1806_ < this.anInt7847; i_1806_++)
		this.aByteArray7850[i_1806_] = i;
	} else {
	    for (int i_1807_ = 0; i_1807_ < this.anInt7847; i_1807_++) {
		int i_1808_ = 255 - ((255 - (is[i_1807_] & 0xff)) * (255 - (i & 0xff)) / 255);
		this.aByteArray7850[i_1807_] = (byte) i_1808_;
	    }
	}
	if (this.aClass32_7858 != null)
	    this.aClass32_7858.anInterface1_397 = null;
	...
	if (is == null) {
	    for (int i_1809_ = 0; i_1809_ < this.anInt7847; i_1809_++)
		this.aByteArray7850[i_1809_] = i;
	} else {
	    for (int i_1810_ = 0; i_1810_ < this.anInt7847; i_1810_++) {
		int i_1811_ = 255 - ((255 - (is[i_1810_] & 0xff)) * (255 - (i & 0xff)) / 255);
		this.aByteArray7850[i_1810_] = (byte) i_1811_;
	    }
	}
	if (this.aClass32_7858 != null)
	    this.aClass32_7858.anInterface1_397 = null;
	...
	Interface_ma interface_ma = this.aClass_ra_Sub2_7824.anInterface_ma5299;
	for (int i_1816_ = 0; i_1816_ < this.anInt7847; i_1816_++) {
	    if (this.aShortArray7861[i_1816_] == i)
		this.aShortArray7861[i_1816_] = i_1815_;
	}
	byte i_1817_ = 0;
	byte i_1818_ = 0;
	if (i != -1) {
	...
	if (i_1817_ != i_1819_ | i_1818_ != i_1820_) {
	    if (this.aClass54Array7880 != null) {
		for (int i_1821_ = 0; i_1821_ < this.anInt7877; i_1821_++) {
		    Class54 class54 = this.aClass54Array7880[i_1821_];
		    Class36 class36 = this.aClass36Array7875[i_1821_];
		    class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
		}
	    }
	    if (this.aClass32_7858 != null)
	...
	for (int i_1824_ = 0; i_1824_ < this.anInt7833; i_1824_++) {
	    int i_1825_ = ((this.anIntArray7836[i_1824_] * i_1822_ + this.anIntArray7834[i_1824_] * i_1823_) >> 14);
	    this.anIntArray7836[i_1824_] = ((this.anIntArray7836[i_1824_] * i_1823_ - this.anIntArray7834[i_1824_] * i_1822_) >> 14);
	    this.anIntArray7834[i_1824_] = i_1825_;
	}
	for (int i_1826_ = 0; i_1826_ < this.anInt7839; i_1826_++) {
	    int i_1827_ = ((this.aShortArray7842[i_1826_] * i_1822_ + (this.aShortArray7829[i_1826_] * i_1823_)) >> 14);
	    this.aShortArray7842[i_1826_] = (short) (((this.aShortArray7842[i_1826_] * i_1823_) - (this.aShortArray7829[i_1826_] * i_1822_)) >> 14);
	    this.aShortArray7829[i_1826_] = (short) i_1827_;
	}
	if (this.aClass32_7889 == null && this.aClass32_7858 != null)
	    this.aClass32_7858.anInterface1_397 = null;
	if (this.aClass32_7889 != null)
	...
	if ((this.aClass_ra_Sub2_7824.aClass298_Sub53_Sub1_8197.buffer).length < this.anInt7885 * 6)
	    this.aClass_ra_Sub2_7824.aClass298_Sub53_Sub1_8197 = new RsFloatBuffer((this.anInt7885 + 100) * 6);
	else
	    this.aClass_ra_Sub2_7824.aClass298_Sub53_Sub1_8197.index = 0;
	RsFloatBuffer class298_sub53_sub1 = (this.aClass_ra_Sub2_7824.aClass298_Sub53_Sub1_8197);
	if (this.aClass_ra_Sub2_7824.aBoolean8143) {
	    for (int i = 0; i < this.anInt7885; i++) {
		class298_sub53_sub1.writeShort((this.aShortArray7851[i]), 16711935);
		class298_sub53_sub1.writeShort((this.aShortArray7852[i]), 16711935);
		class298_sub53_sub1.writeShort((this.aShortArray7853[i]), 16711935);
	    }
	} else {
	    for (int i = 0; i < this.anInt7885; i++) {
		class298_sub53_sub1.method3587((this.aShortArray7851[i]), 1368367793);
		class298_sub53_sub1.method3587((this.aShortArray7852[i]), 1368367793);
		class298_sub53_sub1.method3587((this.aShortArray7853[i]), 1368367793);
	    }
	}
	if (class298_sub53_sub1.index * 385051775 != 0) {
	    if (bool) {
		if (this.anInterface2_7820 == null)
		    this.anInterface2_7820 = (this.aClass_ra_Sub2_7824.method5284(5123, class298_sub53_sub1.buffer, class298_sub53_sub1.index * 385051775, true));
		else
		    this.anInterface2_7820.method19(5123, class298_sub53_sub1.buffer, class298_sub53_sub1.index * 385051775);
		this.aClass41_7879.anInterface2_441 = this.anInterface2_7820;
	    } else
		this.aClass41_7879.anInterface2_441 = (this.aClass_ra_Sub2_7824.method5284(5123, class298_sub53_sub1.buffer, class298_sub53_sub1.index * 385051775, false));
	    if (!bool)
		this.aBoolean7864 = true;
	}
    }
	...
	for (int i_1831_ = 0; i_1831_ < this.anInt7847; i_1831_++) {
	    int i_1832_ = this.aShortArray7849[i_1831_] & 0xffff;
	    ...
	    this.aShortArray7849[i_1831_] = (short) (i_1833_ << 10 | i_1834_ << 7 | i_1835_);
	}
	if (this.aClass54Array7880 != null) {
	    for (int i_1836_ = 0; i_1836_ < this.anInt7877; i_1836_++) {
		Class54 class54 = this.aClass54Array7880[i_1836_];
		Class36 class36 = this.aClass36Array7875[i_1836_];
		class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
	    }
	}
	if (this.aClass32_7858 != null)
	...
	for (int i_1840_ = 0; i_1840_ < this.anInt7847; i_1840_++) {
	    int i_1841_ = this.aShortArray7849[i_1840_] & 0xffff;
	    ...
	    this.aShortArray7849[i_1840_] = (short) (i_1842_ << 10 | i_1843_ << 7 | i_1844_);
	}
	if (this.aClass54Array7880 != null) {
	    for (int i_1845_ = 0; i_1845_ < this.anInt7877; i_1845_++) {
		Class54 class54 = this.aClass54Array7880[i_1845_];
		Class36 class36 = this.aClass36Array7875[i_1845_];
		class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
	    }
	}
	if (this.aClass32_7858 != null)
	...
	for (int i_1849_ = 0; i_1849_ < this.anInt7847; i_1849_++) {
	    int i_1850_ = this.aShortArray7849[i_1849_] & 0xffff;
	    ...
	    this.aShortArray7849[i_1849_] = (short) (i_1851_ << 10 | i_1852_ << 7 | i_1853_);
	}
	if (this.aClass54Array7880 != null) {
	    for (int i_1854_ = 0; i_1854_ < this.anInt7877; i_1854_++) {
		Class54 class54 = this.aClass54Array7880[i_1854_];
		Class36 class36 = this.aClass36Array7875[i_1854_];
		class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
	    }
	}
	if (this.aClass32_7858 != null)
	...
	this.anInt7891 = (int) (Math.sqrt(i_1860_) + 0.99);
	this.anInt7865 = (int) (Math.sqrt(i_1861_) + 0.99);
	...
	if (this.aShortArray7861 == null)
	    return true;
	for (int i = 0; i < this.aShortArray7861.length; i++) {
	    if (this.aShortArray7861[i] != -1 && !(this.aClass_ra_Sub2_7824.anInterface_ma5299.method170(this.aShortArray7861[i], (short) 17109)))
		return false;
	}
	return true;
    }
	...
	Interface_ma interface_ma = this.aClass_ra_Sub2_7824.anInterface_ma5299;
	for (int i_1872_ = 0; i_1872_ < this.anInt7847; i_1872_++) {
	    if (this.aShortArray7861[i_1872_] == i)
		this.aShortArray7861[i_1872_] = i_1871_;
	}
	byte i_1873_ = 0;
	byte i_1874_ = 0;
	if (i != -1) {
	...
	if (i_1873_ != i_1875_ | i_1874_ != i_1876_) {
	    if (this.aClass54Array7880 != null) {
		for (int i_1877_ = 0; i_1877_ < this.anInt7877; i_1877_++) {
		    Class54 class54 = this.aClass54Array7880[i_1877_];
		    Class36 class36 = this.aClass36Array7875[i_1877_];
		    class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
		}
	    }
	    if (this.aClass32_7858 != null)
	...
	for (int i = 0; i < this.anInt7839; i++)
	    this.aShortArray7842[i] = (short) -this.aShortArray7842[i];
	for (int i = 0; i < this.anInt7847; i++) {
	    short i_1878_ = this.aShortArray7851[i];
	    this.aShortArray7851[i] = this.aShortArray7853[i];
	    this.aShortArray7853[i] = i_1878_;
	}
	if (this.aClass32_7889 == null && this.aClass32_7858 != null)
	    this.aClass32_7858.anInterface1_397 = null;
	if (this.aClass32_7889 != null)
	...
	for (int i_1880_ = 0; i_1880_ < this.anInt7847; i_1880_++) {
	    if (this.aShortArray7849[i_1880_] == i)
		this.aShortArray7849[i_1880_] = i_1879_;
	}
	if (this.aClass54Array7880 != null) {
	    for (int i_1881_ = 0; i_1881_ < this.anInt7877; i_1881_++) {
		Class54 class54 = this.aClass54Array7880[i_1881_];
		Class36 class36 = this.aClass36Array7875[i_1881_];
		class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
	    }
	}
	if (this.aClass32_7858 != null)
	...
	for (int i_1883_ = 0; i_1883_ < this.anInt7847; i_1883_++) {
	    if (this.aShortArray7849[i_1883_] == i)
		this.aShortArray7849[i_1883_] = i_1882_;
	}
	if (this.aClass54Array7880 != null) {
	    for (int i_1884_ = 0; i_1884_ < this.anInt7877; i_1884_++) {
		Class54 class54 = this.aClass54Array7880[i_1884_];
		Class36 class36 = this.aClass36Array7875[i_1884_];
		class36.anInt424 = (class36.anInt424 & ~0xffffff | ((Class294.anIntArray3165[(this.aShortArray7849[class54.anInt549]) & 0xffff]) & 0xffffff));
	    }
	}
	if (this.aClass32_7858 != null)
	...
	if (this.aClass85Array7825 != null) {
		...
		class85_1885_.anInt777 = ((int) (class233.aFloatArray2594[12] + ((class233.aFloatArray2594[0] * (this.anIntArray7834[class85.anInt773 * -710317103])) + (class233.aFloatArray2594[4] * (this.anIntArray7835[(class85.anInt773 * -710317103)])) + (class233.aFloatArray2594[8] * (this.anIntArray7836[(class85.anInt773 * -710317103)])))) * -1879868075);
		class85_1885_.anInt783 = ((int) (class233.aFloatArray2594[13] + ((class233.aFloatArray2594[1] * (this.anIntArray7834[class85.anInt773 * -710317103])) + (class233.aFloatArray2594[5] * (this.anIntArray7835[(class85.anInt773 * -710317103)])) + (class233.aFloatArray2594[9] * (this.anIntArray7836[(class85.anInt773 * -710317103)])))) * -2041556771);
		class85_1885_.anInt779 = ((int) (class233.aFloatArray2594[14] + ((class233.aFloatArray2594[2] * (this.anIntArray7834[class85.anInt773 * -710317103])) + (class233.aFloatArray2594[6] * (this.anIntArray7835[(class85.anInt773 * -710317103)])) + (class233.aFloatArray2594[10] * (this.anIntArray7836[(class85.anInt773 * -710317103)])))) * -1434499227);
		class85_1885_.anInt772 = ((int) (class233.aFloatArray2594[12] + ((class233.aFloatArray2594[0] * (this.anIntArray7834[class85.anInt774 * 1705862021])) + (class233.aFloatArray2594[4] * (this.anIntArray7835[(class85.anInt774 * 1705862021)])) + (class233.aFloatArray2594[8] * (this.anIntArray7836[(class85.anInt774 * 1705862021)])))) * 1070341177);
		class85_1885_.anInt781 = ((int) (class233.aFloatArray2594[13] + ((class233.aFloatArray2594[1] * (this.anIntArray7834[class85.anInt774 * 1705862021])) + (class233.aFloatArray2594[5] * (this.anIntArray7835[(class85.anInt774 * 1705862021)])) + (class233.aFloatArray2594[9] * (this.anIntArray7836[(class85.anInt774 * 1705862021)])))) * 1802851857);
		class85_1885_.anInt782 = (int) (class233.aFloatArray2594[14] + ((class233.aFloatArray2594[2] * (this.anIntArray7834[class85.anInt774 * 1705862021])) + (class233.aFloatArray2594[6] * (this.anIntArray7835[class85.anInt774 * 1705862021])) + (class233.aFloatArray2594[10] * (this.anIntArray7836[(class85.anInt774 * 1705862021)])))) * 103846281;
		class85_1885_.anInt771 = ((int) (class233.aFloatArray2594[12] + ((class233.aFloatArray2594[0] * (this.anIntArray7834[class85.anInt775 * 1636170731])) + (class233.aFloatArray2594[4] * (this.anIntArray7835[(class85.anInt775 * 1636170731)])) + (class233.aFloatArray2594[8] * (this.anIntArray7836[(class85.anInt775 * 1636170731)])))) * -2103324039);
		class85_1885_.anInt784 = ((int) (class233.aFloatArray2594[13] + ((class233.aFloatArray2594[1] * (this.anIntArray7834[class85.anInt775 * 1636170731])) + (class233.aFloatArray2594[5] * (this.anIntArray7835[(class85.anInt775 * 1636170731)])) + (class233.aFloatArray2594[9] * (this.anIntArray7836[(class85.anInt775 * 1636170731)])))) * -526039059);
		class85_1885_.anInt785 = (int) (class233.aFloatArray2594[14] + ((class233.aFloatArray2594[2] * (this.anIntArray7834[class85.anInt775 * 1636170731])) + (class233.aFloatArray2594[6] * (this.anIntArray7835[class85.anInt775 * 1636170731])) + (class233.aFloatArray2594[10] * (this.anIntArray7836[(class85.anInt775 * 1636170731)])))) * 491030489;
	    }
	}
	if (this.aClass68Array7857 != null) {
	    for (int i = 0; i < this.aClass68Array7857.length; i++) {
		...
		if (class68.aClass233_677 != null)
		    ...
		    class68.aClass233_677 = new Class233(class233);
		class68_1886_.anInt671 = ((int) (class233.aFloatArray2594[12] + ((class233.aFloatArray2594[0] * (this.anIntArray7834[class68.anInt674 * -180596249])) + (class233.aFloatArray2594[4] * (this.anIntArray7835[(class68.anInt674 * -180596249)])) + (class233.aFloatArray2594[8] * (this.anIntArray7836[(class68.anInt674 * -180596249)])))) * -1436341053);
		class68_1886_.anInt675 = (int) (class233.aFloatArray2594[13] + ((class233.aFloatArray2594[1] * (this.anIntArray7834[class68.anInt674 * -180596249])) + (class233.aFloatArray2594[5] * (this.anIntArray7835[class68.anInt674 * -180596249])) + (class233.aFloatArray2594[9] * (this.anIntArray7836[(class68.anInt674 * -180596249)])))) * 449866009;
		class68_1886_.anInt676 = ((int) (class233.aFloatArray2594[14] + ((class233.aFloatArray2594[2] * (this.anIntArray7834[class68.anInt674 * -180596249])) + (class233.aFloatArray2594[6] * (this.anIntArray7835[(class68.anInt674 * -180596249)])) + (class233.aFloatArray2594[10] * (this.anIntArray7836[(class68.anInt674 * -180596249)])))) * 1336328763);
	    }
	}
    }
	...
	if (this.aClass85Array7825 != null) {
		...
		class85_1887_.anInt777 = ((int) (class233.aFloatArray2594[12] + ((class233.aFloatArray2594[0] * (this.anIntArray7834[class85.anInt773 * -710317103])) + (class233.aFloatArray2594[4] * (this.anIntArray7835[(class85.anInt773 * -710317103)])) + (class233.aFloatArray2594[8] * (this.anIntArray7836[(class85.anInt773 * -710317103)])))) * -1879868075);
		class85_1887_.anInt783 = ((int) (class233.aFloatArray2594[13] + ((class233.aFloatArray2594[1] * (this.anIntArray7834[class85.anInt773 * -710317103])) + (class233.aFloatArray2594[5] * (this.anIntArray7835[(class85.anInt773 * -710317103)])) + (class233.aFloatArray2594[9] * (this.anIntArray7836[(class85.anInt773 * -710317103)])))) * -2041556771);
		class85_1887_.anInt779 = ((int) (class233.aFloatArray2594[14] + ((class233.aFloatArray2594[2] * (this.anIntArray7834[class85.anInt773 * -710317103])) + (class233.aFloatArray2594[6] * (this.anIntArray7835[(class85.anInt773 * -710317103)])) + (class233.aFloatArray2594[10] * (this.anIntArray7836[(class85.anInt773 * -710317103)])))) * -1434499227);
		class85_1887_.anInt772 = ((int) (class233.aFloatArray2594[12] + ((class233.aFloatArray2594[0] * (this.anIntArray7834[class85.anInt774 * 1705862021])) + (class233.aFloatArray2594[4] * (this.anIntArray7835[(class85.anInt774 * 1705862021)])) + (class233.aFloatArray2594[8] * (this.anIntArray7836[(class85.anInt774 * 1705862021)])))) * 1070341177);
		class85_1887_.anInt781 = ((int) (class233.aFloatArray2594[13] + ((class233.aFloatArray2594[1] * (this.anIntArray7834[class85.anInt774 * 1705862021])) + (class233.aFloatArray2594[5] * (this.anIntArray7835[(class85.anInt774 * 1705862021)])) + (class233.aFloatArray2594[9] * (this.anIntArray7836[(class85.anInt774 * 1705862021)])))) * 1802851857);
		class85_1887_.anInt782 = (int) (class233.aFloatArray2594[14] + ((class233.aFloatArray2594[2] * (this.anIntArray7834[class85.anInt774 * 1705862021])) + (class233.aFloatArray2594[6] * (this.anIntArray7835[class85.anInt774 * 1705862021])) + (class233.aFloatArray2594[10] * (this.anIntArray7836[(class85.anInt774 * 1705862021)])))) * 103846281;
		class85_1887_.anInt771 = ((int) (class233.aFloatArray2594[12] + ((class233.aFloatArray2594[0] * (this.anIntArray7834[class85.anInt775 * 1636170731])) + (class233.aFloatArray2594[4] * (this.anIntArray7835[(class85.anInt775 * 1636170731)])) + (class233.aFloatArray2594[8] * (this.anIntArray7836[(class85.anInt775 * 1636170731)])))) * -2103324039);
		class85_1887_.anInt784 = ((int) (class233.aFloatArray2594[13] + ((class233.aFloatArray2594[1] * (this.anIntArray7834[class85.anInt775 * 1636170731])) + (class233.aFloatArray2594[5] * (this.anIntArray7835[(class85.anInt775 * 1636170731)])) + (class233.aFloatArray2594[9] * (this.anIntArray7836[(class85.anInt775 * 1636170731)])))) * -526039059);
		class85_1887_.anInt785 = (int) (class233.aFloatArray2594[14] + ((class233.aFloatArray2594[2] * (this.anIntArray7834[class85.anInt775 * 1636170731])) + (class233.aFloatArray2594[6] * (this.anIntArray7835[class85.anInt775 * 1636170731])) + (class233.aFloatArray2594[10] * (this.anIntArray7836[(class85.anInt775 * 1636170731)])))) * 491030489;
	    }
	}
	if (this.aClass68Array7857 != null) {
	    for (int i = 0; i < this.aClass68Array7857.length; i++) {
		...
		if (class68.aClass233_677 != null)
		    ...
		    class68.aClass233_677 = new Class233(class233);
		class68_1888_.anInt671 = ((int) (class233.aFloatArray2594[12] + ((class233.aFloatArray2594[0] * (this.anIntArray7834[class68.anInt674 * -180596249])) + (class233.aFloatArray2594[4] * (this.anIntArray7835[(class68.anInt674 * -180596249)])) + (class233.aFloatArray2594[8] * (this.anIntArray7836[(class68.anInt674 * -180596249)])))) * -1436341053);
		class68_1888_.anInt675 = (int) (class233.aFloatArray2594[13] + ((class233.aFloatArray2594[1] * (this.anIntArray7834[class68.anInt674 * -180596249])) + (class233.aFloatArray2594[5] * (this.anIntArray7835[class68.anInt674 * -180596249])) + (class233.aFloatArray2594[9] * (this.anIntArray7836[(class68.anInt674 * -180596249)])))) * 449866009;
		class68_1888_.anInt676 = ((int) (class233.aFloatArray2594[14] + ((class233.aFloatArray2594[2] * (this.anIntArray7834[class68.anInt674 * -180596249])) + (class233.aFloatArray2594[6] * (this.anIntArray7835[(class68.anInt674 * -180596249)])) + (class233.aFloatArray2594[10] * (this.anIntArray7836[(class68.anInt674 * -180596249)])))) * 1336328763);
	    }
	}
    }
	...
	for (int i_1891_ = 0; i_1891_ < this.anInt7833; i_1891_++) {
	    int i_1892_ = ((this.anIntArray7836[i_1891_] * i_1889_ + this.anIntArray7834[i_1891_] * i_1890_) >> 14);
	    this.anIntArray7836[i_1891_] = ((this.anIntArray7836[i_1891_] * i_1890_ - this.anIntArray7834[i_1891_] * i_1889_) >> 14);
	    this.anIntArray7834[i_1891_] = i_1892_;
	}
	if (this.aClass32_7831 != null)
	    this.aClass32_7831.anInterface1_397 = null;
	this.aBoolean7843 = false;
	...
	if (this.aShortArray7861 == null)
	    return true;
	for (int i = 0; i < this.aShortArray7861.length; i++) {
	    if (this.aShortArray7861[i] != -1 && !(this.aClass_ra_Sub2_7824.anInterface_ma5299.method170(this.aShortArray7861[i], (short) 19267)))
		return false;
	}
	return true;
    }
	...
	if (this.aShortArray7838 != null) {
	    ...
	    if (bool) {
		class222_1896_ = (this.aClass_ra_Sub2_7824).aClass222_8103;
		class222_1896_.method2074(class222);
	    }
	    float[] fs = new float[3];
	    for (int i_1897_ = 0; i_1897_ < this.anInt7833; i_1897_++) {
		if ((i & this.aShortArray7838[i_1897_]) != 0) {
		    class222_1896_.method2077((this.anIntArray7834[i_1897_]), (this.anIntArray7835[i_1897_]), (this.anIntArray7836[i_1897_]), fs);
    ...
    Class387_Sub2(Class_ra_Sub2 class_ra_sub2, Model class64, int i, int i_1898_, int i_1899_, int i_1900_) {
	this.anInt7832 = 0;
	this.anInt7833 = 0;
	this.anInt7839 = 0;
	this.anInt7847 = 0;
	...
	this.anIntArray7854 = new int[class64.anInt626 + 1];
	for (int i_1901_ = 0; i_1901_ < class64.anInt621; i_1901_++) {
	    if (class64.aByteArray625 == null || class64.aByteArray625[i_1901_] != 2) {
		if (class64.aShortArray617 != null && class64.aShortArray617[i_1901_] != -1) {
		    Class53 class53 = interface_ma.method174((class64.aShortArray617[i_1901_]) & 0xffff, 320662822);
		    if (((this.anInt7826 & 0x40) == 0 || !class53.aBoolean524) && class53.aBoolean538)
			continue;
		}
		is[this.anInt7847++] = i_1901_;
		this.anIntArray7854[(class64.aShortArray644[i_1901_])]++;
		this.anIntArray7854[(class64.aShortArray646[i_1901_])]++;
		this.anIntArray7854[(class64.aShortArray624[i_1901_])]++;
	    }
	}
	this.anInt7885 = this.anInt7847;
	long[] ls = new long[this.anInt7847];
	boolean bool = (this.anInt7863 & 0x100) != 0;
	for (int i_1902_ = 0; i_1902_ < this.anInt7847; i_1902_++) {
	    ...
	    boolean bool_1912_ = ((class64.aByteArray627 != null && class64.aByteArray627[i_1903_] != 0) || class53 != null && class53.anInt528 * -2138060883 != 0);
	    ...
	    class387_sub2_1913_.aBoolean7862 = (class387_sub2_1913_.aBoolean7862 | (class53 != null && (class53.aByte535 != 0 || class53.aByte509 != 0)));
	}
	Class277.method2598(ls, is, (byte) 2);
	this.anInt7832 = class64.anInt614;
	this.anInt7833 = class64.anInt626;
	this.anIntArray7834 = class64.anIntArray616;
	this.anIntArray7835 = class64.anIntArray642;
	this.anIntArray7836 = class64.anIntArray618;
	this.aShortArray7838 = class64.aShortArray620;
	Class43[] class43s = new Class43[this.anInt7833];
	this.aClass85Array7825 = class64.aClass85Array647;
	this.aClass68Array7857 = class64.aClass68Array613;
	if (class64.aClass84Array649 != null) {
	    this.anInt7877 = class64.aClass84Array649.length;
	...
	this.aShort7828 = (short) i_1898_;
	this.aShort7869 = (short) i_1899_;
	...
	this.anIntArray7854[class64.anInt626] = i_1919_;
	Class76 class76 = method4785(class64, is, this.anInt7847);
	...
	for (int i_1922_ = 0; i_1922_ < class64.anInt621; i_1922_++) {
	    ...
	    byte i_1936_ = (class64.aByteArray625 == null ? (byte) 0 : class64.aByteArray625[i_1922_]);
	    if (i_1936_ == 0) {
	...
	for (int i_1937_ = 0; i_1937_ < this.anInt7847; i_1937_++) {
	    ...
	    short i_1942_ = (class64.aShortArray617 == null ? (short) -1 : class64.aShortArray617[i_1938_]);
		...
		if (i_1940_ == -1) {
			...
			float f_1958_ = class64.anIntArray616[i_1955_];
			float f_1959_ = class64.anIntArray642[i_1955_];
			float f_1960_ = class64.anIntArray618[i_1955_];
			float f_1961_ = class64.anIntArray616[i_1956_] - f_1958_;
			float f_1962_ = class64.anIntArray642[i_1956_] - f_1959_;
			float f_1963_ = class64.anIntArray618[i_1956_] - f_1960_;
			float f_1964_ = class64.anIntArray616[i_1957_] - f_1958_;
			float f_1965_ = class64.anIntArray642[i_1957_] - f_1959_;
			float f_1966_ = class64.anIntArray618[i_1957_] - f_1960_;
			float f_1967_ = class64.anIntArray616[i_1952_] - f_1958_;
			float f_1968_ = class64.anIntArray642[i_1952_] - f_1959_;
			float f_1969_ = class64.anIntArray618[i_1952_] - f_1960_;
			float f_1970_ = class64.anIntArray616[i_1953_] - f_1958_;
			float f_1971_ = class64.anIntArray642[i_1953_] - f_1959_;
			float f_1972_ = class64.anIntArray618[i_1953_] - f_1960_;
			float f_1973_ = class64.anIntArray616[i_1954_] - f_1958_;
			float f_1974_ = class64.anIntArray642[i_1954_] - f_1959_;
			float f_1975_ = class64.anIntArray618[i_1954_] - f_1960_;
			...
			float f_1990_ = class64.anIntArray637[i_1940_] / 256.0F;
			if (i_1951_ == 1) {
			    float f_1991_ = (class64.anIntArray641[i_1940_] / 1024.0F);
			    method4744(class64.anIntArray616[i_1983_], class64.anIntArray642[i_1983_], class64.anIntArray618[i_1983_], i_1986_, i_1987_, i_1988_, fs, f_1991_, i_1989_, f_1990_, aFloatArray7884);
			    f = aFloatArray7884[0];
			    f_1943_ = aFloatArray7884[1];
			    method4744(class64.anIntArray616[i_1984_], class64.anIntArray642[i_1984_], class64.anIntArray618[i_1984_], i_1986_, i_1987_, i_1988_, fs, f_1991_, i_1989_, f_1990_, aFloatArray7884);
			    f_1944_ = aFloatArray7884[0];
			    f_1945_ = aFloatArray7884[1];
			    method4744(class64.anIntArray616[i_1985_], class64.anIntArray642[i_1985_], class64.anIntArray618[i_1985_], i_1986_, i_1987_, i_1988_, fs, f_1991_, i_1989_, f_1990_, aFloatArray7884);
			    ...
			    float f_1993_ = (class64.anIntArray643[i_1940_] / 256.0F);
			    float f_1994_ = (class64.anIntArray648[i_1940_] / 256.0F);
			    ...
			    float f_2004_ = (64.0F / class64.anIntArray639[i_1940_]);
			    float f_2005_ = (64.0F / class64.anIntArray640[i_1940_]);
			    float f_2006_ = (64.0F / class64.anIntArray641[i_1940_]);
			    ...
			    method4730(class64.anIntArray616[i_1983_], class64.anIntArray642[i_1983_], class64.anIntArray618[i_1983_], i_1986_, i_1987_, i_1988_, i_1950_, fs, i_1989_, f_1990_, f_1993_, f_1994_, aFloatArray7884);
			    f = aFloatArray7884[0];
			    f_1943_ = aFloatArray7884[1];
			    method4730(class64.anIntArray616[i_1984_], class64.anIntArray642[i_1984_], class64.anIntArray618[i_1984_], i_1986_, i_1987_, i_1988_, i_1950_, fs, i_1989_, f_1990_, f_1993_, f_1994_, aFloatArray7884);
			    f_1944_ = aFloatArray7884[0];
			    f_1945_ = aFloatArray7884[1];
			    method4730(class64.anIntArray616[i_1985_], class64.anIntArray642[i_1985_], class64.anIntArray618[i_1985_], i_1986_, i_1987_, i_1988_, i_1950_, fs, i_1989_, f_1990_, f_1993_, f_1994_, aFloatArray7884);
			    f_1946_ = aFloatArray7884[0];
			    f_1947_ = aFloatArray7884[1];
			} else if (i_1951_ == 3) {
			    method4780(class64.anIntArray616[i_1983_], class64.anIntArray642[i_1983_], class64.anIntArray618[i_1983_], i_1986_, i_1987_, i_1988_, fs, i_1989_, f_1990_, aFloatArray7884);
			    f = aFloatArray7884[0];
			    f_1943_ = aFloatArray7884[1];
			    method4780(class64.anIntArray616[i_1984_], class64.anIntArray642[i_1984_], class64.anIntArray618[i_1984_], i_1986_, i_1987_, i_1988_, fs, i_1989_, f_1990_, aFloatArray7884);
			    f_1944_ = aFloatArray7884[0];
			    f_1945_ = aFloatArray7884[1];
			    method4780(class64.anIntArray616[i_1985_], class64.anIntArray642[i_1985_], class64.anIntArray618[i_1985_], i_1986_, i_1987_, i_1988_, fs, i_1989_, f_1990_, aFloatArray7884);
			    f_1946_ = aFloatArray7884[0];
			    f_1947_ = aFloatArray7884[1];
			    if ((i_1989_ & 0x1) == 0) {
				if (f_1944_ - f > 0.5F) {
		...
		this.aShortArray7851[i_1937_] = method4828(class64, i_2011_, l, class43.anInt464, class43.anInt463, class43.anInt465, class43.anInt466, f, f_1943_);
		class43 = class43s[i_2012_];
		this.aShortArray7852[i_1937_] = method4828(class64, i_2012_, l + i_1948_, class43.anInt464, class43.anInt463, class43.anInt465, class43.anInt466, f_1944_, f_1945_);
		class43 = class43s[i_2013_];
		this.aShortArray7853[i_1937_] = method4828(class64, i_2013_, l + i_1949_, class43.anInt464, class43.anInt463, class43.anInt465, class43.anInt466, f_1946_, f_1947_);
	    } else if (i_2010_ == 1) {
		...
		this.aShortArray7851[i_1937_] = method4828(class64, class64.aShortArray644[i_1938_], l, class37.anInt426, class37.anInt425, class37.anInt427, 0, f, f_1943_);
		this.aShortArray7852[i_1937_] = method4828(class64, class64.aShortArray646[i_1938_], l + i_1948_, class37.anInt426, class37.anInt425, class37.anInt427, 0, f_1944_, f_1945_);
		this.aShortArray7853[i_1937_] = method4828(class64, class64.aShortArray624[i_1938_], l + i_1949_, class37.anInt426, class37.anInt425, class37.anInt427, 0, f_1946_, f_1947_);
	    }
	    if (class64.aByteArray627 != null)
		this.aByteArray7850[i_1937_] = class64.aByteArray627[i_1938_];
	    if (class64.aShortArray615 != null)
		this.aShortArray7856[i_1937_] = class64.aShortArray615[i_1938_];
	    this.aShortArray7849[i_1937_] = class64.aShortArray629[i_1938_];
	...
	if (class64.anIntArray619 != null && Class38.method459(i, this.anInt7826))
	    this.anIntArrayArray7837 = class64.method749(false);
	if (class64.aClass84Array649 != null && Class38.method465(i, this.anInt7826))
	    this.anIntArrayArray7882 = class64.method759();
	if (class64.anIntArray631 != null && Class38.method463(i, this.anInt7826)) {
	    int i_2020_ = 0;
	...
	if (!this.aBoolean7843)
	    method4831();
	int i_2032_ = i_2029_ + this.aShort7870;
	int i_2033_ = i_2029_ + this.aShort7871;
	int i_2034_ = i_2031_ + this.aShort7872;
	int i_2035_ = i_2031_ + this.aShort7876;
	if (i != 1 && i != 2 && i != 3 && i != 5 || (i_2032_ >= 0 && ((i_2033_ + class_xa.anInt6288 * -1212653763 >> class_xa.anInt6289 * -2137349879) < class_xa.anInt6287 * -506105871) && i_2034_ >= 0 && ((i_2035_ + class_xa.anInt6288 * -1212653763 >> class_xa.anInt6289 * -2137349879) < class_xa.anInt6286 * -1148794921))) {
	    ...
	    if (i == 1) {
		for (int i_2036_ = 0; i_2036_ < this.anInt7833; i_2036_++)
		    this.anIntArray7835[i_2036_] = (this.anIntArray7835[i_2036_] + class_xa.method6340(((this.anIntArray7834[i_2036_]) + i_2029_), ((this.anIntArray7836[i_2036_]) + i_2031_), -2002103279) - i_2030_);
	    } else if (i == 2) {
		int i_2037_ = this.aShort7868;
		if (i_2037_ == 0)
		    return;
		for (int i_2038_ = 0; i_2038_ < this.anInt7833; i_2038_++) {
		    int i_2039_ = ((this.anIntArray7835[i_2038_] << 16) / i_2037_);
		    if (i_2039_ < i_2027_)
			this.anIntArray7835[i_2038_] = (this.anIntArray7835[i_2038_] + (class_xa.method6340((this.anIntArray7834[i_2038_]) + i_2029_, (this.anIntArray7836[i_2038_]) + i_2031_, -1796390951) - i_2030_) * (i_2027_ - i_2039_) / i_2027_);
		}
	    } else if (i == 3) {
		...
		int i_2044_ = (this.aShort7874 - this.aShort7868);
		for (int i_2045_ = 0; i_2045_ < this.anInt7833; i_2045_++)
		    this.anIntArray7835[i_2045_] = (this.anIntArray7835[i_2045_] + (class_xa_2028_.method6340((this.anIntArray7834[i_2045_]) + i_2029_, (this.anIntArray7836[i_2045_]) + i_2031_, -1417639500) - i_2030_) + i_2044_);
	    } else if (i == 5) {
		int i_2046_ = (this.aShort7874 - this.aShort7868);
		for (int i_2047_ = 0; i_2047_ < this.anInt7833; i_2047_++) {
		    int i_2048_ = (this.anIntArray7834[i_2047_] + i_2029_);
		    int i_2049_ = (this.anIntArray7836[i_2047_] + i_2031_);
		    ...
		    this.anIntArray7835[i_2047_] = ((this.anIntArray7835[i_2047_] << 8) / i_2046_ * i_2052_ >> 8) - (i_2030_ - i_2050_);
		}
	    }
	    if (this.aClass32_7831 != null)
		this.aClass32_7831.anInterface1_397 = null;
