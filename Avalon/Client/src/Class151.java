...
public class Class151 implements Interface5 {
	...
	try {
	    Class182 class182 = (Class182) Class182.aClass348_1815.method4184(i);
	    if (class182 != null)
		return class182;
	    byte[] is = Class182.aClass243_1821.getFile(0, i);
    ...
    static final void method1645(Class403 class403, byte i) {
	try {
	    class403.aLongArray5251[((class403.anInt5245 += -682569305) * 1685767703 - 1)] = (class403.aClass298_Sub37_Sub17_5260.aLongArray9677[1883543357 * class403.anInt5259]);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1647(Class403 class403, int i) {
	try {
    ...
    static final void method1649(Class403 class403, int i) {
	try {
