...
public class Class142 {
    ...
    static final void method1569(Class403 class403, int i) {
	try {
	...
	try {
		...
		if (bool_6_)
			...
			if (client.aBooleanArray8684[i_16_]) {
			    int i_17_ = (int) ((Math.random() * (2 * (client.anIntArray8860[i_16_]) + 1)) - (client.anIntArray8860[i_16_]) + ((Math.sin((client.anIntArray8790[i_16_]) * ((client.anIntArray8926[i_16_]) / 100.0))) * (client.anIntArray8925[i_16_])));
			    if (i_16_ == 0)
		    ...
		    client.aClass222_8871.method2062(-(Class367.anInt4000 * -1740717447), -(1449634147 * Class110.anInt6403), -(Class146.anInt1575 * -299812095));
		    ...
		    Class82_Sub7.method889(client.aClass233_8658, true, i_3_ / 2, i_4_ / 2, -2134375937 * client.anInt8940 << 1, -2134375937 * client.anInt8940 << 1, i_3_, i_4_, 1807453020);
		    ...
		    Class82_Sub7.method889(client.aClass233_8658, false, i_3_ / 2 + i, i_4_ / 2 + i_2_, -2134375937 * client.anInt8940 << 1, -2134375937 * client.anInt8940 << 1, i_3_, i_4_, -725589740);
		    Class373.aClass_ra4071.method5182(client.aClass233_8658);
	...
	try {
		...
		if (null != Class65.aClass264_664 && HandshakePacket.aClass505_2420 != null)
		    class505 = HandshakePacket.aClass505_2420;
		else
