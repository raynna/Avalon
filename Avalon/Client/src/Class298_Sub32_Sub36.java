...
public class Class298_Sub32_Sub36 extends Class298_Sub32 {
	...
	if (aClass239_7380.aBoolean2607) {
		...
		if (i_8_ == i_9_ && i_9_ == i_10_) {
		    is_4_[i_7_] = i_8_ * (this.anInt9556 * 2015834201) >> 12;
		    is_5_[i_7_] = (1185665605 * this.anInt9554 * i_9_) >> 12;
		    is_6_[i_7_] = (this.anInt9555 * -1640278703 * i_10_) >> 12;
		} else {
		    is_4_[i_7_] = 2015834201 * this.anInt9556;
		    is_5_[i_7_] = 1185665605 * this.anInt9554;
		    is_6_[i_7_] = (-1640278703 * this.anInt9555);
		}
	    }
	}
	return is;
	...
	try {
		...
		for (int i_19_ = 0; i_19_ < -1474554145 * Class250.anInt2755; i_19_++) {
			...
			is_16_[i_19_] = i_20_ * (this.anInt9556 * 2015834201) >> 12;
			is_17_[i_19_] = (1185665605 * this.anInt9554 * i_21_) >> 12;
			is_18_[i_19_] = (this.anInt9555 * -1640278703 * i_22_) >> 12;
		    } else {
			is_16_[i_19_] = (2015834201 * this.anInt9556);
			is_17_[i_19_] = (1185665605 * this.anInt9554);
			is_18_[i_19_] = (-1640278703 * this.anInt9555);
		    }
		}
	    }
	    return is;
	...
	try {
	    switch (i) {
		case 0:
		    this.anInt9556 = class298_sub53.readUnsignedShort() * -280684567;
		    break;
		case 2:
		    this.anInt9555 = class298_sub53.readUnsignedShort() * -1844112463;
		    break;
		case 1:
		    this.anInt9554 = class298_sub53.readUnsignedShort() * -11308915;
		    break;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	super(1, false);
	this.anInt9554 = 923324416;
	this.anInt9555 = 1362825216;
    }
	...
	if (aClass239_7380.aBoolean2607) {
		...
		if (i_32_ == i_33_ && i_33_ == i_34_) {
		    is_28_[i_31_] = i_32_ * (this.anInt9556 * 2015834201) >> 12;
		    is_29_[i_31_] = (1185665605 * this.anInt9554 * i_33_) >> 12;
		    is_30_[i_31_] = (this.anInt9555 * -1640278703 * i_34_) >> 12;
		} else {
		    is_28_[i_31_] = 2015834201 * this.anInt9556;
		    is_29_[i_31_] = 1185665605 * this.anInt9554;
		    is_30_[i_31_] = (-1640278703 * this.anInt9555);
		}
	    }
	}
	return is;
