...
public class Class91 {
    ...
    static final void method998(Class403 class403, int i) {
	try {
    ...
    static final void method999(Class403 class403, byte i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_0_ & i_1_;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1000(Class403 class403, int i) {
	try {
	...
	try {
	    float f1 = 1104.0F;
	    float f2 = 2874.0F;
	    if (client.aFloat8757 < f1)
		client.aFloat8757 = f1;
	    if (client.aFloat8757 > f2)
		client.aFloat8757 = f2;
