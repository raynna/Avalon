...
public class Class469 {
	...
	this.aClass243_5778 = class243;
	this.aClass243_5776 = class243_0_;
	this.anInterface20_5780 = interface20;
	if (null != this.aClass243_5778)
	    anInt5775 = (this.aClass243_5778.method2316(1, -331738803) * -1970727647);
	if (this.aClass243_5776 != null)
	    anInt5777 = (this.aClass243_5776.method2316(1, 1090973479) * 1286548437);
    }

    String method6044(Class367 class367, int[] is, long l) {
	try {
	    if (this.anInterface20_5780 != null) {
		String string = this.anInterface20_5780.method241(class367, is, l);
		if (string != null)
		    return string;
	    }
	...
	try {
	    Class298_Sub37_Sub14 class298_sub37_sub14 = ((Class298_Sub37_Sub14) this.aClass348_5779.method4184(i));
	    if (null != class298_sub37_sub14)
		return class298_sub37_sub14;
	    byte[] is;
	    if (i >= 32768)
		is = this.aClass243_5776.getFile(1, i & 0x7fff);
	    else
		is = this.aClass243_5778.getFile(1, i);
	...
	try {
		...
		int i_12_ = (1196508279 * Class82_Sub14.anInt6875 - (int) (i_6_ / Class301.aFloat3233));
		int i_13_ = (1882038855 * Class376.anInt4090 + (int) (i_7_ / Class301.aFloat3233));
		int i_14_ = ((int) (i_6_ / Class301.aFloat3233) + Class82_Sub14.anInt6875 * 1196508279);
		int i_15_ = (Class376.anInt4090 * 1882038855 - (int) (i_7_ / Class301.aFloat3233));
		Class402.anInt5232 = ((1196508279 * Class82_Sub14.anInt6875 - (int) (i_6_ / Class301.aFloat3233)) * 1478623195);
		Class261.anInt2825 = ((Class376.anInt4090 * 1882038855 - (int) (i_7_ / Class301.aFloat3233)) * -1415233655);
		Class301_Sub1.anInt7625 = ((int) (2 * i_6_ / Class301.aFloat3233) * -830037779);
		Class413.anInt6590 = ((int) (i_7_ * 2 / Class301.aFloat3233) * 827686411);
		Class301.method3709(i_12_ + Class301.anInt3245, i_13_ + Class301.anInt3238, Class301.anInt3245 + i_14_, i_15_ + Class301.anInt3238, i, i_5_, i_6_ + i, 1 + (i_5_ + i_7_));
		Class301.method3698(class_ra);
		Class453 class453 = Class301.method3702(class_ra);
