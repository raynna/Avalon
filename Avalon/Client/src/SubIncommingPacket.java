...
public class SubIncommingPacket {
	...
	try {
	    ...
	    try {
		class476 = Class86.method962("2", client.gametype.aString5317, false, -1804643872);
    ...
    static void sendSomethingOnIComponent(int interfaceHash, int value, int type, int i_4_, int i_5_) {
	try {
	    Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(4, interfaceHash);
	    class298_sub37_sub12.method3449((byte) 123);
	    class298_sub37_sub12.type = 1274450087 * type;
	    class298_sub37_sub12.value = value * 293101103;
	    class298_sub37_sub12.modelZoom = i_4_ * -80288087;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static void method1925(Class502 class502, int i, int i_6_, Class403 class403, int i_7_) {
	try {
		...
		if ((class298_sub37_sub17.aClass502_9678 == Class502.aClass502_6727) || (Class502.aClass502_6721 == class298_sub37_sub17.aClass502_9678) || (Class502.aClass502_6718 == class298_sub37_sub17.aClass502_9678)) {
		    ...
		    class403.anIntArray5248[0] = (Class165.aClass319_6366.method3894((byte) -93) - i_8_);
		    class403.anIntArray5248[1] = (Class165.aClass319_6366.method3883((byte) -71) - i_9_);
