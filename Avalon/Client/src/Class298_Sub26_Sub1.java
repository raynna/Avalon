...
public class Class298_Sub26_Sub1 extends Class298_Sub26 {
	...
	if (anInt9311 == this.anInt9310)
	    anInt9311 = this.anInt9310 = class270.method2535(anInt9311, -1221225571);
	else {
	    anInt9311 = class270.method2535(anInt9311, 465158744);
	    this.anInt9310 = class270.method2535(this.anInt9310, -220655901);
	    if (anInt9311 == this.anInt9310)
		anInt9311--;
	}
	return this;
