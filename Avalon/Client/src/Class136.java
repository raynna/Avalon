...
public class Class136 implements Interface6 {
	...
	try {
	    return (this.aClass243_6387.method2310(-610589451 * this.aClass158_6386.anInt6361, -457216440));
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1496(Class403 class403, int i) {
	try {
    ...
    static final void method1497(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.aShort8928;
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.aShort8929;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (i >= Class372.anInt4051 * -1424479739 && i_6_ <= Class372.anInt4048 * 1135094847 && i_7_ >= 1155384281 * Class372.anInt4049 && i_8_ <= Class372.anInt4050 * -1062447355) {
		if (1 == i_10_)
    ...
    static final void method1500(Class403 class403, int i) {
	try {
    ...
    static final void method1501(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = ItemDefinitions.method6043(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-1033655497), 200, -564822941);
	}
	catch (RuntimeException runtimeexception) {
