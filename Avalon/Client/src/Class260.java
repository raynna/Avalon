...
public class Class260 {
    ...
    public static Class243 aClass243_2819;
    ...
    static final void method2458(Class403 class403, int i) {
	try {
	    ...
	    Class243.method2317(class105, class119, class403, 1204631441);
	}
    ...
    static final void method2459(Class403 class403, int i) {
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = 512449113 * class343_sub1.anInt7720;
    ...
    static final void method2460(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub11_7558.method5666(-391880689) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2461(IComponentDefinition class105, Class119 class119, Class403 class403, short i) {
	try {
	    class403.anInt5239 -= -1175642067;
	    int i_2_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    short i_3_ = (short) (class403.anIntArray5244[1 + 681479919 * class403.anInt5239]);
	    short i_4_ = (short) (class403.anIntArray5244[2 + 681479919 * class403.anInt5239]);
	    if (i_2_ >= 0 && i_2_ < 5) {
		...
		if (class105.anInt1154 * -1309843523 == -1 && !class119.aBoolean1403)
		    Class85.method958(-440872681 * class105.ihash, i_2_, (byte) 1);
	    }
	}
	catch (RuntimeException runtimeexception) {
