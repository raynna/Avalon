...
public class Class239 {
    ...
    static void method2206(Class403 class403, int i) {
	try {
		...
		if (-1 == i_6_)
		    ...
		    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = Class316.aClass362_3318.method4307(i_6_, 245040087).method4570(i_7_, string, 1005518410);
	    } else {
		int i_8_ = -388931549 * class497.anInt6100;
		if (i_6_ == -1)
		    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = i_8_;
		else
		    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = Class316.aClass362_3318.method4307(i_6_, 245040087).method4568(i_7_, i_8_, (byte) -64);
	    }
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2209(IComponentDefinition class105, Class403 class403, byte i) {
	try {
