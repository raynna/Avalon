...
public class Class365_Sub1_Sub1_Sub6 extends Class365_Sub1_Sub1 implements Interface3 {
	...
	try {
		...
		this.aClass334_9882 = Class472.method6063((int) class217.aFloat2451, (int) class217.aFloat2455, (int) class217.aFloat2454, method4491(class_ra, 0, 720922451), 2111696382);
	...
	try {
		...
		if (null != this.aClass387_9879 && null != class365_sub1_sub5_sub1.aClass387_9893)
		    this.aClass387_9879.method4745((class365_sub1_sub5_sub1.aClass387_9893), i, i_3_, i_4_, bool);
	...
	try {
		...
		return null;
	    Class222 class222 = method4347();
	    Class335 class335 = Class73.method818((this.aBoolean9888), 1956566103);
	    this.aClass387_9879.method4739(class222, aClass302_Sub1Array7726[0], 0);
	    return class335;
	}
	catch (RuntimeException runtimeexception) {
	...
	this.anInt9883 = class432.anInt5365 * 1514496897;
	aByte7724 = (byte) i_7_;
	...
	this.aBoolean9887 = (class_ra.method5082() && class432.aBoolean5433 && !this.aBoolean9886 && Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub7_7581.method5650(3122198) != 0);
	int i_18_ = 2048;
	if (this.aBoolean9889)
	    i_18_ |= 0x10000;
	if (class432.aBoolean5441)
	    i_18_ |= 0x80000;
	Class454 class454 = method4492(class_ra, i_18_, this.aBoolean9887, -1835687018);
	if (null != class454) {
	    this.aClass387_9879 = (Class387) class454.anObject5645;
	    this.aClass_na9881 = (Class_na) class454.anObject5646;
	...
	if (this.aClass387_9879 == null)
	    return null;
	Class222 class222 = method4347();
	Class335 class335 = Class73.method818(this.aBoolean9888, 1628879403);
	this.aClass387_9879.method4739(class222, aClass302_Sub1Array7726[0], 0);
	return class335;
    }
	...
	Class217 class217 = method4337().aClass217_2599;
	if (this.aClass334_9882 == null)
	    this.aClass334_9882 = Class472.method6063((int) class217.aFloat2451, (int) class217.aFloat2455, (int) class217.aFloat2454, method4491(class_ra, 0, 489982768), 2048305004);
	return this.aClass334_9882;
    }
	...
	Class217 class217 = method4337().aClass217_2599;
	if (this.aClass334_9882 == null)
	    this.aClass334_9882 = Class472.method6063((int) class217.aFloat2451, (int) class217.aFloat2455, (int) class217.aFloat2454, method4491(class_ra, 0, 2128967957), 2011596409);
	return this.aClass334_9882;
    }

    Class454 method4492(GraphicsToolkit class_ra, int i, boolean bool, int i_19_) {
	try {
	    ObjectDefinitions class432 = (this.aClass433_9884.getObjectDefinitions(this.anInt9883 * 614847827));
	    Class_xa class_xa;
	    ...
	    Class217 class217 = method4337().aClass217_2599;
	    return (class432.method5785(class_ra, i, ((this.aByte9880 != GameObjectType.T11.type * -1976050083) ? (int) this.aByte9880 : GameObjectType.T10.type * -1976050083), ((GameObjectType.T11.type * -1976050083 == this.aByte9880) ? (int) (this.aByte9885 + 4) : this.aByte9885), class_xa, class_xa_20_, (int) class217.aFloat2451, (int) class217.aFloat2455, (int) class217.aFloat2454, bool, null, -920698887));
	}
	catch (RuntimeException runtimeexception) {
	...
	if (class365_sub1 instanceof Class365_Sub1_Sub5_Sub1) {
	    Class365_Sub1_Sub5_Sub1 class365_sub1_sub5_sub1 = (Class365_Sub1_Sub5_Sub1) class365_sub1;
	    if (null != this.aClass387_9879 && null != (class365_sub1_sub5_sub1.aClass387_9893))
		this.aClass387_9879.method4745((class365_sub1_sub5_sub1.aClass387_9893), i, i_24_, i_25_, bool);
	} else if (class365_sub1 instanceof Class365_Sub1_Sub1_Sub6) {
	    Class365_Sub1_Sub1_Sub6 class365_sub1_sub1_sub6_26_ = (Class365_Sub1_Sub1_Sub6) class365_sub1;
	    if (this.aClass387_9879 != null && (class365_sub1_sub1_sub6_26_.aClass387_9879) != null)
		this.aClass387_9879.method4745((class365_sub1_sub1_sub6_26_.aClass387_9879), i, i_24_, i_25_, bool);
	}
    }
	...
	if (class365_sub1 instanceof Class365_Sub1_Sub5_Sub1) {
	    Class365_Sub1_Sub5_Sub1 class365_sub1_sub5_sub1 = (Class365_Sub1_Sub5_Sub1) class365_sub1;
	    if (null != this.aClass387_9879 && null != (class365_sub1_sub5_sub1.aClass387_9893))
		this.aClass387_9879.method4745((class365_sub1_sub5_sub1.aClass387_9893), i, i_27_, i_28_, bool);
	} else if (class365_sub1 instanceof Class365_Sub1_Sub1_Sub6) {
	    Class365_Sub1_Sub1_Sub6 class365_sub1_sub1_sub6_29_ = (Class365_Sub1_Sub1_Sub6) class365_sub1;
	    if (this.aClass387_9879 != null && (class365_sub1_sub1_sub6_29_.aClass387_9879) != null)
		this.aClass387_9879.method4745((class365_sub1_sub1_sub6_29_.aClass387_9879), i, i_27_, i_28_, bool);
	}
    }
