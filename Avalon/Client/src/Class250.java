...
public class Class250 {
	...
	try {
	    Class298_Sub37_Sub11 class298_sub37_sub11 = (Class298_Sub37_Sub11) aClass354_2764.method4253(i);
		...
		aClass354_2764.method4255(class298_sub37_sub11, i);
	    }
	...
	try {
		...
		for (int i_6_ = 0; i_6_ < 256; i_6_++) {
		    double d = i_6_ / 255.0 * 6.283185307179586;
    ...
    static final void method2398(Class403 class403, int i) {
	try {
    ...
    static final void method2399(Class403 class403, byte i) {
	try {
	    class403.anInt5241 -= 1938723502;
	    String string = (String) (class403.anObjectArray5240[-203050393 * class403.anInt5241]);
	    String string_11_ = ((String) (class403.anObjectArray5240[-203050393 * class403.anInt5241 + 1]));
	    if (null != (Class287.myPlayer.aClass366_10209) && (Class287.myPlayer.aClass366_10209.aBoolean3977))
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = string_11_;
	    else
