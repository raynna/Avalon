...
public class Class227 {
	...
	this.aClass470_2549 = class470;
	this.aClass470_2543 = class470_4_;
	this.anInt2551 = i_5_ * -931220425;
	this.anInt2552 = i_6_ * 774291301;
	this.aBoolean2553 = bool;
    ...
    static final void method2110(Class403 class403, byte i) {
	try {
    ...
    static final void method2111(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_8_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    int i_9_ = (class403.anIntArray5244[1 + 681479919 * class403.anInt5239]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class298_Sub1.method2845(i_8_, i_9_, true, false, 1482071907);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2113(Class403 class403, int i) {
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = client.aStringArray8947[i_15_];
	    else
