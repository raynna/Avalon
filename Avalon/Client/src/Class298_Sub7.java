...
public class Class298_Sub7 extends Class298 {
	...
	try {
	    return Class301.aClass298_Sub37_Sub13_3218;
	}
    ...
    static final void method2865(Class403 class403, int i) {
	try {
	    IComponentDefinition class105 = Class50.getIComponentDefinitions((class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]), (byte) 45);
    ...
    static final void method2866(Class403 class403, byte i) {
	try {
