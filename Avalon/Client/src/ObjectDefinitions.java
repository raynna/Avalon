...
public class ObjectDefinitions {
	...
	try {
		...
		if (i_5_ != -1)
		    this.anIntArray5378 = new int[] { i_5_ };
	    } else if (i == 27)
		clip_type = 268680417;
	    else if (28 == i)
		anInt5391 = ((stream.readUnsignedByte() << 2) * 803995289);
	    else if (i == 29)
		this.anInt5392 = stream.readByte(-12558881) * -62240291;
	    else if (39 == i)
		this.anInt5393 = stream.readByte(-12558881) * -1530589831;
	    else if (i >= 30 && i < 35)
		...
		for (int i_7_ = 0; i_7_ < i_6_; i_7_++) {
		    this.aShortArray5369[i_7_] = (short) stream.readUnsignedShort();
		...
		for (int i_9_ = 0; i_9_ < i_8_; i_9_++) {
		    this.aShortArray5372[i_9_] = (short) stream.readUnsignedShort();
		...
		for (int i_11_ = 0; i_11_ < i_10_; i_11_++)
		    this.aByteArray5371[i_11_] = stream.readByte(-12558881);
	    } else if (44 == i) {
		...
		this.anInt5406 = stream.readUnsignedShort() * 929519655;
	    else if (66 == i)
		this.anInt5407 = stream.readUnsignedShort() * -1076239419;
	    else if (i == 67)
		this.anInt5414 = stream.readUnsignedShort() * 1192395179;
	    else if (i == 69) {
		test_cflag = stream.readUnsignedByte();
	    } else if (i == 70)
		this.anInt5379 = (stream.readShort(1954619354) << 2) * 804752437;
	    else if (i == 71)
		this.anInt5396 = ((stream.readShort(1981333343) << 2) * -830213317);
	    else if (i == 72)
		this.anInt5411 = ((stream.readShort(2079097901) << 2) * 1957563615);
	    else if (i == 73)
		aBoolean5410 = true;
	    else if (i == 74) {
		clip_unknown = true;
		...
		this.anInt5420 = stream.readUnsignedShort() * -1228374415;
		if (65535 == 1064010385 * this.anInt5420)
		    this.anInt5420 = 1228374415;
		this.anInt5421 = stream.readUnsignedShort() * -2115564225;
		...
		this.anInt5384 = stream.readUnsignedByte() * -1868938496;
	    } else if (i == 82)
		aBoolean5432 = true;
	    else if (88 == i)
		aBoolean5433 = false;
		...
		this.anInt5384 = stream.readUnsignedShort() * -242181565;
	    } else if (i == 94)
		this.aByte5363 = (byte) 4;
	    else if (95 == i) {
		this.aByte5363 = (byte) 5;
		this.anInt5384 = stream.readShort(2013201622) * -242181565;
	    } else if (97 == i)
		aBoolean5401 = true;
	    else if (98 == i)
		aBoolean5381 = true;
		...
		int i_18_ = 0;
		this.anIntArray5378 = new int[i_17_];
		this.anIntArray5390 = new int[i_17_];
		for (int i_19_ = 0; i_19_ < i_17_; i_19_++) {
		    this.anIntArray5378[i_19_] = stream.readBigSmart(1235052657);
		    i_18_ += this.anIntArray5390[i_19_] = stream.readUnsignedByte();
		}
		...
		if (!this.aClass433_5403.aBoolean5445)
		...
		this.aByte5363 = (byte) 3;
		this.anInt5384 = stream.readInt((byte) 30) * -242181565;
	    } else if (i == 163) {
		this.aByte5417 = stream.readByte(-12558881);
		this.aByte5375 = stream.readByte(-12558881);
		this.aByte5415 = stream.readByte(-12558881);
		this.aByte5377 = stream.readByte(-12558881);
	    } else if (i == 164)
		this.anInt5412 = stream.readShort(2119621102) * -1121469985;
	    else if (165 == i)
		this.anInt5413 = stream.readShort(1762145274) * 1097094883;
	    else if (166 == i)
		this.anInt5419 = stream.readShort(1892618723) * -870210675;
	    else if (i == 167)
		...
		if (this.aClass437_5435 == null) {
		    ...
		    this.aClass437_5435 = new HashTable(i_24_);
		}
	...
	try {
		...
		return true;
	    boolean bool = true;
	    synchronized (this.aClass433_5403.aClass243_5447) {
		for (int i_29_ = 0; i_29_ < aByteArray5430.length; i_29_++) {
			...
			for (int i_30_ = 0; i_30_ < modelIds[i_29_].length; i_30_++) {
			    if (!this.aClass433_5403.aClass243_5447.method2290(modelIds[i_29_][i_30_], 0, -1404450418))
				bool = false;
			}
		    }
		}
	...
	try {
		...
		for (int i_31_ = 0; i_31_ < modelIds.length; i_31_++) {
			...
			bool &= (this.aClass433_5403.aClass243_5447.method2290(modelIds[i_31_][i_32_], 0, -1427920512));
		}
	    }
	    return bool;
	}
	...
	try {
	    if (this.anIntArray5378 != null && -1 != i) {
		for (int i_34_ = 0; i_34_ < this.anIntArray5378.length; i_34_++) {
		    if (this.anIntArray5378[i_34_] == i)
			return true;
		}
	    }
	    return false;
	...
	try {
		...
		i_35_ = GameObjectType.T4.type * -1976050083;
	    long l = i_36_ + ((i_35_ << 3) + (1181652947 * anInt5365 << 10));
	    int i_42_ = i;
	    ...
	    if (GameObjectType.T10.type * -1976050083 == i_35_ && i_36_ > 3)
		i |= 0x5;
	    Class387 class387;
	    synchronized (this.aClass433_5403.aClass348_5451) {
		class387 = (Class387) this.aClass433_5403.aClass348_5451.method4184(l);
	    }
	    ...
	    if (i_35_ == -1976050083 * GameObjectType.T10.type && i_36_ > 3) {
		if (!bool) {
	...
	try {
	    ...
	    int i_48_ = i;
	    boolean bool = (aBoolean5404 || (i_43_ == GameObjectType.T2.type * -1976050083 && i_44_ > 3));
	    if (bool)
		i |= 0x10;
	    if (i_44_ == 0) {
		...
		if (i_51_ > 0) {
			...
			class387 = ((Class387) this.aClass433_5403.aClass348_5450.method4184(l));
		    }
		    if (null != class387) {
			if (i_46_ != class387.c())
			    i |= 0x1000;
			...
			Model class64 = null;
			synchronized (this.aClass433_5403.aClass64Array5443) {
			    for (int i_54_ = 0; i_54_ < i_51_; i_54_++) {
				synchronized ((this.aClass433_5403).aClass243_5447) {
				    class64 = (Model.method751(((this.aClass433_5403).aClass243_5447), is[i_54_], 0));
				}
				if (null == class64) {
				...
				if (class64.anInt630 < 13)
				    class64.method755(2);
				if (i_51_ > 1)
				    this.aClass433_5403.aClass64Array5443[i_54_] = class64;
			    }
			    if (i_51_ > 1)
				class64 = new Model(((this.aClass433_5403).aClass64Array5443), i_51_);
			}
	    ...
	    if (bool)
		class387_56_.wa();
	    if (i_43_ == GameObjectType.T4.type * -1976050083 && i_44_ > 3) {
		class387_56_.S(2048);
	...
	try {
		...
		return i_59_;
	    Class298_Sub35 class298_sub35 = ((Class298_Sub35) this.aClass437_5435.method5812(i));
	...
	try {
		...
		i_61_ = interface23.method250((this.anInt5420 * 1064010385), (byte) 36);
	    else if (-1128963393 * this.anInt5421 != -1)
		i_61_ = interface23.method252((this.anInt5421 * -1128963393), (byte) 99);
	    if (i_61_ < 0 || i_61_ >= anIntArray5366.length - 1 || -1 == anIntArray5366[i_61_]) {
		int i_62_ = anIntArray5366[anIntArray5366.length - 1];
		if (-1 != i_62_)
		    return this.aClass433_5403.getObjectDefinitions(i_62_);
		return null;
	    }
	    return this.aClass433_5403.getObjectDefinitions(anIntArray5366[i_61_]);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		anInt5382 = 0;
		if (null != aByteArray5430 && 1 == aByteArray5430.length && (aByteArray5430[0] == GameObjectType.T10.type * -1976050083))
		    anInt5382 = 455422743;
		...
		anInt5409 = 1763780945 * (clip_type * -2144543407 != 0 ? 1 : 0);
	...
	try {
	    return this.anIntArray5378 != null;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return (this.anIntArray5378 != null && this.anIntArray5378.length > 1);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (null != this.anIntArray5378) {
		if (this.anIntArray5378.length > 1) {
		    int i_64_ = (int) (Math.random() * 65535.0);
		    for (int i_65_ = 0; i_65_ < this.anIntArray5378.length; i_65_++) {
			if (i_64_ <= this.anIntArray5390[i_65_])
			    return this.anIntArray5378[i_65_];
			i_64_ -= this.anIntArray5390[i_65_];
		    }
		} else
		    return this.anIntArray5378[0];
	    }
	    return -1;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (anIntArray5366[i_67_] != -1) {
		    ObjectDefinitions class432_68_ = this.aClass433_5403.getObjectDefinitions(anIntArray5366[i_67_]);
	...
	try {
		...
		i_69_ = GameObjectType.T4.type * -1976050083;
	    long l = (1181652947 * anInt5365 << 10) + (i_69_ << 3) + i_70_;
	    l |= class_ra.anInt5298 * 580915349 << 29;
	    if (class435 != null)
		...
		class454 = (Class454) this.aClass433_5403.aClass348_5452.method4184(l);
	    }
		...
		if (class387 == null || class_ra.method5017(class387.m(), i_76_) != 0) {
		    ...
		    int i_77_ = i_76_;
		    if ((i_69_ == GameObjectType.T10.type * -1976050083) && i_70_ > 3)
			i_77_ |= 0x5;
		...
		catch (Throwable e) { // temp fix
		    // e.printStackTrace();
		}
		if (bool_79_)
		    class387.ia(this.anInt5412 * 945504799, 52797131 * this.anInt5413, this.anInt5419 * 1782732613);
		class387.KA(i);
	    } else
		class387 = class387.method4755((byte) 0, i, true);
	    this.aClass433_5403.aClass454_5456.anObject5645 = class387;
	    this.aClass433_5403.aClass454_5456.anObject5646 = class_na;
	    return (this.aClass433_5403.aClass454_5456);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return (c >= '0' && c <= '9' || c >= 'A' && c <= 'Ö' || c >= 'a' && c <= 'ö');
	}
	catch (RuntimeException runtimeexception) {
	    throw Class346.method4175(runtimeexception, new StringBuilder().append("rw.y(").append(')').toString());
	}
