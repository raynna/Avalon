...
public class Class82_Sub13 extends Class82 {
	...
	try {
	    client.anInt8728 = 938117879 * client.ticketCycle;
	    client.anInt8737 = (1303928015 * client.ticketCycle + 1252628863 * this.anInt6868);
	    ...
	    client.anInt8681 = 563175129 * (392492523 * this.anInt6869 >>> 24);
	    client.anInt8731 = (-1719011785 * (this.anInt6869 * 392492523 >>> 16 & 0xff));
	    client.anInt8732 = (-1294785203 * (392492523 * this.anInt6869 >>> 8 & 0xff));
	    client.anInt8720 = -1656733051 * (392492523 * this.anInt6869 & 0xff);
	}
	...
	this.anInt6868 = class298_sub53.readUnsignedShort() * -477707085;
	this.anInt6869 = class298_sub53.readInt((byte) -19) * -1164408125;
    }
	...
	try {
		...
		for (;;) {
			...
			if (i_13_ > 0 && i_14_ > 0 && i_13_ < i_1_ - 1 && i_14_ < i_2_ - 1) {
			    ...
			    if ((-1976050083 * GameObjectType.T22.type) == i_12_ && Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub2_7547.method5629(-1915667162) == 0 && 0 == 1532834983 * class432.anInt5382 && -2144543407 * class432.clip_type != 1 && !class432.aBoolean5410) {
				if (i_3_ == 3) {
				    /* empty */
				}
			    } else {
