...
public class Class153_Sub2 extends Class153 {
    ...
    @Override
    public void b() {
	if (this.aLong8623 != 0L) {
	    IUnknown.Release(this.aLong8623);
	    this.aLong8623 = 0L;
	}
	this.aClass_ra_Sub3_Sub2_8624.method5293(this);
    }

    void method1658() {
	if (this.aLong8623 != 0L) {
	    this.aClass_ra_Sub3_Sub2_8624.method5552(this.aLong8623);
	    this.aLong8623 = 0L;
	}
    }
	...
	super(class181s);
	this.aClass_ra_Sub3_Sub2_8624 = class_ra_sub3_sub2;
	byte i = 0;
	ByteBuffer bytebuffer = this.aClass_ra_Sub3_Sub2_8624.aByteBuffer8216;
	bytebuffer.clear();
	...
	this.aLong8623 = (IDirect3DDevice.CreateVertexDeclaration(this.aClass_ra_Sub3_Sub2_8624.aLong9847, this.aClass_ra_Sub3_Sub2_8624.aLong8217));
	this.aClass_ra_Sub3_Sub2_8624.method5323(this);
    }
}
