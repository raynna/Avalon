...
public class Class108 {
    ...
    static final void method1147(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8640 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1148(Class403 class403, int i) {
	try {
    ...
    static String AmountValues(int i, Class429 class429, int i_5_) {
	try {
	    if (i < 100000)
    ...
    static final void method1151(Class403 class403, int i) {
	try {
	...
	try {
	    ...
	    class298_sub37_sub12.type = 1274450087 * i_6_;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class82_Sub22.method940((Class372.anIntArrayArray4047[i_8_]), i - i_9_, i_9_ + i, i_11_, -2115360638);
	    while (i_14_ > 0) {
		if (i_20_ < 0) {
		    while (i_20_ < 0) {
			i_20_ += i_24_;
		...
		int i_30_ = i_13_ + i;
		int i_31_ = i - i_13_;
		Class82_Sub22.method940((Class372.anIntArrayArray4047[i_28_]), i_31_, i_30_, i_11_, 756505397);
		Class82_Sub22.method940((Class372.anIntArrayArray4047[i_29_]), i_31_, i_30_, i_11_, 931363895);
	    }
	}
	catch (RuntimeException runtimeexception) {
