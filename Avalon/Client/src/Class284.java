...
public class Class284 {
	...
	try {
		...
		try {
		    ...
		    for (/**/; (l > (6353619706144323107L * this.aLong3051 + 5000L)); l = Class122.method1319((byte) 1)) {
			method2681(256, -518493991);
			this.aLong3051 += (-2662467539374708341L * (256000 / (anInt3059 * 1164070869)));
		    }
		}
	...
	if (null != this.aClass298_Sub19_3054 && this.anInt3072 * -577697835 <= 0) {
	    ...
	    Class62.method731(this.aClass298_Sub19_3054, -1934060670);
	    method2691(this.aClass298_Sub19_3054, this.aClass298_Sub19_3054.method2950(), (byte) -73);
	    int i_4_ = 0;
	    int i_5_ = 255;
	    int i_6_ = 7;
	...
	this.aLong3051 = Class122.method1319((byte) 1) * -2662467539374708341L;
    }
	...
	try {
		...
		method2686(331463442);
		this.aLong3060 = ((Class122.method1319((byte) 1) + 2000L) * -3392636722701155847L);
	    }
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2693(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1156 * -2093041337;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2694(IComponentDefinition class105, Class403 class403, int i) {
	try {
	    int i_23_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    int i_24_ = ((class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) - 1);
	    if (class105.anInt1184 * 1548853569 != 6 && 2 != class105.anInt1184 * 1548853569)
		throw new RuntimeException("");
	    NPCDefinitions class503 = Class15.aClass507_224.method6269(class105.anInt1151 * 572201537, 2035169508);
    ...
    static final void method2695(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub6_7551.method5647(207850013) == 1 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2696(IComponentDefinition class105, Class119 class119, Class403 class403, short i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_25_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    int i_26_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]);
    ...
    static final void method2697(Class403 class403, int i) {
	try {
	    int i_27_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = ObjectDefinitions.method5788((char) i_27_, (short) 160) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
