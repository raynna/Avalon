...
public class Class365_Sub1_Sub3_Sub2 extends Class365_Sub1_Sub3 implements Interface3 {
	...
	try {
	    ...
	    class222.method2064(aShort9802, 0.0F, aShort9803);
	    Class335 class335 = Class73.method818((this.aBoolean9930), 1295089573);
	    this.aClass387_9925.method4739(class222, aClass302_Sub1Array7726[0], 0);
	    return class335;
	}
	catch (RuntimeException runtimeexception) {
	...
	if (this.aClass334_9922 == null)
	    this.aClass334_9922 = Class472.method6063((int) class217.aFloat2451, (int) class217.aFloat2455, (int) class217.aFloat2454, method4510(class_ra, 0, 2120690814), 2092013456);
	...
	this.anInt9926 = class432.anInt5365 * 1469074669;
	...
	this.aBoolean9931 = (class_ra.method5082() && class432.aBoolean5433 && !this.aBoolean9929 && Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub7_7581.method5650(-208809184) != 0);
	int i_11_ = 2048;
	if (class432.aBoolean5441)
	    i_11_ |= 0x80000;
	Class454 class454 = method4511(class_ra, i_11_, this.aBoolean9931, -772904584);
	if (null != class454) {
	    this.aClass387_9925 = (Class387) class454.anObject5645;
	    this.aClass_na9924 = (Class_na) class454.anObject5646;
	    if (class432.aBoolean5441) {
	...
	try {
	    Class217 class217 = method4337().aClass217_2599;
	    if (this.aClass334_9922 == null)
		this.aClass334_9922 = Class472.method6063((int) class217.aFloat2451, (int) class217.aFloat2455, (int) class217.aFloat2454, method4510(class_ra, 0, 1964135899), 2090651504);
	    return this.aClass334_9922;
	}
	catch (RuntimeException runtimeexception) {
	...
	Class217 class217 = method4337().aClass217_2599;
	if (this.aClass334_9922 == null)
	    this.aClass334_9922 = Class472.method6063((int) class217.aFloat2451, (int) class217.aFloat2455, (int) class217.aFloat2454, method4510(class_ra, 0, 1878583731), 1989490846);
	return this.aClass334_9922;
    }
	...
	class222.method2070(method4347());
	class222.method2064(aShort9802, 0.0F, aShort9803);
	Class335 class335 = Class73.method818(this.aBoolean9930, 1438144079);
	this.aClass387_9925.method4739(class222, aClass302_Sub1Array7726[0], 0);
	return class335;
    }
	...
	try {
	    ObjectDefinitions class432 = (this.aClass433_9923.getObjectDefinitions(2016845759 * this.anInt9926));
	    Class_xa class_xa;
	    ...
	    Class217 class217 = method4337().aClass217_2599;
	    return (class432.method5785(class_ra, i, this.aByte9927, this.aByte9928, class_xa, class_xa_16_, (int) class217.aFloat2451, (int) class217.aFloat2455, (int) class217.aFloat2454, bool, null, -911505460));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		Class82_Sub22.method940((Class372.anIntArrayArray4047[i_30_]), i, i_22_, i_25_, 1081395615);
	    for (int i_31_ = i_24_; i_31_ > i_29_; i_31_--)
		Class82_Sub22.method940((Class372.anIntArrayArray4047[i_31_]), i, i_22_, i_25_, -1329971917);
	    int i_32_ = i + i_26_;
