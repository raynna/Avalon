...
public class Class128 implements Interface5 {
    ...
    static final void method1435(boolean bool, Class403 class403, int i) {
	try {
    ...
    static final void method1436(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
	    class105.aBoolean1183 = (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) == 1;
	    Tradution.method6054(class105, 100999784);
	    if (-1 == class105.anInt1154 * -1309843523 && !class119.aBoolean1403)
		Class298_Sub52.method3582(class105.ihash * -440872681, -285766228);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1438(Class403 class403, int i) {
	try {
	    int i_8_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    int i_9_ = client.GRAND_EXCHANGE_SLOTS[i_8_].method2400(-574288948);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_9_ == 2 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
