...
public class Class21 {
    ...
    public static void method364(Class243 class243, int i, int i_0_, int i_1_, boolean bool, Class298_Sub19_Sub1 class298_sub19_sub1, int i_2_) {
	try {
    ...
    static final void method365(IComponentDefinition class105, Class119 class119, boolean bool, int i, Class403 class403, int i_3_) {
	try {
		...
		Class298_Sub50.method3567(-440872681 * class105.ihash, 1388671560);
		Class509.method6286(-440872681 * class105.ihash, 106150101);
		Class70.method808(class105.ihash * -440872681, 2057190103);
	    }
	    if (-1 == i_4_) {
		...
		class105.anInt1284 = class468.modelSize * -1056736627;
    ...
    static final void method366(Class403 class403, int i) {
	try {
    ...
    static final void method367(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_7_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    int i_8_ = (class403.anIntArray5244[1 + 681479919 * class403.anInt5239]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (GraphicsToolkit.aClass256_5315.method2441(i_7_, -1634888229).aCharArray9595[i_8_]);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method368(Class403 class403, int i) {
	try {
