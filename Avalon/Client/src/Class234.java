...
public class Class234 {
    ...
    static final void method2176(Class403 class403, int i) {
	try {
    ...
    static final void method2177(Class403 class403, int i) {
	try {
	    int i_11_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.GRAND_EXCHANGE_SLOTS[i_11_].anInt2768 * 535421071;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2178(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_12_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    int i_13_ = (class403.anIntArray5244[1 + 681479919 * class403.anInt5239]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_12_ % i_13_;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2179(Class403 class403, short i) {
	try {
	    Class74.method830((class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]), -1, -1, false, 752651181);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2180(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub29_7553.method5726(-2145285486);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		class298_sub53_sub2.writeInt(-1886044647 * (class298_sub47.anInt7542), -169937628);
	...
	try {
		...
		PathStrategy.method4093((client.aClass283_8716.method2675(-1611682495).aClass326ArrayArrayArray3518), 234916861);
		if ((client.aClass283_8716.method2675(-1611682495).aClass326ArrayArrayArray3520) != null)
		    PathStrategy.method4093((client.aClass283_8716.method2675(-1611682495).aClass326ArrayArrayArray3520), -1747837187);
    ...
    static final void method2184(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
		...
		Class413.method5583(-440872681 * class105.ihash, (short) 945);
	}
	catch (RuntimeException runtimeexception) {
