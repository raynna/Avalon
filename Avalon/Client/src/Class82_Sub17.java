...
public class Class82_Sub17 extends Class82 {
	...
	this.anInt6889 = class298_sub53.readUnsignedShort() * 1115286323;
	this.anInt6888 = class298_sub53.readUnsignedShort() * -1394180813;
	this.anInt6887 = class298_sub53.readUnsignedByte() * 1303807283;
    }
    ...
    static final void method919(Class403 class403, int i) {
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub7_7581, (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]), -2102625264);
    ...
    static final void method921(Class403 class403, byte i) {
	try {
	    class403.anInt5239 -= -1175642067;
	    client.anInt8837 = 1583527743 * (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    Class110.aClass459_6404 = Class275.method2571((class403.anIntArray5244[(class403.anInt5239 * 681479919) + 1]), 2087599862);
	    if (null == Class110.aClass459_6404)
		Class110.aClass459_6404 = Class459.aClass459_5671;
	    client.anInt8913 = (-1777248765 * (class403.anIntArray5244[2 + class403.anInt5239 * 681479919]));
	    ...
	    class298_sub36.out.writeByte(-1168328513 * client.anInt8837);
	    class298_sub36.out.writeByte(1790024195 * Class110.aClass459_6404.anInt5673);
	    class298_sub36.out.writeByte(client.anInt8913 * -1710848853);
