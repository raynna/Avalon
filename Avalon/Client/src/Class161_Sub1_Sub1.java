...
public class Class161_Sub1_Sub1 extends Class161_Sub1 {
    ...
    public Class233 aClass233_9121;
    Class159 aClass159_9122;
    Class298_Sub31_Sub1 aClass298_Sub31_Sub1_9123;
    public Class233 aClass233_9124 = new Class233();
	...
	try {
	    float f = -5.0E-4F * (1 + (i & 0x3));
	    float f_2_ = 5.0E-4F * ((i >> 3 & 0x3) + 1);
	    ...
	    this.aFloatArray9129[3] = f * aClass_ra_Sub3_1648.anInt8342 % 1.0F;
	    if (!this.aClass159_9122.aBoolean1621) {
		int i_4_ = (int) (aClass_ra_Sub3_1648.anInt8342 * f_2_ * 16.0F);
		aClass_ra_Sub3_1648.method5358(this.aClass159_9122.anInterface9_Impl2Array1624[i_4_ % 16]);
	    } else
		this.aFloat9131 = (float) ((double) f_2_ * (double) aClass_ra_Sub3_1648.anInt8342 % 1.0);
	}
	...
	this.aClass298_Sub31_Sub1_9125 = aClass123_7033.method1360("WorldMatrix", -867744099);
	this.aClass298_Sub31_Sub1_9123 = aClass123_7033.method1360("WVPMatrix", -250672432);
	this.aClass298_Sub31_Sub1_9127 = aClass123_7033.method1360("UGenerationPlane", -1602523427);
	this.aClass298_Sub31_Sub1_9126 = aClass123_7033.method1360("VGenerationPlane", 1186138394);
	this.aClass298_Sub31_Sub1_9119 = aClass123_7033.method1360("Time", -2093315319);
	this.aClass298_Sub31_Sub1_9120 = aClass123_7033.method1360("billowSampler3D", -1560961563);
	if (this.aClass159_9122.aBoolean1621) {
	    this.aClass110_9130 = aClass123_7033.method1327("Waterfall3D", (byte) 0);
	    aClass123_7033.method1331(this.aClass110_9130);
	} else {
	    this.aClass110_9118 = aClass123_7033.method1327("Waterfall2D", (byte) -112);
	    aClass123_7033.method1331(this.aClass110_9118);
	}
	return true;
    }
	...
	try {
	    ...
	    if (this.aClass159_9122.aBoolean1621)
		aClass123_7033.method1341((this.aClass298_Sub31_Sub1_9120), 0, (this.aClass159_9122.anInterface9_Impl3_1625), -1892543284);
	    aClass123_7033.method1368((this.aClass298_Sub31_Sub1_9125), aClass233_9121, 600012267);
	    aClass123_7033.method1368((this.aClass298_Sub31_Sub1_9123), aClass233_9124, 600012267);
	    aClass123_7033.method1339(this.aClass298_Sub31_Sub1_9127, new Class232(this.aFloatArray9128[0], this.aFloatArray9128[1], this.aFloatArray9128[2], this.aFloatArray9128[3]), 1385384483);
	    aClass123_7033.method1339(this.aClass298_Sub31_Sub1_9126, new Class232(this.aFloatArray9129[0], this.aFloatArray9129[1], this.aFloatArray9129[2], this.aFloatArray9129[3]), 560835049);
	    aClass123_7033.method1339((this.aClass298_Sub31_Sub1_9119), new Class232((this.aFloat9131), 0.0F, 0.0F, 0.0F), -247168453);
	...
	try {
	    this.aClass298_Sub31_Sub1_9125 = aClass123_7033.method1360("WorldMatrix", -2088418999);
	    this.aClass298_Sub31_Sub1_9123 = aClass123_7033.method1360("WVPMatrix", -363138804);
	    this.aClass298_Sub31_Sub1_9127 = aClass123_7033.method1360("UGenerationPlane", 1661649711);
	    this.aClass298_Sub31_Sub1_9126 = aClass123_7033.method1360("VGenerationPlane", 2031421483);
	    this.aClass298_Sub31_Sub1_9119 = aClass123_7033.method1360("Time", 293420542);
	    this.aClass298_Sub31_Sub1_9120 = aClass123_7033.method1360("billowSampler3D", 2054271289);
	    if (this.aClass159_9122.aBoolean1621) {
		this.aClass110_9130 = aClass123_7033.method1327("Waterfall3D", (byte) -79);
		aClass123_7033.method1331(this.aClass110_9130);
	    } else {
		this.aClass110_9118 = aClass123_7033.method1327("Waterfall2D", (byte) -52);
		aClass123_7033.method1331(this.aClass110_9118);
	    }
	    return true;
	}
