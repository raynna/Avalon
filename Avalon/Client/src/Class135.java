...
public class Class135 implements Interface6 {
	...
	return (this.aClass243_6381.method2310(791455531 * this.aClass165_6382.anInt6365, -457216440));
    }

    Class135(Class243 class243, Class165 class165) {
    ...
    static final void method1490(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
	    class105.anInt1217 = (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) * -1455284437;
    ...
    static final void method1491(IComponentDefinition class105, Class403 class403, int i) {
	try {
	    int i_15_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    int i_16_ = ((class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) - 1);
    ...
    static final void method1492(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (null != (Class287.myPlayer.aClass366_10209) && (Class287.myPlayer.aClass366_10209.aBoolean3977)) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    int i_20_ = 0;
	    if (-412225079 * class365_sub1_sub1_sub2.anInt10095 > client.ticketCycle * 443738891)
		Class124.method1389(class365_sub1_sub1_sub2, -455530754);
	    else if (class365_sub1_sub1_sub2.anInt10103 * 1450943713 >= client.ticketCycle * 443738891)
		...
		i_20_ = 0;
		class365_sub1_sub1_sub2.method4341(class365_sub1_sub1_sub2.scenePositionXQueue[0] * 512 + (class365_sub1_sub1_sub2.getSize() * 256), class217.aFloat2455, 512 * class365_sub1_sub1_sub2.scenePositionYQueue[0] + (class365_sub1_sub1_sub2.getSize() * 256));
