...
public class Class214 implements Runnable {
    ...
    static final void method1988(Class403 class403, byte i) {
	try {
    ...
    static final void method1989(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
	    class105.anInt1272 = (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) * -1122372539;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1990(Class403 class403, int i) {
	try {
	    Class390 class390 = (class403.aBoolean5261 ? class403.aClass390_5247 : class403.aClass390_5246);
	    IComponentDefinition class105 = class390.aClass105_4168;
    ...
    static final void method1991(Class403 class403, int i) {
	try {
    ...
    static final void method1992(Class403 class403, int i) {
	try {
	    int i_0_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = (class403.myClanChannel.members[i_0_].aString1681);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method1994(Class403 class403, int i) {
	try {
	    String string = null;
