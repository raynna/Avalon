...
public class Class114 {
	...
	try {
	    ...
	    this.aClass100_1375 = Class433.method5799(-1585817819)[i_0_];
	    if (this.aClass100_1375 == Class100.aClass100_1076) {
		int i_1_ = class101.method1080(656081273);
		this.aClass100_1376 = Class433.method5799(-12226797)[i_1_];
		this.anInt1374 = class101.method1080(1114947725) * 811445531;
	    }
	    this.aString1377 = class101.method1079(1509343502);
	    this.aString1378 = class101.method1079(1509343502);
    ...
    static final void method1258(Class403 class403, byte i) {
	try {
    ...
    static final void method1259(Class403 class403, int i) {
	try {
