...
public class Class283 {
    ...
    int anInt3015;
    int anInt3016;
    MapDetails aClass298_Sub37_Sub13_3017;
	...
	try {
	    return this.anInt3039 * -991330803;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return this.anInt3011 * -1456212765;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return this.anInt3015 * -2091897981;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return 2073578817 * this.anInt3016;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		if (!this.aBoolean3018)
		    Class247.method2365(-286862514);
		for (int i_1_ = 0; i_1_ < -991330803 * this.anInt3039 >> 3; i_1_++) {
		    for (int i_2_ = 0; i_2_ < this.anInt3011 * -1456212765 >> 3; i_2_++) {
			int i_3_ = (this.anIntArrayArrayArray3043[i_0_][i_1_][i_2_]);
			if (-1 != i_3_) {
				...
				for (int i_9_ = 0; i_9_ < (this.anIntArray3031).length; i_9_++) {
				    if (i_8_ == (this.anIntArray3031[i_9_]) && null != is[i_9_]) {
					RsByteBuffer class298_sub53 = new RsByteBuffer(is[i_9_]);
					class240_sub1.method2216(class298_sub53, i_0_, i_1_ * 8, i_2_ * 8, i_4_, i_6_, i_7_, i_5_, (this.SCENE_CLIP_DATA_PLANES), -828677341);
		...
		for (int i_11_ = 0; i_11_ < -991330803 * this.anInt3039 >> 3; i_11_++) {
		    for (int i_12_ = 0; (i_12_ < this.anInt3011 * -1456212765 >> 3); i_12_++) {
			int i_13_ = (this.anIntArrayArrayArray3043[i_10_][i_11_][i_12_]);
			if (-1 == i_13_)
	...
	try {
	    if (null != this.aClass240_Sub1_3029 && (this.aClass240_Sub1_3029.aByteArrayArrayArray2631) != null && (this.aClass240_Sub1_3029.aByteArrayArrayArray2631[i]) != null)
		return (this.aClass240_Sub1_3029.aByteArrayArrayArray2631[i]);
	    return null;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return this.anIntArrayArray3026;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return this.SCENE_CLIP_DATA_PLANES[i];
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return this.aByteArrayArrayArray3032;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aByteArrayArrayArray3032 = is;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return this.aClass240_Sub1_3029;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (null != this.aClass331_3037) {
		Class66.method764((byte) 1);
		this.aClass331_3037.aClass324_3528.method3956(-1174492425);
		this.aClass331_3037 = null;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass364_3013 = new Class364(Class373.aClass_ra4071, -991330803 * this.anInt3039 >> 3, this.anInt3011 * -1456212765 >> 3);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.anInt3015 = -896386664;
	    this.anInt3016 = ((int) (34.46 * (-991330803 * this.anInt3039)) * -2038218047);
	    this.anInt3016 = ((2073578817 * this.anInt3016 << 2) * -2038218047);
	    if (Class373.aClass_ra4071.method4998())
		this.anInt3016 += 109412864;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (this.aClass266_3001 != Class266.aClass266_2846 && (Class266.aClass266_2846 != this.aClass266_3004)) {
		if (this.aClass266_3001 == Class266.LOAD_MAP_SCENE_DYNAMIC || (this.aClass266_3001 == Class266.aClass266_2845) || ((this.aClass266_3004 != this.aClass266_3001) && ((Class266.LOAD_MAP_SCENE_NORMAL == this.aClass266_3001) || (this.aClass266_3004 == Class266.LOAD_MAP_SCENE_NORMAL)))) {
		    client.anInt8703 = 0;
		    client.anInt8772 = 0;
		    client.aClass437_8696.method5811((byte) -6);
		}
		this.aClass266_3004 = this.aClass266_3001;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass266_3001 = class267.aClass266_2857;
	    if (this.aClass266_3001 == Class266.aClass266_2848) // background
		method2651(-1676557011);
	    else if (this.aClass266_3001 == Class266.LOAD_MAP_SCENE_NORMAL) // normal
		loadMapSceneNormal(class267.aClass298_Sub53_Sub2_2856, -444215668);
	    else if (this.aClass266_3001 == Class266.aClass266_2846) // cutscenes
		method2665((byte) -112);
	    else if (this.aClass266_3001.allowDynamicMapScene(-1578454249)) // dynamic
									    // maps
	...
	try {
	    ...
	    int i_16_ = this.aClass341_3006.gameSceneBaseX * -1760580017;
	    int i_17_ = this.aClass341_3006.gameSceneBaseY * 283514611;
	    ...
	    int i_20_ = 18;
	    this.anIntArrayArray3042 = new int[i_20_][4];
	    this.anIntArray3031 = new int[i_20_];
	    this.anIntArray3010 = new int[i_20_];
	    this.anIntArray3033 = new int[i_20_];
	    this.anIntArray3034 = new int[i_20_];
	    this.aByteArrayArray3038 = new byte[i_20_][];
	    this.aByteArrayArray3014 = new byte[i_20_][];
	    this.aByteArrayArray3044 = new byte[i_20_][];
	    this.anIntArray3035 = new int[i_20_];
	    this.anIntArray3036 = new int[i_20_];
	    this.aByteArrayArray3041 = new byte[i_20_][];
	    this.aByteArrayArray3002 = new byte[i_20_][];
	    i_20_ = 0;
	    for (int i_21_ = (i_18_ - (this.anInt3039 * -991330803 >> 4)) / 8; i_21_ <= ((-991330803 * this.anInt3039 >> 4) + i_18_) / 8; i_21_++) {
		for (int i_22_ = (i_19_ - (this.anInt3011 * -1456212765 >> 4)) / 8; i_22_ <= ((-1456212765 * this.anInt3011 >> 4) + i_19_) / 8; i_22_++) {
		    int i_23_ = (i_21_ << 8) + i_22_;
		    this.anIntArray3031[i_20_] = i_23_;
		    this.anIntArray3010[i_20_] = (Class65.aClass243_665.getArchiveId(method2669(true, false, i_21_, i_22_, (byte) -40)));
		    this.anIntArray3033[i_20_] = (Class65.aClass243_665.getArchiveId(method2669(false, false, i_21_, i_22_, (byte) 85)));
		    this.anIntArray3034[i_20_] = Class65.aClass243_665.getArchiveId(new StringBuilder().append("n").append(i_21_).append('_').append(i_22_).toString());
		    this.anIntArray3035[i_20_] = (Class65.aClass243_665.getArchiveId(method2669(true, true, i_21_, i_22_, (byte) -47)));
		    this.anIntArray3036[i_20_] = (Class65.aClass243_665.getArchiveId(method2669(false, true, i_21_, i_22_, (byte) -30)));
		    if (this.anIntArray3034[i_20_] == -1) {
			this.anIntArray3010[i_20_] = -1;
			this.anIntArray3033[i_20_] = -1;
			this.anIntArray3035[i_20_] = -1;
			this.anIntArray3036[i_20_] = -1;
		    }
		    i_20_++;
		}
	    }
	    for (int i_24_ = i_20_; i_24_ < this.anIntArray3034.length; i_24_++) {
		this.anIntArray3034[i_24_] = -1;
		this.anIntArray3010[i_24_] = -1;
		this.anIntArray3033[i_24_] = -1;
		this.anIntArray3035[i_24_] = -1;
		this.anIntArray3036[i_24_] = -1;
	    }
	    int i_25_;
	...
	try {
	    ...
	    this.anIntArrayArray3042 = new int[i_29_][4];
	    for (int i_30_ = 0; i_30_ < i_29_; i_30_++) {
		for (int i_31_ = 0; i_31_ < 4; i_31_++)
		    this.anIntArrayArray3042[i_30_][i_31_] = class298_sub53_sub2.readInt((byte) 40);
	    }
	    this.anIntArray3031 = new int[i_29_];
	    this.anIntArray3010 = new int[i_29_];
	    this.anIntArray3033 = new int[i_29_];
	    this.anIntArray3034 = null;
	    this.aByteArrayArray3038 = new byte[i_29_][];
	    this.aByteArrayArray3014 = new byte[i_29_][];
	    this.aByteArrayArray3044 = null;
	    this.anIntArray3035 = new int[i_29_];
	    this.anIntArray3036 = new int[i_29_];
	    this.aByteArrayArray3041 = new byte[i_29_][];
	    this.aByteArrayArray3002 = new byte[i_29_][];
	    i_29_ = 0;
	    for (int i_32_ = (chunkX - (this.anInt3039 * -991330803 >> 4)) / 8; i_32_ <= (chunkX + (this.anInt3039 * -991330803 >> 4)) / 8; i_32_++) {
		for (int i_33_ = (chunkY - (-1456212765 * this.anInt3011 >> 4)) / 8; i_33_ <= ((this.anInt3011 * -1456212765 >> 4) + chunkY) / 8; i_33_++) {
		    this.anIntArray3031[i_29_] = i_33_ + (i_32_ << 8);
		    this.anIntArray3010[i_29_] = (Class65.aClass243_665.getArchiveId(method2669(true, false, i_32_, i_33_, (byte) -113)));
		    this.anIntArray3033[i_29_] = (Class65.aClass243_665.getArchiveId(method2669(false, false, i_32_, i_33_, (byte) -82)));
		    this.anIntArray3035[i_29_] = (Class65.aClass243_665.getArchiveId(method2669(true, true, i_32_, i_33_, (byte) -99)));
		    this.anIntArray3036[i_29_] = (Class65.aClass243_665.getArchiveId(method2669(false, true, i_32_, i_33_, (byte) -80)));
		    i_29_++;
		}
	    }
	...
	try {
	    ...
	    if (1 == loadType)
		this.aClass266_3001 = Class266.LOAD_MAP_SCENE_DYNAMIC;
	    else if (2 == loadType)
		this.aClass266_3001 = Class266.aClass266_2849;
	    else if (loadType == 3)
		this.aClass266_3001 = Class266.aClass266_2845;
	    else if (4 == loadType)
		this.aClass266_3001 = Class266.aClass266_2850;
		...
		for (int i_40_ = 0; i_40_ < -991330803 * this.anInt3039 >> 3; i_40_++) {
		    for (int i_41_ = 0; (i_41_ < -1456212765 * this.anInt3011 >> 3); i_41_++) {
			int i_42_ = stream.readBits(1);
			if (1 == i_42_)
			    this.anIntArrayArrayArray3043[i_39_][i_40_][i_41_] = stream.readBits(26);
			else
			    this.anIntArrayArrayArray3043[i_39_][i_40_][i_41_] = -1;
		    }
		}
	    }
	    stream.finishBitAccess((byte) 65);
	    int i_43_ = ((stream.buffer.length - stream.index * 385051775) / 16);
	    this.anIntArrayArray3042 = new int[i_43_][4];
	    for (int i_44_ = 0; i_44_ < i_43_; i_44_++) {
		for (int i_45_ = 0; i_45_ < 4; i_45_++)
		    this.anIntArrayArray3042[i_44_][i_45_] = stream.readInt((byte) -51);
	    }
	    this.anIntArray3031 = new int[i_43_];
	    this.anIntArray3010 = new int[i_43_];
	    this.anIntArray3033 = new int[i_43_];
	    this.anIntArray3034 = null;
	    this.aByteArrayArray3038 = new byte[i_43_][];
	    this.aByteArrayArray3014 = new byte[i_43_][];
	    this.aByteArrayArray3044 = null;
	    this.anIntArray3035 = new int[i_43_];
	    this.anIntArray3036 = new int[i_43_];
	    this.aByteArrayArray3041 = new byte[i_43_][];
	    this.aByteArrayArray3002 = new byte[i_43_][];
	    i_43_ = 0;
	    for (int i_46_ = 0; i_46_ < 4; i_46_++) {
		for (int i_47_ = 0; i_47_ < -991330803 * this.anInt3039 >> 3; i_47_++) {
		    for (int i_48_ = 0; (i_48_ < -1456212765 * this.anInt3011 >> 3); i_48_++) {
			int i_49_ = (this.anIntArrayArrayArray3043[i_46_][i_47_][i_48_]);
			if (i_49_ != -1) {
			    int i_50_ = i_49_ >> 14 & 0x3ff;
			    int i_51_ = i_49_ >> 3 & 0x7ff;
			    int i_52_ = (i_50_ / 8 << 8) + i_51_ / 8;
			    for (int i_53_ = 0; i_53_ < i_43_; i_53_++) {
				if (i_52_ == (this.anIntArray3031[i_53_])) {
				    i_52_ = -1;
				    break;
				}
			    }
			    if (-1 != i_52_) {
				this.anIntArray3031[i_43_] = i_52_;
				int i_54_ = i_52_ >> 8 & 0xff;
				int i_55_ = i_52_ & 0xff;
				this.anIntArray3010[i_43_] = (Class65.aClass243_665.getArchiveId(method2669(true, false, i_54_, i_55_, (byte) -94)));
				this.anIntArray3033[i_43_] = (Class65.aClass243_665.getArchiveId(method2669(false, false, i_54_, i_55_, (byte) -94)));
				this.anIntArray3035[i_43_] = (Class65.aClass243_665.getArchiveId(method2669(true, true, i_54_, i_55_, (byte) 105)));
				this.anIntArray3036[i_43_] = (Class65.aClass243_665.getArchiveId(method2669(false, true, i_54_, i_55_, (byte) 23)));
				i_43_++;
			    }
			}
		    }
	...
	try {
	    if (class115 != this.aClass115_3003) {
		this.anInt3039 = (this.anInt3011 = class115.anInt1382 * 723673737) * -116821329;
		this.anIntArrayArrayArray3043 = (new int[4][-991330803 * this.anInt3039 >> 3][-1456212765 * this.anInt3011 >> 3]);
		this.anIntArrayArray3023 = (new int[this.anInt3039 * -991330803][-1456212765 * this.anInt3011]);
		this.anIntArrayArray3026 = (new int[-991330803 * this.anInt3039][-1456212765 * this.anInt3011]);
		for (int i_56_ = 0; i_56_ < 4; i_56_++)
		    this.SCENE_CLIP_DATA_PLANES[i_56_] = Class16.method354((-991330803 * this.anInt3039), (this.anInt3011 * -1456212765), -617039163);
		this.aByteArrayArrayArray3032 = (new byte[4][-991330803 * this.anInt3039][this.anInt3011 * -1456212765]);
		this.aClass244_3012 = new Class244(4, -991330803 * this.anInt3039, this.anInt3011 * -1456212765);
		method2647(-1528485886);
		this.aClass115_3003 = class115;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return this.anIntArrayArray3023;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (bool || this.anInt3030 * 19679283 != i || i_57_ != this.anInt3009 * 306966675) {
		this.anInt3030 = i * -1135086853;
		this.anInt3009 = i_57_ * -1928942181;
		if (!this.aBoolean3018) {
		...
		if (this.aClass341_3006 != null)
		    this.aClass341_3007 = this.aClass341_3006;
		else
		    this.aClass341_3007 = new Class341(0, 0, 0);
		this.aClass341_3006 = new Class341(0, 8 * (this.anInt3030 * 19679283 - ((-991330803 * this.anInt3039) >> 4)), 8 * (306966675 * this.anInt3009 - ((this.anInt3011 * -1456212765) >> 4)));
		this.aClass298_Sub37_Sub13_3017 = Class301.method3708(-1760580017 * (this.aClass341_3006.gameSceneBaseX), (this.aClass341_3006.gameSceneBaseY) * 283514611);
		this.aClass296_3005 = null;
		if (!this.aBoolean3018)
	...
	this.anInt3021 = 0;
	this.anInt3024 = -861507225;
	aBoolean3008 = false;
	this.aBoolean3018 = bool;
    }
	...
	try {
		...
		if (null != is_63_) {
		    ...
		    int i_64_ = this.anIntArray3031[i_62_] >> 8;
		    int i_65_ = this.anIntArray3031[i_62_] & 0xff;
		    int i_66_ = (64 * i_64_ - (this.aClass341_3006.gameSceneBaseX * -1760580017));
		    int i_67_ = 64 * i_65_ - 283514611 * (this.aClass341_3006.gameSceneBaseY);
		    if (!this.aBoolean3018)
			Class247.method2365(408539711);
		    class240_sub1.method2215(class298_sub53, i_66_, i_67_, -1760580017 * (this.aClass341_3006.gameSceneBaseX), (this.aClass341_3006.gameSceneBaseY) * 283514611, (this.SCENE_CLIP_DATA_PLANES), -391880689);
		    class240_sub1.method2235(Class373.aClass_ra4071, class298_sub53, i_66_, i_67_, (byte) -72);
		}
	    }
	    for (int i_68_ = 0; i_68_ < i_61_; i_68_++) {
		int i_69_ = ((this.anIntArray3031[i_68_] >> 8) * 64 - (this.aClass341_3006.gameSceneBaseX * -1760580017));
		int i_70_ = ((this.anIntArray3031[i_68_] & 0xff) * 64 - (this.aClass341_3006.gameSceneBaseY * 283514611));
		byte[] is_71_ = is[i_68_];
		if (is_71_ == null && this.anInt3009 * 306966675 < 800) {
		    if (!this.aBoolean3018)
	...
	try {
	    int i_72_ = this.aByteArrayArray3038.length;
	    for (int i_73_ = 0; i_73_ < i_72_; i_73_++) {
		byte[] is_74_ = is[i_73_];
		if (is_74_ != null) {
		    int i_75_ = (64 * (this.anIntArray3031[i_73_] >> 8) - (-1760580017 * this.aClass341_3006.gameSceneBaseX));
		    int i_76_ = ((this.anIntArray3031[i_73_] & 0xff) * 64 - 283514611 * (this.aClass341_3006.gameSceneBaseY));
		    if (!this.aBoolean3018)
			Class247.method2365(-802890876);
		    class240_sub1.method2237(Class373.aClass_ra4071, is_74_, i_75_, i_76_, (this.SCENE_CLIP_DATA_PLANES), 1861855341);
		    if (this.aBoolean3018)
	...
	try {
	    int i_77_ = this.aByteArrayArray3044.length;
	    for (int i_78_ = 0; i_78_ < i_77_; i_78_++) {
		if (this.aByteArrayArray3044[i_78_] == null) {
		    if (i <= -1776092464) {
			/* empty */
		    }
		} else {
			...
			if (this.anIntArray3031[i_78_] == client.anIntArray8751[i_80_]) {
			    i_79_ = i_80_;
			    break;
			}
		    }
		    if (i_79_ == -1) {
			client.anIntArray8751[client.anInt8721 * -160072615] = this.anIntArray3031[i_78_];
			i_79_ = (client.anInt8721 += 424283113) * -160072615 - 1;
		    }
		    RsByteBuffer class298_sub53 = new RsByteBuffer(this.aByteArrayArray3044[i_78_]);
		    int i_81_ = 0;
		    while ((385051775 * class298_sub53.index < (this.aByteArrayArray3044[i_78_]).length) && i_81_ < 511) {
			...
			int i_87_ = (64 * (this.anIntArray3031[i_78_] >> 8) - (this.aClass341_3006.gameSceneBaseX * -1760580017) + i_85_);
			int i_88_ = (i_86_ + (64 * (this.anIntArray3031[i_78_] & 0xff) - (this.aClass341_3006.gameSceneBaseY * 283514611)));
			...
			if (class298_sub29 == null && (class503.aByte6170 & 0x1) > 0 && i_87_ >= 0 && (-2095128707 * class503.size + i_87_ < -991330803 * this.anInt3039) && i_88_ >= 0 && (i_88_ + class503.size * -2095128707 < this.anInt3011 * -1456212765)) {
			    NPC class365_sub1_sub1_sub2_sub1 = (new NPC(this.aClass331_3037));
			    ...
			    class365_sub1_sub1_sub2_sub1.anInt10075 = client.ticketCycle * -128551287;
			    ...
			    class365_sub1_sub1_sub2_sub1.method4415((class365_sub1_sub1_sub2_sub1.aClass503_10190.aClass274_6183.method2567((byte) 73).getType(694163818) << 11 & 0x3fff), true, 822135678);
	...
	try {
	    return 100 - (-1285506348 * this.anInt3027 / (this.anInt3028 * -316305569));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    int i_91_ = (this.aClass341_3006.gameSceneBaseX * -1760580017 - this.aClass341_3007.gameSceneBaseX * -1760580017);
	    int i_92_ = (this.aClass341_3006.gameSceneBaseY * 283514611 - 283514611 * this.aClass341_3007.gameSceneBaseY);
	    if (17 == i) {
		...
		boolean bool = false;
		client.anInt8703 = 0;
		int i_95_ = -755230208 * this.anInt3039 - 512;
		int i_96_ = this.anInt3011 * 1743373824 - 512;
		for (int i_97_ = 0; i_97_ < client.anInt8772 * 1962237353; i_97_++) {
			...
			if ((int) class217.aFloat2451 < 0 || (int) class217.aFloat2451 > i_95_ || (int) class217.aFloat2454 < 0 || (int) class217.aFloat2454 > i_96_) {
				...
				if ((class365_sub1_sub1_sub2_sub1.scenePositionXQueue[i_99_]) < 0 || ((class365_sub1_sub1_sub2_sub1.scenePositionXQueue[i_99_]) >= (this.anInt3039 * -991330803)) || (class365_sub1_sub1_sub2_sub1.scenePositionYQueue[i_99_]) < 0 || ((class365_sub1_sub1_sub2_sub1.scenePositionYQueue[i_99_]) >= (this.anInt3011 * -1456212765)))
				    bool_98_ = false;
			    }
			    if (bool_98_)
		...
		if (this.aClass266_3001 != Class266.aClass266_2850 && (class298_sub1.anInt7150 * 634196087 < 0 || -2146829167 * class298_sub1.anInt7155 < 0 || (634196087 * class298_sub1.anInt7150 >= this.anInt3039 * -991330803) || (-2146829167 * class298_sub1.anInt7155 >= this.anInt3011 * -1456212765)))
		...
		if (this.aClass266_3001 != Class266.aClass266_2850 && (634196087 * class298_sub1.anInt7150 < 0 || -2146829167 * class298_sub1.anInt7155 < 0 || (class298_sub1.anInt7150 * 634196087 >= this.anInt3039 * -991330803) || (-2146829167 * class298_sub1.anInt7155 >= -1456212765 * this.anInt3011)))
		    class298_sub1.method2839(-1460969981);
	    }
		...
		int i_104_ = (int) ((class298_sub2.hash * 7051297995265073167L >> 28) & 0x3L);
		int i_105_ = (int) (7051297995265073167L * class298_sub2.hash & 0x3fffL);
		int i_106_ = i_105_ - (-1760580017 * this.aClass341_3006.gameSceneBaseX);
		int i_107_ = (int) ((class298_sub2.hash * 7051297995265073167L >> 14) & 0x3fffL);
		int i_108_ = i_107_ - 283514611 * (this.aClass341_3006.gameSceneBaseY);
		if (null != this.aClass331_3037) {
		    if (i_106_ < 0 || i_108_ < 0 || i_106_ >= -991330803 * this.anInt3039 || i_108_ >= this.anInt3011 * -1456212765 || i_106_ >= (this.aClass331_3037.anInt3514) * 1988988347 || i_108_ >= 1340714547 * (this.aClass331_3037.anInt3549)) {
			if (this.aClass266_3001 != Class266.aClass266_2850)
			    class298_sub2.method2839(-1460969981);
		    } else if ((this.aClass331_3037.aClass326ArrayArrayArray3516) != null)
			this.aClass331_3037.method4059(i_104_, i_106_, i_108_, (byte) 116);
		}
	    }
		...
		Class_xa.cameraLookViewLocalX -= 446226445 * i_91_;
		IPAddress.cameraLookViewLocalY -= i_92_ * 2019382975;
		Class367.anInt4000 -= i_91_ * 1343197696;
		Class146.anInt1575 -= i_92_ * -276168192;
		if (Math.abs(i_91_) > -991330803 * this.anInt3039 || (Math.abs(i_92_) > this.anInt3011 * -1456212765))
		    this.aClass364_3013.method4324(-1910257839);
	    }
	...
	try {
	    this.aClass240_Sub1_3000 = null;
	    this.aClass240_Sub1_3029 = null;
	    for (int i_109_ = 0; i_109_ < 4; i_109_++) {
		if (null != this.SCENE_CLIP_DATA_PLANES[i_109_])
		    this.SCENE_CLIP_DATA_PLANES[i_109_].method2731(-2096339600);
	    }
	    if (this.aClass244_3012 != null)
		this.aClass244_3012.method2319(-1035232458);
	    if (null != this.aClass364_3013)
		this.aClass364_3013.method4320((byte) 38);
	    if (null != this.aClass331_3037) {
		this.aClass331_3037.aClass324_3528.method3956(-1174492425);
		this.aClass331_3037 = null;
	    }
	...
	try {
		...
		for (int i_111_ = 0; i_111_ < this.anInt3039 * -991330803 >> 3; i_111_++) {
		    for (int i_112_ = 0; (i_112_ < -1456212765 * this.anInt3011 >> 3); i_112_++)
			this.anIntArrayArrayArray3043[i_110_][i_111_][i_112_] = -1;
		}
	    }
		...
		while (i_126_ < i_121_ + i_115_) {
			...
			if (bool)
			    this.anIntArrayArrayArray3043[i_119_][i_116_ + i_122_][i_117_ + i_127_] = ((i_126_ << 3) + ((i_128_ << 14) + (i_118_ << 24)) + (i_113_ << 1));
			else
			    this.anIntArrayArrayArray3043[i_119_][i_116_ + i_127_][i_122_ + i_117_] = (i_113_ << 1) + ((i_126_ << 3) + ((i_128_ << 14) + (i_118_ << 24)));
			i_128_++;
			i_127_ += i_124_;
		    }
		    i_126_++;
	    ...
	    this.anIntArray3031 = new int[i_129_];
	    this.anIntArray3010 = new int[i_129_];
	    this.anIntArray3033 = new int[i_129_];
	    this.anIntArray3034 = null;
	    this.aByteArrayArray3038 = new byte[i_129_][];
	    this.aByteArrayArray3014 = new byte[i_129_][];
	    this.aByteArrayArray3044 = null;
	    this.anIntArray3035 = new int[i_129_];
	    this.anIntArray3036 = new int[i_129_];
	    this.aByteArrayArray3041 = new byte[i_129_][];
	    this.aByteArrayArray3002 = new byte[i_129_][];
	    i_129_ = 0;
		...
		for (int i_134_ = i_130_ >>> 3; i_134_ <= i_132_; i_134_++) {
			...
			for (int i_137_ = 0; i_137_ < i_129_; i_137_++) {
			    if (this.anIntArray3031[i_137_] == i_136_) {
				if (i >= 0) {
				    /* empty */
				}
				continue while_71_;
			...
			this.anIntArray3031[i_129_] = i_136_;
			this.anIntArray3010[i_129_] = (Class65.aClass243_665.getArchiveId(method2669(true, false, i_134_, i_135_, (byte) -52)));
			this.anIntArray3033[i_129_] = (Class65.aClass243_665.getArchiveId(method2669(false, false, i_134_, i_135_, (byte) 111)));
			this.anIntArray3035[i_129_] = (Class65.aClass243_665.getArchiveId(method2669(true, true, i_134_, i_135_, (byte) 24)));
			this.anIntArray3036[i_129_] = (Class65.aClass243_665.getArchiveId(method2669(false, true, i_134_, i_135_, (byte) 86)));
			i_129_++;
		    }
		}
	    }
	    this.anIntArrayArray3042 = Class298_Sub37.anIntArrayArray7407;
	    Class298_Sub37.anIntArrayArray7407 = null;
	    method2657(-991330803 * this.anInt3039 >> 4, -1456212765 * this.anInt3011 >> 4, 17, false, -815771659);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass341_3006 = new Class341();
	    this.anInt3009 = 0;
	    this.anInt3030 = 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		this.anIntArray3031 = class283_138_.anIntArray3031;
		this.anIntArray3010 = class283_138_.anIntArray3010;
		this.anIntArray3033 = class283_138_.anIntArray3033;
		this.anIntArray3034 = class283_138_.anIntArray3034;
		this.anIntArray3035 = class283_138_.anIntArray3035;
		this.anIntArray3036 = class283_138_.anIntArray3036;
		this.anIntArrayArray3042 = class283_138_.anIntArrayArray3042;
		this.aByteArrayArray3038 = class283_138_.aByteArrayArray3038;
		this.aByteArrayArray3014 = class283_138_.aByteArrayArray3014;
		this.aByteArrayArray3044 = class283_138_.aByteArrayArray3044;
		this.aByteArrayArray3041 = class283_138_.aByteArrayArray3041;
		this.aByteArrayArray3002 = class283_138_.aByteArrayArray3002;
		this.SCENE_CLIP_DATA_PLANES = class283_138_.SCENE_CLIP_DATA_PLANES;
		this.aClass244_3012 = class283_138_.aClass244_3012;
		this.aClass364_3013 = class283_138_.aClass364_3013;
		this.anIntArrayArrayArray3043 = class283_138_.anIntArrayArrayArray3043;
		this.anInt3015 = 1 * class283_138_.anInt3015;
		this.anInt3016 = 1 * class283_138_.anInt3016;
		this.aClass298_Sub37_Sub13_3017 = class283_138_.aClass298_Sub37_Sub13_3017;
		this.aClass296_3005 = class283_138_.aClass296_3005;
		this.anIntArrayArray3023 = class283_138_.anIntArrayArray3023;
		this.anIntArrayArray3026 = class283_138_.anIntArrayArray3026;
		this.aByteArrayArrayArray3032 = class283_138_.aByteArrayArrayArray3032;
		this.aClass266_3001 = class283_138_.aClass266_3001;
		this.aClass115_3003 = class283_138_.aClass115_3003;
		this.aClass341_3006 = class283_138_.aClass341_3006;
		this.aClass341_3007 = class283_138_.aClass341_3007;
		this.anInt3030 = class283_138_.anInt3030 * 1;
		this.anInt3009 = 1 * class283_138_.anInt3009;
		this.anInt3039 = class283_138_.anInt3039 * 1;
		this.anInt3011 = class283_138_.anInt3011 * 1;
	...
	try {
	    ...
	    class283_139_.aBoolean3018 = this.aBoolean3018;
	    this.aBoolean3018 = bool;
	    Class266 class266 = class283_139_.aClass266_3004;
	    class283_139_.aClass266_3004 = this.aClass266_3004;
	    this.aClass266_3004 = class266;
	    class283_139_.aClass341_3007 = this.aClass341_3006;
	    this.aClass341_3007 = class283_139_.aClass341_3006;
	    this.aClass364_3013.method4327(class283_139_.method2640((byte) 49), -1162508016);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return 100 - (this.anInt3021 * -1732877004 / (1792875095 * this.anInt3024));
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		for (int i_144_ = 0; i_144_ < -991330803 * this.anInt3039 >> 3; i_144_++) {
		    for (int i_145_ = 0; (i_145_ < -1456212765 * this.anInt3011 >> 3); i_145_++) {
			int i_146_ = (this.anIntArrayArrayArray3043[i_143_][i_144_][i_145_]);
			if (-1 != i_146_) {
				...
				for (int i_152_ = 0; i_152_ < (this.anIntArray3031).length; i_152_++) {
				    if ((this.anIntArray3031[i_152_]) == i_151_ && null != is[i_152_]) {
					class240_sub1.method2238(Class373.aClass_ra4071, is[i_152_], i_143_, 8 * i_144_, i_145_ * 8, i_147_, 8 * (i_149_ & 0x7), (i_150_ & 0x7) * 8, i_148_, (this.SCENE_CLIP_DATA_PLANES), -174685332);
					break;
				    }
				}
			    }
	...
	try {
	    ...
	    this.anInt3027 = 0;
	    for (int i_153_ = 0; i_153_ < this.aByteArrayArray3038.length; i_153_++) {
		if (-1 != this.anIntArray3010[i_153_] && this.aByteArrayArray3038[i_153_] == null) {
		    this.aByteArrayArray3038[i_153_] = Class65.aClass243_665.getFile((this.anIntArray3010[i_153_]), 0);
		    if (null == this.aByteArrayArray3038[i_153_])
			this.anInt3027 += -427342251;
		}
		if (-1 != this.anIntArray3033[i_153_] && null == this.aByteArrayArray3014[i_153_]) {
		    this.aByteArrayArray3014[i_153_] = (Class65.aClass243_665.method2289(this.anIntArray3033[i_153_], 0, this.anIntArrayArray3042[i_153_], -1251594466));
		    if (null == this.aByteArrayArray3014[i_153_])
			this.anInt3027 += -427342251;
		}
		if (this.anIntArray3035[i_153_] != -1 && null == this.aByteArrayArray3041[i_153_]) {
		    this.aByteArrayArray3041[i_153_] = Class65.aClass243_665.getFile((this.anIntArray3035[i_153_]), 0);
		    if (this.aByteArrayArray3041[i_153_] == null)
			this.anInt3027 += -427342251;
		}
		if (this.anIntArray3036[i_153_] != -1 && this.aByteArrayArray3002[i_153_] == null) {
		    this.aByteArrayArray3002[i_153_] = Class65.aClass243_665.getFile((this.anIntArray3036[i_153_]), 0);
		    if (null == this.aByteArrayArray3002[i_153_])
			this.anInt3027 += -427342251;
		}
		if (null != this.anIntArray3034 && null == this.aByteArrayArray3044[i_153_] && this.anIntArray3034[i_153_] != -1) {
		    this.aByteArrayArray3044[i_153_] = (Class65.aClass243_665.method2289(this.anIntArray3034[i_153_], 0, this.anIntArrayArray3042[i_153_], -1874141869));
		    if (null == this.aByteArrayArray3044[i_153_])
			this.anInt3027 += -427342251;
		}
	    }
	    if (this.aClass296_3005 == null) {
		if (null != this.aClass298_Sub37_Sub13_3017 && (Class_v.idx23.method2295(new StringBuilder().append(this.aClass298_Sub37_Sub13_3017.namehash).append("_staticelements").toString(), -400372089))) {
		    if (!Class_v.idx23.method2312(new StringBuilder().append(this.aClass298_Sub37_Sub13_3017.namehash).append("_staticelements").toString(), -2144896080))
			this.anInt3027 += -427342251;
		    else
			this.aClass296_3005 = (WorldMap.getMapKeys(Class_v.idx23, new StringBuilder().append(this.aClass298_Sub37_Sub13_3017.namehash).append("_staticelements").toString(), client.isMemberWorld, 565671699));
		} else
		    this.aClass296_3005 = new MapKeys(0);
	    }
	    if (-528251139 * this.anInt3027 > 0) {
		if (-316305569 * this.anInt3028 < this.anInt3027 * -528251139)
		    this.anInt3028 = this.anInt3027 * -707841245;
		this.aClass273_3025 = Class273.aClass273_2906;
		return false;
	    }
	    this.anInt3021 = 0;
	    for (int i_154_ = 0; i_154_ < this.aByteArrayArray3038.length; i_154_++) {
		byte[] is = this.aByteArrayArray3014[i_154_];
		if (is != null) {
		    int i_155_ = ((this.anIntArray3031[i_154_] >> 8) * 64 - (-1760580017 * this.aClass341_3006.gameSceneBaseX));
		    int i_156_ = ((this.anIntArray3031[i_154_] & 0xff) * 64 - (this.aClass341_3006.gameSceneBaseY * 283514611));
		    if (this.aClass266_3001.allowDynamicMapScene(-1692375482)) {
			i_155_ = 10;
			i_156_ = 10;
		    }
		    int i_157_ = (Class82_Sub13.method910(this.aClass433_3040, is, i_155_, i_156_, this.anInt3039 * -991330803, -1456212765 * this.anInt3011, (byte) -75));
		    if (i_157_ > 0)
			this.anInt3021 += i_157_ * 94764029;
		}
		is = this.aByteArrayArray3002[i_154_];
		if (is != null) {
		    int i_158_ = (64 * (this.anIntArray3031[i_154_] >> 8) - (this.aClass341_3006.gameSceneBaseX * -1760580017));
		    int i_159_ = (64 * (this.anIntArray3031[i_154_] & 0xff) - (this.aClass341_3006.gameSceneBaseY * 283514611));
		    if (this.aClass266_3001.allowDynamicMapScene(-105390577)) {
			i_158_ = 10;
			i_159_ = 10;
		    }
		    int i_160_ = (Class82_Sub13.method910(this.aClass433_3040, is, i_158_, i_159_, this.anInt3039 * -991330803, -1456212765 * this.anInt3011, (byte) 54));
		    if (i_160_ > 0)
			this.anInt3021 += 94764029 * i_160_;
		}
	    }
	    if (-1134020267 * this.anInt3021 > 0) {
		if (1792875095 * this.anInt3024 < this.anInt3021 * -1134020267)
		    this.anInt3024 = this.anInt3021 * -1201957325;
		this.aClass273_3025 = Class273.aClass273_2904;
		return false;
	    }
	    if (!this.aBoolean3018 && this.aClass273_3025 != Class273.aClass273_2905)
	    ...
	    this.aClass273_3025 = Class273.aClass273_2907;
	    if (!this.aBoolean3018)
		...
		for (int i_163_ = 0; i_163_ < this.aByteArrayArray3038.length; i_163_++) {
		    if (this.aByteArrayArray3002[i_163_] != null || (this.aByteArrayArray3041[i_163_] != null)) {
			bool = true;
			break;
		    }
		}
	    ...
	    method2664((byte) 12);
	    this.aClass331_3037 = new Class331(Class373.aClass_ra4071, 9, 4, this.anInt3039 * -991330803, this.anInt3011 * -1456212765, i_164_, bool, Class373.aClass_ra4071.method5048() > 0);
	    this.aClass331_3037.method4052(false, -740850409);
	    this.aClass331_3037.method4007(client.anInt8814 * -2081556469, (byte) -26);
	    if (0 != client.anInt8814 * -2081556469)
		this.aClass331_3037.method4008(ScriptEnvironment.aClass264_7534, -972568309);
	    else
		this.aClass331_3037.method4008(null, 1333003580);
	    this.aClass287_3019 = new Class287();
	    this.aFloat3020 = -0.05F + (float) (Math.random() / 10.0);
	    this.aClass240_Sub1_3029 = new Class240_Sub1(this.aClass331_3037, this.aClass433_3040, 4, -991330803 * this.anInt3039, -1456212765 * this.anInt3011, false, this.aClass244_3012, this.aClass364_3013);
	    this.aClass240_Sub1_3029.method2212(-403694446);
	    this.aClass240_Sub1_3029.anInt2621 = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub7_7581.method5650(-809818345) * 275039235;
	    this.aClass240_Sub1_3029.aBoolean2622 = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub5_7572.method5642(-2131698628) == 2;
	    this.aClass240_Sub1_3029.aBoolean2697 = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub15_7560.method5684(-2037839529) == 1;
	    this.aClass240_Sub1_3029.aBoolean2624 = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub28_7573.method5724(1917266854) == 1;
	    this.aClass240_Sub1_3029.aBoolean2625 = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub16_7557.method5687(1803060969) == 1;
	    if (!this.aClass266_3001.allowDynamicMapScene(338257036))
		method2659(this.aClass240_Sub1_3029, this.aByteArrayArray3038, (short) 821);
	    else
		method2636(this.aClass240_Sub1_3029, this.aByteArrayArray3038, (byte) 53);
	    if (this.aBoolean3018)
		method2658(50, (byte) -75);
	    this.aClass364_3013.method4321(this.anInt3039 * -991330803 >> 4, -1456212765 * this.anInt3011 >> 4, 1532552397);
	    this.aClass364_3013.method4323(this, 1783211969);
	    if (bool) {
		this.aClass331_3037.method4052(true, -740850409);
		this.aClass240_Sub1_3000 = new Class240_Sub1(this.aClass331_3037, this.aClass433_3040, 1, (-991330803 * this.anInt3039), (-1456212765 * this.anInt3011), true, this.aClass244_3012, this.aClass364_3013);
		this.aClass240_Sub1_3000.method2212(-1978540544);
		this.aClass240_Sub1_3000.anInt2621 = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub7_7581.method5650(-15786995) * 275039235;
		this.aClass240_Sub1_3000.aBoolean2622 = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub5_7572.method5642(864049094) == 2;
		this.aClass240_Sub1_3000.aBoolean2697 = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub15_7560.method5684(-1853244696) == 1;
		this.aClass240_Sub1_3000.aBoolean2624 = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub28_7573.method5724(281198825) == 1;
		this.aClass240_Sub1_3000.aBoolean2625 = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub16_7557.method5687(2103749887) == 1;
		if (!this.aClass266_3001.allowDynamicMapScene(1753743768)) {
		    method2659(this.aClass240_Sub1_3000, this.aByteArrayArray3041, (short) 5882);
		    if (!this.aBoolean3018)
			Class517.method6310(true, 1696867322);
		} else {
		    method2636(this.aClass240_Sub1_3000, this.aByteArrayArray3041, (byte) 95);
		    if (!this.aBoolean3018)
			Class517.method6310(true, -428383733);
		}
		this.aClass240_Sub1_3000.method2211(0, (this.aClass240_Sub1_3029.anIntArrayArrayArray2653[0]), -1177013471);
		this.aClass240_Sub1_3000.method2218(Class373.aClass_ra4071, null, null, (byte) -27);
		this.aClass331_3037.method4052(false, -740850409);
		if (this.aBoolean3018)
		    method2658(50, (byte) 33);
	    }
	    this.aClass240_Sub1_3029.method2218(Class373.aClass_ra4071, bool ? (this.aClass240_Sub1_3000.anIntArrayArrayArray2653) : null, this.SCENE_CLIP_DATA_PLANES, (byte) 23);
	    if (!this.aClass266_3001.allowDynamicMapScene(-1767246323)) {
		if (!this.aBoolean3018)
		    Class517.method6310(true, 1723627031);
		method2660(this.aClass240_Sub1_3029, this.aByteArrayArray3014, (byte) -90);
		if (null != this.aByteArrayArray3044)
		    method2661(-388258926);
	    } else {
		if (!this.aBoolean3018)
		    Class517.method6310(true, 2071599739);
		method2671(this.aClass240_Sub1_3029, this.aByteArrayArray3014, 1378612829);
	    }
	    if (!this.aBoolean3018)
		Class517.method6310(true, -741926161);
	    this.aClass240_Sub1_3029.method2219(Class373.aClass_ra4071, (bool ? this.aClass331_3037.aClass_xaArray3521[0] : null), null, (byte) -119);
	    if (this.aBoolean3018)
		method2658(75, (byte) 18);
	    this.aClass240_Sub1_3029.method2242(Class373.aClass_ra4071, false, 1773155741);
	    if (this.aBoolean3018)
		...
		if (!this.aClass266_3001.allowDynamicMapScene(423424816))
		    method2660(this.aClass240_Sub1_3000, this.aByteArrayArray3002, (byte) -36);
		else
		    method2671(this.aClass240_Sub1_3000, this.aByteArrayArray3002, -957252436);
		if (!this.aBoolean3018)
		    Class517.method6310(true, 1319323091);
		this.aClass240_Sub1_3000.method2219(Class373.aClass_ra4071, null, this.aClass331_3037.aClass_xaArray3519[0], (byte) 43);
		this.aClass240_Sub1_3000.method2242(Class373.aClass_ra4071, true, 1773155741);
		if (!this.aBoolean3018)
	    ...
	    this.aClass240_Sub1_3029.method2217(-702552699);
	    if (this.aClass240_Sub1_3000 != null)
		this.aClass240_Sub1_3000.method2217(-702552699);
	    this.aClass331_3037.method4050(-1802988635);
	    if (this.aBoolean3018) {
		...
		this.aClass364_3013.method4331((byte) 3);
		Class113.method1247(1506910584);
	    }
	    for (int i_167_ = 0; i_167_ < 4; i_167_++) {
		for (int i_168_ = 0; i_168_ < this.anInt3039 * -991330803; i_168_++) {
		    for (int i_169_ = 0; i_169_ < -1456212765 * this.anInt3011; i_169_++)
		...
		if (client.aClass299Array8671[i_170_] != null)
		    client.aClass299Array8671[i_170_].method3676(this.aClass331_3037, 1790221759);
	    }
		...
		class298_sub36.out.writeInt(1057001181, -2024753870);
		client.aClass25_8711.method390(class298_sub36, (byte) -45);
	    }
	    if (!this.aClass266_3001.allowDynamicMapScene(1503430704)) {
		int i_171_ = ((19679283 * this.anInt3030 - (this.anInt3039 * -991330803 >> 4)) / 8);
		int i_172_ = ((19679283 * this.anInt3030 + (this.anInt3039 * -991330803 >> 4)) / 8);
		int i_173_ = ((306966675 * this.anInt3009 - (this.anInt3011 * -1456212765 >> 4)) / 8);
		int i_174_ = ((306966675 * this.anInt3009 + (-1456212765 * this.anInt3011 >> 4)) / 8);
	...
	try {
	    this.aClass273_3025 = Class273.aClass273_2905;
	    this.anInt3027 = 0;
	    this.anInt3028 = 255626399;
	    this.anInt3021 = 0;
	    this.anInt3024 = -861507225;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2677(IComponentDefinition class105, Class119 class119, Class403 class403, byte i) {
	try {
