...
public class Class120 {
	...
	try {
	    return i & (1 << this.anInt1461 * -82175751) - 1;
	}
	...
	this.anInt1461 = i_1_ * -1094244023;
    }

    public int method1306(short i) {
	try {
	    return 1 << -82175751 * this.anInt1461;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    return i >>> -82175751 * this.anInt1461;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		Class298_Sub24_Sub4 class298_sub24_sub4 = class298_sub49.aClass308_Sub1_7591.method3772((byte) -78);
		if (null != class298_sub24_sub4) {
		    double d = class298_sub49.aClass308_Sub1_7591.method3779((short) 4615);
		    if (class298_sub24_sub4.method3092((byte) 8) <= d && (class298_sub24_sub4.method3093(-327557193) >= d))
    ...
    static final void method1313(Class403 class403, int i) {
	try {
	    Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub9_7555, (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]) == 1 ? 1 : 0, -1686668837);
