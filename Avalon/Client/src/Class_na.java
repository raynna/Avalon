...
public abstract class Class_na extends Class298_Sub37 {
    ...
    static final void method3477(Class403 class403, int i) {
	try {
	...
	try {
	    ...
	    client.anInt8921 = 727655629 * client.ticketCycle;
	...
	try {
		...
		Class163 class163 = class298_sub25.members[i];
		if (-1 == class163.aByte1683) {
		    ...
		    class298_sub36.out.writeByte(3 + Class58.method693(string, -175153344));
		    class298_sub36.out.writeByte(bool ? 1 : 0);
		    class298_sub36.out.writeShort(i, 16711935);
		    class298_sub36.out.writeString(string, 2135659343);
    ...
    static final void method3480(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.anInt8845 * -363202459;
	}
	catch (RuntimeException runtimeexception) {
