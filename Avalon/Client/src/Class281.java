...
public class Class281 {
	...
	int i_20_ = 0;
	this.anIntArray2992 = new int[i_19_];
	for (int i_21_ = 0; i_21_ < i_19_; i_21_++) {
	    int i_22_ = Class298_Sub23.method3070(4);
	    this.anIntArray2992[i_21_] = i_22_;
	    if (i_22_ >= i_20_)
		i_20_ = i_22_ + 1;
	}
	this.anIntArray2993 = new int[i_20_];
	this.anIntArray2989 = new int[i_20_];
	this.anIntArray2991 = new int[i_20_];
	this.anIntArrayArray2996 = new int[i_20_][];
	for (int i_23_ = 0; i_23_ < i_20_; i_23_++) {
	    this.anIntArray2993[i_23_] = Class298_Sub23.method3070(3) + 1;
	    int i_24_ = (this.anIntArray2989[i_23_] = Class298_Sub23.method3070(2));
	    if (i_24_ != 0)
		this.anIntArray2991[i_23_] = Class298_Sub23.method3070(8);
	    i_24_ = 1 << i_24_;
	    int[] is = new int[i_24_];
	    this.anIntArrayArray2996[i_23_] = is;
	    for (int i_25_ = 0; i_25_ < i_24_; i_25_++)
		is[i_25_] = Class298_Sub23.method3070(8) - 1;
	}
	this.anInt2988 = Class298_Sub23.method3070(2) + 1;
	int i_26_ = Class298_Sub23.method3070(4);
	int i_27_ = 2;
	for (int i_28_ = 0; i_28_ < i_19_; i_28_++)
	    i_27_ += (this.anIntArray2993[this.anIntArray2992[i_28_]]);
	this.anIntArray2990 = new int[i_27_];
	this.anIntArray2990[0] = 0;
	this.anIntArray2990[1] = 1 << i_26_;
	i_27_ = 2;
	for (int i_29_ = 0; i_29_ < i_19_; i_29_++) {
	    int i_30_ = this.anIntArray2992[i_29_];
	    for (int i_31_ = 0; i_31_ < this.anIntArray2993[i_30_]; i_31_++)
		this.anIntArray2990[i_27_++] = Class298_Sub23.method3070(i_26_);
	}
	...
	if (!bool)
	    return false;
	int i = this.anIntArray2990.length;
	for (int i_32_ = 0; i_32_ < i; i_32_++)
	    anIntArray2997[i_32_] = this.anIntArray2990[i_32_];
	int i_33_ = anIntArray2995[this.anInt2988 - 1];
	...
	int i_35_ = 2;
	for (int i_36_ = 0; i_36_ < this.anIntArray2992.length; i_36_++) {
	    int i_37_ = this.anIntArray2992[i_36_];
	    int i_38_ = this.anIntArray2993[i_37_];
	    int i_39_ = this.anIntArray2989[i_37_];
	    int i_40_ = (1 << i_39_) - 1;
	    int i_41_ = 0;
	    if (i_39_ > 0)
		i_41_ = Class298_Sub23.aClass265Array7328[this.anIntArray2991[i_37_]].method2517();
	    for (int i_42_ = 0; i_42_ < i_38_; i_42_++) {
		int i_43_ = (this.anIntArrayArray2996[i_37_][i_41_ & i_40_]);
		i_41_ >>>= i_39_;
	...
	int i_44_ = this.anIntArray2990.length;
	int i_45_ = anIntArray2995[this.anInt2988 - 1];
