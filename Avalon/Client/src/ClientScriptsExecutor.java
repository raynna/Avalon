...
public class ClientScriptsExecutor {
    ...
    static void method4690(ClientScript class298_sub37_sub17, int i, Class403 class403, int i_0_) {
	try {
	    class403.anInt5239 = 0;
	    class403.anInt5241 = 0;
	    class403.anInt5259 = -286750741;
		...
		try {
			...
			class394 = (class403.aClass394Array5258[(class403.anInt5259 += 286750741) * 1883543357]);
			if (Class388.aBoolean4154 && (null == Class388.aString4155 || (null != (class403.aClass298_Sub37_Sub17_5260.aString9673) && (class403.aClass298_Sub37_Sub17_5260.aString9673.indexOf(Class388.aString4155) != -1))))
			    System.out.println(new StringBuilder().append(class403.aClass298_Sub37_Sub17_5260.aString9673).append(": ").append(class394).append(" {" + (-560594807 * Class388.anInt4152) + "/" + i + "}").toString());
			if ((class403.anIntArray5257[1883543357 * class403.anInt5259]) == 1)
			    class403.aBoolean5261 = true;
			else
			    class403.aBoolean5261 = false;
			if (Class394.aClass394_4206 == class394 && (class403.anInt5250 * -932179775 == 0)) {
		    ...
		    stringbuilder.append("").append(7051297995265073167L * (class403.aClass298_Sub37_Sub17_5260.hash)).append(" ");
		    for (int i_1_ = (class403.anInt5250 * -932179775) - 1; i_1_ >= 0; i_1_--)
			stringbuilder.append("").append(7051297995265073167L * ((class403.aClass402Array5249[i_1_]).aClass298_Sub37_Sub17_5229.hash)).append(" ");
    ...
    static final void method4691(Class403 class403, byte i) {
	try {
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = ((Player) class403.aClass365_Sub1_Sub1_Sub2_5242).method4470(true, -1660599936);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4694(Class403 class403, byte i) {
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = Class82_Sub6.aClass7Array6846[i_10_].aString92;
	    else
