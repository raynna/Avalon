...
public abstract class Class247 {
    ...
    RsByteBuffer aClass298_Sub53_2737;
	...
	try {
	    ...
	    class298_sub37_sub16_sub1.aByte10003 = i_1_;
	    class298_sub37_sub16_sub1.aBoolean9672 = bool;
	    if (bool) {
		if (method2348(2080324549) >= 50)
		    throw new RuntimeException();
		this.aClass461_2736.method5982(class298_sub37_sub16_sub1, (byte) -14);
	    } else {
		if (method2341(144457290) >= 20)
		    throw new RuntimeException();
		this.aClass461_2738.method5982(class298_sub37_sub16_sub1, (byte) -22);
	    }
	...
	try {
	    return (this.aClass461_2738.method5986((short) -13891) + this.aClass461_2732.method5986((short) -16314));
	}
	catch (RuntimeException runtimeexception) {
    ...
    Class247() {
	this.aClass461_2738 = new Class461();
	this.aClass461_2732 = new Class461();
	this.aClass298_Sub53_2744 = new RsByteBuffer(6);
	this.aByte2743 = (byte) 0;
	anInt2735 = 0;
	anInt2745 = 0;
	this.aClass298_Sub53_2737 = new RsByteBuffer(10);
    }
	...
	try {
	    return (this.aClass461_2736.method5986((short) -18478) + this.aClass461_2742.method5986((short) -10486));
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2363(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
	    class105.aBoolean1181 = (class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]) == 1;
    ...
    static final void method2364(Class403 class403, byte i) {
	try {
	...
	try {
		...
		return 0;
	    int i_5_ = (946432351 * class298_sub37_sub15.anInt9662);
    ...
    static final void method2367(Class403 class403, int i) {
	try {
		...
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = -530122905 * class298_sub52.anInt7608;
    ...
    static final void method2369(Class403 class403, int i) {
	try {
	...
	try {
		...
		String string = new StringBuilder().append(class25.INCOMMING_PACKET != null ? (2075990793 * class25.INCOMMING_PACKET.anInt2187) : -1).append(Class26.aString353).append(class25.aClass202_345 != null ? (2075990793 * class25.aClass202_345.anInt2187) : -1).append(Class26.aString353).append(null != class25.aClass202_348 ? (2075990793 * class25.aClass202_348.anInt2187) : -1).append(" ").append(class25.anInt336 * -866602563).append(Class26.aString353).append(-1760580017 * class341.gameSceneBaseX + (Class287.myPlayer.scenePositionXQueue[0])).append(Class26.aString353).append(283514611 * class341.gameSceneBaseY + (Class287.myPlayer.scenePositionYQueue[0])).append(" ").toString();
		for (int i_8_ = 0; (i_8_ < -866602563 * class25.anInt336 && i_8_ < 50); i_8_++)
		    string = new StringBuilder().append(string).append(class25.aClass298_Sub53_Sub2_333.buffer[i_8_]).append(Class26.aString353).toString();
	...
	try {
		...
		for (int i_9_ = 0; i_9_ < client.anInt8687 * -1625219821; i_9_++) {
		    ...
		    class298_sub36.out.writeByte(interface16.method218((byte) -114));
		    class298_sub36.out.putTriByte((int) l, (byte) 52);
		}
		...
		class298_sub36.out.writeShort128((int) client.aFloat8757 >> 3);
		class298_sub36.out.writeShortLE((int) client.aFloat8949 >> 3, 1908840395);
		...
		class298_sub36.out.writeByte(Class422_Sub7.aBoolean8385 ? 1 : 0);
		...
		int i_10_ = (385051775 * class298_sub36.out.index);
		RsByteBuffer class298_sub53 = Class422_Sub25.aClass298_Sub48_8425.method3542(-49990428);
		class298_sub36.out.writeBytes(class298_sub53.buffer, 0, 385051775 * class298_sub53.index, (short) -16962);
		class298_sub36.out.method3649((class298_sub36.out.index * 385051775) - i_10_, (byte) -113);
    ...
    static final void method2373(Class403 class403, byte i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_21_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    int i_22_ = (class403.anIntArray5244[1 + class403.anInt5239 * 681479919]);
	    Class461 class461 = Class301.method3693(i_21_ >> 14 & 0x3fff, i_21_ & 0x3fff);
	    boolean bool = false;
	    for (MapDetails class298_sub37_sub13 = (MapDetails) class461.method5984(1544902477); class298_sub37_sub13 != null; class298_sub37_sub13 = ((MapDetails) class461.method5985(1578702645))) {
		if (-947282109 * class298_sub37_sub13.fileId == i_22_) {
		    bool = true;
		    break;
		}
	    }
    ...
    static final void method2374(Class403 class403, int i) {
	try {
	...
	try {
		...
		if (Class214.method1993(946432351 * (class298_sub37_sub15.anInt9662), 1804726647))
