...
public class Class298_Sub32_Sub16 extends Class298_Sub32 {
	...
	if (aClass239_7380.aBoolean2607) {
	    int i_0_ = (-1474554145 * Class250.anInt2755 / (-277601971 * this.anInt9410));
	    int i_1_ = (Class250.anInt2756 * 461985445 / (1955421883 * this.anInt9409));
	    int[][] is_2_;
	    if (i_1_ > 0) {
		int i_3_ = i % i_1_;
	...
	try {
	    switch (i) {
		case 1:
		    this.anInt9409 = class298_sub53.readUnsignedByte() * 853096051;
		    break;
		case 0:
		    this.anInt9410 = class298_sub53.readUnsignedByte() * -637796475;
		    break;
	    }
	}
	...
	try {
	    ...
	    if (aClass239_7380.aBoolean2607) {
		int i_15_ = (-1474554145 * Class250.anInt2755 / (-277601971 * this.anInt9410));
		int i_16_ = (Class250.anInt2756 * 461985445 / (1955421883 * this.anInt9409));
		int[][] is_17_;
		if (i_16_ > 0) {
		    int i_18_ = i % i_16_;
	...
	if (aClass257_7384.aBoolean2810) {
	    int i_28_ = (Class250.anInt2755 * -1474554145 / (-277601971 * this.anInt9410));
	    int i_29_ = (Class250.anInt2756 * 461985445 / (1955421883 * this.anInt9409));
	    int[] is_30_;
	    if (i_29_ > 0) {
		int i_31_ = i % i_29_;
	...
	try {
	    ...
	    if (aClass257_7384.aBoolean2810) {
		int i_35_ = (Class250.anInt2755 * -1474554145 / (-277601971 * this.anInt9410));
		int i_36_ = (Class250.anInt2756 * 461985445 / (1955421883 * this.anInt9409));
		int[] is_37_;
		if (i_36_ > 0) {
		    int i_38_ = i % i_36_;
	...
	if (aClass257_7384.aBoolean2810) {
	    int i_41_ = (Class250.anInt2755 * -1474554145 / (-277601971 * this.anInt9410));
	    int i_42_ = (Class250.anInt2756 * 461985445 / (1955421883 * this.anInt9409));
	    int[] is_43_;
	    if (i_42_ > 0) {
		int i_44_ = i % i_42_;
	...
	if (aClass239_7380.aBoolean2607) {
	    int i_47_ = (-1474554145 * Class250.anInt2755 / (-277601971 * this.anInt9410));
	    int i_48_ = (Class250.anInt2756 * 461985445 / (1955421883 * this.anInt9409));
	    int[][] is_49_;
	    if (i_48_ > 0) {
		int i_50_ = i % i_48_;
