...
public class Class438_Sub2 extends Class438 {
	...
	Class209.method1938(class391, i, this.aClass365_Sub1_8440, -463239640);
    }

    @Override
    void method5837(Class391 class391, int i, byte i_0_) {
	try {
	    Class209.method1938(class391, i, this.aClass365_Sub1_8440, -1175411035);
	}
	...
	try {
	    ObjectDefinitions class432 = client.aClass283_8716.method2641(1998541007).getObjectDefinitions(interface3.method32((byte) 21));
	    if (-1 == -1204256389 * class432.anInt5400)
		return true;
	    Class496 class496 = Class120.aClass487_1463.method6159((class432.anInt5400 * -1204256389), -2130110173);
