...
public class Class173 {
	...
	try {
		...
		if (class298_sub2 == null)
			...
			class365_sub1_sub4_sub1.method4341(i_5_ << 265, i_13_, i_6_ << 265);
	...
	try {
	    ...
	    int i_16_ = (int) (7051297995265073167L * class298_sub51.hash);
		...
		if (class298_sub51_17_.clipped * 27137839 == 3) {
		    int i_18_ = (int) (7051297995265073167L * class298_sub51_17_.hash);
		    if (i_18_ >>> 16 == i_15_)
	...
	try {
	    Class_xa.cameraLookViewLocalX = 446226445 * viewLocalX;
	    IPAddress.cameraLookViewLocalY = viewLocalY * 2019382975;
	    Class18.cameraLookViewZ = viewZ * 584728181;
	    Class128_Sub1.cameraLookSpeed1 = -759692387 * speed1;
	    Class427.cameraLookSpeed2 = -2064447825 * speed2;
	    if (Class427.cameraLookSpeed2 * 1179258959 >= 100) {
		int i_24_ = -589460992 * Class_xa.cameraLookViewLocalX + 256;
		int i_25_ = 1647476224 * IPAddress.cameraLookViewLocalY + 256;
		int i_26_ = (Class356.method4271(i_24_, i_25_, Class99.anInt952 * 1855729883, -1477224800) - Class18.cameraLookViewZ * 771695069);
		...
		int i_30_ = (int) Math.sqrt(i_29_ * i_29_ + i_27_ * i_27_);
		client.anInt8756 = ((int) (Math.atan2(i_28_, i_30_) * 2607.5945876176133) & 0x3fff) * -648269561;
		Class135.anInt6384 = ((int) (Math.atan2(i_27_, i_29_) * -2607.5945876176133) & 0x3fff) * -1587695039;
    ...
    static final void method1825(Class403 class403, int i) {
	try {
