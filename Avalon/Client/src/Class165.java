...
public class Class165 implements Interface5 {
    ...
    static final void method1781(IComponentDefinition class105, Class119 class119, Class403 class403, short i) {
	try {
		...
		Class302_Sub2.method3720(-440872681 * class105.ihash, (byte) 12);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (1343198193 * class468.maleEquipModelId1 >= 0 || 1585491093 * class468.femaleEquipModelId1 >= 0)
	        is[i_9_++] = i_10_;
	    }
    ...
    static final void method1784(Class403 class403, byte i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_13_;
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_14_;
	}
	catch (RuntimeException runtimeexception) {
