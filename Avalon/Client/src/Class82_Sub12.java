...
public class Class82_Sub12 extends Class82 {
	...
	this.anInt6862 = class298_sub53.readUnsignedShort() * 1766759643;
	int i = class298_sub53.readInt((byte) 125);
	this.anInt6863 = 1505574095 * (i >>> 16);
	this.anInt6867 = 1475544545 * (i & 0xffff);
	this.anInt6865 = class298_sub53.readUnsignedByte() * 472584765;
	this.anInt6866 = class298_sub53.method3645(590991010) * -1870262095;
    }
	...
	try {
		...
		for (int i_1_ = 0; i_1_ < i_0_; i_1_++) {
			...
			class298_sub36.out.writeShort(is[i_1_], 16711935);
			class298_sub36.out.writeIntV2(1262526353 * Class379.anInt4099);
			class298_sub36.out.writeShortLE128(client.anInt8836 * 392084321);
			class298_sub36.out.write128Byte(0, (byte) 1);
			client.aClass25_8711.method390(class298_sub36, (byte) -11);
			int i_2_ = class365_sub1_sub1_sub2_sub2.getSize();
			Routes.findRoute(class365_sub1_sub1_sub2_sub2.scenePositionXQueue[0], class365_sub1_sub1_sub2_sub2.scenePositionYQueue[0], true, Routes.createEntityStrategy((class365_sub1_sub1_sub2_sub2.scenePositionXQueue[0]), (class365_sub1_sub1_sub2_sub2.scenePositionYQueue[0]), i_2_, i_2_, 0));
			bool = true;
			break;
		    }
		}
