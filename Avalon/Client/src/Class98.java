...
public abstract class Class98 {
	...
	this.anInt948 = i * -1209403731;
	this.anInt947 = -2125519021 * i_0_;
	this.anInt946 = -1733764677 * i_1_;
    }
	...
	try {
		...
		if (client.aClass283_8716.method2675(-1611682495) != null && (!client.aBoolean8835 || (-112110875 * Class298.anInt3192 & 0x40) != 0)) {
		    int i_18_ = -1;
		    int i_19_ = -1;
		    float f = (i_16_ * 2.0F / (Class436.anInt5491 * 2125992951) - 1.0F);
		    float f_20_ = ((2.0F * i_17_ / (971707205 * Class436.anInt5492)) - 1.0F);
			...
			if (client.aBoolean8835 && (-112110875 * Class298.anInt3192 & 0x40) != 0) {
				...
				Class234.method2174((Tradution.aClass470_5910.method6049(Class321.aClass429_3357, -875414210)), "", -1, 60, -1, 0L, i_18_, i_19_, true, false, i_18_ << 32 | i_19_, true, -1698149123);
			    Class234.method2174(Class82_Sub6.aString6845, "", client.anInt8822 * -1471730241, 23, -1, 0L, i_18_, i_19_, true, false, i_18_ << 32 | i_19_, true, -1114825452);
			}
		    }
		}
		...
		while (iterator.hasNext()) {
			...
			if (class335.aClass365_Sub1_3616 instanceof Player) {
				...
				for (int i_41_ = 0; i_41_ < -1230451913 * client.anInt8703; i_41_++) {
				    Class298_Sub29 class298_sub29 = ((Class298_Sub29) (client.aClass437_8696.method5812(client.anIntArray8699[i_41_])));
					...
					if (443738891 * client.ticketCycle != (class365_sub1_sub1_sub2_sub1.anInt10070) * 335731285) {
						...
						int i_43_ = ((int) (class217_42_.aFloat2451) - (((class365_sub1_sub1_sub2_sub1.aClass503_10190.size) * -2095128707) - 1 << 8));
						int i_44_ = ((int) (class217_42_.aFloat2454) - ((-2095128707 * (class365_sub1_sub1_sub2_sub1.aClass503_10190.size)) - 1 << 8));
						if (i_43_ >= i_39_ && (((class365_sub1_sub1_sub2_sub1.aClass503_10190.size) * -2095128707) <= ((class365_sub1_sub1_sub2_sub2.getSize()) - (i_43_ - i_39_ >> 9))) && i_44_ >= i_40_ && (((class365_sub1_sub1_sub2_sub1.aClass503_10190.size) * -2095128707) <= ((class365_sub1_sub1_sub2_sub2.getSize()) - (i_44_ - i_40_ >> 9)))) {
						    Class140.method1555(class365_sub1_sub1_sub2_sub1, ((Class287.myPlayer.plane) != (class335.aClass365_Sub1_3616.plane)), (byte) -10);
						    class365_sub1_sub1_sub2_sub1.anInt10070 = (-339947553 * client.ticketCycle);
						}
					    }
					}
				    }
				...
				for (int i_46_ = 0; i_46_ < i_45_; i_46_++) {
				    ...
				    if ((null != class365_sub1_sub1_sub2_sub2_47_) && (443738891 * client.ticketCycle != (335731285 * (class365_sub1_sub1_sub2_sub2_47_.anInt10070))) && (class365_sub1_sub1_sub2_sub2 != class365_sub1_sub1_sub2_sub2_47_)) {
					if (!class365_sub1_sub1_sub2_sub2_47_.aBoolean10123) {
						...
						class365_sub1_sub1_sub2_sub2_47_.anInt10070 = (client.ticketCycle * -339947553);
					    }
					}
				    }
				}
			    }
			    if (443738891 * client.ticketCycle == 335731285 * (class365_sub1_sub1_sub2_sub2.anInt10070)) {
				if (i_15_ == 202437353) {
				    /* empty */
				}
				continue;
			    ...
			    class365_sub1_sub1_sub2_sub2.anInt10070 = -339947553 * client.ticketCycle;
			}
			if (class335.aClass365_Sub1_3616 instanceof NPC) {
				...
				if ((0 == ((-2095128707 * (class365_sub1_sub1_sub2_sub1.aClass503_10190.size)) & 0x1) && 0 == ((int) class217.aFloat2451 & 0x1ff) && (((int) class217.aFloat2454 & 0x1ff) == 0)) || (((-2095128707 * (class365_sub1_sub1_sub2_sub1.aClass503_10190.size)) & 0x1) == 1 && (((int) class217.aFloat2451 & 0x1ff) == 256) && (((int) class217.aFloat2454 & 0x1ff) == 256))) {
				    int i_51_ = ((int) class217.aFloat2451 - (((-2095128707 * (class365_sub1_sub1_sub2_sub1.aClass503_10190.size)) - 1) << 8));
				    int i_52_ = ((int) class217.aFloat2454 - (((class365_sub1_sub1_sub2_sub1.aClass503_10190.size) * -2095128707) - 1 << 8));
				    for (int i_53_ = 0; (i_53_ < client.anInt8703 * -1230451913); i_53_++) {
					Class298_Sub29 class298_sub29 = ((Class298_Sub29) (client.aClass437_8696.method5812(client.anIntArray8699[i_53_])));
					if (class298_sub29 == null) {
					    ...
					    if (((335731285 * (class365_sub1_sub1_sub2_sub1_54_.anInt10070)) != (client.ticketCycle * 443738891)) && (class365_sub1_sub1_sub2_sub1_54_ != class365_sub1_sub1_sub2_sub1)) {
						if (!class365_sub1_sub1_sub2_sub1_54_.aBoolean10123) {
						    ...
						    int i_56_ = ((int) (class217_55_.aFloat2451) - (((class365_sub1_sub1_sub2_sub1_54_.aClass503_10190.size) * -2095128707) - 1 << 8));
						    int i_57_ = ((int) (class217_55_.aFloat2454) - (((-2095128707 * (class365_sub1_sub1_sub2_sub1_54_.aClass503_10190.size)) - 1) << 8));
						    if (i_56_ >= i_51_ && ((-2095128707 * (class365_sub1_sub1_sub2_sub1_54_.aClass503_10190.size)) <= (((class365_sub1_sub1_sub2_sub1.aClass503_10190.size) * -2095128707) - ((i_56_ - i_51_) >> 9))) && i_57_ >= i_52_ && ((-2095128707 * (class365_sub1_sub1_sub2_sub1_54_.aClass503_10190.size)) <= ((-2095128707 * (class365_sub1_sub1_sub2_sub1.aClass503_10190.size)) - ((i_57_ - i_52_) >> 9)))) {
							Class140.method1555(class365_sub1_sub1_sub2_sub1_54_, ((class335.aClass365_Sub1_3616.plane) != (Class287.myPlayer.plane)), (byte) -62);
							class365_sub1_sub1_sub2_sub1_54_.anInt10070 = (-339947553 * (client.ticketCycle));
						    }
						}
					    }
					}
					...
					if ((null != class365_sub1_sub1_sub2_sub2) && ((335731285 * (class365_sub1_sub1_sub2_sub2.anInt10070)) != (client.ticketCycle * 443738891))) {
						...
						if (i_61_ >= i_51_ && ((class365_sub1_sub1_sub2_sub2.getSize()) <= (((class365_sub1_sub1_sub2_sub1.aClass503_10190.size) * -2095128707) - (i_61_ - i_51_ >> 9))) && i_62_ >= i_52_ && ((class365_sub1_sub1_sub2_sub2.getSize()) <= ((-2095128707 * (class365_sub1_sub1_sub2_sub1.aClass503_10190.size)) - (i_62_ - i_52_ >> 9)))) {
				...
				if ((class365_sub1_sub1_sub2_sub1.anInt10070 * 335731285) == 443738891 * client.ticketCycle) {
				    if (i_15_ == 202437353)
					throw new IllegalStateException();
				    continue;
				}
				Class140.method1555(class365_sub1_sub1_sub2_sub1, ((Class287.myPlayer.plane) != (class335.aClass365_Sub1_3616.plane)), (byte) -73);
				class365_sub1_sub1_sub2_sub1.anInt10070 = client.ticketCycle * -339947553;
			    }
			}
			if (class335.aClass365_Sub1_3616 instanceof Class365_Sub1_Sub4_Sub1) {
			    ...
			    Class298_Sub2 class298_sub2 = ((Class298_Sub2) (client.aClass437_8685.method5812((class335.aClass365_Sub1_3616.plane) << 28 | i_64_ << 14 | i_63_)));
				...
				while (class298_sub12 != null) {
					...
					if (0 != ((Class298.anInt3192 * -112110875) & 0x1) && (null == class497 || ((class468.method6037((831522399 * Class132.anInt1508), (-388931549 * class497.anInt6100), -2028636758)) != (-388931549 * (class497.anInt6100)))))
					    Class234.method2174(client.aString8838, new StringBuilder().append(client.aString8754).append(" ").append(Class26.aString351).append(" ").append(Class285.method2709(i_66_, -1803338083)).append(class468.name).toString(), (Class240.anInt2704 * 697885143), 17, -1, (class298_sub12.anInt7257) * 1768239597, i_36_, i_37_, true, false, i_65_, false, -1282887596);
				    }
					...
					for (int i_67_ = strings.length - 1; i_67_ >= 0; i_67_--) {
						...
						Class234.method2174(strings[i_67_], new StringBuilder().append(Class285.method2709(i_66_, -1300852022)).append(class468.name).toString(), i_69_, i_68_, -1, (class298_sub12.anInt7257) * 1768239597, i_36_, i_37_, true, false, i_65_, false, -1707817875);
					    }
					}
				    }
			...
			if (class335.aClass365_Sub1_3616 instanceof Interface3) {
				...
				if (client.aBoolean8835 && (class335.aClass365_Sub1_3616.plane == (Class287.myPlayer.plane))) {
					...
					Class234.method2174(client.aString8838, new StringBuilder().append(client.aString8754).append(" ").append(Class26.aString351).append(" ").append(Class285.method2709(65535, -1704073338)).append(class432.name).toString(), Class240.anInt2704 * 697885143, 2, -1, Class119.method1301(interface3, i_36_, i_37_, 2139321433), i_36_, i_37_, true, false, interface3.hashCode(), false, -978621849);
				}
				if (class335.aClass365_Sub1_3616.plane == (Class287.myPlayer.plane)) {
					...
					for (int i_70_ = strings.length - 1; i_70_ >= 0; i_70_--) {
						...
						Class234.method2174(strings[i_70_], new StringBuilder().append(Class285.method2709(65535, -1882925758)).append(class432.name).toString(), i_72_, i_71_, -1, (Class119.method1301(interface3, i_36_, i_37_, 2141756436)), i_36_, i_37_, true, false, interface3.hashCode(), false, -1317659949);
					    }
					}
				    }
				}
    ...
    static final void method1056(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -1567522756;
	    int i_73_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    boolean bool = 1 == (class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]);
	    int i_74_ = (class403.anIntArray5244[class403.anInt5239 * 681479919 + 2]);
	    boolean bool_75_ = ((class403.anIntArray5244[3 + 681479919 * class403.anInt5239]) == 1);
	...
	try {
	    Class298_Sub37_Sub12 class298_sub37_sub12 = Class410.method4985(3, i);
	    class298_sub37_sub12.method3449((byte) 104);
	    class298_sub37_sub12.aString9611 = string;
	}
	catch (RuntimeException runtimeexception) {
