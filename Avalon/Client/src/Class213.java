...
public abstract class Class213 {
	...
	for (int i_7_ = 0; i_7_ < i_1_; i_7_++) {
		...
		for (int i_9_ = 0; i_9_ < i; i_9_++) {
		    for (int i_10_ = 0; i_10_ < this.anInt2443; i_10_++) {
			int i_11_ = this.aShortArray2436[i_10_] << 12;
			int i_12_ = this.anInt2440 * i_11_ >> 12;
			int i_13_ = this.anInt2438 * i_11_ >> 12;
			int i_14_ = this.anInt2442 * i_11_ >> 12;
			int i_15_ = is[i_9_] * i_11_ >> 12;
			int i_16_ = is_2_[i_8_] * i_11_ >> 12;
			int i_17_ = is_3_[i_7_] * i_11_ >> 12;
			i_15_ *= this.anInt2440;
			i_16_ *= this.anInt2438;
			i_17_ *= this.anInt2442;
			int i_18_ = i_15_ >> 12;
			int i_19_ = i_18_ + 1;
			i_18_ &= 0xff;
			int i_20_ = i_16_ >> 12;
			...
			int i_30_ = this.aShortArray2434[i_22_];
			int i_31_ = this.aShortArray2434[i_23_];
			int i_32_ = this.aShortArray2434[i_20_ + i_30_];
			int i_33_ = this.aShortArray2434[i_21_ + i_30_];
			int i_34_ = this.aShortArray2434[i_20_ + i_31_];
			int i_35_ = this.aShortArray2434[i_21_ + i_31_];
			int i_36_ = method1965((this.aShortArray2434[i_18_ + i_32_]), i_15_, i_16_, i_17_);
			int i_37_ = method1965((this.aShortArray2434[i_19_ + i_32_]), i_27_, i_16_, i_17_);
			int i_38_ = i_36_ + (i_24_ * (i_37_ - i_36_) >> 12);
			i_36_ = method1965((this.aShortArray2434[i_18_ + i_33_]), i_15_, i_28_, i_17_);
			i_37_ = method1965((this.aShortArray2434[i_19_ + i_33_]), i_27_, i_28_, i_17_);
			int i_39_ = i_36_ + (i_24_ * (i_37_ - i_36_) >> 12);
			int i_40_ = i_38_ + (i_25_ * (i_39_ - i_38_) >> 12);
			i_36_ = method1965((this.aShortArray2434[i_18_ + i_34_]), i_15_, i_16_, i_29_);
			i_37_ = method1965((this.aShortArray2434[i_19_ + i_34_]), i_27_, i_16_, i_29_);
			i_38_ = i_36_ + (i_24_ * (i_37_ - i_36_) >> 12);
			i_36_ = method1965((this.aShortArray2434[i_18_ + i_35_]), i_15_, i_28_, i_29_);
			i_37_ = method1965((this.aShortArray2434[i_19_ + i_35_]), i_27_, i_28_, i_29_);
    ...
    void method1962() {
	this.aShortArray2436 = new short[this.anInt2443];
	for (int i = 0; i < this.anInt2443; i++)
	    this.aShortArray2436[i] = (short) (int) Math.pow(2.0, i);
    }
    ...
    void method1964() {
	Random random = new Random(this.anInt2439);
	for (int i = 0; i < 255; i++)
	    this.aShortArray2434[i] = (short) i;
	for (int i = 0; i < 255; i++) {
	    int i_47_ = 255 - i;
	    int i_48_ = Class298_Sub19_Sub3.method3039(random, i_47_, (byte) -33);
	    short i_49_ = this.aShortArray2434[i_48_];
	    this.aShortArray2434[i_48_] = this.aShortArray2434[i_47_];
	    this.aShortArray2434[i_47_] = this.aShortArray2434[i_47_ + 256] = i_49_;
	}
    }
	...
	this.anInt2443 = 4;
	this.anInt2439 = i;
	this.anInt2440 = i_59_;
	this.anInt2438 = i_60_;
	this.anInt2442 = i_61_;
	this.anInt2443 = i_58_;
	method1962();
	method1964();
    }
