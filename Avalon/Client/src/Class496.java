...
public class Class496 {
	...
	try {
	    return this.aClass487_6095.aClass243_6068.method2310(anInt6097 * 1690480405, -457216440);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    if (null != class89) {
		IndexedImage class89_2_ = class89;
		IndexedImage class89_3_ = class89;
		IndexedImage class89_4_ = class89;
		class89.anInt811 = 0;
    ...
    static final void method6200(Class403 class403, int i) {
	try {
	    int i_7_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    if (null != Class301_Sub1.aClass437_7636) {
		Class298 class298 = Class301_Sub1.aClass437_7636.method5812(i_7_);
    ...
    static final void method6201(Class403 class403, int i) {
	try {
	...
	try {
		...
		for (int i = 0; i < 256; i++) {
		    int i_9_ = (int) (Math.pow(i / 255.0, d) * 255.0);
    ...
    static final void method6203(Class403 class403, int i) {
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = class105.aStringArray1195[i_11_];
	}
	catch (RuntimeException runtimeexception) {
