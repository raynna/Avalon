...
public class Class380 {
    ...
    static final void method4676(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_2_;
	}
    ...
    static final void method4677(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-706712654);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    class298_sub36.out.writeShortLE128(class105_3_.anInt1280 * -1232467723);
	    class298_sub36.out.writeIntV1(class105.ihash * -440872681, (byte) -22);
	    class298_sub36.out.writeInt(class105_3_.ihash * -440872681, -855626208);
	    class298_sub36.out.writeShort(-1309843523 * class105.anInt1154, 16711935);
	    class298_sub36.out.writeShortLE128(class105_3_.anInt1154 * -1309843523);
	    class298_sub36.out.writeShortLE(class105.anInt1280 * -1232467723, 1472780126);
    ...
    static final void method4680(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub7_7581.method5648(1496111936) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4681(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
