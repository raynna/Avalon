...
public class Class264_Sub3 extends Class264 {
	...
	OpenGL.glTranslatef(i, i_0_, 0.0F);
	...
	float f_6_ = (class30_sub2_sub1.aFloat9051 / class30_sub2_sub1.anInt9047);
	OpenGL.glTexGenfv(8192, 9474, new float[] { f, 0.0F, 0.0F, -i_4_ * f }, 0);
	OpenGL.glTexGenfv(8193, 9474, new float[] { 0.0F, f_6_, 0.0F, -i_5_ * f_6_ }, 0);
	OpenGL.glEnable(3168);
	OpenGL.glEnable(3169);
	OpenGL.glColor4ub((byte) (i_3_ >> 16), (byte) (i_3_ >> 8), (byte) i_3_, (byte) (i_3_ >> 24));
	OpenGL.glTranslatef(i, i_2_, 0.0F);
	this.aClass28_7130.method404(c);
	OpenGL.glLoadIdentity();
	...
	OpenGL.glTexGeni(8193, 9472, 9216);
	float f = (class30_sub2_sub1.aFloat9049 / class30_sub2_sub1.anInt9048);
	float f_11_ = (class30_sub2_sub1.aFloat9051 / class30_sub2_sub1.anInt9047);
	OpenGL.glTexGenfv(8192, 9474, new float[] { f, 0.0F, 0.0F, -i_9_ * f }, 0);
	OpenGL.glTexGenfv(8193, 9474, new float[] { 0.0F, f_11_, 0.0F, -i_10_ * f_11_ }, 0);
	OpenGL.glEnable(3168);
	OpenGL.glEnable(3169);
	OpenGL.glColor4ub((byte) (i_8_ >> 16), (byte) (i_8_ >> 8), (byte) i_8_, (byte) (i_8_ >> 24));
	OpenGL.glTranslatef(i, i_7_, 0.0F);
	this.aClass28_7130.method404(c);
	OpenGL.glLoadIdentity();
	OpenGL.glDisable(3168);
	OpenGL.glDisable(3169);
	...
	OpenGL.glTranslatef(i, i_12_, 0.0F);
	this.aClass28_7130.method404(c);
	OpenGL.glLoadIdentity();
	if (this.aBoolean7131 || bool)
	    this.aClass_ra_Sub2_7129.method5259(0, 5890, 768);
	...
	OpenGL.glTranslatef(i, i_14_, 0.0F);
	this.aClass28_7130.method404(c);
	OpenGL.glLoadIdentity();
	if (this.aBoolean7131 || bool)
	    this.aClass_ra_Sub2_7129.method5259(0, 5890, 768);
    ...
    Class264_Sub3(Class_ra_Sub2 class_ra_sub2, Class505 class505, IndexedImage[] class89s, boolean bool) {
	super(class_ra_sub2, class505);
	this.aClass_ra_Sub2_7129 = class_ra_sub2;
	int i = 0;
	for (int i_16_ = 0; i_16_ < 256; i_16_++) {
	    IndexedImage class89 = class89s[i_16_];
	...
	if (bool) {
		...
		IndexedImage class89 = class89s[i_18_];
		...
		IndexedImage class89 = class89s[i_31_];
	...
	float f = (this.aClass30_Sub2_Sub1_7128.aFloat9049 / (this.aClass30_Sub2_Sub1_7128.anInt9048));
	float f_46_ = (this.aClass30_Sub2_Sub1_7128.aFloat9051 / (this.aClass30_Sub2_Sub1_7128.anInt9047));
	for (int i_47_ = 0; i_47_ < 256; i_47_++) {
	    IndexedImage class89 = class89s[i_47_];
	    int i_48_ = class89.anInt816;
	    int i_49_ = class89.anInt812;
	    int i_50_ = class89.anInt811;
	    int i_51_ = class89.anInt815;
	    float f_52_ = i_47_ % 16 * i;
	    float f_53_ = i_47_ / 16 * i;
	    float f_54_ = f_52_ * f;
	    float f_55_ = f_53_ * f_46_;
	    float f_56_ = (f_52_ + i_49_) * f;
	    float f_57_ = (f_53_ + i_48_) * f_46_;
