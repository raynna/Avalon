...
public class NPC extends Entity {
	...
	if (aClass503_10190 != null && (this.aBoolean10128 || method4454(class_ra, 0, 498700808))) {
	    ...
	    method4445(class_ra, aClass387Array10082, class222, this.aBoolean10128, 1604637699);
	...
	try {
		...
		this.anInt10122 = (int) (-661498661 * (this.anInt10122) - i_4_ / 10.0F) * 1394444115;
	    } else
		...
		if (null != aClass387Array10082[i_7_])
		    this.aBoolean10129 |= aClass387Array10082[i_7_].i();
	...
	try {
		...
		i |= 0x7;
	    boolean bool = (0 != aByte10130 && 443738891 * client.ticketCycle >= anInt10105 * 1920148979 && client.ticketCycle * 443738891 < anInt10106 * 1953154657);
	    if (bool)
		i |= 0x80000;
		...
		if (0 != (this.anInt10097 * -155466425))
		    aClass387Array10082[0].t(this.anInt10097 * -155466425);
		if ((this.anInt10073 * -197572281) != 0)
		    aClass387Array10082[0].EA(-197572281 * this.anInt10073);
		if ((this.anInt10074 * -104151209) != 0)
		    aClass387Array10082[0].ia(0, this.anInt10074 * -104151209, 0);
	    } else
	...
	try {
		...
		class222.method2070(method4347());
		class222.method2064(0.0F, -5.0F, 0.0F);
		method4445(class_ra, aClass387Array10082, class222, this.aBoolean10128, 1317836884);
	...
	try {
	    ...
	    class217.aFloat2451 = (i_22_ << 8) + (scenePositionXQueue[0] << 9);
	    class217.aFloat2454 = (scenePositionYQueue[0] << 9) + (i_22_ << 8);
	    method4340(class217);
	    class217.method2006();
	    if (this.aClass351_10067 != null)
	...
	try {
	    if (this.aClass62_10118 != null && (this.aClass62_10118).aString608 == null)
		return null;
	...
	Class326 class326 = (aClass331_7722.aClass326ArrayArrayArray3516[plane][(int) class235.aClass217_2599.aFloat2451 >> 9][(int) class235.aClass217_2599.aFloat2454 >> 9]);
	if (null != class326 && null != class326.aClass365_Sub1_Sub2_3461) {
	    int i_42_ = ((this.anInt10122 * -661498661) - class326.aClass365_Sub1_Sub2_3461.aShort9801);
	    this.anInt10122 = (int) (-661498661 * (this.anInt10122) - i_42_ / 10.0F) * 1394444115;
	} else
	    this.anInt10122 = (int) (-661498661 * (this.anInt10122) - (this.anInt10122) * -661498661 / 10.0F) * 1394444115;
	...
	for (int i_45_ = 0; i_45_ < aClass387Array10082.length; i_45_++) {
		...
		this.aBoolean10129 |= aClass387Array10082[i_45_].i();
	...
	if (aClass503_10190 != null && (this.aBoolean10128 || method4454(class_ra, 0, -1590633829))) {
	    ...
	    class222.method2070(method4347());
	    class222.method2064(0.0F, -5.0F, 0.0F);
	    method4445(class_ra, aClass387Array10082, class222, this.aBoolean10128, -935143388);
	    for (int i = 0; i < aClass387Array10082.length; i++)
		aClass387Array10082[i] = null;
	}
    }
