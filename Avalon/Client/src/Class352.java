...
public class Class352 {
	...
	try {
		...
		this.anInt3797 = class298_sub53.readUnsignedShort() * 1896723045;
		if (65535 == -539447443 * this.anInt3797)
		    this.anInt3797 = -1896723045;
		this.anInt3798 = class298_sub53.readUnsignedShort() * -1225014007;
		if (-869705415 * this.anInt3798 == 65535)
		    this.anInt3798 = 1225014007;
		this.anInt3795 = class298_sub53.readInt((byte) -62) * -166802393;
		this.anInt3796 = class298_sub53.readInt((byte) -20) * -1288246043;
	    } else if (i >= 10 && i <= 14)
		...
		this.anInt3794 = class298_sub53.readBigSmart(1235052657) * -1998808761;
	    else if (19 == i)
		anInt3817 = class298_sub53.readUnsignedShort() * -1012984825;
	    else if (20 == i) {
		this.anInt3801 = class298_sub53.readUnsignedShort() * -1125434795;
		if (this.anInt3801 * 769127165 == 65535)
		    this.anInt3801 = 1125434795;
		this.anInt3790 = class298_sub53.readUnsignedShort() * -1435131889;
		if (-1461367057 * this.anInt3790 == 65535)
		    this.anInt3790 = 1435131889;
		this.anInt3815 = class298_sub53.readInt((byte) 28) * 1428832641;
		this.anInt3800 = class298_sub53.readInt((byte) 99) * 1701861307;
	    } else if (i == 21)
		...
		if (this.aClass437_3811 == null) {
		    ...
		    this.aClass437_3811 = new HashTable(i_9_);
		}
	...
	try {
		...
		i_13_ = interface23.method252((-869705415 * this.anInt3798), (byte) 44);
	    else if (-1 != -539447443 * this.anInt3797)
		i_13_ = interface23.method250((-539447443 * this.anInt3797), (byte) 24);
	    else
		return true;
		...
		i_14_ = interface23.method252((this.anInt3790 * -1461367057), (byte) 17);
	    else if (-1 != this.anInt3801 * 769127165)
		i_14_ = interface23.method250((this.anInt3801 * 769127165), (byte) 72);
	    else
		return true;
	    if (i_14_ < this.anInt3815 * 372768385 || i_14_ > 520017267 * this.anInt3800)
		return false;
	    return true;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (this.aClass437_3811 == null)
		return i_18_;
	    Class298_Sub35 class298_sub35 = ((Class298_Sub35) this.aClass437_3811.method5812(i));
    ...
    static final void method4242(Class403 class403, byte i) {
	try {
	    class403.anInt5239 -= -1959403445;
	    Class320.method3913((class403.anIntArray5244[681479919 * class403.anInt5239]), (class403.anIntArray5244[class403.anInt5239 * 681479919 + 1]), (class403.anIntArray5244[2 + class403.anInt5239 * 681479919]), (class403.anIntArray5244[3 + 681479919 * class403.anInt5239]), false, (class403.anIntArray5244[class403.anInt5239 * 681479919 + 4]), 2026903657);
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4243(Class403 class403, byte i) {
	try {
	    int i_20_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (Class300.aClass518_3217.method6311(i_20_, 614874976).anInt9604) * 1317156085;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4247(Class403 class403, byte i) {
	try {
	    class403.anInt5239 -= -783761378;
	    Class107.aShortArray1315[(class403.anIntArray5244[(681479919 * class403.anInt5239)])] = (short) Class86.method964((class403.anIntArray5244[(681479919 * class403.anInt5239 + 1)]), (byte) -118);
    ...
    static final void method4248(Class403 class403, byte i) {
	try {
	    int i_24_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = (Class298_Sub32_Sub14.aClass477_9400.getItemDefinitions(i_24_).name);
	}
	catch (RuntimeException runtimeexception) {
