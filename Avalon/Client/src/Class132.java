...
public class Class132 {
	...
	try {
		...
		this.anIntArray1507 = new int[i_2_];
		for (int i_3_ = 0; i_3_ < i_2_; i_3_++)
		    this.anIntArray1507[i_3_] = class298_sub53.readBigSmart(1235052657);
	    } else if (3 == i) {
		if (i_1_ != 2)
		    return;
	    } else if (40 == i) {
		int i_4_ = class298_sub53.readUnsignedByte();
		this.aShortArray1501 = new short[i_4_];
		this.aShortArray1502 = new short[i_4_];
		for (int i_5_ = 0; i_5_ < i_4_; i_5_++) {
		    this.aShortArray1501[i_5_] = (short) class298_sub53.readUnsignedShort();
		    this.aShortArray1502[i_5_] = (short) class298_sub53.readUnsignedShort();
		}
	    } else if (i == 41) {
		int i_6_ = class298_sub53.readUnsignedByte();
		this.aShortArray1503 = new short[i_6_];
		this.aShortArray1504 = new short[i_6_];
		for (int i_7_ = 0; i_7_ < i_6_; i_7_++) {
		    this.aShortArray1503[i_7_] = (short) class298_sub53.readUnsignedShort();
		    this.aShortArray1504[i_7_] = (short) class298_sub53.readUnsignedShort();
		}
	    } else if (i >= 60 && i < 70)
		this.anIntArray1505[i - 60] = class298_sub53.readBigSmart(1235052657);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (this.anIntArray1507 == null)
		return null;
	    Model[] class64s = new Model[this.anIntArray1507.length];
	    synchronized (this.aClass144_1500.aClass243_1560) {
		for (int i_8_ = 0; i_8_ < this.anIntArray1507.length; i_8_++)
		    class64s[i_8_] = Model.method751((this.aClass144_1500.aClass243_1560), (this.anIntArray1507[i_8_]), 0);
	    }
	    for (int i_9_ = 0; i_9_ < this.anIntArray1507.length; i_9_++) {
		if (class64s[i_9_].anInt630 < 13)
	    ...
	    if (null == class64)
		return null;
	    if (this.aShortArray1501 != null) {
		for (int i_10_ = 0; i_10_ < this.aShortArray1501.length; i_10_++)
		    class64.method756(this.aShortArray1501[i_10_], (this.aShortArray1502[i_10_]));
	    }
	    if (this.aShortArray1503 != null) {
		for (int i_11_ = 0; i_11_ < this.aShortArray1503.length; i_11_++)
		    class64.method752(this.aShortArray1503[i_11_], (this.aShortArray1504[i_11_]));
	    }
	    return class64;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		for (int i_12_ = 0; i_12_ < 5; i_12_++) {
		    if (-1 != this.anIntArray1505[i_12_] && !(this.aClass144_1500.aClass243_1560.method2290(this.anIntArray1505[i_12_], 0, -1795823627)))
			bool = false;
		}
	    }
	    return bool;
	...
	try {
		...
		for (int i_14_ = 0; i_14_ < 5; i_14_++) {
		    if (this.anIntArray1505[i_14_] != -1)
			class64s[i_13_++] = Model.method751(((this.aClass144_1500).aClass243_1560), (this.anIntArray1505[i_14_]), 0);
		}
	    }
	    for (int i_15_ = 0; i_15_ < 5; i_15_++) {
		if (null != class64s[i_15_] && class64s[i_15_].anInt630 < 13)
		    class64s[i_15_].method755(2);
	    }
	    Model class64 = new Model(class64s, i_13_);
	    if (null != this.aShortArray1501) {
		for (int i_16_ = 0; i_16_ < this.aShortArray1501.length; i_16_++)
		    class64.method756(this.aShortArray1501[i_16_], (this.aShortArray1502[i_16_]));
	    }
	    if (null != this.aShortArray1503) {
		for (int i_17_ = 0; i_17_ < this.aShortArray1503.length; i_17_++)
		    class64.method752(this.aShortArray1503[i_17_], (this.aShortArray1504[i_17_]));
	    }
	    return class64;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (null == this.anIntArray1507)
		return true;
	    boolean bool = true;
	    synchronized (this.aClass144_1500.aClass243_1560) {
		for (int i_18_ = 0; i_18_ < this.anIntArray1507.length; i_18_++) {
		    if (!this.aClass144_1500.aClass243_1560.method2290(this.anIntArray1507[i_18_], 0, -1755601406))
			bool = false;
		}
	    }
	    return bool;
    ...
    static final void method1478(Class403 class403, int i) {
	try {
    ...
    static final void method1479(Class403 class403, byte i) {
	try {
	    int i_20_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
		...
		if (null == string)
		    ...
		    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = string.substring(0, string.indexOf(':'));
	    }
	}
	catch (RuntimeException runtimeexception) {
