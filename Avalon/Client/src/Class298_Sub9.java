...
public class Class298_Sub9 extends Class298 {
	...
	try {
		...
		for (int i_3_ = 0; i_3_ < class350.anIntArray3732.length; i_3_++) {
			...
			is[i_3_] = this.anIntArray7226[i_4_];
		    else
			is[i_3_] = -1;
		}
	    }
	...
	try {
	    ...
	    long l = -1L;
	    l = l >>> 8 ^ ls[(int) ((l ^ i >> 8) & 0xffL)];
	    l = l >>> 8 ^ ls[(int) ((l ^ i) & 0xffL)];
	    for (int i_21_ = 0; i_21_ < is.length; i_21_++) {
		l = l >>> 8 ^ ls[(int) ((l ^ is[i_21_] >> 24) & 0xffL)];
		l = l >>> 8 ^ ls[(int) ((l ^ is[i_21_] >> 16) & 0xffL)];
		l = l >>> 8 ^ ls[(int) ((l ^ is[i_21_] >> 8) & 0xffL)];
		l = l >>> 8 ^ ls[(int) ((l ^ is[i_21_]) & 0xffL)];
	    }
	    if (null != is_19_) {
		for (int i_22_ = 0; i_22_ < 5; i_22_++)
		    l = l >>> 8 ^ ls[(int) ((l ^ is_19_[i_22_]) & 0xffL)];
	    }
	    l = l >>> 8 ^ ls[(int) ((l ^ (bool ? 1 : 0)) & 0xffL)];
	    return l;
	}
	catch (RuntimeException runtimeexception) {
