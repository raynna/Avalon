...
public abstract class Class323 {
    ...
    static final void method3946(Class403 class403, int i) {
	try {
    ...
    static final void method3947(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
    ...
    static final void method3949(Class403 class403, byte i) {
	try {
