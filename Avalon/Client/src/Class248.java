...
public class Class248 implements Runnable {
	...
	try {
	    this.aClass283_2751.method2645(class433, -441647750);
	}
	...
	try {
		...
		class267 = (Class267) this.aLinkedList2750.pollFirst();
	    }
	    do {
		try {
		    try {
	...
	try {
	    if (Class266.aClass266_2852 == class267.aClass266_2857)
		this.aClass283_2751.method2667(528640146);
	    else
		this.aClass283_2751.sendMapScene(class267, -1991819579);
	    for (boolean bool = this.aClass283_2751.method2672(-1688450979); !bool; bool = this.aClass283_2751.method2672(-770547477)) {
		/* empty */
	    }
	    this.aClass283_2751.method2673((byte) 119);
	...
	try {
	    synchronized (this.aLinkedList2750) {
		this.aLinkedList2750.add(class267);
    ...
    static final void method2386(Class403 class403, int i) {
	try {
	    String string = (String) (class403.anObjectArray5240[(class403.anInt5241 -= 969361751) * -203050393]);
	    String string_1_ = (String) (class403.anObjectArray5240[((class403.anInt5241 -= 969361751) * -203050393)]);
	    ...
	    class298_sub36.out.writeShort((Class58.method693(string, -250227687) + Class58.method693(string_1_, -433489347)), 16711935);
	    class298_sub36.out.writeString(string, 2110683902);
	    class298_sub36.out.writeString(string_1_, 2142092723);
    ...
    static final void method2387(Class403 class403, byte i) {
	try {
	    Class239.method2208((class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]), -292908966);
	}
	catch (RuntimeException runtimeexception) {
