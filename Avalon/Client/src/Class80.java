...
public class Class80 {
    ...
    static final void method854(Class403 class403, byte i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = class105.anInt1162 * 457937409;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method856(Class403 class403, int i) {
	try {
	    String string = (String) (class403.anObjectArray5240[(class403.anInt5241 -= 969361751) * -203050393]);
	    class403.anInt5239 -= -783761378;
	    int i_18_ = (class403.anIntArray5244[681479919 * class403.anInt5239]);
	    int i_19_ = (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]);
	    class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393 - 1)] = string.substring(i_18_, i_19_);
	}
	catch (RuntimeException runtimeexception) {
