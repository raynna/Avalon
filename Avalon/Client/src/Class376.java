...
public class Class376 {
    ...
    static final void method4657(Class403 class403, int i) {
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_3_;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4658(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub2_7547.method5629(-460328639) == 1 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method4660(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = (int) (Class122.method1319((byte) 1) / 60000L);
	}
	catch (RuntimeException runtimeexception) {
