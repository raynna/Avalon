...
public class Class251 {
	...
	this.aByte2767 = class298_sub53.readByte(-12558881);
	...
	try {
	    return (this.aByte2767 & 0x8) == 8 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    client.anInt8857 = 0;
	    client.anInt8852 = ((class403.anIntArray5244[681479919 * class403.anInt5239 + 2]) * -2045228877);
	    client.anInt8774 = (-546154255 * (class403.anIntArray5244[3 + 681479919 * class403.anInt5239]));
	    int i_2_ = (class403.anIntArray5244[4 + 681479919 * class403.anInt5239]);
	    if (i_2_ >= 2)
		throw new RuntimeException();
	    client.anInt8769 = -2694169 * i_2_;
	    int i_3_ = (class403.anIntArray5244[5 + 681479919 * class403.anInt5239]);
	...
	try {
	    ...
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub16_7557.method5612(i_10_, 1352882135);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    ...
	    Class344.method4165((class403.anIntArray5244[(681479919 * class403.anInt5239)]), (class403.anIntArray5244[1 + (681479919 * class403.anInt5239)]), 0, -1721946915);
	}
	catch (RuntimeException runtimeexception) {
