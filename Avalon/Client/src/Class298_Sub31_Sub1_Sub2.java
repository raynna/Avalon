...
public final class Class298_Sub31_Sub1_Sub2 extends Class298_Sub31_Sub1 {
	...
	return (this.anIntArray9997[this.aClass123_Sub1_9996.method1333(1457769061)]);
    }

    final int method3127() {
	return (this.anIntArray9995[this.aClass123_Sub1_9996.method1333(1410617434)]);
    }
	...
	int i_0_ = this.anIntArray9995[i];
	int i_1_ = this.anIntArray9997[i];
	if (i_0_ != -1)
	    return i_0_;
	if (i_1_ != -1)
	    return i_1_ | 0x10000;
	...
	int i_2_ = this.anIntArray9995[i];
	int i_3_ = this.anIntArray9997[i];
	if (i_2_ != -1)
	    return i_2_;
	if (i_3_ != -1)
	    return i_3_ | 0x10000;
	...
	int i_4_ = this.anIntArray9995[i];
	int i_5_ = this.anIntArray9997[i];
	if (i_4_ != -1)
	    return i_4_;
	if (i_5_ != -1)
	    return i_5_ | 0x10000;
	...
	super(class114);
	this.aClass123_Sub1_9996 = class123_sub1;
	this.anIntArray9995 = class114.anIntArray1379;
	this.anIntArray9997 = class114.anIntArray1380;
    }
}
