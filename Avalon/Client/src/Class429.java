...
public class Class429 implements Interface21 {
	...
	for (int i = 0; i < class429s_0_.length; i++) {
	    ...
	    if ((aClass429Array6635[-1719637847 * class429.anInt6630]) != null)
		throw new IllegalStateException();
	    aClass429Array6635[-1719637847 * class429.anInt6630] = class429;
	}
    }
	...
	if (null != locale)
	    ...
	    this.aLocale6634 = new Locale(method5753(218016567));
    }
    ...
    static final void method5757(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub2_7547.method5628((byte) 103) ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		//System.out.println("Client blocked simpleclick:" + ((class105.ihash * -440872681) >> 16) + "," + ((class105.ihash * -440872681) & 0xFFFF) + "," + class105.anInt1154 * -1309843523);
	    }
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method5759(Class403 class403, byte i) {
	try {
	    class403.anInt5239 -= -783761378;
	    int i_5_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    int i_6_ = (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = i_5_ - i_6_;
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    if (null != Class301.aClass298_Sub37_Sub13_3218) {
		Class122.method1319((byte) 1);
		Class122.method1319((byte) 1);
		if (Class301_Sub1.anInt7624 * -1289394455 < 10) {
		    if (!Class301.idx23.method2312(Class301.aClass298_Sub37_Sub13_3218.namehash, -2140139718)) {
			Class301_Sub1.anInt7624 = (Class_v.idx23.method2305((Class301.aClass298_Sub37_Sub13_3218.namehash), -1210672889)) / 10 * 1078186329;
			return;
		    }
		...
		if (10 == Class301_Sub1.anInt7624 * -1289394455) {
		    Class301.anInt3245 = (Class301.aClass298_Sub37_Sub13_3218.anInt9650 * 1364716801) >> 6 << 6;
		    Class301.anInt3238 = (1345239131 * (Class301.aClass298_Sub37_Sub13_3218.anInt9649) >> 6 << 6);
		    Class301.anInt3239 = ((Class301.aClass298_Sub37_Sub13_3218.anInt9647 * -2052483955) >> 6 << 6) - Class301.anInt3245 + 64;
		    Class301.anInt3240 = 64 + (((Class301.aClass298_Sub37_Sub13_3218.anInt9646) * 929385381 >> 6 << 6) - Class301.anInt3238);
		    int[] is = new int[3];
		    int i_7_ = -1;
		    int i_8_ = -1;
		    ...
		    if (Class301.aClass298_Sub37_Sub13_3218.method3453(Class287.myPlayer.plane, (((int) class217.aFloat2451 >> 9) + -1760580017 * class341.gameSceneBaseX), (283514611 * class341.gameSceneBaseY + ((int) class217.aFloat2454 >> 9)), is, 46106083)) {
			i_7_ = is[1] - Class301.anInt3245;
			i_8_ = is[2] - Class301.anInt3238;
		    }
		    if (!Class301_Sub1.aBoolean7631 && i_7_ >= 0 && i_7_ < Class301.anInt3239 && i_8_ >= 0 && i_8_ < Class301.anInt3240) {
			...
			Class301.aClass298_Sub37_Sub13_3218.method3452(1646852571 * Class301_Sub1.anInt7629, Class301_Sub1.anInt7623 * 679054909, is, -1594439812);
			if (null != is) {
			    Class82_Sub14.anInt6875 = -2076584633 * (is[1] - Class301.anInt3245);
			    Class376.anInt4090 = ((is[2] - Class301.anInt3238) * -435591305);
			}
			Class301_Sub1.anInt7623 = 1505298155;
			Class301_Sub1.anInt7629 = 1801430445;
			Class301_Sub1.aBoolean7631 = false;
		    } else {
			Class301.aClass298_Sub37_Sub13_3218.method3452((Class301.aClass298_Sub37_Sub13_3218.tileHash) * -1973484731 >> 14 & 0x3fff, -1973484731 * (Class301.aClass298_Sub37_Sub13_3218.tileHash) & 0x3fff, is, -1810513482);
			Class82_Sub14.anInt6875 = (is[1] - Class301.anInt3245) * -2076584633;
			Class376.anInt4090 = (is[2] - Class301.anInt3238) * -435591305;
		    }
		    if ((1110271707 * Class301.aClass298_Sub37_Sub13_3218.defaultZoom) == 37) {
			Class301.aFloat3233 = 3.0F;
			Class301.aFloat3234 = 3.0F;
		    } else if ((Class301.aClass298_Sub37_Sub13_3218.defaultZoom) * 1110271707 == 50) {
			Class301.aFloat3233 = 4.0F;
			Class301.aFloat3234 = 4.0F;
		    } else if ((Class301.aClass298_Sub37_Sub13_3218.defaultZoom) * 1110271707 == 75) {
			Class301.aFloat3233 = 6.0F;
			Class301.aFloat3234 = 6.0F;
		    } else if (1110271707 * (Class301.aClass298_Sub37_Sub13_3218.defaultZoom) == 100) {
			Class301.aFloat3233 = 8.0F;
			Class301.aFloat3234 = 8.0F;
		    } else if (1110271707 * (Class301.aClass298_Sub37_Sub13_3218.defaultZoom) == 200) {
			Class301.aFloat3233 = 16.0F;
			Class301.aFloat3234 = 16.0F;
		    } else {
			Class301.aFloat3233 = 8.0F;
			Class301.aFloat3234 = 8.0F;
		    }
		    Class301.anInt3254 = (int) Class301.aFloat3233 >> 1;
		    Class301.aByteArrayArrayArray3229 = IcmpService_Sub1.method6381(Class301.anInt3254, 51229796);
		    Class225.method2103(65536);
		    Class301.method3706();
		    Class476.aClass453_5986 = new Class453();
		    Class301.anInt3227 += (int) (Math.random() * 5.0) - 2;
		    if (Class301.anInt3227 < -8)
			Class301.anInt3227 = -8;
		    if (Class301.anInt3227 > 8)
			Class301.anInt3227 = 8;
		    Class301.anInt3228 += (int) (Math.random() * 5.0) - 2;
		    if (Class301.anInt3228 < -16)
			Class301.anInt3228 = -16;
		    if (Class301.anInt3228 > 16)
			Class301.anInt3228 = 16;
		    Class301.method3707(interface_ma, (Class301.anInt3227 >> 2 << 10), Class301.anInt3228 >> 1);
		    Class301.aClass339_3251.method4119(1024, 256, 303697513);
		    Class301.aClass487_3225.method6160(256, 256, -1144646938);
		    Class301.aClass433_3220.method5792(4096, (byte) 82);
		    ...
		    Class301.method3699(class_ra, Class301.anInt3227, Class301.anInt3228);
		    ...
		    if (Class301.idx23.method2295(new StringBuilder().append(Class301.aClass298_Sub37_Sub13_3218.namehash).append("_staticelements").toString(), -400372089)) {
			if (!Class301.idx23.method2312(new StringBuilder().append(Class301.aClass298_Sub37_Sub13_3218.namehash).append("_staticelements").toString(), -2145213052))
			    return;
			Class301.aClass296_3235 = (WorldMap.getMapKeys(Class301.idx23, new StringBuilder().append(Class301.aClass298_Sub37_Sub13_3218.namehash).append("_staticelements").toString(), client.isMemberWorld, 565671699));
		    } else
			Class301.aClass296_3235 = new MapKeys(0);
		    Class301.method3697();
