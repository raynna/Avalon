...
public class Class298_Sub32_Sub8 extends Class298_Sub32 {
	...
	switch (i) {
	    case 6:
		this.anInt9379 = class298_sub53.readUnsignedShort() * 216958721;
		break;
	    case 1:
		this.anInt9376 = class298_sub53.readUnsignedByte() * 2087340231;
		break;
	    case 0:
		this.anInt9371 = class298_sub53.readUnsignedByte() * 427847093;
		break;
	    case 5:
		this.anInt9373 = class298_sub53.readUnsignedShort() * -83830103;
		break;
	    case 4:
		this.anInt9383 = class298_sub53.readUnsignedShort() * 414558029;
		break;
	    case 3:
		this.anInt9377 = class298_sub53.readUnsignedShort() * -984012539;
		break;
	    case 2:
		this.anInt9378 = class298_sub53.readUnsignedShort() * 1949794091;
		break;
	    case 7:
		this.anInt9375 = class298_sub53.readUnsignedShort() * 1258867389;
		break;
	}
    }
	...
	try {
	    Random random = new Random(1685453047 * (this.anInt9376));
		...
		if (i_28_ > 0) {
		    ...
		    int i_30_ = (((Class298_Sub19_Sub3.method3039(random, 4096, (byte) -30) - 2048) * (this.anInt9377 * -1888601139)) >> 12);
		...
		for (int i_31_ = 0; (i_31_ < this.anInt9371 * -327362403); i_31_++) {
			...
			int i_33_ = (((Class298_Sub19_Sub3.method3039(random, 4096, (byte) -82) - 2048) * (this.anInt9378 * -1484830845)) >> 12);
			i_32_ += i_33_ * i_26_ >> 12;
			this.anIntArrayArray9381[i_28_][i_31_] = i_32_ + (this.anIntArrayArray9381[i_28_][i_31_ - 1]);
		    }
		    this.anIntArrayArray9364[i_28_][i_31_] = ((this.anInt9375 * -762707819 > 0) ? 4096 - (Class298_Sub19_Sub3.method3039(random, (this.anInt9375 * -762707819), (byte) 23)) : 4096);
		}
