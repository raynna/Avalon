...
public class Class519 {
	...
	try {
	    ...
	    if (this.anInflater6273 == null)
		this.anInflater6273 = new Inflater(true);
	    try {
		this.anInflater6273.setInput(class298_sub53.buffer, 10 + 385051775 * class298_sub53.index, (class298_sub53.buffer.length - (8 + (385051775 * class298_sub53.index + 10))));
		this.anInflater6273.inflate(is);
	    }
	    catch (Exception exception) {
		this.anInflater6273.reset();
		throw new RuntimeException("");
	    }
	    this.anInflater6273.reset();
	}
