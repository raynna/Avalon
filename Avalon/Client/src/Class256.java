...
public class Class256 {
	...
	try {
	    Class298_Sub37_Sub8 class298_sub37_sub8 = ((Class298_Sub37_Sub8) this.aClass348_2798.method4184(i));
	    if (null != class298_sub37_sub8)
		return class298_sub37_sub8;
	    byte[] is;
	    if (i >= 32768)
		is = this.aClass243_2797.getFile(0, i & 0x7fff);
	    else
		is = this.aClass243_2796.getFile(0, i);
	...
	if (this.aClass243_2796 != null)
	    this.aClass243_2796.method2316(0, 1395155699);
	if (this.aClass243_2797 != null)
	    this.aClass243_2797.method2316(0, 393673779);
    }
    ...
    static final void method2443(Class403 class403, int i) {
	try {
    ...
    static final void method2444(Class403 class403, int i) {
	try {
    ...
    static final void method2445(Class403 class403, int i) {
	try {
	...
	try {
	    ...
	    class298_sub36.out.writeBytes(class298_sub53.buffer, 0, 385051775 * class298_sub53.index, (short) -19107);
	    return is;
	}
	catch (RuntimeException runtimeexception) {
