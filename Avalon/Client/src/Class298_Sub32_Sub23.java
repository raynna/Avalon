...
public class Class298_Sub32_Sub23 extends Class298_Sub32 {
	...
	for (int i_0_ = 0; i_0_ < 256; i_0_++) {
		...
		aByteArray9470[i++] = (byte) (int) (255.0 / (Math.sqrt((65535 + (i_0_ * i_0_ + i_1_ * i_1_)) / 65535.0F)));
	}
    }
	...
	try {
		...
		int i_3_ = ((1238246435 * this.anInt9472 * (Class250.anInt2757 * 1282258747)) >> 12);
		...
		for (int i_7_ = 0; i_7_ < -1474554145 * Class250.anInt2755; i_7_++) {
		    ...
		    i_13_ = (this.anIntArray9475[0] * i_13_) >> 12;
		    i_14_ = (this.anIntArray9475[1] * i_14_) >> 12;
		    i_15_ = (this.anIntArray9475[2] * i_15_) >> 12;
	...
	super(1, true);
	this.anInt9469 = 1473478640;
	this.anInt9474 = 825586896;
	this.anIntArray9475 = new int[3];
    }
	...
	try {
	    switch (i) {
		case 0:
		    this.anInt9472 = class298_sub53.readUnsignedShort() * -1530549365;
		    break;
		case 2:
		    this.anInt9474 = class298_sub53.readUnsignedShort() * -272185243;
		    break;
		case 1:
		    this.anInt9469 = class298_sub53.readUnsignedShort() * -803512697;
		    break;
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    double d = Math.cos((this.anInt9474) * -5592723 / 4096.0F);
	    this.anIntArray9475[0] = (int) (Math.sin(this.anInt9469 * -2106652873 / 4096.0F) * d * 4096.0);
	    this.anIntArray9475[1] = (int) (Math.cos(-2106652873 * this.anInt9469 / 4096.0F) * d * 4096.0);
	    this.anIntArray9475[2] = (int) (Math.sin(this.anInt9474 * -5592723 / 4096.0F) * 4096.0);
	    int i_17_ = ((this.anIntArray9475[0] * this.anIntArray9475[0]) >> 12);
	    int i_18_ = ((this.anIntArray9475[1] * this.anIntArray9475[1]) >> 12);
	    int i_19_ = ((this.anIntArray9475[2] * this.anIntArray9475[2]) >> 12);
	    int i_20_ = (int) (Math.sqrt(i_19_ + (i_18_ + i_17_) >> 12) * 4096.0);
	    if (i_20_ != 0) {
		this.anIntArray9475[0] = ((this.anIntArray9475[0] << 12) / i_20_);
		this.anIntArray9475[1] = ((this.anIntArray9475[1] << 12) / i_20_);
		this.anIntArray9475[2] = ((this.anIntArray9475[2] << 12) / i_20_);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	if (aClass257_7384.aBoolean2810) {
	    int i_21_ = ((1238246435 * this.anInt9472 * (Class250.anInt2757 * 1282258747)) >> 12);
		...
		i_31_ = (this.anIntArray9475[0] * i_31_ >> 12);
		i_32_ = (this.anIntArray9475[1] * i_32_ >> 12);
		i_33_ = (this.anIntArray9475[2] * i_33_ >> 12);
	...
	if (aClass257_7384.aBoolean2810) {
	    int i_34_ = ((1238246435 * this.anInt9472 * (Class250.anInt2757 * 1282258747)) >> 12);
		...
		i_44_ = (this.anIntArray9475[0] * i_44_ >> 12);
		i_45_ = (this.anIntArray9475[1] * i_45_ >> 12);
		i_46_ = (this.anIntArray9475[2] * i_46_ >> 12);
