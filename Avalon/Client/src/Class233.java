...
public final class Class233 {
    ...
    public static Class233 aClass233_2595 = new Class233();

    public Class233(Class233 class233_0_) {
	aFloatArray2594 = new float[16];
	method2142(class233_0_);
    }

    public void method2142(Class233 class233_1_) {
	System.arraycopy(class233_1_.aFloatArray2594, 0, aFloatArray2594, 0, 16);
    }

    public void method2143(Class233 class233_2_, Class233 class233_3_) {
    ...
    public void method2144(Class233 class233_19_) {
	...
	aFloatArray2594[0] = class222.aFloat2494;
	aFloatArray2594[1] = class222.aFloat2502;
	aFloatArray2594[2] = class222.aFloat2495;
	aFloatArray2594[3] = 0.0F;
	aFloatArray2594[4] = class222.aFloat2496;
	aFloatArray2594[5] = class222.aFloat2497;
	aFloatArray2594[6] = class222.aFloat2498;
	aFloatArray2594[7] = 0.0F;
	aFloatArray2594[8] = class222.aFloat2499;
	aFloatArray2594[9] = class222.aFloat2500;
	aFloatArray2594[10] = class222.aFloat2501;
	aFloatArray2594[11] = 0.0F;
	aFloatArray2594[12] = class222.aFloat2492;
	aFloatArray2594[13] = class222.aFloat2503;
	aFloatArray2594[14] = class222.aFloat2493;
	...
	double d = Math.sqrt(f * f + f_76_ * f_76_ + f_77_ * f_77_);
	fs[0] = (float) (f / d);
	fs[1] = (float) (f_76_ / d);
	fs[2] = (float) (f_77_ / d);
	fs[3] = (float) ((aFloatArray2594[15] + aFloatArray2594[12]) / d);
	return fs;
    }
	...
	double d = Math.sqrt(f * f + f_78_ * f_78_ + f_79_ * f_79_);
	fs[0] = (float) (f / d);
	fs[1] = (float) (f_78_ / d);
	fs[2] = (float) (f_79_ / d);
	fs[3] = (float) ((aFloatArray2594[15] + aFloatArray2594[14]) / d);
	return fs;
    }
	...
	double d = Math.sqrt(f * f + f_80_ * f_80_ + f_81_ * f_81_);
	fs[0] = (float) (f / d);
	fs[1] = (float) (f_80_ / d);
	fs[2] = (float) (f_81_ / d);
	fs[3] = (float) ((aFloatArray2594[15] - aFloatArray2594[14]) / d);
	...
	double d = Math.sqrt(f * f + f_97_ * f_97_ + f_98_ * f_98_);
	fs[0] = (float) (f / d);
	fs[1] = (float) (f_97_ / d);
	fs[2] = (float) (f_98_ / d);
	fs[3] = (float) ((aFloatArray2594[15] - aFloatArray2594[13]) / d);
	return fs;
    }
	...
	if (i != 0) {
	    ...
	    aFloatArray2594[0] = f_103_ * i_99_;
	    aFloatArray2594[5] = f_103_ * i_100_;
	    aFloatArray2594[1] = f_104_ * i_99_;
	    aFloatArray2594[4] = -f_104_ * i_100_;
	    ...
	    aFloatArray2594[0] = i_99_;
	    aFloatArray2594[5] = i_100_;
	    aFloatArray2594[10] = 1.0F;
	    float[] fs = aFloatArray2594;
	...
	double d = Math.sqrt(f * f + f_116_ * f_116_ + f_117_ * f_117_);
	fs[0] = (float) (f / d);
	fs[1] = (float) (f_116_ / d);
	fs[2] = (float) (f_117_ / d);
	fs[3] = (float) ((aFloatArray2594[15] - aFloatArray2594[12]) / d);
	...
	double d = Math.sqrt(f * f + f_118_ * f_118_ + f_119_ * f_119_);
	fs[0] = (float) (f / d);
	fs[1] = (float) (f_118_ / d);
	fs[2] = (float) (f_119_ / d);
	fs[3] = (float) ((aFloatArray2594[15] + aFloatArray2594[13]) / d);
