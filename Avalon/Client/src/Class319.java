...
public abstract class Class319 {
    ...
    static final void method3901(Class403 class403, int i) {
	try {
	    ...
	    int i_10_ = (class403.anIntArray5244[2 + class403.anInt5239 * 681479919]);
	    int i_11_ = (class403.anIntArray5244[681479919 * class403.anInt5239 + 3]);
	    i_8_ += i_9_ << 14;
	    i_8_ += i_10_ << 28;
	    i_8_ += i_11_;
