...
public class Class22 {
	...
	try {
		...
		class343_sub1.anInt3672 = buffer.readUnsignedByte() * 672848077;
    ...
    static final void method373(IComponentDefinition class105, Class119 class119, Class403 class403, int i) {
	try {
    ...
    static final void method374(Class403 class403, int i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub3_7556.method5633(-863865720) == 1 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
