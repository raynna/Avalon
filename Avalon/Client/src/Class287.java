...
public class Class287 {
    ...
    static final void method2721(Class403 class403, byte i) {
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = 1914527151 * Class298_Sub41.anInt7456;
	}
	catch (RuntimeException runtimeexception) {
    ...
    static final void method2723(Class403 class403, int i) {
	try {
	    int i_12_ = (class403.anIntArray5244[((class403.anInt5239 -= -391880689) * 681479919)]);
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.GRAND_EXCHANGE_SLOTS[i_12_].anInt2770 * 1869840307;
	}
	catch (RuntimeException runtimeexception) {
