...
public class Class200_Sub3_Sub1 extends Class200_Sub3 implements Interface9_Impl2_Impl1 {
	...
	long l_4_ = IDirect3DDevice.CreateRenderTarget(((this.aClass_ra_Sub3_Sub2_6410).aLong9847), i_1_, i_2_, 21, 0, 0, true);
	if (jagdx.a.f(IDirect3DDevice.StretchRect((this.aClass_ra_Sub3_Sub2_6410.aLong9847), l, i, i_0_, i_1_, i_2_, l_4_, 0, 0, i_1_, i_2_, 1))) {
	    IDirect3DSurface.Download(l_4_, 0, 0, i_1_, i_2_, i_1_ * 4, 16, (this.aClass_ra_Sub3_Sub2_6410.aLong8217));
	    this.aClass_ra_Sub3_Sub2_6410.aByteBuffer8216.clear();
	    this.aClass_ra_Sub3_Sub2_6410.aByteBuffer8216.asIntBuffer().get(is);
	}
	IUnknown.Release(l);
	...
	long l = IDirect3DTexture.GetSurfaceLevel(this.aLong6407, 0);
	long l_24_ = IDirect3DDevice.CreateRenderTarget(((this.aClass_ra_Sub3_Sub2_6410).aLong9847), i_21_, i_22_, 21, 0, 0, true);
	if (jagdx.a.f(IDirect3DDevice.StretchRect((this.aClass_ra_Sub3_Sub2_6410.aLong9847), l, i, i_20_, i_21_, i_22_, l_24_, 0, 0, i_21_, i_22_, 1))) {
	    IDirect3DSurface.Download(l_24_, 0, 0, i_21_, i_22_, i_21_ * 4, 16, (this.aClass_ra_Sub3_Sub2_6410.aLong8217));
	    this.aClass_ra_Sub3_Sub2_6410.aByteBuffer8216.clear();
	    this.aClass_ra_Sub3_Sub2_6410.aByteBuffer8216.asIntBuffer().get(is);
	}
	IUnknown.Release(l);
	...
	long l = IDirect3DTexture.GetSurfaceLevel(this.aLong6407, 0);
	long l_45_ = IDirect3DDevice.CreateRenderTarget(((this.aClass_ra_Sub3_Sub2_6410).aLong9847), i_42_, i_43_, 21, 0, 0, true);
	if (jagdx.a.f(IDirect3DDevice.StretchRect((this.aClass_ra_Sub3_Sub2_6410.aLong9847), l, i, i_41_, i_42_, i_43_, l_45_, 0, 0, i_42_, i_43_, 1))) {
	    IDirect3DSurface.Download(l_45_, 0, 0, i_42_, i_43_, i_42_ * 4, 16, (this.aClass_ra_Sub3_Sub2_6410.aLong8217));
	    this.aClass_ra_Sub3_Sub2_6410.aByteBuffer8216.clear();
	    this.aClass_ra_Sub3_Sub2_6410.aByteBuffer8216.asIntBuffer().get(is);
	}
	IUnknown.Release(l);
