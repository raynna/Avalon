...
public class Class356 {
	...
	try {
		...
		for (int i_1_ = 0; i_1_ < class111s.length; i_1_++) {
		    ...
		    if (class111.anInt1366 * -1047699439 > 588194557 * Class111.anInt1367)
			Class111.anInt1367 = 510332837 * class111.anInt1366;
		}
	...
	try {
	    class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919 - 1)] = client.aBoolean8643 ? 1 : 0;
	}
	catch (RuntimeException runtimeexception) {
