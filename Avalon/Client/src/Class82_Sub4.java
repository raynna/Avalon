...
public class Class82_Sub4 extends Class82 {
	...
	this.anInt6831 = class298_sub53.readUnsignedShort() * -451568871;
	int i = class298_sub53.readUnsignedByte();
	if ((i & 0x1) != 0) {
	    this.anInt6827 = class298_sub53.readUnsignedShort() * -1685041125;
	    this.anInt6830 = class298_sub53.readUnsignedShort() * -1587740951;
	} else {
	    this.anInt6827 = 1685041125;
	    this.anInt6830 = 1587740951;
	}
	if ((i & 0x2) != 0) {
	    this.anInt6828 = class298_sub53.readUnsignedShort() * -455796477;
	    this.anInt6826 = class298_sub53.readUnsignedShort() * 1360155927;
	} else {
