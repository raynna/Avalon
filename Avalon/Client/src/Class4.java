...
public class Class4 {
	...
	class_ra.qa(this.anIntArray77);
	if (i - i_21_ <= this.anIntArray77[2] && i + i_21_ >= this.anIntArray77[0] && (i_19_ - this.anInt76 <= this.anIntArray77[3]) && (i_19_ + this.anInt74 >= this.anIntArray77[1]))
	    method304(class_ra, string, this.anIntArray77, i - i_21_, i_19_, i_20_, bool);
    }
