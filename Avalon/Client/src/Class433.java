...
public class Class433 {
	...
	try {
	    if (this.aBoolean5445 != bool) {
		this.aBoolean5445 = bool;
	...
	try {
		...
		this.aClass348_5450.method4187();
	    }
	    synchronized (this.aClass348_5452) {
		this.aClass348_5452.method4187();
	    }
	    synchronized (this.aClass348_5451) {
		this.aClass348_5451.method4187();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    this.aClass348_5449 = new Class348(i);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
		...
		this.aClass348_5449.method4187();
	    }
	    synchronized (this.aClass348_5450) {
		this.aClass348_5450.method4187();
	    }
	    ...
	    this.aClass64Array5443 = new Model[4];
	    this.aClass454_5456 = new Class454(null, null);
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    synchronized (this.aClass348_5449) {
		this.aClass348_5449.method4186(i, -798729587);
	    }
	    synchronized (this.aClass348_5450) {
		this.aClass348_5450.method4186(i, -1754602717);
	    }
	    synchronized (this.aClass348_5452) {
		this.aClass348_5452.method4186(i, 466618917);
	    }
	    synchronized (this.aClass348_5451) {
		this.aClass348_5451.method4186(i, -855180536);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    synchronized (this.aClass348_5449) {
		this.aClass348_5449.method4189();
	    }
	    synchronized (this.aClass348_5450) {
		this.aClass348_5450.method4189();
	    }
	    synchronized (this.aClass348_5452) {
		this.aClass348_5452.method4189();
	    }
	    synchronized (this.aClass348_5451) {
		this.aClass348_5451.method4189();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	this.aClass348_5451 = new Class348(50);
	this.aClass64Array5443 = new Model[4];
	this.aClass454_5456 = new Class454(null, null);
	this.aClass411_5455 = class411;
	this.aClass429_5444 = class429;
	this.aBoolean5445 = bool;
	this.aClass243_5446 = class243;
	this.aClass243_5447 = class243_3_;
	if (null != this.aClass243_5446) {
	    int i = this.aClass243_5446.method2296(1680210708) - 1;
	    Class120.aClass120_1443.method1306((short) 23751);
	    this.aClass243_5446.method2316(i, -1017296855);
	}
	if (this.aClass411_5455 == Class411.game_rs)
	    this.aStringArray5454 = (new String[] { null, null, null, null, null, Tradution.aClass470_5905.method6049((this.aClass429_5444), -875414210) });
	else
	    this.aStringArray5454 = new String[] { null, null, null, null, null, null };
    }
	...
	try {
	    ...
	    synchronized (this.aClass348_5449) {
		class432 = (ObjectDefinitions) this.aClass348_5449.method4184(objectId);
	    }
	    if (class432 != null)
		return class432;
	    byte[] is;
	    synchronized (this.aClass243_5446) {
		is = (this.aClass243_5446.getFile(Class120.aClass120_1443.method1307(objectId, -1875026798), Class120.aClass120_1443.method1305(objectId, -1955117131)));
	    }
	    class432 = new ObjectDefinitions();
	    class432.anInt5365 = objectId * -950871973;
	    class432.aClass433_5403 = this;
	    class432.aStringArray5394 = this.aStringArray5454.clone();
	    if (null != is)
		class432.method5783(new RsByteBuffer(is), -1780393822);
	    class432.method5778(-231037911);
	    if (class432.clip_unknown) {
		//System.out.println("Object: " + objectId + " (" + class432.name + ") has weird flag set!");
		class432.clip_type = 0;
		class432.clip_solid = false;
	    }
	    if (!this.aBoolean5445 && class432.aBoolean5434) {
	...
	try {
	    ...
	    int i_11_ = -i_6_;
	    int i_12_ = -1;
	    Class82_Sub22.method940(Class372.anIntArrayArray4047[i_5_], i - i_6_, i + i_6_, i_7_, 198591816);
	    while (i_10_ > i_9_) {
		i_12_ += 2;
		i_11_ += i_12_;
		i_9_++;
		if (i_11_ >= 0) {
		    i_10_--;
		    i_11_ -= i_10_ << 1;
		    int[] is = Class372.anIntArrayArray4047[i_10_ + i_5_];
		    int[] is_13_ = Class372.anIntArrayArray4047[i_5_ - i_10_];
		    int i_14_ = i_9_ + i;
		    int i_15_ = i - i_9_;
		...
		int i_16_ = i_10_ + i;
		int i_17_ = i - i_10_;
		int[] is = Class372.anIntArrayArray4047[i_5_ + i_9_];
		int[] is_18_ = Class372.anIntArrayArray4047[i_5_ - i_9_];
    ...
    static final void method5798(Class403 class403, short i) {
	try {
