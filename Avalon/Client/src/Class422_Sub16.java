...
public class Class422_Sub16 extends Class422 {
	...
	try {
	    if (aClass298_Sub48_5346.method3541((byte) -46) != Class411.game_rs)
	...
	try {
	    if (aClass298_Sub48_5346.method3541((byte) -12) == Class411.game_rs)
		return true;
	    return false;
	}
	catch (RuntimeException runtimeexception) {
	...
	if (aClass298_Sub48_5346.method3541((byte) -17) == Class411.game_rs) {
	...
	try {
	    if (aClass298_Sub48_5346.method3541((byte) -43) == Class411.game_rs) {
