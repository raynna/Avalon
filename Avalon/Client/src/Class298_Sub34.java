...
public class Class298_Sub34 extends Class298 {
	...
	try {
		...
		if (null == is || is[i_2_] != 0) {
		    int i_3_ = this.anIntArray7393[i_2_];
		    if (0 == i_3_) {
			if (i <= 1962237353) {
			    /* empty */
			}
			...
			if (null != class298_sub26_sub1) {
			    this.aClass298_Sub26_Sub1Array7387[i_2_] = class298_sub26_sub1;
			    this.anIntArray7393[i_2_] = 0;
			}
		    }
		}
	    }
	...
	this.aByteArray7388 = new byte[128];
	this.aByteArray7392 = new byte[128];
	this.aClass104Array7391 = new Class104[128];
	this.aByteArray7386 = new byte[128];
	this.anIntArray7393 = new int[128];
	...
	for (int i_19_ = 0; i_19_ < class104s.length; i_19_++) {
	    ...
	    if (i_20_ > 0)
		class104.aByteArray1114 = new byte[i_20_ * 2];
	    i_20_ = class298_sub53.readUnsignedByte();
	    if (i_20_ > 0) {
		class104.aByteArray1110 = new byte[2 + 2 * i_20_];
		class104.aByteArray1110[1] = (byte) 64;
	    }
	}
	...
	for (int i_28_ = 0; i_28_ < 128; i_28_++) {
	    ...
	    this.aShortArray7390[i_28_] = (short) i_27_;
	}
	i_27_ = 0;
	for (int i_29_ = 0; i_29_ < 128; i_29_++) {
	    i_27_ += class298_sub53.readUnsignedByte();
	    this.aShortArray7390[i_29_] += i_27_ << 8;
	}
	int i_30_ = 0;
	int i_31_ = 0;
	int i_32_ = 0;
	for (int i_33_ = 0; i_33_ < 128; i_33_++) {
	    ...
	    this.aShortArray7390[i_33_] += (i_32_ - 1 & 0x2) << 14;
	    this.anIntArray7393[i_33_] = i_32_;
	    i_30_--;
	}
	i_30_ = 0;
	i_31_ = 0;
	...
	for (int i_35_ = 0; i_35_ < 128; i_35_++) {
	    if (this.anIntArray7393[i_35_] != 0) {
		if (0 == i_30_) {
		...
		this.aByteArray7386[i_35_] = (byte) i_34_;
		i_30_--;
	    }
	}
	i_30_ = 0;
	...
	for (int i_37_ = 0; i_37_ < 128; i_37_++) {
	    if (this.anIntArray7393[i_37_] != 0) {
		if (0 == i_30_) {
		...
		this.aByteArray7392[i_37_] = (byte) i_36_;
		i_30_--;
	    }
	}
	i_30_ = 0;
	...
	for (int i_38_ = 0; i_38_ < 128; i_38_++) {
	    if (this.anIntArray7393[i_38_] != 0) {
		if (i_30_ == 0) {
		...
		this.aClass104Array7391[i_38_] = class104;
		i_30_--;
	    }
	}
	i_30_ = 0;
	...
	for (int i_40_ = 0; i_40_ < 128; i_40_++) {
		...
		if (i_31_ < is_25_.length)
		    ...
		    i_30_ = -1;
		if (this.anIntArray7393[i_40_] > 0)
		    i_39_ = class298_sub53.readUnsignedByte() + 1;
	    }
	    this.aByteArray7388[i_40_] = (byte) i_39_;
	    i_30_--;
	}
	this.anInt7389 = (class298_sub53.readUnsignedByte() + 1) * 306353405;
	for (int i_41_ = 0; i_41_ < i_15_; i_41_++) {
	    Class104 class104_42_ = class104s[i_41_];
	    if (null != class104_42_.aByteArray1114) {
		for (int i_43_ = 1; i_43_ < class104_42_.aByteArray1114.length; i_43_ += 2)
		    class104_42_.aByteArray1114[i_43_] = class298_sub53.readByte(-12558881);
	    }
	    if (null != class104_42_.aByteArray1110) {
		for (int i_44_ = 3; (i_44_ < class104_42_.aByteArray1110.length - 2); i_44_ += 2)
		    class104_42_.aByteArray1110[i_44_] = class298_sub53.readByte(-12558881);
	    }
	}
	if (is_22_ != null) {
	...
	for (int i_47_ = 0; i_47_ < i_15_; i_47_++) {
	    ...
	    if (class104_48_.aByteArray1110 != null) {
		i_27_ = 0;
		for (int i_49_ = 2; i_49_ < class104_48_.aByteArray1110.length; i_49_ += 2) {
		    i_27_ = 1 + i_27_ + class298_sub53.readUnsignedByte();
		    class104_48_.aByteArray1110[i_49_] = (byte) i_27_;
		}
	    }
	}
	for (int i_50_ = 0; i_50_ < i_15_; i_50_++) {
	    Class104 class104_51_ = class104s[i_50_];
	    if (class104_51_.aByteArray1114 != null) {
		i_27_ = 0;
		for (int i_52_ = 2; i_52_ < class104_51_.aByteArray1114.length; i_52_ += 2) {
		    i_27_ = i_27_ + 1 + class298_sub53.readUnsignedByte();
		    class104_51_.aByteArray1114[i_52_] = (byte) i_27_;
		}
	    }
	}
	if (null != is_22_) {
		...
		this.aByteArray7388[i_56_] = (byte) (i_55_ * (this.aByteArray7388[i_56_]) + 32 >> 6);
		...
		for (int i_61_ = i_54_; i_61_ < i_58_; i_61_++) {
		    ...
		    this.aByteArray7388[i_61_] = (byte) ((this.aByteArray7388[i_61_]) * i_62_ + 32 >> 6);
		    i_60_ += i_59_ - i_55_;
		}
		i_54_ = i_58_;
		i_55_ = i_59_;
		...
		this.aByteArray7388[i_63_] = (byte) ((this.aByteArray7388[i_63_] * i_55_) + 32 >> 6);
	    Object object = null;
	}
	if (null != is_23_) {
	    i_27_ = class298_sub53.readUnsignedByte();
		...
		int i_68_ = ((this.aByteArray7392[i_67_] & 0xff) + i_66_);
		if (i_68_ < 0)
		    i_68_ = 0;
		if (i_68_ > 128)
		    i_68_ = 128;
		this.aByteArray7392[i_67_] = (byte) i_68_;
	    }
		...
		for (int i_73_ = i_65_; i_73_ < i_70_; i_73_++) {
		    ...
		    int i_75_ = (i_74_ + (this.aByteArray7392[i_73_] & 0xff));
		    if (i_75_ < 0)
			i_75_ = 0;
		    if (i_75_ > 128)
			i_75_ = 128;
		    this.aByteArray7392[i_73_] = (byte) i_75_;
		    i_72_ += i_71_ - i_66_;
		}
		i_65_ = i_70_;
		i_66_ = i_71_;
		...
		int i_77_ = i_66_ + (this.aByteArray7392[i_76_] & 0xff);
		if (i_77_ < 0)
		    i_77_ = 0;
		if (i_77_ > 128)
		    i_77_ = 128;
		this.aByteArray7392[i_76_] = (byte) i_77_;
	    }
	    Object object = null;
	}
	for (int i_78_ = 0; i_78_ < i_15_; i_78_++)
	    class104s[i_78_].anInt1111 = class298_sub53.readUnsignedByte() * 890917585;
	for (int i_79_ = 0; i_79_ < i_15_; i_79_++) {
	    Class104 class104_80_ = class104s[i_79_];
	    if (class104_80_.aByteArray1114 != null)
		class104_80_.anInt1112 = class298_sub53.readUnsignedByte() * 1553889121;
	    if (class104_80_.aByteArray1110 != null)
		class104_80_.anInt1113 = class298_sub53.readUnsignedByte() * -1467946285;
	    if (1753302577 * class104_80_.anInt1111 > 0)
		class104_80_.anInt1109 = class298_sub53.readUnsignedByte() * 189354207;
	}
	for (int i_81_ = 0; i_81_ < i_15_; i_81_++)
	    class104s[i_81_].anInt1116 = class298_sub53.readUnsignedByte() * 419117413;
	for (int i_82_ = 0; i_82_ < i_15_; i_82_++) {
	    Class104 class104_83_ = class104s[i_82_];
	    if (430264429 * class104_83_.anInt1116 > 0)
		class104_83_.anInt1115 = class298_sub53.readUnsignedByte() * -1131925083;
	}
	for (int i_84_ = 0; i_84_ < i_15_; i_84_++) {
	    Class104 class104_85_ = class104s[i_84_];
	    if (class104_85_.anInt1115 * 671305261 > 0)
		class104_85_.anInt1117 = class298_sub53.readUnsignedByte() * 1175770411;
	}
    }

    void method3398(byte i) {
	try {
	    this.anIntArray7393 = null;
	}
	catch (RuntimeException runtimeexception) {
