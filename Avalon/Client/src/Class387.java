...
public abstract class Class387 {
	...
	i_5_ -= i_8_;
	i_6_ -= i_9_;
	float f_15_ = i * fs[0] + i_5_ * fs[1] + i_6_ * fs[2];
	float f_16_ = i * fs[3] + i_5_ * fs[4] + i_6_ * fs[5];
	float f_17_ = i * fs[6] + i_5_ * fs[7] + i_6_ * fs[8];
	float f_18_;
	float f_19_;
	if (i_10_ == 0) {
	    f_18_ = f_15_ + f + 0.5F;
	...
	float f_28_ = (float) Math.cos(i_24_ * 0.024543693F);
	float f_29_ = (float) Math.sin(i_24_ * 0.024543693F);
	...
	float f_32_ = 1.0F;
	float f_33_ = 0.0F;
	f_28_ = i_22_ / 32767.0F;
	f_29_ = -(float) Math.sqrt(1.0F - f_28_ * f_28_);
	f_30_ = 1.0F - f_28_;
	float f_34_ = (float) Math.sqrt(i * i + i_23_ * i_23_);
	...
	if (i_44_ != 0) {
	    int i_65_ = ((int) (Math.atan2(i_61_ - i_62_, i_44_) * 2607.5945876176133) & 0x3fff);
	    if (i_65_ != 0) {
		if (i_45_ != 0) {
		    if (i_65_ > 8192) {
	...
	if (i_43_ != 0) {
	    int i_67_ = ((int) (Math.atan2(i_64_ - i_63_, i_43_) * 2607.5945876176133) & 0x3fff);
	    if (i_67_ != 0) {
		if (i_46_ != 0) {
		    if (i_67_ > 8192) {
	...
	if (i != -1) {
		...
		Class96 class96 = (class298_sub37_sub4.aClass96Array9579[i]);
		Class298_Sub15 class298_sub15 = class96.aClass298_Sub15_931;
		Class96 class96_75_ = null;
		if (class298_sub37_sub4_70_ != null) {
		    class96_75_ = (class298_sub37_sub4_70_.aClass96Array9579[i_71_]);
		    if (class96_75_.aClass298_Sub15_931 != class298_sub15)
			class96_75_ = null;
		}
	...
	if (i != -1) {
		...
		if (!ea())
			...
			class96_91_ = (class298_sub37_sub4_81_.aClass96Array9579[i_82_]);
			if (class96_91_.aClass298_Sub15_931 != class298_sub15)
			    class96_91_ = null;
		    }
		    method4767(class298_sub15, class96, class96_91_, i_83_, i_84_, 0, bools, false, bool, 65535, null);
		    Class96 class96_92_ = (class298_sub37_sub4_85_.aClass96Array9579[i_86_]);
		    Class96 class96_93_ = null;
		    if (class298_sub37_sub4_87_ != null) {
			class96_93_ = (class298_sub37_sub4_87_.aClass96Array9579[i_88_]);
			if (class96_93_.aClass298_Sub15_931 != class298_sub15)
			    class96_93_ = null;
		    }
		    method4738(0, new int[0], 0, 0, 0, 0, bool);
		    method4767(class96_92_.aClass298_Sub15_931, class96_92_, class96_93_, i_89_, i_90_, 0, bools, true, bool, 65535, null);
		    ka();
		    method4734();
		}
	    }
	...
	if (i != -1) {
		...
		Class96 class96 = (class298_sub37_sub4.aClass96Array9579[i]);
		Class298_Sub15 class298_sub15 = class96.aClass298_Sub15_931;
		for (int i_94_ = 0; i_94_ < class96.anInt925; i_94_++) {
		    short i_95_ = class96.aShortArray933[i_94_];
		    if (class298_sub15.aBooleanArray7275[i_95_]) {
			if (class96.aShortArray937[i_94_] != -1)
			    w(0, 0, 0, 0);
			w((class298_sub15.anIntArray7278[i_95_]), class96.aShortArray934[i_94_], class96.aShortArray930[i_94_], class96.aShortArray936[i_94_]);
		    }
		}
		ka();
		method4734();
	...
	i_123_ -= i_126_;
	i_124_ -= i_127_;
	float f_131_ = (i * fs[0] + i_123_ * fs[1] + i_124_ * fs[2]);
	float f_132_ = (i * fs[3] + i_123_ * fs[4] + i_124_ * fs[5]);
	float f_133_ = (i * fs[6] + i_123_ * fs[7] + i_124_ * fs[8]);
	float f_134_ = (((float) Math.atan2(f_131_, f_133_) / 6.2831855F) + 0.5F);
	if (f != 1.0F)
	    f_134_ *= f;
	...
	if (i != -1) {
		...
		if (class298_sub37_sub4_191_ != null) {
		    class96_197_ = (class298_sub37_sub4_191_.aClass96Array9579[i_192_]);
		    if (class96_197_.aClass298_Sub15_931 != class298_sub15)
			class96_197_ = null;
		}
	...
	if (class96_210_ == null || i == 0) {
	    for (int i_215_ = 0; i_215_ < class96.anInt925; i_215_++) {
		short i_216_ = class96.aShortArray933[i_215_];
		if (bools == null || bools[i_216_] == bool || (class298_sub15.anIntArray7278[i_216_]) == 0) {
		    short i_217_ = class96.aShortArray937[i_215_];
		    if (i_217_ != -1)
			method4766(0, (class298_sub15.anIntArrayArray7279[i_217_]), 0, 0, 0, i_212_, bool_213_, i_214_ & (class298_sub15.anIntArray7280[i_217_]), is);
		    method4766((class298_sub15.anIntArray7278[i_216_]), (class298_sub15.anIntArrayArray7279[i_216_]), class96.aShortArray934[i_215_], class96.aShortArray930[i_215_], class96.aShortArray936[i_215_], i_212_, bool_213_, i_214_ & (class298_sub15.anIntArray7280[i_216_]), is);
		}
	    }
	} else {
	    int i_218_ = 0;
	    int i_219_ = 0;
	    for (int i_220_ = 0; (i_220_ < class298_sub15.anInt7268 * 92429039); i_220_++) {
		boolean bool_221_ = false;
		if (i_218_ < class96.anInt925 && class96.aShortArray933[i_218_] == i_220_)
		    bool_221_ = true;
		boolean bool_222_ = false;
		if (i_219_ < class96_210_.anInt925 && (class96_210_.aShortArray933[i_219_] == i_220_))
		    bool_222_ = true;
		if (bool_221_ || bool_222_) {
		    if (bools != null && bools[i_220_] != bool && (class298_sub15.anIntArray7278[i_220_]) != 0) {
			if (bool_221_)
			    i_218_++;
			if (bool_222_)
			    i_219_++;
			...
			int i_223_ = 0;
			int i_224_ = (class298_sub15.anIntArray7278[i_220_]);
			...
			byte i_229_;
			if (bool_221_) {
			    i_225_ = class96.aShortArray934[i_218_];
			    i_226_ = class96.aShortArray930[i_218_];
			    i_227_ = class96.aShortArray936[i_218_];
			    i_228_ = class96.aShortArray937[i_218_];
			    i_229_ = class96.aByteArray938[i_218_];
			    i_218_++;
			} else {
			    i_225_ = i_223_;
			    i_226_ = i_223_;
			...
			byte i_234_;
			if (bool_222_) {
			    i_230_ = (class96_210_.aShortArray934[i_219_]);
			    i_231_ = (class96_210_.aShortArray930[i_219_]);
			    i_232_ = (class96_210_.aShortArray936[i_219_]);
			    i_233_ = (class96_210_.aShortArray937[i_219_]);
			    i_234_ = (class96_210_.aByteArray938[i_219_]);
			    i_219_++;
			} else {
			    i_230_ = i_223_;
			    i_231_ = i_223_;
			...
			if (i_228_ != -1)
			    method4766(0, (class298_sub15.anIntArrayArray7279[i_228_]), 0, 0, 0, i_212_, bool_213_, (i_214_ & (class298_sub15.anIntArray7280[i_228_])), is);
			else if (i_233_ != -1)
			    method4766(0, (class298_sub15.anIntArrayArray7279[i_233_]), 0, 0, 0, i_212_, bool_213_, (i_214_ & (class298_sub15.anIntArray7280[i_233_])), is);
			method4766(i_224_, (class298_sub15.anIntArrayArray7279[i_220_]), i_235_, i_236_, i_237_, i_212_, bool_213_, i_214_ & (class298_sub15.anIntArray7280[i_220_]), is);
		    }
		}
	    }
	}
	...
	i_259_ -= i_262_;
	i_260_ -= i_263_;
	float f_266_ = (i * fs[0] + i_259_ * fs[1] + i_260_ * fs[2]);
	float f_267_ = (i * fs[3] + i_259_ * fs[4] + i_260_ * fs[5]);
	float f_268_ = (i * fs[6] + i_259_ * fs[7] + i_260_ * fs[8]);
	float f_269_ = (float) Math.sqrt(f_266_ * f_266_ + f_267_ * f_267_ + f_268_ * f_268_);
	...
	if (class64.aByteArray635 != null) {
		...
		if (i_296_ > 0) {
			...
			if (i_299_ == 0) {
			    ...
			    f = 1.0F;
			    f_298_ = i_299_ / 1024.0F;
			} else {
			    f_298_ = 1.0F;
			    f = -i_299_ / 1024.0F;
			}
			f_297_ = 64.0F / class64.anIntArray640[i_295_];
		    } else if (i_296_ == 2) {
			f = 64.0F / class64.anIntArray639[i_295_];
			f_297_ = 64.0F / class64.anIntArray640[i_295_];
			f_298_ = 64.0F / class64.anIntArray641[i_295_];
		    } else {
			f = class64.anIntArray639[i_295_] / 1024.0F;
			f_297_ = class64.anIntArray640[i_295_] / 1024.0F;
			f_298_ = class64.anIntArray641[i_295_] / 1024.0F;
		    }
