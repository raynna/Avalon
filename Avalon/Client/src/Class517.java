...
public class Class517 {
	...
	try {
		...
		this.aClass348_6267.method4186(i, -583338746);
	    }
	}
	...
	try {
	    synchronized (this.aClass348_6267) {
		this.aClass348_6267.method4187();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    synchronized (this.aClass348_6267) {
		this.aClass348_6267.method4189();
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    Class520 class520;
	    synchronized (this.aClass348_6267) {
		class520 = (Class520) this.aClass348_6267.method4184(i);
	    }
	    if (class520 != null)
		return class520;
	    byte[] is;
	    synchronized (this.aClass243_6269) {
		is = (this.aClass243_6269.getFile(Class120.aClass120_1452.anInt1460 * -1006924897, i));
	    }
	...
	this.aClass243_6269 = class243;
	if (this.aClass243_6269 != null)
	    anInt6268 = (this.aClass243_6269.method2316(-1006924897 * Class120.aClass120_1452.anInt1460, 650803238)) * 2084802537;
	else
	    anInt6268 = 0;
    }
	...
	try {
		...
		if (Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub14_7571.method5677(-627187888) == 0) {
			...
			Class298_Sub32_Sub14.aClass477_9400.method6086(class_ra, class_ra, (-1979936541 * class298_sub14.anInt7264), (class298_sub14.anInt7261 * -751580615), (1613862267 * class298_sub14.anInt7263), (class298_sub14.anInt7260 * -944151257), false, false, (-1216336855 * class298_sub14.anInt7262), ScriptEnvironment.aClass264_7534, (class298_sub14.aBoolean7265 ? (Class287.myPlayer.aClass366_10209) : null), 1788760477);
    ...
    static final void method6309(Class403 class403, int i) {
	try {
		...
		class403.anObjectArray5240[((class403.anInt5241 += 969361751) * -203050393) - 1] = Class15.aClass507_224.method6269(i_2_, 745591351).method6245(i_3_, class497.aString6101, 1273707892);
	    else
		class403.anIntArray5244[((class403.anInt5239 += -391880689) * 681479919) - 1] = (Class15.aClass507_224.method6269(i_2_, 1830480683).method6239(i_3_, -388931549 * class497.anInt6100, (byte) 106));
	}
	catch (RuntimeException runtimeexception) {
