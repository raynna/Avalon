...
public class Class302_Sub3_Sub1_Sub1 extends Class302_Sub3_Sub1 {
	...
	this.aClass342_10037 = class342;
	anInt9785 = i << 12;
	anInt9789 = i_0_ << 12;
	anInt9790 = i_1_ << 12;
	anInt9792 = i_7_;
	this.aShort10034 = this.aShort10035 = (short) i_6_;
	anInt9791 = i_8_;
	anInt9794 = i_9_;
	...
	this.anInt10032 = i_5_;
	aByte9793 = (this.aClass342_10037.aClass85_3662.aByte780);
	method3725();
    }
	...
	anInt9790 = i_12_ << 12;
	anInt9792 = i_18_;
	this.aShort10034 = this.aShort10035 = (short) i_17_;
	anInt9791 = i_19_;
	anInt9794 = i_20_;
	...
	this.anInt10032 = i_16_;
	aByte9793 = (this.aClass342_10037.aClass85_3662.aByte780);
	method3725();
    }

    void method3725() {
	int i = ((this.aClass342_10037).aClass351_3649.anInt3763);
	if (((this.aClass342_10037).aClass351_3649.aClass302_Sub3_Sub1_Sub1Array3762[i]) != null)
	    (this.aClass342_10037).aClass351_3649.aClass302_Sub3_Sub1_Sub1Array3762[i].method3726();
	(this.aClass342_10037.aClass351_3649).aClass302_Sub3_Sub1_Sub1Array3762[i] = this;
	this.aShort10033 = (short) (this.aClass342_10037.aClass351_3649).anInt3763;
	(this.aClass342_10037).aClass351_3649.anInt3763 = i + 1 & 0x1fff;
	this.aClass342_10037.aClass442_3648.method5870(this, -1945856763);
    }

    void method3726() {
	(this.aClass342_10037).aClass351_3649.aClass302_Sub3_Sub1_Sub1Array3762[this.aShort10033] = null;
	...
	if (i_23_ > 0 || i_23_ < -262144 || i < 0 || i >= class331.anInt3514 * 1988988347 || i_22_ < 0 || i_22_ >= class331.anInt3549 * 1340714547)
	    ...
	    Class351 class351 = ((this.aClass342_10037).aClass351_3649);
	    Class182 class182 = ((this.aClass342_10037).aClass182_3656);
	...
	if (this.aShort10035 <= 0)
		...
		if ((this.aShort10034 - this.aShort10035) <= class182.anInt1886 * -1703669099) {
		    int i_34_ = ((anInt9792 >> 8 & 0xff00) + (this.anInt10040 >> 16 & 0xff) + class182.anInt1879 * -1778169623 * i);
		    int i_35_ = ((anInt9792 & 0xff00) + (this.anInt10040 >> 8 & 0xff) + class182.anInt1880 * 936719777 * i);
		    int i_36_ = ((anInt9792 << 8 & 0xff00) + (this.anInt10040 & 0xff) + class182.anInt1881 * 1137945971 * i);
		    if (i_34_ < 0)
			i_34_ = 0;
		    else if (i_34_ > 65535)
			i_34_ = 65535;
		    ...
		    this.anInt10040 &= ~0xffffff;
		    this.anInt10040 |= (((i_34_ & 0xff) << 16) + ((i_35_ & 0xff) << 8) + (i_36_ & 0xff));
		}
		if ((this.aShort10034 - this.aShort10035) <= class182.anInt1845 * -966201447) {
		    int i_37_ = ((anInt9792 >> 16 & 0xff00) + (this.anInt10040 >> 24 & 0xff) + class182.anInt1882 * 825667009 * i);
		    if (i_37_ < 0)
			i_37_ = 0;
		    else if (i_37_ > 65535)
			i_37_ = 65535;
		    ...
		    this.anInt10040 &= 0xffffff;
		    this.anInt10040 |= (i_37_ & 0xff) << 24;
		}
	    }
	    if (class182.anInt1828 * 799607235 != -1 && ((this.aShort10034 - this.aShort10035) <= class182.anInt1883 * -1035489121))
		this.anInt10032 += class182.anInt1884 * 1185897849 * i;
	    if (class182.anInt1832 * -1628433875 != -1 && ((this.aShort10034 - this.aShort10035) <= class182.anInt1885 * -1648307777))
		anInt9791 += class182.anInt1878 * 308094979 * i;
	    double d = this.aShort10036;
	    double d_38_ = this.aShort10039;
	    double d_39_ = this.aShort10038;
	    boolean bool = false;
	    if (class182.anInt1819 * 166927215 == 1) {
		int i_40_ = (i_31_ - (this.aClass342_10037.aClass363_3655).anInt3926 * 60582813);
		int i_41_ = (i_32_ - (this.aClass342_10037.aClass363_3655).anInt3929 * 915630045);
		int i_42_ = i_33_ - ((this.aClass342_10037).aClass363_3655.anInt3919) * -1989166667;
		int i_43_ = ((int) Math.sqrt(i_40_ * i_40_ + i_41_ * i_41_ + i_42_ * i_42_) >> 2);
		long l_44_ = class182.anInt1847 * 1305957559 * i_43_ * i;
		this.anInt10032 -= (this.anInt10032 * l_44_) >> 18;
	    } else if (class182.anInt1819 * 166927215 == 2) {
		int i_45_ = (i_31_ - (this.aClass342_10037.aClass363_3655).anInt3926 * 60582813);
		int i_46_ = (i_32_ - (this.aClass342_10037.aClass363_3655).anInt3929 * 915630045);
		int i_47_ = i_33_ - ((this.aClass342_10037).aClass363_3655.anInt3919) * -1989166667;
		int i_48_ = i_45_ * i_45_ + i_46_ * i_46_ + i_47_ * i_47_;
		long l_49_ = class182.anInt1847 * 1305957559 * i_48_ * i;
		this.anInt10032 -= (this.anInt10032 * l_49_) >> 28;
	    }
	    if (class182.anIntArray1823 != null) {
		Iterator iterator = class351.aList3768.iterator();
		while (iterator.hasNext()) {
		    Class298_Sub45 class298_sub45 = (Class298_Sub45) iterator.next();
		    Class190 class190 = class298_sub45.aClass190_7514;
			...
			if (bool_50_) {
			    double d_52_ = i_31_ - (class298_sub45.anInt7516 * -1108687965);
			    double d_53_ = i_32_ - (class298_sub45.anInt7517 * 80933881);
			    double d_54_ = i_33_ - (class298_sub45.anInt7519 * -78566587);
				...
				if (d_56_ == 0.0)
				    d_56_ = 1.0;
				double d_57_ = ((d_52_ * (class298_sub45.aFloat7515) + d_53_ * (class190.anInt1934 * -739294135) + d_54_ * (class298_sub45.aFloat7520)) * 65535.0 / (class190.anInt1941 * 1414342983 * d_56_));
				if (!(d_57_ < class190.anInt1943 * -1188833415)) {
				    double d_58_ = 0.0;
				    if (class190.anInt1936 * -1660029223 == 1)
					d_58_ = (d_56_ / 16.0 * (class190.anInt1920 * -1595714959));
				    else if (class190.anInt1936 * -1660029223 == 2)
					d_58_ = (d_56_ / 16.0 * (d_56_ / 16.0) * (class190.anInt1920 * -1595714959));
				    if (class190.anInt1939 * 91019621 == 0) {
					if (class190.anInt1942 * 162409547 == 0) {
					    d += ((class298_sub45.aFloat7515) - d_58_) * i;
					    d_38_ += ((class190.anInt1934) * -739294135 - d_58_) * i;
					    d_39_ += ((class298_sub45.aFloat7520) - d_58_) * i;
					    bool = true;
					} else {
					    anInt9785 += ((class298_sub45.aFloat7515) - d_58_) * i;
					    anInt9789 += ((class190.anInt1934) * -739294135 - d_58_) * i;
					    anInt9790 += ((class298_sub45.aFloat7520) - d_58_) * i;
					}
				    } else {
					double d_59_ = (d_52_ / d_56_ * (class190.anInt1941 * 1414342983));
					double d_60_ = (d_53_ / d_56_ * (class190.anInt1941 * 1414342983));
					double d_61_ = (d_54_ / d_56_ * (class190.anInt1941 * 1414342983));
					if (class190.anInt1942 * 162409547 == 0) {
					    d += d_59_ * i;
					    d_38_ += d_60_ * i;
					    d_39_ += d_61_ * i;
		...
		for (int i_62_ = 0; i_62_ < class182.anIntArray1846.length; i_62_++) {
		    Class298_Sub45 class298_sub45 = ((Class298_Sub45) (Class344.aClass437_3684.method5812(class182.anIntArray1846[i_62_])));
		    while (class298_sub45 != null) {
			Class190 class190 = class298_sub45.aClass190_7514;
			double d_63_ = i_31_ - (class298_sub45.anInt7516) * -1108687965;
			double d_64_ = i_32_ - (class298_sub45.anInt7517) * 80933881;
			double d_65_ = i_33_ - (class298_sub45.anInt7519) * -78566587;
			...
			if (d_66_ > class190.aLong1931 * 6688605316592129449L)
			    ...
			    if (d_67_ == 0.0)
				d_67_ = 1.0;
			    double d_68_ = ((d_63_ * (class298_sub45.aFloat7515) + d_64_ * (class190.anInt1934 * -739294135) + d_65_ * (class298_sub45.aFloat7520)) * 65535.0 / (class190.anInt1941 * 1414342983 * d_67_));
				...
				if (class190.anInt1939 * 91019621 == 0) {
				    if (class190.anInt1942 * 162409547 == 0) {
					d += ((class298_sub45.aFloat7515) - d_69_) * i;
					d_38_ += (class190.anInt1934 * -739294135 - d_69_) * i;
					d_39_ += ((class298_sub45.aFloat7520) - d_69_) * i;
					bool = true;
				    } else {
					anInt9785 += ((class298_sub45.aFloat7515) - d_69_) * i;
					anInt9789 += (class190.anInt1934 * -739294135 - d_69_) * i;
					anInt9790 += ((class298_sub45.aFloat7520) - d_69_) * i;
				    }
				} else {
				    double d_70_ = (d_63_ / d_67_ * (class190.anInt1941 * 1414342983));
				    double d_71_ = (d_64_ / d_67_ * (class190.anInt1941 * 1414342983));
				    double d_72_ = (d_65_ / d_67_ * (class190.anInt1941 * 1414342983));
				    if (class190.anInt1942 * 162409547 == 0) {
					d += d_70_ * i;
					d_38_ += d_71_ * i;
					d_39_ += d_72_ * i;
		...
		if (class182.anIntArray1848 == null) {
			...
			class182.anIntArray1848[i_73_] = (((Class298_Sub35) (Class190.aClass437_1928.method5812(class182.anIntArray1829[i_73_]))).anInt7394) * -774922497;
		    }
		}
		for (int i_74_ = 0; i_74_ < class182.anIntArray1848.length; i_74_++) {
		    ...
		    if (class190.anInt1942 * 162409547 == 0) {
			d += class190.anInt1933 * 1776313545 * i;
			d_38_ += class190.anInt1934 * -739294135 * i;
			d_39_ += class190.anInt1935 * -1849369705 * i;
			bool = true;
		    } else {
		...
		this.aShort10036 = (short) (int) d;
		this.aShort10039 = (short) (int) d_38_;
		this.aShort10038 = (short) (int) d_39_;
	    }
	    anInt9785 += (((long) this.aShort10036 * (long) (this.anInt10032 << 2)) >> 23) * i;
	    anInt9789 += (((long) this.aShort10039 * (long) (this.anInt10032 << 2)) >> 23) * i;
	    anInt9790 += (((long) this.aShort10038 * (long) (this.anInt10032 << 2)) >> 23) * i;
	}
    }
}
