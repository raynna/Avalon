...
public class Class397 {
    ...
    static final void method4911(Class403 class403, short i) {
	try {
	    Class399.method4926((class403.anIntArray5244[(class403.anInt5239 -= -391880689) * 681479919]), -1104898137);
	}
	...
	try {
		...
		float f = client.anInt8857 * 892197957 / 65535.0F;
		...
		for (int i_2_ = 0; i_2_ < 3; i_2_++) {
		    ...
		    fs[i_2_] = (f * (i_7_ + (i_8_ + i_9_ * f) * f) + i_6_);
		}
		...
		for (int i_12_ = 0; i_12_ < 3; i_12_++) {
		    ...
		    fs_10_[i_12_] = ((i_17_ + (f * i_19_ + i_18_) * f) * f + i_16_);
		}
		...
		client.anInt8756 = ((int) (Math.atan2(f_21_, d) * 2607.5945876176133) & 0x3fff) * -648269561;
		Class135.anInt6384 = ((int) (-Math.atan2(f_20_, f_22_) * 2607.5945876176133) & 0x3fff) * -1587695039;
	...
	try {
		...
		if (!class117.method1274(i_35_, i_37_, -1933314892) || !class117.method1274(i_36_, i_37_, -1940258831) || !class117.method1274(i_35_, i_38_, -1423315727) || !class117.method1274(i_36_, i_38_, -1131709831)) {
		    double d = Math.atan2(i_31_, i_32_);
