...
/* Class264_Sub5 - Decompiled by JODE
...
public class Class264_Sub5 extends Class264 {
	...
	float f = this.aClass_ra_Sub3_7139.method4992((short) 4206).method545();
	float f_2_ = this.aClass_ra_Sub3_7139.method4992((short) 5279).method552();
	class138.aClass233_1540.method2147(2.0F / f, 2.0F / f_2_, 1.0F, 1.0F);
	class138.aClass233_1540.aFloatArray2594[12] = ((i + this.aClass_ra_Sub3_7139.method5315()) * 2.0F / f) - 1.0F;
	class138.aClass233_1540.aFloatArray2594[13] = ((i_0_ + this.aClass_ra_Sub3_7139.method5315()) * 2.0F / f_2_) - 1.0F;
	...
	float f = this.aClass_ra_Sub3_7139.method4992((short) -19985).method545();
	float f_5_ = this.aClass_ra_Sub3_7139.method4992((short) -4306).method552();
	class138.aClass233_1540.method2147(2.0F / f, 2.0F / f_5_, 1.0F, 1.0F);
	class138.aClass233_1540.aFloatArray2594[12] = ((i + this.aClass_ra_Sub3_7139.method5315()) * 2.0F / f) - 1.0F;
	class138.aClass233_1540.aFloatArray2594[13] = ((i_3_ + this.aClass_ra_Sub3_7139.method5315()) * 2.0F / f_5_) - 1.0F;
	class138.aClass233_1540.aFloatArray2594[14] = -1.0F;
	class138.aClass233_1541.method2172();
	class138.anInterface7_Impl1_1538 = this.anInterface7_Impl1_7140;
	class138.anInt1543 = c * '\004';
	...
	float f = this.aClass_ra_Sub3_7139.method4992((short) -6084).method545();
	float f_12_ = this.aClass_ra_Sub3_7139.method4992((short) -21308).method552();
	class138.aClass233_1540.method2147(2.0F / f, 2.0F / f_12_, 1.0F, 1.0F);
	class138.aClass233_1540.aFloatArray2594[12] = ((i + this.aClass_ra_Sub3_7139.method5315()) * 2.0F / f) - 1.0F;
	class138.aClass233_1540.aFloatArray2594[13] = ((i_10_ + this.aClass_ra_Sub3_7139.method5315()) * 2.0F / f_12_) - 1.0F;
	class138.aClass233_1540.aFloatArray2594[14] = -1.0F;
	class138.aClass233_1541.method2172();
	class138.anInterface7_Impl1_1538 = this.anInterface7_Impl1_7140;
	class138.anInt1543 = c * '\004';
    ...
    Class264_Sub5(Class_ra_Sub3 class_ra_sub3, Class505 class505, IndexedImage[] class89s, boolean bool) {
	super(class_ra_sub3, class505);
	this.aClass_ra_Sub3_7139 = class_ra_sub3;
	int i = 0;
	for (int i_17_ = 0; i_17_ < 256; i_17_++) {
	    IndexedImage class89 = class89s[i_17_];
	...
	if (bool) {
		...
		IndexedImage class89 = class89s[i_19_];
		...
		IndexedImage class89 = class89s[i_34_];
	...
	bytebuffer.clear();
	float f = (this.anInterface9_Impl2_7138.method77(i_18_) / i_18_);
	float f_49_ = (this.anInterface9_Impl2_7138.method78(i_18_) / i_18_);
	for (int i_50_ = 0; i_50_ < 256; i_50_++) {
	    IndexedImage class89 = class89s[i_50_];
	    int i_51_ = class89.anInt816;
	    int i_52_ = class89.anInt812;
	    int i_53_ = class89.anInt811;
	    int i_54_ = class89.anInt815;
	    float f_55_ = i_50_ % 16 * i;
	    float f_56_ = i_50_ / 16 * i;
	    float f_57_ = f_55_ * f;
	    float f_58_ = f_56_ * f_49_;
	    float f_59_ = (f_55_ + i_52_) * f;
	    float f_60_ = (f_56_ + i_51_) * f_49_;
	    bytebuffer.putFloat(i_54_);
	    bytebuffer.putFloat(i_53_);
	    bytebuffer.putFloat(0.0F);
	    bytebuffer.putFloat(f_57_);
	    bytebuffer.putFloat(f_58_);
	    bytebuffer.putFloat(i_54_);
	    bytebuffer.putFloat(i_53_ + i_51_);
	    bytebuffer.putFloat(0.0F);
	    bytebuffer.putFloat(f_57_);
	    bytebuffer.putFloat(f_60_);
	    bytebuffer.putFloat(i_54_ + i_52_);
	    bytebuffer.putFloat(i_53_ + i_51_);
	    bytebuffer.putFloat(0.0F);
