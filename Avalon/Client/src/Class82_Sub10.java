...
public class Class82_Sub10 extends Class82 {
	...
	try {
	    ...
	    if (client.qa_op && (client.method2801(class105).anInt7416 * -1266165749 != 0 || class105.type * -1215239439 == 0)) {
		...
		class298_sub46.arguements = class105.anObjectArray1164;
		client.aClass453_8893.add(class298_sub46);
	    }
	}
	catch (RuntimeException runtimeexception) {
	...
	try {
	    class403.anIntArray5244[681479919 * class403.anInt5239 - 2] = (Class316.aClass362_3318.method4307((class403.anIntArray5244[class403.anInt5239 * 681479919 - 2]), 245040087).anIntArrayArray4017[(class403.anIntArray5244[class403.anInt5239 * 681479919 - 1])][0]);
