...
public class Class57_Sub3 extends Class57 {
	...
	Class30_Sub2_Sub1 class30_sub2_sub1 = (((Class_ta_Sub1) class_ta).aClass30_Sub2_Sub1_8441);
	if (this.aBoolean9039) {
	    float f_7_ = method271();
	    float f_8_ = method626();
	    float f_9_ = (f_1_ - f) / f_7_;
	    float f_10_ = (f_2_ - f_0_) / f_7_;
	    float f_11_ = (f_3_ - f) / f_8_;
	    float f_12_ = (f_4_ - f_0_) / f_8_;
	    float f_13_ = f_11_ * this.anInt9042;
	    float f_14_ = f_12_ * this.anInt9042;
	    float f_15_ = f_9_ * this.anInt9037;
	    float f_16_ = f_10_ * this.anInt9037;
	    float f_17_ = -f_9_ * this.anInt9045;
	    float f_18_ = -f_10_ * this.anInt9045;
	    float f_19_ = -f_11_ * this.anInt9044;
	    float f_20_ = -f_12_ * this.anInt9044;
	    f = f + f_15_ + f_13_;
	...
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	this.aClass_ra_Sub2_9041.method5243(1);
	this.aClass_ra_Sub2_9041.method5255(1);
	this.aClass_ra_Sub2_9041.method5256(class30_sub2_sub1);
	this.aClass_ra_Sub2_9041.method5258(7681, 8448);
	this.aClass_ra_Sub2_9041.method5259(0, 34168, 768);
	this.aClass_ra_Sub2_9041.method5266(1);
	float f_23_ = (class30_sub2_sub1.aFloat9049 / class30_sub2_sub1.anInt9048);
	float f_24_ = (class30_sub2_sub1.aFloat9051 / class30_sub2_sub1.anInt9047);
	OpenGL.glBegin(7);
	OpenGL.glColor3f(1.0F, 1.0F, 1.0F);
	OpenGL.glMultiTexCoord2f(33984, 0.0F, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	OpenGL.glMultiTexCoord2f(33985, f_23_ * (f - i_5_), ((class30_sub2_sub1.aFloat9051) - f_24_ * (f_0_ - i_6_)));
	OpenGL.glVertex2f(f, f_0_);
	OpenGL.glMultiTexCoord2f(33984, 0.0F, 0.0F);
	OpenGL.glMultiTexCoord2f(33985, f_23_ * (f_3_ - i_5_), ((class30_sub2_sub1.aFloat9051) - f_24_ * (f_4_ - i_6_)));
	OpenGL.glVertex2f(f_3_, f_4_);
	OpenGL.glMultiTexCoord2f(33984, (this.aClass30_Sub2_Sub1_9043).aFloat9049, 0.0F);
	OpenGL.glMultiTexCoord2f(33985, f_23_ * (f_21_ - i_5_), ((class30_sub2_sub1.aFloat9051) - f_24_ * (f_22_ - i_6_)));
	...
	OpenGL.glMultiTexCoord2f(33985, f_23_ * (f_1_ - i_5_), ((class30_sub2_sub1.aFloat9051) - f_24_ * (f_2_ - i_6_)));
	OpenGL.glVertex2f(f_1_, f_2_);
	OpenGL.glEnd();
	this.aClass_ra_Sub2_9041.method5259(0, 5890, 768);
	this.aClass_ra_Sub2_9041.method5243(0);
	this.aClass_ra_Sub2_9041.method5256(null);
	...
	this.anInt9044 = 0;
	this.anInt9045 = 0;
	this.aClass_ra_Sub2_9041 = class_ra_sub2;
	...
	this.anInt9045 = 0;
	this.aClass_ra_Sub2_9041 = class_ra_sub2;
	this.aClass30_Sub2_Sub1_9043 = Class30_Sub2_Sub1.method425(class_ra_sub2, i, i_28_, false, is, i_30_, i_29_);
    }
	...
	return (this.aClass30_Sub2_Sub1_9043.anInt9048);
    }

    @Override
    public int method626() {
	return (this.aClass30_Sub2_Sub1_9043.anInt9047 + this.anInt9042 + this.anInt9044);
    }
	...
	return (this.aClass30_Sub2_Sub1_9043.anInt9048 + this.anInt9037 + this.anInt9045);
    }

    @Override
    void method676(float f, float f_34_, float f_35_, float f_36_, float f_37_, float f_38_, int i, int i_39_, int i_40_, int i_41_) {
	if (this.aBoolean9039) {
	    float f_42_ = method271();
	    float f_43_ = method626();
	    float f_44_ = (f_35_ - f) / f_42_;
	    float f_45_ = (f_36_ - f_34_) / f_42_;
	    float f_46_ = (f_37_ - f) / f_43_;
	    float f_47_ = (f_38_ - f_34_) / f_43_;
	    float f_48_ = f_46_ * this.anInt9042;
	    float f_49_ = f_47_ * this.anInt9042;
	    float f_50_ = f_44_ * this.anInt9037;
	    float f_51_ = f_45_ * this.anInt9037;
	    float f_52_ = -f_44_ * this.anInt9045;
	    float f_53_ = -f_45_ * this.anInt9045;
	    float f_54_ = -f_46_ * this.anInt9044;
	    float f_55_ = -f_47_ * this.anInt9044;
	    f = f + f_50_ + f_48_;
	...
	this.aClass30_Sub2_Sub1_9043.method410((i_41_ & 0x1) != 0);
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	this.aClass_ra_Sub2_9041.method5266(i_40_);
	this.aClass_ra_Sub2_9041.method5243(i);
	...
	if (this.aClass_ra_Sub2_9041.aBoolean8166) {
	    int[] is = this.aClass_ra_Sub2_9041.aq(i_61_, i_62_, i_59_, i_60_);
	    if (is != null) {
	...
	this.aClass30_Sub2_Sub1_9038 = (Class30_Sub2_Sub1.method427(this.aClass_ra_Sub2_9041, i, i_64_, this.aClass30_Sub2_Sub1_9043.anInt9048, this.aClass30_Sub2_Sub1_9043.anInt9047));
	...
	this.aClass_ra_Sub2_9041.method5255(1);
	this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	this.aClass_ra_Sub2_9041.method5258(this.aClass_ra_Sub2_9041.method5288(i), 7681);
	this.aClass_ra_Sub2_9041.method5259(1, 34167, 768);
	this.aClass_ra_Sub2_9041.method5286(0, 34168, 770);
	this.aClass_ra_Sub2_9041.method5255(0);
	this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9038);
	this.aClass_ra_Sub2_9041.method5258(34479, 7681);
	this.aClass_ra_Sub2_9041.method5259(1, 34166, 768);
	if (this.anInt9040 == 0)
	    this.aClass_ra_Sub2_9041.method5260(1.0F, 0.5F, 0.5F, 0.0F);
	else if (this.anInt9040 == 1)
	    this.aClass_ra_Sub2_9041.method5260(0.5F, 1.0F, 0.5F, 0.0F);
	else if (this.anInt9040 == 2)
	    this.aClass_ra_Sub2_9041.method5260(0.5F, 0.5F, 1.0F, 0.0F);
	else if (this.anInt9040 == 3)
	    this.aClass_ra_Sub2_9041.method5260(128.5F, 128.5F, 128.5F, 0.0F);
    }

    void method690() {
	this.aClass_ra_Sub2_9041.method5255(1);
	this.aClass_ra_Sub2_9041.method5256(null);
	this.aClass_ra_Sub2_9041.method5258(8448, 8448);
	this.aClass_ra_Sub2_9041.method5259(1, 34168, 768);
	this.aClass_ra_Sub2_9041.method5286(0, 5890, 770);
	this.aClass_ra_Sub2_9041.method5255(0);
	this.aClass_ra_Sub2_9041.method5259(1, 34168, 768);
    }
	...
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5266(i_70_);
	...
	if (this.aClass30_Sub2_Sub1_9038 == null) {
	    this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	    this.aClass_ra_Sub2_9041.method5243(i_68_);
	    OpenGL.glBegin(7);
	    OpenGL.glTexCoord2f(0.0F, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	    OpenGL.glVertex2i(i, i_67_);
	    OpenGL.glTexCoord2f(0.0F, 0.0F);
	    OpenGL.glVertex2i(i, i_67_ + (this.aClass30_Sub2_Sub1_9043).anInt9047);
	    OpenGL.glTexCoord2f((this.aClass30_Sub2_Sub1_9043).aFloat9049, 0.0F);
	    OpenGL.glVertex2i(i + (this.aClass30_Sub2_Sub1_9043).anInt9048, i_67_ + (this.aClass30_Sub2_Sub1_9043).anInt9047);
	    OpenGL.glTexCoord2f((this.aClass30_Sub2_Sub1_9043).aFloat9049, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	    OpenGL.glVertex2i(i + (this.aClass30_Sub2_Sub1_9043).anInt9048, i_67_);
	    OpenGL.glEnd();
	} else {
	    method689(i_68_);
	...
	int i_74_ = i + this.aClass30_Sub2_Sub1_9043.anInt9048;
	int i_75_ = i_71_ + (this.aClass30_Sub2_Sub1_9043.anInt9047);
	float f = (class30_sub2_sub1.aFloat9049 / class30_sub2_sub1.anInt9048);
	float f_76_ = (class30_sub2_sub1.aFloat9051 / class30_sub2_sub1.anInt9047);
	float f_77_ = (i - i_72_) * f;
	float f_78_ = (i_74_ - i_72_) * f;
	float f_79_ = (class30_sub2_sub1.aFloat9051 - (i_71_ - i_73_) * f_76_);
	float f_80_ = (class30_sub2_sub1.aFloat9051 - (i_75_ - i_73_) * f_76_);
	OpenGL.glBegin(7);
	OpenGL.glColor3f(1.0F, 1.0F, 1.0F);
	OpenGL.glMultiTexCoord2f(33984, 0.0F, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	...
	OpenGL.glVertex2i(i, i_71_ + (this.aClass30_Sub2_Sub1_9043).anInt9047);
	OpenGL.glMultiTexCoord2f(33984, (this.aClass30_Sub2_Sub1_9043).aFloat9049, 0.0F);
	OpenGL.glMultiTexCoord2f(33985, f_78_, f_80_);
	OpenGL.glVertex2i(i + (this.aClass30_Sub2_Sub1_9043.anInt9048), i_71_ + (this.aClass30_Sub2_Sub1_9043).anInt9047);
	OpenGL.glMultiTexCoord2f(33984, (this.aClass30_Sub2_Sub1_9043).aFloat9049, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	OpenGL.glMultiTexCoord2f(33985, f_78_, f_79_);
	OpenGL.glVertex2i(i + (this.aClass30_Sub2_Sub1_9043.anInt9048), i_71_);
	OpenGL.glEnd();
	this.aClass_ra_Sub2_9041.method5259(0, 5890, 768);
	this.aClass_ra_Sub2_9041.method5243(0);
	this.aClass_ra_Sub2_9041.method5256(null);
	...
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5266(i_86_);
	...
	if (this.aBoolean9039) {
	    ...
	    float f_89_ = i + this.anInt9037 * f;
	    float f_90_ = (i_81_ + this.anInt9042 * f_88_);
	    float f_91_ = (f_89_ + (this.aClass30_Sub2_Sub1_9043.anInt9048) * f);
	    float f_92_ = (f_90_ + (this.aClass30_Sub2_Sub1_9043.anInt9047) * f_88_);
	    if (this.aClass30_Sub2_Sub1_9038 == null) {
		this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
		this.aClass_ra_Sub2_9041.method5243(i_84_);
		OpenGL.glBegin(7);
		OpenGL.glTexCoord2f(0.0F, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	...
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	this.aClass_ra_Sub2_9041.method5266(i_98_);
	this.aClass_ra_Sub2_9041.method5243(i_96_);
	...
	if (this.aClass30_Sub2_Sub1_9043.aBoolean9050 && !this.aBoolean9039) {
	    float f = (this.aClass30_Sub2_Sub1_9043.aFloat9051 * i_95_ / (this.aClass30_Sub2_Sub1_9043.anInt9047));
	    float f_101_ = (this.aClass30_Sub2_Sub1_9043.aFloat9049 * i_94_ / (this.aClass30_Sub2_Sub1_9043.anInt9048));
	    OpenGL.glBegin(7);
	    ...
	    OpenGL.glPushMatrix();
	    OpenGL.glTranslatef(this.anInt9037, this.anInt9042, 0.0F);
	    int i_102_ = method271();
	    int i_103_ = method626();
	    int i_104_ = i_93_ + (this.aClass30_Sub2_Sub1_9043.anInt9047);
	    OpenGL.glBegin(7);
	    int i_105_ = i_93_;
	    for (/**/; i_104_ <= i_100_; i_104_ += i_103_) {
		int i_106_ = i + (this.aClass30_Sub2_Sub1_9043.anInt9048);
		int i_107_ = i;
		while (i_106_ <= i_99_) {
		    OpenGL.glTexCoord2f(0.0F, ((this.aClass30_Sub2_Sub1_9043).aFloat9051));
		...
		if (i_107_ < i_99_) {
		    float f = ((this.aClass30_Sub2_Sub1_9043.aFloat9049) * (i_99_ - i_107_) / (this.aClass30_Sub2_Sub1_9043).anInt9048);
		    OpenGL.glTexCoord2f(0.0F, ((this.aClass30_Sub2_Sub1_9043).aFloat9051));
		    OpenGL.glVertex2i(i_107_, i_105_);
		    OpenGL.glTexCoord2f(0.0F, 0.0F);
		    OpenGL.glVertex2i(i_107_, i_104_);
	    ...
	    if (i_105_ < i_100_) {
		float f = ((this.aClass30_Sub2_Sub1_9043.aFloat9051) * ((this.aClass30_Sub2_Sub1_9043).anInt9047 - (i_100_ - i_105_)) / (this.aClass30_Sub2_Sub1_9043).anInt9047);
		int i_108_ = i + (this.aClass30_Sub2_Sub1_9043.anInt9048);
		int i_109_ = i;
		while (i_108_ <= i_99_) {
		    OpenGL.glTexCoord2f(0.0F, ((this.aClass30_Sub2_Sub1_9043).aFloat9051));
		...
		if (i_109_ < i_99_) {
		    float f_110_ = ((this.aClass30_Sub2_Sub1_9043.aFloat9049) * (i_99_ - i_109_) / (this.aClass30_Sub2_Sub1_9043).anInt9048);
		    OpenGL.glTexCoord2f(0.0F, ((this.aClass30_Sub2_Sub1_9043).aFloat9051));
		    OpenGL.glVertex2i(i_109_, i_105_);
		    OpenGL.glTexCoord2f(0.0F, f);
		    OpenGL.glVertex2i(i_109_, i_100_);
	...
	if (this.aBoolean9039) {
	    float f_119_ = method271();
	    float f_120_ = method626();
	    ...
	    float f_125_ = f_123_ * this.anInt9042;
	    float f_126_ = f_124_ * this.anInt9042;
	    float f_127_ = f_121_ * this.anInt9037;
	    float f_128_ = f_122_ * this.anInt9037;
	    float f_129_ = -f_121_ * this.anInt9045;
	    float f_130_ = -f_122_ * this.anInt9045;
	    float f_131_ = -f_123_ * this.anInt9044;
	    float f_132_ = -f_124_ * this.anInt9044;
	    f = f + f_127_ + f_125_;
	...
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	this.aClass_ra_Sub2_9041.method5266(i_117_);
	this.aClass_ra_Sub2_9041.method5243(i);
	...
	Class30_Sub2_Sub1 class30_sub2_sub1 = (((Class_ta_Sub1) class_ta).aClass30_Sub2_Sub1_8441);
	if (this.aBoolean9039) {
	    float f_142_ = method271();
	    float f_143_ = method626();
	    ...
	    float f_148_ = f_146_ * this.anInt9042;
	    float f_149_ = f_147_ * this.anInt9042;
	    float f_150_ = f_144_ * this.anInt9037;
	    float f_151_ = f_145_ * this.anInt9037;
	    float f_152_ = -f_144_ * this.anInt9045;
	    float f_153_ = -f_145_ * this.anInt9045;
	    float f_154_ = -f_146_ * this.anInt9044;
	    float f_155_ = -f_147_ * this.anInt9044;
	    f = f + f_150_ + f_148_;
	...
	this.aClass_ra_Sub2_9041.method5259(0, 34168, 768);
	this.aClass_ra_Sub2_9041.method5266(1);
	float f_158_ = (class30_sub2_sub1.aFloat9049 / class30_sub2_sub1.anInt9048);
	float f_159_ = (class30_sub2_sub1.aFloat9051 / class30_sub2_sub1.anInt9047);
	OpenGL.glBegin(7);
	OpenGL.glColor3f(1.0F, 1.0F, 1.0F);
	OpenGL.glMultiTexCoord2f(33984, 0.0F, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	OpenGL.glMultiTexCoord2f(33985, f_158_ * (f - i_140_), ((class30_sub2_sub1.aFloat9051) - f_159_ * (f_135_ - i_141_)));
	OpenGL.glVertex2f(f, f_135_);
	OpenGL.glMultiTexCoord2f(33984, 0.0F, 0.0F);
	OpenGL.glMultiTexCoord2f(33985, f_158_ * (f_138_ - i_140_), ((class30_sub2_sub1.aFloat9051) - f_159_ * (f_139_ - i_141_)));
	OpenGL.glVertex2f(f_138_, f_139_);
	OpenGL.glMultiTexCoord2f(33984, (this.aClass30_Sub2_Sub1_9043).aFloat9049, 0.0F);
	OpenGL.glMultiTexCoord2f(33985, f_158_ * (f_156_ - i_140_), ((class30_sub2_sub1.aFloat9051) - f_159_ * (f_157_ - i_141_)));
	OpenGL.glVertex2f(f_156_, f_157_);
	OpenGL.glMultiTexCoord2f(33984, (this.aClass30_Sub2_Sub1_9043).aFloat9049, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	OpenGL.glMultiTexCoord2f(33985, f_158_ * (f_136_ - i_140_), ((class30_sub2_sub1.aFloat9051) - f_159_ * (f_137_ - i_141_)));
	...
	this.aClass_ra_Sub2_9041.method5266(1);
	i += this.anInt9037;
	i_160_ += this.anInt9042;
	int i_163_ = i + this.aClass30_Sub2_Sub1_9043.anInt9048;
	int i_164_ = i_160_ + (this.aClass30_Sub2_Sub1_9043.anInt9047);
	float f = (class30_sub2_sub1.aFloat9049 / class30_sub2_sub1.anInt9048);
	float f_165_ = (class30_sub2_sub1.aFloat9051 / class30_sub2_sub1.anInt9047);
	float f_166_ = (i - i_161_) * f;
	float f_167_ = (i_163_ - i_161_) * f;
	float f_168_ = (class30_sub2_sub1.aFloat9051 - (i_160_ - i_162_) * f_165_);
	float f_169_ = (class30_sub2_sub1.aFloat9051 - (i_164_ - i_162_) * f_165_);
	OpenGL.glBegin(7);
	OpenGL.glColor3f(1.0F, 1.0F, 1.0F);
	OpenGL.glMultiTexCoord2f(33984, 0.0F, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	...
	OpenGL.glVertex2i(i, i_160_ + (this.aClass30_Sub2_Sub1_9043).anInt9047);
	OpenGL.glMultiTexCoord2f(33984, (this.aClass30_Sub2_Sub1_9043).aFloat9049, 0.0F);
	OpenGL.glMultiTexCoord2f(33985, f_167_, f_169_);
	OpenGL.glVertex2i(i + (this.aClass30_Sub2_Sub1_9043.anInt9048), i_160_ + (this.aClass30_Sub2_Sub1_9043).anInt9047);
	OpenGL.glMultiTexCoord2f(33984, (this.aClass30_Sub2_Sub1_9043).aFloat9049, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	OpenGL.glMultiTexCoord2f(33985, f_167_, f_168_);
	OpenGL.glVertex2i(i + (this.aClass30_Sub2_Sub1_9043.anInt9048), i_160_);
	OpenGL.glEnd();
	this.aClass_ra_Sub2_9041.method5259(0, 5890, 768);
	this.aClass_ra_Sub2_9041.method5243(0);
	this.aClass_ra_Sub2_9041.method5256(null);
	...
	this.aClass30_Sub2_Sub1_9043.method410(false);
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5266(i_173_);
	OpenGL.glColor4ub((byte) (i_172_ >> 16), (byte) (i_172_ >> 8), (byte) i_172_, (byte) (i_172_ >> 24));
	i += this.anInt9037;
	i_170_ += this.anInt9042;
	if (this.aClass30_Sub2_Sub1_9038 == null) {
	    this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	    this.aClass_ra_Sub2_9041.method5243(i_171_);
	    OpenGL.glBegin(7);
	    OpenGL.glTexCoord2f(0.0F, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	    OpenGL.glVertex2i(i, i_170_);
	    OpenGL.glTexCoord2f(0.0F, 0.0F);
	    OpenGL.glVertex2i(i, i_170_ + (this.aClass30_Sub2_Sub1_9043).anInt9047);
	    OpenGL.glTexCoord2f((this.aClass30_Sub2_Sub1_9043).aFloat9049, 0.0F);
	    OpenGL.glVertex2i(i + (this.aClass30_Sub2_Sub1_9043).anInt9048, i_170_ + (this.aClass30_Sub2_Sub1_9043).anInt9047);
	    OpenGL.glTexCoord2f((this.aClass30_Sub2_Sub1_9043).aFloat9049, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	    OpenGL.glVertex2i(i + (this.aClass30_Sub2_Sub1_9043).anInt9048, i_170_);
	    OpenGL.glEnd();
	} else {
	    method689(i_171_);
	    this.aClass30_Sub2_Sub1_9038.method410(false);
	...
	if (this.aClass_ra_Sub2_9041.aBoolean8166) {
	    int[] is = this.aClass_ra_Sub2_9041.aq(i_177_, i_178_, i_175_, i_176_);
	    if (is != null) {
	    ...
	    this.aClass30_Sub2_Sub1_9043.method419(i, i_174_, i_175_, i_176_, i_177_, i_178_);
    }
	...
	Class30_Sub2_Sub1 class30_sub2_sub1 = (((Class_ta_Sub1) class_ta).aClass30_Sub2_Sub1_8441);
	if (this.aBoolean9039) {
	    float f_187_ = method271();
	    float f_188_ = method626();
	    ...
	    float f_193_ = f_191_ * this.anInt9042;
	    float f_194_ = f_192_ * this.anInt9042;
	    float f_195_ = f_189_ * this.anInt9037;
	    float f_196_ = f_190_ * this.anInt9037;
	    float f_197_ = -f_189_ * this.anInt9045;
	    float f_198_ = -f_190_ * this.anInt9045;
	    float f_199_ = -f_191_ * this.anInt9044;
	    float f_200_ = -f_192_ * this.anInt9044;
	    f = f + f_195_ + f_193_;
	...
	this.aClass_ra_Sub2_9041.method5259(0, 34168, 768);
	this.aClass_ra_Sub2_9041.method5266(1);
	float f_203_ = (class30_sub2_sub1.aFloat9049 / class30_sub2_sub1.anInt9048);
	float f_204_ = (class30_sub2_sub1.aFloat9051 / class30_sub2_sub1.anInt9047);
	OpenGL.glBegin(7);
	OpenGL.glColor3f(1.0F, 1.0F, 1.0F);
	OpenGL.glMultiTexCoord2f(33984, 0.0F, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	OpenGL.glMultiTexCoord2f(33985, f_203_ * (f - i_185_), ((class30_sub2_sub1.aFloat9051) - f_204_ * (f_180_ - i_186_)));
	OpenGL.glVertex2f(f, f_180_);
	OpenGL.glMultiTexCoord2f(33984, 0.0F, 0.0F);
	OpenGL.glMultiTexCoord2f(33985, f_203_ * (f_183_ - i_185_), ((class30_sub2_sub1.aFloat9051) - f_204_ * (f_184_ - i_186_)));
	OpenGL.glVertex2f(f_183_, f_184_);
	OpenGL.glMultiTexCoord2f(33984, (this.aClass30_Sub2_Sub1_9043).aFloat9049, 0.0F);
	OpenGL.glMultiTexCoord2f(33985, f_203_ * (f_201_ - i_185_), ((class30_sub2_sub1.aFloat9051) - f_204_ * (f_202_ - i_186_)));
	OpenGL.glVertex2f(f_201_, f_202_);
	OpenGL.glMultiTexCoord2f(33984, (this.aClass30_Sub2_Sub1_9043).aFloat9049, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	OpenGL.glMultiTexCoord2f(33985, f_203_ * (f_181_ - i_185_), ((class30_sub2_sub1.aFloat9051) - f_204_ * (f_182_ - i_186_)));
	...
	this.aClass30_Sub2_Sub1_9043.method410(false);
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5266(i_208_);
	OpenGL.glColor4ub((byte) (i_207_ >> 16), (byte) (i_207_ >> 8), (byte) i_207_, (byte) (i_207_ >> 24));
	i += this.anInt9037;
	i_205_ += this.anInt9042;
	if (this.aClass30_Sub2_Sub1_9038 == null) {
	    this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	    this.aClass_ra_Sub2_9041.method5243(i_206_);
	    OpenGL.glBegin(7);
	    OpenGL.glTexCoord2f(0.0F, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	    OpenGL.glVertex2i(i, i_205_);
	    OpenGL.glTexCoord2f(0.0F, 0.0F);
	    OpenGL.glVertex2i(i, i_205_ + (this.aClass30_Sub2_Sub1_9043).anInt9047);
	    OpenGL.glTexCoord2f((this.aClass30_Sub2_Sub1_9043).aFloat9049, 0.0F);
	    OpenGL.glVertex2i(i + (this.aClass30_Sub2_Sub1_9043).anInt9048, i_205_ + (this.aClass30_Sub2_Sub1_9043).anInt9047);
	    OpenGL.glTexCoord2f((this.aClass30_Sub2_Sub1_9043).aFloat9049, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	    OpenGL.glVertex2i(i + (this.aClass30_Sub2_Sub1_9043).anInt9048, i_205_);
	    OpenGL.glEnd();
	} else {
	    method689(i_206_);
	    this.aClass30_Sub2_Sub1_9038.method410(false);
	...
	this.aClass30_Sub2_Sub1_9043.method410((i_215_ & 0x1) != 0);
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5266(i_214_);
	...
	if (this.aBoolean9039) {
	    ...
	    float f_217_ = i + this.anInt9037 * f;
	    float f_218_ = (i_209_ + this.anInt9042 * f_216_);
	    float f_219_ = (f_217_ + (this.aClass30_Sub2_Sub1_9043.anInt9048) * f);
	    float f_220_ = (f_218_ + (this.aClass30_Sub2_Sub1_9043.anInt9047) * f_216_);
	    if (this.aClass30_Sub2_Sub1_9038 == null) {
		this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
		this.aClass_ra_Sub2_9041.method5243(i_212_);
		OpenGL.glBegin(7);
		OpenGL.glTexCoord2f(0.0F, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	...
	this.aClass30_Sub2_Sub1_9043.method410((i_227_ & 0x1) != 0);
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5266(i_226_);
	...
	if (this.aBoolean9039) {
	    ...
	    float f_229_ = i + this.anInt9037 * f;
	    float f_230_ = (i_221_ + this.anInt9042 * f_228_);
	    float f_231_ = (f_229_ + (this.aClass30_Sub2_Sub1_9043.anInt9048) * f);
	    float f_232_ = (f_230_ + (this.aClass30_Sub2_Sub1_9043.anInt9047) * f_228_);
	    if (this.aClass30_Sub2_Sub1_9038 == null) {
		this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
		this.aClass_ra_Sub2_9041.method5243(i_224_);
		OpenGL.glBegin(7);
		OpenGL.glTexCoord2f(0.0F, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	...
	if (this.aClass_ra_Sub2_9041.aBoolean8166) {
	    int[] is = this.aClass_ra_Sub2_9041.aq(i_236_, i_237_, i_234_, i_235_);
	    if (is != null) {
	    ...
	    this.aClass30_Sub2_Sub1_9043.method419(i, i_233_, i_234_, i_235_, i_236_, i_237_);
    }
	...
	this.anInt9037 = i;
	this.anInt9042 = i_239_;
	this.anInt9045 = i_240_;
	this.anInt9044 = i_241_;
	this.aBoolean9039 = (this.anInt9037 != 0 || this.anInt9042 != 0 || this.anInt9045 != 0 || this.anInt9044 != 0);
    }
	...
	OpenGL.glPixelTransferf(3354, 0.5F);
	OpenGL.glPixelTransferf(3355, 0.499F);
	this.aClass30_Sub2_Sub1_9038 = (Class30_Sub2_Sub1.method427(this.aClass_ra_Sub2_9041, i, i_242_, this.aClass30_Sub2_Sub1_9043.anInt9048, this.aClass30_Sub2_Sub1_9043.anInt9047));
	this.anInt9040 = i_243_;
	OpenGL.glPixelTransferf(3348, 1.0F);
	OpenGL.glPixelTransferf(3349, 0.0F);
	OpenGL.glPixelTransferf(3352, 1.0F);
	OpenGL.glPixelTransferf(3353, 0.0F);
	...
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	this.aClass_ra_Sub2_9041.method5266(i_254_);
	this.aClass_ra_Sub2_9041.method5243(i_252_);
	OpenGL.glColor4ub((byte) (i_253_ >> 16), (byte) (i_253_ >> 8), (byte) i_253_, (byte) (i_253_ >> 24));
	if (this.aClass30_Sub2_Sub1_9043.aBoolean9050 && !this.aBoolean9039) {
	    float f = (this.aClass30_Sub2_Sub1_9043.aFloat9051 * i_251_ / (this.aClass30_Sub2_Sub1_9043.anInt9047));
	    float f_257_ = (this.aClass30_Sub2_Sub1_9043.aFloat9049 * i_250_ / (this.aClass30_Sub2_Sub1_9043.anInt9048));
	    OpenGL.glBegin(7);
	    OpenGL.glTexCoord2f(0.0F, f);
	    ...
	    int i_260_ = i_249_ + (this.aClass30_Sub2_Sub1_9043.anInt9047);
	    OpenGL.glBegin(7);
	    int i_261_ = i_249_;
	    for (/**/; i_260_ <= i_256_; i_260_ += i_259_) {
		int i_262_ = i + (this.aClass30_Sub2_Sub1_9043.anInt9048);
		int i_263_ = i;
		while (i_262_ <= i_255_) {
		    OpenGL.glTexCoord2f(0.0F, ((this.aClass30_Sub2_Sub1_9043).aFloat9051));
		...
		if (i_263_ < i_255_) {
		    float f = ((this.aClass30_Sub2_Sub1_9043.aFloat9049) * (i_255_ - i_263_) / (this.aClass30_Sub2_Sub1_9043).anInt9048);
		    OpenGL.glTexCoord2f(0.0F, ((this.aClass30_Sub2_Sub1_9043).aFloat9051));
		    OpenGL.glVertex2i(i_263_, i_261_);
		    OpenGL.glTexCoord2f(0.0F, 0.0F);
		    OpenGL.glVertex2i(i_263_, i_260_);
	    ...
	    if (i_261_ < i_256_) {
		float f = ((this.aClass30_Sub2_Sub1_9043.aFloat9051) * ((this.aClass30_Sub2_Sub1_9043).anInt9047 - (i_256_ - i_261_)) / (this.aClass30_Sub2_Sub1_9043).anInt9047);
		int i_264_ = i + (this.aClass30_Sub2_Sub1_9043.anInt9048);
		int i_265_ = i;
		while (i_264_ <= i_255_) {
		    OpenGL.glTexCoord2f(0.0F, ((this.aClass30_Sub2_Sub1_9043).aFloat9051));
		...
		if (i_265_ < i_255_) {
		    float f_266_ = ((this.aClass30_Sub2_Sub1_9043.aFloat9049) * (i_255_ - i_265_) / (this.aClass30_Sub2_Sub1_9043).anInt9048);
		    OpenGL.glTexCoord2f(0.0F, ((this.aClass30_Sub2_Sub1_9043).aFloat9051));
		    OpenGL.glVertex2i(i_265_, i_261_);
		    OpenGL.glTexCoord2f(0.0F, f);
		    OpenGL.glVertex2i(i_265_, i_256_);
		    ...
		    OpenGL.glVertex2i(i_255_, i_256_);
		    OpenGL.glTexCoord2f(f_266_, ((this.aClass30_Sub2_Sub1_9043).aFloat9051));
		    OpenGL.glVertex2i(i_255_, i_261_);
		}
	    }
	    OpenGL.glEnd();
	...
	if (this.aBoolean9039) {
	    float f_275_ = method271();
	    float f_276_ = method626();
	    ...
	    float f_281_ = f_279_ * this.anInt9042;
	    float f_282_ = f_280_ * this.anInt9042;
	    float f_283_ = f_277_ * this.anInt9037;
	    float f_284_ = f_278_ * this.anInt9037;
	    float f_285_ = -f_277_ * this.anInt9045;
	    float f_286_ = -f_278_ * this.anInt9045;
	    float f_287_ = -f_279_ * this.anInt9044;
	    float f_288_ = -f_280_ * this.anInt9044;
	    f = f + f_283_ + f_281_;
	...
	this.aClass30_Sub2_Sub1_9043.method410((i_274_ & 0x1) != 0);
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	this.aClass_ra_Sub2_9041.method5266(i_273_);
	this.aClass_ra_Sub2_9041.method5243(i);
	...
	if (this.aBoolean9039) {
	    float f_299_ = method271();
	    float f_300_ = method626();
	    ...
	    float f_305_ = f_303_ * this.anInt9042;
	    float f_306_ = f_304_ * this.anInt9042;
	    float f_307_ = f_301_ * this.anInt9037;
	    float f_308_ = f_302_ * this.anInt9037;
	    float f_309_ = -f_301_ * this.anInt9045;
	    float f_310_ = -f_302_ * this.anInt9045;
	    float f_311_ = -f_303_ * this.anInt9044;
	    float f_312_ = -f_304_ * this.anInt9044;
	    f = f + f_307_ + f_305_;
	...
	this.aClass30_Sub2_Sub1_9043.method410((i_298_ & 0x1) != 0);
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	this.aClass_ra_Sub2_9041.method5266(i_297_);
	this.aClass_ra_Sub2_9041.method5243(i);
	...
	if (this.aBoolean9039) {
	    float f_323_ = method271();
	    float f_324_ = method626();
	    ...
	    float f_329_ = f_327_ * this.anInt9042;
	    float f_330_ = f_328_ * this.anInt9042;
	    float f_331_ = f_325_ * this.anInt9037;
	    float f_332_ = f_326_ * this.anInt9037;
	    float f_333_ = -f_325_ * this.anInt9045;
	    float f_334_ = -f_326_ * this.anInt9045;
	    float f_335_ = -f_327_ * this.anInt9044;
	    float f_336_ = -f_328_ * this.anInt9044;
	    f = f + f_331_ + f_329_;
	...
	this.aClass30_Sub2_Sub1_9043.method410((i_322_ & 0x1) != 0);
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	this.aClass_ra_Sub2_9041.method5266(i_321_);
	this.aClass_ra_Sub2_9041.method5243(i);
	...
	this.aClass30_Sub2_Sub1_9043.method410(false);
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5266(i_342_);
	OpenGL.glColor4ub((byte) (i_341_ >> 16), (byte) (i_341_ >> 8), (byte) i_341_, (byte) (i_341_ >> 24));
	i += this.anInt9037;
	i_339_ += this.anInt9042;
	if (this.aClass30_Sub2_Sub1_9038 == null) {
	    this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	    this.aClass_ra_Sub2_9041.method5243(i_340_);
	    OpenGL.glBegin(7);
	    OpenGL.glTexCoord2f(0.0F, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	    OpenGL.glVertex2i(i, i_339_);
	    OpenGL.glTexCoord2f(0.0F, 0.0F);
	    OpenGL.glVertex2i(i, i_339_ + (this.aClass30_Sub2_Sub1_9043).anInt9047);
	    OpenGL.glTexCoord2f((this.aClass30_Sub2_Sub1_9043).aFloat9049, 0.0F);
	    OpenGL.glVertex2i(i + (this.aClass30_Sub2_Sub1_9043).anInt9048, i_339_ + (this.aClass30_Sub2_Sub1_9043).anInt9047);
	    OpenGL.glTexCoord2f((this.aClass30_Sub2_Sub1_9043).aFloat9049, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	    OpenGL.glVertex2i(i + (this.aClass30_Sub2_Sub1_9043).anInt9048, i_339_);
	    OpenGL.glEnd();
	} else {
	    method689(i_340_);
	    this.aClass30_Sub2_Sub1_9038.method410(false);
	...
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	this.aClass_ra_Sub2_9041.method5266(i_348_);
	this.aClass_ra_Sub2_9041.method5243(i_346_);
	OpenGL.glColor4ub((byte) (i_347_ >> 16), (byte) (i_347_ >> 8), (byte) i_347_, (byte) (i_347_ >> 24));
	if (this.aClass30_Sub2_Sub1_9043.aBoolean9050 && !this.aBoolean9039) {
	    float f = (this.aClass30_Sub2_Sub1_9043.aFloat9051 * i_345_ / (this.aClass30_Sub2_Sub1_9043.anInt9047));
	    float f_351_ = (this.aClass30_Sub2_Sub1_9043.aFloat9049 * i_344_ / (this.aClass30_Sub2_Sub1_9043.anInt9048));
	    OpenGL.glBegin(7);
	    OpenGL.glTexCoord2f(0.0F, f);
	    ...
	    int i_354_ = i_343_ + (this.aClass30_Sub2_Sub1_9043.anInt9047);
	    OpenGL.glBegin(7);
	    int i_355_ = i_343_;
	    for (/**/; i_354_ <= i_350_; i_354_ += i_353_) {
		int i_356_ = i + (this.aClass30_Sub2_Sub1_9043.anInt9048);
		int i_357_ = i;
		while (i_356_ <= i_349_) {
		    OpenGL.glTexCoord2f(0.0F, ((this.aClass30_Sub2_Sub1_9043).aFloat9051));
		...
		if (i_357_ < i_349_) {
		    float f = ((this.aClass30_Sub2_Sub1_9043.aFloat9049) * (i_349_ - i_357_) / (this.aClass30_Sub2_Sub1_9043).anInt9048);
		    OpenGL.glTexCoord2f(0.0F, ((this.aClass30_Sub2_Sub1_9043).aFloat9051));
		    OpenGL.glVertex2i(i_357_, i_355_);
		    OpenGL.glTexCoord2f(0.0F, 0.0F);
		    OpenGL.glVertex2i(i_357_, i_354_);
	    ...
	    if (i_355_ < i_350_) {
		float f = ((this.aClass30_Sub2_Sub1_9043.aFloat9051) * ((this.aClass30_Sub2_Sub1_9043).anInt9047 - (i_350_ - i_355_)) / (this.aClass30_Sub2_Sub1_9043).anInt9047);
		int i_358_ = i + (this.aClass30_Sub2_Sub1_9043.anInt9048);
		int i_359_ = i;
		while (i_358_ <= i_349_) {
		    OpenGL.glTexCoord2f(0.0F, ((this.aClass30_Sub2_Sub1_9043).aFloat9051));
		...
		if (i_359_ < i_349_) {
		    float f_360_ = ((this.aClass30_Sub2_Sub1_9043.aFloat9049) * (i_349_ - i_359_) / (this.aClass30_Sub2_Sub1_9043).anInt9048);
		    OpenGL.glTexCoord2f(0.0F, ((this.aClass30_Sub2_Sub1_9043).aFloat9051));
		    OpenGL.glVertex2i(i_359_, i_355_);
		    OpenGL.glTexCoord2f(0.0F, f);
		    OpenGL.glVertex2i(i_359_, i_350_);
		    ...
		    OpenGL.glVertex2i(i_349_, i_350_);
		    OpenGL.glTexCoord2f(f_360_, ((this.aClass30_Sub2_Sub1_9043).aFloat9051));
		    OpenGL.glVertex2i(i_349_, i_355_);
		}
	    }
	    OpenGL.glEnd();
	...
	if (this.aBoolean9039) {
	    float f_369_ = method271();
	    float f_370_ = method626();
	    ...
	    float f_375_ = f_373_ * this.anInt9042;
	    float f_376_ = f_374_ * this.anInt9042;
	    float f_377_ = f_371_ * this.anInt9037;
	    float f_378_ = f_372_ * this.anInt9037;
	    float f_379_ = -f_371_ * this.anInt9045;
	    float f_380_ = -f_372_ * this.anInt9045;
	    float f_381_ = -f_373_ * this.anInt9044;
	    float f_382_ = -f_374_ * this.anInt9044;
	    f = f + f_377_ + f_375_;
	...
	this.aClass30_Sub2_Sub1_9043.method410((i_368_ & 0x1) != 0);
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	this.aClass_ra_Sub2_9041.method5266(i_367_);
	this.aClass_ra_Sub2_9041.method5243(i);
	...
	if (this.aBoolean9039) {
	    float f_393_ = method271();
	    float f_394_ = method626();
	    ...
	    float f_399_ = f_397_ * this.anInt9042;
	    float f_400_ = f_398_ * this.anInt9042;
	    float f_401_ = f_395_ * this.anInt9037;
	    float f_402_ = f_396_ * this.anInt9037;
	    float f_403_ = -f_395_ * this.anInt9045;
	    float f_404_ = -f_396_ * this.anInt9045;
	    float f_405_ = -f_397_ * this.anInt9044;
	    float f_406_ = -f_398_ * this.anInt9044;
	    f = f + f_401_ + f_399_;
	...
	this.aClass30_Sub2_Sub1_9043.method410((i_392_ & 0x1) != 0);
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	this.aClass_ra_Sub2_9041.method5266(i_391_);
	this.aClass_ra_Sub2_9041.method5243(i);
	...
	this.aClass30_Sub2_Sub1_9043.method410(false);
	this.aClass_ra_Sub2_9041.method5251();
	this.aClass_ra_Sub2_9041.method5266(i_412_);
	OpenGL.glColor4ub((byte) (i_411_ >> 16), (byte) (i_411_ >> 8), (byte) i_411_, (byte) (i_411_ >> 24));
	i += this.anInt9037;
	i_409_ += this.anInt9042;
	if (this.aClass30_Sub2_Sub1_9038 == null) {
	    this.aClass_ra_Sub2_9041.method5256(this.aClass30_Sub2_Sub1_9043);
	    this.aClass_ra_Sub2_9041.method5243(i_410_);
	    OpenGL.glBegin(7);
	    OpenGL.glTexCoord2f(0.0F, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	    OpenGL.glVertex2i(i, i_409_);
	    OpenGL.glTexCoord2f(0.0F, 0.0F);
	    OpenGL.glVertex2i(i, i_409_ + (this.aClass30_Sub2_Sub1_9043).anInt9047);
	    OpenGL.glTexCoord2f((this.aClass30_Sub2_Sub1_9043).aFloat9049, 0.0F);
	    OpenGL.glVertex2i(i + (this.aClass30_Sub2_Sub1_9043).anInt9048, i_409_ + (this.aClass30_Sub2_Sub1_9043).anInt9047);
	    OpenGL.glTexCoord2f((this.aClass30_Sub2_Sub1_9043).aFloat9049, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	    OpenGL.glVertex2i(i + (this.aClass30_Sub2_Sub1_9043).anInt9048, i_409_);
	    OpenGL.glEnd();
	} else {
	    method689(i_410_);
	    this.aClass30_Sub2_Sub1_9038.method410(false);
	...
	Class30_Sub2_Sub1 class30_sub2_sub1 = (((Class_ta_Sub1) class_ta).aClass30_Sub2_Sub1_8441);
	if (this.aBoolean9039) {
	    float f_420_ = method271();
	    float f_421_ = method626();
	    ...
	    float f_426_ = f_424_ * this.anInt9042;
	    float f_427_ = f_425_ * this.anInt9042;
	    float f_428_ = f_422_ * this.anInt9037;
	    float f_429_ = f_423_ * this.anInt9037;
	    float f_430_ = -f_422_ * this.anInt9045;
	    float f_431_ = -f_423_ * this.anInt9045;
	    float f_432_ = -f_424_ * this.anInt9044;
	    float f_433_ = -f_425_ * this.anInt9044;
	    f = f + f_428_ + f_426_;
	...
	this.aClass_ra_Sub2_9041.method5259(0, 34168, 768);
	this.aClass_ra_Sub2_9041.method5266(1);
	float f_436_ = (class30_sub2_sub1.aFloat9049 / class30_sub2_sub1.anInt9048);
	float f_437_ = (class30_sub2_sub1.aFloat9051 / class30_sub2_sub1.anInt9047);
	OpenGL.glBegin(7);
	OpenGL.glColor3f(1.0F, 1.0F, 1.0F);
	OpenGL.glMultiTexCoord2f(33984, 0.0F, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	OpenGL.glMultiTexCoord2f(33985, f_436_ * (f - i_418_), ((class30_sub2_sub1.aFloat9051) - f_437_ * (f_413_ - i_419_)));
	OpenGL.glVertex2f(f, f_413_);
	OpenGL.glMultiTexCoord2f(33984, 0.0F, 0.0F);
	OpenGL.glMultiTexCoord2f(33985, f_436_ * (f_416_ - i_418_), ((class30_sub2_sub1.aFloat9051) - f_437_ * (f_417_ - i_419_)));
	OpenGL.glVertex2f(f_416_, f_417_);
	OpenGL.glMultiTexCoord2f(33984, (this.aClass30_Sub2_Sub1_9043).aFloat9049, 0.0F);
	OpenGL.glMultiTexCoord2f(33985, f_436_ * (f_434_ - i_418_), ((class30_sub2_sub1.aFloat9051) - f_437_ * (f_435_ - i_419_)));
	OpenGL.glVertex2f(f_434_, f_435_);
	OpenGL.glMultiTexCoord2f(33984, (this.aClass30_Sub2_Sub1_9043).aFloat9049, (this.aClass30_Sub2_Sub1_9043).aFloat9051);
	OpenGL.glMultiTexCoord2f(33985, f_436_ * (f_414_ - i_418_), ((class30_sub2_sub1.aFloat9051) - f_437_ * (f_415_ - i_419_)));
