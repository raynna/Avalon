...
final class Class238 implements Interface10 {
    ...
    static final void method2202(Class403 class403, int i) {
	try {
	    class403.anInt5239 -= -1175642067;
	    int i_13_ = (class403.anIntArray5244[class403.anInt5239 * 681479919]);
	    int i_14_ = (class403.anIntArray5244[681479919 * class403.anInt5239 + 1]);
	    int i_15_ = (class403.anIntArray5244[2 + 681479919 * class403.anInt5239]);
	    Class50.getIComponentDefinitions(i_13_, (byte) 83);
	    Class359.method4291(Class389.aClass119Array4165[i_13_ >>> 16], i_13_ & 0xffff, i_14_, i_15_, class403.aBoolean5261, class403, -782842809);
	}
	catch (RuntimeException runtimeexception) {
