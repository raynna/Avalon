...
public class Class264_Sub2 extends Class264 {
	...
	if (i_11_ > i_15_) {
	    i_15_ = i_11_;
	    i_2_ += (this.aClass_ra_Sub1_7122.anInt7971 * 692106883 * (i_11_ - i_8_));
    ...
    Class264_Sub2(Class_ra_Sub1 class_ra_sub1, Class505 class505, IndexedImage[] class89s, int[] is, int[] is_40_) {
	...
	for (int i = 0; i < class89s.length; i++) {
	    IndexedImage class89 = class89s[i];
	    if (class89.aByteArray819 != null)
		this.aByteArrayArray7123[i] = class89.aByteArray819;
	    else {
	    ...
	    this.anIntArray7126[i] = class89.anInt811;
	    this.anIntArray7127[i] = class89.anInt815;
	}
    }
	...
	if ((this.aClass_ra_Sub1_7122.anIntArray7967) != null) {
		...
		int i_50_ = (692106883 * (this.aClass_ra_Sub1_7122).anInt7971);
		...
		if (i_48_ > 0 && i_49_ > 0)
		    method2504(this.aByteArrayArray7123[c], (this.aClass_ra_Sub1_7122.anIntArray7967), i_45_, i_54_, i_51_, i_48_, i_49_, i_52_, i_53_, i, i_44_, this.anIntArray7124[c], class_ta, i_46_, i_47_);
	    }
	}
    }
	...
	if ((this.aClass_ra_Sub1_7122.anIntArray7967) != null) {
	    ...
	    int i_62_ = (this.aClass_ra_Sub1_7122.anInt7971) * 692106883;
	...
	if ((this.aClass_ra_Sub1_7122.anIntArray7967) != null) {
	    i += this.anIntArray7127[c];
	    i_70_ += this.anIntArray7126[c];
	    int i_72_ = this.anIntArray7124[c];
	    int i_73_ = this.anIntArray7125[c];
	    int i_74_ = (this.aClass_ra_Sub1_7122.anInt7971) * 692106883;
	    int i_75_ = i_70_ * i_74_ + i;
	    int i_76_ = i_74_ - i_72_;
	    int i_77_ = 0;
	    int i_78_ = 0;
	    if (i_70_ < -1278653805 * ((this.aClass_ra_Sub1_7122).anInt7976)) {
		int i_79_ = ((this.aClass_ra_Sub1_7122.anInt7976) * -1278653805 - i_70_);
		i_73_ -= i_79_;
		i_70_ = (this.aClass_ra_Sub1_7122.anInt7976 * -1278653805);
		i_78_ += i_72_ * i_79_;
		i_75_ += i_74_ * i_79_;
	    }
	    if (i_73_ + i_70_ > 63686679 * (this.aClass_ra_Sub1_7122.anInt7977))
		i_73_ -= i_73_ + i_70_ - 63686679 * ((this.aClass_ra_Sub1_7122).anInt7977);
	    if (i < (this.aClass_ra_Sub1_7122.anInt7974) * -912871679) {
		int i_80_ = ((this.aClass_ra_Sub1_7122.anInt7974) * -912871679 - i);
		i_72_ -= i_80_;
		i = (this.aClass_ra_Sub1_7122.anInt7974 * -912871679);
		i_78_ += i_80_;
		i_75_ += i_80_;
	    ...
	    if (i_72_ + i > (this.aClass_ra_Sub1_7122.anInt7991) * -1416794725) {
		int i_81_ = i_72_ + i - (this.aClass_ra_Sub1_7122.anInt7991) * -1416794725;
		i_72_ -= i_81_;
		i_77_ += i_81_;
		i_76_ += i_81_;
	    }
	    if (i_72_ > 0 && i_73_ > 0)
		method2505(this.aByteArrayArray7123[c], (this.aClass_ra_Sub1_7122.anIntArray7967), i_71_, i_78_, i_75_, i_72_, i_73_, i_76_, i_77_);
	}
    }
	...
	if ((this.aClass_ra_Sub1_7122.anIntArray7967) != null) {
	    i += this.anIntArray7127[c];
	    i_82_ += this.anIntArray7126[c];
	    int i_84_ = this.anIntArray7124[c];
	    int i_85_ = this.anIntArray7125[c];
	    int i_86_ = (this.aClass_ra_Sub1_7122.anInt7971) * 692106883;
	    int i_87_ = i_82_ * i_86_ + i;
	    int i_88_ = i_86_ - i_84_;
	    int i_89_ = 0;
	    int i_90_ = 0;
	    if (i_82_ < -1278653805 * ((this.aClass_ra_Sub1_7122).anInt7976)) {
		int i_91_ = ((this.aClass_ra_Sub1_7122.anInt7976) * -1278653805 - i_82_);
		i_85_ -= i_91_;
		i_82_ = (this.aClass_ra_Sub1_7122.anInt7976 * -1278653805);
		i_90_ += i_84_ * i_91_;
		i_87_ += i_86_ * i_91_;
	    }
	    if (i_85_ + i_82_ > 63686679 * (this.aClass_ra_Sub1_7122.anInt7977))
		i_85_ -= i_85_ + i_82_ - 63686679 * ((this.aClass_ra_Sub1_7122).anInt7977);
	    if (i < (this.aClass_ra_Sub1_7122.anInt7974) * -912871679) {
		int i_92_ = ((this.aClass_ra_Sub1_7122.anInt7974) * -912871679 - i);
		i_84_ -= i_92_;
		i = (this.aClass_ra_Sub1_7122.anInt7974 * -912871679);
		i_90_ += i_92_;
		i_87_ += i_92_;
	    ...
	    if (i_84_ + i > (this.aClass_ra_Sub1_7122.anInt7991) * -1416794725) {
		int i_93_ = i_84_ + i - (this.aClass_ra_Sub1_7122.anInt7991) * -1416794725;
		i_84_ -= i_93_;
		i_89_ += i_93_;
		i_88_ += i_93_;
	    }
	    if (i_84_ > 0 && i_85_ > 0)
		method2505(this.aByteArrayArray7123[c], (this.aClass_ra_Sub1_7122.anIntArray7967), i_83_, i_90_, i_87_, i_84_, i_85_, i_88_, i_89_);
	}
    }
	...
	if ((this.aClass_ra_Sub1_7122.anIntArray7967) != null) {
		...
		i += this.anIntArray7127[c];
		i_94_ += this.anIntArray7126[c];
		int i_98_ = this.anIntArray7124[c];
		int i_99_ = this.anIntArray7125[c];
		int i_100_ = (692106883 * (this.aClass_ra_Sub1_7122).anInt7971);
		int i_101_ = i_94_ * i_100_ + i;
		int i_102_ = i_100_ - i_98_;
		int i_103_ = 0;
		int i_104_ = 0;
		if (i_94_ < -1278653805 * ((this.aClass_ra_Sub1_7122).anInt7976)) {
		    int i_105_ = (-1278653805 * (this.aClass_ra_Sub1_7122).anInt7976 - i_94_);
		    i_99_ -= i_105_;
		    i_94_ = ((this.aClass_ra_Sub1_7122).anInt7976 * -1278653805);
		    i_104_ += i_98_ * i_105_;
		    i_101_ += i_105_ * i_100_;
		}
		if (i_94_ + i_99_ > ((this.aClass_ra_Sub1_7122).anInt7977) * 63686679)
		    i_99_ -= (i_99_ + i_94_ - (this.aClass_ra_Sub1_7122.anInt7977) * 63686679);
		if (i < (this.aClass_ra_Sub1_7122.anInt7974 * -912871679)) {
		    int i_106_ = (-912871679 * (this.aClass_ra_Sub1_7122).anInt7974 - i);
		    i_98_ -= i_106_;
		    i = (this.aClass_ra_Sub1_7122.anInt7974 * -912871679);
		    i_104_ += i_106_;
		    i_101_ += i_106_;
		...
		if (i + i_98_ > -1416794725 * ((this.aClass_ra_Sub1_7122).anInt7991)) {
		    int i_107_ = i_98_ + i - ((this.aClass_ra_Sub1_7122).anInt7991) * -1416794725;
		    i_98_ -= i_107_;
		    i_103_ += i_107_;
		    i_102_ += i_107_;
		}
		if (i_98_ > 0 && i_99_ > 0)
		    method2504(this.aByteArrayArray7123[c], (this.aClass_ra_Sub1_7122.anIntArray7967), i_95_, i_104_, i_101_, i_98_, i_99_, i_102_, i_103_, i, i_94_, this.anIntArray7124[c], class_ta, i_96_, i_97_);
	    }
	}
    }
