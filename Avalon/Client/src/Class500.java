...
public class Class500 {
	...
	this.aClass243_6114 = class243;
	this.anInt6115 = (this.aClass243_6114.method2316((-1006924897 * (Class120.aClass120_1431.anInt1460)), -1837337583) * 1005943745);
	if (bool) {
	    this.aClass298_Sub37_Sub7Array6116 = (new Class298_Sub37_Sub7[this.anInt6115 * 589337665]);
	    for (int i = 0; i < this.anInt6115 * 589337665; i++) {
		byte[] is;
		synchronized (this.aClass243_6114) {
		    is = (this.aClass243_6114.getFile(-1006924897 * Class120.aClass120_1431.anInt1460, i));
		}
		...
		this.aClass298_Sub37_Sub7Array6116[i] = class298_sub37_sub7;
	    }
	}
    }
