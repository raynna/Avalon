...
public abstract class Class298_Sub50 extends Class298 {
    ...
    static HandshakePacket[] method3566(int i) {
	try {
	    return (new HandshakePacket[] { HandshakePacket.JAGGRAB, HandshakePacket.aClass211_2416, HandshakePacket.aClass211_2412, HandshakePacket.aClass211_2407, HandshakePacket.aClass211_2419, HandshakePacket.aClass211_2414, HandshakePacket.aClass211_2411, HandshakePacket.aClass211_2417, HandshakePacket.aClass211_2413, HandshakePacket.aClass211_2409, HandshakePacket.ACCOUNT_CREATION });
	}
