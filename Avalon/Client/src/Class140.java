...
public class Class140 implements Runnable {
    ...
    public void run() {
        try {
            try {
                ...
                BufferedReader bufferedreader = (new BufferedReader(new InputStreamReader(new DataInputStream(new URL(new StringBuilder().append("http://").append(Class474.aClass471_5976.address).append(":").append(i).append("/news.ws?game=").append(-937307905 * (client.gametype.gameType)).toString()).openStream()))));
    ...
    public static Class190 method1554(int i, int i_2_) {
        try {
            Class190 class190 = (Class190) Class190.aClass348_1929.method4184(i);
            if (class190 != null)
                return class190;
            byte[] is = Class287.aClass243_3100.getFile(1, i);
            ...
            if (2 == class190.anInt1940 * -1955592777 && Class190.aClass437_1928.method5812(i) == null) {
                    ...
                    if (1817570317 * class365_sub1_sub1_sub2_sub1.anInt10189 != 0) {
                        ...
                        if (1817570317 * class365_sub1_sub1_sub2_sub1.anInt10189 <= 0)
                            string = new StringBuilder().append(string)
                                    .append(Class18.method358(1817570317 * (class365_sub1_sub1_sub2_sub1.anInt10189),
                                            (Class287.myPlayer.anInt10206) * 696798311, (byte) 4))
                                    .toString();
                        else
    ...
    static final void method1556(Class403 class403, int i) {
        try {
